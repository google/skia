...
require (
	...
	github.com/bazelbuild/remote-apis-sdks v0.0.0-20201118210229-b732553f9d45 // indirect
	...
	go.chromium.org/luci v0.0.0-20201119045315-531681ceb045 // indirect
	go.skia.org/infra v0.0.0-20201118213550-885b716afd3d
