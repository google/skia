...
public:
    ...
    SVG_ATTR(SurfaceScale, SkSVGNumberType, SkSVGNumberType(1))
...
class SkSVGFeSpecularLighting : public SkSVGFeLighting {
public:
    static sk_sp<SkSVGFeSpecularLighting> Make() {
        return sk_sp<SkSVGFeSpecularLighting>(new SkSVGFeSpecularLighting());
    }

    SVG_ATTR(SpecularConstant, SkSVGNumberType, SkSVGNumberType(1))
    SVG_ATTR(SpecularExponent, SkSVGNumberType, SkSVGNumberType(1))
