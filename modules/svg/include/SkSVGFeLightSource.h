...
class SkSVGFeDistantLight : public SkSVGFeLightSource {
public:
    static sk_sp<SkSVGFeDistantLight> Make() {
        return sk_sp<SkSVGFeDistantLight>(new SkSVGFeDistantLight());
    }

    SVG_ATTR(Azimuth  , SkSVGNumberType, SkSVGNumberType(0))
    SVG_ATTR(Elevation, SkSVGNumberType, SkSVGNumberType(0))
...
class SkSVGFePointLight : public SkSVGFeLightSource {
public:
    static sk_sp<SkSVGFePointLight> Make() {
        return sk_sp<SkSVGFePointLight>(new SkSVGFePointLight());
    }

    SVG_ATTR(X, SkSVGNumberType, SkSVGNumberType(0))
    SVG_ATTR(Y, SkSVGNumberType, SkSVGNumberType(0))
    SVG_ATTR(Z, SkSVGNumberType, SkSVGNumberType(0))
...
class SkSVGFeSpotLight : public SkSVGFeLightSource {
public:
    ...
    SVG_ATTR(Y               , SkSVGNumberType, SkSVGNumberType(0))
    SVG_ATTR(Z               , SkSVGNumberType, SkSVGNumberType(0))
    SVG_ATTR(PointsAtX       , SkSVGNumberType, SkSVGNumberType(0))
    SVG_ATTR(PointsAtY       , SkSVGNumberType, SkSVGNumberType(0))
    SVG_ATTR(PointsAtZ       , SkSVGNumberType, SkSVGNumberType(0))
