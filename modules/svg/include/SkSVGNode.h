...
protected:
    ...
    virtual bool onNeedsObjectBounds() const { return false; }

    virtual SkSize onComputeBounds(const SkSVGLengthContext&) const { return SkSize::MakeEmpty(); }
