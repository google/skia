...
public:
    ...
    public:
        ...
        virtual void operator()(const SkSVGRenderContext&, const sk_sp<SkTextBlob>&,
                                const SkPaint* fill, const SkPaint* stroke) = 0;
    };
    ...
    SkSVGTextContext(const SkSVGRenderContext&, BlobHandler*, const SkSVGTextPath* = nullptr);
    ...
    BlobHandler* handler() const { return fBlobHandler; }
