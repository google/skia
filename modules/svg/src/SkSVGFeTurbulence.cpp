...
bool SkSVGFeTurbulence::parseAndSetAttribute(const char* name, const char* value) {
    return INHERITED::parseAndSetAttribute(name, value) ||
           this->setNumOctaves(tryParse<SkSVGIntegerType>(name, value, "numOctaves")) ||
           this->setSeed(tryParse<SkSVGNumberType>(name, value, "seed")) ||
           this->setBaseFrequency(tryParse<SkSVGFeTurbulenceBaseFrequency>(
                   name, value, "baseFrequency", SkSVGFeTurbulence::parse)) ||
           this->setTurbulenceType(
                   tryParse<SkSVGFeTurbulenceType>(name, value, "type", SkSVGFeTurbulence::parse));
}
