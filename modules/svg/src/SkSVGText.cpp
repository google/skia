...
// SkSVGTextContext (aka The Chunkinator, aka Chunk Norris) is responsible for sequencing input
// text chars into "chunks".  A single text chunk can span multiple structural elements (<text>,
// <tspan>, etc), and per [1] new chunks are emitted
//
...
private:
    ...
    SkVector                        fChunkAdvance = {0,0}; // cummulative advance
