...
SkSVGTextContext::ScopedPosResolver::ScopedPosResolver(const SkSVGTextContainer& txt,
    ...
    , fRotate(ResolveLengths(lctx, txt.getRotate(), SkSVGLengthContext::LengthType::kOther))
{
...
SkSVGTextContext::ScopedPathResolver::ScopedPathResolver(const SkSVGTextPath& tpath,
                                                         const SkSVGLengthContext& lctx,
                                                         SkSVGTextContext* tctx)
    : fTextContext(tctx)
    , fPrevResolver(tctx->fPathResolver)
{
    fTextContext->fPathResolver = this;
}

SkSVGTextContext::ScopedPathResolver::~ScopedPathResolver() {
    fTextContext->fPathResolver = fPrevResolver;
}
...
bool SkSVGTextContainer::parseAndSetAttribute(const char* name, const char* value) {
    return INHERITED::parseAndSetAttribute(name, value) ||
           ...
           this->setRotate(SkSVGAttributeParser::parse<std::vector<SkSVGLength>>("rotate",
                                                                                 name, value)) ||
...
void SkSVGTextPath::onRenderText(const SkSVGRenderContext& ctx, SkSVGTextContext* tctx,
                                 SkSVGXmlSpace xs) const {
    const SkSVGTextContext::ScopedPathResolver resolver(*this, ctx.lengthContext(), tctx);
...
bool SkSVGTextPath::parseAndSetAttribute(const char* name, const char* value) {
    return INHERITED::parseAndSetAttribute(name, value) ||
        this->setHref(SkSVGAttributeParser::parse<SkSVGStringType>("xlink:href", name, value)) ||   
        this->setStartOffset(SkSVGAttributeParser::parse<SkSVGLength>("start-offset", name, value));
}
