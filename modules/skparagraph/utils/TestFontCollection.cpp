...
TestFontCollection::TestFontCollection(const std::string& resourceDir, bool loadFonts)
...
void TestFontCollection::addFontFromFile(const std::string& path, const std::string& familyName) {
