...
#ifndef SkParagraphCache_DEFINED
#define SkParagraphCache_DEFINED
...
public:
    SkParagraphCacheKey(sk_sp<SkFontCollection> collection,
...
public:
    SkParagraphCacheValue(sk_sp<SkFontCollection> collection,
                          SkParagraphStyle paraStyle,
                          SkTArray<SkBlock, true>
                                  textStyles,
                          SkSpan<const char>
...
#endif  // SkParagraphCache_DEFINED