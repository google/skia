...
void ParagraphImpl::paint(SkCanvas* canvas, SkScalar x, SkScalar y) {
    ...
    if (fState < kDrawn) {
        ...
        this->paintLinesIntoPicture(canvas->getLocalClipBounds().width(), canvas->getLocalClipBounds().height());
        fState = kDrawn;
    }
...
void ParagraphImpl::paintLinesIntoPicture(SkScalar width, SkScalar height) {
    SkPictureRecorder recorder;
    SkCanvas* textCanvas = recorder.beginRecording(width, height, nullptr, 0);
