...
void TextWrapper::breakTextIntoLines(ParagraphImpl* parent,
    ...
    while (fEndLine.endCluster() != end) {
        ...
        TextRange textWithSpaces(fEndLine.startCluster()->textRange().start, start->textRange().start);
        ...
        ClusterRange clustersWithGhosts(fEndLine.startCluster() - parent->clusters().begin(), start - parent->clusters().begin());
