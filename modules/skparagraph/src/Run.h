...
public:
    ...
    SkScalar correctedHeight(bool ascent, bool descent, bool leading = true) const {
        return ::round((double)(descent ? fRawDescent : fDescent)
                                - (ascent ? fRawAscent : fAscent)
                                + (leading ? fRawLeading : fLeading) );
    }
