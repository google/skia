...
public:
    ...
    inline SkSpan<Cluster> clusters() const { return fClusters; }
    inline void setClusters(SkSpan<Cluster> clusters) { fClusters = clusters; }
    SkRect clip() const {
...
public:
    ...
    inline Run* run() const { return fRun; }
