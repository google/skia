...
class Decorations {
    ...
    void calculateParameters(TextStyle textStyle, sk_sp<SkTypeface> typeface);
    ...
    void calculateGaps(const TextLine::ClipContext& context, SkScalar x0, SkScalar x1, SkScalar y, SkScalar baseline);
