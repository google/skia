...
DEF_TEST(SkParagraph_HeightCalculations, reporter) {
    ...
    auto draw = [&](TextHeightBehavior hb, const char* text) {
        ParagraphStyle paragraph_style;
        ...
        //REPORTER_ASSERT(reporter, SkScalarNearlyEqual(paragraph->getHeight(), 16.0f));
    };

    draw(TextHeightBehavior::kAll, "Hello\nLine 2\nLine 3");
    draw(TextHeightBehavior::kDisableAll, "Hello\nLine 2\nLine 3");
    draw(TextHeightBehavior::kDisableFirstAscent, "Hello");
}
