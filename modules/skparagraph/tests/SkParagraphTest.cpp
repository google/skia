...
UNIX_ONLY_TEST(SkParagraph_TextEditingFunctionality, reporter) {
    ...
    REPORTER_ASSERT(reporter, lineNumber == 2);
...
UNIX_ONLY_TEST(SkParagraph_API_USES_UTF16, reporter) {
    ...
    REPORTER_ASSERT(reporter, paragraph->getFontAtUTF16Offset(0) != nullptr);
    REPORTER_ASSERT(reporter, paragraph->getFontAtUTF16Offset(4) == nullptr);
