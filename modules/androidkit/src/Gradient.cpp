...
static jlong Gradient_MakeLinear(JNIEnv* env, jobject, jfloat x0, jfloat y0, jfloat x1, jfloat y1,
...
int register_androidkit_Gradient(JNIEnv* env) {
    static const JNINativeMethod methods[] = {
        {"nMakeLinear", "(FFFF[F[FIJ)J", reinterpret_cast<void*>(Gradient_MakeLinear)},
    };

    const auto clazz = env->FindClass("org/skia/androidkit/Gradient");
    return clazz
