...
const SkPoint& TransformPropertyHandle::getAnchorPoint() const {
...
const SkPoint& TransformPropertyHandle::getPosition() const {
...
const SkVector& TransformPropertyHandle::getScale() const {
...
void PropertyObserver::onColorProperty(const char[], std::unique_ptr<ColorPropertyHandle>) {}

void PropertyObserver::onOpacityProperty(const char[], std::unique_ptr<OpacityPropertyHandle>) {}

void PropertyObserver::onTransformProperty(const char[], std::unique_ptr<TransformPropertyHandle>) {}
