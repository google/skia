...
template <>
PropertyHandle<OpacityPropertyValue, sksg::OpacityEffect>::~PropertyHandle() = default;
...
template <>
PropertyHandle<TransformPropertyValue, TransformAdapter>::~PropertyHandle() = default;
