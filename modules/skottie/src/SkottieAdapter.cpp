...
DropShadowEffectAdapter::DropShadowEffectAdapter(sk_sp<sksg::DropShadowEffect> dropShadow)
...
void DropShadowEffectAdapter::apply() {
    ...
    fDropShadow->setMode(fShadowOnly ? sksg::DropShadowEffect::Mode::kShadowOnly
                                     : sksg::DropShadowEffect::Mode::kShadowAndForeground);
}
