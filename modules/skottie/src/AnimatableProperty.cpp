...
MakeEvaluator(const AnimationBuilder&, const skjson::ArrayValue*, T*);
...
template <>
AnimatableProperty<ScalarValue>::~AnimatableProperty() = default;
...
template <>
AnimatableProperty<ShapeValue>::~AnimatableProperty() = default;
...
template <>
AnimatableProperty<TextValue>::~AnimatableProperty() = default;
...
void AnimatableProperty<T>::init(const AnimationBuilder& abuilder,
    ...
    // Keyframed property.
    fEvaluator = MakeEvaluator<T>(abuilder, jpropK, &fStorage);
}
