...
public:
    ...
    struct ShapedGlyphs {
        ...
        // Legacy/cheaper textblob-style conservative bounds.
        // TODO: investigate removing and using the more expensive accurate bounds instead.
        SkRect computeConservativeBounds() const;
