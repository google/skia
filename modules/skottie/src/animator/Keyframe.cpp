...
KeyframeAnimatorBase::Builder::~Builder() = default;

bool KeyframeAnimatorBase::Builder::parseKeyframes(const AnimationBuilder& abuilder,
...
uint32_t KeyframeAnimatorBase::Builder::parseMapping(const skjson::ObjectValue& jkf) {
...
bool BindPropertyImpl(const AnimationBuilder& abuilder,
                      ...
                      KeyframeAnimatorBase::Builder& builder,
...
public:
    class Builder final : public KeyframeAnimatorBase::Builder {
    public:
...
bool AnimatablePropertyContainer::bind<VectorValue>(const AnimationBuilder& abuilder,
    ...
    if (!ParseDefault<bool>((*jprop)["s"], false)) {
        ...
        return BindPropertyImpl(abuilder, jprop, builder, &fAnimators, v);
    }
