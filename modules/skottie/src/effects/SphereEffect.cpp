...
// To simplify things, the shader is set up such that:
//
...
private:
    ...
    sk_sp<SkShader> buildEffectShader(float selector) const {
        ...
        builder.uniform("rot_matrix")  = fRotateMatrix;
    ...
    // Cached shaders
    mutable sk_sp<SkShader> fSphereShader;
    mutable sk_sp<SkShader> fContentShader;

    // Effect controls.
    RotMatrix  fRotateMatrix;
    SkPoint    fCenter = {0,0};
    float      fRadius = 0;
...
private:
    void onSync() override {
        ...
        const auto rotation = [](ScalarValue order, ScalarValue x, ScalarValue y,
                                 ScalarValue z) -> SphereNode::RotMatrix {
            ...
            switch (SkScalarRoundToInt(order)) {
                case 1: r = rx * ry * rz; break;
                case 2: r = rx * rz * ry; break;
                case 3: r = ry * rx * rz; break;
                case 4: r = ry * rz * rx; break;
                case 5: r = rz * rx * ry; break;
                case 6: r = rz * ry * rx; break;
                default: break;
            }
        ...
        sph->setRotateMatrix(rotation(fRotOrder, fRotX, fRotY, fRotZ));
    }
