...
sk_sp<Animation> Animation::Builder::make(const char* data, size_t data_len) {
    ...
    fStats.fJsonParseTimeMS =
            std::chrono::duration_cast<std::chrono::microseconds>(t1 - t0).count() * .001f;
    ...
    fStats.fSceneParseTimeMS =
            std::chrono::duration_cast<std::chrono::microseconds>(t2 - t1).count() * .001f;
    fStats.fTotalLoadTimeMS  =
            std::chrono::duration_cast<std::chrono::microseconds>(t2 - t0).count() * .001f;
