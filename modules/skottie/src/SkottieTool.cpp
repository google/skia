...
int main(int argc, char** argv) {
    ...
    double avg = std::accumulate(frames_ms.begin(), frames_ms.end(), 0) / frame_count;
    SkDebugf("frame time min %gms, med %gms, avg %gms, max %gms\n",
             frames_ms[0], frames_ms[frame_count/2], avg, frames_ms.back());
    return 0;
}
