...
#include "modules/skresources/utils/SkResourcesUtils.h"
...
sk_sp<skresources::ImageAsset> FileResourceProvider::loadImageAsset(const char resource_path[],
...
sk_sp<skresources::ImageAsset> ResourceProviderProxyBase::loadImageAsset(const char rpath[],
                                                                         const char rname[],
...
sk_sp<skresources::ImageAsset> CachingResourceProvider::loadImageAsset(
...
sk_sp<skresources::ImageAsset> DataURIResourceProviderProxy::loadImageAsset(
        const char rpath[],
        const char rname[],
        const char rid[]) const {
