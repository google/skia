...
#FIXME(kjlbuick) add --closure 1 back in
RELEASE_CONF="-Oz --closure 0 --llvm-lto 1 -DSK_RELEASE --pre-js $BASE_DIR/release.js \
...
if [[ $@ == *debug* ]]; then
  ...
  RELEASE_CONF="-Os --llvm-lto 1 -g3 -DSK_RELEASE --profiling-funcs --closure 0 \
