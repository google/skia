describe('Basic Canvas ops', () => {
    ...
    // to decode an image, and the other uses codecs included in the CanvasKit wasm to decode an image.
    // wasm codec Image decoding is faster (50 microseconds vs 20000 microseconds), but including
    // codecs in wasm increases the size of the CanvasKit wasm binary.
    for (const testImageFilename of TEST_IMAGE_FILENAMES) {
        ...
        it('can decode an image using HTMLImageElement and Canvas2D', async () => {
            ...
            async function test(ctx) {
                ...
                // Testing showed that waiting for the load event is faster than waiting for image.decode()
