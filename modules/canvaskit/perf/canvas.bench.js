describe('Basic Canvas ops', () => {
    ...
    it('can draw 100 colored regions', () => {
        function setup(ctx) {
            ...
            ctx.canvas.clear(CanvasKit.Color(255, 255, 255, 0.0)); // transparent
        };
    ...
    it('can draw a shadow with tonal colors', () => {
        ...
        const flags = 0;
        const lightPos = [250,150,300]; // what values to use here?
        const zPlaneParams = [0,0,1]; // what values to use here?
