describe('CanvasKit\'s Canvas Behavior', function() {
    ...
    it('draws with color filters', function(done) {
        LoadCanvasKit.then(catchException(done, () => {
            ...
            const blue = CanvasKit.SkColorFilter.MakeBlend(CanvasKit.BLUE, CanvasKit.BlendMode.SrcIn);
            const red =  CanvasKit.SkColorFilter.MakeBlend(CanvasKit.Color(255, 0, 0, 0.8), CanvasKit.BlendMode.SrcOver);
