describe('Canvas Behavior', () => {
  ...
  gm('rrect_canvas', (canvas) => {
    ...
    canvas.drawRRect(CanvasKit.RRectXY(CanvasKit.LTRBRect(10, 10, 50, 50), 5, 10), paint);

    canvas.drawRRect(CanvasKit.RRectXY(CanvasKit.LTRBRect(60, 10, 110, 50), 10, 5), paint);

    canvas.drawRRect(CanvasKit.RRectXY(CanvasKit.LTRBRect(10, 60, 210, 260), 0, 30), paint);

    canvas.drawRRect(CanvasKit.RRectXY(CanvasKit.LTRBRect(50, 90, 160, 210), 30, 30), paint);
  ...
  gm('colorfilters_canvas', (canvas) => {
    ...
    const blue = CanvasKit.ColorFilter.MakeBlend(CanvasKit.BLUE, CanvasKit.BlendMode.SrcIn);
    const red = CanvasKit.ColorFilter.MakeBlend(
      CanvasKit.Color(255, 0, 0, 0.8),
    ...
    const r = CanvasKit.ColorMatrix.rotated(0, 0.707, -0.707);
    const b = CanvasKit.ColorMatrix.rotated(2, 0.5, 0.866);
  ...
  gm('drawpoints_canvas', (canvas) => {
    ...
    const caps = [CanvasKit.StrokeCap.Round, CanvasKit.StrokeCap.Square, CanvasKit.StrokeCap.Butt];
    const joins = [
  ...
  gm(
    'drawImageNine_canvas',
    (canvas, fetchedByteBuffers) => {
      ...
      canvas.drawImageNine(
        img,
        CanvasKit.LTRBiRect(40, 40, 400, 300),
        CanvasKit.LTRBRect(5, 5, 300, 650),
  ...
  gm(
    ...
    (canvas, fetchedByteBuffers) => {
      ...
      canvas.clear(CanvasKit.WHITE);
      const paint = new CanvasKit.Paint();
      const shader = imgWithMipMap.makeShaderOptions(
        CanvasKit.TileMode.Decal,
        CanvasKit.TileMode.Clamp,
        CanvasKit.FilterMode.Nearest,
  ...
  gm(
    ...
    (canvas, fetchedByteBuffers) => {
      ...
      const points = [70, 170, 40, 90, 130, 150, 100, 50, 225, 150, 225, 60, 310, 180, 330, 100];
      const textureCoordinates = [0, 240, 0, 0, 80, 240, 80, 0, 160, 240, 160, 0, 240, 240, 240, 0];
      const vertices = CanvasKit.MakeVertices(
  ...
  it('can change the 3x3 matrix on the canvas and read it back', () => {
    ...
    expect4x4MatricesToMatch(
      [0.707106, -0.707106, 0, 7.071067, 0.707106, 0.707106, 0, 21.213203, 0, 0, 0, 0, 0, 0, 0, 1],
      matr
    );
  });
  ...
  it('can accept a 3x2 matrix', () => {
    ...
    matr = canvas.getLocalToDevice();
    expect4x4MatricesToMatch([1.4, -0.2, 0, 12, 0.2, 1.4, 0, 24, 0, 0, 0, 0, 0, 0, 0, 1], matr);
  });
