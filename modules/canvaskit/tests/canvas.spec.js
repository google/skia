describe('CanvasKit\'s Canvas Behavior', function() {
    ...
    it('returns the depth of the save state stack', function() {
    ...
    gm('drawImageNine_canvas', (canvas, fetchedByteBuffers) => {
        let img = CanvasKit.MakeImageFromEncoded(fetchedByteBuffers[0]);
    ...
    it('can change the matrix on the canvas and read it back', function() {
        const canvas = new CanvasKit.SkCanvas();
