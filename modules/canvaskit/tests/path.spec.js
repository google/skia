describe('CanvasKit\'s Path Behavior', function() {
    ...
    it('can draw a path using relative functions', function(done) {
        LoadCanvasKit.then(catchException(done, () => {
            ...
            const path = new CanvasKit.SkPath();
            path.rMoveTo(20, 5);
            path.rLineTo(10, 15);  // 30, 20
            path.rLineTo(10, -5);  // 40, 10
            path.rLineTo(10, 10);  // 50, 20
            path.rLineTo(10, -20); // 60, 0
            path.rLineTo(-40, 5);  // 20, 5

            path.moveTo(20, 80);
            path.rCubicTo(70, -70, 140, 70, 170, -70); // 90, 10, 160, 150, 190, 10

            path.moveTo(36, 148);
            path.rQuadTo(30, 40, 84, -12); // 66, 188, 120, 136
            path.lineTo(36, 148);

            path.moveTo(150, 180);
            path.rArcTo(24, 24, 45, true, false, -68, -24); // 82, 156
            path.lineTo(160, 160);
