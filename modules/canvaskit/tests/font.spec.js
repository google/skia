describe('Font Behavior', () => {
    ...
    gm('serif_text_on_path', (canvas) => {
        const notoSerif = CanvasKit.Typeface.MakeFromData(notoSerifFontBuffer);
    ...
    gm('nullterminators_skbug_9314', (canvas) => {
        const bungee = CanvasKit.Typeface.MakeFromData(bungeeFontBuffer);
    ...
    gm('various_font_formats', (canvas, fetchedByteBuffers) => {
        ...
        for (const fontType of inputs) {
            ...
            const typeface = CanvasKit.Typeface.MakeFromData(fontType.buffer);
        ...
        // manual test.
        const typeface = CanvasKit.Typeface.MakeFromData(fetchedByteBuffers[3]);
    ...
    it('can measure text very precisely with proper settings', () => {
        const typeface = CanvasKit.Typeface.MakeFromData(notoSerifFontBuffer);
