describe('CanvasKit\'s Font Behavior', function() {
    ...
    fit('can load fonts of a variety of types', function(done) {
        ...
        Promise.all([LoadCanvasKit, otfFontLoaded, bungeeFontLoaded, woffFontLoaded, woff2FontLoaded]).then(catchException(done, () => {
            ...
            canvas.drawText(`The following should be ${inputs.length} lines of text:`, 5, 30, fontPaint, defaultFont);
            ...
            fontPaint.delete();
            fontMgr.delete();
            reportSurface(surface, 'various_font_types', null);
        }));
    });
