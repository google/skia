...
### Deprecated
 - `MakeSkCornerPathEffect` will be renamed soon. Calls can be replaced with `PathEffect.MakeCorner`.
 - `MakeSkDiscretePathEffect` will be renamed soon. Calls can be replaced with `PathEffect.MakeDiscrete`.
