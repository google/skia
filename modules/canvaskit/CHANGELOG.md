...
### Added
 ...
 - `CanvasKit.ColorAsInt`, `SkPaint.setColorComponents`, `SkPaint.setColorInt` for when clients want
   to avoid the overhead of allocating an array for color components.
