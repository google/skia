...
export interface CanvasKit {
     ...
     * @param soundMap - an optional mapping of sound identifiers (strings) to AudioPlayers. Only needed if the animation supports sound.
     */
    MakeManagedAnimation(json: string, assets?: Record<string, ArrayBuffer>,
                         filterPrefix?: string): ManagedSkottieAnimation, soundMap?: SoundMap;
