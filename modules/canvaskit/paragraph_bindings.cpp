...
struct SimpleTextStyle {
    ...
    int shadowLen;
    uintptr_t /* float* */ shadowColorsPtr;
    uintptr_t /* float* */ shadowOffsetsPtr;
...
para::TextStyle toTextStyle(const SimpleTextStyle& s) {
    ...
    if (s.fontFeatureLen > 0) {
      ...
      for (int i = 0; i < s.fontFeatureLen; i++) {
        SkString name(fontFeatureNames[i]);
...
para::PlaceholderStyle toPlaceholderStyle(SimplePlaceholderStyle s) {
  para::PlaceholderStyle ps(s.width, s.height, s.alignment, s.baseline, s.offset);
  return ps;
}
...
EMSCRIPTEN_BINDINGS(Paragraph) {
    ...
    class_<para::ParagraphBuilderImpl>("ParagraphBuilder")
      ...
      .class_function("_MakeFromFontProvider", optional_override([](SimpleParagraphStyle style,
        ...
        .function("addText", optional_override([](para::ParagraphBuilderImpl& self, std::u16string text) {
      ...
      .function("_addPlaceholder", optional_override([](para::ParagraphBuilderImpl& self,
                                                        SimplePlaceholderStyle placeholder) {
          auto ps = toPlaceholderStyle(placeholder);
    ...
    value_object<SimpleTextShadow>("TextShadow")
        .field("_colorPtr",  &SimpleTextShadow::colorPtr)
        .field("offset",     &SimpleTextShadow::offset)
        .field("blurRadius", &SimpleTextShadow::blurRadius);
    ...
    value_object<SimplePlaceholderStyle>("PlaceholderStyle")
      .field("width",     &SimplePlaceholderStyle::width)
      .field("height",    &SimplePlaceholderStyle::height)
      .field("alignment", &SimplePlaceholderStyle::alignment)
      .field("baseline",  &SimplePlaceholderStyle::baseline)
      .field("offset",    &SimplePlaceholderStyle::offset);
