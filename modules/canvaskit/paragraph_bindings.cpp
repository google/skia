...
struct SimpleTextStyle {
    uintptr_t /* float* */ color;
    uintptr_t /* float* */ foregroundColor;
    uintptr_t /* float* */ backgroundColor;
    uint8_t decoration;
