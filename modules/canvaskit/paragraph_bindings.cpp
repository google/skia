...
EMSCRIPTEN_BINDINGS(Paragraph) {
    ...
    class_<para::ParagraphBuilderImpl>("ParagraphBuilder")
        ...
        // A method of pushing a textStyle with paints instead of colors for foreground and background.
        // Since SimpleTextStyle is a value object, it cannot contain paints, which are not primitives.
        // This binding is here to accept them. Any color that is specified in the textStyle is overridden.
