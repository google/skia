...
bool IsMockContextType(sk_gpu_test::GrContextFactory::ContextType) {return false;}
void RunWithGPUTestContexts(GrContextTestFn* test, GrContextTypeFilterFn* contextTypeFilter,
    ...
    sk_sp<GrDirectContext> glCtx(GrDirectContext::MakeGL(options));
    if (!glCtx) {
        SkDebugf("Could not make WebGL context\n");
        return;
    }
    WasmContextInfo ctxInfo(glCtx.get(), options);
