...
bool IsGLContextType(ContextType ct) {
    return ct == ContextType::kGL_ContextType;
}
...
void RunWithGPUTestContexts(GrContextTestFn* test, GrContextTypeFilterFn* contextTypeFilter,
    ...
    if (!contextTypeFilter || (*contextTypeFilter)(ContextType::kGL_ContextType)) {
        ctx = GrDirectContext::MakeGL(options);
    } else if ((*contextTypeFilter)(ContextType::kMock_ContextType)) {
        ctx = GrDirectContext::MakeMock(nullptr, options);
    } else {
        return;
    }
