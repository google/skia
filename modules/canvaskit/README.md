...
wasm2wat 1.0.13 (1.0.17) is required for the tools in `wasm_tools/SIMD/`. These tools
programmatically inspect the wasm output of a CanvasKit build to detect the presence of wasm SIMD
operations.
