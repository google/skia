...
export interface TypefaceFactory {
    /**
     * Create a typeface from the specified bytes and return it. CanvasKit supports .ttf, .woff and
     * .woff2 fonts. It returns null if the bytes cannot be decoded.
     * @param fontData
     */
    MakeFromData(fontData: ArrayBuffer): Typeface | null;
}
