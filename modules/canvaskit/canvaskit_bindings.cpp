...
void computeTonalColors(uintptr_t cPtrAmbi /* float * */, uintptr_t cPtrSpot /* float * */) {
    ...
    ambiFloats[0] = ambi4f.fR;
    ambiFloats[1] = ambi4f.fG;
    ambiFloats[2] = ambi4f.fB;
    ambiFloats[3] = ambi4f.fA;
    spotFloats[0] = spot4f.fR;
    spotFloats[1] = spot4f.fG;
    spotFloats[2] = spot4f.fB;
    spotFloats[3] = spot4f.fA;
}
