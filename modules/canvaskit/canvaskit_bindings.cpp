...
sk_sp<GrDirectContext> MakeGrDirectContext(EMSCRIPTEN_WEBGL_CONTEXT_HANDLE context)
{
...
EMSCRIPTEN_BINDINGS(Skia) {
    ...
    function("MakeGrDirectContext", &MakeGrDirectContext);
    ...
    class_<GrDirectContext>("GrDirectContext")
        ...
        .function("getResourceCacheLimitBytes", optional_override([](auto& self)->size_t {
            int maxResources = 0;// ignored
            size_t currMax = 0;
            self.getResourceCacheLimits(&maxResources, &currMax);
            return currMax;
        }))
        .function("getResourceCacheUsageBytes", optional_override([](auto& self)->size_t {
        ...
        .function("setResourceCacheLimitBytes", optional_override([](auto& self, size_t maxResourceBytes)->void {
            int maxResources = 0;
