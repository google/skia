...
EMSCRIPTEN_BINDINGS(Skia) {
    ...
    class_<SkCanvas>("SkCanvas")
        ...
        .function("_drawDRRect",optional_override([](SkCanvas& self, uintptr_t /* float* */ oPtr,
                                                     uintptr_t /* float* */ iPtr, const SkPaint& paint) {
            self.drawDRRect(ptrToSkRRect(oPtr), ptrToSkRRect(iPtr), paint);
        }))
