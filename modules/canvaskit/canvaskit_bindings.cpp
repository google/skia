...
EMSCRIPTEN_BINDINGS(Skia) {
    ...
    class_<SkAnimatedImage>("SkAnimatedImage")
        ...
        .function("getFrameCount", optional_override([](SkAnimatedImage& self)->int {
            return self.codec()->codec()->getFrameCount();
        }))
