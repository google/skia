...
EMSCRIPTEN_BINDINGS(Skia) {
    ...
    class_<SkImageFilter>("SkImageFilter")
        ...
        .class_function("MakeComposed", &SkImageFilters::Compose)
        .class_function("MakeImage", select_overload<sk_sp<SkImageFilter>(sk_sp<SkImage>)>(&SkImageFilters::Image))
        ...
        .class_function("MakePicture", select_overload<sk_sp<SkImageFilter>(sk_sp<SkPicture>)>(&SkImageFilters::Picture));
