...
struct OptionalMatrix44 : SkM44 {
    OptionalMatrix44(uintptr_t mPtr) {
        if (mPtr) {
            ...
            this->setRowMajor(sixteenMatrixValues);
        }
    }
};
...
EMSCRIPTEN_BINDINGS(Skia) {
    ...
    class_<SkCanvas>("SkCanvas")
        ...
        .function("_concat", optional_override([](SkCanvas& self, uintptr_t /* SkScalar*  */ mPtr) {
            OptionalMatrix44 localMatrix(mPtr);
            self.concat44(localMatrix);
        }))
        ...
        .function("_saveCamera", optional_override([](SkCanvas& self,
            ...
            // See comment above for uintptr_t explanation
            OptionalMatrix44 projection(pPtr);
            OptionalMatrix44 camera(cPtr);
            self.experimental_saveCamera(projection, camera);
        }))
