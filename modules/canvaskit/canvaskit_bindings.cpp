...
EMSCRIPTEN_BINDINGS(Skia) {
    ...
    class_<SkImageFilter>("SkImageFilter")
        ...
        .class_function("MakeColorFilter", &SkImageFilters::Compose)
        .class_function("MakeCompose", &SkImageFilters::Compose)
        .class_function("MakeDropShadow", optional_override([](SkScalar dx, SkScalar dy,
                                                               SkScalar sigmaX, SkScalar sigmaY,
                                                               SkColor c, sk_sp<SkImageFilter> i)->sk_sp<SkImageFilter> {
            // Emscripten does not like default args nor SkIRect* much
            return SkImageFilters::DropShadow(dx, dy, sigmaX, sigmaY, c, i, nullptr);
        }));
