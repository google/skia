...
EMSCRIPTEN_BINDINGS(Skia) {
    ...
    class_<SkShader>("Shader")
        ...
        .class_function("MakeFractalNoise", optional_override([](SkScalar baseFrequencyX, SkScalar baseFrequencyY,
        ...
        .class_function("MakeTurbulence", optional_override([](SkScalar baseFrequencyX, SkScalar baseFrequencyY,
                                                               int numOctaves, SkScalar seed,
                                                               int tileW, int tileH)->sk_sp<SkShader> {
            if (tileW > 0 && tileH > 0) {
                SkISize tileSize = SkISize::Make(tileW, tileH);
