...
public:
    ...
    void apply(const SkParticleUpdateParams& params, SkParticles& particles, int start, int count);
...
private:
    virtual void onApply(const SkParticleUpdateParams& params, SkParticles& particles,
                         int start, int count) = 0;
