...
void SkParticleEffect::update(double now) {
    ...
    // Do integration of effect position and orientation
    {
        ...
        SkScalar s = SkScalarSin(fState.fSpin * fState.fDeltaTime),
                 c = SkScalarCos(fState.fSpin * fState.fDeltaTime);
        fState.fHeading.set(fState.fHeading.fX * c - fState.fHeading.fY * s,
