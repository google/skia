...
public:
    ...
    void call(int index, float* arguments, float* outReturn) override {
        *outReturn = fCurve.eval(*arguments, fContext.fRandom[index]);
    }
...
public:
    ...
    void call(int index, float* arguments, float* outReturn) override {
        SkColor4f color = fCurve.eval(*arguments, fContext.fRandom[index]);
...
public:
    ...
    void call(int index, float* arguments, float* outReturn) override {
        ...
        fContext.fSpawnRequests->emplace_back(index, fParams, loop);
    }
