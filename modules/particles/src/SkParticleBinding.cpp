...
public:
    SkPathExternalValue(const char* name,
                        SkSL::Compiler& compiler,
                        const LinearizedPath& path,
                        skvm::Uniforms* uniforms,
                        SkArenaAlloc* alloc)
            : SkParticleExternalValue(
...
public:
    ...
    std::unique_ptr<SkParticleExternalValue> toValue(SkSL::Compiler& compiler,
                                                     skvm::Uniforms* uniforms,
                                                     SkArenaAlloc* alloc) override {
        return std::unique_ptr<SkParticleExternalValue>(
                new SkPathExternalValue(fName.c_str(), compiler, fData, uniforms, alloc));
    }
...
class SkShaderExternalValue : public SkParticleExternalValue {
public:
    SkShaderExternalValue(const char* name,
                          SkSL::Compiler& compiler,
...
public:
    ...
    std::unique_ptr<SkParticleExternalValue> toValue(SkSL::Compiler& compiler,
                                                     ...
                                                     SkArenaAlloc* alloc) override {
        return std::unique_ptr<SkParticleExternalValue>(
                new SkShaderExternalValue(fName.c_str(), compiler, fShader, uniforms, alloc));
    }
