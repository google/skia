...
ShaperHarfBuzz::ShaperHarfBuzz(HBBuffer buffer, sk_sp<SkFontMgr> fontmgr)
    ...
    , fLineBreakIterator(std::move(fUnicode->makeBreakIterator("th", nullptr, 0,
        SkUnicode::UBreakType::kLines)))
    , fGraphemeBreakIterator(std::move(fUnicode->makeBreakIterator("th", nullptr, 0,
        SkUnicode::UBreakType::kGraphemes)))
