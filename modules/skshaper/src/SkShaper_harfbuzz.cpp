...
private:
    ...
    static bool CompareEntry(Entry const& a, Entry const& b) {
        return a.runIterator->endOfCurrentRun() < b.runIterator->endOfCurrentRun() ||
               (a.runIterator->endOfCurrentRun() == b.runIterator->endOfCurrentRun() && a.priority < b.priority);
    }
