...
public:
    ...
    void consume() override {
        ...
        SkUnichar u = SkUTF8_NextUnicharReplace(&fEndOfCurrentRun, fEndOfAllRuns);
        ...
        while (fUTF16LogicalPosition < endPosition) {
            ...
            u = SkUTF8_NextUnicharReplace(&fEndOfCurrentRun, fEndOfAllRuns);
            fUTF16LogicalPosition += SkUTF::ToUTF16(u);
        }
    }
...
public:
    ...
    void consume() override {
        ...
        SkUnichar u = SkUTF8_NextUnicharReplace(&fCurrent, fEnd);
        fCurrentScript = hb_unicode_script(fHBUnicode, u);
        while (fCurrent < fEnd) {
            const char* prev = fCurrent;
            u = SkUTF8_NextUnicharReplace(&fCurrent, fEnd);
    ...
    SkTArray<ShapedRun> runs;
{
    ...
    while (runSegmenter.advanceRuns()) {
        ...
        while (utf8Current < utf8End) {
            ...
            hb_codepoint_t u = SkUTF8_NextUnicharReplace(&utf8Current, utf8End);
