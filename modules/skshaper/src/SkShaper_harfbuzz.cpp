                               ...
                               RunHandler* handler) const
{
    ...
    while (runSegmenter.advanceRuns()) {  // For each item
        ...
        ShapedRun model(RunHandler::Range(), SkFont(ToolUtils::DefaultTypeface()), 0, nullptr, 0);
        ...
        while (utf8Start < utf8End) {  // While there are still code points left in this item
            ...
            ShapedRun best(RunHandler::Range(), SkFont(ToolUtils::DefaultTypeface()), 0, nullptr, 0,
