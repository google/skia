...
static hb_position_t skhb_glyph_h_advance(hb_font_t* hb_font,
                                          void* font_data,
...
static void skhb_glyph_h_advances(hb_font_t* hb_font,
                                  void* font_data,
                                  unsigned count,
...
static hb_bool_t skhb_glyph_extents(hb_font_t* hb_font,
                                    void* font_data,
                                    hb_codepoint_t codepoint,
...
static hb_font_funcs_t* skhb_get_font_funcs() {
...
HBFont create_hb_font(const SkFont& font) {
    ...
    HBFace face;
    if (!typefaceAsset) {
        face.reset(hb_face_create_for_tables(skhb_get_table,
