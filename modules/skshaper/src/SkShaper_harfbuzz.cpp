...
class IcuBiDiRunIterator : public SkShaper::BiDiRunIterator {
public:
...
class HbScriptRunIterator : public SkShaper::ScriptRunIterator {
public:
...
class FontMgrRunIterator : public SkShaper::FontRunIterator {
public:
...
class StdLanguageRunIterator : public SkShaper::LanguageRunIterator {
public:
                                  ...
                                  const FontRunIterator& font) const
{
    ...
    hb_buffer_set_script(buffer, (hb_script_t)script.currentScript());
