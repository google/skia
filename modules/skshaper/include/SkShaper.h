...
public:
    ...
    public:
        ...
        /** Called once for each run in a line after commitRunInfo. The returned buffer will be filled out. */
        virtual Buffer runBuffer(const RunInfo&) = 0;

        /** Called after runBuffer is filled out. */
