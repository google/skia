...
SkPoint Text::alignedPosition(const SkRect& bounds) const {
    ...
    case SkPaint::kCenter_Align:
        aligned.offset(-bounds.width() / 2, 0);
        break;
    case SkPaint::kRight_Align:
        aligned.offset(-bounds.width(), 0);
        break;
    }
