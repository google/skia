 ...
 *
 * Supported instantiations: SkMatrix, SkMat4.
 *
 * Sample use:
 *
...
protected:
    ...
    bool is44() const override { return std::is_same<T, SkMat4>::value; }

    SkMatrix asMatrix() const override;
    SkMat4   asM44   () const override;
