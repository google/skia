...
async function driveBrowser() {
  ...
  try {
    ...
    // console.log(window._skottieDone);
    // console.log(window._avgFrameTimeMs);
    // console.log(window._minFrameTimeMs);
    // console.log(window._maxFrameTimeMs);
  ...
  // Write results.
  fs.writeFileSync(options.output, "test test test");
