...
void Viewer::drawSlide(SkCanvas* canvas) {
    ...
    if (ColorMode::kLegacy != fColorMode) {
        ...
        SkAssertResult(skcms_PrimariesToXYZD50(
            fColorSpacePrimaries.fRX, fColorSpacePrimaries.fRY,
            fColorSpacePrimaries.fGX, fColorSpacePrimaries.fGY,
            fColorSpacePrimaries.fBX, fColorSpacePrimaries.fBY,
            fColorSpacePrimaries.fWX, fColorSpacePrimaries.fWY,
            &toXYZ));
