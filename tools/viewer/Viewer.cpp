...
static void ImGui_DragQuad(SkPoint* pts) {
    ImDrawList* drawList = ImGui::GetWindowDrawList();
    ...
    // Corner markers
    ImVec2 tl = ImGui_DragPoint("TL", pts + 0, pos, size);
    ImVec2 tr = ImGui_DragPoint("TR", pts + 1, pos, size);
    ImVec2 bl = ImGui_DragPoint("BL", pts + 2, pos, size);
    ImVec2 br = ImGui_DragPoint("BR", pts + 3, pos, size);
    ...
    if (fShowImGuiDebugWindow) {
        ...
        if (ImGui::Begin("Tools", &fShowImGuiDebugWindow,
            ...
            if (ImGui::CollapsingHeader("Transform")) {
                ...
                ImGui::Checkbox("Perspective", &fPerspective);
