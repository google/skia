    ...
    , fPerspectiveMode(kPerspective_Off)
{
    ...
    fCommands.addCommand('A', "Paint", "Antialias Mode", [this]() {
        if (!(fPaintOverrides.fFlags & kAntiAlias_Flag)) {
            fPaintOverrides.fAntiAlias = SkPaintFields::AntiAliasState::Alias;
            fPaintOverrides.fFlags |= kAntiAlias_Flag;
...
void Viewer::updateTitle() {
    ...
    auto paintFlag = [this, &paintTitle](unsigned flag, bool (SkPaint::* isFlag)() const,
    ...
    paintFlag(kAntiAlias_Flag, &SkPaint::isAntiAlias, "Antialias", "Alias");
    paintFlag(kDither_Flag, &SkPaint::isDither, "DITHER", "No Dither");
...
public:
    ...
    bool onFilter(SkTCopyOnFirstWrite<SkPaint>* paint, Type) const override {
        ...
        if (fPaintOverrides->fFlags & kDither_Flag) {
