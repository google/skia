...
static bool ImGui_Primaries(SkColorSpacePrimaries* primaries, SkImage* gamutImage,
    ...
    // Primary markers
    anyDrag = ImGui_DragPoint(&primaries->fRX, &primaries->fRY, &dragging[0], "R", 0xFF000040,
                              drawList, canvasPos, canvasSize, &r);
    anyDrag = ImGui_DragPoint(&primaries->fGX, &primaries->fGY, &dragging[1], "G", 0xFF004000,
                              drawList, canvasPos, canvasSize, &g) || anyDrag;
    anyDrag = ImGui_DragPoint(&primaries->fBX, &primaries->fBY, &dragging[2], "B", 0xFF400000,
                              drawList, canvasPos, canvasSize, &b) || anyDrag;
    anyDrag = ImGui_DragPoint(&primaries->fWX, &primaries->fWY, &dragging[3], "W", 0xFFFFFFFF,
                              drawList, canvasPos, canvasSize, nullptr) || anyDrag;
