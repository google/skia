...
void Viewer::updateUIState() {
    ...
    int lastMeasurement = (fCurrentMeasurement + (kMeasurementCount - 1)) & (kMeasurementCount - 1);
    fpsState[kValue] = SkStringPrintf("%8.3lf : %8.3lf : %8.3lf ms",
                                      fAnimateTimes[lastMeasurement],
                                      fPaintTimes[lastMeasurement],
                                      fFlushTimes[lastMeasurement]).c_str();
