...
public:
    ...
    virtual void visit(const char*, sk_sp<SkParticleEmitter>&) = 0;
...
public:
    ...
    const char* getType() const override { return "SkCircleEmitter"; }
...
public:
    ...
    const char* getType() const override { return "SkLineEmitter"; }
...
public:
    ...
    void visitFields(SkFieldVisitor* v) {
        ...
        v->enterObject("Emitter");
        v->visit(nullptr, fEmitter);
        v->exitObject();
    }
};
...
public:
    ...
    void visit(const char* name, sk_sp<SkParticleEmitter>& e) override {
...
public:
    ...
    void visit(const char* name, sk_sp<SkParticleEmitter>& e) override {
        ...
        if (strcmp(type, "SkCircleEmitter") == 0) {
            e.reset(new SkCircleEmitter());
        } else if (strcmp(type, "SkLineEmitter") == 0) {
            e.reset(new SkLineEmitter());
        }
