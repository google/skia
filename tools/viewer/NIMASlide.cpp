...
void NIMAActorImage::drawVerticesObject(SkCanvas* canvas, bool useBones) const {
...
Vec2D NIMAActorImage::deform(const Vec2D& position, uint32_t* boneIdx, float* boneWgt) const {
