...
class SkiaDesktopPage(page_module.Page):
  ...
  def __init__(self, url, page_set):
    ...
    self.archive_data_file = 'data/skia_yahoonews_desktop.json'
...
class SkiaYahoonewsDesktopPageSet(story.StorySet):
  """ Pages designed to represent the median, not highly optimized web """

  def __init__(self):
    super(SkiaYahoonewsDesktopPageSet, self).__init__(
