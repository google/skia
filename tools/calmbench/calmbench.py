...
def parse_args():
    ...
    default_skiadir = os.path.expanduser('~/skia/skia')
    ...
    definitions = [
        ...
        ['--ninjadir',  str, 'out/Clang', 'default: %(default)s'],
...
def main():
    ...
    orig_ruby_name = os.path.dirname(__file__) + "/" + RUBY_SCRIPT
    temp_ruby_name = args.writedir + "/" + RUBY_SCRIPT
    subprocess.call(['cp', orig_ruby_name, temp_ruby_name])
