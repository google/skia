...
Json::Value SkDrawShadowCommand::toJSON(UrlDataManager& urlDataManager) const {
    ...
    bool transparentOcc = SkToBool(fShadowRec.fFlags & SkShadowFlags::kTransparentOccluder_ShadowFlag);
    ...
    store_bool(&result, SKDEBUGCANVAS_SHADOWFLAG_TRANSPARENT_OCC, transparentOcc, false);
