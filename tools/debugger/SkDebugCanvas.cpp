...
void SkDebugCanvas::onDrawEdgeAAQuad(const SkRect& rect, const SkPoint clip[], int clipCount,
                                     SkCanvas::QuadAAFlags aa, SkColor color, SkBlendMode mode) {
    this->addDrawCommand(new SkDrawEdgeAAQuadCommand(rect, clip, clipCount, aa, color, mode));
}
