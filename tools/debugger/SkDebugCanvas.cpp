...
void SkDebugCanvas::onDrawImageSet(const SkCanvas::ImageSetEntry set[], int cnt, float alpha,
                                   SkFilterQuality filterQuality, SkBlendMode mode) {
    this->addDrawCommand(new SkDrawImageSetCommand(set, cnt, alpha, filterQuality, mode));
}
