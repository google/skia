...
static const struct {
    ...
    { "commandbuffer_es2",       "gpu", "api=commandbuffer_es2" },
    { "commandbuffer_es3",       "gpu", "api=commandbuffer_es3" },
    { "commandbuffer_es3_msaa4", "gpu", "api=commandbuffer_es3,samples=4" },
    { "mock",                    "gpu", "api=mock" },
#ifdef SK_DAWN
    { "dawn",                    "gpu", "api=dawn" },
#endif
...
static bool parse_option_gpu_api(const SkString&                      value,
    ...
    *outFakeGLESVersion2 = false;
    ...
    if (value.equals("commandbuffer_es2")) {
        *outContextType = GrContextFactory::kCommandBuffer_ES2_ContextType;
        return true;
    }
    if (value.equals("commandbuffer_es3")) {
