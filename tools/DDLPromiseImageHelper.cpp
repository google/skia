...
sk_sp<SkData> DDLPromiseImageHelper::deflateSKP(SkPicture* inputPicture) {
    SkSerialProcs procs;
...
sk_sp<SkPicture> DDLPromiseImageHelper::reinflateSKP(SkDeferredDisplayListRecorder* recorder,
