...
DEFINE_double(duration, 0.0, "The total duration, in seconds, of the animation we are drawing.");
DEFINE_double(frame, 0.0, "A double value in [0, 1] that specifies the point in animation to draw.");
