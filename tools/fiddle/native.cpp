...
public:
    GLXProcGetter() {
        fGetCurrentContext = (GLXGetCurrentContextProc) dlsym(fLoader.handle(), "eglXGetCurrentContext");
        fGetProcAddress = (GLXGetProcAddressProc) dlsym(fLoader.handle(), "eglXGetProcAddress");
    }
