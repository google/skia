...
// callback is executed with the absolute path of all files in the given directory.
...
listFiles(options.resources, (absPath) => {
  resourceListing.push(path.relative(resourceBaseDir, absPath));
});
