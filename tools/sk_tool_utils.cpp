...
void add_to_text_blob_w_len(SkTextBlobBuilder* builder, const char* text, size_t len,
    ...
    glyphs.append(font.textToGlyphs(text, len, static_cast<SkTextEncoding>(paint.getTextEncoding()),
                                    nullptr, 0));
    font.textToGlyphs(text, len, static_cast<SkTextEncoding>(paint.getTextEncoding()),
