...
#define CONST 1
#define FRIEND 2   // either friend or static
#define BLANK  0
#define ANY -1
...
const struct OperatorParser {
    ...
    { DEFOP::kUnknown, "??", "???", },
    { DEFOP::kAdd,     "+",  "add",    FRIEND, OpType::kThis,   OpMod::kNone,         BLANK,
    ...
    { DEFOP::kEqual,   "==", "equal",  FRIEND, OpType::kBool,   OpMod::kNone,         BLANK,
                                    {{ CONST,  OpType::kThis,   OpMod::kReference, },
                                     { CONST,  OpType::kThis,   OpMod::kReference, }}},
    { DEFOP::kEqual,   "==", "equal",  BLANK,  OpType::kBool,   OpMod::kNone,         CONST,
                                    {{ CONST,  OpType::kThis,   OpMod::kReference, }}},
    ...
    { DEFOP::kMultiply, "*", "multiply", FRIEND, OpType::kThis, OpMod::kNone,         BLANK,
                                    {{ CONST,  OpType::kThis,   OpMod::kReference, },
                                     { CONST,  OpType::kThis,   OpMod::kReference, }}},
    { DEFOP::kMultiplyBy, "*=", "multiplyby", BLANK,  OpType::kVoid, OpMod::kReference, BLANK,
                                    {{ BLANK,  OpType::kScalar, OpMod::kNone, }}},
    { DEFOP::kNew,     "new", "new",   BLANK,  OpType::kVoid,   OpMod::kPointer,      BLANK,
                                    {{ BLANK,  OpType::kSizeT,  OpMod::kNone, }}},
    { DEFOP::kNotEqual, "!=", "notequal", FRIEND, OpType::kBool,   OpMod::kNone,         BLANK,
                                    {{ CONST,  OpType::kThis,   OpMod::kReference, },
                                     { CONST,  OpType::kThis,   OpMod::kReference, }}},
    { DEFOP::kNotEqual, "!=", "notequal", BLANK,  OpType::kBool,   OpMod::kNone,         CONST,
                                    {{ CONST,  OpType::kThis,   OpMod::kReference, }}},
    { DEFOP::kSubtract, "-", "subtract", FRIEND, OpType::kThis, OpMod::kNone,         BLANK,
                                    {{ CONST,  OpType::kThis,   OpMod::kReference, },
                                     { CONST,  OpType::kThis,   OpMod::kReference, }}},
...
bool Definition::parseOperator(size_t doubleColons, string& result) {
    ...
    iParser.skipWhiteSpace();
    bool isFriend = iParser.skipExact("friend") || iParser.skipExact("static");
    iParser.skipWhiteSpace();
    iParser.skipExact("SK_API");
    iParser.skipWhiteSpace();
    bool returnsConst = iParser.skipExact("const");
    SkASSERT(isFriend == false || returnsConst == false);
    iParser.skipWhiteSpace();
    ...
    const char* namePtr = iParser.fChar;
    ...
    for (auto parser : opData) {
        ...
        if (parser.fFriend != ANY && ((parser.fFriend == FRIEND && !isFriend) ||
                (parser.fFriend == CONST && !returnsConst))) {
            continue;
        }
