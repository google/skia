...
bool IncludeParser::parseDefine(Definition* child) {
    // could be nothing, e.g. #define foo
    // or a const, e.g. #define foo 3
    // or an alias, e.g. #define foo bar
    // or a method, e.g. #define foo(x) x
