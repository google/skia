        ...
        if (!found && 'f' == word[0] && isupper(word[1])) {
            ...
            // look for word as member of class or struct
                        ...
                        if (globals.fRefMap.end() != defIter) {
                            found = true;
                            SkAssertResult(globals.fLinkMap.end()
    ...
    switch (def->fMarkType) {
        ...
        case MarkType::kPopulate: {
            ...
            if (MarkType::kCode == parent->fMarkType) {
                ...
                fMethod = iMethod;
                NameMap paramMap;
                paramMap.fParent = &def->fParent->fParent->asRoot()->fNames;
                fNames = &paramMap;
