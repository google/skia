...
bool BmhParser::endTableColumn(const char* end, const char* terminator) {
    ...
    fColumn->fContentEnd = end;
    fColumn->fTerminator = terminator;
    fColStart = fChar - 1;
    this->skipSpace();
            ...
            if (this->peek() == fMC) {
                ...
                if (this->peek() != fMC) {
                    if (MarkType::kColumn == fParent->fMarkType) {
                        ...
                        fRow->fContentEnd = fColumn->fContentEnd;
                        fColumn = nullptr;
                        fRow = nullptr;
                ...
                if (TableState::kColumnStart == fTableState) {
                    ...
                    fColumn = &fMarkup.front();
                    fColumn->fName = fParent->fName;
                    fColumn->fContentStart = fChar;
                    this->setAsParent(fColumn);
