...
private:
    void catalog(Definition* example, const char* stdOutStart,
        const char* stdOutEnd);
    bool parseFiddles();
    void stdOutCheck(Definition* example, const char* stdOutStart,
        const char* stdOutEnd);
    BmhParser* fBmhParser;  // must be writable; writes example hash
    void (FiddleParser::*fExampleHandler)(Definition* example, const char* stdOutStart,
        const char* stdOutEnd);
