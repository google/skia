...
static bool IncompleteAllowed(MarkType markType) { 
...
public:
    ...
    string incompleteMessage() const;
...
public:
    ...
    static constexpr const char* kGeneratedSubtopics[] = {
        kClassesAndStructs, kConstants, kConstructors, kDefines,
