...
public:
    ...
    string codeBlock(const Definition& def) const {
        return codeBlock(def.fMarkType, def.fName);
    }

    string codeBlock(MarkType markType, string name) const {
    ...
    string writeCodeBlock(const Definition&, MarkType ) const;
    string writeCodeBlock(TextParser& i, MarkType ) const;
