...
public:
    ...
    string loweredTopic(string name, Definition* def, NameMap* );
    string memberName();
    string methodName();
    ...
    void setUpPartialSubstitute(string name, NameMap* );
    void setUpSubstitute(string name, Definition* def, NameMap*);
