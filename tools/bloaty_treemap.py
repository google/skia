...
#   bloaty <path_to_binary> -d compileunits,symbols -n 0 --tsv > bloaty.out
# -or-
#   bloaty <path_to_binary> -d compileunits,fullsymbols -n 0 --tsv > bloaty.out
#
# Then:
#   python bloaty_treemap.py bloaty.out > bloaty.html
#
