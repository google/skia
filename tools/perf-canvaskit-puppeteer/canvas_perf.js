...
tests.push({
    name: 'Get and set the color to a paint',
    setup: function(CanvasKit, ctx) {
...
tests.push({
    name: 'Set the color to a paint by components',
    setup: function(CanvasKit, ctx) {
        ctx.paint = new CanvasKit.SkPaint();
    },
    test: function(CanvasKit, ctx) {
...
tests.push({
    name: 'Draw a shadow with tonal colors',
    setup: function(CanvasKit, ctx) {
        ctx.canvas = ctx.surface.getCanvas();
...
// TODO(nifong): handle tests that have data depedencies such as test images.

// 3x3 matrix ops
tests.push({
    name: 'Multiply 3x3 matrices together',
    setup: function(CanvasKit, ctx) {
...
tests.push({
    name: 'Transform a point using a matrix (mapPoint)',
    setup: function(CanvasKit, ctx) {
...
tests.push({
    name: 'Create a shader from a 3x3 matrix',
    setup: function(CanvasKit, ctx) {
        ctx.matr = CanvasKit.SkMatrix.multiply(
            CanvasKit.SkMatrix.rotated(Math.PI/2, 10, 20),
            CanvasKit.SkMatrix.scaled(1, 2, 3, 4),
    ...
    test: function(CanvasKit, ctx) {
        ctx.shader = CanvasKit.SkShader.MakeSweepGradient(
            100, 100,
...
tests.push({
    name: 'Multiply 4x4 matrices together',
    setup: function(CanvasKit, ctx) {
...
tests.push({
    name: 'Concat 4x4 matrix on a canvas',
    setup: function(CanvasKit, ctx) {
...
tests.push({
    name: 'Mltiply DOM matrices together',
    setup: function(CanvasKit, ctx) {
...
tests.push({
    name: 'Transform a point using a matrix (transformPoint)',
    setup: function(CanvasKit, ctx) {
...
tests.push({
    name: 'make a shader from a DOMMatrix',
    setup: function(CanvasKit, ctx) {
        ctx.matr = new DOMMatrix().translate(10, 20).rotate(90).translate(-10, -20)
            .multiply(new DOMMatrix().translate(3, 4).scale(1, 2).translate(-3, -4));
    },
