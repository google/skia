...
for (const skp_name of skp_names) {
    if (SIMD_DATA[skp_name] && RELEASE_DATA[skp_name]) {
        ...
        comparisonData[commonSKPDataCount] = {
            skp_name,
...
const simd_average_frame = simd_frame_average_accumulator / commonSKPDataCount;
const simd_skps_median_frame = simd_frame_median_accumulator / commonSKPDataCount;
const release_average_frame = release_frame_average_accumulator / commonSKPDataCount;
const release_median_frame = release_frame_median_accumulator / commonSKPDataCount;
