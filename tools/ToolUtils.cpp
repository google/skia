...
const char* colortype_name(SkColorType ct) {
    switch (ct) {
        ...
        case kA16_flt_SkColorType:            return "A16_flt";
        ...
        case kR16G16_flt_SkColorType:         return "R16G16_flot";
...
const char* colortype_depth(SkColorType ct) {
    switch (ct) {
        ...
        case kA16_flt_SkColorType:            return "AF16";
        ...
        case kR16G16_flt_SkColorType:         return "F16F16";
