...
public:
    ...
    GrContext* grContext() { return fGrContext1.get(); }
...
private:
    ...
    GrVkExtensions fExtensions1;
    VkPhysicalDeviceFeatures2 fFeatures1 = {};
    VkDebugReportCallbackEXT fDebugCallback1 = VK_NULL_HANDLE;
    PFN_vkDestroyDebugReportCallbackEXT fDestroyDebugCallback1 = nullptr;
    GrVkBackendContext fBackendContext1;
