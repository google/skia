...
#define DECLARE_VK_PROC(name) PFN_vk##name f1Vk##name
...
public:
    ...
    bool init(sk_sp<GrContext>);

    GrContext* getGrContext();

    sk_sp<SkImage> createI420Image(int width, int height);
...
private:
    ...
    VkDevice fDevice1 = VK_NULL_HANDLE;

    PFN_vkDestroyDebugReportCallbackEXT fDestroyDebugCallback1 = nullptr;

    GrVkBackendContext fBackendContext;
    sk_sp<GrContext> fGrContext;

    VkImage fImage1 = VK_NULL_HANDLE;
    VkDeviceMemory fImageMemory1 = VK_NULL_HANDLE;
