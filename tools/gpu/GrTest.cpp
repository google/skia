...
void GrRenderTargetContextPriv::testingOnly_addDrawOp(GrOp::OpOwner op) {
...
#define DRAW_OP_TEST_EXTERN(Op) \
    extern GrOp::OpOwner Op##__Test(GrPaint&&, SkRandom*, \
...
void GrDrawRandomOp(SkRandom* random, GrRenderTargetContext* renderTargetContext, GrPaint&& paint) {
    ...
    using MakeDrawOpFn = GrOp::OpOwner (GrPaint&&, SkRandom*,
                                        GrRecordingContext*, int numSamples);
