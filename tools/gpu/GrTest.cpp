...
void SetupAlwaysEvictAtlas(GrContext* context) {
    ...
    configs[kA8_GrMaskFormat].fStartNumPlotsX = 1;
    configs[kA8_GrMaskFormat].fStartNumPlotsY = 1;
    configs[kA8_GrMaskFormat].fMaxNumPlotsX = 1;
    configs[kA8_GrMaskFormat].fMaxNumPlotsY = 1;

    configs[kA8_GrMaskFormat].fLog2Width1 = SkNextLog2(dim);
    configs[kA8_GrMaskFormat].fLog2Height1 = SkNextLog2(dim);

    //--
    configs[kA565_GrMaskFormat].fPlotWidth = dim;
    configs[kA565_GrMaskFormat].fPlotHeight = dim;
    configs[kA565_GrMaskFormat].fStartNumPlotsX = 1;
    configs[kA565_GrMaskFormat].fStartNumPlotsY = 1;
    configs[kA565_GrMaskFormat].fMaxNumPlotsX = 1;
    configs[kA565_GrMaskFormat].fMaxNumPlotsY = 1;

    configs[kA565_GrMaskFormat].fLog2Width1 = SkNextLog2(dim);
    configs[kA565_GrMaskFormat].fLog2Height1 = SkNextLog2(dim);

    //--
    configs[kARGB_GrMaskFormat].fPlotWidth = dim;
    configs[kARGB_GrMaskFormat].fPlotHeight = dim;
    configs[kARGB_GrMaskFormat].fStartNumPlotsX = 1;
    configs[kARGB_GrMaskFormat].fStartNumPlotsY = 1;
    configs[kARGB_GrMaskFormat].fMaxNumPlotsX = 1;
    configs[kARGB_GrMaskFormat].fMaxNumPlotsY = 1;

    configs[kARGB_GrMaskFormat].fLog2Width1 = SkNextLog2(dim);
    configs[kARGB_GrMaskFormat].fLog2Height1 = SkNextLog2(dim);
