...
int GrCCPathCacheEntry::testingOnly_getOnFlushRefCnt() const { return fOnFlushRefCnt; }

int GrCCCachedAtlas::testingOnly_getOnFlushRefCnt() const { return fOnFlushRefCnt; }
