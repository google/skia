...
/**
 * Helper to allocate SkPixmaps for a SkYUVASpec. Pixmaps are valid so long as YUVAPixmaps is
 * alive.
 */
class YUVAPixmaps {
public:
...
private:
    SkYUVASpec fSpec;
    SkPixmap fPlanes[SkYUVASpec::kMaxPlanes];
