...
public:
     ...
     * unfinished flushes active on the GPU at a time. If we have 2 outstandig flushes then we will
...
private:
    ...
    sk_sp<SubmitFinishTracker> fFinishTrackers[kMaxFrameLag - 1];
    int fCurrentSubmitIdx = 0;
