...
public:
    ...
    /**
     * Like make makeCurrent() but this returns an object that will restore the previous current
     ...
     */
    SkScopeExit<std::function<void()>> SK_WARN_UNUSED_RESULT makeCurrentAndAutoRestore() const;
