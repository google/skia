...
public:
    ...
    static nxtSwapChainImplementation Create(sk_sp<const GrGLInterface> glInterface) {
...
nxtSwapChainImplementation NXTGLWindowContext::createSwapChainImplementation(int width, int height, const DisplayParams& params) {
