...
- (void)mouseDown:(NSEvent *)event {
    ...
    fWindow->onMouse(pos.x, pos.y, Window::kDown_InputState,
                     get_modifiers(event));
}
...
- (void)mouseUp:(NSEvent *)event {
    const NSPoint pos = [event locationInWindow];
    fWindow->onMouse(pos.x, pos.y, Window::kUp_InputState,
                     get_modifiers(event));
}

- (void)mouseMoved:(NSEvent *)event {
    const NSPoint pos = [event locationInWindow];
    fWindow->onMouse(pos.x, pos.y, Window::kMove_InputState,
                     get_modifiers(event));
}
