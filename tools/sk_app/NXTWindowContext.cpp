...
NXTWindowContext::NXTWindowContext(const DisplayParams& params)
...
void NXTWindowContext::initializeContext(int width, int height) {
    ...
    fSwapChain.Configure(nxt::TextureFormat::R8G8B8A8Unorm, nxt::TextureUsageBit::OutputAttachment, width, height);
...
sk_sp<SkSurface> NXTWindowContext::getBackbufferSurface() {
    ...
    imageInfo.fFormat = NXT_TEXTURE_FORMAT_R8_G8_B8_A8_UNORM; // FIXME
...
void NXTWindowContext::resize(int w, int h) {
    ...
    fSwapChain.Configure(nxt::TextureFormat::R8G8B8A8Unorm, nxt::TextureUsageBit::OutputAttachment, fWidth, fHeight);
}
