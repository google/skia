...
sk_sp<GrDawnBackendContext> DawnGLWindowContext_win::onInitializeContext() {
    HDC dc = GetDC(fHWND);
    ...
    ProcGetter getter;
    dawnDevice backendDevice = dawn_native::opengl::CreateDevice(ProcGetter::getProcAddress);
