...
namespace backend {
    namespace vulkan {
        ...
        dawnSwapChainImplementation CreateNativeSwapChainImpl(dawnDevice device, uint64_t surface);
...
dawnSwapChainImplementation NXTVulkanWindowContext_xlib::createSwapChainImplementation(int width, int height, const DisplayParams& params) {
