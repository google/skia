...
int main(int argc, char** const argv) {
    ...
    for (auto entry : sorted) {
        ...
        for (char c : "mlqkcz") {
            ...
            switch (c) {
                case 'm':
                    if ("1" != count) SkDebugf("moves: %s  ", count);
                    break;
                case 'l':
                    if ("0" != count) SkDebugf("lines: %s  ", count);
                    break;
                case 'q':
                    if ("0" != count) SkDebugf("quads: %s  ", count);
                    break;
                case 'k':
                    if ("0" != count) SkDebugf("conics: %s  ", count);
                    break;
                case 'c':
                    if ("0" != count) SkDebugf("cubics: %s  ", count);
                    break;
                case 'z':
                    if ("1" != count) SkDebugf("closes: %s  ", count);
                    break;
                case '\0':
                    break;
                default:
