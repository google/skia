...
def make_apk(architectures,
    ...
    os.chdir('platform_tools/android')  # Why does gradlew need to be called fromthis directory?
...
def main():
    ...
    final_output_dir = os.path.abspath(os.environ.get('SKQP_OUTPUT_DIR', default_build))
