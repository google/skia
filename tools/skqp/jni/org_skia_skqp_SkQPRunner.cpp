...
void Java_org_skia_skqp_SkQPRunner_nInit(JNIEnv* env, jobject object, jobject assetManager,
    ...
    array = env->NewObjectArray((jint)gBackends.size(), gStringClass, nullptr);
    ...
    array = env->NewObjectArray((jint)gGMs.size(), gStringClass, nullptr);
    ...
    array = env->NewObjectArray((jint)gUnitTests.size(), gStringClass, nullptr);
