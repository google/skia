...
void drawBG(SkCanvas* canvas) {
    ...
    auto rad = SkGradientShader::MakeRadial(
        SkPoint::Make(128, 128), 128, radColors, nullptr, 3, SkTileMode::kClamp);

    SkMatrix rotMtx; rotMtx.setRotate(-90, 128, 128);
    SkColor sweepColors[] = {
        0xFFFF00FF, 0xFFFF0000, 0xFFFFFF00, 0xFF00FF00, 0xFF00FFFF, 0xFF0000FF, 0xFFFF00FF };
