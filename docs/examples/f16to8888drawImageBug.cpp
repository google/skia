...
void draw(SkCanvas* canvas) {
    ...
    SkImageInfo imageInfo = SkImageInfo::Make(100, 100, kRGBA_F16_SkColorType, kPremul_SkAlphaType,
        colorSpace);
    ...
    SkImageInfo imageInfo2 = SkImageInfo::Make(100, 100, kN32_SkColorType, kPremul_SkAlphaType,
        colorSpace2);
