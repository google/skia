...
//  const float top = scale - 1;
  ...
  path.arcTo(scaled_endcap_radius - 1, scaled_endcap_radius - 1, 90, SkPath::kSmall_ArcSize,
      SkPathDirection::kCCW, scaled_endcap_radius - 1, bottom - 1 - scaled_endcap_radius);
  //path.rLineTo(0, -1);
  ...
  // top right
  path.arcTo(scaled_endcap_radius + 1, scaled_endcap_radius + 1, 90, SkPath::kSmall_ArcSize,
      SkPathDirection::kCW, right - scaled_endcap_radius + 1, scaled_endcap_radius + 1);
...
SkPath GetInteriorPath(float scale,
                       const SkISize& size,
                       float endcap_width,
  ...
  right_path.arcTo(scaled_endcap_radius, scaled_endcap_radius, 90, SkPath::kSmall_ArcSize, 
      SkPathDirection::kCW, right - scaled_endcap_radius, bottom - scaled_endcap_radius);
