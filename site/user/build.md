...
### *Highly Recommended*: Bulid with clang-cl
...
If you installed the prebuilt LLVM downloaded from [here](http://releases.llvm.org/download.html "LLVM Download") in the default location that would be:
