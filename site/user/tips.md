...
1.  Subclass `SkDevice`
    ...
    redirected to a graphics backend via the `SkDevice` with which it is 
    initialized. See [Creating SkCanvas Objects](./api/creating_skcanvas) for
    examples of currently supported backends.
