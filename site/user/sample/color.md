...
<span id="limits">Why is Skia Color Correct?</span>
...
<span id="limits">Skia Architecture for Color Correctness</span>
...
The transfer function is actually free on GPU!  GPU hardware can transform to/from linear values on
reads/writes.

<span id="limits">Best Practices for Color Correct Skia</span>
...
**SkColor** (stored on **SkPaint**) is assumed to be in the sRGB color space - nothing extra to do
here.  **SkShaders** (also stored on **SkPaint**) can be used to create more complex colors.
...
<span id="limits">Opting In To Color Correct Skia</span>
...
<tr><td>Null</td>                <td>Non-null</td> <td>n/a</td>     <td>Undefined</td></tr>
<tr><td>Non-null</td>            <td>Null</td> <td>expand</td>      <td>Legacy Skia</td></tr>
<tr><td>Null</td>                <td>Null</td> <td>expand</td>      <td>Legacy Skia</td></tr>
</table>
