...
<table style='border-collapse: collapse' class='td_const tr_const td2_const' >
  ...
  <tr>
    ...
    <td>1</td>
    <td><a href="Opaque">Opaque</a></td>    <td>Pixels are opaque. The <a href="#Color_Type">Color Type</a> must have no explicit alpha
component, or all alpha components must be set to their maximum value.
  ...
  <tr>
    ...
    <td>2</td>
    <td><a href="Premul">Premul</a></td>    <td>Pixels have <a href="SkColor_Reference#Alpha">Alpha</a> <a href="undocumented#Premultiply">Premultiplied</a> into color components.
<a href="SkSurface_Reference#Surface">Surface</a> pixels must be <a href="undocumented#Premultiply">Premultiplied</a>.
  ...
  <tr>
    ...
    <td>3</td>
    <td><a href="Unpremul">Unpremul</a></td>    <td><a href="undocumented#Pixel">Pixel</a> color component values are independent of alpha value.
...
encoding format and size is unknown.
  ...
  <tr>
    ...
    <td>1</td>
    <td><a href="Alpha_8">Alpha_8</a></td>    <td>Stores 8-bit byte pixel encoding that represents transparency. Value of zero
is completely transparent; a value of 255 is completely opaque.
  ...
  <tr>
    ...
    <td>2</td>
    <td><a href="RGB_565">RGB_565</a></td>    <td>Stores 16-bit word pixel encoding that contains five bits of blue,
six bits of green, and five bits of red.
  ...
  <tr>
    ...
    <td>3</td>
    <td><a href="ARGB_4444">ARGB_4444</a></td>    <td>Stores 16-bit word pixel encoding that contains four bits of alpha,
four bits of blue, four bits of green, and four bits of red.
  ...
  <tr>
    ...
    <td>4</td>
    <td><a href="RGBA_8888">RGBA_8888</a></td>    <td>Stores 32-bit word pixel encoding that contains eight bits of red,
eight bits of green, eight bits of blue, and eight bits of alpha.
  ...
  <tr>
    ...
    <td>5</td>
    <td><a href="RGB_888">RGB_888</a></td>    <td>Stores 32-bit word pixel encoding that contains eight bits of red,
eight bits of green, eight bits of blue, and eight unused bits.
  ...
  <tr>
    ...
    <td>6</td>
    <td><a href="BGRA_8888">BGRA_8888</a></td>    <td>Stores 32-bit word pixel encoding that contains eight bits of blue,
eight bits of green, eight bits of red, and eight bits of alpha.
  ...
  <tr>
    ...
    <td>7</td>
    <td><a href="RGBA_1010102">RGBA_1010102</a></td>    <td>Stores 32-bit word pixel encoding that contains ten bits of red,
ten bits of green, ten bits of blue, and two bits of alpha.
  ...
  <tr>
    ...
    <td>8</td>
    <td><a href="RGB_101010">RGB_101010</a></td>    <td>Stores 32-bit word pixel encoding that contains ten bits of red,
ten bits of green, ten bits of blue, and two unused bits.
  ...
  <tr>
    ...
    <td>9</td>
    <td><a href="Gray_8">Gray_8</a></td>    <td>Stores 8-bit byte pixel encoding that equivalent to equal values for red,
blue, and green, representing colors from black to white.
  ...
  <tr>
    ...
    <td>10</td>
    <td><a href="RGBA_F16">RGBA_F16</a></td>    <td>Stores 64-bit word pixel encoding that contains 16 bits of blue,
