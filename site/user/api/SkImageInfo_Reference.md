...
<th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>Description</th></tr>
  ...
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkImageSourceChannel'>SkImageSourceChannel</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>readable channels in image source</td>
  </tr>
  <tr>
  ...
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#kA_SkImageSourceChannel'>kA_SkImageSourceChannel</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>image <a href='SkColor_Reference#Alpha'>Alpha</a> channel</td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
  ...
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#kB_SkImageSourceChannel'>kB_SkImageSourceChannel</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>image blue channel</td>
  </tr>
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#kG_SkImageSourceChannel'>kG_SkImageSourceChannel</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>image green channel</td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
  ...
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#kLastEnum_SkImageSourceChannel'>kLastEnum_SkImageSourceChannel</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>last valid value</td>
  </tr>
  <tr>
  ...
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#kR_SkImageSourceChannel'>kR_SkImageSourceChannel</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>image red channel</td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
...
## <a name='Image_Source_Channel'>Image Source Channel</a>

## <a name='SkImageSourceChannel'>Enum SkImageSourceChannel</a>

<pre style="padding: 1em 1em 1em 1em;width: 62.5em; background-color: #f0f0f0">
enum <a href='#SkImageSourceChannel'>SkImageSourceChannel</a> {
    <a href='#kR_SkImageSourceChannel'>kR_SkImageSourceChannel</a>,
    <a href='#kG_SkImageSourceChannel'>kG_SkImageSourceChannel</a>,
    <a href='#kB_SkImageSourceChannel'>kB_SkImageSourceChannel</a>,
    <a href='#kA_SkImageSourceChannel'>kA_SkImageSourceChannel</a>,
    <a href='#kLastEnum_SkImageSourceChannel'>kLastEnum_SkImageSourceChannel</a> = <a href='#kA_SkImageSourceChannel'>kA_SkImageSourceChannel</a>,
};
</pre>
...
<th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>Description</th></tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a name='kR_SkImageSourceChannel'><code>kR_SkImageSourceChannel</code></a></td>
    <td style='text-align: center; border: 2px solid #dddddd; padding: 8px; '>0</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>
image red channel</td>
  </tr>
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a name='kG_SkImageSourceChannel'><code>kG_SkImageSourceChannel</code></a></td>
    <td style='text-align: center; border: 2px solid #dddddd; padding: 8px; '>1</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>
image green channel</td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a name='kB_SkImageSourceChannel'><code>kB_SkImageSourceChannel</code></a></td>
    <td style='text-align: center; border: 2px solid #dddddd; padding: 8px; '>2</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>
image blue channel</td>
  </tr>
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a name='kA_SkImageSourceChannel'><code>kA_SkImageSourceChannel</code></a></td>
    <td style='text-align: center; border: 2px solid #dddddd; padding: 8px; '>3</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>
image Alpha channel</td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a name='kLastEnum_SkImageSourceChannel'><code>kLastEnum_SkImageSourceChannel</code></a></td>
    <td style='text-align: center; border: 2px solid #dddddd; padding: 8px; '>3</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>
Used by tests to iterate through all valid values.
</td>
...
<th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>Description</th></tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkYUVAIndex_fChannel'>fChannel</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>channel selector for ARGB component</td>
  </tr>
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkYUVAIndex_fIndex'>fIndex</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>image source index</td>
  </tr>
</table>
...
Describes which image source and channel to read for each YUV and <a href='SkColor_Reference#Alpha'>Alpha</a> plane.
<a href='#SkYUVAIndex'>SkYUVAIndex</a> contains a index for which image source to read from and a enum for
...
<th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>Description</th></tr>
  <tr style='background-color: #f0f0f0; '>
    ...
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>
Describes which image source to read from.

If from zero to three, defines which image source to read from. If -1, denotes
that the image source doesn't exist. Each YUV plane always has an image source.
<a href='SkColor_Reference#Alpha'>Alpha</a> plane image is optional.
</td>
  </tr>
  <tr>
    ...
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>
Describes which ARGB channel to read from.
</td>
  </tr>
</table>
