...
<table style='border-collapse: collapse' class='td_const tr_const td2_const' >
  ...
  <tr>
    ...
    <td>0</td>
    <td><a href="#Alpha_Type">Alpha Type</a> is uninitialized.
</td>
  </tr>
  <tr>
    <td><a name="kOpaque_SkAlphaType"> <code><strong>kOpaque_SkAlphaType </strong></code> </a></td>
    <td>1</td>
    <td>Pixels are opaque. The <a href="#Color_Type">Color Type</a> must have no explicit alpha
component, or all alpha components must be set to their maximum value.
  ...
  <tr>
    ...
    <td>2</td>
    <td>Pixels have <a href="SkColor_Reference#Alpha">Alpha</a> <a href="undocumented#Premultiply">Premultiplied</a> into color components.
<a href="SkSurface_Reference#Surface">Surface</a> pixels must be <a href="undocumented#Premultiply">Premultiplied</a>.
  ...
  <tr>
    ...
    <td>3</td>
    <td><a href="undocumented#Pixel">Pixel</a> color component values are independent of alpha value.
...
<a href="SkSurface_Reference#Surface">Surface</a> pixels.
  ...
  <tr>
    ...
    <td>3</td>
    <td>Used by tests to iterate through all valid values.

### See Also

<a href="#kLastEnum_SkColorType">kLastEnum_SkColorType</a>
...
<table style='border-collapse: collapse' class='td_const tr_const td2_const' >
  ...
  <tr>
    ...
    <td>0</td>
    <td><a href="#Color_Type">Color Type</a> is set to <a href="#kUnknown_SkColorType">kUnknown_SkColorType</a> by default. If set,
...
<a href="#kLastEnum_SkAlphaType">kLastEnum_SkAlphaType</a>
  ...
  <tr>
    ...
    <td>1</td>
    <td>Stores 8-bit byte pixel encoding that represents transparency. Value of zero is
...
incomplete
  ...
  <tr>
    ...
    <td>2</td>
    <td>Stores 16-bit word pixel encoding that contains five bits of blue,
six bits of green, and five bits of red. Pixels are fully opaque as if its
...
![kRGB_565_SkColorType](https://fiddle.skia.org/i/f5981f4d2337dc5b6ee2d1d0c2a05078_raster.png "")
...
incomplete
  ...
  <tr>
    ...
    <td>3</td>
    <td>Stores 16-bit word pixel encoding that contains four bits of alpha,
four bits of blue, four bits of green, and four bits of red.

![kARGB_4444_SkColorType](https://fiddle.skia.org/i/0441bdba65a19aa72b75b7fa62d22121_raster.png "")
...
incomplete
  ...
  <tr>
    ...
    <td>4</td>
    <td>Stores 32-bit word pixel encoding that contains eight bits of red,
eight bits of green, eight bits of blue, and eight bits of alpha.

![kRGBA_8888_SkColorType](https://fiddle.skia.org/i/4ccd35f27fe73dce8cce8c75e18df23c_raster.png "")
...
incomplete
  ...
  <tr>
    ...
    <td>5</td>
    <td>Stores 32-bit word pixel encoding that contains eight bits of red,
eight bits of green, eight bits of blue, and eight unused bits. Is fully
opaque as if its <a href="SkColor_Reference#Alpha">Color Alpha</a> was set to one, and should always be paired with
<a href="#kOpaque_SkAlphaType">kOpaque_SkAlphaType</a>.

![kRGB_888x_SkColorType](https://fiddle.skia.org/i/fecfe58c25cfc1b1e411e5eb50f7d8d1_raster.png "")
...
<div><fiddle-embed name="4260d6cc15db2c60c07f6fdc8d9ae425"></fiddle-embed></div>
  ...
  <tr>
    ...
    <td>6</td>
    <td>Stores 32-bit word pixel encoding that contains eight bits of blue,
eight bits of green, eight bits of red, and eight bits of alpha.

![kBGRA_8888_SkColorType](https://fiddle.skia.org/i/babd0e12db21a88c74d4e88aa40268ab_raster.png "")
...
incomplete
  ...
  <tr>
    ...
    <td>7</td>
    <td>Stores 32-bit word pixel encoding that contains ten bits of red,
...
![kRGBA_1010102_SkColorType](https://fiddle.skia.org/i/6c470410001ad8f1ee9f58204c66f1bb_raster.png "")
...
incomplete
  ...
  <tr>
    ...
    <td>8</td>
    <td>Stores 32-bit word pixel encoding that contains ten bits of red,
ten bits of green, ten bits of blue, and two unused bits.  Is fully
...
![kRGB_101010x_SkColorType](https://fiddle.skia.org/i/c22477b11dabaa3e3a0b5bb33a7733cd_raster.png "")
...
incomplete
  ...
  <tr>
    ...
    <td>9</td>
    <td>Stores 8-bit byte pixel encoding that equivalent to equal values for red,
blue, and green, representing colors from black to white.  Is fully
opaque as if its <a href="SkColor_Reference#Alpha">Color Alpha</a> was set to one, and should always be paired with
<a href="#kOpaque_SkAlphaType">kOpaque_SkAlphaType</a>.
...
incomplete
  ...
  <tr>
    ...
    <td>10</td>
    <td>Stores 64-bit word pixel encoding that contains 16 bits of blue,
...
![kRGBA_F16_SkColorType](https://fiddle.skia.org/i/9344796c059ff5e4f057595e781905b3_raster.png "")
...
<table style='border-collapse: collapse' class='td_const tr_const td2_const' >
  ...
  <tr>
    ...
    <td>4</td>
    <td>Encodes <a href="SkColor_Reference#ARGB">Color ARGB</a> as either <a href="#kRGBA_8888_SkColorType">kRGBA_8888_SkColorType</a> or
...
<table style='border-collapse: collapse' class='td_const tr_const td2_const' >
  ...
  <tr>
    ...
    <td>0</td>
    <td>Describes standard JPEG color space;
<a href="https://en.wikipedia.org/wiki/Rec._601">CCIR 601</a> with full range of 0 to 255 for components.
  ...
  <tr>
    ...
    <td>1</td>
    <td>Describes standard used by standard definition television;
<a href="https://en.wikipedia.org/wiki/Rec._601">CCIR 601</a> with studio range of 16 to 235 range for components.
  ...
  <tr>
    ...
    <td>2</td>
    <td>Describes standard used by high definition television;
