...
correct parents.
If you run <a href="bmh_usingBookmaker?cl=9919#Bookmaker">Bookmaker</a> inside <a href="bmh_usingBookmaker?cl=9919#Visual_Studio">Visual_Studio</a>, you can click on errors and it
...
writing out/dir/obj/<a href="bmh_usingBookmaker?cl=9919#bmh_SkXXX">bmh_SkXXX</a>.md.
Error checking includes: undefined references, fiddle compiler errors,
missing or mismatched printf output.
Again, you can click on any errors inside <a href="bmh_usingBookmaker?cl=9919#Visual_Studio">Visual_Studio</a>.
...
# <a name="Bugs"></a> Bugs
x underlines not removed when links are created
x regular words made links if they are the same as method names -- add () to keep as method
structs not discovered in include parse
typedefs not associated with enums
...
check that all methods have one line descriptions in overview
       check that method name if all lower has ()
