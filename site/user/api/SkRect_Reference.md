...
Returns constructed <a href='SkRect_Reference#SkRect'>SkRect</a> set to (0, 0, <a href='#SkRect_MakeSize_size'>size</a>.<a href='#SkRect_width'>width()</a>, <a href='#SkRect_MakeSize_size'>size</a>.<a href='#SkRect_height'>height()</a>). Does not
...
Sets to bounds of  <a href='SkPath_Reference#Point_Array'>SkPoint array</a>array with <a href='#SkRect_setBounds_count'>count</a> entries. If <a href='#SkRect_setBounds_count'>count</a> is zero or smaller,
or if  <a href='SkPath_Reference#Point_Array'>SkPoint array</a>array contains an infinity or NaN, sets to (0, 0, 0, 0).
...
Sets to bounds of  <a href='SkPath_Reference#Point_Array'>SkPoint array</a>array with <a href='#SkRect_setBoundsCheck_count'>count</a> entries. Returns false if <a href='#SkRect_setBoundsCheck_count'>count</a> is
zero or smaller, or if  <a href='SkPath_Reference#Point_Array'>SkPoint array</a>array contains an infinity or NaN; in these cases
...
Sets to bounds of  <a href='SkPath_Reference#Point_Array'>SkPoint array</a>array with <a href='#SkRect_set_3_count'>count</a> entries. If <a href='#SkRect_set_3_count'>count</a> is zero or smaller,
or if  <a href='SkPath_Reference#Point_Array'>SkPoint array</a>array contains an infinity or NaN, sets <a href='SkRect_Reference#SkRect'>SkRect</a> to (0, 0, 0, 0).
