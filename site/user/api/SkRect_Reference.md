...
Returns constructed <a href='#SkRect'>SkRect</a> set to (0, 0, 0, 0).
...
Returns constructed <a href='#SkRect'>SkRect</a> set to <a href='undocumented#SkScalar'>SkScalar</a> values (0, 0, <a href='#SkRect_MakeWH_w'>w</a>, <a href='#SkRect_MakeWH_h'>h</a>). Does not
validate input; <a href='#SkRect_MakeWH_w'>w</a> or <a href='#SkRect_MakeWH_h'>h</a> may be negative.

Passing integer values may generate a compiler warning since <a href='#SkRect'>SkRect</a> cannot
...
<table>  <tr>    <td><a name='SkRect_MakeWH_w'><code><strong>w</strong></code></a></td>
    <td><a href='undocumented#SkScalar'>SkScalar</a> width of constructed <a href='#SkRect'>SkRect</a></td>
  </tr>
  <tr>    <td><a name='SkRect_MakeWH_h'><code><strong>h</strong></code></a></td>
    <td><a href='undocumented#SkScalar'>SkScalar</a> height of constructed <a href='#SkRect'>SkRect</a></td>
  </tr>
</table>
...
Returns constructed <a href='#SkRect'>SkRect</a> set to integer values (0, 0, <a href='#SkRect_MakeIWH_w'>w</a>, <a href='#SkRect_MakeIWH_h'>h</a>). Does not validate
...
<table>  <tr>    <td><a name='SkRect_MakeIWH_w'><code><strong>w</strong></code></a></td>
    <td>integer width of constructed <a href='#SkRect'>SkRect</a></td>
  </tr>
  <tr>    <td><a name='SkRect_MakeIWH_h'><code><strong>h</strong></code></a></td>
    <td>integer height of constructed <a href='#SkRect'>SkRect</a></td>
  </tr>
</table>
...
Returns constructed <a href='#SkRect'>SkRect</a> set to (0, 0, <a href='#SkRect_MakeSize_size'>size</a>.width(), <a href='#SkRect_MakeSize_size'>size</a>.height()). Does not
validate input; <a href='#SkRect_MakeSize_size'>size</a>.width() or <a href='#SkRect_MakeSize_size'>size</a>.height() may be negative.

### Parameters

<table>  <tr>    <td><a name='SkRect_MakeSize_size'><code><strong>size</strong></code></a></td>
    <td><a href='undocumented#SkScalar'>SkScalar</a> values for <a href='#SkRect'>SkRect</a> width and height</td>
  </tr>
</table>

### Return Value

bounds (0, 0, <a href='#SkRect_MakeSize_size'>size</a>.width(), <a href='#SkRect_MakeSize_size'>size</a>.height())
...
Returns constructed <a href='#SkRect'>SkRect</a> set to (<a href='#SkRect_MakeLTRB_l'>l</a>, <a href='#SkRect_MakeLTRB_t'>t</a>, <a href='#SkRect_MakeLTRB_r'>r</a>, <a href='#SkRect_MakeLTRB_b'>b</a>). Does not sort input; <a href='#SkRect'>SkRect</a> may
...
Returns constructed <a href='SkIRect_Reference#SkIRect'>SkIRect</a> set to (0, 0, <a href='#SkRect_Make_size'>size</a>.width(), <a href='#SkRect_Make_size'>size</a>.height()).
Does not validate input; <a href='#SkRect_Make_size'>size</a>.width() or <a href='#SkRect_Make_size'>size</a>.height() may be negative.
...
bounds (0, 0, <a href='#SkRect_Make_size'>size</a>.width(), <a href='#SkRect_Make_size'>size</a>.height())
...
to or greater than <a href='#SkRect_fBottom'>fBottom</a>. Call sort() to reverse rectangles with negative
width() or height().
...
to or less than <a href='#SkRect_fBottom'>fBottom</a>. Call sort() to reverse rectangles with negative
width() or height().
...
Returns left edge of <a href='#SkRect'>SkRect</a>, if sorted. Call <a href='#SkRect_isSorted'>isSorted</a>() to see if <a href='#SkRect'>SkRect</a> is valid.
Call sort() to reverse <a href='#SkRect_fLeft'>fLeft</a> and <a href='#SkRect_fRight'>fRight</a> if needed.
...
Returns top edge of <a href='#SkRect'>SkRect</a>, if sorted. Call <a href='#SkRect_isEmpty'>isEmpty</a>() to see if <a href='#SkRect'>SkRect</a> may be invalid,
and sort() to reverse <a href='#SkRect_fTop'>fTop</a> and <a href='#SkRect_fBottom'>fBottom</a> if needed.
...
Returns right edge of <a href='#SkRect'>SkRect</a>, if sorted. Call <a href='#SkRect_isSorted'>isSorted</a>() to see if <a href='#SkRect'>SkRect</a> is valid.
Call sort() to reverse <a href='#SkRect_fLeft'>fLeft</a> and <a href='#SkRect_fRight'>fRight</a> if needed.
...
Returns bottom edge of <a href='#SkRect'>SkRect</a>, if sorted. Call <a href='#SkRect_isEmpty'>isEmpty</a>() to see if <a href='#SkRect'>SkRect</a> may be invalid,
and sort() to reverse <a href='#SkRect_fTop'>fTop</a> and <a href='#SkRect_fBottom'>fBottom</a> if needed.
...
Returns span on the x-axis. This does not check if <a href='#SkRect'>SkRect</a> is sorted, or if
...
Returns span on the y-axis. This does not check if <a href='#SkRect'>SkRect</a> is sorted, or if
result fits in 32-bit float; result may be negative or infinity.
...
Returns average of left edge and right edge. Result does not change if <a href='#SkRect'>SkRect</a>
is sorted. Result may overflow to infinity if <a href='#SkRect'>SkRect</a> is far from the origin.
...
Returns average of top edge and bottom edge. Result does not change if <a href='#SkRect'>SkRect</a>
is sorted.
...
<table>  <tr>    <td><a name='SkRect_equal_operator_a'><code><strong>a</strong></code></a></td>
    <td><a href='#SkRect'>SkRect</a> to compare</td>
  </tr>
...
Sets to bounds of <a href='SkPoint_Reference#SkPoint'>SkPoint</a> array with <a href='#SkRect_setBounds_count'>count</a> entries. If <a href='#SkRect_setBounds_count'>count</a> is zero or smaller,
or if <a href='SkPoint_Reference#SkPoint'>SkPoint</a> array contains an infinity or NaN, sets to (0, 0, 0, 0).
...
<table>  <tr>    <td><a name='SkRect_setBounds_pts'><code><strong>pts</strong></code></a></td>
    <td><a href='SkPoint_Reference#SkPoint'>SkPoint</a> array</td>
  </tr>
...
Sets to bounds of <a href='SkPoint_Reference#SkPoint'>SkPoint</a> array with <a href='#SkRect_setBoundsCheck_count'>count</a> entries. Returns false if <a href='#SkRect_setBoundsCheck_count'>count</a> is
zero or smaller, or if <a href='SkPoint_Reference#SkPoint'>SkPoint</a> array contains an infinity or NaN; in these cases
sets <a href='#SkRect'>SkRect</a> to (0, 0, 0, 0).
...
contains infinity or NaN, all <a href='#SkRect'>SkRect</a> dimensions are set to NaN.
...
Sets <a href='#SkRect'>SkRect</a> to <a href='#SkRect_set()_src'>src</a>, promoting <a href='#SkRect_set()_src'>src</a> members from integer to <a href='undocumented#Scalar'>scalar</a>.
...
<table>  <tr>    <td><a name='SkRect_set_src'><code><strong>src</strong></code></a></td>
    <td>integer <a href='#SkRect'>SkRect</a></td>
  </tr>
</table>
...
Sets <a href='#SkRect'>SkRect</a> to (<a href='#SkRect_set_2_left'>left</a>, <a href='#SkRect_set_2_top'>top</a>, <a href='#SkRect_set_2_right'>right</a>, <a href='#SkRect_set_2_bottom'>bottom</a>).
...
Sets <a href='#SkRect'>SkRect</a> to (<a href='#SkRect_setLTRB_left'>left</a>, <a href='#SkRect_setLTRB_top'>top</a>, <a href='#SkRect_setLTRB_right'>right</a>, <a href='#SkRect_setLTRB_bottom'>bottom</a>).
...
Sets to bounds of <a href='SkPoint_Reference#SkPoint'>SkPoint</a> array with <a href='#SkRect_set_3_count'>count</a> entries. If <a href='#SkRect_set_3_count'>count</a> is zero or smaller,
or if <a href='SkPoint_Reference#SkPoint'>SkPoint</a> array contains an infinity or NaN, sets <a href='#SkRect'>SkRect</a> to (0, 0, 0, 0).
...
Sets bounds to the smallest <a href='#SkRect'>SkRect</a> enclosing <a href='SkPoint_Reference#SkPoint'>SkPoint</a> <a href='#SkRect_set_4_p0'>p0</a> and <a href='#SkRect_set_4_p1'>p1</a>. The result is
...
Sets <a href='#SkRect'>SkRect</a> to (0, 0, <a href='#SkRect_setWH_width'>width</a>, <a href='#SkRect_setWH_height'>height</a>). Does not validate input;
...
Sets <a href='#SkRect'>SkRect</a> to (<a href='#SkRect_iset()_left'>left</a>, <a href='#SkRect_iset()_top'>top</a>, <a href='#SkRect_iset()_right'>right</a>, <a href='#SkRect_iset()_bottom'>bottom</a>).
...
Sets <a href='#SkRect'>SkRect</a> to (0, 0, <a href='#SkRect_isetWH_width'>width</a>, <a href='#SkRect_isetWH_height'>height</a>).
...
Returns <a href='#SkRect'>SkRect</a> offset by (<a href='#SkRect_makeOffset_dx'>dx</a>, <a href='#SkRect_makeOffset_dy'>dy</a>).

If <a href='#SkRect_makeOffset_dx'>dx</a> is negative, <a href='#SkRect'>SkRect</a> returned is moved to the left.
If <a href='#SkRect_makeOffset_dx'>dx</a> is positive, <a href='#SkRect'>SkRect</a> returned is moved to the right.
If <a href='#SkRect_makeOffset_dy'>dy</a> is negative, <a href='#SkRect'>SkRect</a> returned is moved upward.
If <a href='#SkRect_makeOffset_dy'>dy</a> is positive, <a href='#SkRect'>SkRect</a> returned is moved downward.
...
<a href='#SkRect'>SkRect</a> offset on axes, with original width and height
...
Returns <a href='#SkRect'>SkRect</a>, inset by (<a href='#SkRect_makeInset_dx'>dx</a>, <a href='#SkRect_makeInset_dy'>dy</a>).

If <a href='#SkRect_makeInset_dx'>dx</a> is negative, <a href='#SkRect'>SkRect</a> returned is wider.
If <a href='#SkRect_makeInset_dx'>dx</a> is positive, <a href='#SkRect'>SkRect</a> returned is narrower.
If <a href='#SkRect_makeInset_dy'>dy</a> is negative, <a href='#SkRect'>SkRect</a> returned is taller.
If <a href='#SkRect_makeInset_dy'>dy</a> is positive, <a href='#SkRect'>SkRect</a> returned is shorter.
...
<a href='#SkRect'>SkRect</a> inset symmetrically left and right, top and bottom
...
Returns <a href='#SkRect'>SkRect</a>, outset by (<a href='#SkRect_makeOutset_dx'>dx</a>, <a href='#SkRect_makeOutset_dy'>dy</a>).

If <a href='#SkRect_makeOutset_dx'>dx</a> is negative, <a href='#SkRect'>SkRect</a> returned is narrower.
If <a href='#SkRect_makeOutset_dx'>dx</a> is positive, <a href='#SkRect'>SkRect</a> returned is wider.
If <a href='#SkRect_makeOutset_dy'>dy</a> is negative, <a href='#SkRect'>SkRect</a> returned is shorter.
If <a href='#SkRect_makeOutset_dy'>dy</a> is positive, <a href='#SkRect'>SkRect</a> returned is taller.
...
<a href='#SkRect'>SkRect</a> outset symmetrically left and right, top and bottom
...
Offsets <a href='#SkRect'>SkRect</a> by adding <a href='#SkRect_offset()_dx'>dx</a> to <a href='#SkRect_fLeft'>fLeft</a>, <a href='#SkRect_fRight'>fRight</a>; and by adding <a href='#SkRect_offset()_dy'>dy</a> to <a href='#SkRect_fTop'>fTop</a>, <a href='#SkRect_fBottom'>fBottom</a>.

If <a href='#SkRect_offset()_dx'>dx</a> is negative, moves <a href='#SkRect'>SkRect</a> to the left.
If <a href='#SkRect_offset()_dx'>dx</a> is positive, moves <a href='#SkRect'>SkRect</a> to the right.
If <a href='#SkRect_offset()_dy'>dy</a> is negative, moves <a href='#SkRect'>SkRect</a> upward.
If <a href='#SkRect_offset()_dy'>dy</a> is positive, moves <a href='#SkRect'>SkRect</a> downward.
...
Offsets <a href='#SkRect'>SkRect</a> by adding <a href='#SkRect_offset_2_delta'>delta</a>.<a href='SkPoint_Reference#SkPoint_fX'>fX</a> to <a href='#SkRect_fLeft'>fLeft</a>, <a href='#SkRect_fRight'>fRight</a>; and by adding <a href='#SkRect_offset_2_delta'>delta</a>.<a href='SkPoint_Reference#SkPoint_fY'>fY</a> to
<a href='#SkRect_fTop'>fTop</a>, <a href='#SkRect_fBottom'>fBottom</a>.

If <a href='#SkRect_offset_2_delta'>delta</a>.<a href='SkPoint_Reference#SkPoint_fX'>fX</a> is negative, moves <a href='#SkRect'>SkRect</a> to the left.
If <a href='#SkRect_offset_2_delta'>delta</a>.<a href='SkPoint_Reference#SkPoint_fX'>fX</a> is positive, moves <a href='#SkRect'>SkRect</a> to the right.
If <a href='#SkRect_offset_2_delta'>delta</a>.<a href='SkPoint_Reference#SkPoint_fY'>fY</a> is negative, moves <a href='#SkRect'>SkRect</a> upward.
If <a href='#SkRect_offset_2_delta'>delta</a>.<a href='SkPoint_Reference#SkPoint_fY'>fY</a> is positive, moves <a href='#SkRect'>SkRect</a> downward.

### Parameters

<table>  <tr>    <td><a name='SkRect_offset_2_delta'><code><strong>delta</strong></code></a></td>
    <td>added to <a href='#SkRect'>SkRect</a></td>
  </tr>
</table>
...
Offsets <a href='#SkRect'>SkRect</a> so that <a href='#SkRect_fLeft'>fLeft</a> equals <a href='#SkRect_offsetTo_newX'>newX</a>, and <a href='#SkRect_fTop'>fTop</a> equals <a href='#SkRect_offsetTo_newY'>newY</a>. width and height
are unchanged.

### Parameters

<table>  <tr>    <td><a name='SkRect_offsetTo_newX'><code><strong>newX</strong></code></a></td>
    <td>stored in <a href='#SkRect_fLeft'>fLeft</a>, preserving width()</td>
  </tr>
  <tr>    <td><a name='SkRect_offsetTo_newY'><code><strong>newY</strong></code></a></td>
    <td>stored in <a href='#SkRect_fTop'>fTop</a>, preserving height()</td>
  </tr>
</table>
...
Insets <a href='#SkRect'>SkRect</a> by (<a href='#SkRect_inset()_dx'>dx</a>, <a href='#SkRect_inset()_dy'>dy</a>).

If <a href='#SkRect_inset()_dx'>dx</a> is positive, makes <a href='#SkRect'>SkRect</a> narrower.
If <a href='#SkRect_inset()_dx'>dx</a> is negative, makes <a href='#SkRect'>SkRect</a> wider.
If <a href='#SkRect_inset()_dy'>dy</a> is positive, makes <a href='#SkRect'>SkRect</a> shorter.
If <a href='#SkRect_inset()_dy'>dy</a> is negative, makes <a href='#SkRect'>SkRect</a> taller.
...
Outsets <a href='#SkRect'>SkRect</a> by (<a href='#SkRect_outset()_dx'>dx</a>, <a href='#SkRect_outset()_dy'>dy</a>).

If <a href='#SkRect_outset()_dx'>dx</a> is positive, makes <a href='#SkRect'>SkRect</a> wider.
If <a href='#SkRect_outset()_dx'>dx</a> is negative, makes <a href='#SkRect'>SkRect</a> narrower.
If <a href='#SkRect_outset()_dy'>dy</a> is positive, makes <a href='#SkRect'>SkRect</a> taller.
If <a href='#SkRect_outset()_dy'>dy</a> is negative, makes <a href='#SkRect'>SkRect</a> shorter.
...
true if (<a href='#SkRect_contains()_x'>x</a>, <a href='#SkRect_contains()_y'>y</a>) is inside <a href='#SkRect'>SkRect</a>
...
Returns true if <a href='#SkRect'>SkRect</a> contains <a href='#SkRect_contains_2_r'>r</a>.
Returns false if <a href='#SkRect'>SkRect</a> is empty or <a href='#SkRect_contains_2_r'>r</a> is empty.

<a href='#SkRect'>SkRect</a> contains <a href='#SkRect_contains_2_r'>r</a> when <a href='#SkRect'>SkRect</a> area completely includes <a href='#SkRect_contains_2_r'>r</a> area.

### Parameters

<table>  <tr>    <td><a name='SkRect_contains_2_r'><code><strong>r</strong></code></a></td>
    <td><a href='#SkRect'>SkRect</a> contained</td>
  </tr>
</table>

### Return Value

true if all sides of <a href='#SkRect'>SkRect</a> are outside <a href='#SkRect_contains_2_r'>r</a>
...
Returns true if <a href='#SkRect'>SkRect</a> contains <a href='#SkRect_contains_3_r'>r</a>.
Returns false if <a href='#SkRect'>SkRect</a> is empty or <a href='#SkRect_contains_3_r'>r</a> is empty.

<a href='#SkRect'>SkRect</a> contains <a href='#SkRect_contains_3_r'>r</a> when <a href='#SkRect'>SkRect</a> area completely includes <a href='#SkRect_contains_3_r'>r</a> area.
...
true if all sides of <a href='#SkRect'>SkRect</a> are outside <a href='#SkRect_contains_3_r'>r</a>
...
Returns true if <a href='#SkRect'>SkRect</a> intersects <a href='#SkRect_intersect()_r'>r</a>, and sets <a href='#SkRect'>SkRect</a> to intersection.
Returns false if <a href='#SkRect'>SkRect</a> does not intersect <a href='#SkRect_intersect()_r'>r</a>, and leaves <a href='#SkRect'>SkRect</a> unchanged.

Returns false if either <a href='#SkRect_intersect()_r'>r</a> or <a href='#SkRect'>SkRect</a> is empty, leaving <a href='#SkRect'>SkRect</a> unchanged.
...
true if <a href='#SkRect_intersect()_r'>r</a> and <a href='#SkRect'>SkRect</a> have area in common
...
Constructs <a href='#SkRect'>SkRect</a> to intersect from (<a href='#SkRect_intersect_2_left'>left</a>, <a href='#SkRect_intersect_2_top'>top</a>, <a href='#SkRect_intersect_2_right'>right</a>, <a href='#SkRect_intersect_2_bottom'>bottom</a>). Does not sort
construction.

Returns true if <a href='#SkRect'>SkRect</a> intersects construction, and sets <a href='#SkRect'>SkRect</a> to intersection.
Returns false if <a href='#SkRect'>SkRect</a> does not intersect construction, and leaves <a href='#SkRect'>SkRect</a> unchanged.

Returns false if either construction or <a href='#SkRect'>SkRect</a> is empty, leaving <a href='#SkRect'>SkRect</a> unchanged.

### Parameters

<table>  <tr>    <td><a name='SkRect_intersect_2_left'><code><strong>left</strong></code></a></td>
    <td>x-axis minimum of constructed <a href='#SkRect'>SkRect</a></td>
  </tr>
  <tr>    <td><a name='SkRect_intersect_2_top'><code><strong>top</strong></code></a></td>
    <td>y-axis minimum of constructed <a href='#SkRect'>SkRect</a></td>
  </tr>
  <tr>    <td><a name='SkRect_intersect_2_right'><code><strong>right</strong></code></a></td>
    <td>x-axis maximum of constructed <a href='#SkRect'>SkRect</a></td>
  </tr>
  <tr>    <td><a name='SkRect_intersect_2_bottom'><code><strong>bottom</strong></code></a></td>
    <td>y-axis maximum of constructed <a href='#SkRect'>SkRect</a></td>
  </tr>
</table>

### Return Value

true if construction and <a href='#SkRect'>SkRect</a> have area in common
...
Returns true if <a href='#SkRect_intersect_3_a'>a</a> intersects <a href='#SkRect_intersect_3_b'>b</a>, and sets <a href='#SkRect'>SkRect</a> to intersection.
Returns false if <a href='#SkRect_intersect_3_a'>a</a> does not intersect <a href='#SkRect_intersect_3_b'>b</a>, and leaves <a href='#SkRect'>SkRect</a> unchanged.

Returns false if either <a href='#SkRect_intersect_3_a'>a</a> or <a href='#SkRect_intersect_3_b'>b</a> is empty, leaving <a href='#SkRect'>SkRect</a> unchanged.

### Parameters

<table>  <tr>    <td><a name='SkRect_intersect_3_a'><code><strong>a</strong></code></a></td>
    <td><a href='#SkRect'>SkRect</a> to intersect</td>
  </tr>
...
Constructs <a href='#SkRect'>SkRect</a> to intersect from (<a href='#SkRect_intersects()_left'>left</a>, <a href='#SkRect_intersects()_top'>top</a>, <a href='#SkRect_intersects()_right'>right</a>, <a href='#SkRect_intersects()_bottom'>bottom</a>). Does not sort
construction.

Returns true if <a href='#SkRect'>SkRect</a> intersects construction.
Returns false if either construction or <a href='#SkRect'>SkRect</a> is empty, or do not intersect.
...
Returns true if <a href='#SkRect'>SkRect</a> intersects <a href='#SkRect_intersects_2_r'>r</a>.
Returns false if either <a href='#SkRect_intersects_2_r'>r</a> or <a href='#SkRect'>SkRect</a> is empty, or do not intersect.
...
true if <a href='#SkRect_intersects_2_r'>r</a> and <a href='#SkRect'>SkRect</a> have area in common
...
Constructs <a href='#SkRect'>SkRect</a> to intersect from (<a href='#SkRect_join()_left'>left</a>, <a href='#SkRect_join()_top'>top</a>, <a href='#SkRect_join()_right'>right</a>, <a href='#SkRect_join()_bottom'>bottom</a>). Does not sort
construction.

Sets <a href='#SkRect'>SkRect</a> to the union of itself and the construction.

Has no effect if construction is empty. Otherwise, if <a href='#SkRect'>SkRect</a> is empty, sets
<a href='#SkRect'>SkRect</a> to construction.
...
Sets <a href='#SkRect'>SkRect</a> to the union of itself and <a href='#SkRect_join_2_r'>r</a>.

Has no effect if <a href='#SkRect_join_2_r'>r</a> is empty. Otherwise, if <a href='#SkRect'>SkRect</a> is empty, sets
<a href='#SkRect'>SkRect</a> to <a href='#SkRect_join_2_r'>r</a>.

### Parameters

<table>  <tr>    <td><a name='SkRect_join_2_r'><code><strong>r</strong></code></a></td>
    <td>expansion <a href='#SkRect'>SkRect</a></td>
  </tr>
</table>
...
Sets <a href='#SkRect'>SkRect</a> to the union of itself and <a href='#SkRect_joinNonEmptyArg_r'>r</a>.

Asserts if <a href='#SkRect_joinNonEmptyArg_r'>r</a> is empty and SK_DEBUG is defined.
If <a href='#SkRect'>SkRect</a> is empty, sets <a href='#SkRect'>SkRect</a> to <a href='#SkRect_joinNonEmptyArg_r'>r</a>.
...
May produce incorrect results if <a href='#SkRect'>SkRect</a> or <a href='#SkRect_joinPossiblyEmptyRect_r'>r</a> is empty.
...
Returns <a href='#SkRect'>SkRect</a> with <a href='#SkRect_fLeft'>fLeft</a> and <a href='#SkRect_fRight'>fRight</a> swapped if <a href='#SkRect_fLeft'>fLeft</a> is greater than <a href='#SkRect_fRight'>fRight</a>; and
...
Returns pointer to first <a href='undocumented#Scalar'>scalar</a> in <a href='#SkRect'>SkRect</a>, to treat it as an array with four
entries.
...
Writes <a href='undocumented#Text'>text</a> representation of <a href='#SkRect'>SkRect</a> to standard output. Set <a href='#SkRect_dump()_asHex'>asHex</a> to true to
...
Writes <a href='undocumented#Text'>text</a> representation of <a href='#SkRect'>SkRect</a> to standard output. The representation may be
directly compiled as C++ code. Floating <a href='SkPoint_Reference#Point'>point</a> values are written
with limited precision; it may not be possible to reconstruct original <a href='#SkRect'>SkRect</a>
from output.
