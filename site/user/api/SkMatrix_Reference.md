...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  ...
  <tr>
    <td><a name="SkMatrix_kIdentity_Mask"> <code><strong>SkMatrix::kIdentity_Mask </strong></code> </a></td>
    <td>0</td>
    <td></td>    <td>all bits clear if <a href="#Matrix">Matrix</a> is identity</td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kTranslate_Mask"> <code><strong>SkMatrix::kTranslate_Mask </strong></code> </a></td>
    <td>1</td>
    <td></td>    <td>set if <a href="#Matrix">Matrix</a> has translation</td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kScale_Mask"> <code><strong>SkMatrix::kScale_Mask </strong></code> </a></td>
    <td>2</td>
    <td></td>    <td>set if <a href="#Matrix">Matrix</a> has x or y scale</td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kAffine_Mask"> <code><strong>SkMatrix::kAffine_Mask </strong></code> </a></td>
    <td>4</td>
    <td></td>    <td>set if <a href="#Matrix">Matrix</a> skews or rotates</td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kPerspective_Mask"> <code><strong>SkMatrix::kPerspective_Mask </strong></code> </a></td>
    <td>8</td>
    <td></td>    <td>set if <a href="#Matrix">Matrix</a> has perspective</td>
  </tr>
</table>
...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  ...
  <tr>
    <td><a href="Matrix_MemberIndex"> <code><strong>MemberIndex </strong></code> </a></td>
    <td>#Const kMScaleX 0</td>
    <td>horizontal scale factor</td>
  <tr>
  <tr>
    <td><a href="Matrix_MemberIndex"> <code><strong>MemberIndex </strong></code> </a></td>
    <td>#Const kMSkewX 1</td>
    <td>horizontal skew factor</td>
  <tr>
  <tr>
    <td><a href="Matrix_MemberIndex"> <code><strong>MemberIndex </strong></code> </a></td>
    <td>#Const kMTransX 2</td>
    <td>horizontal translation</td>
  <tr>
  <tr>
    <td><a href="Matrix_MemberIndex"> <code><strong>MemberIndex </strong></code> </a></td>
    <td>#Const kMSkewY 3</td>
    <td>vertical skew factor</td>
  <tr>
  <tr>
    <td><a href="Matrix_MemberIndex"> <code><strong>MemberIndex </strong></code> </a></td>
    <td>#Const kMScaleY 4</td>
    <td>vertical scale factor</td>
  <tr>
  <tr>
    <td><a href="Matrix_MemberIndex"> <code><strong>MemberIndex </strong></code> </a></td>
    <td>#Const kMTransY 5</td>
    <td>vertical translation</td>
  <tr>
  <tr>
    <td><a href="Matrix_MemberIndex"> <code><strong>MemberIndex </strong></code> </a></td>
    <td>#Const kMPersp0 6</td>
    <td>input x perspective factor</td>
  <tr>
  <tr>
    <td><a href="Matrix_MemberIndex"> <code><strong>MemberIndex </strong></code> </a></td>
    <td>#Const kMPersp1 7</td>
    <td>input y perspective factor</td>
  <tr>
  <tr>
    <td><a href="Matrix_MemberIndex"> <code><strong>MemberIndex </strong></code> </a></td>
    <td>#Const kMPersp2 8</td>
    <td>perspective bias</td>
  <tr>
</table>
...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value&nbsp;</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkMatrix_kMScaleX"> <code><strong>SkMatrix::kMScaleX </strong></code> </a></td>
    <td>0</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kMSkewX"> <code><strong>SkMatrix::kMSkewX </strong></code> </a></td>
    <td>1</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kMTransX"> <code><strong>SkMatrix::kMTransX </strong></code> </a></td>
    <td>2</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kMSkewY"> <code><strong>SkMatrix::kMSkewY </strong></code> </a></td>
    <td>3</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kMScaleY"> <code><strong>SkMatrix::kMScaleY </strong></code> </a></td>
    <td>4</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kMTransY"> <code><strong>SkMatrix::kMTransY </strong></code> </a></td>
    <td>5</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kMPersp0"> <code><strong>SkMatrix::kMPersp0 </strong></code> </a></td>
    <td>6</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kMPersp1"> <code><strong>SkMatrix::kMPersp1 </strong></code> </a></td>
    <td>7</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kMPersp2"> <code><strong>SkMatrix::kMPersp2 </strong></code> </a></td>
    <td>8</td>
    <td></td>    <td></td>
  </tr>
</table>
...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value&nbsp;</th><th>Description</th></tr>
  <tr>
    <td><a href="Matrix_AffineIndex"> <code><strong>AffineIndex </strong></code> </a></td>
    <td>#Const kAScaleX 0</td>
    <td>horizontal scale factor</td>
  <tr>
  <tr>
    <td><a href="Matrix_AffineIndex"> <code><strong>AffineIndex </strong></code> </a></td>
    <td>#Const kASkewY 1</td>
    <td>vertical skew factor</td>
  <tr>
  <tr>
    <td><a href="Matrix_AffineIndex"> <code><strong>AffineIndex </strong></code> </a></td>
    <td>#Const kASkewX 2</td>
    <td>horizontal skew factor</td>
  <tr>
  <tr>
    <td><a href="Matrix_AffineIndex"> <code><strong>AffineIndex </strong></code> </a></td>
    <td>#Const kAScaleY 3</td>
    <td>vertical scale factor</td>
  <tr>
  <tr>
    <td><a href="Matrix_AffineIndex"> <code><strong>AffineIndex </strong></code> </a></td>
    <td>#Const kATransX 4</td>
    <td>horizontal translation</td>
  <tr>
  <tr>
    <td><a href="Matrix_AffineIndex"> <code><strong>AffineIndex </strong></code> </a></td>
    <td>#Const kATransY 5</td>
    <td>vertical translation</td>
  <tr>
</table>
...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value&nbsp;</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkMatrix_kAScaleX"> <code><strong>SkMatrix::kAScaleX </strong></code> </a></td>
    <td>0</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kASkewY"> <code><strong>SkMatrix::kASkewY </strong></code> </a></td>
    <td>1</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kASkewX"> <code><strong>SkMatrix::kASkewX </strong></code> </a></td>
    <td>2</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kAScaleY"> <code><strong>SkMatrix::kAScaleY </strong></code> </a></td>
    <td>3</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kATransX"> <code><strong>SkMatrix::kATransX </strong></code> </a></td>
    <td>4</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkMatrix_kATransY"> <code><strong>SkMatrix::kATransY </strong></code> </a></td>
    <td>5</td>
    <td></td>    <td></td>
  </tr>
</table>
...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value&nbsp;</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkMatrix_kFill_ScaleToFit"> <code><strong>SkMatrix::kFill_ScaleToFit </strong></code> </a></td>
    <td>0</td>
    <td></td>    <td>Computes <a href="#Matrix">Matrix</a> that scales in x and y independently, so that source <a href="SkRect_Reference#Rect">Rect</a> is
...
may change.
  ...
  <tr>
    <td><a name="SkMatrix_kStart_ScaleToFit"> <code><strong>SkMatrix::kStart_ScaleToFit </strong></code> </a></td>
    <td>1</td>
    <td></td>    <td>Computes <a href="#Matrix">Matrix</a> that maintains source <a href="SkRect_Reference#Rect">Rect</a> aspect ratio, mapping source <a href="SkRect_Reference#Rect">Rect</a>
...
of destination <a href="SkRect_Reference#Rect">Rect</a>.
  ...
  <tr>
    <td><a name="SkMatrix_kCenter_ScaleToFit"> <code><strong>SkMatrix::kCenter_ScaleToFit </strong></code> </a></td>
    <td>2</td>
    <td></td>    <td>Computes <a href="#Matrix">Matrix</a> that maintains source <a href="SkRect_Reference#Rect">Rect</a> aspect ratio, mapping source <a href="SkRect_Reference#Rect">Rect</a>
...
<a href="SkRect_Reference#Rect">Rect</a>.
  ...
  <tr>
    <td><a name="SkMatrix_kEnd_ScaleToFit"> <code><strong>SkMatrix::kEnd_ScaleToFit </strong></code> </a></td>
    <td>3</td>
    <td></td>    <td>Computes <a href="#Matrix">Matrix</a> that maintains source <a href="SkRect_Reference#Rect">Rect</a> aspect ratio, mapping source <a href="SkRect_Reference#Rect">Rect</a>
