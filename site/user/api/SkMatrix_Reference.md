...
| 1 | 0 | 0 |
| 0 | 1 | 0 |
| <a href="#SkMatrix_MakeTrans_dx">dx</a> | <a href="#SkMatrix_MakeTrans_dy">dy</a> | 1 |
...
|  <a href="#SkMatrix_I">I</a> |      |  |sets <a href="#Matrix">Matrix</a> to:
...
|  <a href="#SkMatrix_I">I</a> |   |  |   | GJ+HM+ GK+HN+ GL+HO+ |
...
|  <a href="#SkMatrix_I">I</a> |               | 0 0  1 |sets <a href="#Matrix">Matrix</a> to:
...
|  <a href="#SkMatrix_I">I</a> | | 0 0  1 |   |  G*<a href="#SkMatrix_preTranslate_dx">dx</a>+H*<a href="#SkMatrix_preTranslate_dy">dy</a>+<a href="#SkMatrix_I">I</a> |
...
|  <a href="#SkMatrix_I">I</a> |                       |  0  0  1 |wheredx = <a href="#SkMatrix_preScale_px">px</a> - <a href="#SkMatrix_preScale_sx">sx</a> * <a href="#SkMatrix_preScale_px">px</a>
dy = <a href="#SkMatrix_preScale_py">py</a> - <a href="#SkMatrix_preScale_sy">sy</a> * <a href="#SkMatrix_preScale_py">py</a>sets <a href="#Matrix">Matrix</a> to:
...
|  <a href="#SkMatrix_I">I</a> | |  0  0  1 |   | G*<a href="#SkMatrix_preScale_sx">sx</a> H*<a href="#SkMatrix_preScale_sy">sy</a> G*dx+H*dy+<a href="#SkMatrix_I">I</a> |
...
|  <a href="#SkMatrix_I">I</a> | |  0  0  1 |   | G*<a href="#SkMatrix_preScale_2_sx">sx</a> H*<a href="#SkMatrix_preScale_2_sy">sy</a> <a href="#SkMatrix_I">I</a> |
...
|  <a href="#SkMatrix_I">I</a> |                        | 0  0  1 |wherec  = cos(degrees)
s  = sin(degrees)
dx =  s * <a href="#SkMatrix_preRotate_py">py</a> + (1 - c) * <a href="#SkMatrix_preRotate_px">px</a>
dy = -s * <a href="#SkMatrix_preRotate_px">px</a> + (1 - c) * <a href="#SkMatrix_preRotate_py">py</a>sets <a href="#Matrix">Matrix</a> to:

|  <a href="undocumented#C">C</a> | | c -s dx |   | Ac+ -As+ A*dx+B*dy+<a href="undocumented#C">C</a> |
<a href="#Matrix">Matrix</a> *  = |  | | s  c dy | = | Dc+ -Ds+ D*dx+E*dy+ |
|  <a href="#SkMatrix_I">I</a> | | 0  0  1 |   | Gc+ -Gs+ G*dx+H*dy+<a href="#SkMatrix_I">I</a> |
...
|  <a href="#SkMatrix_I">I</a> |                        | 0  0 1 |wherec  = cos(degrees)
s  = sin(degrees)sets <a href="#Matrix">Matrix</a> to:

|  <a href="undocumented#C">C</a> | | c -s 0 |   | Ac+ -As+ <a href="undocumented#C">C</a> |
<a href="#Matrix">Matrix</a> *  = |  | | s  c 0 | = | Dc+ -Ds+ |
|  <a href="#SkMatrix_I">I</a> | | 0  0 1 |   | Gc+ -Gs+ <a href="#SkMatrix_I">I</a> |
...
|  <a href="#SkMatrix_I">I</a> |                       |  0  0  1 |wheredx = -<a href="#SkMatrix_preSkew_kx">kx</a> * <a href="#SkMatrix_preSkew_py">py</a>
dy = -<a href="#SkMatrix_preSkew_ky">ky</a> * <a href="#SkMatrix_preSkew_px">px</a>sets <a href="#Matrix">Matrix</a> to:
...
|  <a href="#SkMatrix_I">I</a> | |  0  0  1 |   | G+H*<a href="#SkMatrix_preSkew_ky">ky</a> G*<a href="#SkMatrix_preSkew_kx">kx</a>+ G*dx+H*dy+<a href="#SkMatrix_I">I</a> |
...
|  <a href="#SkMatrix_I">I</a> | |  0  0 1 |   | G+H*<a href="#SkMatrix_preSkew_2_ky">ky</a> G*<a href="#SkMatrix_preSkew_2_kx">kx</a>+ <a href="#SkMatrix_I">I</a> |
...
|  |               | 0 0  1 |sets <a href="#Matrix">Matrix</a> to:
...
|  |                       |  0  0  1 |wheredx = <a href="#SkMatrix_postScale_px">px</a> - <a href="#SkMatrix_postScale_sx">sx</a> * <a href="#SkMatrix_postScale_px">px</a>
dy = <a href="#SkMatrix_postScale_py">py</a> - <a href="#SkMatrix_postScale_sy">sy</a> * <a href="#SkMatrix_postScale_py">py</a>sets <a href="#Matrix">Matrix</a> to:
...
|  |                   | sx  0  0 |
<a href="#Matrix">Matrix</a> = |  |,wheresx = 1 / <a href="#SkMatrix_postIDiv_divx">divx</a>
sy = 1 / <a href="#SkMatrix_postIDiv_divy">divy</a>sets <a href="#Matrix">Matrix</a> to:
...
|  |                        | c -s dx |
<a href="#Matrix">Matrix</a> = |  |,   = | s  c dy |
|  |                        | 0  0  1 |wherec  = cos(degrees)
s  = sin(degrees)
dx =  s * <a href="#SkMatrix_postRotate_py">py</a> + (1 - c) * <a href="#SkMatrix_postRotate_px">px</a>
dy = -s * <a href="#SkMatrix_postRotate_px">px</a> + (1 - c) * <a href="#SkMatrix_postRotate_py">py</a>sets <a href="#Matrix">Matrix</a> to:
...
|  |                       |  0  0  1 |wheredx = -<a href="#SkMatrix_postSkew_kx">kx</a> * <a href="#SkMatrix_postSkew_py">py</a>
dy = -<a href="#SkMatrix_postSkew_ky">ky</a> * <a href="#SkMatrix_postSkew_px">px</a>sets <a href="#Matrix">Matrix</a> to:
