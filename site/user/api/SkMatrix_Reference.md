...
Sets <a href="#SkMatrix_invert_inverse">inverse</a> to reciprocal matrix, returning true if <a href="#Matrix">Matrix</a> is invertible.
...
maps from destination to source. If <a href="#Matrix">Matrix</a> is not invertible, <a href="#SkMatrix_invert_inverse">inverse</a> is
unchanged.
...
true if <a href="#Matrix">Matrix</a> is invertible
...
<div><fiddle-embed name="d2f5928a9381c437ccee868eb5eec4d2"></fiddle-embed></div>
...
Compares <a href="#SkMatrix_not_equal_operator_a">a</a> and <a href="#SkMatrix_not_equal_operator_b">b</a>; returns true if <a href="#SkMatrix_not_equal_operator_a">a</a> and <a href="#SkMatrix_not_equal_operator_b">b</a> are not umerically equal. Returns false
...
Returns true if <a href="#SkMatrix_getMinMaxScales_scaleFactors">scaleFactors</a> are computable; otherwise, returns false and sets
...
Returns true if <a href="#SkMatrix_decomposeScale_scale">scale</a> components are computable. <a href="#SkMatrix_decomposeScale_scale">scale</a> and <a href="#SkMatrix_decomposeScale_remaining">remaining</a> are
