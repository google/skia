...
Returns mean <a href="#SkMatrix_mapRadius_radius">radius</a> of closed curve formed by constructing <a href="undocumented#Circle">Circle</a> with <a href="#SkMatrix_mapRadius_radius">radius</a> at
origin, and mapping constructed <a href="undocumented#Circle">Circle</a> with <a href="#Matrix">Matrix</a>. Result is not meaningful
if <a href="#Matrix">Matrix</a> contains perspective elements.
