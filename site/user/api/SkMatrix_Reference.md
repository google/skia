...
| --- | ---  |
| <a href="#SkMatrix_notequal2_operator">operator!=(const SkMatrix& a, const SkMatrix& b)</a> | Returns true if members are unequal. |
| <a href="#SkMatrix_equal2_operator">operator==(const SkMatrix& a, const SkMatrix& b)</a> | Returns true if members are equal. |
| <a href="#SkMatrix_array_operator">operator[](int index)</a> const | Returns <a href="#Matrix">Matrix</a> value. |
| <a href="#SkMatrix_array_operator">operator[](int index)</a> | Returns writable reference to <a href="#Matrix">Matrix</a> value. |
...
<a href="#SkMatrix_array_operator">operator[](int index)</a> <a href="#SkMatrix_set">set</a>
...
x-coordinate of <a href="SkPoint_Reference#Point">Point</a> to map</td>
  </tr>  <tr>    <td><a name="SkMatrix_mapXY_y"> <code><strong>y </strong></code> </a></td> <td>
y-coordinate of <a href="SkPoint_Reference#Point">Point</a> to map</td>
...
<a href="#SkMatrix_equal2_operator">operator==(const SkMatrix& a, const SkMatrix& b)</a>

---

<a name="SkMatrix_equal2_operator"></a>
## operator==
...
Compares <a href="#SkMatrix_equal2_operator_a">a</a> and <a href="#SkMatrix_equal2_operator_b">b</a>; returns true if <a href="#SkMatrix_equal2_operator_a">a</a> and <a href="#SkMatrix_equal2_operator_b">b</a> are numerically equal. Returns true
...
<table>  <tr>    <td><a name="SkMatrix_equal2_operator_a"> <code><strong>a </strong></code> </a></td> <td>
<a href="#Matrix">Matrix</a> to compare</td>
  </tr>  <tr>    <td><a name="SkMatrix_equal2_operator_b"> <code><strong>b </strong></code> </a></td> <td>
<a href="#Matrix">Matrix</a> to compare</td>
  </tr>
</table>
...
<a href="#SkMatrix_cheapEqualTo">cheapEqualTo</a> <a href="#SkMatrix_notequal2_operator">operator!=(const SkMatrix& a, const SkMatrix& b)</a>

---

<a name="SkMatrix_notequal2_operator"></a>
## operator!=
...
Compares <a href="#SkMatrix_notequal2_operator_a">a</a> and <a href="#SkMatrix_notequal2_operator_b">b</a>; returns true if <a href="#SkMatrix_notequal2_operator_a">a</a> and <a href="#SkMatrix_notequal2_operator_b">b</a> are not numerically equal. Returns false
even if sign of zero values are different. Returns true if either <a href="#Matrix">Matrix</a>
contains <a href="undocumented#NaN">NaN</a>, even if the other <a href="#Matrix">Matrix</a> also contains <a href="undocumented#NaN">NaN</a>.

### Parameters

<table>  <tr>    <td><a name="SkMatrix_notequal2_operator_a"> <code><strong>a </strong></code> </a></td> <td>
<a href="#Matrix">Matrix</a> to compare</td>
  </tr>  <tr>    <td><a name="SkMatrix_notequal2_operator_b"> <code><strong>b </strong></code> </a></td> <td>
<a href="#Matrix">Matrix</a> to compare</td>
  </tr>
</table>
...
<a href="#SkMatrix_cheapEqualTo">cheapEqualTo</a> <a href="#SkMatrix_equal2_operator">operator==(const SkMatrix& a, const SkMatrix& b)</a>
...
modifications to <a href="#Matrix">Matrix</a> element reference returned by <a href="#SkMatrix_array_operator">operator[](int index)</a>.
...
<a href="#SkMatrix_array_operator">operator[](int index)</a> <a href="#SkMatrix_getType">getType</a>
