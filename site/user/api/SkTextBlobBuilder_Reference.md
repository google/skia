...
<a name='SkTextBlobBuilder'></a>Helper class for constructing <a href='SkTextBlob_Reference#SkTextBlob'>SkTextBlob</a>.
...
SkTextBlobBuilder uses <code>class</code> to declare the public data structures and interfaces.
<table style='border-collapse: collapse; width: 62.5em'>
<tr><th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>Class</th><th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>
Description</th></tr>
</table>
...
SkTextBlobBuilder can be constructed or initialized by these functions, including <code>class</code> constructors.
<table style='border-collapse: collapse; width: 62.5em'>
...
SkTextBlobBuilder uses member functions to read and modify structure properties.
<table style='border-collapse: collapse; width: 62.5em'>
...
SkTextBlobBuilder::RunBuffer contains members that may be read and written directly without using a member function.
<table style='border-collapse: collapse; width: 62.5em'>
