...
public:
    ...
    <a href='#SkPixmap_const_SkImageInfo_const_star'>SkPixmap(const SkImageInfo& info, const void* addr, size t rowBytes)</a>;
    ...
    void* <a href='#SkPixmap_writable_addr_2'>writable addr</a>(int x, int y) const;
