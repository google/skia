...
raster destiniations. <a href="SkCanvas_Reference#Canvas">Canvas</a> can not draw <a href="#Pixmap">Pixmap</a>, nor does <a href="#Pixmap">Pixmap</a> provide
...
| --- | ---  |
| <a href="#SkPixmap_addr">addr</a> |  |
| <a href="#SkPixmap_addr16">addr16</a> |  |
| <a href="#SkPixmap_addr32">addr32</a> |  |
| <a href="#SkPixmap_addr64">addr64</a> |  |
| <a href="#SkPixmap_addr8">addr8</a> |  |
| <a href="#SkPixmap_addrF16">addrF16</a> |  |
| <a href="#SkPixmap_alphaType">alphaType</a> |  |
| <a href="#SkPixmap_bounds">bounds</a> |  |
| <a href="#SkPixmap_colorSpace">colorSpace</a> |  |
| <a href="#SkPixmap_colorType">colorType</a> |  |
| <a href="#SkPixmap_computeIsOpaque">computeIsOpaque</a> |  |
| <a href="#SkPixmap_erase">erase</a> |  |
| <a href="#SkPixmap_extractSubset">extractSubset</a> |  |
| <a href="#SkPixmap_getColor">getColor</a> |  |
| <a href="#SkPixmap_getSafeSize">getSafeSize</a> |  |
| <a href="#SkPixmap_getSafeSize64">getSafeSize64</a> |  |
| <a href="#SkPixmap_getSize64">getSize64</a> |  |
| <a href="#SkPixmap_height">height</a> |  |
| <a href="#SkPixmap_info">info</a> |  |
| <a href="#SkPixmap_isOpaque">isOpaque</a> |  |
| <a href="#SkPixmap_readPixels">readPixels</a> |  |
| <a href="#SkPixmap_reset">reset</a> | Reuses existing <a href="#Pixmap">Pixmap</a> with replacement values. |
| <a href="#SkPixmap_rowBytes">rowBytes</a> |  |
| <a href="#SkPixmap_rowBytesAsPixels">rowBytesAsPixels</a> |  |
| <a href="#SkPixmap_scalePixels">scalePixels</a> |  |
| <a href="#SkPixmap_setColorSpace">setColorSpace</a> |  |
| <a href="#SkPixmap_shiftPerPixel">shiftPerPixel</a> |  |
| <a href="#SkPixmap_width">width</a> |  |
| <a href="#SkPixmap_writable_addr">writable addr</a> |  |
| <a href="#SkPixmap_writable_addr16">writable addr16</a> |  |
| <a href="#SkPixmap_writable_addr32">writable addr32</a> |  |
| <a href="#SkPixmap_writable_addr64">writable addr64</a> |  |
| <a href="#SkPixmap_writable_addr8">writable addr8</a> |  |
| <a href="#SkPixmap_writable_addrF16">writable addrF16</a> |  |
...
out of scope, its destructor does not affect <a href="#SkPixmap_addr">addr</a>.
...
<a href="undocumented#Mask">Mask</a> with pixels and their dimensions</td>
  </tr>
</table>

### Return Value

true if <a href="#SkPixmap_reset">reset</a> to <a href="undocumented#Mask">Mask</a> properties
...
Returns minimum memory required for pixel storage.
Does not include unused memory on last row when <a href="#SkPixmap_rowBytesAsPixels">rowBytesAsPixels</a> exceeds <a href="#SkPixmap_width">width</a>.
Returns zero if value is not representable as a signed 32 bit integer.
...
readable untyped pointer to pixel
...
readable unsigned 16-bit pointer to pixel at (<a href="#SkPixmap_addrF16_2_x">x</a>, <a href="#SkPixmap_addrF16_2_y">y</a>)
...
writable untyped base pointer to pixels
...
writable untyped pointer to pixel
...
writable untyped pointer to first component of pixel
...
<a href="#SkPixmap_readPixels_behavior">behavior</a> equalling <a href="#SkTransferFunctionBehavior_kRespect">SkTransferFunctionBehavior::kRespect</a> converts source
pixels to a linear space before converting to <a href="#SkPixmap_readPixels_dstInfo">dstInfo</a>; otherwise, source
