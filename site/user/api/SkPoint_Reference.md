...
| --- | ---  |
| <a href="#SkPoint">SkPoint</a> <a href="#SkPoint_multiply_operator">operator*(SkScalar scale)</a> const | Returns <a href="#Point">Point</a> multiplied by <a href="#SkPoint_scale">scale</a>. |
| <a href="#SkPoint">SkPoint</a> <a href="#SkPoint_minus_operator">operator-</a> const | Reverses sign of <a href="#Point">Point</a>. |
...
| <a href="SkPoint_Reference#SkVector">SkVector</a> <a href="#SkPoint_subtract_operator">operator-(const SkPoint& a, const SkVector& b)</a> | Returns <a href="SkPoint_Reference#Vector">Vector</a> between <a href="#Point">Points</a>. |
...
<a href="#SkPoint_minus_operator">operator-</a> <a href="#SkPoint_setAbs">setAbs</a>
...
<a href="#SkPoint_negate">negate</a> <a href="#SkPoint_subtract_operator">operator-(const SkPoint& a, const SkVector& b)</a> <a href="#SkPoint_subtractfrom_operator">operator-=(const SkVector& v)</a> <a href="#SkIPoint_minus_operator">SkIPoint::operator-()</a>
...
<a href="#SkPoint_offset">offset</a> <a href="#SkPoint_subtract_operator">operator-(const SkPoint& a, const SkVector& b)</a> <a href="#SkIPoint_minus_operator">SkIPoint::operator-</a>=(const <a href="SkIPoint_Reference#SkIPoint">SkIPoint</a>& <a href="#SkPoint_subtractfrom_operator_v">v</a>)
...
<a href="#SkPoint_multiply_operator">operator*(SkScalar scale)</a> <a href="#SkPoint_scale">scale</a> <a href="#SkPoint_setLength">setLength</a> <a href="#SkPoint_setNormalize">setNormalize</a>
...
<a href="#Point">Point</a> or <a href="SkPoint_Reference#Vector">Vector</a> to subtract from</td>
...
<pre style="padding: 1em 1em 1em 1em;width: 50em; background-color: #f0f0f0">
static SkScalar Normalize(SkVector* pt)
</pre>

Scales (pt-><a href="#SkPoint_fX">fX</a>, pt-><a href="#SkPoint_fY">fY</a>) so that <a href="#SkPoint_length">length</a> returns one, while preserving ratio of pt-><a href="#SkPoint_fX">fX</a> to pt-><a href="#SkPoint_fY">fY</a>,
if possible. If original <a href="#SkPoint_length">length</a> is nearly zero, sets <a href="#SkPoint_Normalize_pt">pt</a> to (0, 0) and returns zero;
otherswise, returns <a href="#SkPoint_length">length</a> of <a href="#SkPoint_Normalize_pt">pt</a> before <a href="#SkPoint_Normalize_pt">pt</a> is scaled.
...
original <a href="#SkPoint_Normalize_pt">pt</a> <a href="#SkPoint_length">length</a>
