...
| name | description |
| --- | --- |
| <a href="#SkPoint_Make">SkPoint::Make</a> | constructs from <a href="undocumented#SkScalar">SkScalar</a> inputs |

## <a name="Operators"></a> Operators

| name | description |
| --- | --- |
| <a href="#SkPoint_notequal_operator">SkPoint::operator!=(const SkPoint& a, const SkPoint& b)</a> | returns true if <a href="#Point">Point</a> are unequal |
| <a href="#SkPoint_multiply_operator">SkPoint::operator*(SkScalar scale) const</a> | returns <a href="#Point">Point</a> multiplied by scale |
| <a href="#SkPoint_multiplyby_operator">SkPoint::operator*=(SkScalar scale)</a> | multiplies <a href="#Point">Point</a> by scale factor |
| <a href="#SkPoint_add_operator">SkPoint::operator+(const SkPoint& a, const SkVector& b)</a> | returns <a href="#Point">Point</a> offset by <a href="SkPoint_Reference#Vector">Vector</a> |
| <a href="#SkPoint_addto_operator">SkPoint::operator+=(const SkVector& v)</a> | adds <a href="SkPoint_Reference#Vector">Vector</a> to <a href="#Point">Point</a> |
| <a href="#SkPoint_minus_operator">SkPoint::operator-() const</a> | reverses sign of <a href="#Point">Point</a> |
| <a href="#SkPoint_subtract_operator">SkPoint::operator-(const SkPoint& a, const SkPoint& b)</a> | returns <a href="SkPoint_Reference#Vector">Vector</a> between <a href="#Point">Points</a> |
| <a href="#SkPoint_subtractfrom_operator">SkPoint::operator-=(const SkVector& v)</a> | subtracts <a href="SkPoint_Reference#Vector">Vector</a> from <a href="#Point">Point</a> |
| <a href="#SkPoint_equal_operator">SkPoint::operator==(const SkPoint& a, const SkPoint& b)</a> | returns true if <a href="#Point">Point</a> are equal |

## <a name="Member_Functions"></a> Member Functions

| name | description |
| --- | --- |
| <a href="#SkPoint_CrossProduct">SkPoint::CrossProduct</a> | returns cross product |
| <a href="#SkPoint_Distance">SkPoint::Distance</a> | returns straight-line distance between points |
| <a href="#SkPoint_DotProduct">SkPoint::DotProduct</a> | returns dot product |
| <a href="#SkPoint_Length">SkPoint::Length</a> | returns straight-line distance to origin |
| <a href="#SkPoint_Make">SkPoint::Make</a> | constructs from <a href="undocumented#SkScalar">SkScalar</a> inputs |
| <a href="#SkPoint_Normalize">SkPoint::Normalize</a> | sets length to one, and returns prior length |
| <a href="#SkPoint_Offset">SkPoint::Offset</a> | translates <a href="#Point">Point</a> array |
| <a href="#SkPoint_cross">SkPoint::cross()</a> | returns cross product |
| <a href="#SkPoint_distanceToOrigin">SkPoint::distanceToOrigin</a> | returns straight-line distance to origin |
| <a href="#SkPoint_dot">SkPoint::dot()</a> | returns dot product |
| <a href="#SkPoint_equals">SkPoint::equals()</a> | returns true if <a href="#Point">Points</a> are equal |
| <a href="#SkPoint_isFinite">SkPoint::isFinite</a> | returns true if no member is infinite or NaN |
| <a href="#SkPoint_isZero">SkPoint::isZero</a> | returns true if both members equal zero |
| <a href="#SkPoint_iset">SkPoint::iset()</a> | sets to integer input |
| <a href="#SkPoint_length">SkPoint::length()</a> | returns straight-line distance to origin |
| <a href="#SkPoint_negate">SkPoint::negate()</a> | reverses the sign of both members |
| <a href="#SkPoint_normalize">SkPoint::normalize()</a> | sets length to one, preserving direction |
| <a href="#SkPoint_offset">SkPoint::offset()</a> | translates <a href="#Point">Point</a> |
| <a href="#SkPoint_scale">SkPoint::scale()</a> | multiplies <a href="#Point">Point</a> by scale factor |
| <a href="#SkPoint_set">SkPoint::set()</a> | sets to <a href="undocumented#SkScalar">SkScalar</a> input |
| <a href="#SkPoint_setAbs">SkPoint::setAbs</a> | sets sign of both members to positive |
| <a href="#SkPoint_setLength">SkPoint::setLength</a> | sets straight-line distance to origin |
| <a href="#SkPoint_setNormalize">SkPoint::setNormalize</a> | sets length to one, in direction of (x, y) |
| <a href="#SkPoint_x">SkPoint::x()</a> | returns <a href="#SkPoint_fX">fX</a> |
| <a href="#SkPoint_y">SkPoint::y()</a> | returns <a href="#SkPoint_fY">fY</a> |

## <a name="Members"></a> Members

| name | description |
| --- | --- |
| <a href="#SkPoint_fX">SkPoint::fX</a> | x-axis value |
| <a href="#SkPoint_fY">SkPoint::fY</a> | y-axis value |
