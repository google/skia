...
| <a href="#SkPoint">SkPoint</a> <a href="#SkPoint_add_operator">operator+(const SkPoint& a, const SkPoint& b)</a> | Returns <a href="#Point">Point</a> <a href="#SkPoint_offset">offset</a> by <a href="SkPoint_Reference#Vector">Vector</a>. |
| <a href="#SkPoint">SkPoint</a> <a href="#SkPoint_subtract_operator">operator-(const SkPoint& a, const SkPoint& b)</a> | Returns <a href="SkPoint_Reference#Vector">Vector</a> between <a href="#Point">Points</a>. |
...
| void <a href="#SkPoint_addto_operator">operator+=(const SkPoint& v)</a> | Offsets <a href="#Point">Point</a> by <a href="SkPoint_Reference#Vector">Vector</a>. |
| void <a href="#SkPoint_subtractfrom_operator">operator-=(const SkPoint& v)</a> | Offsets <a href="#Point">Point</a> opposite of <a href="SkPoint_Reference#Vector">Vector</a>. |
...
<a href="#SkPoint_offset">offset</a> <a href="#SkPoint_addto_operator">operator+=(const SkPoint& v)</a>
...
if possible. If prior <a href="#SkPoint_length">length</a> is nearly zero, sets <a href="#Point">Point</a> to (0, 0) and returns
...
Sets <a href="#Point">Point</a> to (<a href="#SkPoint_x">x</a>, <a href="#SkPoint_y">y</a>) scaled so <a href="#SkPoint_length">length</a> returns one, and so that
(<a href="#SkPoint_fX">fX</a>, <a href="#SkPoint_fY">fY</a>) is proportional to (<a href="#SkPoint_x">x</a>, <a href="#SkPoint_y">y</a>).  If <a href="SkPoint_Reference#Vector">Vector</a> (<a href="#SkPoint_x">x</a>, <a href="#SkPoint_y">y</a>) <a href="#SkPoint_length">length</a> is nearly zero,
sets <a href="#Point">Point</a> to (0, 0) and returns false; otherwise returns true.
...
<div><fiddle-embed name="8c7c2036332910122391c6a324d45f18"></fiddle-embed></div>
...
Scales <a href="#Point">Point</a> so that <a href="#SkPoint_distanceToOrigin">distanceToOrigin</a> returns <a href="#SkPoint_length">length</a>, if possible. If former
<a href="#SkPoint_length">length</a> is nearly zero, sets <a href="#Point">Point</a> to (0, 0) and return false; otherwise returns
true.
...
<div><fiddle-embed name="fb472837ae53149ad83f5151c815dda2"></fiddle-embed></div>
...
Sets <a href="#Point">Point</a> to (<a href="#SkPoint_x">x</a>, <a href="#SkPoint_y">y</a>) scaled to <a href="#SkPoint_length">length</a>, if possible. If former
<a href="#SkPoint_length">length</a> is nearly zero, sets <a href="#Point">Point</a> to (0, 0) and return false; otherwise returns
true.
...
<div><fiddle-embed name="d2caa84fc8ac2486b0719643914ff497"></fiddle-embed></div>
...
<a href="#SkPoint_multiply_operator">operator*(SkScalar scale)</a> <a href="#SkPoint_multiplyby_operator">operator*=(SkScalar scale)</a> <a href="#SkPoint_setLength">setLength</a>
