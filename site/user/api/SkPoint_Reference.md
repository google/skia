...
struct <a href='SkPoint_Reference#SkPoint'>SkPoint</a> {
    ...
    void void<a href='#SkPoint_addto_operator'>operator+=(const SkVector& v)</a>(const <a href='SkPoint_Reference#SkVector'>SkVector</a>& v);
    void void<a href='#SkPoint_subtractfrom_operator'>operator-=(const SkVector& v)</a>(const <a href='SkPoint_Reference#SkVector'>SkVector</a>& v);
    <a href='SkPoint_Reference#SkPoint'>SkPoint</a> SkPoint<a href='#SkPoint_multiply_operator'>operator*(SkScalar scale) const</a>(<a href='undocumented#SkScalar'>SkScalar</a> scale) const;
    <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& SkPoint<a href='#SkPoint_multiplyby_operator'>operator*=(SkScalar scale)</a>(<a href='undocumented#SkScalar'>SkScalar</a> scale);
    ...
    friend bool bool<a href='#SkPoint_equal_operator'>operator==(const SkPoint& a, const SkPoint& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& a, const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& b);
    friend bool bool<a href='#SkPoint_notequal_operator'>operator!=(const SkPoint& a, const SkPoint& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& a, const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& b);
    friend <a href='SkPoint_Reference#SkVector'>SkVector</a> SkVector<a href='#SkPoint_subtract_operator'>operator-(const SkPoint& a, const SkPoint& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& a, const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& b);
    friend <a href='SkPoint_Reference#SkPoint'>SkPoint</a> SkPoint<a href='#SkPoint_add_operator'>operator+(const SkPoint& a, const SkVector& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& a, const <a href='SkPoint_Reference#SkVector'>SkVector</a>& b);
...
<a href='#SkPoint_Offset_offset'>offset</a> offset<a href='#SkPoint_addto_operator'>operator+=(const SkVector& v)</a>(const <a href='SkPoint_Reference#SkVector'>SkVector</a>& v)
...
<a href='#SkPoint_offset'>offset</a> offset<a href='#SkPoint_addto_operator'>operator+=(const SkVector& v)</a>(const <a href='SkPoint_Reference#SkVector'>SkVector</a>& v)
...
<a href='#SkPoint_multiply_operator'>operator*(SkScalar scale) const</a>(<a href='undocumented#SkScalar'>SkScalar</a> <a href='#SkPoint_scale_scale'>scale</a>) const const<a href='#SkPoint_multiplyby_operator'>operator*=(SkScalar scale)</a>(<a href='undocumented#SkScalar'>SkScalar</a> <a href='#SkPoint_scale_scale'>scale</a>) <a href='#SkPoint_setLength'>setLength</a>
...
<a href='#SkPoint_multiply_operator'>operator*(SkScalar scale) const</a>(<a href='undocumented#SkScalar'>SkScalar</a> <a href='#SkPoint_scale'>scale</a>) const const<a href='#SkPoint_multiplyby_operator'>operator*=(SkScalar scale)</a>(<a href='undocumented#SkScalar'>SkScalar</a> <a href='#SkPoint_scale'>scale</a>) <a href='#SkPoint_setLength'>setLength</a>
...
<a href='#SkPoint_negate'>negate</a> negate<a href='#SkPoint_subtract_operator'>operator-(const SkPoint& a, const SkPoint& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& a, const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& b) b<a href='#SkPoint_subtractfrom_operator'>operator-=(const SkVector& v)</a>(const <a href='SkPoint_Reference#SkVector'>SkVector</a>& v) <a href='SkIPoint_Reference#SkIPoint'>SkIPoint</a>::operator-() const
...
<a href='#SkPoint_offset'>offset()</a> offset()<a href='#SkPoint_add_operator'>operator+(const SkPoint& a, const SkVector& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& a, const <a href='SkPoint_Reference#SkVector'>SkVector</a>& b) <a href='SkIPoint_Reference#SkIPoint'>SkIPoint</a>::SkIPoint<a href='#SkIPoint_addto_operator'>operator+=(const SkIVector& v)</a>(const <a href='SkIPoint_Reference#SkIVector'>SkIVector</a>& <a href='#SkPoint_addto_operator_v'>v</a>)
...
<a href='#SkPoint_offset'>offset()</a> offset()<a href='#SkPoint_subtract_operator'>operator-(const SkPoint& a, const SkPoint& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& a, const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& b) <a href='SkIPoint_Reference#SkIPoint'>SkIPoint</a>::SkIPoint<a href='#SkIPoint_subtractfrom_operator'>operator-=(const SkIVector& v)</a>(const <a href='SkIPoint_Reference#SkIVector'>SkIVector</a>& <a href='#SkPoint_subtractfrom_operator_v'>v</a>)
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
<a href='SkPoint_Reference#SkPoint'>SkPoint</a> SkPointoperator*(SkScalar scale)(<a href='undocumented#SkScalar'>SkScalar</a> scale)const
</pre>
...
<a href='#SkPoint_multiplyby_operator'>operator*=(SkScalar scale)</a>(<a href='undocumented#SkScalar'>SkScalar</a> <a href='#SkPoint_multiply_operator_scale'>scale</a>) <a href='#SkPoint_scale'>scale()</a> <a href='#SkPoint_setLength'>setLength</a> <a href='#SkPoint_setNormalize'>setNormalize</a>
...
<a href='#SkPoint_multiply_operator'>operator*(SkScalar scale) const</a>(<a href='undocumented#SkScalar'>SkScalar</a> <a href='#SkPoint_multiplyby_operator_scale'>scale</a>) const <a href='#SkPoint_scale'>scale()</a> <a href='#SkPoint_setLength'>setLength</a> <a href='#SkPoint_setNormalize'>setNormalize</a>
...
<a href='#SkPoint_equal_operator'>operator==(const SkPoint& a, const SkPoint& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& a, const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& b)
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
bool bool<a href='#SkPoint_equal_operator'>operator==(const SkPoint& a, const SkPoint& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& a, const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& b)
</pre>
...
<a href='#SkPoint_equals'>equals()</a> equals()<a href='#SkPoint_notequal_operator'>operator!=(const SkPoint& a, const SkPoint& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& <a href='#SkPoint_equal_operator_a'>a</a>, const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& <a href='#SkPoint_equal_operator_b'>b</a>)
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
bool bool<a href='#SkPoint_notequal_operator'>operator!=(const SkPoint& a, const SkPoint& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& a, const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& b)
</pre>
...
<a href='#SkPoint_equal_operator'>operator==(const SkPoint& a, const SkPoint& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& <a href='#SkPoint_notequal_operator_a'>a</a>, const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& <a href='#SkPoint_notequal_operator_b'>b</a>) <a href='#SkPoint_equals'>equals()</a>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
<a href='SkPoint_Reference#SkVector'>SkVector</a> SkVector<a href='#SkPoint_subtract_operator'>operator-(const SkPoint& a, const SkPoint& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& a, const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& b)
</pre>
...
<a href='#SkPoint_subtractfrom_operator'>operator-=(const SkVector& v)</a>(const <a href='SkPoint_Reference#SkVector'>SkVector</a>& v) <a href='#SkPoint_offset'>offset()</a>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
<a href='SkPoint_Reference#SkPoint'>SkPoint</a> SkPoint<a href='#SkPoint_add_operator'>operator+(const SkPoint& a, const SkVector& b)</a>(const <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& a, const <a href='SkPoint_Reference#SkVector'>SkVector</a>& b)
</pre>
...
<a href='#SkPoint_addto_operator'>operator+=(const SkVector& v)</a>(const <a href='SkPoint_Reference#SkVector'>SkVector</a>& v) <a href='#SkPoint_offset'>offset()</a>
