...
struct <a href='SkPoint_Reference#SkPoint'>SkPoint</a> {
    ...
    void iset(const <a href='SkIPoint_Reference#SkIPoint'>SkIPoint</a>& p);
...
set <a href='#SkPoint_Make'>Make</a> <a href='SkIPoint_Reference#SkIPoint'>SkIPoint</a>::<a href='#SkIPoint_set'>set</a>
...
set <a href='#SkPoint_Make'>Make</a> <a href='#SkPoint_negate'>negate</a>
...
offset offset<a href='#SkPoint_addto_operator'>operator+=(const SkVector& v)</a>
...
normalize <a href='#SkPoint_setLength'>setLength</a>
...
<a href='SkPoint_Reference#SkVector'>SkVector</a> provides an alternative name for SkPoint. SkVector and SkPoint can
