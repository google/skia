...
Used to wrap a <a href="undocumented#GPU">GPU</a>-backed texture as a <a href="#SkSurface">SkSurface</a>. <a href="undocumented#Skia">Skia</a> will not assume
...
create <a href="undocumented#GPU">GPU</a>-backed <a href="undocumented#GrRenderTarget">GrRenderTarget</a> with mips to avoid a copy later on.
...
Issue any pending surface <a href="undocumented#I">I</a>/<a href="undocumented#O">O</a> to the current <a href="undocumented#GPU">GPU</a>-backed <a href="undocumented#API">API</a> and resolve any surface MSAA.
