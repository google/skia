...
class <a href='#SkBitmap'>SkBitmap</a> {
    ...
    <a href='undocumented#SkPixelRef'>SkPixelRef</a>* pixelRef() const;
    <a href='SkIPoint_Reference#SkIPoint'>SkIPoint</a> pixelRefOrigin() const;
    ...
    class Allocator : public <a href='undocumented#SkRefCnt'>SkRefCnt</a> {
    public:
