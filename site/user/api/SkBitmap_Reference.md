...
colortype. Returns true on success, where success means either <a href="#SkBitmap_setPixels">setPixels</a>
...
Subclass of <a href="#SkBitmap_Allocator">Allocator</a> that returns a pixelref that allocates its pixel
...
Returns zero if <a href="#SkBitmap_colorType">colorType</a> is <a href="undocumented#SkColorType">kUnknown SkColorType</a>, or if <a href="#SkBitmap_rowBytes">rowBytes</a> supplied to
<a href="#SkBitmap_setInfo">setInfo</a> wasn't large enough to hold a row of pixels.
...
<div><fiddle-embed name="798d5f259dbd1ead4f3b1eac955c2cde"><div><a href="#SkBitmap_getSize">getSize</a> results aren't useful when <a href="#SkBitmap_width">width</a> and <a href="#SkBitmap_height">height</a> are large.</div>
...
<div><fiddle-embed name="47a93c44326c86371dbf42d2544e76be"><div><a href="#SkBitmap_getSafeSize">getSafeSize</a> results aren't useful when <a href="#SkBitmap_width">width</a> and <a href="#SkBitmap_height">height</a> are large.</div>
...
volatile by default; a <a href="undocumented#GPU">GPU</a> backend may upload pixel values expecting them to be
...
<div><fiddle-embed name="50df848163c6db14a3dcfbf6703954f7"></fiddle-embed></div>
...
<div><fiddle-embed name="ecea9792fc9d301a29f1d879aa98eaa5"></fiddle-embed></div>
...
<div><fiddle-embed name="f1668f0216dfcb8db4675aabc0bb3507"></fiddle-embed></div>
...
<table>  <tr>
    ...
    <td><a href="#SkBitmap_setInfo_imageInfo">imageInfo</a>.<a href="#SkBitmap_width">width</a> times <a href="#SkBitmap_setInfo_imageInfo">imageInfo</a>.<a href="#SkBitmap_bytesPerPixel">bytesPerPixel</a> exeeds 31 bits</td>  </tr>  <tr>
...
requires 40,000,000,000 bytes of storage. The allocator implemented 
...
<div><fiddle-embed name="4a7d5772dc236a54d59cd61d2df011c2"><div><a href="undocumented#Text">Text</a> is drawn on a transparent background; drawing the bitmap a second time
...
<div><fiddle-embed name="a7e04447b2081010c50d7920e80a6bb2"><div><a href="undocumented#GPU">GPU</a> doesn't support <a href="undocumented#SkAlphaType">kUnpremul SkAlphaType</a>, doesn't assert that it doesn't.</div></fiddle-embed></div>
...
<div><fiddle-embed name="adf57cbd123556d48b8aa065d641e143"><div><a href="#Bitmap">Bitmap</a> hosts and draws gray values in set1. <a href="#SkBitmap_tryAllocPixels">tryAllocPixels</a> replaces <a href="undocumented#Pixel_Ref">Pixel Ref</a>
...
<div><fiddle-embed name="7eb0cd5652b53ab46bc9ccbe8b3311e3"><div><a href="#Bitmap">Bitmap</a> hosts and draws gray values in set1. <a href="#SkBitmap_allocPixels">allocPixels</a> replaces <a href="undocumented#Pixel_Ref">Pixel Ref</a>
and erases it to black, but does not alter set1. <a href="#SkBitmap_setPixels">setPixels</a> replaces black
...
<div><fiddle-embed name="c05cbcdf07a91db3fec2a6f24cd1e2ee"><div><a href="#SkBitmap_HeapAllocator">HeapAllocator</a> limits the maximum size of <a href="#Bitmap">Bitmap</a> to two gigabytes. Using
...
<div><fiddle-embed name="b31c95752f04f80092d04966b3625f62"></fiddle-embed></div>
...
<div><fiddle-embed name="fb414f2af91982354f55a515ac002539"><div>Treating 32 bit data as 8 bit data is unlikely to produce useful results.</div></fiddle-embed></div>
...
<div><fiddle-embed name="2e22335a8dcc9bd6b531097930f685be"></fiddle-embed></div>
...
<div><fiddle-embed name="e2b5d885f3163fdc351226f42744967f"></fiddle-embed></div>
...
<div><fiddle-embed name="97c8fd201094343c83ee1f22ab14410b"><div>Transferring the gradient from 8 bits per component to 4 bits per component
...
<div><fiddle-embed name="8551e9b9fad8d6f5a195125458287aed"></fiddle-embed></div>
...
<div><fiddle-embed name="b7d8c3c4926d5441958cfa007dbd788d"></fiddle-embed></div>
...
<div><fiddle-embed name="d809e7e69cad410a8fa9878b7ba3e1f1"></fiddle-embed></div>
...
<div><fiddle-embed name="82753efd388aed9ad2d1fa59fa37b87b"></fiddle-embed></div>
...
<div><fiddle-embed name="57a59c0bdab4bacb1d55ea84158d263c"></fiddle-embed></div>
