...
Returns constructed <a href='SkIRect_Reference#SkIRect'>SkIRect</a> set to (0, 0, <a href='#SkIRect_MakeSize_size'>size</a>.<a href='#SkIRect_width'>width()</a>, <a href='#SkIRect_MakeSize_size'>size</a>.<a href='#SkIRect_height'>height()</a>).
Does not validate input; <a href='#SkIRect_MakeSize_size'>size</a>.<a href='#SkIRect_width'>width()</a> or <a href='#SkIRect_MakeSize_size'>size</a>.<a href='#SkIRect_height'>height()</a> may be negative.
...
bounds (0, 0, <a href='#SkIRect_MakeSize_size'>size</a>.<a href='#SkIRect_width'>width()</a>, <a href='#SkIRect_MakeSize_size'>size</a>.<a href='#SkIRect_height'>height()</a>)
