...
Returns constructed <a href='#IRect'>IRect</a> set to: (x, y, x + <a href='#SkIRect_MakeXYWH_w'>w</a>, y + <a href='#SkIRect_MakeXYWH_h'>h</a>).
...
Sets <a href='#IRect'>IRect</a> to: (x, y, x + width, y + height).
...
Returns true if: <a href='#SkIRect_fLeft'>fLeft</a> <= x < <a href='#SkIRect_fRight'>fRight</a> && <a href='#SkIRect_fTop'>fTop</a> <= y < <a href='#SkIRect_fBottom'>fBottom</a>.
Returns false if <a href='#IRect'>IRect</a> is empty.

Considers input to describe constructed <a href='#IRect'>IRect</a>: (x, y, x + 1, y + 1)and returns true if constructed area is completely enclosed by <a href='#IRect'>IRect</a> area.
