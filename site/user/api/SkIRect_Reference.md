...
width of constructed <a href="SkRect_Reference#Rect">Rect</a></td>
  </tr>  <tr>    <td><a name="SkIRect_MakeWH_h"> <code><strong>h </strong></code> </a></td> <td>
height of constructed <a href="SkRect_Reference#Rect">Rect</a></td>
  </tr>
</table>
...
values for <a href="SkRect_Reference#Rect">Rect</a> width and height</td>
  </tr>
</table>
...
Returns constructed <a href="#IRect">IRect</a> set to (<a href="#SkIRect_MakeLTRB_l">l</a>, <a href="#SkIRect_MakeLTRB_t">t</a>, <a href="#SkIRect_MakeLTRB_r">r</a>, <a href="#SkIRect_MakeLTRB_b">b</a>). Does not sort input; <a href="SkRect_Reference#Rect">Rect</a> may
...
Returns average of left edge and right edge. Result does not change if <a href="SkRect_Reference#Rect">Rect</a>
...
Returns average of top edge and bottom edge. Result does not change if <a href="SkRect_Reference#Rect">Rect</a>
is sorted. Result may be incorrect if <a href="SkRect_Reference#Rect">Rect</a> is far from the origin.
...
<a href="#SkIRect_EmptyIRect">EmptyIRect</a> <a href="#SkIRect_MakeEmpty">MakeEmpty</a> sort <a href="#SkRect_isEmpty">SkRect::isEmpty</a>
...
set <a href="#SkIRect_setXYWH">setXYWH</a> <a href="#SkRect_setLTRB">SkRect::setLTRB</a>
...
<a href="#SkIRect_MakeXYWH">MakeXYWH</a> <a href="#SkIRect_setLTRB">setLTRB</a> set <a href="#SkRect_setXYWH">SkRect::setXYWH</a>
...
<a href="SkRect_Reference#Rect">Rect</a> offset in x or y, with original width and height
...
<a href="SkRect_Reference#Rect">Rect</a> inset symmetrically left and right, top and bottom
...
<a href="SkRect_Reference#Rect">Rect</a> outset symmetrically left and right, top and bottom
...
offset <a href="#SkIRect_makeOffset">makeOffset</a> <a href="#SkIRect_setXYWH">setXYWH</a> <a href="#SkRect_offsetTo">SkRect::offsetTo</a>
...
outset <a href="#SkIRect_makeInset">makeInset</a> <a href="#SkRect_inset">SkRect::inset</a>
...
inset <a href="#SkIRect_makeOutset">makeOutset</a> <a href="#SkRect_outset">SkRect::outset</a>
...
x minimum of constructed <a href="SkRect_Reference#Rect">Rect</a></td>
  </tr>  <tr>    <td><a name="SkIRect_quickReject_t"> <code><strong>t </strong></code> </a></td> <td>
y minimum of constructed <a href="SkRect_Reference#Rect">Rect</a></td>
  </tr>  <tr>    <td><a name="SkIRect_quickReject_r"> <code><strong>r </strong></code> </a></td> <td>
x maximum of constructed <a href="SkRect_Reference#Rect">Rect</a></td>
  </tr>  <tr>    <td><a name="SkIRect_quickReject_b"> <code><strong>b </strong></code> </a></td> <td>
y maximum of constructed <a href="SkRect_Reference#Rect">Rect</a></td>
  </tr>
</table>
...
<a href="#SkIRect_containsNoEmptyCheck">containsNoEmptyCheck</a><sup><a href="#SkIRect_containsNoEmptyCheck_2">[2]</a></sup> <a href="#SkRect_contains">SkRect::contains</a>
...
Constructs <a href="SkRect_Reference#Rect">Rect</a> to intersect from (left, top, right, bottom). Does not sort
construction.

Returns true if <a href="SkRect_Reference#Rect">Rect</a> contains construction.
...
Returns true if <a href="SkRect_Reference#Rect">Rect</a> contains <a href="#SkIRect_contains_3_r">r</a>.
Returns false if <a href="SkRect_Reference#Rect">Rect</a> is empty or <a href="#SkIRect_contains_3_r">r</a> is empty.

<a href="SkRect_Reference#Rect">Rect</a> contains <a href="#SkIRect_contains_3_r">r</a> when <a href="SkRect_Reference#Rect">Rect</a> area completely includes <a href="#SkIRect_contains_3_r">r</a> area.
...
Returns true if <a href="SkRect_Reference#Rect">Rect</a> contains <a href="#SkIRect_contains_4_r">r</a>.
Returns false if <a href="SkRect_Reference#Rect">Rect</a> is empty or <a href="#SkIRect_contains_4_r">r</a> is empty.

<a href="SkRect_Reference#Rect">Rect</a> contains <a href="#SkIRect_contains_4_r">r</a> when <a href="SkRect_Reference#Rect">Rect</a> area completely includes <a href="#SkIRect_contains_4_r">r</a> area.
...
contains <a href="#SkRect_contains">SkRect::contains</a>
...
<a href="#SkIRect_Intersects">Intersects</a> <a href="#SkIRect_intersectNoEmptyCheck">intersectNoEmptyCheck</a> join <a href="#SkRect_intersect">SkRect::intersect</a>
...
<a href="#SkIRect_Intersects">Intersects</a> intersect join <a href="#SkRect_intersect">SkRect::intersect</a>
...
<a href="#SkIRect_intersectNoEmptyCheck">intersectNoEmptyCheck</a> <a href="#SkIRect_Intersects">Intersects</a> join <a href="#SkRect_intersect">SkRect::intersect</a>
...
<a href="#SkIRect_IntersectsNoEmptyCheck">IntersectsNoEmptyCheck</a> intersect <a href="#SkRect_intersect">SkRect::intersect</a>
...
<a href="#SkIRect_Intersects">Intersects</a> intersect <a href="#SkRect_intersect">SkRect::intersect</a>
...
set <a href="#SkRect_join">SkRect::join</a>
...
sort <a href="#SkRect_makeSorted">SkRect::makeSorted</a>
