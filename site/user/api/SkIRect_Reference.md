...
Returns constructed <a href='SkIRect_Reference#SkIRect'>SkIRect</a> set to (0, 0, <a href='undocumented#Size'>size</a>.width(), <a href='undocumented#Size'>size</a>.height()).
Does not validate input; <a href='undocumented#Size'>size</a>.width() or <a href='undocumented#Size'>size</a>.height() may be negative.
...
bounds (0, 0, <a href='undocumented#Size'>size</a>.width(), <a href='undocumented#Size'>size</a>.height())
...
Returns true if all members in a: <a href='#SkIRect_fLeft'>fLeft</a>, <a href='#SkIRect_fTop'>fTop</a>, <a href='#SkIRect_fRight'>fRight</a>, and <a href='#SkIRect_fBottom'>fBottom</a>; are
...
Returns true if any member in a: <a href='#SkIRect_fLeft'>fLeft</a>, <a href='#SkIRect_fTop'>fTop</a>, <a href='#SkIRect_fRight'>fRight</a>, and <a href='#SkIRect_fBottom'>fBottom</a>; is not
...
Sets <a href='SkIRect_Reference#SkIRect'>SkIRect</a> to (left, top, right, bottom).
...
Offsets <a href='SkIRect_Reference#SkIRect'>SkIRect</a> by adding <a href='#SkIRect_offset_2_delta'>delta</a>.<a href='SkIPoint_Reference#SkIPoint_fX'>fX</a> to <a href='#SkIRect_fLeft'>fLeft</a>, <a href='#SkIRect_fRight'>fRight</a>; and by adding <a href='#SkIRect_offset_2_delta'>delta</a>.<a href='SkIPoint_Reference#SkIPoint_fY'>fY</a> to
<a href='#SkIRect_fTop'>fTop</a>, <a href='#SkIRect_fBottom'>fBottom</a>.

If <a href='#SkIRect_offset_2_delta'>delta</a>.<a href='SkIPoint_Reference#SkIPoint_fX'>fX</a> is negative, moves <a href='SkIRect_Reference#SkIRect'>SkIRect</a> returned to the left.
If <a href='#SkIRect_offset_2_delta'>delta</a>.<a href='SkIPoint_Reference#SkIPoint_fX'>fX</a> is positive, moves <a href='SkIRect_Reference#SkIRect'>SkIRect</a> returned to the right.
If <a href='#SkIRect_offset_2_delta'>delta</a>.<a href='SkIPoint_Reference#SkIPoint_fY'>fY</a> is negative, moves <a href='SkIRect_Reference#SkIRect'>SkIRect</a> returned upward.
If <a href='#SkIRect_offset_2_delta'>delta</a>.<a href='SkIPoint_Reference#SkIPoint_fY'>fY</a> is positive, moves <a href='SkIRect_Reference#SkIRect'>SkIRect</a> returned downward.
...
greater than right, the <a href='SkIRect_Reference#SkIRect'>SkIRect</a> will be considered empty. Call sort() after this call
...
Constructs <a href='SkIRect_Reference#SkIRect'>SkIRect</a> to intersect from (left, top, right, bottom). Does not sort
construction.
...
Constructs <a href='SkIRect_Reference#SkIRect'>SkIRect</a> from (left, top, right, bottom). Does not sort
construction.
...
Returns true if a intersects <a href='#SkIRect_intersect_2_b'>b</a>, and sets <a href='SkIRect_Reference#SkIRect'>SkIRect</a> to intersection.
Returns false if a does not intersect <a href='#SkIRect_intersect_2_b'>b</a>, and leaves <a href='SkIRect_Reference#SkIRect'>SkIRect</a> unchanged.

Returns false if either a or <a href='#SkIRect_intersect_2_b'>b</a> is empty, leaving <a href='SkIRect_Reference#SkIRect'>SkIRect</a> unchanged.
...
true if a and <a href='#SkIRect_intersect_2_b'>b</a> have area in common
...
Returns true if a intersects <a href='#SkIRect_intersectNoEmptyCheck_b'>b</a>, and sets <a href='SkIRect_Reference#SkIRect'>SkIRect</a> to intersection.
Returns false if a does not intersect <a href='#SkIRect_intersectNoEmptyCheck_b'>b</a>, and leaves <a href='SkIRect_Reference#SkIRect'>SkIRect</a> unchanged.

Asserts if either a or <a href='#SkIRect_intersectNoEmptyCheck_b'>b</a> is empty, and if SK_DEBUG is defined.
...
true if a and <a href='#SkIRect_intersectNoEmptyCheck_b'>b</a> have area in common
...
Returns true if a intersects <a href='#SkIRect_Intersects_b'>b</a>.
Returns false if either a or <a href='#SkIRect_Intersects_b'>b</a> is empty, or do not intersect.
...
true if a and <a href='#SkIRect_Intersects_b'>b</a> have area in common
...
Returns true if a intersects <a href='#SkIRect_IntersectsNoEmptyCheck_b'>b</a>.
Asserts if either a or <a href='#SkIRect_IntersectsNoEmptyCheck_b'>b</a> is empty, and if SK_DEBUG is defined.
...
true if a and <a href='#SkIRect_IntersectsNoEmptyCheck_b'>b</a> have area in common
