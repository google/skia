...
Returns span on the x-axis. This does not check if <a href='SkRect_Reference#Rect'>Rect</a> is sorted, or if
...
Returns the top left corner x-radius. If <a href='#SkRRect_type'>type</a> returns <a href='#SkRRect_kSimple_Type'>kSimple Type</a>,
this equals the value of all corner radii. More complex <a href='#RRect'>Round Rect</a> types have
...
Set this <a href='#RRect'>Round Rect</a> to match the supplied rect. All radii are set to zero.
