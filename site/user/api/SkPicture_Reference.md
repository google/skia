...
<a name='SkPicture'></a><a href='#Picture'>Picture</a> records drawing commands made to <a href='SkCanvas_Reference#Canvas'>Canvas</a>. The command stream may be
...
SkPicture uses <code>class</code> to declare the public data structures and interfaces.
<table style='border-collapse: collapse; width: 62.5em'>
...
SkPicture uses member functions to read and modify structure properties.
<table style='border-collapse: collapse; width: 62.5em'>
