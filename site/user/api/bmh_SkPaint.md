...
<fiddle-embed name="1bb6f16fe6899fedbd155f862680aad1"><p>A red line is drawn with transparency on the edges to make it look smoother.
...
aliasing easier to see.</p></fiddle-embed>
...
<fiddle-embed name="525062c7023c2c5f2f962a09baad75eb"><p>Four commas are drawn normally and with combinations of <a href="bmh_SkPaint?cl=9919#LCD_Text">LCD_Text</a> and <a href="bmh_SkPaint?cl=9919#Subpixel_Text">Subpixel_Text</a>.
...
When <a href="bmh_SkPaint?cl=9919#Subpixel_Text">Subpixel_Text</a> is enabled, the comma glyphs are unique, but appear evenly spaced.</p></fiddle-embed>
...
<fiddle-embed name=""><p>The hintgasp <a href="bmh_undocumented?cl=9919#TrueType">TrueType</a> font in the <a href="bmh_undocumented?cl=9919#Skia">Skia</a> resources/fonts directory includes an embedded
...
as their <a href="bmh_undocumented?cl=9919#Engine">Font_Engine</a>.
<a href="bmh_undocumented?cl=9919#Windows">Windows</a> may, but is not required to, return a bitmap glyph if <a href="bmh_SkPaint?cl=9919#kEmbeddedBitmapText_Flag">kEmbeddedBitmapText_Flag</a> is set.</p></fiddle-embed>
...
<fiddle-embed name="3832b070eefd62afff5fe375baa86445">raster gpu<p>The pixels hit to represent thin lines vary with the angle of the 
line and the platform's implementation.</p></fiddle-embed>
...
<fiddle-embed name="00badb5eeabf35289325f0754c476f40"><p>This example draws a stroked corner and the miter length beneath.
When the miter limit is decreased slightly, the miter join is replaced
by a bevel join.</p></fiddle-embed>
...
<fiddle-embed name="53da2db22c88f891a990f12de286bce3"><p>A very small quad stroke is turned into a filled path with increasing levels of precision.
At the lowest precision, the quad stroke is approximated by a rectangle. 
At the highest precision, the filled path has high fidelity compared to the original stroke.</p></fiddle-embed>
