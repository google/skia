...
## <a name="Topic_Paint_Overview"></a> Paint Overview
### <a name="Subtopic_Paint_Subtopics"></a> Paint Subtopics
### <a name="Subtopic_Paint_Constants"></a> Paint Constants
...
### <a name="Subtopic_Structures"></a> Structures


| [FontMetrics](SkPaint_FontMetrics) | [Typeface](Typeface) values. |

### <a name="Subtopic_Paint_Constructors"></a> Paint Constructors
...
### <a name="Subtopic_Paint_Operators"></a> Paint Operators
...
### <a name="Subtopic_Paint_Member_Functions"></a> Paint Member Functions
...
## <a name="Topic_Paint_Constructor"></a> Paint Constructor
<!--?prettify lang=cc?-->

    <a name="SkPaint_empty_constructor"></a>SkPaint()
...
paint default values. The overrides may be included in [SkUserConfig](SkUserConfig). h or predefined by the build system.

#### Example

<fiddle-embed hash="9db1cabd02ad20f6e8654de6d697b1bc"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_copy_constructor"></a>SkPaint(const SkPaint& paint)
...
<fiddle-embed hash="2de7fa7ce51a8f560b2951f8f5732cca"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_move_constructor"></a>SkPaint(SkPaint&& paint)
...
<fiddle-embed hash="0f3d4d38fa43549c22c2cea35412a31b"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_destructor"></a>~SkPaint()
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_copy_assignment_operator"></a>SkPaint& operator=(const SkPaint&)
...
<fiddle-embed hash="a33951d3aac20c13eab365dddb06e8e5"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_move_assignment_operator"></a>SkPaint& operator=(SkPaint&&)
...
<fiddle-embed hash="b178ef2aaf49b5da6ec78b87873ad0c2"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_equal_operator"></a>bool operator==(const SkPaint& a, const SkPaint& b)
...
<fiddle-embed hash="2ebadcc4709652a1f39981ccfe4f85a6"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_not_equal_operator"></a>bool operator!=(const SkPaint& a, const SkPaint& b)
...
<fiddle-embed hash="96fb444c9a41da32105af262bfa4413d"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_getHash"></a>uint32_t getHash() const
...
<fiddle-embed hash="008d3bc3dfe20a442a77c0121e9a4c53"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_flatten"></a>void flatten(SkWriteBuffer&) const
...
<fiddle-embed hash="c0840d7a4a2992f81082639f6c86f7bd"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_unflatten"></a>void unflatten(SkReadBuffer&)
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_reset"></a>void reset()
...
<fiddle-embed hash="af301c5e19c8f5adab8c23e47413923f"></fiddle-embed>
...
## <a name="Topic_Paint_Hinting"></a> Paint Hinting
### <a name="SkPaint_Hinting"></a> Enum SkPaint::Hinting
enum [Hinting](SkPaint_Hinting){
        [kNo_Hinting](SkPaint_kNo_Hinting)= 0,
        [kSlight_Hinting](SkPaint_kSlight_Hinting)= 1,
        [kNormal_Hinting](SkPaint_kNormal_Hinting)= 2,
        [kFull_Hinting](SkPaint_kFull_Hinting)= 3
};
##
...
#### <a name="SkPaint_kNo_Hinting"></a> Const SkPaint::kNo_Hinting 0
[kNo_Hinting](SkPaint_kNo_Hinting) leaves glyph outlines unchanged from their native representation.
#### <a name="SkPaint_kSlight_Hinting"></a> Const SkPaint::kSlight_Hinting 1
[kSlight_Hinting](SkPaint_kSlight_Hinting) modifies glyph outlines minimally to improve constrast.
#### <a name="SkPaint_kNormal_Hinting"></a> Const SkPaint::kNormal_Hinting 2
[kNormal_Hinting](SkPaint_kNormal_Hinting) modifies glyph outlines to improve constrast.
#### <a name="SkPaint_kFull_Hinting"></a> Const SkPaint::kFull_Hinting 3
[kFull_Hinting](SkPaint_kFull_Hinting) modifies glyph outlines for maxiumum constrast.
2013-03-03 07: 16: 29+ 0000
915On [OS_X](OS_X) and iOS, hinting controls whether [Core_Graphics](Core_Graphics) dilates the font outlines
to account for [LCD](LCD) text. No hinting uses [Core_Text](Core_Text) gray scale output.
Normal hinting uses [Core_Text](Core_Text) [LCD](LCD) output. If [kLCDRenderText_Flag](SkPaint_kLCDRenderText_Flag) is clear,
the [LCD](LCD) output is reduced to a single grayscale channel.
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_getHinting"></a>Hinting getHinting() const
...
<fiddle-embed hash="c91cfb5a3767889b802c577ebfd73221"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setHinting"></a>void setHinting(Hinting hintingLevel) const
...
<fiddle-embed hash="39a0706eaf1135f09657265ea8ad1d37"></fiddle-embed>
...
## <a name="Topic_Paint_Flags"></a> Paint Flags
### <a name="SkPaint_Flags"></a> Enum SkPaint::Flags
enum [Flags](SkPaint_Flags){
        [kAntiAlias_Flag](SkPaint_kAntiAlias_Flag)= 0x01,
        [kDither_Flag](SkPaint_kDither_Flag)= 0x04,
        [kFakeBoldText_Flag](SkPaint_kFakeBoldText_Flag)= 0x20,
        [kLinearText_Flag](SkPaint_kLinearText_Flag)= 0x40,
        [kSubpixelText_Flag](SkPaint_kSubpixelText_Flag)= 0x80,
        [kDevKernText_Flag](SkPaint_kDevKernText_Flag)= 0x100,
        [kLCDRenderText_Flag](SkPaint_kLCDRenderText_Flag)= 0x200,
        [kEmbeddedBitmapText_Flag](SkPaint_kEmbeddedBitmapText_Flag)= 0x400,
        [kAutoHinting_Flag](SkPaint_kAutoHinting_Flag)= 0x800,
        [kVerticalText_Flag](SkPaint_kVerticalText_Flag)= 0x1000,
        [kGenA8FromLCD_Flag](SkPaint_kGenA8FromLCD_Flag)= 0x2000,

        [kAllFlags](SkPaint_kAllFlags)= 0xFFFF,

# ifdef [SK_SUPPORT_LEGACY_PAINT_TEXTDECORATION](SK_SUPPORT_LEGACY_PAINT_TEXTDECORATION)
[kUnderlineText_Flag](SkPaint_kUnderlineText_Flag)= 0x08,
        [kStrikeThruText_Flag](SkPaint_kStrikeThruText_Flag)= 0x10,
# endif
};
...
#### <a name="SkPaint_kAntiAlias_Flag"></a> Const SkPaint::kAntiAlias_Flag 0x0001 
Controls if [Anti-alias](Anti-alias) is enabled or disabled.
#### <a name="SkPaint_kDither_Flag"></a> Const SkPaint::kDither_Flag 0x0004
Controls if [Dither](Dither) is enabled or disabled.
#### <a name="SkPaint_kUnderlineText_Flag"></a> Const SkPaint::kUnderlineText_Flag 0x0008
Deprecated.
#### <a name="SkPaint_kStrikeThruText_Flag"></a> Const SkPaint::kStrikeThruText_Flag 0x1000
Deprecated.
#### <a name="SkPaint_kFakeBoldText_Flag"></a> Const SkPaint::kFakeBoldText_Flag 0x0020
Controls if [Fake_Bold](Fake_Bold) is enabled or disabled.
#### <a name="SkPaint_kLinearText_Flag"></a> Const SkPaint::kLinearText_Flag 0x0040
Controls if [Linear_Text](Linear_Text) is enabled or disabled.
#### <a name="SkPaint_kSubpixelText_Flag"></a> Const SkPaint::kSubpixelText_Flag 0x0080
Controls if [Subpixel_Text](Subpixel_Text) is enabled or disabled.
#### <a name="SkPaint_kDevKernText_Flag"></a> Const SkPaint::kDevKernText_Flag 0x0100
Controls if [Full_Hinting_Spacing](Full_Hinting_Spacing) is enabled or disabled.
#### <a name="SkPaint_kLCDRenderText_Flag"></a> Const SkPaint::kLCDRenderText_Flag 0x0200
Controls if [LCD_Text](LCD_Text) is enabled or disabled.
#### <a name="SkPaint_kEmbeddedBitmapText_Flag"></a> Const SkPaint::kEmbeddedBitmapText_Flag 0x0400
Controls if [Font_Embedded_Bitmaps](Font_Embedded_Bitmaps) is enabled or disabled.
#### <a name="SkPaint_kAutoHinting_Flag"></a> Const SkPaint::kAutoHinting_Flag 0x0800
Controls if [Forced_Auto-hinting](Forced_Auto-hinting) is enabled or disabled.
#### <a name="SkPaint_kVerticalText_Flag"></a> Const SkPaint::kVerticalText_Flag 0x1000
Controls if [Vertical_Text](Vertical_Text) is enabled or disabled.
#### <a name="SkPaint_kGenA8FromLCD_Flag"></a> Const SkPaint::kGenA8FromLCD_Flag 0x2000
Not intended for public use.
#### <a name="SkPaint_kAllFlags"></a> Const SkPaint::kAllFlags 0xFFFF
Masks the range of [Paint_Flags](Paint_Flags), including private flags and flags
...
# ifdef [SK_BUILD_FOR_ANDROID_FRAMEWORK](SK_BUILD_FOR_ANDROID_FRAMEWORK)
enum [ReserveFlags](SkPaint_ReserveFlags){
        [kUnderlineText_ReserveFlag](SkPaint_kUnderlineText_ReserveFlag)= 0x08,
        [kStrikeThruText_ReserveFlag](SkPaint_kStrikeThruText_ReserveFlag)= 0x10,
    };
# endif
##

#### <a name="SkPaint_kUnderlineText_ReserveFlag"></a> Const SkPaint::kUnderlineText_ReserveFlag 0x0008
#### <a name="SkPaint_kStrikeThruText_ReserveFlag"></a> Const SkPaint::kStrikeThruText_ReserveFlag 0x0010
<!--?prettify lang=cc?-->

    <a name="SkPaint_getFlags"></a>uint32_t getFlags() const
...
<fiddle-embed hash="e95d09086fe8a862f78087e5fff070a4"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setFlags"></a>void setFlags(uint32_t flags)
...
<fiddle-embed hash="3c209da57ee0acba480ba05ade14b6d7"></fiddle-embed>
...
## <a name="Topic_Anti-alias"></a> Anti-alias
[Anti-alias](Anti-alias) drawing approximates partial pixel coverage with transparency.
...
[Anti-alias](Anti-alias) is disabled by default.
[Anti-alias](Anti-alias) can be enabled by default by setting [SkPaintDefaults_Flags](SkPaintDefaults_Flags) to [kAntiAlias_Flag](SkPaint_kAntiAlias_Flag)
at compile time.

### Example

<fiddle-embed hash="1bb6f16fe6899fedbd155f862680aad1"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_isAntiAlias"></a>bool isAntiAlias() const
...
<fiddle-embed hash="aecda6fe10e4a19b2574f1f2fb80d437"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setAntiAlias"></a>void setAntiAlias(bool aa)
...
<fiddle-embed hash="231c9631061232096c3d7bd94ddd5c27"></fiddle-embed>
...
a [kRGB_565_SkColorType](SkColorType) surface.

6224
[Dither](Dither) is ignored if the gradient has two colors.
##

[Dither](Dither) is disabled by default.
...
<fiddle-embed hash="b28987b65d3be14717e4faaacaf2faa1"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_isDither"></a>bool isDither() const
...
<fiddle-embed hash="87f9538060779de8a0284d9227bdf91a"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setDither"></a>void setDither(bool dither)
...
<fiddle-embed hash="4c7a25e4a7a314d84147a399763c9773"></fiddle-embed>
...
[Gradient](Gradient) [Color_RGB-565](Color_RGB-565)
## <a name="Topic_Paint_Device_Text"></a> Paint Device Text
[LCD_Text](LCD_Text) and [Subpixel_Text](Subpixel_Text) increase the precision of glyph position.

When set, [Flags](SkPaint_Flags) [kLCDRenderText_Flag](SkPaint_kLCDRenderText_Flag) takes advantage of the organization of [Color_RGB](Color_RGB) stripes that create a color, and relies
...
[LCD_Text](LCD_Text) or [Subpixel_Text](Subpixel_Text) can be enabled by default by setting [SkPaintDefaults_Flags](SkPaintDefaults_Flags) to [kLCDRenderText_Flag](SkPaint_kLCDRenderText_Flag) or [kSubpixelText_Flag](SkPaint_kSubpixelText_Flag)( or both) at compile time.

### Example

<fiddle-embed hash="525062c7023c2c5f2f962a09baad75eb"></fiddle-embed>
...
Four commas are drawn normally and with combinations of [LCD_Text](LCD_Text) and [Subpixel_Text](Subpixel_Text).
        ...
        When [Subpixel_Text](Subpixel_Text) is enabled, the comma glyphs are unique, but appear evenly spaced.
### <a name="Subtopic_Linear_Text"></a> Linear Text
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_isLinearText"></a>bool isLinearText() const

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_setLinearText"></a>void setLinearText(bool linearText)

---

### <a name="Subtopic_Subpixel_Text"></a> Subpixel Text
[Flags](SkPaint_Flags) [kSubpixelText_Flag](SkPaint_kSubpixelText_Flag) uses the pixel transparency to represent a fractional offset. 
As the opaqueness
of the color increases, the edge of the glyph appears to move towards the outside of the pixel.
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_isSubpixelText"></a>bool isSubpixelText() const
...
<fiddle-embed hash="fc6e1fa6b9a383e6529211dc773a464d"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setSubpixelText"></a>void setSubpixelText(bool subpixelText)
...
<fiddle-embed hash="17270e681eb6931258acdbbbbefcc17c"></fiddle-embed>
...
### <a name="Subtopic_LCD_Text"></a> LCD Text
When set, [Flags](SkPaint_Flags) [kLCDRenderText_Flag](SkPaint_kLCDRenderText_Flag) takes advantage of the organization of [Color_RGB](Color_RGB) stripes that create a color, and relies
on the small size of the stripe and visual perception to make the color fringing inperceptible.
[LCD_Text](LCD_Text) can be enabled on devices that orient stripes horizontally or vertically, and that order
the color components as [Color_RGB](Color_RGB) or [Color_RBG](Color_RBG).
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_isLCDRenderText"></a>bool isLCDRenderText() const
...
<fiddle-embed hash="bf834391d2837b242c889c0591e828c8"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setLCDRenderText"></a>void setLCDRenderText(bool lcdText)
...
<fiddle-embed hash="50f5dc9c5337271fc088aab9f6e73bbf"></fiddle-embed>
...
## <a name="Topic_Font_Embedded_Bitmaps"></a> Font Embedded Bitmaps
...
<fiddle-embed hash=""></fiddle-embed>
...
as their [Font_Engine](Font_Engine).
        [Windows](Windows) may, but is not required to, return a bitmap glyph if [kEmbeddedBitmapText_Flag](SkPaint_kEmbeddedBitmapText_Flag) is set.
embeddedbitmap. png
<!--?prettify lang=cc?-->

    <a name="SkPaint_isEmbeddedBitmapText"></a>bool isEmbeddedBitmapText() const
...
<fiddle-embed hash="3f4c8fd210a7d276871a11a1b330f401"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setEmbeddedBitmapText"></a>void setEmbeddedBitmapText(bool useEmbeddedBitmapText)
...
<fiddle-embed hash="4d0c99d7d4a6f39d3c51a1be09060e48"></fiddle-embed>
...
## <a name="Topic_Forced_Auto-hinting"></a> Forced Auto-hinting
[Forced_Auto-hinting](Forced_Auto-hinting) no longer has any effect.
Set [Hinting](SkPaint_Hinting) to [kNo_Hinting](SkPaint_kNo_Hinting) to leave the font outlines unhinted instead.
<!--?prettify lang=cc?-->

    <a name="SkPaint_isAutohinted"></a>bool isAutohinted() const
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setAutohinted"></a>void setAutohinted(bool useAutohinter)
...
## <a name="Topic_Vertical_Text"></a> Vertical Text
...
<fiddle-embed hash="3c4995e97b7d0d0afeb718e44f9472c0"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_isVerticalText"></a>bool isVerticalText() const
...
<fiddle-embed hash="8de09d99eebade65c6446d8bfc980fe1"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setVerticalText"></a>void setVerticalText(bool vertical)
...
<fiddle-embed hash="4bc82860cbf0e9a9d2cc2627879ecc7f"></fiddle-embed>
...
## <a name="Topic_Paint_Text_Decorations"></a> Paint Text Decorations
<!--?prettify lang=cc?-->

    <a name="SkPaint_isUnderlineText"></a>bool isUnderlineText() const
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_isStrikeThruText"></a>bool isStrikeThruText() const { return false; }

requires [SK_SUPPORT_LEGACY_PAINT_TEXTDECORATION](SK_SUPPORT_LEGACY_PAINT_TEXTDECORATION)
unsure if/ how to document this
---

### <a name="Subtopic_Fake_Bold"></a> Fake Bold
...
Use [Paint_Text_Skew_X](Paint_Text_Skew_X) to approximate an italic font style when the italic font face is not available.
...
<fiddle-embed hash="c68a5108ac9e8945c30bf215549599b2"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_isFakeBoldText"></a>bool isFakeBoldText() const;
...
<fiddle-embed hash="bc4ff096643bd3a132429f68d410492e"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setFakeBoldText"></a>void setFakeBoldText(bool fakeBoldText)
...
<fiddle-embed hash="6e6982855b1a836762050e6b0bd5f618"></fiddle-embed>
...
## <a name="Topic_Full_Hinting_Spacing"></a> Full Hinting Spacing
[Full_Hinting_Spacing](Full_Hinting_Spacing) adjusts the character spacing by the difference of the hinted and unhinted left and right side bearings, 
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_isDevKernText"></a>bool isDevKernText() const
...
<fiddle-embed hash="2a0016c5875bf070d18508457143fb16"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_setDevKernText"></a>void setDevKernText(bool devKernText)
...
<fiddle-embed hash="c00e36f5f3c49317c622e88e97d334a3"></fiddle-embed>
...
## <a name="Topic_Paint_Filter_Quality"></a> Paint Filter Quality
...
[Filter_Quality](Filter_Quality) is used in the paint passed as a parameter to
[SkCanvas](SkCanvas):: drawBitmap
[SkCanvas](SkCanvas):: drawBitmapRect
[SkCanvas](SkCanvas):: drawImage
[SkCanvas](SkCanvas):: drawImageRect
and when [Paint](Paint) has a [Shader](Shader) specialization that uses [Image](Image) or [Bitmap](Bitmap).

[Filter_Quality](Filter_Quality) is [kNone_SkFilterQuality](SkFilterQuality) by default.

### Example

<fiddle-embed hash="97d214c30dcacf9f13a1487d5d2b377d"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getFilterQuality"></a>SkFilterQuality getFilterQuality() const
...
<fiddle-embed hash="ba511d61d6149608616b8dc9af296b23"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setFilterQuality"></a>void setFilterQuality(SkFilterQuality quality)
...
<table>
  <tr>
    <td><code><strong>quality</strong></code></td> <td>One of: [kNone_SkFilterQuality](SkFilterQuality), [kLow_SkFilterQuality](SkFilterQuality), 
                 [kMedium_SkFilterQuality](SkFilterQuality), [kHigh_SkFilterQuality](SkFilterQuality).
                 Not checked to see if quality is valid.
</td>
  </tr>
#
...
<fiddle-embed hash="9385d0ef925a17fd1eb5651b816e496e"></fiddle-embed>
...
## <a name="Topic_Paint_Color"></a> Paint Color
...
<fiddle-embed hash="f6eec81567acaca6638d696ad00cfb5d"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getColor"></a>SkColor getColor() const
...
<fiddle-embed hash="896fd0df04c096398b5d5d7d47061cdf"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setColor"></a>void setColor(SkColor color)
...
<fiddle-embed hash="be988544a8f36325c3480cf679ae021a"></fiddle-embed>
...
### <a name="Subtopic_Paint_Alpha"></a> Paint Alpha
[Paint_Alpha](Paint_Alpha) sets the transparency independent of [Color_RGB](Color_RGB): [Color_Red](Color_Red), [Color_Blue](Color_Blue), and [Color_Green](Color_Green).

<!--?prettify lang=cc?-->

    <a name="SkPaint_getAlpha"></a>uint8_t getAlpha() const
...
<fiddle-embed hash="2b1f43ba1731db56cccd04172c62bb84"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setAlpha"></a>void setAlpha(U8CPU a)

Replaces [Color_Alpha](Color_Alpha), leaving [Color_RGB](Color_RGB) unchanged. An out of range value triggers an assert in the debug
build.
...
<fiddle-embed hash="4e783d6b70a95b2669f497ad7c4d5243"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setARGB"></a>void setARGB(U8CPU a, U8CPU r, U8CPU g, U8CPU b)
...
<table>
  <tr>
    <td><code><strong>a</strong></code></td> <td>The amount of [Color_Alpha](Color_Alpha), from fully transparent( 0) to fully opaque( 255).</td>
  </tr>
  <tr>
    <td><code><strong>r</strong></code></td> <td>The amount of [Color_Red](Color_Red), from no red( 0) to full red( 255).</td>
  </tr>
  <tr>
    <td><code><strong>g</strong></code></td> <td>The amount of [Color_Green](Color_Green), from no green( 0) to full green( 255).</td>
  </tr>
  <tr>
    <td><code><strong>b</strong></code></td> <td>The amount of [Color_Blue](Color_Blue), from no blue( 0) to full blue( 255).</td>
  </tr>
</table>

#### Example

<fiddle-embed hash="345a684de24090f4c469e15659bd101d"></fiddle-embed>
...
## <a name="Topic_Paint_Style"></a> Paint Style
...
### <a name="Subtopic_Paint_Stroke"></a> Paint Stroke
...
may have gaps, and if [kAntiAlias_Flag](SkPaint_kAntiAlias_Flag) is set, [Paint_Alpha](Paint_Alpha) will increase to visually decrease coverage.
### <a name="Subtopic_Paint_Hairline"></a> Paint Hairline
[Stroke_Width](Stroke_Width) of zero has a special meaning and switches drawing to use [Paint_Hairline](Paint_Hairline).
[Paint_Hairline](Paint_Hairline) draws the thinnest continuous frame. If [kAntiAlias_Flag](SkPaint_kAntiAlias_Flag) is clear, adjacent pixels flow horizontally, vertically, or diagonally. 
...
enum [Style](SkPaint_Style){
        [kFill_Style](SkPaint_kFill_Style),
        [kStroke_Style](SkPaint_kStroke_Style),
        [kStrokeAndFill_Style](SkPaint_kStrokeAndFill_Style),
    };
##

#### <a name="SkPaint_kFill_Style"></a> Const SkPaint::kFill_Style 0
[kFill_Style](SkPaint_kFill_Style) applies to [Rect](Rect), [Region](Region), [Round_Rect](Round_Rect), [Circle](Circle), [Oval](Oval), [Path](Path), and [Text](Text). 
[Bitmap](Bitmap), [Image](Image), [Patch](Patch), [Region](Region), [Sprite](Sprite), and [Vertex](Vertex) are painted as if [kFill_Style](SkPaint_kFill_Style) is set,
...
[Paint_Style](Paint_Style) is set to [kFill_Style](SkPaint_kFill_Style) by default.
#### <a name="SkPaint_kStroke_Style"></a> Const SkPaint::kStroke_Style 1
[kStroke_Style](SkPaint_kStroke_Style) applies to [Rect](Rect), [Region](Region), [Round_Rect](Round_Rect), [Arc](Arc), [Circle](Circle), [Oval](Oval),
...
and ignore the set [Paint_Style](Paint_Style).
The stroke construction is unaffected by the [Path_Fill_Type](Path_Fill_Type).
#### <a name="SkPaint_kStrokeAndFill_Style"></a> Const SkPaint::kStrokeAndFill_Style 2
[kStrokeAndFill_Style](SkPaint_kStrokeAndFill_Style) applies to [Rect](Rect), [Region](Region), [Round_Rect](Round_Rect), [Circle](Circle), [Oval](Oval), [Path](Path), and [Text](Text).
[Path](Path) is treated as if it is set to [SkPath_kWinding_FillType](SkPath_kWinding_FillType),
and the set [Path_Fill_Type](Path_Fill_Type) is ignored.
...
with [kStrokeAndFill_Style](SkPaint_kStrokeAndFill_Style).
### <a name="SkPaint_anonymous"></a> Enum SkPaint::anonymous
enum{
        [kStyleCount](SkPaint_kStyleCount)= [kStrokeAndFill_Style](SkPaint_kStrokeAndFill_Style)+ 1
};
##

#### <a name="SkPaint_kStyleCount"></a> Const SkPaint::kStyleCount 3
[kStyleCount](SkPaint_kStyleCount) is the number of different [Paint_Style](Paint_Style) values defined.
[kStyleCount](SkPaint_kStyleCount) may be used to verify that [Paint_Style](Paint_Style) is a legal value.
<!--?prettify lang=cc?-->

    <a name="SkPaint_getStyle"></a>Style getStyle() const
...
<fiddle-embed hash="3693fce7864fe4094cb3d3948db8cacf"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setStyle"></a>void setStyle(Style style)
...
<table>
  <tr>
    <td><code><strong>style</strong></code></td> <td>One of: [kFill_Style](SkPaint_kFill_Style), [kStroke_Style](SkPaint_kStroke_Style), [kStrokeAndFill_Style](SkPaint_kStrokeAndFill_Style).
                  Has no effect if style is not a legal [Style](SkPaint_Style) value.
</td>
  </tr>
#
...
<fiddle-embed hash="c7bb6248e4735b8d1a32d02fba40d344"></fiddle-embed>
...
[Path_Fill_Type](Path_Fill_Type) [Path_Effect](Path_Effect) [Style_Fill](Style_Fill) [Style_Stroke](Style_Stroke)
## <a name="Topic_Style_Fill"></a> Style Fill
### See Also

[Path_Fill_Type](Path_Fill_Type)
## <a name="Topic_Style_Stroke"></a> Style Stroke
## <a name="Topic_Stroke_Width"></a> Stroke Width
[Stroke_Width](Stroke_Width) sets the width for stroking. The width is the thickness
of the stroke perpendicular to the path' s direction when the paint' s style is set to [kStroke_Style](SkPaint_kStroke_Style) or [kStrokeAndFill_Style](SkPaint_kStrokeAndFill_Style).
...
<fiddle-embed hash="3832b070eefd62afff5fe375baa86445"></fiddle-embed>

raster gpu
The pixels hit to represent thin lines vary with the angle of the line and the platform' s implementation.
<!--?prettify lang=cc?-->

    <a name="SkPaint_getStrokeWidth"></a>SkScalar getStrokeWidth() const
...
<fiddle-embed hash="983efec8708cec5d0e9bd12d8b950c55"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setStrokeWidth"></a>void setStrokeWidth(SkScalar width)
...
<table>
  <tr>
    <td><code><strong>width</strong></code></td> <td>Zero thickness for [Paint_Hairline](Paint_Hairline); greater than zero for pen thickness. 
                  Has no effect if less than zero.
</td>
  </tr>
#
...
<fiddle-embed hash="4387d63c69fb469fb66668cc15719165"></fiddle-embed>
...
## <a name="Topic_Miter_Limit"></a> Miter Limit
...
[Miter_Limit](Miter_Limit) default value is 4.
The default may be changed at compile time by setting [SkPaintDefaults_MiterLimit](SkPaintDefaults_MiterLimit)
in [SkUserConfig](SkUserConfig). h or as a define supplied by the build environment.
...
<fiddle-embed hash="00badb5eeabf35289325f0754c476f40"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_getStrokeMiter"></a>SkScalar getStrokeMiter() const
...
<fiddle-embed hash="f5715648fe49fe6152ed7753ba41ec1a"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setStrokeMiter"></a>void setStrokeMiter(SkScalar miter)
...
<fiddle-embed hash="f8b9bc2c138950c080bed6ad1a820f44"></fiddle-embed>
...
## <a name="Topic_Stroke_Cap"></a> Stroke Cap
...
enum [Cap](SkPaint_Cap){
        [kButt_Cap](SkPaint_kButt_Cap),
        [kRound_Cap](SkPaint_kRound_Cap),
        [kSquare_Cap](SkPaint_kSquare_Cap),

        [kLast_Cap](SkPaint_kLast_Cap)= [kSquare_Cap](SkPaint_kSquare_Cap),
        [kDefault_Cap](SkPaint_kDefault_Cap)= [kButt_Cap](SkPaint_kButt_Cap)
};
    static constexpr int [kCapCount](SkPaint_kCapCount)= [kLast_Cap](SkPaint_kLast_Cap)+ 1;
##

#### <a name="SkPaint_kButt_Cap"></a> Const SkPaint::kButt_Cap 0
[kButt_Cap](SkPaint_kButt_Cap) does not extend the stroke past the beginning or the end.
#### <a name="SkPaint_kRound_Cap"></a> Const SkPaint::kRound_Cap 1
[kRound_Cap](SkPaint_kRound_Cap) adds a circle with a diameter equal to [Stroke_Width](Stroke_Width) at the beginning
and end.
#### <a name="SkPaint_kSquare_Cap"></a> Const SkPaint::kSquare_Cap 2
[kSquare_Cap](SkPaint_kSquare_Cap) adds a square with sides equal to [Stroke_Width](Stroke_Width) at the beginning
and end. The square sides are parallel to the initial and final direction
of the stroke.
#### <a name="SkPaint_kLast_Cap"></a> Const SkPaint::kLast_Cap 2
[kLast_Cap](SkPaint_kLast_Cap) is equivalent to the largest value for [Stroke_Cap](Stroke_Cap).
#### <a name="SkPaint_kDefault_Cap"></a> Const SkPaint::kDefault_Cap 0
[kDefault_Cap](SkPaint_kDefault_Cap) is equivalent to [kButt_Cap](SkPaint_kButt_Cap).
         [Stroke_Cap](Stroke_Cap) is set to [kButt_Cap](SkPaint_kButt_Cap) by default.
#### <a name="SkPaint_kCapCount"></a> Const SkPaint::kCapCount 3
[kCapCount](SkPaint_kCapCount) is the number of different [Stroke_Cap](Stroke_Cap) values defined.
         [kCapCount](SkPaint_kCapCount) may be used to verify that [Stroke_Cap](Stroke_Cap) is a legal value.
[Paint_Stroke](Paint_Stroke) describes the area covered by a pen of [Stroke_Width](Stroke_Width) as it follows the [Path_Contour](Path_Contour), moving parallel to the contours' s direction.
...
[kRound_Cap](SkPaint_kRound_Cap) and [Zero_Length_Contour](Zero_Length_Contour) draws a circle of diameter [Stroke_Width](Stroke_Width) at the contour point.
...
<fiddle-embed hash="0cab4c079c48e3c277637647d46ce88a"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getStrokeCap"></a>Cap getStrokeCap() const
...
<fiddle-embed hash="753c12ecfc325c7e860ae13a0f045e60"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setStrokeCap"></a>void setStrokeCap(Cap cap)
...
<fiddle-embed hash="88b79a48aaab2990093c057deffb05c6"></fiddle-embed>
...
## <a name="Topic_Stroke_Join"></a> Stroke Join
...
<fiddle-embed hash="620b563d74734c49cc08e6fe07c01090"></fiddle-embed>

### <a name="SkPaint_Join"></a> Enum SkPaint::Join
enum [Join](SkPaint_Join){
        [kMiter_Join](SkPaint_kMiter_Join),
        [kRound_Join](SkPaint_kRound_Join),
        [kBevel_Join](SkPaint_kBevel_Join),

        [kLast_Join](SkPaint_kLast_Join)= [kBevel_Join](SkPaint_kBevel_Join),
        [kDefault_Join](SkPaint_kDefault_Join)= [kMiter_Join](SkPaint_kMiter_Join)
};
    static constexpr int [kJoinCount](SkPaint_kJoinCount)= [kLast_Join](SkPaint_kLast_Join)+ 1;
##
...
The fill path constructed to describe the stroked path respects the join setting but may not contain the actual join. For instance, a fill path constructed with round joins does
not necessarily include circles at each connected segment.

#### <a name="SkPaint_kMiter_Join"></a> Const SkPaint::kMiter_Join 0
[kMiter_Join](SkPaint_kMiter_Join) extends the outside of the to the extent allowed by [Miter_Limit](Miter_Limit).
If the extension exceeds [Miter_Limit](Miter_Limit), [kBevel_Join](SkPaint_kBevel_Join) is used instead.
#### <a name="SkPaint_kRound_Join"></a> Const SkPaint::kRound_Join 1
[kRound_Join](SkPaint_kRound_Join) adds a circle with a diameter of [Stroke_Width](Stroke_Width) at the sharp corner.
#### <a name="SkPaint_kBevel_Join"></a> Const SkPaint::kBevel_Join 2
[kBevel_Join](SkPaint_kBevel_Join) connects the outside edges of the sharp corner.
#### <a name="SkPaint_kLast_Join"></a> Const SkPaint::kLast_Join 2
[kLast_Join](SkPaint_kLast_Join) is equivalent to the largest value for [Stroke_Join](Stroke_Join).
#### <a name="SkPaint_kDefault_Join"></a> Const SkPaint::kDefault_Join 1
[kDefault_Join](SkPaint_kDefault_Join) is equivalent to [kMiter_Join](SkPaint_kMiter_Join).
[Stroke_Join](Stroke_Join) is set to [kMiter_Join](SkPaint_kMiter_Join) by default.
#### <a name="SkPaint_kJoinCount"></a> Const SkPaint::kJoinCount 3
[kJoinCount](SkPaint_kJoinCount) is the number of different [Stroke_Join](Stroke_Join) values defined.
[kJoinCount](SkPaint_kJoinCount) may be used to verify that [Stroke_Join](Stroke_Join) is a legal value.
#### Example

<fiddle-embed hash="93eb98f36614f1159645cf252fe9d3a5"></fiddle-embed>

#### See Also

[setStrokeJoin](SkPaint_setStrokeJoin) [getStrokeJoin](SkPaint_getStrokeJoin) [setStrokeMiter](SkPaint_setStrokeMiter) [getStrokeMiter](SkPaint_getStrokeMiter)
<!--?prettify lang=cc?-->

    <a name="SkPaint_getStrokeJoin"></a>Join getStrokeJoin() const
...
<fiddle-embed hash="841a73f24e10c6678630c179506c0595"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setStrokeJoin"></a>void setStrokeJoin(Join join)
...
<table>
  <tr>
    <td><code><strong>join</strong></code></td> <td>One of: [kMiter_Join](SkPaint_kMiter_Join), [kRound_Join](SkPaint_kRound_Join), [kBevel_Join](SkPaint_kBevel_Join).
                 If join is not a valid, [setStrokeJoin](SkPaint_setStrokeJoin) has no effect.
</td>
  </tr>
#
...
<fiddle-embed hash="693707e991e819a54baa7a3a0404ecee"></fiddle-embed>
...
[Miter_Limit](Miter_Limit)
## <a name="Topic_Fill_Path"></a> Fill Path
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_getFillPath"></a>bool getFillPath(const SkPath& src, SkPath* dst, const SkRect* cullRect,
...
<fiddle-embed hash="53da2db22c88f891a990f12de286bce3"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_getFillPath_2"></a>bool getFillPath(const SkPath& src, SkPath* dst) const
...
<fiddle-embed hash="095d99da76d587b015f7d3b675efc7b8"></fiddle-embed>

---

### See Also

[Style_Stroke](Style_Stroke) [Stroke_Width](Stroke_Width) [Path_Effect](Path_Effect)
## <a name="Topic_Paint_Shader"></a> Paint Shader
...
<fiddle-embed hash="c015dc2010c15e1c00b4f7330232b0f7"></fiddle-embed>
...
<fiddle-embed hash="f45b9765dd06d996921ffa1ef8e78d8a"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getShader"></a>SkShader* getShader() const
...
<fiddle-embed hash="09f15b9fd88882850da2d235eb86292f"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_refShader"></a>sk_sp<SkShader> refShader() const
...
<fiddle-embed hash="53da0295972a418cbc9607bbb17feaa8"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setShader"></a>void setShader(sk_sp<SkShader> shader)
...
<fiddle-embed hash="92996333200d7c0b2158927f7e8439c5"></fiddle-embed>

---

## <a name="Topic_Paint_Color_Filter"></a> Paint Color Filter
...
<fiddle-embed hash="3343ea21abaf9778d35e9953f0a6be10"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getColorFilter"></a>SkColorFilter* getColorFilter() const
...
<fiddle-embed hash="093bdc627d6b59002670fd290931f6c9"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_refColorFilter"></a>sk_sp<SkColorFilter> refColorFilter() const
...
<fiddle-embed hash="be0095f54d59487ef2d2e87457910bc9"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setColorFilter"></a>void setColorFilter(sk_sp<SkColorFilter> filter)
...
<fiddle-embed hash="01e7486180e7d3ecf9a6501e6afeb717"></fiddle-embed>

---

## <a name="Topic_Paint_Blend_Mode"></a> Paint Blend Mode
...
<fiddle-embed hash="73092d4d06faecea3c204d852a4dd8a8"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_getBlendMode"></a>SkBlendMode getBlendMode() const
...
<fiddle-embed hash="4ec1864b8203d52c0810e8605092f45c"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_isSrcOver"></a>bool isSrcOver() const
...
<fiddle-embed hash="257c9473db7a2b3a0fb2b9e2431e59a6"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setBlendMode"></a>void setBlendMode(SkBlendMode mode)
...
## <a name="Topic_Paint_Path_Effect"></a> Paint Path Effect
...
<fiddle-embed hash="5daa7aebf14b7e224d0e1e98798e5e7d"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_getPathEffect"></a>SkPathEffect* getPathEffect() const
...
<fiddle-embed hash="211a1b14bfa6c4332082c8eab4fbc5fd"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_refPathEffect"></a>sk_sp<SkPathEffect> refPathEffect() const
...
<fiddle-embed hash="c24ff92a980a5988697f6ae910560e21"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setPathEffect"></a>void setPathEffect(sk_sp<SkPathEffect> pathEffect)
...
<fiddle-embed hash="52dd55074ca0b7d520d04e750ca2a0d7"></fiddle-embed>

---

## <a name="Topic_Paint_Mask_Filter"></a> Paint Mask Filter
...
<fiddle-embed hash="320b04ea1e1291d49f1e61994a0410fe"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getMaskFilter"></a>SkMaskFilter* getMaskFilter() const
...
<fiddle-embed hash="8cd53ece8fc83e4560599ace094b0f16"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_refMaskFilter"></a>sk_sp<SkMaskFilter> refMaskFilter() const
...
<fiddle-embed hash="ddb211ed3d5e226b0bb973de5076de26"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setMaskFilter"></a>void setMaskFilter(sk_sp<SkMaskFilter> maskFilter)
...
<fiddle-embed hash="62c5a826692f85c3de3bab65e9e97aa9"></fiddle-embed>

---

## <a name="Topic_Paint_Typeface"></a> Paint Typeface
...
<fiddle-embed hash="bb32c82a23a147f528dfbc2e327a3fa4"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getTypeface"></a>SkTypeface* getTypeface() const
...
<fiddle-embed hash="4d9ffb5761b62a9e3bc9b0bca8787bce"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_refTypeface"></a>sk_sp<SkTypeface> refTypeface() const
...
<fiddle-embed hash="c8edce7b36a3ffda8af4fe89d7187dbc"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setTypeface"></a>void setTypeface(sk_sp<SkTypeface> typeface)
...
<fiddle-embed hash="a67efa7096c9b7ff7a4c59aa80310ce9"></fiddle-embed>

---

## <a name="Topic_Paint_Rasterizer"></a> Paint Rasterizer
...
<fiddle-embed hash="196bbd3000a2988ccc5460398cb32f5a"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getRasterizer"></a>SkRasterizer* getRasterizer() const
...
<fiddle-embed hash="0707d407c3a14388b107af8ae5873e55"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_refRasterizer"></a>sk_sp<SkRasterizer> refRasterizer() const
...
<fiddle-embed hash="c0855ce19a33cb7e5747750ef341b7b3"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setRasterizer"></a>void setRasterizer(sk_sp<SkRasterizer> rasterizer)
...
<fiddle-embed hash="181e7a5c63a8652edcdc64b7b957f8ec"></fiddle-embed>

---

## <a name="Topic_Paint_Image_Filter"></a> Paint Image Filter
...
<fiddle-embed hash="4fd19982b82bc27340a507183e39d7d3"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getImageFilter"></a>SkImageFilter* getImageFilter() const
...
<fiddle-embed hash="38788d42772641606e08c60d9dd418a2"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_refImageFilter"></a>sk_sp<SkImageFilter> refImageFilter() const
...
<fiddle-embed hash="0828822500bc17539a248ca16a75ddc7"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setImageFilter"></a>void setImageFilter(sk_sp<SkImageFilter> imageFilter)
...
<fiddle-embed hash="7cac26cde809379c561c3af7af9c74db"></fiddle-embed>

---

## <a name="Topic_Paint_Draw_Looper"></a> Paint Draw Looper
...
<fiddle-embed hash="8de8294eee43c40e41c4cf5f15bb2b40"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getDrawLooper"></a>SkDrawLooper* getDrawLooper() const
...
<fiddle-embed hash="af4c5acc7a91e7f23c2af48018903ad4"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_refDrawLooper"></a>sk_sp<SkDrawLooper> refDrawLooper() const
...
<fiddle-embed hash="bd18a131b759ef38033b0c8cf916d922"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_getLooper"></a>SkDrawLooper* getLooper() const

6259---

<!--?prettify lang=cc?-->

    <a name="SkPaint_setDrawLooper"></a>void setDrawLooper(sk_sp<SkDrawLooper> drawLooper)
...
<fiddle-embed hash="4044a981dc3627c2c5149b0c9869c598"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_setLooper"></a>void setLooper(sk_sp<SkDrawLooper>)

6259---

## <a name="Topic_Paint_Text_Align"></a> Paint Text Align
...
[Paint_Text_Align](Paint_Text_Align) adjusts the glyph position to center it or move it to abut the position using the metrics returned by the font.

[Paint_Text_Align](Paint_Text_Align) defaults to [kLeft_Align](SkPaint_kLeft_Align).

### <a name="SkPaint_Align"></a> Enum SkPaint::Align
enum [Align](SkPaint_Align){
        [kLeft_Align](SkPaint_kLeft_Align),
        [kCenter_Align](SkPaint_kCenter_Align),
        [kRight_Align](SkPaint_kRight_Align),
    };
##

#### <a name="SkPaint_kLeft_Align"></a> Const SkPaint::kLeft_Align 0
[kLeft_Align](SkPaint_kLeft_Align) leaves the glyph at the position computed by the font offset by the text position.
#### <a name="SkPaint_kCenter_Align"></a> Const SkPaint::kCenter_Align 1
[kCenter_Align](SkPaint_kCenter_Align) moves the glyph half its width if [Paint_Flags](Paint_Flags) has [kVerticalText_Flag](SkPaint_kVerticalText_Flag) clear, and
half its height if [Paint_Flags](Paint_Flags) has [kVerticalText_Flag](SkPaint_kVerticalText_Flag) set.
#### <a name="SkPaint_kRight_Align"></a> Const SkPaint::kRight_Align 2
[kRight_Align](SkPaint_kRight_Align) moves the glyph by its width if [Paint_Flags](Paint_Flags) has [kVerticalText_Flag](SkPaint_kVerticalText_Flag) clear,
    and by its height if [Paint_Flags](Paint_Flags) has [kVerticalText_Flag](SkPaint_kVerticalText_Flag) set.
### <a name="SkPaint_anonymous_2"></a> Enum SkPaint::anonymous_2
enum{
        [kAlignCount](SkPaint_kAlignCount)= 3
};
##

#### <a name="SkPaint_kAlignCount"></a> Const SkPaint::kAlignCount 3
[kAlignCount](SkPaint_kAlignCount) is the number of different [Paint_Text_Align](Paint_Text_Align) values defined.
### Example

<fiddle-embed hash="d317346b0bb75ecef4e6d8d94ad08664"></fiddle-embed>

Each position separately moves the glyph in drawPosText.
### Example

<fiddle-embed hash="e003042766521a607dbbaa653a565709"></fiddle-embed>

[Vertical_Text](Vertical_Text) treats [kLeft_Align](SkPaint_kLeft_Align) as top align, and [kRight_Align](SkPaint_kRight_Align) as bottom align.
<!--?prettify lang=cc?-->

    <a name="SkPaint_getTextAlign"></a>Align getTextAlign() const
...
<fiddle-embed hash="70a061ac1c0ce260e1f8ec9f10e37285"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setTextAlign"></a>void    setTextAlign(Align align)
...
<fiddle-embed hash="02967ca885ff7b481070253c86493244"></fiddle-embed>

---

## <a name="Topic_Paint_Text_Size"></a> Paint Text Size
...
<fiddle-embed hash="03cdf48119c978083f658fc8bf4385b7"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getTextSize"></a>SkScalar getTextSize() const

[getTextSize](SkPaint_getTextSize) returns [Paint_Text_Size](Paint_Text_Size) in points.

#### Example

<fiddle-embed hash="5d9555de745276df36e1087187fd7cf4"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_setTextSize"></a>void setTextSize(SkScalar textSize)
...
<fiddle-embed hash="1cf7805047da9c02d21a447006c3fb09"></fiddle-embed>

---

## <a name="Topic_Paint_Text_Scale_X"></a> Paint Text Scale X
...
<fiddle-embed hash="c7ed964e579009590293249ac9c53b89"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getTextScaleX"></a>SkScalar getTextScaleX() const

[getTextScaleX](SkPaint_getTextScaleX) returns [Paint_Text_Scale_X](Paint_Text_Scale_X).

#### Example

<fiddle-embed hash="0afc0838b3e1279b663b7b721b20dfad"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_setTextScaleX"></a>void setTextScaleX(SkScalar scaleX)

[setTextScaleX](SkPaint_setTextScaleX) sets [Paint_Text_Scale_X](Paint_Text_Scale_X).
     
#### Example

<fiddle-embed hash="60b1221813c58876e7a6922832b371aa"></fiddle-embed>

---

## <a name="Topic_Paint_Text_Skew_X"></a> Paint Text Skew X
...
<fiddle-embed hash="b16bfa01960d8d9cd5fa7882fd046ba4"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getTextSkewX"></a>SkScalar getTextSkewX() const

[getTextSkewX](SkPaint_getTextSkewX) returns [Paint_Text_Skew_X](Paint_Text_Skew_X).

#### Example

<fiddle-embed hash="3425475634dab75c0e37bdae44d10cf4"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_setTextSkewX"></a>void setTextSkewX(SkScalar skewX)

[setTextSkewX](SkPaint_setTextSkewX) sets [Paint_Text_Skew_X](Paint_Text_Skew_X).

#### Example

<fiddle-embed hash="e97458d2757bdfa72868f50d7c79ddcc"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_SetTextMatrix"></a>static SkMatrix* SetTextMatrix(SkMatrix* matrix, SkScalar size,
...
<fiddle-embed hash="6617cfa316e85aef183e1661e7d95c5e"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setTextMatrix"></a>SkMatrix* setTextMatrix(SkMatrix* matrix) const
...
<fiddle-embed hash="24d55d886bbd82fff7c8c65085697ca3"></fiddle-embed>
...
## <a name="Topic_Paint_Text_Encoding"></a> Paint Text Encoding
...
enum [TextEncoding](SkPaint_TextEncoding){
        [kUTF8_TextEncoding](SkPaint_kUTF8_TextEncoding),
        [kUTF16_TextEncoding](SkPaint_kUTF16_TextEncoding),
        [kUTF32_TextEncoding](SkPaint_kUTF32_TextEncoding),
        [kGlyphID_TextEncoding](SkPaint_kGlyphID_TextEncoding)
};
##

#### <a name="SkPaint_kUTF8_TextEncoding"></a> Const SkPaint::kUTF8_TextEncoding 0
[kUTF8_TextEncoding](SkPaint_kUTF8_TextEncoding) uses a series of bytes to represent [UTF-8](UTF-8) or [ASCII](ASCII).
#### <a name="SkPaint_kUTF16_TextEncoding"></a> Const SkPaint::kUTF16_TextEncoding 1
[kUTF16_TextEncoding](SkPaint_kUTF16_TextEncoding) uses a series of two byte words to represent most of [Unicode](Unicode).
#### <a name="SkPaint_kUTF32_TextEncoding"></a> Const SkPaint::kUTF32_TextEncoding 2
[kUTF32_TextEncoding](SkPaint_kUTF32_TextEncoding) uses a series of four byte words to represent all of [Unicode](Unicode).
#### <a name="SkPaint_kGlyphID_TextEncoding"></a> Const SkPaint::kGlyphID_TextEncoding 3
[kGlyphID_TextEncoding](SkPaint_kGlyphID_TextEncoding) uses a series of two byte words to represent glyph indices.
### Example

<fiddle-embed hash="8570b90dd0d10749c49cd8ff5f846be1"></fiddle-embed>

<!--?prettify lang=cc?-->

    <a name="SkPaint_getTextEncoding"></a>TextEncoding getTextEncoding() const

[getTextEncoding](SkPaint_getTextEncoding) returns [Paint_Text_Encoding](Paint_Text_Encoding).

#### Example

<fiddle-embed hash="f5277b17a3d17517dee0f54af727238c"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_setTextEncoding"></a>void setTextEncoding(TextEncoding encoding)
...
<fiddle-embed hash="9f34027d218dda8a970ab43484be9c92"></fiddle-embed>
...
## <a name="Topic_Paint_Font_Metrics"></a> Paint Font Metrics
[Paint_Font_Metrics](Paint_Font_Metrics) describe dimensions common to the glyphs in [Paint_Typeface](Paint_Typeface).
The dimensions are computed by [Font_Manager](Font_Manager) from font data and do not take [Paint](Paint) settings other than [Paint_Text_Size](Paint_Text_Size) into account.
...
<fiddle-embed hash="e3e7f0a80becb227b2d4397c5a8771e9"></fiddle-embed>

512
### <a name="SkPaint_FontMetrics"></a> Struct SkPaint::FontMetrics
struct [FontMetrics](SkPaint_FontMetrics) FontMetrics{
        enum [FontMetricsFlags](SkPaint_FontMetrics_FontMetricsFlags){...

        uint32_t [fFlags](SkPaint_FontMetrics_fFlags);
        [SkScalar](SkScalar) [fTop](SkPaint_FontMetrics_fTop);
        [SkScalar](SkScalar) [fAscent](SkPaint_FontMetrics_fAscent);
        [SkScalar](SkScalar) [fDescent](SkPaint_FontMetrics_fDescent);
        [SkScalar](SkScalar) [fBottom](SkPaint_FontMetrics_fBottom);
        [SkScalar](SkScalar) [fLeading](SkPaint_FontMetrics_fLeading);
        [SkScalar](SkScalar) [fAvgCharWidth](SkPaint_FontMetrics_fAvgCharWidth);
        [SkScalar](SkScalar) [fMaxCharWidth](SkPaint_FontMetrics_fMaxCharWidth);
        [SkScalar](SkScalar) [fXMin](SkPaint_FontMetrics_fXMin);
        [SkScalar](SkScalar) [fXMax](SkPaint_FontMetrics_fXMax);
        [SkScalar](SkScalar) [fXHeight](SkPaint_FontMetrics_fXHeight);
        [SkScalar](SkScalar) [fCapHeight](SkPaint_FontMetrics_fCapHeight);
        [SkScalar](SkScalar) [fUnderlineThickness](SkPaint_FontMetrics_fUnderlineThickness);
        [SkScalar](SkScalar) [fUnderlinePosition](SkPaint_FontMetrics_fUnderlinePosition);

        bool [hasUnderlineThickness](SkPaint_FontMetrics_hasUnderlineThickness)(...
        bool [hasUnderlinePosition](SkPaint_FontMetrics_hasUnderlinePosition)(...
    };
##
...
enum [FontMetricsFlags](SkPaint_FontMetrics_FontMetricsFlags){
            [kUnderlineThinknessIsValid_Flag](SkPaint_FontMetrics_kUnderlineThinknessIsValid_Flag)= 1<< 0,
            [kUnderlinePositionIsValid_Flag](SkPaint_FontMetrics_kUnderlinePositionIsValid_Flag)= 1<< 1,
        };
##
...
##### <a name="SkPaint_FontMetrics_kUnderlineThinknessIsValid_Flag"></a> Const SkPaint::FontMetrics_kUnderlineThinknessIsValid_Flag 0x0001
[kUnderlineThinknessIsValid_Flag](SkPaint_FontMetrics_kUnderlineThinknessIsValid_Flag) set in [fFlags](SkPaint_FontMetrics_fFlags) if [fUnderlineThickness](SkPaint_FontMetrics_fUnderlineThickness) is valid.
##### <a name="SkPaint_FontMetrics_kUnderlinePositionIsValid_Flag"></a> Const SkPaint::FontMetrics_kUnderlinePositionIsValid_Flag 0x0002
[kUnderlinePositionIsValid_Flag](SkPaint_FontMetrics_kUnderlinePositionIsValid_Flag) set in [fFlags](SkPaint_FontMetrics_fFlags) if [fUnderlinePosition](SkPaint_FontMetrics_fUnderlinePosition) is valid.
[fFlags](SkPaint_FontMetrics_fFlags) is set when underline metrics are valid.
[fTop](SkPaint_FontMetrics_fTop) is the largest height for any glyph.
        [fTop](SkPaint_FontMetrics_fTop) is a measure from the baseline, and is less than or equal to zero.
[fAscent](SkPaint_FontMetrics_fAscent) is the recommended distance above the baseline to reserve for a line of text.
        [fAscent](SkPaint_FontMetrics_fAscent) is a measure from the baseline, and is less than or equal to zero.
[fDescent](SkPaint_FontMetrics_fDescent) is the recommended distance below the baseline to reserve for a line of text.
        [fDescent](SkPaint_FontMetrics_fDescent) is a measure from the baseline, and is greater than or equal to zero.
[fBottom](SkPaint_FontMetrics_fBottom) is the greatest extent below the baseline for any glyph. 
        [fBottom](SkPaint_FontMetrics_fBottom) is a measure from the baseline, and is greater than or equal to zero.
[fLeading](SkPaint_FontMetrics_fLeading) is the recommended distance to add between lines of text.
        [fLeading](SkPaint_FontMetrics_fLeading) is greater than or equal to zero.
[fAvgCharWidth](SkPaint_FontMetrics_fAvgCharWidth) is the average character width, if it is available.
        [fAvgCharWidth](SkPaint_FontMetrics_fAvgCharWidth) is zero if no average width is stored in the font.
[fMaxCharWidth](SkPaint_FontMetrics_fMaxCharWidth) is the max character width.
[fXMin](SkPaint_FontMetrics_fXMin) is the minimum bounding box x value for all glyphs. [fXMin](SkPaint_FontMetrics_fXMin)
is typically less than zero.
[fXMax](SkPaint_FontMetrics_fXMax) is the maximum bounding box x value for all glyphs. [fXMax](SkPaint_FontMetrics_fXMax)
is typically greater than zero.
[fXHeight](SkPaint_FontMetrics_fXHeight) is the height of a lower-case' x'. [fXHeight](SkPaint_FontMetrics_fXHeight) may be zero
if no lower-case height is stored in the font.
[fCapHeight](SkPaint_FontMetrics_fCapHeight) is the height of an upper-case letter. [fCapHeight](SkPaint_FontMetrics_fCapHeight) may be zero
if no upper-case height is stored in the font.
[fUnderlineThickness](SkPaint_FontMetrics_fUnderlineThickness) is the underline thickness. If the metric
is valid, the [kUnderlineThinknessIsValid_Flag](SkPaint_FontMetrics_kUnderlineThinknessIsValid_Flag) is set in [fFlags](SkPaint_FontMetrics_fFlags).
        If [kUnderlineThinknessIsValid_Flag](SkPaint_FontMetrics_kUnderlineThinknessIsValid_Flag) is clear, [fUnderlineThickness](SkPaint_FontMetrics_fUnderlineThickness) is zero.
[fUnderlinePosition](SkPaint_FontMetrics_fUnderlinePosition) is the underline position relative to the baseline.
...
below the baseline. 
       ...
       If [kUnderlinePositionIsValid_Flag](SkPaint_FontMetrics_kUnderlinePositionIsValid_Flag) is clear, [fUnderlinePosition](SkPaint_FontMetrics_fUnderlinePosition) is zero.
<!--?prettify lang=cc?-->

    <a name="SkPaint_FontMetrics_hasUnderlineThickness"></a>bool hasUnderlineThickness(SkScalar* thickness) const

thickness receives the underline width.

        If [Paint_Font_Metrics](Paint_Font_Metrics) has a valid underline thickness, return true, and set thickness to that value. If it doesn' t, return false, and ignore
thickness.
---

<!--?prettify lang=cc?-->

    <a name="SkPaint_FontMetrics_hasUnderlinePosition"></a>bool hasUnderlinePosition(SkScalar* position) const

position receives the underline offset from the baseline.

        If [Paint_Font_Metrics](Paint_Font_Metrics) has a valid underline position, return true, and set position to that value. If it doesn' t, return false, and ignore
position.
---

<!--?prettify lang=cc?-->

    <a name="SkPaint_getFontMetrics"></a>SkScalar getFontMetrics(FontMetrics* metrics, SkScalar scale = 0) const
...
<fiddle-embed hash="68cd6aefd0012ef68e5986569d588343"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_getFontSpacing"></a>SkScalar getFontSpacing() const
...
<fiddle-embed hash="a67cc9ac54b30e741f1b6b9334ad2ecc"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_getFontBounds"></a>SkRect getFontBounds() const
...
<fiddle-embed hash="6a7b89373d7281a458c275ebb70e8d0e"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_textToGlyphs"></a>int textToGlyphs(const void* text, size_t byteLength,
...
<fiddle-embed hash="bfdd99089bdc3bdd2af67f3b6344b4ef"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_countText"></a>int countText(const void* text, size_t byteLength) const
...
<fiddle-embed hash="6e9152c7aa85b69bb25c90122e0f75a7"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_containsText"></a>bool containsText(const void* text, size_t byteLength) const
...
<fiddle-embed hash="0e4177aaf9931893c6c80070a7bf44c2"></fiddle-embed>
...
<fiddle-embed hash="556776e9b7065168d6640042dde42ab8"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_glyphsToUnichars"></a>void glyphsToUnichars(const SkGlyphID glyphs[], int count, SkUnichar text[]) const
...
## <a name="Topic_Paint_Measure_Text"></a> Paint Measure Text
<!--?prettify lang=cc?-->

    <a name="SkPaint_measureText"></a>SkScalar measureText(const void* text, size_t length, SkRect* bounds) const
...
<fiddle-embed hash="ed96dd912a1cbeeabb21b7ce386da003"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_measureText_2"></a>SkScalar measureText(const void* text, size_t length) const
...
<fiddle-embed hash="1db5db3866773f1fe788b8ef38b7dd71"></fiddle-embed>
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_breakText"></a>size_t  breakText(const void* text, size_t length, SkScalar maxWidth,
...
<fiddle-embed hash="50698c82c7cc4510564cac15efaeef6e"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_getTextWidths"></a>int getTextWidths(const void* text, size_t byteLength, SkScalar widths[],
...
<fiddle-embed hash="31f29360964e867e5569291d9b53a2aa"></fiddle-embed>

---

## <a name="Topic_Paint_Text_Path"></a> Paint Text Path
[Paint_Text_Path](Paint_Text_Path) describes the geometry of glyphs used to draw text.

<!--?prettify lang=cc?-->

    <a name="SkPaint_getTextPath"></a>void getTextPath(const void* text, size_t length, SkScalar x, SkScalar y,
...
<fiddle-embed hash="4419b133092615ede9c32fbc3b567d1c"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_getPosTextPath"></a>void getPosTextPath(const void* text, size_t length,
...
<fiddle-embed hash="f7dc4fad0676d7c6bf0771f406eff51e"></fiddle-embed>

---

## <a name="Topic_Paint_Text_Intercepts"></a> Paint Text Intercepts
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_getTextIntercepts"></a>int getTextIntercepts(const void* text, size_t length, SkScalar x, SkScalar y,
...
<fiddle-embed hash="31dd0970f3200545427390788636fbe4"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_getPosTextIntercepts"></a>int getPosTextIntercepts(const void* text, size_t length, const SkPoint pos[],
...
<fiddle-embed hash="5c7ca6a2c8896e4717d1d7f92526f8aa"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_getPosTextHIntercepts"></a>int getPosTextHIntercepts(const void* text, size_t length, const SkScalar xpos[],
...
<fiddle-embed hash="8f15e8305035afa24224bdc92a4cfb50"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_getTextBlobIntercepts"></a>int getTextBlobIntercepts(const SkTextBlob* blob, const SkScalar bounds[2],
...
<fiddle-embed hash="c4e51f1d95f7ab511c47a6ea6d4a3311"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_nothingToDraw"></a>bool nothingToDraw() const
...
<fiddle-embed hash="2fbbed1e035f836728a74673e6977c28"></fiddle-embed>
...
## <a name="Topic_Paint_Fast_Bounds"></a> Paint Fast Bounds
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_canComputeFastBounds"></a>bool canComputeFastBounds() const
...
<fiddle-embed hash="04311b628fe9828d9ed921a36185db26"></fiddle-embed>

---

<!--?prettify lang=cc?-->

    <a name="SkPaint_computeFastBounds"></a>const SkRect& computeFastBounds(const SkRect& orig, SkRect* storage) const
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_computeFastStrokeBounds"></a>const SkRect& computeFastStrokeBounds(const SkRect& orig,

[SkRect](SkRect)* storage) const
#### Example
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_doComputeFastBounds"></a>const SkRect& doComputeFastBounds(const SkRect& orig, SkRect* storage,
...
<!--?prettify lang=cc?-->
    ...
    <a name="SkPaint_toString"></a>void toString(SkString* str) const;

Converts [Paint](Paint) to machine parsable form in developer mode.

### Example

<fiddle-embed hash="072356aee21483fbb454d01ebf31ef28"></fiddle-embed>
