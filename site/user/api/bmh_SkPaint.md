...
<div style="display: block; font-family: monospace; white-space: pre;margin: 1em 0px 1em; background-color: #ddd;">
...
<table>
  <tr>
    <td><a name="SkPaint_kAntiAlias_Flag"></a> <code><strong>SkPaint::kAntiAlias_Flag</strong></code></td><td>0x0001 </td><td>Controls if <a href="#Anti-alias">Anti-alias</a> is enabled or disabled.</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a name="SkPaint_kAutoHinting_Flag"></a> <code><strong>SkPaint::kAutoHinting_Flag</strong></code></td><td>0x0800</td><td>Controls if <a href="#Forced_Auto-hinting">Forced_Auto-hinting</a> is enabled or disabled.</td>
  </tr>
  <tr>
...
[Filter_Quality](#Filter_Quality) is used in the paint passed as a parameter to[SkCanvas](#SkCanvas)::drawBitmap
...
<table>
  <tr>
    <td><code><strong>a</strong></code></td> <td>The amount of <a href="#Color_Alpha">Color_Alpha</a>, from fully transparent (0) to fully opaque (255).</td>
  </tr>
  <tr>
    <td><code><strong>r</strong></code></td> <td>The amount of <a href="#Color_Red">Color_Red</a>, from no red (0) to full red (255).</td>
  </tr>
  <tr>
    <td><code><strong>g</strong></code></td> <td>The amount of <a href="#Color_Green">Color_Green</a>, from no green (0) to full green (255).</td>
  </tr>
  <tr>
    <td><code><strong>b</strong></code></td> <td>The amount of <a href="#Color_Blue">Color_Blue</a>, from no blue (0) to full blue (255).</td>
  </tr>
</table>
...
<a href="#Bitmap">Bitmap</a>, <a href="#Image">Image</a>, <a href="#Patch">Patch</a>, <a href="#Region">Region</a>, <a href="#Sprite">Sprite</a>, and <a href="#Vertex">Vertex</a> are painted as if <a href="#SkPaint_kFill_Style">kFill_Style</a> is set,
...
static constexpr int [kCapCount](#SkPaint_kCapCount) = [kLast_Cap](#SkPaint_kLast_Cap) + 1;</div>
...
static constexpr int [kJoinCount](#SkPaint_kJoinCount) = [kLast_Join](#SkPaint_kLast_Join) + 1;</div>
...
<div style="display: block; font-family: monospace; white-space: pre;margin: 1em 0px 1em; background-color: #ddd;">
struct [FontMetrics](#SkPaint_FontMetrics) {
