...
Sets <a href="bmh_SkPaint?cl=9919#kAntiAlias_Flag">kAntiAlias_Flag</a> if <a href="bmh_SkPaint?cl=9919#aa">aa</a> is true.
Clears <a href="bmh_SkPaint?cl=9919#kAntiAlias_Flag">kAntiAlias_Flag</a> if <a href="bmh_SkPaint?cl=9919#aa">aa</a> is false.
...
Sets <a href="bmh_SkPaint?cl=9919#kDither_Flag">kDither_Flag</a> if <a href="bmh_SkPaint?cl=9919#dither">dither</a> is true.
Clears <a href="bmh_SkPaint?cl=9919#kDither_Flag">kDither_Flag</a> if <a href="bmh_SkPaint?cl=9919#dither">dither</a> is false.
...
Sets <a href="bmh_SkPaint?cl=9919#kSubpixelText_Flag">kSubpixelText_Flag</a> if <a href="bmh_SkPaint?cl=9919#subpixelText">subpixelText</a> is true.
Clears <a href="bmh_SkPaint?cl=9919#kSubpixelText_Flag">kSubpixelText_Flag</a> if <a href="bmh_SkPaint?cl=9919#subpixelText">subpixelText</a> is false.
...
Sets <a href="bmh_SkPaint?cl=9919#kLCDRenderText_Flag">kLCDRenderText_Flag</a> if <a href="bmh_SkPaint?cl=9919#lcdText">lcdText</a> is true.
Clears <a href="bmh_SkPaint?cl=9919#kLCDRenderText_Flag">kLCDRenderText_Flag</a> if <a href="bmh_SkPaint?cl=9919#lcdText">lcdText</a> is false.
...
as their <a href="bmh_undocumented?cl=9919#Engine">Font_Engine</a>.
<a href="bmh_undocumented?cl=9919#Windows">Windows</a> may, but is not required to, return a bitmap glyph if <a href="bmh_SkPaint?cl=9919#kEmbeddedBitmapText_Flag">kEmbeddedBitmapText_Flag</a> is set.</p></fiddle-embed></div>
...
Sets <a href="bmh_SkPaint?cl=9919#kEmbeddedBitmapText_Flag">kEmbeddedBitmapText_Flag</a> if <a href="bmh_SkPaint?cl=9919#useEmbeddedBitmapText">useEmbeddedBitmapText</a> is true.
Clears <a href="bmh_SkPaint?cl=9919#kEmbeddedBitmapText_Flag">kEmbeddedBitmapText_Flag</a> if <a href="bmh_SkPaint?cl=9919#useEmbeddedBitmapText">useEmbeddedBitmapText</a> is false.

### Parameters

<table>
  <tr>
    <td><code><strong>useEmbeddedBitmapText</strong></code></td> <td>Sets or clears <a href="bmh_SkPaint?cl=9919#kEmbeddedBitmapText_Flag">kEmbeddedBitmapText_Flag</a>.</td>
  </tr>
</table>
...
<table>
  <tr>
    <td><code><strong>verticalText</strong></code></td> <td>Sets or clears <a href="bmh_SkPaint?cl=9919#kVerticalText_Flag">kVerticalText_Flag</a>.</td>
  </tr>
</table>
...
Sets <a href="bmh_SkPaint?cl=9919#kFakeBoldText_Flag">kFakeBoldText_Flag</a> if <a href="bmh_SkPaint?cl=9919#fakeBoldText">fakeBoldText</a> is true.
Clears <a href="bmh_SkPaint?cl=9919#kFakeBoldText_Flag">kFakeBoldText_Flag</a> if <a href="bmh_SkPaint?cl=9919#fakeBoldText">fakeBoldText</a> is false.
...
Sets <a href="bmh_SkPaint?cl=9919#kDevKernText_Flag">kDevKernText_Flag</a> if <a href="bmh_SkPaint?cl=9919#devKernText">devKernText</a> is true.
Clears <a href="bmh_SkPaint?cl=9919#kDevKernText_Flag">kDevKernText_Flag</a> if <a href="bmh_SkPaint?cl=9919#devKernText">devKernText</a> is false.
...
with <a href="bmh_SkPaint?cl=9919#kStrokeAndFill_Style">kStrokeAndFill_Style</a>.
...
The filled equivalent of the stroked path.
Replaces <a href="bmh_SkPaint?cl=9919#dst">dst</a> with the <a href="bmh_SkPaint?cl=9919#src">src</a> path modified by <a href="bmh_undocumented?cl=9919#Path_Effect">Path_Effect</a> and <a href="bmh_SkPaint?cl=9919#Style_Stroke">Style_Stroke</a>.
...
<a href="bmh_SkPaint?cl=9919#Text_Align">Text_Align</a> affects glyphs drawn with: <a href="bmh_SkCanvas?cl=9919#drawText">SkCanvas::drawText</a>, <a href="bmh_SkCanvas?cl=9919#drawPosText">SkCanvas::drawPosText</a>,
...
<div><fiddle-embed name="f550c7bad94785bf9020bfc7b0336fc3"><p><a href="bmh_SkPaint?cl=9919#Vertical_Text">Vertical_Text</a> treats <a href="bmh_SkPaint?cl=9919#kLeft_Align">kLeft_Align</a> as top align, and <a href="bmh_SkPaint?cl=9919#kRight_Align">kRight_Align</a> as bottom align.</p></fiddle-embed></div>
...
<a href="bmh_SkPaint?cl=9919#setTextAlign">setTextAlign</a> sets <a href="bmh_SkPaint?cl=9919#Text_Align">Text_Align</a> to <a href="bmh_SkPaint?cl=9919#align">align</a>.
...
<a href="bmh_SkPaint?cl=9919#setTextEncoding">setTextEncoding</a> sets <a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a> to <a href="bmh_SkPaint?cl=9919#encoding">encoding</a>.
...
<a href="bmh_SkPaint?cl=9919#thickness">thickness</a> receives the underline width.
        If <a href="bmh_SkPaint?cl=9919#Font_Metrics">Font_Metrics</a> has a valid underline <a href="bmh_SkPaint?cl=9919#thickness">thickness</a>, return true, and set 
...
<a href="bmh_SkPaint?cl=9919#position">position</a> receives the underline offset from the baseline.
        If <a href="bmh_SkPaint?cl=9919#Font_Metrics">Font_Metrics</a> has a valid underline <a href="bmh_SkPaint?cl=9919#position">position</a>, return true, and set 
...
If <a href="bmh_SkPaint?cl=9919#metrics">metrics</a> is not nullptr, <a href="bmh_SkPaint?cl=9919#Font_Metrics">Font_Metrics</a> is copied to <a href="bmh_SkPaint?cl=9919#metrics">metrics</a>.
...
<a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a> specifies how <a href="bmh_SkPaint?cl=9919#text">text</a> represents characters or <a href="bmh_SkPaint?cl=9919#glyphs">glyphs</a>.
...
<table>
  <tr>
    <td><code><strong>text</strong></code></td> <td>Character stroage encoded with <a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a>.</td>
  </tr>
  <tr>
...
by <a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a>; the <a href="bmh_SkPaint?cl=9919#text">text</a> values returned are equivalent to <a href="bmh_SkPaint?cl=9919#kUTF32_TextEncoding">kUTF32_TextEncoding</a>.
...
Returns the advance width of <a href="bmh_SkPaint?cl=9919#text">text</a> if <a href="bmh_SkPaint?cl=9919#kVerticalText_Flag">kVerticalText_Flag</a> is clear,
and the height of <a href="bmh_SkPaint?cl=9919#text">text</a> if <a href="bmh_SkPaint?cl=9919#kVerticalText_Flag">kVerticalText_Flag</a> is set.
The advance is the normal distance to move before drawing additional <a href="bmh_SkPaint?cl=9919#text">text</a>.
<a href="bmh_SkPaint?cl=9919#measureText">measureText</a> uses <a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a> to decode <a href="bmh_SkPaint?cl=9919#text">text</a>, <a href="bmh_undocumented?cl=9919#Typeface">Typeface</a> to get the font metrics,
...
Returns the adance width of <a href="bmh_SkPaint?cl=9919#text">text</a> if <a href="bmh_SkPaint?cl=9919#kVerticalText_Flag">kVerticalText_Flag</a> is clear,
and the height of <a href="bmh_SkPaint?cl=9919#text">text</a> if <a href="bmh_SkPaint?cl=9919#kVerticalText_Flag">kVerticalText_Flag</a> is set.
The advance is the normal distance to move before drawing additional <a href="bmh_SkPaint?cl=9919#text">text</a>.
<a href="bmh_SkPaint?cl=9919#measureText">measureText</a> uses <a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a> to decode <a href="bmh_SkPaint?cl=9919#text">text</a>, <a href="bmh_undocumented?cl=9919#Typeface">Typeface</a> to get the font metrics,
...
If <a href="bmh_SkPaint?cl=9919#kVerticalText_Flag">kVerticalText_Flag</a> is clear, the <a href="bmh_SkPaint?cl=9919#text">text</a> fragment fits if its advance width is less than or
equal to <a href="bmh_SkPaint?cl=9919#maxWidth">maxWidth</a>.
If <a href="bmh_SkPaint?cl=9919#kVerticalText_Flag">kVerticalText_Flag</a> is set, the <a href="bmh_SkPaint?cl=9919#text">text</a> fragment fits if its advance height is less than or
equal to <a href="bmh_SkPaint?cl=9919#maxWidth">maxWidth</a>.
...
<a href="bmh_SkPaint?cl=9919#breakText">breakText</a> uses <a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a> to decode <a href="bmh_SkPaint?cl=9919#text">text</a>, <a href="bmh_undocumented?cl=9919#Typeface">Typeface</a> to get the font metrics,
and <a href="bmh_SkPaint?cl=9919#Text_Size">Text_Size</a> to scale the metrics.
...
If <a href="bmh_SkPaint?cl=9919#kVerticalText_Flag">kVerticalText_Flag</a> is clear, <a href="bmh_SkPaint?cl=9919#widths">widths</a> returns the horizontal advance.
If <a href="bmh_SkPaint?cl=9919#kVerticalText_Flag">kVerticalText_Flag</a> is set, <a href="bmh_SkPaint?cl=9919#widths">widths</a> returns the vertical advance.
<a href="bmh_SkPaint?cl=9919#getTextWidths">getTextWidths</a> uses <a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a> to decode <a href="bmh_SkPaint?cl=9919#text">text</a>, <a href="bmh_undocumented?cl=9919#Typeface">Typeface</a> to get the font metrics,
and <a href="bmh_SkPaint?cl=9919#Text_Size">Text_Size</a> to scale the <a href="bmh_SkPaint?cl=9919#widths">widths</a> and <a href="bmh_SkPaint?cl=9919#bounds">bounds</a>.
...
<a href="bmh_SkPaint?cl=9919#getTextWidths">getTextWidths</a> does return include <a href="bmh_SkPaint?cl=9919#Text_Decorations">Text_Decorations</a> and <a href="bmh_undocumented?cl=9919#Path_Effect">Path_Effect</a> in the <a href="bmh_SkPaint?cl=9919#bounds">bounds</a>.
...
<a href="bmh_SkPaint?cl=9919#getTextPath">getTextPath</a> uses <a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a> to decode <a href="bmh_SkPaint?cl=9919#text">text</a>, <a href="bmh_undocumented?cl=9919#Typeface">Typeface</a> to get the glyph paths,
...
<a href="bmh_SkPaint?cl=9919#getTextPath">getTextPath</a> uses <a href="bmh_SkPaint?cl=9919#x">x</a>, <a href="bmh_SkPaint?cl=9919#y">y</a>, and <a href="bmh_SkPaint?cl=9919#Text_Align">Text_Align</a> to position <a href="bmh_SkPaint?cl=9919#path">path</a>.
...
<a href="bmh_SkPaint?cl=9919#getPosTextPath">getPosTextPath</a> uses <a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a> to decode <a href="bmh_SkPaint?cl=9919#text">text</a>, <a href="bmh_undocumented?cl=9919#Typeface">Typeface</a> to get the glyph paths,
and <a href="bmh_SkPaint?cl=9919#Text_Size">Text_Size</a>, <a href="bmh_SkPaint?cl=9919#Text_Decorations">Text_Decorations</a>, and <a href="bmh_undocumented?cl=9919#Path_Effect">Path_Effect</a> to scale and modify the glyph paths.
All of the glyph paths are stored in <a href="bmh_SkPaint?cl=9919#path">path</a>.
<a href="bmh_SkPaint?cl=9919#getPosTextPath">getPosTextPath</a> uses <a href="bmh_SkPaint?cl=9919#pos">pos</a> array and <a href="bmh_SkPaint?cl=9919#Text_Align">Text_Align</a> to position <a href="bmh_SkPaint?cl=9919#path">path</a>.
...
the string. 
<a href="bmh_SkPaint?cl=9919#getTextIntercepts">getTextIntercepts</a> uses <a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a> to decode <a href="bmh_SkPaint?cl=9919#text">text</a>, <a href="bmh_undocumented?cl=9919#Typeface">Typeface</a> to get the glyph paths,
and <a href="bmh_SkPaint?cl=9919#Text_Size">Text_Size</a>, <a href="bmh_SkPaint?cl=9919#Text_Decorations">Text_Decorations</a>, and <a href="bmh_undocumented?cl=9919#Path_Effect">Path_Effect</a> to scale and modify the glyph paths.
<a href="bmh_SkPaint?cl=9919#getTextIntercepts">getTextIntercepts</a> uses <a href="bmh_SkPaint?cl=9919#x">x</a>, <a href="bmh_SkPaint?cl=9919#y">y</a>, and <a href="bmh_SkPaint?cl=9919#Text_Align">Text_Align</a> to position <a href="bmh_SkPaint?cl=9919#intervals">intervals</a>.
...
The return count is zero or a multiple of two, and is at most twice the number of glyphs in
the string. 
<a href="bmh_SkPaint?cl=9919#getPosTextIntercepts">getPosTextIntercepts</a> uses <a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a> to decode <a href="bmh_SkPaint?cl=9919#text">text</a>, <a href="bmh_undocumented?cl=9919#Typeface">Typeface</a> to get the glyph paths,
and <a href="bmh_SkPaint?cl=9919#Text_Size">Text_Size</a>, <a href="bmh_SkPaint?cl=9919#Text_Decorations">Text_Decorations</a>, and <a href="bmh_undocumented?cl=9919#Path_Effect">Path_Effect</a> to scale and modify the glyph paths.
<a href="bmh_SkPaint?cl=9919#getPosTextIntercepts">getPosTextIntercepts</a> uses <a href="bmh_SkPaint?cl=9919#pos">pos</a> array and <a href="bmh_SkPaint?cl=9919#Text_Align">Text_Align</a> to position <a href="bmh_SkPaint?cl=9919#intervals">intervals</a>.
Pass nullptr for <a href="bmh_SkPaint?cl=9919#intervals">intervals</a> to determine the size of the interval array.
<a href="bmh_SkPaint?cl=9919#intervals">intervals</a> are cached to improve performance for multiple calls.
...
The return count is zero or a multiple of two, and is at most twice the number of glyphs in
the string. 
<a href="bmh_SkPaint?cl=9919#getPosTextHIntercepts">getPosTextHIntercepts</a> uses <a href="bmh_SkPaint?cl=9919#Text_Encoding">Text_Encoding</a> to decode <a href="bmh_SkPaint?cl=9919#text">text</a>, <a href="bmh_undocumented?cl=9919#Typeface">Typeface</a> to get the glyph paths,
and <a href="bmh_SkPaint?cl=9919#Text_Size">Text_Size</a>, <a href="bmh_SkPaint?cl=9919#Text_Decorations">Text_Decorations</a>, and <a href="bmh_undocumented?cl=9919#Path_Effect">Path_Effect</a> to scale and modify the glyph paths.
<a href="bmh_SkPaint?cl=9919#getPosTextHIntercepts">getPosTextHIntercepts</a> uses <a href="bmh_SkPaint?cl=9919#xpos">xpos</a> array, <a href="bmh_SkPaint?cl=9919#constY">constY</a>, and <a href="bmh_SkPaint?cl=9919#Text_Align">Text_Align</a> to position <a href="bmh_SkPaint?cl=9919#intervals">intervals</a>.
Pass nullptr for <a href="bmh_SkPaint?cl=9919#intervals">intervals</a> to determine the size of the interval array.
<a href="bmh_SkPaint?cl=9919#intervals">intervals</a> are cached to improve performance for multiple calls.
...
and <a href="bmh_SkPaint?cl=9919#Text_Size">Text_Size</a>, <a href="bmh_SkPaint?cl=9919#Text_Decorations">Text_Decorations</a>, and <a href="bmh_undocumented?cl=9919#Path_Effect">Path_Effect</a> to scale and modify the glyph paths.
<a href="bmh_SkPaint?cl=9919#getPosTextIntercepts">getPosTextIntercepts</a> uses pos array and <a href="bmh_SkPaint?cl=9919#Text_Align">Text_Align</a> to position <a href="bmh_SkPaint?cl=9919#intervals">intervals</a>.
Pass nullptr for <a href="bmh_SkPaint?cl=9919#intervals">intervals</a> to determine the size of the interval array.
<a href="bmh_SkPaint?cl=9919#intervals">intervals</a> are cached to improve performance for multiple calls.
