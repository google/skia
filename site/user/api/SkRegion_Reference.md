...
class <a href='SkRegion_Reference#SkRegion'>SkRegion</a> {
    ...
    SkRegion()<a href='#SkRegion_copy_const_SkRegion'>SkRegion(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>);
    explicit explicit<a href='#SkRegion_copy_const_SkIRect'>SkRegion(const SkIRect& rect)</a>(const <a href='SkIRect_Reference#SkIRect'>SkIRect</a>& <a href='SkRect_Reference#Rect'>rect</a>);
    ~<a href='#SkRegion_empty_constructor'>SkRegion()</a>;
    <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& SkRegion<a href='#SkRegion_copy_operator'>operator=(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>);
    bool bool<a href='#SkRegion_equal1_operator'>operator==(const SkRegion& other) const</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& other) const;
    bool bool<a href='#SkRegion_notequal1_operator'>operator!=(const SkRegion& other) const</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& other) const;
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
<a href='#SkRegion_copy_const_SkRegion'>SkRegion(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>)
</pre>
...
<a href='#SkRegion_setRegion'>setRegion</a> setRegion<a href='#SkRegion_copy_operator'>operator=(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='#SkRegion_copy_const_SkRegion_region'>region</a>)
...
<a href='#SkRegion_empty_constructor'>SkRegion()</a> SkRegion()<a href='#SkRegion_copy_const_SkRegion'>SkRegion(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>) region<a href='#SkRegion_copy_const_SkIRect'>SkRegion(const SkIRect& rect)</a>(const <a href='SkIRect_Reference#SkIRect'>SkIRect</a>& <a href='SkRect_Reference#Rect'>rect</a>) rect<a href='#SkRegion_copy_operator'>operator=(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>)
...
<a href='#SkRegion_set'>set</a> <a href='#SkRegion_swap'>swap</a> swap<a href='#SkRegion_copy_const_SkRegion'>SkRegion(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='#SkRegion_copy_operator_region'>region</a>)
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
bool booloperator==(const SkRegion& other)(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& other)const
</pre>
...
<a href='#SkRegion_notequal1_operator'>operator!=(const SkRegion& other) const</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='#SkRegion_equal1_operator_other'>other</a>) const const<a href='#SkRegion_copy_operator'>operator=(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>)
...
<a href='#SkRegion_equal1_operator'>operator==(const SkRegion& other) const</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='#SkRegion_notequal1_operator_other'>other</a>) const const<a href='#SkRegion_copy_operator'>operator=(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>)
...
<a href='#SkRegion_copy_operator'>operator=(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>) <a href='#SkRegion_swap'>swap</a> swap<a href='#SkRegion_copy_const_SkRegion'>SkRegion(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>)
...
<a href='#SkRegion_swap'>swap()</a> usage has largely been replaced by by<a href='#SkRegion_copy_operator'>operator=(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>).
...
<table>  <tr>    <td><a name='SkRegion_swap_other'><code><strong>other</strong></code></a></td>
    <td><a href='#SkRegion_copy_operator'>operator=(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>) set</td>
  </tr>
</table>
...
<a href='#SkRegion_copy_operator'>operator=(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>) <a href='#SkRegion_set'>set</a> set<a href='#SkRegion_copy_const_SkRegion'>SkRegion(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='SkRegion_Reference#Region'>region</a>)
...
<a href='#SkRegion_isRect'>isRect</a> <a href='#SkRegion_isComplex'>isComplex</a> isComplex<a href='#SkRegion_equal1_operator'>operator==(const SkRegion& other) const</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& other) const
...
<a href='#SkRegion_copy_const_SkIRect'>SkRegion(const SkIRect& rect)</a>(const <a href='SkIRect_Reference#SkIRect'>SkIRect</a>& <a href='#SkRegion_setRect_rect'>rect</a>)
...
<a href='#SkRegion_copy_const_SkIRect'>SkRegion(const SkIRect& rect)</a>(const <a href='SkIRect_Reference#SkIRect'>SkIRect</a>& <a href='SkRect_Reference#Rect'>rect</a>)
...
<a href='#SkRegion_copy_const_SkRegion'>SkRegion(const SkRegion& region)</a>(const <a href='SkRegion_Reference#SkRegion'>SkRegion</a>& <a href='#SkRegion_setRegion_region'>region</a>)
