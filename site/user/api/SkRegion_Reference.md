...
SkRegion  <code>typedef</code> define a data type.
<table style='border-collapse: collapse; width: 62.5em'>
  <tr><th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>Topic</th>
<th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>Description</th></tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkRegion_RunType'>RunType</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>internal data type</td>
  </tr>
</table>

The <a href='#SkRegion'>SkRegion</a> class encapsulates the geometric region used to specify
...
<th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>Description</th></tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkRegion_GetEmptyRegion'>GetEmptyRegion</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>incomplete</td>
  </tr>
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkRegion_UnitTest'>UnitTest</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>incomplete</td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
  ...
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkRegion_debugSetRuns'>debugSetRuns</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>incomplete</td>
  </tr>
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkRegion_dump'>dump</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>incomplete</td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
  ...
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkRegion_validate'>validate</a></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>incomplete</td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
...
Returns true if <a href='#SkRegion_Iterator'>Iterator</a> is pointing to final <a href='SkIRect_Reference#IRect'>IRect</a> in <a href='#Region'>Region</a>.

### Return Value

true if <a href='#SkRegion_Iterator'>Iterator</a> is pointing to final <a href='SkIRect_Reference#IRect'>IRect</a> in <a href='#Region'>Region</a>
...
## <a name='SkRegion_RunType'>Typedef SkRegion::RunType</a>
Internal data type.
...
Exchanges rect array of <a href='#Region'>Region</a> and <a href='#SkRegion_swap_other'>other</a>. <a href='#SkRegion_swap'>swap</a> internally exchanges pointers,
...
and <a href='#SkRegion_setRect'>setRect</a> with dimensionless data make <a href='#Region'>Region</a> mepty.
...
Returns false if either r or <a href='#Region'>Region</a> is empty, or do not intersect.
...
<a name='SkRegion_GetEmptyRegion'></a>
## GetEmptyRegion

<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
static const <a href='#SkRegion'>SkRegion</a>& <a href='#SkRegion_GetEmptyRegion'>GetEmptyRegion</a>()
</pre>
...
<a name='SkRegion_dump'></a>
## dump

<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkRegion_dump'>dump</a>() const
</pre>
...
<a name='SkRegion_validate'></a>
## validate

<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkRegion_validate'>validate</a>() const
</pre>
...
<a name='SkRegion_UnitTest'></a>
## UnitTest

<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
static void <a href='#SkRegion_UnitTest'>UnitTest</a>()
</pre>
...
<a name='SkRegion_debugSetRuns'></a>
## debugSetRuns

<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
bool <a href='#SkRegion_debugSetRuns'>debugSetRuns</a>(const <a href='#SkRegion_RunType'>RunType</a> runs[], int count)
</pre>

### Parameters

<table>  <tr>    <td><a name='SkRegion_debugSetRuns_runs'><code><strong>runs</strong></code></a></td>
    <td>incomplete</td>
  </tr>
  <tr>    <td><a name='SkRegion_debugSetRuns_count'><code><strong>count</strong></code></a></td>
    <td>incomplete</td>
  </tr>
</table>
