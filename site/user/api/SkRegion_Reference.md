...
intersection, difference, and so on; but <a href='SkCanvas_Reference#Canvas'>Canvas</a> allows only intersection and
...
rectangles contained by it, optionally intersecting a bouding rectangle.
