...
Used by <a href="#SkImage_asLegacyBitmap">asLegacyBitmap</a> to specify if <a href="SkBitmap_Reference#Bitmap">Bitmap</a> can be written to.
...
<table>
  ...
  <tr>
    <td><a name="SkImage_kRW_LegacyBitmapMode"> <code><strong>SkImage::kRW_LegacyBitmapMode </strong></code> </a></td><td>1</td><td>Returned bitmap is read-write and mutable. May be deprecated in the future.</td>
  </tr>
</table>
