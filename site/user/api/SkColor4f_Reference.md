...
struct <a href='SkColor4f_Reference#SkRGBA4f'>SkRGBA4f</a> {
    ...
    bool bool<a href='#SkRGBA4f_equal1_operator'>operator==(const SkRGBA4f& other) const</a>(const <a href='SkColor4f_Reference#SkRGBA4f'>SkRGBA4f</a>& other) const;
    bool bool<a href='#SkRGBA4f_notequal1_operator'>operator!=(const SkRGBA4f& other) const</a>(const <a href='SkColor4f_Reference#SkRGBA4f'>SkRGBA4f</a>& other) const;
    <a href='SkColor4f_Reference#SkRGBA4f'>SkRGBA4f</a> SkRGBA4f<a href='#SkRGBA4f_multiply_operator'>operator*(float scale) const</a>(float scale) const;
    <a href='SkColor4f_Reference#SkRGBA4f'>SkRGBA4f</a> SkRGBA4f<a href='#SkRGBA4f_multiply1_operator'>operator*(const SkRGBA4f& scale) const</a>(const <a href='SkColor4f_Reference#SkRGBA4f'>SkRGBA4f</a>& scale) const;
    const float* <a href='#SkRGBA4f_vec'>vec()</a> const;
    float* <a href='#SkRGBA4f_vec'>vec()</a>;
    float float<a href='#SkRGBA4f_array_operator'>operator[](int index) const</a>(int index) const;
    float& float<a href='#SkRGBA4f_array1_operator'>operator[](int index)</a>(int index);
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
bool booloperator==(const SkRGBA4f& other)(const <a href='SkColor4f_Reference#SkRGBA4f'>SkRGBA4f</a>& other)const
</pre>
...
<a href='#SkRGBA4f_notequal1_operator'>operator!=(const SkRGBA4f& other) const</a>(const <a href='SkColor4f_Reference#SkRGBA4f'>SkRGBA4f</a>& <a href='#SkRGBA4f_equal1_operator_other'>other</a>) const
...
<a href='#SkRGBA4f_equal1_operator'>operator==(const SkRGBA4f& other) const</a>(const <a href='SkColor4f_Reference#SkRGBA4f'>SkRGBA4f</a>& <a href='#SkRGBA4f_notequal1_operator_other'>other</a>) const
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
<a href='SkColor4f_Reference#SkRGBA4f'>SkRGBA4f</a> SkRGBA4foperator*(float scale)(float scale)const
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
<a href='SkColor4f_Reference#SkRGBA4f'>SkRGBA4f</a> SkRGBA4foperator*(const SkRGBA4f& scale)(const <a href='SkColor4f_Reference#SkRGBA4f'>SkRGBA4f</a>& scale)const
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
float float<a href='#SkRGBA4f_array1_operator'>operator[](int index)</a>(int index)const
</pre>
