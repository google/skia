...
<div><fiddle-embed name=""gpu="true"><div>The pixels hit to represent thin lines vary with the angle of the 
...
<div><fiddle-embed name=""><div>First line is encoded in UTF-8.
...
<div><fiddle-embed name=""><div>Convert UTF-8 <a href="#SkPaint_glyphsToUnichars_text">text</a> to <a href="#SkPaint_glyphsToUnichars_glyphs">glyphs</a>; then convert <a href="#SkPaint_glyphsToUnichars_glyphs">glyphs</a> to <a href="undocumented#Unichar">Unichar</a> code points.</div></fiddle-embed></div>
