...
<div><fiddle-embed name="87f55e62ec4c3535e1a5d0f1415b20c6"><div>Allocates a three by three bitmap, clears it to white, and draws a black pixel
in the center.
</div>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
virtual ~<a href='SkCanvas_Reference#SkCanvas'>SkCanvas</a>()
</pre>
...
<div><fiddle-embed name="b7bc91ff16c9b9351b2a127f35394b82"><div>Canvas Layer draws into bitmap. saveLayerAlpha sets up an additional
...
<div><fiddle-embed name="a7ac9c21bbabcdeeca00f72a61cd0f3e"><div>Draws "ABC" on the device. Then draws "DEF" in Layer, and reads
...
<table>  <tr>
    ...
    <td>Canvas pixels could not be converted to dstInfo.colorType() or dstInfo.alphaType().</td>
  </tr>  <tr>
    <td>Canvas pixels are not readable; for instance, Canvas is document-based.</td>
  </tr>  <tr>
    <td>dstRowBytes is too small to contain one row of pixels.</td>
  </tr>
</table>
...
<table>  <tr>    <td><a name='SkCanvas_readPixels_dstInfo'><code><strong>dstInfo</strong></code></a></td>
    <td>width, height, Color_Type, and Alpha_Type of dstPixels</td>
  </tr>
  <tr>    <td><a name='SkCanvas_readPixels_dstPixels'><code><strong>dstPixels</strong></code></a></td>
    <td>storage for pixels; dstInfo.height() times dstRowBytes, or larger</td>
  </tr>
  <tr>    <td><a name='SkCanvas_readPixels_dstRowBytes'><code><strong>dstRowBytes</strong></code></a></td>
    <td>size of one destination row; dstInfo.width() times pixel size, or larger</td>
  </tr>
...
<div><fiddle-embed name="481e990e923a0ed34654f4361b94f096"><div>Canvas returned by Raster_Surface has Premultiplied pixel values.
...
<table>  <tr>
    ...
    <td>Canvas pixels could not be converted to pixmap.colorType() or pixmap.alphaType().</td>
  </tr>  <tr>
    <td>Canvas pixels are not readable; for instance, Canvas is document-based.</td>
  </tr>  <tr>
    <td>Pixmap pixels could not be allocated.</td>
  </tr>  <tr>
    <td>pixmap.rowBytes() is too small to contain one row of pixels.</td>
  </tr>
</table>
...
<table>  <tr>    <td><a name='SkCanvas_readPixels_2_pixmap'><code><strong>pixmap</strong></code></a></td>
    <td>storage for pixels copied from Canvas</td>
  </tr>
...
<div><fiddle-embed name="85f199032943b6483722c34a91c4e20f"><div>clear() takes Unpremultiplied input with Color_Alpha equal 0x80
and RGB equal 0x55, 0xAA, 0xFF. RGB is multiplied by Color_Alpha
...
<table>  <tr>
    ...
    <td>Canvas pixels could not be converted to bitmap.colorType() or bitmap.alphaType().</td>
  </tr>  <tr>
    <td>Canvas pixels are not readable; for instance, Canvas is document-based.</td>
  </tr>  <tr>
    <td>bitmap pixels could not be allocated.</td>
  </tr>  <tr>
    <td>bitmap.rowBytes() is too small to contain one row of pixels.</td>
  </tr>
</table>
...
<div><fiddle-embed name="af6dec8ef974aa67bf102f29915bcd6a"><div>clear() takes Unpremultiplied input with Color_Alpha equal 0x80
and RGB equal 0x55, 0xAA, 0xFF. RGB is multiplied by Color_Alpha
to generate Premultiplied value 0x802B5580.
</div>
...
<table>  <tr>
    ...
    <td>pixels could not be converted to Canvas imageInfo().colorType() or
imageInfo().alphaType().</td>
  </tr>  <tr>
    <td>Canvas pixels are not writable; for instance, Canvas is document-based.</td>
  </tr>  <tr>
    <td>rowBytes is too small to contain one row of pixels.</td>
  </tr>
</table>
...
<table>  <tr>    <td><a name='SkCanvas_writePixels_info'><code><strong>info</strong></code></a></td>
    <td>width, height, Color_Type, and Alpha_Type of pixels</td>
  </tr>
  <tr>    <td><a name='SkCanvas_writePixels_pixels'><code><strong>pixels</strong></code></a></td>
    <td>pixels to copy, of size info.height() times rowBytes, or larger</td>
  </tr>
  <tr>    <td><a name='SkCanvas_writePixels_rowBytes'><code><strong>rowBytes</strong></code></a></td>
    <td>size of one row of pixels; info.width() times pixel size, or larger</td>
  </tr>
  <tr>    <td><a name='SkCanvas_writePixels_x'><code><strong>x</strong></code></a></td>
    <td>offset into Canvas writable pixels on x-axis; may be negative</td>
  </tr>
  <tr>    <td><a name='SkCanvas_writePixels_y'><code><strong>y</strong></code></a></td>
    <td>offset into Canvas writable pixels on y-axis; may be negative</td>
  </tr>
</table>
...
<table>  <tr>
    ...
    <td>bitmap does not have allocated pixels.</td>
  </tr>  <tr>
    <td>bitmap pixels could not be converted to Canvas imageInfo().colorType() or
imageInfo().alphaType().</td>
  </tr>  <tr>
    <td>Canvas pixels are not writable; for instance, Canvas is document based.</td>
  </tr>  <tr>
    <td>bitmap pixels are inaccessible; for instance, bitmap wraps a texture.</td>
  </tr>
</table>
...
<table>  <tr>    <td><a name='SkCanvas_writePixels_2_bitmap'><code><strong>bitmap</strong></code></a></td>
    <td>contains pixels copied to Canvas</td>
  </tr>
  <tr>    <td><a name='SkCanvas_writePixels_2_x'><code><strong>x</strong></code></a></td>
    <td>offset into Canvas writable pixels in x; may be negative</td>
  </tr>
  <tr>    <td><a name='SkCanvas_writePixels_2_y'><code><strong>y</strong></code></a></td>
    <td>offset into Canvas writable pixels in y; may be negative</td>
  </tr>
</table>
...
<div><fiddle-embed name="bb1dbfdca3aedf716beb6f07e2aab065"><div>Draw to ever smaller clips; then restore drawing to full canvas.
...
<div><fiddle-embed name="9f563a2d60aa31d4b26742e5aa17aa4e"><div>While clipRect is given the same rectangle twice, Matrix makes the second
...
<div><fiddle-embed name="42318b18d403e17e07a541652da91ee2"><div>Rectangles are blurred by Image_Filter when restore() draws Layer to main
Canvas.
</div></fiddle-embed></div>
...
<div><fiddle-embed name="a17aec3aa4909527be039e26a7eda694"><div>Rectangles are blurred by Image_Filter when restore() draws Layer to main Canvas.
...
<a href='#SkCanvas_SaveLayerFlags'>SaveLayerFlags</a> provides options that may be used in any combination in SaveLayerRec,
...
<div><fiddle-embed name="05db6a937225e8e31ae3481173d25dae"><div>Canvas Layer captures red and blue circles scaled up by four.
...
<table>  <tr>    <td><a name='SkCanvas_SaveLayerRec_const_SkRect_star_const_SkPaint_star_const_SkImageFilter_star_const_SkImage_star_const_SkMatrix_star_bounds'><code><strong>bounds</strong></code></a></td>
  ...
  <tr>    <td><a name='SkCanvas_SaveLayerRec_const_SkRect_star_const_SkPaint_star_const_SkImageFilter_star_const_SkImage_star_const_SkMatrix_star_paint'><code><strong>paint</strong></code></a></td>
    <td>graphics state applied to Layer when overlaying prior
Layer; may be nullptr
  ...
  <tr>    <td><a name='SkCanvas_SaveLayerRec_const_SkRect_star_const_SkPaint_star_const_SkImageFilter_star_const_SkImage_star_const_SkMatrix_star_backdrop'><code><strong>backdrop</strong></code></a></td>
    <td>prior Layer copied with Image_Filter;
may be nullptr
</td>
  </tr>
  <tr>    <td><a name='SkCanvas_SaveLayerRec_const_SkRect_star_const_SkPaint_star_const_SkImageFilter_star_const_SkImage_star_const_SkMatrix_star_clipMask'><code><strong>clipMask</strong></code></a></td>
    <td>clip applied to Layer; may be nullptr</td>
  </tr>
  <tr>    <td><a name='SkCanvas_SaveLayerRec_const_SkRect_star_const_SkPaint_star_const_SkImageFilter_star_const_SkImage_star_const_SkMatrix_star_clipMatrix'><code><strong>clipMatrix</strong></code></a></td>
    <td>matrix applied to clipMask; may be nullptr to use
identity matrix
</td>
  </tr>
  <tr>    <td><a name='SkCanvas_SaveLayerRec_const_SkRect_star_const_SkPaint_star_const_SkImageFilter_star_const_SkImage_star_const_SkMatrix_star_saveLayerFlags'><code><strong>saveLayerFlags</strong></code></a></td>
    <td>SaveLayerRec options to modify Layer</td>
  </tr>
</table>
...
<div><fiddle-embed name="7d3751e82d1b6ec328ffa3d6f48ca831"><div>The example draws an image, and saves it into a Layer with kInitWithPrevious_SaveLayerFlag.
...
<div><fiddle-embed name="eb93d5fa66a5f7a10f4f9210494d7222"><div>scale() followed by translate() produces different results from translate() followed
by scale().
...
<div><fiddle-embed name="963789ac8498d4e505748ab3b15cdaa5"><div>Draw clock hands at time 5:10. The hour hand and minute hand point up and
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_setMatrix'>setMatrix</a>(const SkMatrix& matrix)
</pre>
...
<div><fiddle-embed name="862cc026601a41a58df49c0b9f0d7777"><div>Draw a red circle with an Aliased clip and an Anti_Aliased clip.
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_clipRect'>clipRect</a>(const SkRect& rect, SkClipOp op, bool doAntiAlias)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_clipRect'>clipRect</a>(const SkRect& rect, SkClipOp op)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_clipRect'>clipRect</a>(const SkRect& rect, bool doAntiAlias = false)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_androidFramework_setDeviceClipRestriction'>androidFramework_setDeviceClipRestriction</a>(const SkIRect& rect)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_clipRRect'>clipRRect</a>(const SkRRect& rrect, SkClipOp op, bool doAntiAlias)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_clipRRect'>clipRRect</a>(const SkRRect& rrect, SkClipOp op)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_clipRRect'>clipRRect</a>(const SkRRect& rrect, bool doAntiAlias = false)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_clipPath'>clipPath</a>(const SkPath& path, SkClipOp op, bool doAntiAlias)
</pre>
...
<div><fiddle-embed name="ee47ae6b813bfaa55e1a7b7c053ed60d"><div>Top figure uses SkPath::kInverseWinding_FillType and SkClipOp::kDifference;
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_clipPath'>clipPath</a>(const SkPath& path, SkClipOp op)
</pre>
...
<div><fiddle-embed name="7856755c1bf8431c286c734b353345ad"><div>Overlapping Rects form a clip. When clip Path_Fill_Type is set to
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_clipPath'>clipPath</a>(const SkPath& path, bool doAntiAlias = false)
</pre>
...
<div><fiddle-embed name="187a7ae77a8176e417181411988534b6"><div>Clip loops over itself covering its center twice. When clip Path_Fill_Type
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_clipRegion'>clipRegion</a>(const SkRegion& deviceRgn, SkClipOp op = SkClipOp::kIntersect)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
bool <a href='#SkCanvas_quickReject'>quickReject</a>(const SkRect& rect) const
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
bool <a href='#SkCanvas_quickReject'>quickReject</a>(const SkPath& path) const
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
<a href='SkRect_Reference#SkRect'>SkRect</a> getLocalClipBounds() const
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
bool <a href='#SkCanvas_getLocalClipBounds'>getLocalClipBounds</a>(SkRect* bounds) const
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
<a href='SkIRect_Reference#SkIRect'>SkIRect</a> getDeviceClipBounds() const
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
bool <a href='#SkCanvas_getDeviceClipBounds'>getDeviceClipBounds</a>(SkIRect* bounds) const
</pre>
...
<div><fiddle-embed name="30823cb4edf884d330285ea161664931"><div>Outer Rect has no corner radii, but stroke join is rounded.
...
<a href='#SkCanvas_drawImage'>drawImage</a>, drawImageRect, and drawImageNine can be called with a bare pointer or
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawImage'>drawImage</a>(const sk_sp&lt;SkImage&gt;& image, SkScalar left, SkScalar top,
...
<a href='#SkCanvas_SrcRectConstraint'>SrcRectConstraint</a> controls the behavior at the edge of source Rect,
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawImageRect'>drawImageRect</a>(const SkImage* image, const SkRect& src, const SkRect& dst, const SkPaint* paint,
...
<div><fiddle-embed name="bfd18e9cac896cdf94c9f154ccf94be8"><div>The left bitmap draws with Paint default kNone_SkFilterQuality, and stays within
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawImageRect'>drawImageRect</a>(const SkImage* image, const SkIRect& isrc, const SkRect& dst, const SkPaint* paint,
                   SrcRectConstraint constraint = kStrict_SrcRectConstraint)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawImageRect'>drawImageRect</a>(const SkImage* image, const SkRect& dst, const SkPaint* paint)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawImageRect'>drawImageRect</a>(const sk_sp&lt;SkImage&gt;& image, const SkRect& src, const SkRect& dst,
...
<div><fiddle-embed name="d4b35a9d24c32c042bd1f529b8de3c0d"><div>Canvas scales and translates; transformation from src to dst also scales.
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawImageRect'>drawImageRect</a>(const sk_sp&lt;SkImage&gt;& image, const SkIRect& isrc, const SkRect& dst,
                   const SkPaint* paint, SrcRectConstraint constraint = kStrict_SrcRectConstraint)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawImageRect'>drawImageRect</a>(const sk_sp&lt;SkImage&gt;& image, const SkRect& dst, const SkPaint* paint)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawImageNine'>drawImageNine</a>(const SkImage* image, const SkIRect& center, const SkRect& dst,
                   const SkPaint* paint = nullptr)
</pre>
...
<div><fiddle-embed name="4f153cf1d0dbe1a95acf5badeec14dae"><div>The leftmost image is smaller than center; only corners are drawn, all scaled to fit.
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawImageNine'>drawImageNine</a>(const sk_sp&lt;SkImage&gt;& image, const SkIRect& center, const SkRect& dst,
                   const SkPaint* paint = nullptr)
</pre>
...
<div><fiddle-embed name="d597d9af8d17fd93e634dd12017058e2"><div>The two leftmost images has four corners and sides to the left and right of center.
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawBitmap'>drawBitmap</a>(const SkBitmap& bitmap, SkScalar left, SkScalar top, const SkPaint* paint = nullptr)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawBitmapRect'>drawBitmapRect</a>(const SkBitmap& bitmap, const SkRect& src, const SkRect& dst,
                    const SkPaint* paint, SrcRectConstraint constraint = kStrict_SrcRectConstraint)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawBitmapRect'>drawBitmapRect</a>(const SkBitmap& bitmap, const SkIRect& isrc, const SkRect& dst,
                    const SkPaint* paint, SrcRectConstraint constraint = kStrict_SrcRectConstraint)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawBitmapRect'>drawBitmapRect</a>(const SkBitmap& bitmap, const SkRect& dst, const SkPaint* paint,
                    SrcRectConstraint constraint = kStrict_SrcRectConstraint)
</pre>
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawBitmapNine'>drawBitmapNine</a>(const SkBitmap& bitmap, const SkIRect& center, const SkRect& dst,
                    const SkPaint* paint = nullptr)
</pre>
...
<table>  <tr>    <td><a name='SkCanvas_drawBitmapNine_bitmap'><code><strong>bitmap</strong></code></a></td>
    <td>Bitmap containing pixels, dimensions, and format</td>
  </tr>
...
<div><fiddle-embed name="e99e7be0d8f67dfacbecf85df585433d"><div>The two leftmost bitmap draws has four corners and sides to the left and right of center.
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawBitmapLattice'>drawBitmapLattice</a>(const SkBitmap& bitmap, const Lattice& lattice, const SkRect& dst,
                       const SkPaint* paint = nullptr)
</pre>
...
<div><fiddle-embed name="c5bfa944e17ba4a4400dc799f032069c"><div>The two leftmost bitmap draws has four corners and sides to the left and right of center.
The leftmost bitmap draw scales the width of corners proportionately to fit.
...
<pre style="padding: 1em 1em 1em 1em; width: 62.5em;background-color: #f0f0f0">
void <a href='#SkCanvas_drawImageLattice'>drawImageLattice</a>(const SkImage* image, const Lattice& lattice, const SkRect& dst,
                      const SkPaint* paint = nullptr)
</pre>
...
<div><fiddle-embed name="55f5e59350622c5e2834d1c85789f732"><div>The same text is drawn varying Paint_Text_Size and varying
Matrix.
</div></fiddle-embed></div>
...
<a href='#SkCanvas_drawTextBlob_blob'>blob</a> contains <a href='undocumented#Glyph'>Glyphs</a>, their positions, and <a href='#SkCanvas_drawTextBlob_paint'>paint</a> attributes specific to <a href='undocumented#Text'>text</a>: <a href='undocumented#Typeface'>Typeface</a>, Paint_Text_Size, Paint_Text_Scale_X,
...
<table>  <tr>    <td><a name='SkCanvas_drawTextBlob_blob'><code><strong>blob</strong></code></a></td>
    <td>Glyphs, positions, and their paints' text size, typeface, and so on</td>
  </tr>
  <tr>    <td><a name='SkCanvas_drawTextBlob_x'><code><strong>x</strong></code></a></td>
    <td>horizontal offset applied to blob</td>
  </tr>
  <tr>    <td><a name='SkCanvas_drawTextBlob_y'><code><strong>y</strong></code></a></td>
    <td>vertical offset applied to blob</td>
  </tr>
...
<a href='#SkCanvas_drawTextBlob_2_blob'>blob</a> contains <a href='undocumented#Glyph'>Glyphs</a>, their positions, and <a href='#SkCanvas_drawTextBlob_2_paint'>paint</a> attributes specific to <a href='undocumented#Text'>text</a>: Typeface, Paint_Text_Size, Paint_Text_Scale_X,
Paint_Text_Skew_X, Paint_Text_Align, Paint_Hinting, Anti_Alias, Paint_Fake_Bold,
Font_Embedded_Bitmaps, Full_Hinting_Spacing, LCD_Text, Linear_Text,
and Subpixel_Text
.
...
<div><fiddle-embed name="af4c69fbbd165c8b0eb0c9bd49ccbd8d"><div>Paint attributes unrelated to text, like color, have no effect on paint in allocated Text_Blob.
