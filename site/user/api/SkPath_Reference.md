...
public:
    enum <a href='#SkPath_Direction'>Direction</a> {
        <a href='#SkPath_kCW_Direction'>kCW Direction</a>,  //!< contour travels clockwise
        <a href='#SkPath_kCCW_Direction'>kCCW Direction</a>, //!< contour travels counterclockwise
    };
    ...
    friend SK_API bool <a href='#SkPath_equal_operator'>operator==(const SkPath& a, const SkPath& b)</a>;
    friend bool <a href='#SkPath_notequal_operator'>operator!=(const SkPath& a, const SkPath& b)</a>;
    bool <a href='#SkPath_isInterpolatable'>isInterpolatable</a>( <a href='#SkPath'>SkPath</a>& ) const;
    bool <a href='#SkPath_interpolate'>interpolate</a>( <a href='#SkPath'>SkPath</a>& , <a href='undocumented#SkScalar'>SkScalar</a>, <a href='#SkPath'>SkPath</a>* ) const;
    ...
    void <a href='#SkPath_setFillType'>setFillType</a>(<a href='#SkPath_FillType'>FillType</a>);
    ...
    void <a href='#SkPath_setConvexity'>setConvexity</a>(<a href='#SkPath_Convexity'>Convexity</a>);
    bool <a href='#SkPath_isConvex'>isConvex</a>() const;
    bool <a href='#SkPath_isOval'>isOval</a>(<a href='SkRect_Reference#SkRect'>SkRect</a>* ) const;
    bool <a href='#SkPath_isRRect'>isRRect</a>(<a href='SkRRect_Reference#SkRRect'>SkRRect</a>* ) const;
    ...
    void <a href='#SkPath_setIsVolatile'>setIsVolatile</a>();
    static bool <a href='#SkPath_IsLineDegenerate'>IsLineDegenerate</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,  <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& , );
    static bool <a href='#SkPath_IsQuadDegenerate'>IsQuadDegenerate</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,  <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,
                                  <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& , );
    static bool <a href='#SkPath_IsCubicDegenerate'>IsCubicDegenerate</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,  <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,
                                   <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,  <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& , );
    bool <a href='#SkPath_isLine'>isLine</a>(<a href='SkPoint_Reference#SkPoint'>SkPoint</a>[2]) const;
    int <a href='#SkPath_countPoints'>countPoints</a>() const;
    <a href='SkPoint_Reference#SkPoint'>SkPoint</a> <a href='#SkPath_getPoint'>getPoint</a>() const;
    int <a href='#SkPath_getPoints'>getPoints</a>(<a href='SkPoint_Reference#SkPoint'>SkPoint</a>[], ) const;
    int <a href='#SkPath_countVerbs'>countVerbs</a>() const;
    int <a href='#SkPath_getVerbs'>getVerbs</a>([], ) const;
    ...
    bool <a href='#SkPath_conservativelyContainsRect'>conservativelyContainsRect</a>( <a href='SkRect_Reference#SkRect'>SkRect</a>& ) const;
    void <a href='#SkPath_incReserve'>incReserve</a>();
    void <a href='#SkPath_shrinkToFit'>shrinkToFit</a>();
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_moveTo'>moveTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_moveTo_2'>moveTo</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_rMoveTo'>rMoveTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_lineTo'>lineTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_lineTo_2'>lineTo</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_rLineTo'>rLineTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_quadTo'>quadTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_quadTo_2'>quadTo</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,  <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_rQuadTo'>rQuadTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_conicTo'>conicTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>,
                    <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_conicTo_2'>conicTo</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,  <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& , <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_rConicTo'>rConicTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>,
                     <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_cubicTo'>cubicTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>,
                    <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_cubicTo_2'>cubicTo</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,  <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,  <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_rCubicTo'>rCubicTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>,
                     <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_arcTo'>arcTo</a>( <a href='SkRect_Reference#SkRect'>SkRect</a>& , <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_arcTo_2'>arcTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_arcTo_3'>arcTo</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>,  <a href='SkPoint_Reference#SkPoint'>SkPoint</a>, <a href='undocumented#SkScalar'>SkScalar</a>);

    enum <a href='#SkPath_ArcSize'>ArcSize</a> {
        <a href='#SkPath_kSmall_ArcSize'>kSmall ArcSize</a>, //!< smaller of arc pair
        <a href='#SkPath_kLarge_ArcSize'>kLarge ArcSize</a>, //!< larger of arc pair
    };

    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_arcTo_4'>arcTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='#SkPath_ArcSize'>ArcSize</a>,
                  <a href='#SkPath_Direction'>Direction</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_arcTo_5'>arcTo</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='#SkPath_ArcSize'>ArcSize</a>, <a href='#SkPath_Direction'>Direction</a>,
                <a href='SkPoint_Reference#SkPoint'>SkPoint</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_rArcTo'>rArcTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='#SkPath_ArcSize'>ArcSize</a>,
                   <a href='#SkPath_Direction'>Direction</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_close'>close</a>();
    static bool <a href='#SkPath_IsInverseFillType'>IsInverseFillType</a>(<a href='#SkPath_FillType'>FillType</a>);
    static <a href='#SkPath_FillType'>FillType</a> <a href='#SkPath_ConvertToNonInverseFillType'>ConvertToNonInverseFillType</a>(<a href='#SkPath_FillType'>FillType</a>);
    static int <a href='#SkPath_ConvertConicToQuads'>ConvertConicToQuads</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,  <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,  <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& ,
                                   <a href='undocumented#SkScalar'>SkScalar</a>, <a href='SkPoint_Reference#SkPoint'>SkPoint</a>[], );
    bool <a href='#SkPath_isRect'>isRect</a>(<a href='SkRect_Reference#SkRect'>SkRect</a>* , *  = , <a href='#SkPath_Direction'>Direction</a>*  = ) const;
    bool <a href='#SkPath_isNestedFillRects'>isNestedFillRects</a>(<a href='SkRect_Reference#SkRect'>SkRect</a>[2], <a href='#SkPath_Direction'>Direction</a>[2] = ) const;
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addRect'>addRect</a>( <a href='SkRect_Reference#SkRect'>SkRect</a>& , <a href='#SkPath_Direction'>Direction</a> = );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addRect_2'>addRect</a>( <a href='SkRect_Reference#SkRect'>SkRect</a>& , <a href='#SkPath_Direction'>Direction</a>, );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addRect_3'>addRect</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>,
                    <a href='#SkPath_Direction'>Direction</a> = );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addOval'>addOval</a>( <a href='SkRect_Reference#SkRect'>SkRect</a>& , <a href='#SkPath_Direction'>Direction</a> = );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addOval_2'>addOval</a>( <a href='SkRect_Reference#SkRect'>SkRect</a>& , <a href='#SkPath_Direction'>Direction</a>, );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addCircle'>addCircle</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>,
                      <a href='#SkPath_Direction'>Direction</a> = );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addArc'>addArc</a>( <a href='SkRect_Reference#SkRect'>SkRect</a>& , <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addRoundRect'>addRoundRect</a>( <a href='SkRect_Reference#SkRect'>SkRect</a>& , <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>,
                         <a href='#SkPath_Direction'>Direction</a> = );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addRoundRect_2'>addRoundRect</a>( <a href='SkRect_Reference#SkRect'>SkRect</a>& ,  <a href='undocumented#SkScalar'>SkScalar</a>[],
                         <a href='#SkPath_Direction'>Direction</a> = );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addRRect'>addRRect</a>( <a href='SkRRect_Reference#SkRRect'>SkRRect</a>& , <a href='#SkPath_Direction'>Direction</a> = );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addRRect_2'>addRRect</a>( <a href='SkRRect_Reference#SkRRect'>SkRRect</a>& , <a href='#SkPath_Direction'>Direction</a>, );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addPoly'>addPoly</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>[], , );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addPoly_2'>addPoly</a>(<<a href='SkPoint_Reference#SkPoint'>SkPoint</a>>& , );

    enum <a href='#SkPath_AddPathMode'>AddPathMode</a> {
        <a href='#SkPath_kAppend_AddPathMode'>kAppend AddPathMode</a>, //!< appended to destination unaltered
        <a href='#SkPath_kExtend_AddPathMode'>kExtend AddPathMode</a>, //!< add line if prior contour is not closed
    };

    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addPath'>addPath</a>( <a href='#SkPath'>SkPath</a>& , <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>,
                    <a href='#SkPath_AddPathMode'>AddPathMode</a> = );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addPath_2'>addPath</a>( <a href='#SkPath'>SkPath</a>& , <a href='#SkPath_AddPathMode'>AddPathMode</a> = );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addPath_3'>addPath</a>( <a href='#SkPath'>SkPath</a>& ,  <a href='SkMatrix_Reference#SkMatrix'>SkMatrix</a>& ,
                    <a href='#SkPath_AddPathMode'>AddPathMode</a> = );
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_reverseAddPath'>reverseAddPath</a>( <a href='#SkPath'>SkPath</a>& );
    void <a href='#SkPath_offset'>offset</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='#SkPath'>SkPath</a>* ) const;
    void <a href='#SkPath_offset_2'>offset</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    void <a href='#SkPath_transform'>transform</a>( <a href='SkMatrix_Reference#SkMatrix'>SkMatrix</a>& , <a href='#SkPath'>SkPath</a>* ) const;
    void <a href='#SkPath_transform_2'>transform</a>( <a href='SkMatrix_Reference#SkMatrix'>SkMatrix</a>& );
    bool <a href='#SkPath_getLastPt'>getLastPt</a>(<a href='SkPoint_Reference#SkPoint'>SkPoint</a>* ) const;
    void <a href='#SkPath_setLastPt'>setLastPt</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>);
    void <a href='#SkPath_setLastPt_2'>setLastPt</a>( <a href='SkPoint_Reference#SkPoint'>SkPoint</a>& );

    enum <a href='#SkPath_SegmentMask'>SegmentMask</a> {
        <a href='#SkPath_kLine_SegmentMask'>kLine SegmentMask</a>  = 1 << 0, //!< contains one or more lines
        <a href='#SkPath_kQuad_SegmentMask'>kQuad SegmentMask</a>  = 1 << 1, //!< contains one or more quads
        <a href='#SkPath_kConic_SegmentMask'>kConic SegmentMask</a> = 1 << 2, //!< contains one or more conics
        <a href='#SkPath_kCubic_SegmentMask'>kCubic SegmentMask</a> = 1 << 3, //!< contains one or more cubics
    };

    uint32_t <a href='#SkPath_getSegmentMasks'>getSegmentMasks</a>() const;

    enum <a href='#SkPath_Verb'>Verb</a> {
        <a href='#SkPath_kMove_Verb'>kMove Verb</a>,  //!< starts new contour at next <a href='SkPoint_Reference#SkPoint'>SkPoint</a>
        <a href='#SkPath_kLine_Verb'>kLine Verb</a>,  //!< adds line from last point to next <a href='SkPoint_Reference#SkPoint'>SkPoint</a>
        <a href='#SkPath_kQuad_Verb'>kQuad Verb</a>,  //!< adds quad from last point
        <a href='#SkPath_kConic_Verb'>kConic Verb</a>, //!< adds conic from last point
        <a href='#SkPath_kCubic_Verb'>kCubic Verb</a>, //!< adds cubic from last point
        <a href='#SkPath_kClose_Verb'>kClose Verb</a>, //!< closes contour
        <a href='#SkPath_kDone_Verb'>kDone Verb</a>,  //!< terminates <a href='#SkPath'>SkPath</a>
    };

    class SK_API <a href='#SkPath_Iter'>Iter</a> {
    public:
        <a href='#SkPath_Iter_Iter'>Iter</a>();
        <a href='#SkPath_Iter_const_SkPath'>Iter</a>( <a href='#SkPath'>SkPath</a>& , );
        void setPath(const SkPath& path, bool forceClose);
        <a href='#SkPath_Verb'>Verb</a> next(SkPoint pts[4], bool doConsumeDegenerates = true, bool exact = false);
        <a href='undocumented#SkScalar'>SkScalar</a> conicWeight() const;
        bool isCloseLine() const;
        bool isClosedContour() const;
    };

    class SK_API <a href='#SkPath_RawIter'>RawIter</a> {
    public:
        <a href='#SkPath_RawIter_RawIter'>RawIter</a>();
        <a href='#SkPath_RawIter_copy_const_SkPath'>RawIter</a>( <a href='#SkPath'>SkPath</a>& );
        void setPath(const SkPath& path);
        <a href='#SkPath_Verb'>Verb</a> next(SkPoint pts[4]);
        <a href='#SkPath_Verb'>Verb</a> peek() const;
        <a href='undocumented#SkScalar'>SkScalar</a> conicWeight() const;
    };

    bool <a href='#SkPath_contains'>contains</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>) const;
    void <a href='#SkPath_dump'>dump</a>(<a href='SkWStream_Reference#SkWStream'>SkWStream</a>* , , ) const;
    void <a href='#SkPath_dump_2'>dump</a>() const;
    void <a href='#SkPath_dumpHex'>dumpHex</a>() const;
    size_t <a href='#SkPath_writeToMemory'>writeToMemory</a>(* ) const;
    <a href='undocumented#sk_sp'>sk sp</a><<a href='undocumented#SkData'>SkData</a>> <a href='#SkPath_serialize'>serialize</a>() const;
    size_t <a href='#SkPath_readFromMemory'>readFromMemory</a>(* , );
...
<a name='SkPath'></a><a href='#Path'>Paths</a> contain geometry. <a href='#Path'>Paths</a> may be empty, or contain one or more <a href='#Verb'>Verbs</a> that
...
SkPath defines related constants are using <code>enum</code>, <code>enum class</code>,  <code>#define</code>, <code>const</code>, and <code>constexpr</code>.
<table style='border-collapse: collapse; width: 62.5em'>
...
SkPath can be constructed or initialized by these functions, including <code>class</code> constructors.
<table style='border-collapse: collapse; width: 62.5em'>
...
SkPath defines member functions with arithmetic equivalents.
<table style='border-collapse: collapse; width: 62.5em'>
...
Description</th></tr>
  ...
  <tr>
    ...
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_dump'>void dump(SkWStream* stream, bool forceClose, bool dumpAsHex) const</a></td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_dump_2'>void dump() const</a></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_setLastPt'>void setLastPt(SkScalar x, SkScalar y)</a></td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
...
Description</th></tr>
  ...
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addOval'>SkPath& addOval(const SkRect& oval, Direction dir = kCW_Direction)</a></td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addOval_2'>SkPath& addOval(const SkRect& oval, Direction dir, unsigned start)</a></td>
  </tr>
  <tr>
  ...
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addPath'>SkPath& addPath(const SkPath& src, SkScalar dx, SkScalar dy,
                 AddPathMode mode = kAppend_AddPathMode)</a></td>
  </tr>
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addPath_2'>SkPath& addPath(const SkPath& src, AddPathMode mode = kAppend_AddPathMode)</a></td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addPath_3'>SkPath& addPath(const SkPath& src, const SkMatrix& matrix, AddPathMode mode = kAppend_AddPathMode)</a></td>
  </tr>
  <tr>
  ...
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addPoly'>SkPath& addPoly(const SkPoint pts[], int count, bool close)</a></td>
  </tr>
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addPoly_2'>SkPath& addPoly(const std::initializer_list<SkPoint>& list, bool close)</a></td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
  ...
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addRRect'>SkPath& addRRect(const SkRRect& rrect, Direction dir = kCW_Direction)</a></td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addRRect_2'>SkPath& addRRect(const SkRRect& rrect, Direction dir, unsigned start)</a></td>
  </tr>
  <tr>
  ...
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addRect'>SkPath& addRect(const SkRect& rect, Direction dir = kCW_Direction)</a></td>
  </tr>
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addRect_2'>SkPath& addRect(const SkRect& rect, Direction dir, unsigned start)</a></td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addRect_3'>SkPath& addRect(SkScalar left, SkScalar top, SkScalar right, SkScalar bottom,
                 Direction dir = kCW_Direction)</a></td>
  </tr>
  <tr>
  ...
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addRoundRect'>SkPath& addRoundRect(const SkRect& rect, SkScalar rx, SkScalar ry,
                      Direction dir = kCW_Direction)</a></td>
  </tr>
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_addRoundRect_2'>SkPath& addRoundRect(const SkRect& rect, const SkScalar radii[],
                      Direction dir = kCW_Direction)</a></td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
  ...
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_arcTo'>SkPath& arcTo(const SkRect& oval, SkScalar startAngle, SkScalar sweepAngle, bool forceMoveTo)</a></td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
  ...
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_cubicTo'>SkPath& cubicTo(SkScalar x1, SkScalar y1, SkScalar x2, SkScalar y2,
                 SkScalar x3, SkScalar y3)</a></td>
  </tr>
  <tr>
  ...
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_lineTo'>SkPath& lineTo(SkScalar x, SkScalar y)</a></td>
  </tr>
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_lineTo_2'>SkPath& lineTo(const SkPoint& p)</a></td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
  ...
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_moveTo'>SkPath& moveTo(SkScalar x, SkScalar y)</a></td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_moveTo_2'>SkPath& moveTo(const SkPoint& p)</a></td>
  </tr>
  <tr>
...
<a href='#SkPath_arcTo'>arcTo</a>( <a href='SkRect_Reference#SkRect'>SkRect</a>& , <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, )
...
<a href='#SkPath_arcTo_2'>arcTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>)
...
<a href='#SkPath_arcTo_4'>arcTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='#SkPath_ArcSize'>ArcSize</a>, <a href='#SkPath_Direction'>Direction</a>,
<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>)
...
<table>  <tr>
    <td><sup>1</sup> <a href='#SkPath_arcTo'>arcTo</a>( <a href='SkRect_Reference#SkRect'>SkRect</a>& , <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, )</td>
  </tr>  <tr>
    <td><sup>2</sup> parameter sets force MoveTo</td>
  </tr>  <tr>
    <td><sup>3</sup> start angle must be multiple of 90 degrees</td>
  </tr>  <tr>
    <td><sup>4</sup> <a href='#SkPath_arcTo_2'>arcTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>)</td>
  </tr>  <tr>
    <td><sup>5</sup> <a href='#SkPath_arcTo_4'>arcTo</a>(<a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='#SkPath_ArcSize'>ArcSize</a>,
<a href='#SkPath_Direction'>Direction</a>, <a href='undocumented#SkScalar'>SkScalar</a>, <a href='undocumented#SkScalar'>SkScalar</a>)</td>
  </tr>
</table>
...
Description</th></tr>
  ...
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_offset'>void offset(SkScalar dx, SkScalar dy, SkPath* dst) const</a></td>
  </tr>
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_offset_2'>void offset(SkScalar dx, SkScalar dy)</a></td>
  </tr>
  <tr>
  ...
  <tr style='background-color: #f0f0f0; '>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>overloads</td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_transform'>void transform(const SkMatrix& matrix, SkPath* dst) const</a></td>
  </tr>
  <tr>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '></td>
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '><a href='#SkPath_transform_2'>void transform(const SkMatrix& matrix)</a></td>
  </tr>
</table>
...
SkPath uses <code>class</code> to declare the public data structures and interfaces.
<table style='border-collapse: collapse; width: 62.5em'>
...
public:
    ...
    void <a href='#SkPath_Iter_setPath'>setPath</a>( <a href='#SkPath'>SkPath</a>& , );
    <a href='#SkPath_Verb'>Verb</a> <a href='#SkPath_Iter_next'>next</a>(<a href='SkPoint_Reference#SkPoint'>SkPoint</a>[4],  = ,  = );
...
SkPath::Iter can be constructed or initialized by these functions, including <code>class</code> constructors.
<table style='border-collapse: collapse; width: 62.5em'>
<tr><th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>Constructor</th><th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>
Description</th></tr>
  <tr style='background-color: #f0f0f0; '>
...
<pre style="padding: 1em 1em 1em 1em;width: 62.5em; background-color: #f0f0f0">
    ...
    public:
        ...
        void <a href='#SkPath_RawIter_setPath'>setPath</a>( <a href='#SkPath'>SkPath</a>& );
        <a href='#SkPath_Verb'>Verb</a> <a href='#SkPath_RawIter_next'>next</a>(<a href='SkPoint_Reference#SkPoint'>SkPoint</a>[4]);
...
SkPath::RawIter can be constructed or initialized by these functions, including <code>class</code> constructors.
<table style='border-collapse: collapse; width: 62.5em'>
<tr><th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>Constructor</th><th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>
Description</th></tr>
  <tr style='background-color: #f0f0f0; '>
