...
<table style='border-collapse: collapse' class='td_const tr_const td2_const' >
  ...
  <tr>
    <td><a name="SkPath_kMove_Verb"> <code><strong>SkPath::kMove_Verb </strong></code> </a></td>
    <td>0</td>
    <td></td>    <td>Consecutive <a href="#SkPath_kMove_Verb">kMove Verb</a> are preserved but all but the last <a href="#SkPath_kMove_Verb">kMove Verb</a> is
...
<a href="#SkPath_kMove_Verb">kMove Verb</a> as the last <a href="#Verb">Verb</a> is preserved but ignored.
  ...
  <tr>
    <td><a name="SkPath_kLine_Verb"> <code><strong>SkPath::kLine_Verb </strong></code> </a></td>
    <td>1</td>
    <td></td>    <td><a href="undocumented#Line">Line</a> is a straight segment from <a href="SkPoint_Reference#Point">Point</a> to <a href="SkPoint_Reference#Point">Point</a>. Consecutive <a href="#SkPath_kLine_Verb">kLine Verb</a>
...
at same position as prior line or curve <a href="#Verb">Verb</a> is preserved but is ignored.
  ...
  <tr>
    <td><a name="SkPath_kQuad_Verb"> <code><strong>SkPath::kQuad_Verb </strong></code> </a></td>
    <td>2</td>
    <td></td>    <td>Adds <a href="#Quad">Quad</a> from <a href="#Last_Point">Last Point</a>, using control <a href="SkPoint_Reference#Point">Point</a>, and end <a href="SkPoint_Reference#Point">Point</a>.
...
and control <a href="SkPoint_Reference#Point">Point</a> to end <a href="SkPoint_Reference#Point">Point</a>.
  ...
  <tr>
    <td><a name="SkPath_kConic_Verb"> <code><strong>SkPath::kConic_Verb </strong></code> </a></td>
    <td>3</td>
    <td></td>    <td>Adds <a href="#Conic">Conic</a> from <a href="#Last_Point">Last Point</a>, using control <a href="SkPoint_Reference#Point">Point</a>, end <a href="SkPoint_Reference#Point">Point</a>, and <a href="#Conic_Weight">Conic Weight</a>.
...
parabolic (and identical to <a href="#Quad">Quad</a>); greater than one hyperbolic.
  ...
  <tr>
    <td><a name="SkPath_kCubic_Verb"> <code><strong>SkPath::kCubic_Verb </strong></code> </a></td>
    <td>4</td>
    <td></td>    <td>Adds <a href="#Cubic">Cubic</a> from <a href="#Last_Point">Last Point</a>, using two control <a href="SkPoint_Reference#Point">Points</a>, and end <a href="SkPoint_Reference#Point">Point</a>.
...
to first control <a href="SkPoint_Reference#Point">Point</a>, and from second control <a href="SkPoint_Reference#Point">Point</a> to end <a href="SkPoint_Reference#Point">Point</a>.
  ...
  <tr>
    <td><a name="SkPath_kClose_Verb"> <code><strong>SkPath::kClose_Verb </strong></code> </a></td>
    <td>5</td>
    <td></td>    <td>Closes <a href="#Contour">Contour</a>, connecting <a href="#Last_Point">Last Point</a> to <a href="#SkPath_kMove_Verb">kMove Verb</a> <a href="SkPoint_Reference#Point">Point</a>. Consecutive
...
<a href="#SkPath_kMove_Verb">kMove Verb</a> has no effect.
  ...
  <tr>
    <td><a name="SkPath_kDone_Verb"> <code><strong>SkPath::kDone_Verb </strong></code> </a></td>
    <td>6</td>
    <td></td>    <td>Not in <a href="#Verb_Array">Verb Array</a>, but returned by <a href="#Path">Path</a> iterator.
</td>
  </tr>
...
<table style='border-collapse: collapse' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkPath_kCW_Direction"> <code><strong>SkPath::kCW_Direction </strong></code> </a></td>
    <td>0</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kCCW_Direction"> <code><strong>SkPath::kCCW_Direction </strong></code> </a></td>
    <td>1</td>
    <td></td>    <td></td>
  </tr>
</table>
...
<table style='border-collapse: collapse' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkPath_kWinding_FillType"> <code><strong>SkPath::kWinding_FillType </strong></code> </a></td>
    <td>0</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kEvenOdd_FillType"> <code><strong>SkPath::kEvenOdd_FillType </strong></code> </a></td>
    <td>1</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kInverseWinding_FillType"> <code><strong>SkPath::kInverseWinding_FillType </strong></code> </a></td>
    <td>2</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kInverseEvenOdd_FillType"> <code><strong>SkPath::kInverseEvenOdd_FillType </strong></code> </a></td>
    <td>3</td>
    <td></td>    <td></td>
  </tr>
</table>
...
<table style='border-collapse: collapse' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkPath_kUnknown_Convexity"> <code><strong>SkPath::kUnknown_Convexity </strong></code> </a></td>
    <td>0</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kConvex_Convexity"> <code><strong>SkPath::kConvex_Convexity </strong></code> </a></td>
    <td>1</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kConcave_Convexity"> <code><strong>SkPath::kConcave_Convexity </strong></code> </a></td>
    <td>2</td>
    <td></td>    <td></td>
  </tr>
</table>
...
<table style='border-collapse: collapse' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkPath_kSmall_ArcSize"> <code><strong>SkPath::kSmall_ArcSize </strong></code> </a></td>
    <td>0</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kLarge_ArcSize"> <code><strong>SkPath::kLarge_ArcSize </strong></code> </a></td>
    <td>1</td>
    <td></td>    <td></td>
  </tr>
</table>
...
<table style='border-collapse: collapse' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkPath_kAppend_AddPathMode"> <code><strong>SkPath::kAppend_AddPathMode </strong></code> </a></td>
    <td>#Line # appended to destination unaltered ##</td>
    <td></td>    <td><a href="#Path">Path</a> <a href="#Verb">Verbs</a>, <a href="SkPoint_Reference#Point">Points</a>, and <a href="#Conic_Weight">Conic Weights</a> are appended to destination unaltered.
...
starts a new <a href="#Contour">Contour</a>.
  ...
  <tr>
    <td><a name="SkPath_kExtend_AddPathMode"> <code><strong>SkPath::kExtend_AddPathMode </strong></code> </a></td>
    <td>#Line # add line if prior Contour is not closed ##</td>
    <td></td>    <td>If destination is closed or empty, start a new <a href="#Contour">Contour</a>. If destination
...
<table style='border-collapse: collapse' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkPath_kLine_SegmentMask"> <code><strong>SkPath::kLine_SegmentMask </strong></code> </a></td>
    <td>1</td>
    <td></td>    <td>Set if <a href="#Verb_Array">Verb Array</a> contains <a href="#SkPath_kLine_Verb">kLine Verb</a>.
</td>
  </tr>
  <tr>
    <td><a name="SkPath_kQuad_SegmentMask"> <code><strong>SkPath::kQuad_SegmentMask </strong></code> </a></td>
    <td>2</td>
    <td></td>    <td>Set if <a href="#Verb_Array">Verb Array</a> contains <a href="#SkPath_kQuad_Verb">kQuad Verb</a>. Note that <a href="#SkPath_conicTo">conicTo</a> may add a <a href="#Quad">Quad</a>.
</td>
  </tr>
  <tr>
    <td><a name="SkPath_kConic_SegmentMask"> <code><strong>SkPath::kConic_SegmentMask </strong></code> </a></td>
    <td>4</td>
    <td></td>    <td>Set if <a href="#Verb_Array">Verb Array</a> contains <a href="#SkPath_kConic_Verb">kConic Verb</a>.
</td>
  </tr>
  <tr>
    <td><a name="SkPath_kCubic_SegmentMask"> <code><strong>SkPath::kCubic_SegmentMask </strong></code> </a></td>
    <td>8</td>
    <td></td>    <td>Set if <a href="#Verb_Array">Verb Array</a> contains <a href="#SkPath_kCubic_Verb">kCubic Verb</a>.
</td>
  </tr>
</table>
