...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  ...
  <tr>
    <td><a name="SkPath_kMove_Verb"> <code>SkPath::kMove_Verb</code> </a></td>
    <td>0</td>
...
<a href="#SkPath_kMove_Verb">kMove Verb</a> as the last <a href="#Verb">Verb</a> is preserved but ignored.
  ...
  <tr>
    <td><a name="SkPath_kLine_Verb"> <code>SkPath::kLine_Verb</code> </a></td>
    <td>1</td>
...
at same position as prior line or curve <a href="#Verb">Verb</a> is preserved but is ignored.
  ...
  <tr>
    <td><a name="SkPath_kQuad_Verb"> <code>SkPath::kQuad_Verb</code> </a></td>
    <td>2</td>
...
and control <a href="SkPoint_Reference#Point">Point</a> to end <a href="SkPoint_Reference#Point">Point</a>.
  ...
  <tr>
    <td><a name="SkPath_kConic_Verb"> <code>SkPath::kConic_Verb</code> </a></td>
    <td>3</td>
...
parabolic (and identical to <a href="#Quad">Quad</a>); greater than one hyperbolic.
  ...
  <tr>
    <td><a name="SkPath_kCubic_Verb"> <code>SkPath::kCubic_Verb</code> </a></td>
    <td>4</td>
...
to first control <a href="SkPoint_Reference#Point">Point</a>, and from second control <a href="SkPoint_Reference#Point">Point</a> to end <a href="SkPoint_Reference#Point">Point</a>.
  ...
  <tr>
    <td><a name="SkPath_kClose_Verb"> <code>SkPath::kClose_Verb</code> </a></td>
    <td>5</td>
...
<a href="#SkPath_kMove_Verb">kMove Verb</a> has no effect.
  ...
  <tr>
    <td><a name="SkPath_kDone_Verb"> <code>SkPath::kDone_Verb</code> </a></td>
    <td>6</td>
...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value&nbsp;</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkPath_kCW_Direction"> <code>SkPath::kCW_Direction</code> </a></td>
    <td>0</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kCCW_Direction"> <code>SkPath::kCCW_Direction</code> </a></td>
    <td>1</td>
    <td></td>    <td></td>
  </tr>
</table>
...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value&nbsp;</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkPath_kWinding_FillType"> <code>SkPath::kWinding_FillType</code> </a></td>
    <td>0</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kEvenOdd_FillType"> <code>SkPath::kEvenOdd_FillType</code> </a></td>
    <td>1</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kInverseWinding_FillType"> <code>SkPath::kInverseWinding_FillType</code> </a></td>
    <td>2</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kInverseEvenOdd_FillType"> <code>SkPath::kInverseEvenOdd_FillType</code> </a></td>
    <td>3</td>
    <td></td>    <td></td>
  </tr>
</table>
...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value&nbsp;</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkPath_kUnknown_Convexity"> <code>SkPath::kUnknown_Convexity</code> </a></td>
    <td>0</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kConvex_Convexity"> <code>SkPath::kConvex_Convexity</code> </a></td>
    <td>1</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kConcave_Convexity"> <code>SkPath::kConcave_Convexity</code> </a></td>
    <td>2</td>
    <td></td>    <td></td>
  </tr>
</table>
...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value&nbsp;</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkPath_kSmall_ArcSize"> <code>SkPath::kSmall_ArcSize</code> </a></td>
    <td>0</td>
    <td></td>    <td></td>
  </tr>
  <tr>
    <td><a name="SkPath_kLarge_ArcSize"> <code>SkPath::kLarge_ArcSize</code> </a></td>
    <td>1</td>
    <td></td>    <td></td>
  </tr>
</table>
...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value&nbsp;</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkPath_kAppend_AddPathMode"> <code>SkPath::kAppend_AddPathMode</code> </a></td>
...
starts a new <a href="#Contour">Contour</a>.
  ...
  <tr>
    <td><a name="SkPath_kExtend_AddPathMode"> <code>SkPath::kExtend_AddPathMode</code> </a></td>
...
<table style='border-collapse: collapse; width: 62.5em' class='td_const tr_const td2_const' >
  <tr><th>Const</th><th>Value&nbsp;</th><th>Details</th><th>Description</th></tr>
  <tr>
    <td><a name="SkPath_kLine_SegmentMask"> <code>SkPath::kLine_SegmentMask</code> </a></td>
    <td>1</td>
    <td></td>    <td>Set if <a href="#Verb_Array">Verb Array</a> contains <a href="#SkPath_kLine_Verb">kLine Verb</a>.
</td>
  </tr>
  <tr>
    <td><a name="SkPath_kQuad_SegmentMask"> <code>SkPath::kQuad_SegmentMask</code> </a></td>
    <td>2</td>
  ...
  <tr>
    <td><a name="SkPath_kConic_SegmentMask"> <code>SkPath::kConic_SegmentMask</code> </a></td>
    <td>4</td>
    <td></td>    <td>Set if <a href="#Verb_Array">Verb Array</a> contains <a href="#SkPath_kConic_Verb">kConic Verb</a>.
</td>
  </tr>
  <tr>
    <td><a name="SkPath_kCubic_SegmentMask"> <code>SkPath::kCubic_SegmentMask</code> </a></td>
    <td>8</td>
