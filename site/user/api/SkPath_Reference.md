...
public:
    ...
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addPath'>addPath</a>(const <a href='#SkPath'>SkPath</a>& src, <a href='undocumented#SkScalar'>SkScalar</a> dx, <a href='undocumented#SkScalar'>SkScalar</a> dy,
                    <a href='#SkPath_AddPathMode'>AddPathMode</a> mode = <a href='#SkPath_kAppend_AddPathMode'>kAppend AddPathMode</a>);
    <a href='#SkPath'>SkPath</a>& <a href='#SkPath_addPath_2'>addPath</a>(const <a href='#SkPath'>SkPath</a>& src, <a href='#SkPath_AddPathMode'>AddPathMode</a> mode = <a href='#SkPath_kAppend_AddPathMode'>kAppend AddPathMode</a>);
...
<th style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>Description</th></tr>
  <tr style='background-color: #f0f0f0; '>
    ...
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>functions that construct <a href='#SkPath_RawIter'>SkPath::RawIter</a></td>
  </tr>
</table>
...
SkPath::RawIter defines related constants are using <code>enum</code>, <code>enum class</code>,  <code>#define</code>, <code>const</code>, and <code>constexpr</code>.
<table style='border-collapse: collapse; width: 62.5em'>
...
manage <a href='undocumented#Path_Contour'>Contour</a>, and terminate <a href='#Path'>Path</a>.
...
ignored. <a href='#SkPath_kMove_Verb'>kMove Verb</a> after other <a href='#Verb'>Verbs</a> implicitly closes the previous <a href='undocumented#Path_Contour'>Contour</a>
...
extend <a href='undocumented#Path_Contour'>Contour</a>. <a href='#SkPath_kLine_Verb'>kLine Verb</a> at same position as prior <a href='#SkPath_kMove_Verb'>kMove Verb</a> is
...
to first control <a href='SkPoint_Reference#Point'>Point</a>, and from second control <a href='SkPoint_Reference#Point'>Point</a> to end <a href='SkPoint_Reference#Point'>Point</a>.
  ...
  <tr>
    ...
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>
Closes <a href='undocumented#Path_Contour'>Contour</a>, connecting <a href='#Last_Point'>Last Point</a> to <a href='#SkPath_kMove_Verb'>kMove Verb</a> <a href='SkPoint_Reference#Point'>Point</a>. Consecutive
...
<a href='#SkPath_Direction'>Direction</a> describes whether <a href='undocumented#Path_Contour'>Contour</a> is clockwise or counterclockwise.
When <a href='#Path'>Path</a> contains multiple overlapping <a href='undocumented#Path_Contour'>Contours</a>, <a href='#SkPath_Direction'>Direction</a> together with
<a href='#Fill_Type'>Fill Type</a> determines whether overlaps are filled or form holes.

<a href='#SkPath_Direction'>Direction</a> also determines how <a href='undocumented#Path_Contour'>Contour</a> is measured. For instance, dashing
...
Closed <a href='undocumented#Path_Contour'>Contours</a> like <a href='SkRect_Reference#Rect'>Rect</a>, <a href='SkRRect_Reference#RRect'>Round Rect</a>, <a href='undocumented#Circle'>Circle</a>, and <a href='undocumented#Oval'>Oval</a> added with
...
<a href='#SkPath_empty_constructor'>SkPath</a>() <a href='#SkPath_copy_const_SkPath'>SkPath</a>(const <a href='#SkPath'>SkPath</a>& path) <a href='#SkPath_copy_operator'>operator=(const SkPath& path)</a>
...
SkPath::RawIter defines member functions with arithmetic equivalents.
<table style='border-collapse: collapse; width: 62.5em'>
...
<a href='#SkPath_swap'>swap</a> <a href='#SkPath_copy_const_SkPath'>SkPath</a>(const <a href='#SkPath'>SkPath</a>& path)
...
fills if the sum of <a href='undocumented#Path_Contour'>Contour</a> edges is not zero, where clockwise edges add one, and
...
number of <a href='undocumented#Path_Contour'>Contour</a> edges is odd. Each <a href='#Fill_Type'>Fill Type</a> has an inverse variant that
reverses the rule:
<a href='#SkPath_kInverseWinding_FillType'>kInverseWinding FillType</a> fills where the sum of <a href='undocumented#Path_Contour'>Contour</a> edges is zero;
<a href='#SkPath_kInverseEvenOdd_FillType'>kInverseEvenOdd FillType</a> fills where the number of <a href='undocumented#Path_Contour'>Contour</a> edges is even.
...
<a href='#Path'>Path</a> is convex if it contains one <a href='undocumented#Path_Contour'>Contour</a> and <a href='undocumented#Path_Contour'>Contour</a> loops no more than
360 degrees, and <a href='undocumented#Path_Contour'>Contour</a> angles all have same <a href='#SkPath_Direction'>Direction</a>. Convex <a href='#Path'>Path</a>
...
<a href='undocumented#Path_Contour'>Contour</a> <a href='#SkPath_Direction'>Direction</a> <a href='#SkPath_getConvexity'>getConvexity</a> <a href='#SkPath_getConvexityOrUnknown'>getConvexityOrUnknown</a> <a href='#SkPath_setConvexity'>setConvexity</a> <a href='#SkPath_isConvex'>isConvex</a>
...
<a href='#SkPath_Convexity'>Convexity</a> <a href='undocumented#Path_Contour'>Contour</a> <a href='#SkPath_Direction'>Direction</a> <a href='#SkPath_getConvexityOrUnknown'>getConvexityOrUnknown</a> <a href='#SkPath_setConvexity'>setConvexity</a> <a href='#SkPath_isConvex'>isConvex</a>
...
<a href='#SkPath_Convexity'>Convexity</a> <a href='undocumented#Path_Contour'>Contour</a> <a href='#SkPath_Direction'>Direction</a> <a href='#SkPath_getConvexity'>getConvexity</a> <a href='#SkPath_setConvexity'>setConvexity</a> <a href='#SkPath_isConvex'>isConvex</a>
...
<a href='#SkPath_Convexity'>Convexity</a> <a href='undocumented#Path_Contour'>Contour</a> <a href='#SkPath_Direction'>Direction</a> <a href='#SkPath_getConvexity'>getConvexity</a> <a href='#SkPath_getConvexityOrUnknown'>getConvexityOrUnknown</a> <a href='#SkPath_isConvex'>isConvex</a>
...
<a href='#SkPath_Convexity'>Convexity</a> <a href='undocumented#Path_Contour'>Contour</a> <a href='#SkPath_Direction'>Direction</a> <a href='#SkPath_getConvexity'>getConvexity</a> <a href='#SkPath_getConvexityOrUnknown'>getConvexityOrUnknown</a> <a href='#SkPath_setConvexity'>setConvexity</a>
...
Returns if <a href='undocumented#Path_Contour'>Contour</a> is closed.
<a href='undocumented#Path_Contour'>Contour</a> is closed if <a href='#Path'>Path</a> <a href='#SkPath_Verb'>Verb</a> array was last modified by <a href='#SkPath_close'>close</a>(). When stroked,
closed <a href='undocumented#Path_Contour'>Contour</a> draws <a href='SkPaint_Reference#Stroke_Join'>Paint Stroke Join</a> instead of <a href='SkPaint_Reference#Stroke_Cap'>Paint Stroke Cap</a> at first and last <a href='SkPoint_Reference#Point'>Point</a>.

### Return Value

true if the last <a href='undocumented#Path_Contour'>Contour</a> ends with a <a href='#SkPath_kClose_Verb'>kClose Verb</a>
...
each <a href='#SkPath_Verb'>Verb</a> in <a href='#Verb_Array'>Verb Array</a>. For instance, <a href='#Path'>Path</a> containing one <a href='undocumented#Path_Contour'>Contour</a> with <a href='undocumented#Line'>Line</a>
...
<a href='#SkPath_getPoint'>getPoint</a>, with <a href='#SkPath_Iter'>Iter</a>, or with <a href='#SkPath_RawIter_RawIter'>RawIter</a>.
...
the quantity of <a href='#SkPath_kMove_Verb'>kMove Verb</a> equals the <a href='undocumented#Path_Contour'>Contour</a> count.
...
or with <a href='#SkPath_RawIter_RawIter'>RawIter</a>.
...
<a href='#SkPath_getVerbs'>getVerbs</a> <a href='#SkPath_Iter'>Iter</a> <a href='#SkPath_RawIter_RawIter'>RawIter</a>
...
<a href='#SkPath_countVerbs'>countVerbs</a> <a href='#SkPath_getPoints'>getPoints</a> <a href='#SkPath_Iter'>Iter</a> <a href='#SkPath_RawIter_RawIter'>RawIter</a>
...
<a href='#SkPath_kMove_Verb'>kMove Verb</a> that define empty <a href='undocumented#Path_Contour'>Contours</a>.
...
<a href='undocumented#Path_Contour'>Contours</a>.
...
For now, only returns true if <a href='#Path'>Path</a> has one <a href='undocumented#Path_Contour'>Contour</a> and is convex.
...
Adds beginning of <a href='undocumented#Path_Contour'>Contour</a> at <a href='SkPoint_Reference#Point'>Point</a> (<a href='#SkPath_moveTo_x'>x</a>, <a href='#SkPath_moveTo_y'>y</a>).

### Parameters

<table>  <tr>    <td><a name='SkPath_moveTo_x'><code><strong>x</strong></code></a></td>
    <td><a href='#SkPath_moveTo_x'>x</a>-axis value of <a href='undocumented#Path_Contour'>Contour</a> start</td>
  </tr>
  <tr>    <td><a name='SkPath_moveTo_y'><code><strong>y</strong></code></a></td>
    <td><a href='#SkPath_moveTo_y'>y</a>-axis value of <a href='undocumented#Path_Contour'>Contour</a> start</td>
  </tr>
</table>
...
Adds beginning of <a href='undocumented#Path_Contour'>Contour</a> at <a href='SkPoint_Reference#Point'>Point</a> <a href='#SkPath_moveTo_2_p'>p</a>.
...
Adds beginning of <a href='undocumented#Path_Contour'>Contour</a> relative to <a href='#Last_Point'>Last Point</a>.
If <a href='#Path'>Path</a> is empty, starts <a href='undocumented#Path_Contour'>Contour</a> at (<a href='#SkPath_rMoveTo_dx'>dx</a>, <a href='#SkPath_rMoveTo_dy'>dy</a>).
Otherwise, start <a href='undocumented#Path_Contour'>Contour</a> at <a href='#Last_Point'>Last Point</a> offset by (<a href='#SkPath_rMoveTo_dx'>dx</a>, <a href='#SkPath_rMoveTo_dy'>dy</a>).
Function name stands for "relative move to".

### Parameters

<table>  <tr>    <td><a name='SkPath_rMoveTo_dx'><code><strong>dx</strong></code></a></td>
    <td>offset from <a href='#Last_Point'>Last Point</a> to <a href='undocumented#Path_Contour'>Contour</a> start on x-axis</td>
  </tr>
  <tr>    <td><a name='SkPath_rMoveTo_dy'><code><strong>dy</strong></code></a></td>
    <td>offset from <a href='#Last_Point'>Last Point</a> to <a href='undocumented#Path_Contour'>Contour</a> start on y-axis</td>
  </tr>
</table>
...
<a href='undocumented#Path_Contour'>Contour</a> <a href='#SkPath_moveTo'>moveTo</a><sup><a href='#SkPath_moveTo_2'>[2]</a></sup> <a href='#SkPath_rLineTo'>rLineTo</a> <a href='#SkPath_addRect'>addRect</a><sup><a href='#SkPath_addRect_2'>[2]</a></sup><sup><a href='#SkPath_addRect_3'>[3]</a></sup>
...
<a href='undocumented#Path_Contour'>Contour</a> <a href='#SkPath_moveTo'>moveTo</a><sup><a href='#SkPath_moveTo_2'>[2]</a></sup> <a href='#SkPath_lineTo'>lineTo</a><sup><a href='#SkPath_lineTo_2'>[2]</a></sup> <a href='#SkPath_addRect'>addRect</a><sup><a href='#SkPath_addRect_2'>[2]</a></sup><sup><a href='#SkPath_addRect_3'>[3]</a></sup>
...
<a href='undocumented#Path_Contour'>Contour</a> <a href='#SkPath_moveTo'>moveTo</a><sup><a href='#SkPath_moveTo_2'>[2]</a></sup> <a href='#SkPath_conicTo'>conicTo</a><sup><a href='#SkPath_conicTo_2'>[2]</a></sup> <a href='#SkPath_rQuadTo'>rQuadTo</a>
...
<a href='undocumented#Path_Contour'>Contour</a> <a href='#SkPath_moveTo'>moveTo</a><sup><a href='#SkPath_moveTo_2'>[2]</a></sup> <a href='#SkPath_conicTo'>conicTo</a><sup><a href='#SkPath_conicTo_2'>[2]</a></sup> <a href='#SkPath_quadTo'>quadTo</a><sup><a href='#SkPath_quadTo_2'>[2]</a></sup>
...
may be inspected with <a href='#SkPath_Iter'>Iter</a>, or with <a href='#SkPath_RawIter_RawIter'>RawIter</a>.
...
<a href='undocumented#Path_Contour'>Contour</a> <a href='#SkPath_moveTo'>moveTo</a><sup><a href='#SkPath_moveTo_2'>[2]</a></sup> <a href='#SkPath_rCubicTo'>rCubicTo</a> <a href='#SkPath_quadTo'>quadTo</a><sup><a href='#SkPath_quadTo_2'>[2]</a></sup>
...
<a href='undocumented#Path_Contour'>Contour</a> <a href='#SkPath_moveTo'>moveTo</a><sup><a href='#SkPath_moveTo_2'>[2]</a></sup> <a href='#SkPath_cubicTo'>cubicTo</a><sup><a href='#SkPath_cubicTo_2'>[2]</a></sup> <a href='#SkPath_quadTo'>quadTo</a><sup><a href='#SkPath_quadTo_2'>[2]</a></sup>
...
which may continue <a href='undocumented#Path_Contour'>Contour</a> or start a new one. This construction is similar to <a href='undocumented#PostScript'>PostScript</a> and
<a href='undocumented#HTML_Canvas'>HTML Canvas</a> arcs. Variation <a href='#SkPath_addArc'>addArc</a> always starts new <a href='undocumented#Path_Contour'>Contour</a>. Canvas::drawArc draws without
...
<table>  <tr>
    ...
    <td>3 is similar to 1, but always begins new <a href='undocumented#Path_Contour'>Contour</a>.</td>
  </tr>  <tr>
...
is false and <a href='#Path'>Path</a> is not empty. Otherwise, added <a href='undocumented#Path_Contour'>Contour</a> begins with first point
...
Appends <a href='#SkPath_kClose_Verb'>kClose Verb</a> to <a href='#Path'>Path</a>. A closed <a href='undocumented#Path_Contour'>Contour</a> connects the first and last <a href='SkPoint_Reference#Point'>Point</a>
with <a href='undocumented#Line'>Line</a>, forming a continuous loop. Open and closed <a href='undocumented#Path_Contour'>Contour</a> draw the same
with <a href='SkPaint_Reference#SkPaint_kFill_Style'>SkPaint::kFill Style</a>. With <a href='SkPaint_Reference#SkPaint_kStroke_Style'>SkPaint::kStroke Style</a>, open <a href='undocumented#Path_Contour'>Contour</a> draws
<a href='SkPaint_Reference#Stroke_Cap'>Paint Stroke Cap</a> at <a href='undocumented#Path_Contour'>Contour</a> start and end; closed <a href='undocumented#Path_Contour'>Contour</a> draws
<a href='SkPaint_Reference#Stroke_Join'>Paint Stroke Join</a> at <a href='undocumented#Path_Contour'>Contour</a> start and end.
...
Appends <a href='#Arc'>Arc</a> to <a href='#Path'>Path</a>, as the start of new <a href='undocumented#Path_Contour'>Contour</a>. <a href='#Arc'>Arc</a> added is part of ellipse
...
Appends <a href='SkRRect_Reference#RRect'>Round Rect</a> to <a href='#Path'>Path</a>, creating a new closed <a href='undocumented#Path_Contour'>Contour</a>. <a href='SkRRect_Reference#RRect'>Round Rect</a> has bounds
...
Adds <a href='#SkPath_addRRect_rrect'>rrect</a> to <a href='#Path'>Path</a>, creating a new closed <a href='undocumented#Path_Contour'>Contour</a>. If
...
Adds <a href='#SkPath_addRRect_2_rrect'>rrect</a> to <a href='#Path'>Path</a>, creating a new closed <a href='undocumented#Path_Contour'>Contour</a>. If <a href='#SkPath_addRRect_2_dir'>dir</a> is <a href='#SkPath_kCW_Direction'>kCW Direction</a>, <a href='#SkPath_addRRect_2_rrect'>rrect</a>
...
Adds <a href='undocumented#Path_Contour'>Contour</a> created from <a href='undocumented#Line'>Line</a> array, adding (<a href='#SkPath_addPoly_count'>count</a> - 1) <a href='undocumented#Line'>Line</a> segments.
<a href='undocumented#Path_Contour'>Contour</a> added starts at <a href='#SkPath_addPoly_pts'>pts</a>[0], then adds a line for every additional <a href='SkPoint_Reference#Point'>Point</a>
...
<table>  <tr>    <td><a name='SkPath_addPoly_pts'><code><strong>pts</strong></code></a></td>
  ...
  <tr>    <td><a name='SkPath_addPoly_close'><code><strong>close</strong></code></a></td>
    <td>true to add <a href='undocumented#Line'>Line</a> connecting <a href='undocumented#Path_Contour'>Contour</a> end and start</td>
  </tr>
</table>
...
Adds <a href='undocumented#Path_Contour'>Contour</a> created from <a href='#SkPath_addPoly_2_list'>list</a>. <a href='undocumented#Path_Contour'>Contour</a> added starts at <a href='#SkPath_addPoly_2_list'>list</a>[0], then adds a line
...
the last <a href='undocumented#Path_Contour'>Contour</a> or start a new <a href='undocumented#Path_Contour'>Contour</a>.
...
starts a new <a href='undocumented#Path_Contour'>Contour</a>.
</td>
  </tr>
  <tr>
    ...
    <td style='text-align: left; border: 2px solid #dddddd; padding: 8px; '>
If destination is closed or empty, start a new <a href='undocumented#Path_Contour'>Contour</a>. If destination
...
Reversed <a href='#SkPath_reverseAddPath_src'>src</a> always appends a new <a href='undocumented#Path_Contour'>Contour</a> to <a href='#Path'>Path</a>.
...
<a href='undocumented#Path_Contour'>Contour</a>. <a href='#Last_Point'>Last Point</a> of <a href='undocumented#Path_Contour'>Contour</a> is shared as first <a href='SkPoint_Reference#Point'>Point</a> of added <a href='undocumented#Line'>Line</a> or <a href='undocumented#Curve'>Curve</a>.
...
| --- | ---  |
| <a href='#SkPath_kWinding_FillType'>kWinding FillType</a> | a non-zero sum of <a href='undocumented#Path_Contour'>Contour</a> <a href='#Direction'>Directions</a>. |
| <a href='#SkPath_kEvenOdd_FillType'>kEvenOdd FillType</a> | an odd number of <a href='undocumented#Path_Contour'>Contours</a>. |
| <a href='#SkPath_kInverseWinding_FillType'>kInverseWinding FillType</a> | a zero sum of <a href='undocumented#Path_Contour'>Contour</a> <a href='#Direction'>Directions</a>. |
| <a href='#SkPath_kInverseEvenOdd_FillType'>kInverseEvenOdd FillType</a> | and even number of <a href='undocumented#Path_Contour'>Contours</a>. |
...
SkPath::RawIter uses <code>class</code> to declare the public data structures and interfaces.
<table style='border-collapse: collapse; width: 62.5em'>
...
Provides options to treat open <a href='undocumented#Path_Contour'>Contours</a> as closed, and to ignore
degenerate data.
...
open <a href='undocumented#Path_Contour'>Contour</a>. <a href='#SkPath_Iter_const_SkPath_path'>path</a> is not altered.
...
<table>  <tr>    <td><a name='SkPath_Iter_const_SkPath_path'><code><strong>path</strong></code></a></td>
  ...
  <tr>    <td><a name='SkPath_Iter_const_SkPath_forceClose'><code><strong>forceClose</strong></code></a></td>
    <td>true if open <a href='undocumented#Path_Contour'>Contours</a> generate <a href='#SkPath_kClose_Verb'>kClose Verb</a></td>
  </tr>
</table>
...
open <a href='undocumented#Path_Contour'>Contour</a>. <a href='#SkPath_Iter_setPath_path'>path</a> is not altered.
...
also the start point of <a href='undocumented#Path_Contour'>Contour</a>.
...
<a href='#SkPath_kMove_Verb'>kMove Verb</a>. if true, <a href='undocumented#Path_Contour'>Contour</a> <a href='#SkPath_Iter_Iter'>Iter</a> is processing may end with <a href='#SkPath_kClose_Verb'>kClose Verb</a>, or
<a href='#SkPath_Iter_Iter'>Iter</a> may have been initialized with force close set to true.

### Return Value

true if <a href='undocumented#Path_Contour'>Contour</a> is closed
