...
1.  **[SkCanvas](/user/api/bmh_SkCanvas?cl=9919)** - the drawing context.
2.  **[SkPaint](/user/api/bmh_SkPaint?cl=9919)** - color, stroke, font, effects
3.  **[SkPath](/user/api/bmh_SkPath?cl=9919)** - contours of lines and curves
...
*   [SkCanvas](/user/api/bmh_SkCanvas?cl=9919)
*   [SkPaint](/user/api/bmh_SkPaint?cl=9919)
*   [SkPath](/user/api/bmh_SkPath?cl=9919)
