...
*   [SkAutoCanvasRestore](/user/api/SkAutoCanvasRestore_Reference) - preserves Canvas save count
...
*   [SkImageInfo](/user/api/SkImageInfo_Reference) - describes Image and Surface dimensions and
    pixel type
...
*   [SkSurface](/user/api/SkSurface_Reference) - manages the pixels that a Canvas draws into
...
1.  [SkCanvas Overview](/user/api/skcanvas_overvie) - the drawing context
