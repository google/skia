...
1.  **[SkCanvas](https://skia.org/user/api/bmh_SkCanvas?cl=9919)** - the drawing context.
2.  **[SkPaint](https://skia.org/user/api/bmh_SkPaint?cl=9919)** - color, stroke, font, effects
3.  **[SkPath](https://skia.org/user/api/bmh_SkPath?cl=9919)** - contours of lines and curves
4.  **[SkRect](/user/api/skrect)** - rectangles
5.  **[SkRegion](/user/api/skregion)** - set operations with rectangles and paths
...
*   [SkCanvas](https://skia.org/user/api/bmh_SkCanvas?cl=9919)
*   [SkPaint](https://skia.org/user/api/bmh_SkPaint?cl=9919)
*   [SkPath](https://skia.org/user/api/bmh_SkPath?cl=9919)
