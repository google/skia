...
<style>
  ...
  #patheffect,#paths,#sk_drinks,#sk_party {
    width: 300px;
    height: 300px;
  }
...
(function() {
  ...
  if (window.WebAssembly && typeof window.WebAssembly.compile === 'function') {
    ...
    document.getElementById('demo').innerHTML = "<div>WASM not supported by your browser. Try a recent version of Chrome or Firefox</div>";
    return;
  }
