...
**left** - `Number`, x coordinate of top-left corner of rectangle.
**top** - `Number`, y coordinate of top-left corner of rectangle.
**right** - `Number`, x coordinate of bottom-right corner of rectangle.
