...
(function() {
  ...
  if (window.WebAssembly && typeof window.WebAssembly.compile === 'function') {
    ...
    window.__pathkit_locate_file = 'https://unpkg.com/experimental-pathkit-wasm@0.5.0/bin/';
  } else {
    console.log('WebAssembly is not supported (yet) on this browser. Using the asmjs version of PathKit');
    window.__pathkit_locate_file = 'https://unpkg.com/experimental-pathkit-asmjs@0.5.0/bin/';
  }
