...
and GrBackendRenderTarget objects that in are used to create SkSurface and SkImage
...
interpretted as a GrVkImageInfo*. This allows a client to get the backing VkImage
