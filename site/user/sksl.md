...
Note that because the object you bind and sample is an `SkShader`, you can directly
use any Skia shader, without necessarily turning it into an image (texture) first.
For example, you can sample a [linear gradient](https://fiddle.skia.org/c/e928ef443e70b65386d75a1a0ede2c5d), or even
