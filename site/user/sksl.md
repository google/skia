...
You can even sample another SkSL shader:

<fiddle-embed name='13b446d926326481b340842f05014a9c'></fiddle-embed>

You will still need to understand how [alpha](#premul) is handled in Skia,
and how [coordinates](#coords) work.
...
* Skia _enforces_ that the color produced by your SkSL is a "valid" premultiplied color.
  ...
  clamped, leading to incorrect colors:

<fiddle-embed name='e588240c730adf7133fcae3be2a54273'></fiddle-embed>
