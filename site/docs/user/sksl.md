...
coordinates. They will be relative to the local coordinate space of the `SkCanvas`, and may be
further transformed by a `localMatrix` when you call `SkRuntimeEffect::makeShader` or
`SkRuntimeShaderBuilder::makeShader`.
