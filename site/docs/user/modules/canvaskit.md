...
(function() {
  ...
  fetch('https://storage.googleapis.com/skia-world-readable/misc/lego_loader.json').then((resp) => {
    resp.text().then((str) => {
      legoJSON = str;
      SkottieExample(CanvasKit, 'sk_legos', legoJSON, [-183, -100, 483, 400]);
    });
  ...
  fetch('https://storage.googleapis.com/skia-world-readable/misc/drinks.json').then((resp) => {
    resp.text().then((str) => {
      drinksJSON = str;
      SkottieExample(CanvasKit, 'sk_drinks', drinksJSON, fullBounds);
    });
  ...
  fetch('https://storage.googleapis.com/skia-world-readable/misc/confetti.json').then((resp) => {
    resp.text().then((str) => {
      confettiJSON = str;
      SkottieExample(CanvasKit, 'sk_party', confettiJSON, fullBounds);
    });
  ...
  fetch('https://storage.googleapis.com/skia-world-readable/misc/onboarding.json').then((resp) => {
    resp.text().then((str) => {
      onboardingJSON = str;
      SkottieExample(CanvasKit, 'sk_onboarding', onboardingJSON, fullBounds);
    });
  ...
  const loadBrickTex = fetch('https://storage.googleapis.com/skia-world-readable/misc/brickwork-texture.jpg').then((response) => response.arrayBuffer());
  const loadBrickBump = fetch('https://storage.googleapis.com/skia-world-readable/misc/brickwork_normal-map.jpg').then((response) => response.arrayBuffer());
  ...
  function ShapingExample(CanvasKit) {
    ...
    let robotoData = null;
    fetch('https://storage.googleapis.com/skia-world-readable/google-web-fonts/Roboto-Regular.ttf').then((resp) => {
    ...
    let emojiData = null;
    fetch('https://storage.googleapis.com/skia-world-readable/misc/NotoColorEmoji.ttf').then((resp) => {
      resp.arrayBuffer().then((buffer) => {
        emojiData = buffer;
      });
    });
