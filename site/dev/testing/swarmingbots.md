...
- Machine name like “skia-gce-NNN”, “skia-ct-gce-NNN”, “skia-i-gce-NNN”, “ct-gce-NNN”, “ct-xxx-builder-NNN” -> GCE
  ...
  * To log in to a Windows bot in GCE, first go to the VM's detail page, click the "Set Windows password" button, and
    copy or save your password. There are two options to connect:
