...
![Debugger interface](/usr/local/google/home/nifong/skia/site/dev/tools/onlinedebugger.png)
...
[sample mskp file](/usr/local/google/home/nifong/skia/site/dev/tools/calendar.mskp)
...
![play](/usr/local/google/home/nifong/skia/site/dev/tools/playcommands.png), (the one not
...
![expand](/usr/local/google/home/nifong/skia/site/dev/tools/expand.png) icon to see all of the
...
![end](/usr/local/google/home/nifong/skia/site/dev/tools/end.png) button.

### Frame playback

![frame playback](/usr/local/google/home/nifong/skia/site/dev/tools/frameplayback.png)
...
![resources](/usr/local/google/home/nifong/skia/site/dev/tools/resources.png)
...
![layers](/usr/local/google/home/nifong/skia/site/dev/tools/layers.png)
...
draw event occured. Each Layer box has two buttons: `Show Use` will cycle through use events for that
...
![crosshair](/usr/local/google/home/nifong/skia/site/dev/tools/crosshair.png)
...
![settings](/usr/local/google/home/nifong/skia/site/dev/tools/settings.png)

Each of the filtered commands from above has a colored number to its right
![gpu op](/usr/local/google/home/nifong/skia/site/dev/tools/gpuop.png). This is the GPU
...
![buttons](/usr/local/google/home/nifong/skia/site/dev/tools/settings.png)
...
Firt to page height - make the canvas fit vertically but allow scrolling horizontally.
