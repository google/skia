...
<!--
Question: When is it "skia.primary" and when is it "luci.skia.skia.primary"?
-->
...
The following keyword does not belong in the commit message footer:

NO\_MERGE\_BUILDS
-----------------

This keyword prevents the Skia build masters from building this commit with
others. Use it when your commit may have effects that you don't want
mis-attributed to other commits. Just include the keyword somewhere in the
commit message:
