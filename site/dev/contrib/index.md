...
You can also search the [Chromium issue
...
skia-discuss ahead of development.  For more information, see [How to submit a
patch](/dev/contrib/submit).
...
(or your organization's) name and contact info to the [AUTHORS
