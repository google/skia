...
`WORKSPACE.bzl` acts like `DEPS`, listing external dependencies and how to
...
Each overriden dependency will need its own directory with a few files.
...
less enough to simply know that we can subsitute prebuilts this way.  The most
