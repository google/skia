...
DOCS_PREVIEW_LINK = 'https://skia.org/?cl='
...
def PostUploadHook(gerrit, change, output_api):
  ...
  * Adds 'No-Try: true' if the CL contains only docs changes.
  ...
  docs_preview_link = DOCS_PREVIEW_URL.format(issue=issue)
  if (atleast_one_docs_change
  ...
  if description_changed:
    gerrit.SetChangeDescription(
        change.issue, change.FullDescriptionText())
