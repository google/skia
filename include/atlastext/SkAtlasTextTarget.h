...
/** Represents a renderable surface and is used to draw text into the surface. */
...
public:
    ...
    /**
     * Enqueues draws text into the target. 'color' here is interpreted by the client's
     * SkAtlasTextRenderer when it actually renders the text.
     */
