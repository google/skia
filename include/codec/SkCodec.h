...
public:
    ...
    /**
     *  Returns kSuccess, or another value explaining the type of failure. The passed in
     *  SkYUVAPixmaps has been configured with allocated pixmaps according to a successful call to
     *  queryYUVAUInfo(). This function fills in the planar data into the pixmaps.
     */
