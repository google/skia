...
public:
     ...
     *  SkYUVAPixmaps has been configured with pixmaps allocated according to a successful call to
     *  queryYUVAInfo(). This function fills in the planar data into the pixmaps.
     */
