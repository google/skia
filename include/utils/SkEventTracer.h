...
public:
     ...
     * installed and true is returned. Otherwise, false is returned. Upon success ownership has been
     * transferred and the instance will be freed at process termination.
     */
