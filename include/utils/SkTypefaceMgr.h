...
#ifndef SkTypefaceMgr_DEFINED
#define SkTypefaceMgr_DEFINED
 ...
 */
class SK_API SkTypefaceMgr : public SkFontMgr {
public:
    SkTypefaceMgr();
    ~SkTypefaceMgr() override;

    void append(sk_sp<SkTypeface>);
...
private:
    std::vector<sk_sp<SkTypeface>> fList;
};
