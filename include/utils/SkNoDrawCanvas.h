...
protected:
    ...
    void onDrawEdgeAAQuad(const SkRect&, const SkPoint[], int, SkCanvas::QuadAAFlags, SkColor,
                          SkBlendMode) override {}
    void onDrawEdgeAAImageSet(const SkCanvas::ImageSetEntry[], int, const SkPoint[],
