...
class GrBackendMutableStateImpl;
...
public:
    ...
    void setBackendMutableState(const GrBackendMutableState&);
...
private:
    ...
    sk_sp<GrBackendMutableStateImpl> getMutableState() const;
    ...
    sk_sp<GrBackendMutableStateImpl> fMutableState;
};
