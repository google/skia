...
public:
    ...
    // GrBackendTexture and plumb the GrPixelconfig manually throughout our code (or remove move
    // all use of GrPixelConfig in general).
...
public:
    ...
    // GrBackendRenderTarget and plumb the pixel config manually throughout our code (or remove move
    // all use of GrPixelConfig in general).
    GrPixelConfig pixelConfig() const { return fConfig; }
    void setPixelConfig(GrPixelConfig config) { fConfig = config; }
