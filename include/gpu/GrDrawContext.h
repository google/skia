...
public:
    ...
    */
    ...
    sk_sp<GrTexture> asTexture() { return sk_ref_sp(this->accessRenderTarget()->asTexture()); }
...
protected:
    GrDrawContext(GrContext*, GrDrawingManager*, sk_sp<GrRenderTargetProxy>, sk_sp<SkColorSpace>,
