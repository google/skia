 ...
 *     Any other draw that requires a copy wlil fail (this includes using backdrop filter with save
 *         layer).
...
public:
    ...
    // finish on the GPU. If it is called earlier than some vulkan objects may be deleted while they
