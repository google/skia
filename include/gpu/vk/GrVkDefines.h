...
// Need to extend VkStructureType enum
static constexpr VkStructureType VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2_KHR = (VkStructureType) 1000059000;
static constexpr VkStructureType VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2_KHR = (VkStructureType) 1000059001;
static constexpr VkStructureType VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_2_KHR = (VkStructureType) 1000059002;
static constexpr VkStructureType VK_STRUCTURE_TYPE_IMAGE_FORMAT_PROPERTIES_2_KHR = (VkStructureType) 1000059003;
static constexpr VkStructureType VK_STRUCTURE_TYPE_PHYSICAL_DEVICEIMAGE_FORMAT_INFO_2_KHR = (VkStructureType) 1000059004;
static constexpr VkStructureType VK_STRUCTURE_TYPE_QUEUE_FAMILY_PROPERTIES_2_KHR = (VkStructureType) 1000059005;
static constexpr VkStructureType VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_PROPERTIES_2_KHR = (VkStructureType) 1000059006;
static constexpr VkStructureType VK_STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2_KHR = (VkStructureType) 1000059007;
static constexpr VkStructureType VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SPARSE_IMAGE_FORMAT_INFO_2_KHR = (VkStructureType) 1000059008;
