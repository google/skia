...
// defines and includes the vulkan.h header. Then they should define SK_VULKAN_HEADER to point to
// their custum header or set the skia_vulkan_header_shim in gn.
