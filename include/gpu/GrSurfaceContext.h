...
public:
    ...
    virtual sk_sp<GrSurfaceProxy> asRefSurfaceProxy() = 0;

    virtual GrTextureProxy* asTextureProxy() = 0;
    virtual sk_sp<GrTextureProxy> asRefTextureProxy() = 0;

    virtual GrRenderTargetProxy* asRenderTargetProxy() = 0;
    virtual sk_sp<GrRenderTargetProxy> asRefRenderTargetProxy() = 0;
