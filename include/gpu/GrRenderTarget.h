...
public:
    ...
    GrFSAAType fsaaType() const {
        if (!fSampleCnt) {
            SkASSERT(!(fFlags & kMixedSampled_GrRenderTargetFlags));
            return GrFSAAType::kNone;
        }
        return (fFlags & kMixedSampled_GrRenderTargetFlags) ? GrFSAAType::kMixedSamples
...
protected:
    GrRenderTarget(GrGpu*, const GrSurfaceDesc&,
                   GrRenderTargetFlags = kNone_GrRenderTargetFlags,
