...
public:
     ...
     * operations occur (e.g. Vulkan). After the idle proc is called it is removed. In unusual
     * shutdown scenarios (e.g. the context has been abandoned) the proc will be called before the
