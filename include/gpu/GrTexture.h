...
class GrCrossContextTextureData;
class GrTexturePriv;
...
public:
    ...
    /**
     *  Return the native bookeeping data for this texture, and abandon the resource.
     */
    virtual std::unique_ptr<GrCrossContextTextureData> detachBackendTexture() = 0;
