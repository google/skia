...
public:
     ...
     * will populate config and flags fields of the desc such that copySurface can
     * efficiently succeed as well as the proxy origin. rectsMustMatch will be set to true if the
     * copy operation must ensure that the src and dest rects are identical. disallowSubrect will be
     * set to true if copy rect must equal src's bounds.
     */
