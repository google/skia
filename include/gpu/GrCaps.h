...
public:
     ...
     * is created, pixels are written to it, and then that is copied or drawn into the the render
     * target. If the surface is not a render target then we simply fail.
     */
