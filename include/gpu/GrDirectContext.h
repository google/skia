...
// Note: UtilityContexts do not get to abandon the context family only the DirectContext has
// that power.

class SK_API GrUtilityContext : public GrContext_Base {
public:
    class DooDad : public SkRefCnt {
    };
...
protected:
    ...
    GrUtilityContext(sk_sp<DooDad>, sk_sp<GrContextThreadSafeProxy>);

private:
    sk_sp<DooDad>          fDooDad;
