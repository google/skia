...
public:
     ...
     * GrDirectContext is destroyed. This also means that any objects created with this GrContext
     * (e.g. SkSurfaces, SkImages, etc.) must also be released as they may hold refs on the
     * GrDirectContext. Once all these objects and the GrContext are released, then it is safe to
     * delete the vulkan objects.
     */
