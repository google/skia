...
protected:
    ...
    bool hasSameSamplersAndImageStorages(const GrProcessor&) const;
...
public:
    ...
    GrShaderVar::ImageStorageFormat format() const { return fFormat; }
...
private:
    ...
    GrShaderFlags                   fVisibility;
    GrShaderVar::ImageStorageFormat fFormat;
    typedef SkNoncopyable INHERITED;
};
