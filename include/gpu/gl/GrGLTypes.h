...
enum class GrGLFormat {
    ...
    kR16F,
    kRGB8,
    kSRGB8, // double check this entry
    kRG8,
    kRGB10_A2,
    kRGBA4,
    kSRGB8_ALPHA8,
    //---
    kCOMPRESSED_ETC1_RGB8_1,
    //---
    kCOMPRESSED_RGB8_ETC2_1,
    kCOMPRESSED_SRGB8_ETC2,
    kCOMPRESSED_RGBA8_ETC2,
    kCOMPRESSED_SRGBA8_ETC2,
    //---
    kCOMPRESSED_RGB8_BC1,
    kCOMPRESSED_SRGB8_BC1,
    kCOMPRESSED_RGBA8_BC1,
    kCOMPRESSED_SRGBA8_BC1,
    //---
    kR16,
    kRG16,
    kRGBA16,
