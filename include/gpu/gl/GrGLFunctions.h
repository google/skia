...
public:
    ...
    GrGLFunction(Closure closure) {
        ...
        static_assert(skstd::is_trivially_copyable<Closure>::value, "");
        static_assert(skstd::is_trivially_destructible<Closure>::value, "");
