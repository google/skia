...
/**
 * A description of a set GrBackendTextures that hold the planar data for a SkYUVAInfo.
 */
...
public:
     ...
     * by GrMipmmapped. This will produce an invalid result (return false from isValid()) if the
     ...
     * compatible plane texture formats.
     */
