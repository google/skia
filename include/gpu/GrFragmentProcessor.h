...
public:
    ...
    */
     ...
     */
    virtual bool hasConstantOutputWithConstantInput(const GrColor4f& inputColor,
                                                    GrColor4f* outputColor) const = 0;
...
#define HASCO \
    bool hasConstantOutputWithConstantInput(const GrColor4f& inputColor, GrColor4f* outputColor) const override { return false; }
...
protected:
    enum OptimizationFlags : uint32_t {
        ...
        kAllOptimizationFlags = kModulatesInput_OptimizationFlag | kPreservesOpaqueInput_OptimizationFlag
    };
