...
public:
    ...
    */
     ...
     * color or alpha in the 0..1 range. If this is true and the blend mode allows it we may fold
     * coverage into color at the top of the color pipeline before executing the processors.
     */
...
protected:
    enum OptimizationFlags : uint32_t {
        ...
        kAllOptimizationFlags = kModulatesInput_OptimizationFlag |
