...
struct GrMockOptions {
    GrMockOptions() {
        ...
        // By default RGBA_8888 is textureable and renderable and A8 and BGR565 are texturable.
        fConfigOptions1[(int)GrColorType::kRGBA_8888].fRenderability = Renderability::kNonMSAA;
        fConfigOptions1[(int)GrColorType::kRGBA_8888].fTexturable = true;
        fConfigOptions1[(int)GrColorType::kAlpha_8].fTexturable = true;
        fConfigOptions1[(int)GrColorType::kBGR_565].fTexturable = true;
    }
    ...
    ConfigOptions fConfigOptions1[kGrColorTypeCnt];
