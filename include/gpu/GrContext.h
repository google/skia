...
public:
     ...
     * SkSurfaces, SkImages, etc.) but also be released as they may hold refs onto the GrContext.
     ...
     * live for the livetime of the GrContext object itself. The reason for this is so that
