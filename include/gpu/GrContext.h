...
public:
     ...
     * will put those objects in a state that is ready for external uses of the underlying backend
     * object. See declaration of GrPreopareForExternalIORequests for more details.
     */
