...
public:
     ...
     * GrContext is destroyed or one of the abandonContext is called on the GrContext.
     */
     ...
     *
     * For Vulkan, even if the device becomes lost, the VkQueue, VkDevice, or VkInstance used to
     * create the GrContext must be alive before callin releaseResourcesAndAbandonContext.
     */
