...
public:
     ...
     * signal on the GPU. Thus the client should not have the GPU wait on any of the semaphores.
     * However, any pending commands to the context will still be flushed.
     */
