...
public:
     ...
     * therefore hide the error from Skia. Also, it is advised not to use
     * GrContextOptions::fSkipGLErrorChecks enabled if relying on this query. That option may
     * prevent GrContext from ever checking the GL context for OOM.
     *
