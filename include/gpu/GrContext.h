...
public:
    ...
    */
    ...
    //
    // This is only guaranteed to work if the device used in step #2 is the same as the one used
    // in step #4. Using cached shader blobs on a different device, or a device with a different
    // driver are undefined.
