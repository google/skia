...
public:
    ...
    /**
     * If the backend is GrBackendApi::kOpenGL, then all texture units/targets for which the
     * GrContext has modified the bound texture will be have texture id 0 bound. This does not
     ...
     * all unit/target combinntions are considered to have unmodified bindings until the GrContext
