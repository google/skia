...
public:
    ...
    /*
     * Retrieve the default GrBackendFormat for a given SkColorType. It is guaranteed that
     * this backend format will be the one used by the following SkColorType and
     * SkSurfaceCharacterization-based createBackendTexture methods.
     */
