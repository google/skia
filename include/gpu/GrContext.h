...
public:
    ...
    /**
     * Purge GPU resources that haven't been used in the past 'ms' milliseconds or are otherwise
     * marked for deletion, regardless of whether the context is under budget.
     */
    void performDeferredCleanup(std::chrono::milliseconds ms);
