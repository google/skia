...
private:
     ...
     */
    sk_sp<GrFragmentProcessor> createPMToUPMEffect(GrTexture*, sk_sp<GrColorSpaceXform>,
                                                   const GrSwizzle&, const SkMatrix&) const;
    sk_sp<GrFragmentProcessor> createUPMToPMEffect(GrTexture*, sk_sp<GrColorSpaceXform>,
                                                   const GrSwizzle&, const SkMatrix&) const;
