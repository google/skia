...
public:
     ...
     *                          number of indices.
     * @param   ColorArrayMeaning  Determines how the color array should be interpreted.
     */
    void drawVertices(const GrClip&,
                      ...
                      int indexCount,
                      ColorArrayMeaning = ColorArrayMeaning::kPremulGrColor);
