...
enum GrRenderTargetFlags {
    kNone_GrRenderTargetFlags                = 0,
    ...
    //        are supported
    kMixedSampled_GrRenderTargetFlags        = 1 << 0,
    ...
    kWindowRectsSupport_GrRenderTargetFlags  = 1 << 1
};
GR_MAKE_BITFIELD_OPS(GrRenderTargetFlags);
