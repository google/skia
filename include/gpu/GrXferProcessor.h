...
protected:
    ...
    static ColorType AnalysisColorType(const GrPipelineAnalysis&);
    static CoverageType AnalysisCoverageType(const GrPipelineAnalysis&);
...
private:
     ...
     */
    virtual bool willReadDstColor(const GrCaps&, ColorType, CoverageType) const;
