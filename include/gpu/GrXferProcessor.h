 ...
 *
 * GrXPFactories are intendend to be static immutable objects. We pass them around as raw pointers
 * and expect the pointers to always be valid and for the factories to be reusable. Equailty is
 * tested as pointer comparison. GrXPFactories also may not have destructors.
 */
class GrXPFactory {
public:
...
#pragma clang diagnostic pop
    ...
    bool isEqual(const GrXPFactory& that) const { return this == &that; }
