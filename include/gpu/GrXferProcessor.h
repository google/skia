...
public:
     ...
     */
    OptFlags getOptimizations(const GrPipelineAnalysis& optimizations,
...
private:
    ...
    virtual OptFlags onGetOptimizations(const GrPipelineAnalysis& optimizations,
                                        bool doesStencilWrite,
                                        GrColor* overrideColor,
...
public:
    ...
    GrXferProcessor* createXferProcessor(const GrPipelineAnalysis& analysis,
    ...
    bool willNeedDstTexture(const GrCaps& caps, const GrPipelineAnalysis& optimizations) const;
