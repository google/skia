...
private:
    ...
    bool isPreCoverageBlendedColorConstant(const GrProcOptInfo& colorInput, GrColor*) const override { return false; }

    bool willReadsDst(const GrProcOptInfo&, const GrProcOptInfo&) const override { return fRegionOp != SkRegion::kReplace_Op; }
