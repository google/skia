...
public:
    ...
    static bool WillSrcOverReadDst(const GrXPFactory*, const GrProcOptInfo& colorInput,
                                   const GrProcOptInfo& coverageInput);
    static bool IsSrcOverPreCoverageBlendedColorConstant(const GrXPFactory*, const GrProcOptInfo& colorInput, GrColor* color);
