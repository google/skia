...
public:
    SkSTArray() : STORAGE{}, INHERITED((STORAGE*)this) {
    }

    SkSTArray(const SkSTArray& array)
        : STORAGE{}, INHERITED(array, (STORAGE*)this) {
    }

    SkSTArray(SkSTArray&& array)
        : STORAGE{}, INHERITED(std::move(array), (STORAGE*)this) {
    }
    ...
    SkSTArray(const T* array, int count)
        : STORAGE{}, INHERITED(array, count, (STORAGE*)this) {
    }

    SkSTArray(std::initializer_list<T> data)
        : STORAGE{}, INHERITED(data, (STORAGE*)this) {
    }
