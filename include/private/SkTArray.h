...
public:
    SkSTArray() : STORAGE{}, INHERITED(this) {
    }

    SkSTArray(const SkSTArray& array)
        : STORAGE{}, INHERITED(array, this) {
    }

    SkSTArray(SkSTArray&& array)
        : STORAGE{}, INHERITED(std::move(array), this) {
    }
    ...
    SkSTArray(const T* array, int count)
        : STORAGE{}, INHERITED(array, count, this) {
    }

    SkSTArray(std::initializer_list<T> data)
        : STORAGE{}, INHERITED(data, this) {
    }
