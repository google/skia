...
// Nothing looks anywhere near as likely to be used by Skia as math.h.
    ...
    // be safe, 32- and 64-bit builds both get this treatment.
        ...
        #error We should be the first math.h include or this is all pointless.
    #endif
    ...
    #if !defined(_INC_MATH)
        #error Looks like ucrt\math.h has changed?  Better check if it's still missing 'static'.
    #endif
