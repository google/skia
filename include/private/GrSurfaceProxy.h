...
protected:
    GrIORefProxy() : fRefCnt(1), fPendingReads(0), fPendingWrites(0), fTarget(nullptr) {}
...
private:
    ...
    void completedRead() const {
        ...
        SkASSERT(0); // How was the read completed if the Proxy hasn't been instantiated?
    }
    ...
    void completedWrite() const {
        ...
        SkASSERT(0); // How was the write completed if the Proxy hasn't been instantiated?
    }
