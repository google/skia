...
public:
     ...
     * (Mipmapping and MSAA are not supported by this method.)
     */
...
private:
    ...
    // (via text barrier). This information is necessary for certain assertions.
    SkDEBUGCODE(bool fIsDirectDstRead_DebugOnly = false;)
