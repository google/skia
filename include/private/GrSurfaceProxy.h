...
public:
     ...
     * (MSAA and stencil are not supported by this method.) If width and height must either both be
     * greater than 0 or both -1. A value of -1 is a signal that the width and height are currently
     * unknown.
     */
