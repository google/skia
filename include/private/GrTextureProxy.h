...
public:
    ...
    // Returns true if the passed in proxies can be used as dynamic textures together when flushing
    // draws to the gpu.
    static bool ProxiesAreCompatibleAsDynamicTextures(const GrTextureProxy* first,
