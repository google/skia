...
public:
     ...
     * direct context, then all three contexts will report the same family id. It is an error
     * for an image to be used with a context that reports a different family id.
     */
