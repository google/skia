...
public:
    ...
    static size_t SafeSize(size_t Tsize, size_t n);
...
public:
    ...
    void* append(size_t e, size_t n) { return (void*)fMemoryBlock.append(S(e), SS(n)); }
    void* insert(size_t i, size_t e, size_t n) { return (void*)fMemoryBlock.insert(S(i), S(e), SS(n)); }
    void* remove(size_t r, size_t e, size_t n) { return (void*)fMemoryBlock.remove(S(r), S(e), S(n)); }

    void* addrOf(size_t index) { return fMemoryBlock.addrOf(S(index)); }
    const void* addrOf(size_t index) const { return fMemoryBlock.addrOf(S(index)); }
...
private:
    ...
    static size_t SS(size_t s) { return SkMemoryBlock::SafeSize(TSize, s); }
