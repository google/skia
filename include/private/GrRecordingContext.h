...
public:
    ...
    class Arenas {
    public:
        Arenas(GrOpMemoryPool*, SkArenaAlloc*, GrQuadAllocator*);
        ...
        GrQuadAllocator* quadAllocator() { return fQuadAllocator; }

    private:
        GrOpMemoryPool* fOpMemoryPool;
        SkArenaAlloc*   fRecordTimeAllocator;
        GrQuadAllocator* fQuadAllocator;
    };
...
protected:
    ...
    private:
        ...
        std::unique_ptr<GrQuadAllocator> fQuadAllocator;
    };
