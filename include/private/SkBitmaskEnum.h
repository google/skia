...
template <typename E> constexpr SK_WHEN(skstd::is_bitmask_enum<E>::value, bool) Any(E e) {
    return e != static_cast<E>(typename std::underlying_type<E>::type(0));
}
}
...
template <typename E> constexpr SK_WHEN(skstd::is_bitmask_enum<E>::value, E) operator~(E e) {
