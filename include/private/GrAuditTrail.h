...
public:
    ...
    // Specifically, future draw calls may change combine previous ops and thus would invalidate
    ...
    // accurate for N + 1 or N - 1 draws depending on the actual merging algorithm used.
...
private:
    ...
    // The client cas pass in an optional client ID which we will use to mark the ops
    int fClientID;
    bool fEnabled;
};
