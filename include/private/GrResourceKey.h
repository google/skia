...
public:
    ...
    GrUniqueKeyInvalidatedMessage(GrUniqueKeyInvalidatedMessage&& other) = default;
    GrUniqueKeyInvalidatedMessage& operator=(GrUniqueKeyInvalidatedMessage&& other) = default;
