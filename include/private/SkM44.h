...
struct SkVec3 {
    ...
    static SkVec3 Normalize(const SkVec3& v) { return v * (1.0f / v.length()); }
    ...
    SkVec3 normalize()            const { return Normalize(*this); }
...
public:
     ...
     */
    bool SK_WARN_UNUSED_RESULT invert(SkMat4* inverse) const;
