...
constexpr float SK_Float1     = 1.0f;
constexpr float SK_FloatHalf  = 0.5f;
...
#define sk_float_degrees_to_radians(degrees) ((degrees) * (SK_FloatPI / 180))
#define sk_float_radians_to_degrees(radians) ((radians) * (180 / SK_FloatPI))
