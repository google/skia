...
/**
 * Refers to the encoding of a GPU buffer as it will be interpereted by the GPU when sampling and
 * blending.
 */
...
static inline GrSRGBConversion GrDetermineWritePixelsSRGBConversion(
...
static inline GrSRGBConversion GrDetermineReadPixelsSRGBConversion(
