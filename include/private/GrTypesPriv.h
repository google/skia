...
// In general we try to not mix CompressionType and ColorType, but curently SkImage still requires
...
static constexpr SkColorType GrCompressionTypeToSkColorType(SkImage::CompressionType compression) {
    switch (compression) {
        ...
        case SkImage::CompressionType::kETC1:           return kRGB_888x_SkColorType;
