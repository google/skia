...
enum class GrDstSampleType {
    ...
    kAsSelfTexture, // The dst value will sampled directly from the dst itself as a texture.
    kAsInputAttachment, // The dst value will sampled directly from the dst as an input attchment.
};
