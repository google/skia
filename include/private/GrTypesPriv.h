...
static constexpr GrSLType GrSLCombinedSamplerTypeForTextureType(GrTextureType type) {
    switch (type) {
...
static constexpr bool GrTextureTypeHasRestrictedSampling(GrTextureType type) {
    switch (type) {
        case GrTextureType::k2D:
            return false;
        case GrTextureType::kRectangle:
...
static constexpr GrClipEdgeType GrInvertProcessorEdgeType(const GrClipEdgeType edgeType) {
    switch (edgeType) {
