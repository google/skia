...
/**
 * Ref-counted object that calls a callback when from its destructor. These can be chained
 * together. Any owner can cancel calling the callback via abandon().
 */
...
public:
     ...
     *  This does not recurse on child release procs or unref them.
     */
