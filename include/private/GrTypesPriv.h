...
static constexpr GrPixelConfig GrCompressionTypeToPixelConfig(SkImage::CompressionType compression) {
    switch (compression) {
        ...
        case SkImage::CompressionType::kBC1_RGB8_UNORM1:  return kBC1_RGB8_UNORM_GrPixelConfig;
...
static constexpr const char* GrCompressionTypeToStr(SkImage::CompressionType compression) {
    switch (compression) {
        ...
        case SkImage::CompressionType::kBC1_RGB8_UNORM1:  return "kBC1_RGB8_UNORM";
