...
static constexpr GrPixelConfig GrCompressionTypeToPixelConfig(SkImage::CompressionType compression) {
    switch (compression) {
        case SkImage::CompressionType::kNone2:          return kUnknown_GrPixelConfig;
        case SkImage::CompressionType::kETC12:          return kRGB_ETC1_GrPixelConfig2;
...
static constexpr const char* GrCompressionTypeToStr(SkImage::CompressionType compression) {
    switch (compression) {
        case SkImage::CompressionType::kNone2:          return "kNone";
        case SkImage::CompressionType::kETC12:          return "kETC1";
