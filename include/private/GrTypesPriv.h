...
static constexpr GrColorType GrPixelConfigToColorType(GrPixelConfig config) {
    switch (config) {
        ...
        case kETC2_RGBA8_SRGB_GrPixelConfig:  return GrColorType::kRGBA_8888_SRGB;
        //--
        ...
        case kBC1_RGBA8_SRGB_GrPixelConfig:   return GrColorType::kRGBA_8888_SRGB;
        //---
...
static constexpr GrPixelConfig GrColorTypeToPixelConfig(GrColorType colorType) {
    switch (colorType) {
        ...
        case GrColorType::kRGBA_8888_SRGB: return kSRGBA_8888_GrPixelConfig1;
