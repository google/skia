...
static constexpr SkColorType GrColorTypeToSkColorType(GrColorType ct) {
    switch (ct) {
        ...
        case GrColorType::kRGBA1_1010102:     return kRGBA_1010102_SkColorType;
...
static constexpr GrColorType SkColorTypeToGrColorType(SkColorType ct) {
    switch (ct) {
        ...
        case kRGBA_1010102_SkColorType:       return GrColorType::kRGBA1_1010102;
...
static constexpr uint32_t GrColorTypeChannelFlags(GrColorType ct) {
    switch (ct) {
        ...
        case GrColorType::kRGBA1_1010102:     return kRGBA_SkColorChannelFlags;
...
static constexpr GrColorTypeDesc GrGetColorTypeDesc(GrColorType ct) {
    switch (ct) {
        ...
        case GrColorType::kBGRA_8888:
            return GrColorTypeDesc::MakeRGBA(8, GrColorTypeEncoding::kUnorm);
        case GrColorType::kRGBA1_1010102:
...
static constexpr size_t GrColorTypeBytesPerPixel(GrColorType ct) {
    switch (ct) {
        ...
        case GrColorType::kRGBA1_1010102:     return 4;
...
static constexpr const char* GrColorTypeToStr(GrColorType ct) {
    switch (ct) {
        ...
        case GrColorType::kRGBA1_1010102:     return "kRGBA_1010102";
