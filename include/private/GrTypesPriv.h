 ...
 * kNone or kMSAA when GrAA::kNo is passed to it. This adjusts that function's return value to
 ...
 */
GrAAType GrAdjustAATypeForNonAAAsCoverage(GrAAType, const GrPaint &, const GrCaps &);
