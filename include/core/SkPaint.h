...
private:
    ...
    int getTextIntercepts(const SkFont&, const uint16_t[], int count, SkScalar x, SkScalar y,
                          const SkScalar bounds[2], SkScalar* intervals) const;
    int getPosTextIntercepts(const SkFont&, const uint16_t[], int count, const SkPoint pos[],
                             const SkScalar bounds[2], SkScalar* intervals) const;
    int getPosTextHIntercepts(const SkFont&, const uint16_t[], int count, const SkScalar xpos[],
