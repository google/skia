...
public:
    ...
    */
    enum Flags {
        ...
        kGenA8FromLCD_Flag       = 0x2000, //!< not intended for public use
    ...
    */
    enum Style {
        /** Set to fill geometry.
            Applies to SkRect, SkRegion, SkRRect, Circle, Oval, SkPath, and Text.
            SkBitmap, SkImage, Patch, SkRegion, Sprite, and Vertices are painted as if kFill_Style is set,
        ...
        */
        ...
        /** Set to stroke geometry.
            Applies to SkRect, SkRegion, SkRRect, Arc, Circle, Oval,
            SkPath, and Text.
    ...
    */
    ...
    /** SkPaint::Cap
        Cap draws at the beginning and end of an open Path_Contour.
    */
    enum Cap {
    ...
    */
    struct FontMetrics {
        ...
        /** SkPaint::FontMetrics::FontMetricsFlags
