...
public:
    ...
    */
    enum Flags {
        kAntiAlias_Flag          = 0x01,   //!< mask for setting SkPaint anti-alias
        kDither_Flag             = 0x04,   //!< mask for setting SkPaint dither
        kFakeBoldText_Flag       = 0x20,   //!< mask for setting SkPaint fake bold
    ...
    */
    ...
    /** SkPaint::TextEncoding
        ...
        or glyph indices. Character codes use the encoding specified by the Unicode standard. Character codes encoded size
        are specified by UTF-8, UTF-16, or UTF-32. All character encoding are able to represent all of
        Unicode, differing only in the total storage required. UTF-8 (RFC 3629) is made up of 8-bit bytes,
        and is a superset of ASCII. UTF-16 (RFC 2781) is made up of 16-bit words,
        and is a superset of Unicode ranges 0x0000 to 0xD7FF and 0xE000 to 0xFFFF. UTF-32 is made up of 32-bit words,
    ...
    */
    ...
    /** Returns SkPaint::FontMetrics associated with SkTypeface.
        ...
        dimensions required by SkPaint text scale x, SkPaint text skew x, SkPaint fake bold,
    ...
    */
    ...
    /** Returns the bytes of text that fit within maxWidth.
        ...
        Does not scale the advance or bounds by SkPaint fake bold or SkPathEffect.
    ...
    */
    ...
    /** Retrieves the advance and bounds for each glyph in text, and returns
        ...
        Does not scale the advance by SkPaint fake bold or SkPathEffect.
        Does return include SkPaint fake bold and SkPathEffect in the bounds.
    ...
    */
    ...
    /** Returns the geometry as SkPath equivalent to the drawn text.
        ...
        and SkPaint text size, SkPaint fake bold, and SkPathEffect to scale and modify the glyph paths.
    ...
    */
    ...
    /** Returns the union of bounds of all glyphs.
        ...
        and SkPaint text skew x, but not SkPaint fake bold or SkPathEffect.
