...
public:
    ...
    */
    enum Flags {
        ...
        kDither_Flag             = 0x04,   //!< mask for setting SkPaint dither
        ...
        kDevKernText_Flag        = 0x100,  //!< mask for setting SkPaint full hinting spacing
        kLCDRenderText_Flag      = 0x200,  //!< mask for setting LCD_Text
        kEmbeddedBitmapText_Flag = 0x400,  //!< mask for setting SkPaint font embedded bitmaps
        kAutoHinting_Flag        = 0x800,  //!< mask for setting auto-hinting
        kVerticalText_Flag       = 0x1000, //!< mask for setting SkPaint vertical text
    ...
    */
    ...
    /** The limit at which a sharp corner is drawn beveled.
        ...
        @return  zero and greater SkPaint miter limit
    */
    ...
    /** The limit at which a sharp corner is drawn beveled.
        ...
        @param miter  zero and greater SkPaint miter limit
    */
