...
public:
    ...
    */
    ...
    /** Compares a and b, and returns true if a and b are equivalent. May return false
        if SkTypeface, SkPathEffect, SkShader, SkMaskFilter, SkColorFilter, SkRasterizer, SkDrawLooper,
    ...
    */
    ...
    /** \enum SkPaint::Hinting
        SkPaint::Hinting adjusts the glyph outlines so that the shape provides a uniform
        look at a given point size on font engines that support it. SkPaint::Hinting may have a
    ...
    */
    ...
    /** \enum SkPaint::Flags
        The bit values stored in SkPaint::Flags.
        The default value for SkPaint::Flags, normally zero, can be changed at compile time
        with a custom definition of SkPaintDefaults_Flags.
        All flags can be read and written explicitly; SkPaint::Flags allows manipulating
        multiple settings at once.
    */
    enum Flags {
        kAntiAlias_Flag          = 0x01,        //!< mask for setting Anti-alias
        kDither_Flag             = 0x04,        //!< mask for setting Dither
        kFakeBoldText_Flag       = 0x20,        //!< mask for setting Fake_Bold
        kLinearText_Flag         = 0x40,        //!< mask for setting Linear_Text
        kSubpixelText_Flag       = 0x80,        //!< mask for setting Subpixel_Text
        kDevKernText_Flag        = 0x100,       //!< mask for setting Full_Hinting_Spacing
        kLCDRenderText_Flag      = 0x200,       //!< mask for setting LCD_Text
        kEmbeddedBitmapText_Flag = 0x400,       //!< mask for setting Font_Embedded_Bitmaps
        kAutoHinting_Flag        = 0x800,       //!< mask for setting Automatic_Hinting
        kVerticalText_Flag       = 0x1000,      //!< mask for setting Vertical_Text
        /** not intended for public use
        */
        kGenA8FromLCD_Flag       = 0x2000,
        /** mask of all SkPaint::Flags, including private flags and flags
    ...
    */
    ...
    /** Sets SkPaint::Flags to the union of the SkPaint::Flags members.
        ...
        @param flags  union of SkPaint::Flags for Paint
    */
    ...
    */
    ...
    /** \enum SkPaint::Style
        Set SkPaint::Style to kStrokeAndFill_Style to fill, stroke, or both fill and stroke geometry.
        The stroke and fill
    ...
    */
    enum Style {
        /** Set to fill geometry.
            Applies to SkRect, Region, SkRRect, Circle, Oval, SkPath, and Text.
            SkBitmap, SkImage, Patch, Region, Sprite, and Vertices are painted as if kFill_Style is set,
            and ignore the set SkPaint::Style.
            ...
            SkPaint::Style is set to kFill_Style by default.
        */
        kFill_Style,
        /** Set to stroke geometry.
            Applies to SkRect, Region, SkRRect, Arc, Circle, Oval,
            SkPath, and Text.
            Arc, Line, SkPoint, and point array are always drawn as if kStroke_Style is set,
            and ignore the set SkPaint::Style.
    ...
    enum {
        /** The number of different SkPaint::Style values defined.
    ...
    */
    ...
    /** Retrieves color alpha and Color_RGB, unpremultiplied, packed into 32 bits.
    ...
    */
    ...
    /** Sets color alpha and Color_RGB used when stroking and filling. The color is a 32-bit value,
        unpremutiplied, packing 8-bit components for color alpha, Color_RGB_Red, Color_RGB_Blue, and Color_RGB_Green.
    ...
    */
    ...
    /** \enum SkPaint::Cap
        SkPaint::Cap draws at the beginning and end of an open Path_Contour.
    */
    enum Cap {
        kButt_Cap,                       //!< Does not extend the stroke past the beginning or the end.
        /** Adds a circle with a diameter equal to SkPaint stroke width at the beginning
            and end.
        */
        kRound_Cap,
        /** Adds a square with sides equal to SkPaint stroke width at the beginning
            and end. The square sides are parallel to the initial and final direction
            of the stroke.
        */
        kSquare_Cap,
        kLast_Cap    = kSquare_Cap,      //!< Equivalent to the largest value for Stroke_Cap.
        /** Equivalent to kButt_Cap.
            SkPaint::Cap is set to kButt_Cap by default.
        */
    ...
    */
    enum Join {
        /** Extends the outside of the to the extent allowed by SkPaint miter limit.
            If the extension exceeds SkPaint miter limit, kBevel_Join is used instead.
        */
        kMiter_Join,
        /** Adds a circle with a diameter of SkPaint stroke width at the sharp corner.
        */
        kRound_Join,
        kBevel_Join,                      //!< Connects the outside edges of the sharp corner.
        kLast_Join    = kBevel_Join,      //!< Equivalent to the largest value for Stroke_Join.
        /** Equivalent to kMiter_Join.
            SkPaint::Join is set to kMiter_Join by default.
        */
    ...
    */
    ...
    /** Optional colors used when filling a path, such as a gradient.
        ...
        Does not alter SkShader Reference_Count.
    ...
    */
    ...
    /** Returns SkColorFilter if set, or nullptr.
        Does not alter SkColorFilter Reference_Count.
    ...
    */
    ...
    /** Returns SkPathEffect if set, or nullptr.
        Does not alter SkPathEffect Reference_Count.
    ...
    */
    ...
    /** Returns SkMaskFilter if set, or nullptr.
        Does not alter SkMaskFilter Reference_Count.
    ...
    */
    ...
    /** Returns SkTypeface if set, or nullptr.
        Does not alter SkTypeface Reference_Count.
    ...
    */
    ...
    /** Returns SkRasterizer if set, or nullptr.
        Does not alter SkRasterizer Reference_Count.
    ...
    */
    ...
    /** Returns SkImageFilter if set, or nullptr.
        Does not alter SkImageFilter Reference_Count.
    ...
    */
    ...
    /** Returns SkDrawLooper if set, or nullptr.
        Does not alter SkDrawLooper Reference_Count.
    ...
    */
    enum Align {
        ...
        */
        kLeft_Align,
        /** Moves the glyph half its width if SkPaint::Flags has kVerticalText_Flag clear, and
            half its height if SkPaint::Flags has kVerticalText_Flag set.
        */
        ,
        kCenter_Align,
        /** Moves the glyph by its width if SkPaint::Flags has kVerticalText_Flag clear,
            and by its height if SkPaint::Flags has kVerticalText_Flag set.
        */
        ,
        kRight_Align
    };
    ...
    */
    ...
    /** Returns SkPaint text size in points.

        @return  typographic height of text
    */
    SkScalar getTextSize() const { return fTextSize; }

    /** Sets SkPaint text size in points.
    ...
    */
    ...
    /** getTextSkewX returns SkPaint text skew x.
    ...
    */
    ...
    /** setTextSkewX sets SkPaint text skew x.
        Default value is zero.
    ...
    */
    ...
    /** \enum SkPaint::TextEncoding
        ...
        or glyph indices. Character codes use the encoding specified by the. Character codes encoded size
        are specified by UTF-8, UTF-16, or UTF-32. All character encoding are able to represent all of
        Unicode, differing only in the total storage required.is made up of 8-bit bytes,
        and is a superset of ASCII.is made up of 16-bit words,
        and is a superset of Unicode ranges 0x0000 to 0xD7FF and 0xE000 to 0xFFFF.is made up of 32-bit words,
    ...
    */
    ...
    /** Returns SkPaint::FontMetrics associated with SkTypeface.
        ...
        Results are scaled by SkPaint text size but does not take into account
        dimensions required by SkPaint text scale x, SkPaint text skew x, fake bold,
    ...
    */
    ...
    /** Returns the recommended spacing between lines: the sum of metrics
        descent, ascent, and leading.
        Result is scaled by SkPaint text size but does not take into account
    ...
    */
    ...
    /** Returns the advance width of text if kVerticalText_Flag is clear,
        ...
        and SkPaint text size, SkPaint text scale x, SkPaint text skew x, SkPaint stroke width, and
    ...
    */
    ...
    /** Returns the bytes of text that fit within maxWidth.
        ...
        Uses SkPaint::TextEncoding to decode text, SkTypeface to get the font metrics,
        and SkPaint text size to scale the metrics.
        Does not scale the advance or bounds by SkPaint text decorations
        or Path_Effect.
    ...
    */
    ...
    /** Retrieves the advance and bounds for each glyph in text, and returns
        ...
        Uses SkPaint::TextEncoding to decode text, SkTypeface to get the font metrics,
        and SkPaint text size to scale the widths and bounds.
        Does not scale the advance by SkPaint text decorations or SkPathEffect.
        Does return include SkPaint text decorations and SkPathEffect in the bounds.
    ...
    */
    ...
    /** Returns the geometry as SkPath equivalent to the drawn text.
        ...
        and SkPaint text size, SkPaint text decorations, and SkPathEffect to scale and modify the glyph paths.
    ...
    */
    ...
    /** getTextIntercepts returns the number of intervals that intersect bounds.
        ...
        the string.
        getTextIntercepts uses SkPaint::TextEncoding to decode text, SkTypeface to get the glyph paths,
        and SkPaint text size, SkPaint text decorations, and SkPathEffect to scale and modify the glyph paths.
    ...
    */
    ...
    /** Returns the union of bounds of all glyphs.
        ...
        ignoring SkPaint::Hinting. getFontBounds includes SkPaint text size, SkPaint text scale x,
        and SkPaint text skew x, but not fake bold or SkPathEffect.

        If SkPaint text size is large, SkPaint text scale x is one, and SkPaint text skew x is zero,
