...
public:
    ...
    */
    void setStrokeCap(Cap cap) { fBitfields.fCapType = SkToU8(cap); }
    ...
    */
    void setStrokeJoin(Join join) { fBitfields.fJoinType = SkToU8(join); }
    ...
    */
    void setTextSize(SkScalar textSize) { fTextSize = textSize; }
