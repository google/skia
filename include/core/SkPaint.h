...
private:
    ...
    void getScalerContextDescriptor(SkScalerContextEffects*, SkAutoDescriptor*,
                                    ...
                                    SkScalerContextFlags scalerContextFlags, const SkMatrix*) const;

    SkGlyphCache* detachCache(const SkSurfaceProps* surfaceProps,
                              SkScalerContextFlags scalerContextFlags,
                              const SkMatrix*) const;

    void descriptorProc(const SkSurfaceProps* surfaceProps, SkScalerContextFlags scalerContextFlags,
