...
public:
    ...
    enum class AlphaType {
        ...
        NonlinearPremul, // Pixels are premultiplied after the transfer funciton:  a, tf(r)*a...
...
private:
    ...
    SkColorSpaceTransferFn               fDstTF, fSrcTF;
    float                                fSrcGamutToDstGamut[12];  // 3x4 column-major matrix
    SkJumper_MemoryCtx                   fDst, fSrc;
    std::function<void(int,int,int,int)> fRun;
};
