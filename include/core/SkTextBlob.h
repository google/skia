...
/* Generated by tools/bookmaker from include/core/SkTextBlob.h and docs/SkTextBlob_Reference.bmh
   on 2018-08-10 10:11:39. Additional documentation and examples can be found at:
...
public:
    ...
    */
    ...
    /** Creates SkTextBlob with a single run. text meaning depends on SkPaint::TextEncoding;
        ...
        SkPaint font embedded bitmaps, SkPaint full hinting spacing, LCD text, SkPaint linear text, and
        SkPaint subpixel text.
...
public:
    ...
    */
    ...
    /** \struct SkTextBlobBuilder::RunBuffer
        ...
        utf8text and clusters are set to nullptr.
    */
    struct RunBuffer {
        SkGlyphID* glyphs;
        SkScalar* pos;
