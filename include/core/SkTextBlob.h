...
public:
    ...
    */
    ...
    /** Returns run with storage for glyphs, text, and clusters. Caller must
        ...
        into utf8text, and count monotonic indexes to the UTF-8 code units
        into clusters before next call to SkTextBlobBuilder.
    ...
    */
    ...
    /** Returns run with storage for glyphs, positions along baseline, text,
        ...
        utf8text, and count monotonic indexes to the UTF-8 code units before
        next call to SkTextBlobBuilder.
