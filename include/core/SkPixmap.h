...
public:
    ...
    */
    ...
    /** Returns width, height, SkAlphaType, native SkColorType, and SkColorSpace.
    ...
    */
    ...
    /** Returns native SkColorType, one of: kUnknown_SkColorType, kAlpha_8_SkColorType,
        ...
        @return  native SkColorType in SkImageInfo
    */
    ...
    */
    ...
    /** Returns true if SkAlphaType is kOpaque_SkAlphaType.
        Does not check if native SkColorType allows alpha, or if any pixel value has
        transparency.
    ...
    */
    ...
    /** Returns true if all pixels are opaque. native SkColorType determines how pixels
        are encoded, and whether pixel describes alpha. Returns true for native SkColorType
        without alpha in each pixel; for other native SkColorType, returns true if all
        pixels have alpha values equivalent to 1.0 or greater.

        For native SkColorType kRGB_565_SkColorType or kGray_8_SkColorType: always
        returns true. For native SkColorType kAlpha_8_SkColorType, kBGRA_8888_SkColorType,
        kRGBA_8888_SkColorType: returns true if all pixel alpha values are 255.
        For native SkColorType kARGB_4444_SkColorType: returns true if all pixel alpha values are 15.
        For kRGBA_F16_SkColorType: returns true if all pixel alpha values are 1.0 or
        greater.

        Returns false for kUnknown_SkColorType.

        @return  true if all pixels have opaque values or native SkColorType is opaque
    */
    bool computeIsOpaque() const;

    /** Returns pixel at (x, y) as unpremultiplied color.
        Returns black with alpha if native SkColorType is kAlpha_8_SkColorType.

        Input is not validated: out of bounds values of x or y trigger an assert() if
        built with SK_DEBUG defined; and returns undefined values or may crash if
        SK_RELEASE is defined. Fails if native SkColorType is kUnknown_SkColorType or
    ...
    */
    ...
    /** Returns readable pixel address at (x, y). Returns nullptr if SkPixelRef is nullptr.
        ...
        Input is not validated: out of bounds values of x or y trigger an assert() if
        built with SK_DEBUG defined. Returns nullptr if native SkColorType is kUnknown_SkColorType.
    ...
    */
    ...
    /** Returns readable base pixel address. Result is addressable as unsigned 8-bit bytes.
        Will trigger an assert() if native SkColorType is not kAlpha_8_SkColorType or
    ...
    */
    ...
    /** Returns readable base pixel address. Result is addressable as unsigned 16-bit words.
        Will trigger an assert() if native SkColorType is not kRGB_565_SkColorType or
    ...
    */
    ...
    /** Returns readable base pixel address. Result is addressable as unsigned 32-bit words.
        Will trigger an assert() if native SkColorType is not kRGBA_8888_SkColorType or
    ...
    */
    ...
    /** Returns readable base pixel address. Result is addressable as unsigned 64-bit words.
        Will trigger an assert() if native SkColorType is not kRGBA_F16_SkColorType and is built
    ...
    */
    ...
    /** Returns writable pixel address at (x, y).
        ...
        Input is not validated: out of bounds values of x or y trigger an assert() if
        built with SK_DEBUG defined. Returns zero if native SkColorType is kUnknown_SkColorType.
    ...
    */
    ...
    /** Returns writable pixel address at (x, y). Result is addressable as unsigned
        8-bit bytes. Will trigger an assert() if native SkColorType is not kAlpha_8_SkColorType
    ...
    */
    ...
    /** Returns writable_addr pixel address at (x, y). Result is addressable as unsigned
        16-bit words. Will trigger an assert() if native SkColorType is not kRGB_565_SkColorType
    ...
    */
    ...
    /** Returns writable pixel address at (x, y). Result is addressable as unsigned
        32-bit words. Will trigger an assert() if native SkColorType is not
    ...
    */
    ...
    /** Returns writable pixel address at (x, y). Result is addressable as unsigned
        64-bit words. Will trigger an assert() if native SkColorType is not
    ...
    */
    ...
    /** Returns writable pixel address at (x, y). Result is addressable as unsigned
        16-bit words. Will trigger an assert() if native SkColorType is not
        kRGBA_F16_SkColorType and is built with SK_DEBUG defined.
    ...
    */
    ...
    /** Copies a SkRect of pixels to dstPixels. Copy starts at (srcX, srcY), and does not
        ...
        dstInfo specifies width, height, native SkColorType, SkAlphaType, and
        ...
        @param dstInfo      destination width, height, native SkColorType, SkAlphaType, SkColorSpace
    ...
    */
    ...
    /** Copies a SkRect of pixels to dst. Copy starts at (srcX, srcY), and does not
        exceed SkPixmap (width(), height()). dst specifies width, height, native SkColorType,
    ...
    */
    ...
    /** Copies pixels inside bounds() to dst. dst specifies width, height, native SkColorType,
        SkAlphaType, and SkColorSpace of destination.  Returns true if pixels are copied.
        Returns false if dst.addr() equals nullptr, or dst.rowBytes() is less than
        dst SkImageInfo::minRowBytes.

        Pixels are copied only if pixel conversion is possible. If SkPixmap colorType() is
        kGray_8_SkColorType, or kAlpha_8_SkColorType; dst native SkColorType must match.
