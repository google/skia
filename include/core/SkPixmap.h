...
public:
    ...
    */
    ...
    /** Copies a SkRect of pixels to dstPixels. Copy starts at (srcX, srcY), and does not exceed (this->width(), this->height()) .
        ...
        false if width() or height() is zero or negative. Returns false if abs(srcX) >= this->width(), or if abs(srcY) >= this->height() .
    ...
    */
    ...
    /** Copies a SkRect of pixels to dstPixels. Copy starts at (srcX, srcY), and does not
        ...
        srcX and srcY may be negative to copy only top or left of source. Returns
        false if this->width() or this->height() is zero or negative. Returns false if abs(srcX) >= this->width(), or if abs(srcY) >= this->height() .
    ...
    */
    ...
    /** Copies a SkRect of pixels to dst. Copy starts at (srcX, srcY), and does not
        ...
        srcX and srcY may be negative to copy only top or left of source. Returns
        false this->width() or this->height() is zero or negative. Returns false if abs(srcX) >= this->width(), or if abs(srcY) >= this->height() .
