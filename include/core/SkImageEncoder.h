...
inline sk_sp<SkData> SkEncodeImage(const SkPixmap& src, SkEncodedImageFormat format,
                                   const SkEncodeOptions& options) {
...
inline bool SkEncodeImage(SkWStream* dst, const SkPixmap& src, SkEncodedImageFormat format,
                          int quality) {
