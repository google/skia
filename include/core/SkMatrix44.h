...
static const SkScalar SK_MScalarPI = 3.14159265f;
static const SkScalar SK_MScalarNaN = SK_FloatNaN;
...
#define SkIntToMScalar(n)       static_cast<SkScalar>(n)
...
private:
    ...
    SkScalar transX() const { return fMat[12]; }
    SkScalar transY() const { return fMat[13]; }
    SkScalar transZ() const { return fMat[14]; }

    SkScalar scaleX() const { return fMat[0]; }
    SkScalar scaleY() const { return fMat[5]; }
    SkScalar scaleZ() const { return fMat[10]; }

    SkScalar perspX() const { return fMat[3]; }
    SkScalar perspY() const { return fMat[7]; }
    SkScalar perspZ() const { return fMat[11]; }
    ...
    inline const SkScalar* colMajorValues() const { return fMat; }
