...
#if SK_WHITELIST_SERIALIZED_TYPEFACES && !SK_SUPPORT_LEGACY_GLOBAL_SKFONTMGR
#  error "SK_WHITELIST_SERIALIZED_TYPEFACES requires SK_SUPPORT_LEGACY_GLOBAL_SKFONTMGR"
#endif
