...
public:
    ...
    public:
        ...
        PromiseImageTexture(const PromiseImageTexture&) = default;
        ...
        PromiseImageTexture& operator=(const PromiseImageTexture&) = default;
    ...
    using LegacyPromiseImageTextureFulfillProc = void(*)(PromiseImageTextureContext, GrBackendTexture*);
