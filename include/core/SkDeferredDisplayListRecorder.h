...
public:
    ...
    /**
        Create a new SkImage that is very similar to the SkImage created by MakeFromTexture. The main
        ...
        match those set during the SkImage creation, and it must contain a valid backend gpu texture.
        ...
        In other words we will will never call textureFulfillProc or textureReleaseProc multiple
        times for the same textureContext before calling the other.
