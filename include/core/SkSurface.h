...
public:
     ...
     *  we will use for rendering. We then resolve into the passed in texture.
     *
     *  The GrBackendTexture mush have a valid backend format supplied (GrGLTextureInfo::fFormat,
    ...
    /**
     *  The GrBackendRenderTarget mush have a valid backend format set (GrGLTextureInfo::fFormat,
     *  GrVkImageInfo::fFormat, etc.) in it. The passed in SkColorType informs skia how it should
