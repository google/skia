...
public:
    ...
    */
    ...
    /** Issues pending SkSurface commands to the GPU-backed API and resolves any SkSurface MSAA.
        ...
        The GrSurfaceFlushInfo describes additional options to flush.
        ...
        to wait on any of the semaphores passed in the GrSurfaceFlushInfo.

        Pending surface commands are flushed regardless of the return result.

        @param access  type of access the call will do on the backend object after flush
        @param inf     flush options
        @return        one of: GrSemaphoresSubmitted::kYes, GrSemaphoresSubmitted::kNo
    */
    GrSemaphoresSubmitted flush(BackendSurfaceAccess access, const GrSurfaceFlushInfo& info);
