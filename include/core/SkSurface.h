...
public:
    ...
    */
    ...
    /** Issues pending SkSurface commands to the GPU-backed API and resolves any SkSurface MSAA.
        ...
        are signaled by the GPU. The work that is submitted to the GPU will be dependent on the
        BackendSurfaceAccess that is passed in.
        ...
        SkSurface will have its queue transferred to that of which is was created. If the SkSurface
        was created by wrapping a VkImage, the queue will be set to the queue which was originally
        passed in on the GrVkImageInfo. Additionally, if the original queue was not external or
        foreign the layout of the VkImage will be set to VK_IMAGE_LAYOUT_PRESENT_SRC_KHR.
