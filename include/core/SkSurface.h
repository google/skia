...
public:
     ...
     *
     * If this call returns falls, the GPU backend will not have created or added any semaphores to
     ...
     * call returns false, then the GPU backend will not wait on any passed in semaphores, and
     * the client will still own the semaphores.
     */
