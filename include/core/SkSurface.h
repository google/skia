    ...
    */
    ...
    /** Issues pending SkSurface commands to the GPU-backed API and resolves any SkSurface MSAA.
        ...
        GrFlushInfo for more info.
         ...
         will not have submitted any semaphores to be signal on the GPU. Thus the client should not
         have the GPU wait on any of the semaphores passed in with the GrFlushInfo. Regardless of
         whether semaphores were submitted to the GPU or not, the cliet is still responsible for
