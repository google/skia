...
public:
    ...
    */
    ...
    /** Makes surface pixel data available to caller, possibly asynchronously. It can also rescale
        ...
        @param sampling        controls the technique of the rescaling
    ...
    void asyncRescaleAndReadPixels(const SkImageInfo& info,
                                   ...
                                   ReadPixelsCallback callback,
                                   ReadPixelsContext context) {
        return asyncRescaleAndReadPixels(info, srcRect, rescaleGamma, SkSamplingOptions(quality),
                                         callback, context);
    }
#endif
    ...
    /**
        ...
        @param rescaleGamma   controls whether rescaling is done in the surface's gamma or whether
                              the source data is transformed to a linear gamma before rescaling.
        @param sampling       controls the sampling technique of the rescaling
    ...
    void asyncRescaleAndReadPixelsYUV420(SkYUVColorSpace yuvColorSpace,
        ...
        return asyncRescaleAndReadPixelsYUV420(yuvColorSpace, std::move(dstColorSpace), srcRect,
                                               dstSize, rescaleGamma, SkSamplingOptions(quality),
                                               callback, context);
    }
#endif
