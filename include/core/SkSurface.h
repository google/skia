...
public:
    ...
    /** Allocates raster SkSurface. SkCanvas returned by SkSurface draws directly into pixels.
        ...
        rowBytes is large enough to contain info width pixels of color type.

        Pixel buffer size should be info height times computed rowBytes.
        Pixels are not initialized.
        To access pixels after drawing, call flush() or peekPixels().

        @param imageInfo     width, height, color type, alpha type, SkColorSpace,
    ...
    */
    ...
    /** Allocates raster SkSurface. SkCanvas returned by SkSurface draws directly into pixels.
        ...
        info dimensions are greater than zero;
        info contains color type and alpha type supported by raster surface;
        rowBytes is large enough to contain info width pixels of color type, or is zero.
    ...
    */
    ...
    /** Allocates raster SkSurface. SkCanvas returned by SkSurface draws directly into pixels.
        ...
        Internally, sets SkYUVColorSpace to width, height, native color type, and
        kPremul_SkAlphaType.
    ...
    */
    ...
    /** Returns SkSurface on GPU indicated by context. Allocates memory for
        pixels, based on the width, height, and color type in ImageInfo.  budgeted
        selects whether allocation for pixels is tracked by context. imageInfo
        describes the pixel format in color type, and transparency in
        alpha type, and color matching in SkColorSpace.
    ...
    */
    ...
    /** Copies SkSurface pixel address, row bytes, and SkYUVColorSpace to SkPixmap, if address
