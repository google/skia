...
public:
    ...
    /** Allocates raster SkSurface. SkCanvas returned by SkSurface draws directly into pixels.
        ...
        rowBytes is large enough to contain info width pixels of native SkColorType.

        Pixel buffer size should be info height times computed rowBytes.
        Pixels are not initialized.
        To access pixels after drawing, call flush() or peekPixels().

        @param imageInfo     width, height, native SkColorType, SkAlphaType, SkColorSpace,
    ...
    */
    ...
    /** Allocates raster SkSurface. SkCanvas returned by SkSurface draws directly into pixels.
        ...
        info dimensions are greater than zero;
        info contains native SkColorType and SkAlphaType supported by raster surface;
        rowBytes is large enough to contain info width pixels of native SkColorType, or is zero.
    ...
    */
    ...
    /** Returns SkSurface on GPU indicated by context. Allocates memory for
        pixels, based on the width, height, and native SkColorType in ImageInfo.  budgeted
        selects whether allocation for pixels is tracked by context. imageInfo
        describes the pixel format in native SkColorType, and transparency in
