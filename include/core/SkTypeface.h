...
public:
     ...
     *  axis names specified by the font.
    ...
    /** Copy into 'coordinates' (allocated by the caller) the variation design instances.
     *
     *  @param index the index of the variation instance.
    ...
    /**
     *  Returns an iterator which will attempt to enumerate all of the
     *  variable desgin instances specified by the font.
     *  It is the caller's responsibility to unref() the returned pointer.
     */
    LocalizedStrings* createVariationDesignInstanceNameIterator(int axis) const;
    ...
    /**
     *  Returns an iterator which will attempt to enumerate all of the
     *  palettes specified by the font.
     *  It is the caller's responsibility to unref() the returned pointer.
     */
...
protected:
    ...
    */
    ...
    virtual LocalizedStrings* onCreateVariationDesignInstanceNameIterator(int axis) const;
