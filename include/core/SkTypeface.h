...
public:
     ...
     */
    sk_sp<LocalizedStrings> createAxisNameIterator(int axis) const;
     ...
     *  It is the caller's responsibility to unref() the returned pointer.
     */
    sk_sp<LocalizedStrings> createVariationDesignInstanceNameIterator(int instance) const;
     ...
     *  It is the caller's responsibility to unref() the returned pointer.
     */
    sk_sp<LocalizedStrings> createPaletteNameIterator(int palette) const;
...
protected:
    ...
    */
    ...
    virtual sk_sp<LocalizedStrings> onCreateFamilyNameIterator() const = 0;

    virtual sk_sp<LocalizedStrings> onCreateAxisNameIterator(int axis) const;

    virtual sk_sp<LocalizedStrings> onCreateVariationDesignInstanceNameIterator(
        int instance) const;

    virtual sk_sp<LocalizedStrings> onCreatePaletteNameIterator(int palette) const;
