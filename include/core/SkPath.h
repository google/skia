...
public:
    ...
    */
    ...
    SkPath& addRect(const SkRect& rect, Direction);
    SkPath& addRect(const SkRect& rect, Direction, unsigned start);
    SkPath& addRect(SkScalar left, SkScalar top, SkScalar right, SkScalar bottom,
                    Direction);
    SkPath& addOval(const SkRect& oval, Direction);
    SkPath& addOval(const SkRect& oval, Direction, unsigned start);
    SkPath& addCircle(SkScalar x, SkScalar y, SkScalar radius, Direction);
    SkPath& addRoundRect(const SkRect& rect, SkScalar rx, SkScalar ry, Direction);
    SkPath& addRoundRect(const SkRect& rect, const SkScalar radii[], Direction);
    SkPath& addRRect(const SkRRect& rrect, Direction);
    SkPath& addRRect(const SkRRect& rrect, Direction, unsigned start);
#endif
