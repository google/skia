...
enum Direction {
    ...
    */
    ...
    /** Approximates conic with quad array. Conic is constructed from start SkPoint p0,
        ...
        (1 + 2 * (1 << pow2)) * sizeof(SkPoint)ConvertConicToQuads returns quad count used the approximation, which may be smaller
    ...
    */
    ...
    /** Add circle centered at (x, y) of size radius to SkPath, appending kMove_Verb,
        ...
        (x + radius, y)and continues clockwise if dir is kCW_Direction, counterclockwise if dir is
        kCCW_Direction.
    ...
    */
    ...
    /** Add contour created from line array, adding
        count - 1Line segments. Contour added starts at pts[0], then adds a line
        for every additional SkPoint in pts array. If close is true,
        appends kClose_Verb to SkPath, connecting pts[count - 1] and pts[0].
