...
public:
    ...
    */
    bool isConvex() const {
        return SkPathConvexityType::kConvex == this->getConvexity();
    }
    ...
    */
    ...
    bool isRect(SkRect* rect, bool* isClosed = nullptr, Direction* direction = nullptr) const {
        return this->isRect(rect, isClosed, static_cast<SkPathDirection*>(direction));
    }
    ...
    SkPath& addRoundRect(const SkRect& rect, SkScalar rx, SkScalar ry,
                         Direction dir = kCW_Direction) {
        return this->addRoundRect(rect, rx, ry, static_cast<SkPathDirection>(dir));
    }
    SkPath& addRoundRect(const SkRect& rect, const SkScalar radii[],
                         Direction dir = kCW_Direction) {
        return this->addRoundRect(rect, radii, static_cast<SkPathDirection>(dir));
    }
