 ...
 */
class SK_API SkNewVerts : public SkNVRefCnt<SkNewVerts> {
public:
    enum VertexMode {
     ...
     */
    static sk_sp<SkNewVerts> MakeCopy(VertexMode mode, int vertexCount,
                                      const SkPoint vertices[],
                                      int perVertexDataCount,
                                      SkScalar vertData[],  // [vertexCount * perVertexDataCount]
                                      int indexCount,
    ...
    class Builder {
    public:
        Builder(VertexMode mode, int vertexCount, int perVertDataCount, int indexCount);
    ...
    int perVertexDataCount() const { return fVDataCnt; }
    int indexCount() const { return fIndexCnt; }

    const SkPoint* positions() const { return fPositions; }
    const SkScalar* perVertexData() const { return fVData; }
