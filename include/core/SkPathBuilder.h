...
public:
    ...
    void addRect(const SkRect&, SkPathDirection dir = kCW_SkPathDirection);
    void addOval(const SkRect&, SkPathDirection dir = kCW_SkPathDirection);
    void addRRect(const SkRRect&, SkPathDirection dir = kCW_SkPathDirection);

private:
    SkTDArray<SkPoint>  fPts;
    SkTDArray<char>     fVerbs;
    sk_sp<SkROPath>     fCachedPath;
};
