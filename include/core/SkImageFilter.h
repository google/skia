...
protected:
    ...
    // If 'mungedSrcBounds' will sample outside the border of 'originalSrcBounds' (i.e., the sample
    ...
    static bool IntersectWithRepeat(SkIRect* mungedSrcBounds, const SkIRect& filterRect,
