...
public:
    ...
    struct PDFMetadata {
        ...
        /** The default behavior is to use lossless encoding for images, but if this is true,
         *  then opaque images may uses a lossy encoding which may reduce the document size.
         */
        bool fAllowLossyEncoding = false;
    };
