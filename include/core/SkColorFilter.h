...
private:
    ...
    /*
     *  Returns true and sets |outer| and |inner| is this is a compose color filter.
     *  Returns false otherwise.
     */
    virtual bool asACompose(sk_sp<SkColorFilter>* /*outer*/, sk_sp<SkColorFilter>* /*inner*/) const
    {
        return false;
    }
