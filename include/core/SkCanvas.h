...
public:
    ...
    */
     ...
     */
    void experimentalDrawImageSet(const ImageSetEntry imageSet[], int cnt, float alpha,
                                  SkBlendMode);
...
protected:
    ...
    virtual void onDrawImageSet(const ImageSetEntry imageSet[], int cnt, float alpha, SkBlendMode);
