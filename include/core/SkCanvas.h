...
public:
    ...
    /** Allocates raster SkCanvas that will draw directly into pixels.
        ...
        info contains native SkColorType and SkAlphaType supported by raster surface;
        pixels is not nullptr;
        rowBytes is zero or large enough to contain info width pixels of native SkColorType.

        Pass zero for rowBytes to compute rowBytes from info width and size of pixel.
        If rowBytes is greater than zero, it must be equal to or greater than
        info width times bytes required for native SkColorType.

        Pixel buffer size should be info height times computed rowBytes.
        Pixels are not initialized.
        To access pixels after drawing, call flush() or peekPixels().

        @param info      width, height, native SkColorType, SkAlphaType, SkColorSpace, of raster surface;
    ...
    */
    ...
    /** Allocates raster SkCanvas specified by inline image specification. Subsequent SkCanvas
        ...
        native SkColorType is set to kN32_SkColorType.
        ...
        If rowBytes is greater than zero, it must be equal to or greater than
        width times bytes required for native SkColorType.
    ...
    */
    ...
    /** Construct a canvas that draws into bitmap.
        ...
        @param bitmap  width, height, native SkColorType, SkAlphaType, and pixel
    ...
    */
    ...
    /** Construct a canvas that draws into bitmap.
        ...
        @param bitmap  width, height, native SkColorType, SkAlphaType,
    ...
    */
    ...
    /** Returns SkImageInfo for SkCanvas. If SkCanvas is not associated with raster surface or
        GPU surface, returned native SkColorType is set to kUnknown_SkColorType.

        @return  dimensions and native SkColorType of SkCanvas
    */
    ...
    */
    ...
    /** Creates SkSurface matching info and props, and associates it with SkCanvas.
        ...
        @param info   width, height, native SkColorType, SkAlphaType, and SkColorSpace
    ...
    */
    ...
    /** Copies SkRect of pixels from SkCanvas into dstPixels. SkMatrix and clip are
        ...
        Pixel values are converted only if native SkColorType and SkAlphaType
        ...
        @param dstInfo      width, height, native SkColorType, and SkAlphaType of dstPixels
    ...
    */
    ...
    /** Copies SkRect of pixels from SkCanvas into bitmap. SkMatrix and clip are
        ...
        SkBitmap values are converted only if native SkColorType and SkAlphaType
        do not match. Only pixels within both source and destination rectangles
    ...
    */
    ...
    /** Copies SkRect from pixels to SkCanvas. SkMatrix and clip are ignored.
        ...
        @param info      width, height, native SkColorType, and SkAlphaType of pixels
    ...
    */
    ...
    /** Saves SkMatrix, clip, and SkDrawFilter (Draw_Filter deprecated on most platforms),
        and allocates a SkBitmap for subsequent drawing.
        SkPaint text is preserved when the layer is drawn to the prior layer.
        ...
        Draw text on an opaque background so that SkPaint text blends correctly with the
        prior layer. SkPaint text drawn on a background with transparency may result in
        incorrect blending.
    ...
    */
    ...
    /** Draw SkTextBlob blob at (x, y), using clip, SkMatrix, and SkPaint paint.
        ...
        SkPaint embedded bitmaps, SkPaint hinting spacing, SkPaint text, SkPaint text,
        SkPaint text, and SkPaint vertical text.
