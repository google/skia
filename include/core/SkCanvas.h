...
public:
    ...
    */
    ...
    /** Draws count glyphs, at positions relative to origin styled with font and paint with
       ...
       This function draw glyphs a the given positions relative to the given origin.
       ...
       @param textSize    size of the utf8text
    ...
    */
    void drawGlyphs(int count, const SkGlyphID glyphs[], const SkPoint positions[],
                    const uint32_t clusters[], int textSize, const char utf8text[],
