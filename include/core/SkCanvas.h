...
public:
    ...
    /** Allocates raster SkCanvas that will draw directly into pixels.
        ...
        @example https://fiddle.skia.org/c/@Canvas_000
    */
    ...
    /** Allocates raster SkCanvas specified by inline image specification. Subsequent SkCanvas
        ...
        @example https://fiddle.skia.org/c/@Canvas_001
    */
    ...
    /** Creates an empty SkCanvas with no backing device or pixels, with
        ...
        @example https://fiddle.skia.org/c/@Canvas_002
    */
    SkCanvas();
    ...
    /** Creates SkCanvas of the specified dimensions without a SkSurface.
        ...
        @example https://fiddle.skia.org/c/@Canvas_003
    */
    ...
    */
    ...
    /** Constructs a canvas that draws into bitmap.
        ...
        @example https://fiddle.skia.org/c/@Canvas_004
    */
    ...
    */
    ...
    /** Constructs a canvas that draws into bitmap.
        ...
        @example https://fiddle.skia.org/c/@Canvas_005
    */
    ...
    /** Draws saved layers, if any.
        ...
        @example https://fiddle.skia.org/c/@Canvas_006
    */
    virtual ~SkCanvas();
    ...
    /** Returns SkImageInfo for SkCanvas. If SkCanvas is not associated with raster surface or
        ...
        @example https://fiddle.skia.org/c/@Canvas_008
    */
    ...
    /** Copies SkSurfaceProps, if SkCanvas is associated with raster surface or
        ...
        @example https://fiddle.skia.org/c/@Canvas_009
    */
    ...
    */
    ...
    /** Gets the size of the base or root layer in global canvas coordinates. The
        ...
        @example https://fiddle.skia.org/c/@Canvas_010
    */
    ...
    /** Creates SkSurface matching info and props, and associates it with SkCanvas.
        ...
        @example https://fiddle.skia.org/c/@Canvas_011
    */
    ...
    /** Returns GPU context of the GPU surface associated with SkCanvas.
        ...
        @example https://fiddle.skia.org/c/@Canvas_012
    */
    ...
    /** Returns the pixel base address, SkImageInfo, rowBytes, and origin if the pixels
        ...
        @example https://fiddle.skia.org/c/@Canvas_013

        @example https://fiddle.skia.org/c/@Canvas_014
    */
    ...
    /** Returns custom context that tracks the SkMatrix and clip.
        ...
        @example https://fiddle.skia.org/c/@Canvas_015
    */
    ...
    /** Returns true if SkCanvas has direct access to its pixels.
        ...
        @example https://fiddle.skia.org/c/@Canvas_016
    */
    ...
    */
    ...
    /** Copies SkRect of pixels from SkCanvas into pixmap. SkMatrix and clip are
        ...
        @example https://fiddle.skia.org/c/@Canvas_019
    */
    ...
    /** Copies SkRect of pixels from SkCanvas into bitmap. SkMatrix and clip are
        ...
        @example https://fiddle.skia.org/c/@Canvas_020
    */
    ...
    /** Copies SkRect from pixels to SkCanvas. SkMatrix and clip are ignored.
        ...
        @example https://fiddle.skia.org/c/@Canvas_021
    */
    ...
    /** Copies SkRect from pixels to SkCanvas. SkMatrix and clip are ignored.
        ...
        @example https://fiddle.skia.org/c/@Canvas_022

        @example https://fiddle.skia.org/c/@Canvas_023

        @example https://fiddle.skia.org/c/@Canvas_024
    */
    ...
    /** Saves SkMatrix and clip.
        ...
        @example https://fiddle.skia.org/c/@Canvas_025
    */
    int save();
    ...
    /** Saves SkMatrix and clip, and allocates a SkBitmap for subsequent drawing.
        ...
        @example https://fiddle.skia.org/c/@Canvas_029
    */
    ...
    /** Saves SkMatrix and clip, and allocates a SkBitmap for subsequent drawing.
        ...
        @example https://fiddle.skia.org/c/@Canvas_030
    */
    int saveLayer(const SkRect& bounds, const SkPaint* paint) {
    ...
    /** Saves SkMatrix and clip, and allocates SkBitmap for subsequent drawing.
        ...
        @example https://fiddle.skia.org/c/@Canvas_032
    */
    ...
    /** \enum SkCanvas::SaveLayerFlagsSet
        ...
        @example https://fiddle.skia.org/c/@Canvas_033
    */
    ...
    /** \struct SkCanvas::SaveLayerRec
        ...
        @example https://fiddle.skia.org/c/@Canvas_034
    */
    struct SaveLayerRec {
        ...
        /** Sets fBounds, fPaint, and fBackdrop to nullptr. Clears fSaveLayerFlags.
            ...
            @example https://fiddle.skia.org/c/@Canvas_035
        */
        SaveLayerRec() {}
        ...
        /** Sets fBounds, fPaint, and fSaveLayerFlags; sets fBackdrop to nullptr.
            ...
            @example https://fiddle.skia.org/c/@Canvas_036
        */
        ...
        /** Sets fBounds, fPaint, fBackdrop, and fSaveLayerFlags.
            ...
            @example https://fiddle.skia.org/c/@Canvas_037
        */
    ...
    /** Saves SkMatrix and clip, and allocates SkBitmap for subsequent drawing.
        ...
        @example https://fiddle.skia.org/c/@Canvas_038
    */
    ...
    /** Removes changes to SkMatrix and clip since SkCanvas state was
        ...
        @example https://fiddle.skia.org/c/@AutoCanvasRestore_001

        @example https://fiddle.skia.org/c/@Canvas_026
    */
    void restore();
    ...
    /** Returns the number of saved states, each containing: SkMatrix and clip.
        ...
        @example https://fiddle.skia.org/c/@Canvas_027
    */
    ...
    /** Restores state to SkMatrix and clip values when save(), saveLayer(),
        ...
        @example https://fiddle.skia.org/c/@Canvas_028
    */
    ...
    /** Translates SkMatrix by dx along the x-axis and dy along the y-axis.
        ...
        @example https://fiddle.skia.org/c/@Canvas_039
    */
    ...
    /** Scales SkMatrix by sx on the x-axis and sy on the y-axis.
        ...
        @example https://fiddle.skia.org/c/@Canvas_040
    */
    ...
    /** Rotates SkMatrix by degrees. Positive degrees rotates clockwise.
        ...
        @example https://fiddle.skia.org/c/@Canvas_041
    */
    ...
    /** Rotates SkMatrix by degrees about a point at (px, py). Positive degrees rotates
        ...
        @example https://fiddle.skia.org/c/@Canvas_042
    */
    ...
    /** Skews SkMatrix by sx on the x-axis and sy on the y-axis. A positive value of sx
        ...
        @example https://fiddle.skia.org/c/@Canvas_043
    */
    ...
    /** Replaces SkMatrix with matrix premultiplied with existing SkMatrix.
        ...
        @example https://fiddle.skia.org/c/@Canvas_044
    */
    ...
    /** Replaces SkMatrix with matrix.
        ...
        @example https://fiddle.skia.org/c/@Canvas_045
    */
    ...
    /** Sets SkMatrix to the identity matrix.
        ...
        @example https://fiddle.skia.org/c/@Canvas_046
    */
    void resetMatrix();
    ...
    /** Replaces clip with the intersection or difference of clip and rect,
        ...
        @example https://fiddle.skia.org/c/@Canvas_049
    */
    ...
    /** Replaces clip with the intersection or difference of clip and rect.
        ...
        @example https://fiddle.skia.org/c/@Canvas_050
    */
    ...
    /** Replaces clip with the intersection of clip and rect.
        ...
        @example https://fiddle.skia.org/c/@Canvas_051
    */
    ...
    */
    ...
    /** Replaces clip with the intersection or difference of clip and rrect,
        ...
        @example https://fiddle.skia.org/c/@Canvas_052
    */
    ...
    /** Replaces clip with the intersection or difference of clip and rrect.
        ...
        @example https://fiddle.skia.org/c/@Canvas_053
    */
    ...
    /** Replaces clip with the intersection of clip and rrect,
        ...
        @example https://fiddle.skia.org/c/@Canvas_054
    */
    ...
    /** Replaces clip with the intersection or difference of clip and path,
        ...
        @example https://fiddle.skia.org/c/@Canvas_055
    */
    ...
    /** Replaces clip with the intersection or difference of clip and path.
        ...
        @example https://fiddle.skia.org/c/@Canvas_056
    */
    ...
    /** Replaces clip with the intersection of clip and path.
        ...
        @example https://fiddle.skia.org/c/@Canvas_057
    */
    ...
    */
    ...
    /** Replaces clip with the intersection or difference of clip and SkRegion deviceRgn.
        ...
        @example https://fiddle.skia.org/c/@Canvas_058
    */
    ...
    /** Returns true if SkRect rect, transformed by SkMatrix, can be quickly determined to be
        ...
        @example https://fiddle.skia.org/c/@Canvas_059
    */
    ...
    /** Returns true if path, transformed by SkMatrix, can be quickly determined to be
        ...
        @example https://fiddle.skia.org/c/@Canvas_060
    */
    ...
    /** Returns bounds of clip, transformed by inverse of SkMatrix. If clip is empty,
        ...
        @example https://fiddle.skia.org/c/@Canvas_061
    */
    ...
    /** Returns bounds of clip, transformed by inverse of SkMatrix. If clip is empty,
        ...
        @example https://fiddle.skia.org/c/@Canvas_062
    */
    ...
    /** Returns SkIRect bounds of clip, unaffected by SkMatrix. If clip is empty,
        ...
        @example https://fiddle.skia.org/c/@Canvas_063
    */
    ...
    /** Returns SkIRect bounds of clip, unaffected by SkMatrix. If clip is empty,
        ...
        @example https://fiddle.skia.org/c/@Canvas_064
    */
    ...
    /** Fills clip with color color.
        ...
        @example https://fiddle.skia.org/c/@Canvas_065
    */
    ...
    /** Fills clip with color color using SkBlendMode::kSrc.
        ...
        @example https://fiddle.skia.org/c/@Canvas_066
    */
    ...
    */
    ...
    /** Fills clip with SkPaint paint. SkPaint components SkMaskFilter, SkShader,
        ...
        @example https://fiddle.skia.org/c/@Canvas_067
    */
    ...
    /** \enum SkCanvas::PointMode
        ...
        @example https://fiddle.skia.org/c/@Canvas_068
    */
    enum PointMode {
    ...
    /** Draws pts using clip, SkMatrix and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_069
    */
    ...
    /** Draws point at (x, y) using clip, SkMatrix and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_070
    */
    ...
    /** Draws point p using clip, SkMatrix and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_071
    */
    ...
    /** Draws line segment from (x0, y0) to (x1, y1) using clip, SkMatrix, and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_072
    */
    ...
    /** Draws line segment from p0 to p1 using clip, SkMatrix, and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_073
    */
    ...
    /** Draws SkRect rect using clip, SkMatrix, and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_074
    */
    ...
    /** Draws SkIRect rect using clip, SkMatrix, and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_075
    */
    ...
    /** Draws SkRegion region using clip, SkMatrix, and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_076
    */
    ...
    /** Draws oval oval using clip, SkMatrix, and SkPaint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_077
    */
    ...
    /** Draws SkRRect rrect using clip, SkMatrix, and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_078
    */
    ...
    /** Draws SkRRect outer and inner
        ...
        @example https://fiddle.skia.org/c/@Canvas_079

        @example https://fiddle.skia.org/c/@Canvas_080
    */
    ...
    /** Draws circle at (cx, cy) with radius using clip, SkMatrix, and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_081
    */
    ...
    /** Draws circle at center with radius using clip, SkMatrix, and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_082
    */
    ...
    */
    ...
    /** Draws SkRRect bounded by SkRect rect, with corner radii (rx, ry) using clip,
        ...
        @example https://fiddle.skia.org/c/@Canvas_085
    */
    ...
    /** Draws SkPath path using clip, SkMatrix, and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_086
    */
    ...
    */
    ...
    /** Draws SkImage image, with its top-left corner at (left, top),
        ...
        @example https://fiddle.skia.org/c/@Canvas_088
    */
    ...
    /** \enum SkCanvas::SrcRectConstraint
        ...
        @example https://fiddle.skia.org/c/@Canvas_089
    */
    ...
    */
    ...
    /** Draws SkImage image, scaled and translated to fill SkRect dst, using clip, SkMatrix,
        ...
        @example https://fiddle.skia.org/c/@Canvas_092
    */
    ...
    /** Draws SkRect src of SkImage image, scaled and translated to fill SkRect dst.
        ...
        @example https://fiddle.skia.org/c/@Canvas_093
    */
    ...
    /** Draws SkIRect isrc of SkImage image, scaled and translated to fill SkRect dst.
        ...
        @example https://fiddle.skia.org/c/@Canvas_094
    */
    ...
    /** Draws SkImage image, scaled and translated to fill SkRect dst,
        ...
        @example https://fiddle.skia.org/c/@Canvas_095
    */
    ...
    /** Draws SkImage image stretched proportionally to fit into SkRect dst.
        ...
        @example https://fiddle.skia.org/c/@Canvas_104
    */
    ...
    /** Draws SkImage image stretched proportionally to fit into SkRect dst.
        ...
        @example https://fiddle.skia.org/c/@Canvas_097
    */
    ...
    */
    ...
    /** Draws SkRect src of SkBitmap bitmap, scaled and translated to fill SkRect dst.
        ...
        @example https://fiddle.skia.org/c/@Canvas_099
    */
    ...
    /** Draws SkIRect isrc of SkBitmap bitmap, scaled and translated to fill SkRect dst.
        ...
        @example https://fiddle.skia.org/c/@Canvas_100
    */
    ...
    /** Draws SkBitmap bitmap, scaled and translated to fill SkRect dst.
        ...
        @example https://fiddle.skia.org/c/@Canvas_101
    */
    ...
    /** Draws SkBitmap bitmap stretched proportionally to fit into SkRect dst.
        ...
        @example https://fiddle.skia.org/c/@Canvas_102
    */
    ...
    */
    ...
    /** Draws SkBitmap bitmap stretched proportionally to fit into SkRect dst.
        ...
        @example https://fiddle.skia.org/c/@Canvas_103
    */
    ...
    */
    ...
    /** Draws SkTextBlob blob at (x, y), using clip, SkMatrix, and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_111
    */
    ...
    /** Draws SkTextBlob blob at (x, y), using clip, SkMatrix, and SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_112
    */
    ...
    /** Draws SkPicture picture, using clip and SkMatrix.
        ...
        @example https://fiddle.skia.org/c/@Canvas_114
    */
    ...
    */
    ...
    /** Draws SkPicture picture, using clip and SkMatrix; transforming picture with
        ...
        @example https://fiddle.skia.org/c/@Canvas_115
    */
    ...
    */
    ...
    /** Draws SkVertices vertices, a triangle mesh, using clip and SkMatrix.
        ...
        @example https://fiddle.skia.org/c/@Canvas_117
    */
    ...
    /** Draws SkVertices vertices, a triangle mesh, using clip and SkMatrix.
        ...
        @example https://fiddle.skia.org/c/@Canvas_118
    */
    ...
    */
    ...
    /** Draws a set of sprites from atlas, using clip, SkMatrix, and optional SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_122
    */
    ...
    /** Draws a set of sprites from atlas, using clip, SkMatrix, and optional SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_123
    */
    ...
    /** Draws a set of sprites from atlas, using clip, SkMatrix, and optional SkPaint paint.
        ...
        @example https://fiddle.skia.org/c/@Canvas_124
    */
    ...
    */
    ...
    /** Draws SkDrawable drawable using clip and SkMatrix, concatenated with
        ...
        @example https://fiddle.skia.org/c/@Canvas_126
    */
    ...
    /** Draws SkDrawable drawable using clip and SkMatrix, offset by (x, y).
        ...
        @example https://fiddle.skia.org/c/@Canvas_127
    */
    ...
    /** Associates SkRect on SkCanvas with an annotation; a key-value pair, where the key is
        ...
        @example https://fiddle.skia.org/c/@Canvas_128
    */
    ...
    */
    ...
    /** Returns true if clip is empty; that is, nothing will draw.
        ...
        @example https://fiddle.skia.org/c/@Canvas_130
    */
    ...
    /** Returns true if clip is SkRect and not empty.
        ...
        @example https://fiddle.skia.org/c/@Canvas_131
    */
    ...
    /** Returns SkMatrix.
        ...
        @example https://fiddle.skia.org/c/@Canvas_047

        @example https://fiddle.skia.org/c/@Canvas_048
    */
...
public:
    ...
    /** Preserves SkCanvas::save() count. Optionally saves SkCanvas clip and SkCanvas matrix.
        ...
        @example https://fiddle.skia.org/c/@AutoCanvasRestore_000
    */
