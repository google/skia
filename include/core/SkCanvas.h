...
protected:
    ...
    // Overriders should call the corresponding INHERITED method up the inheritance chain.
    virtual SaveLayerStrategy getSaveLayerStrategy(const SaveLayerRec& layerRec) {
        return kFullLayer_SaveLayerStrategy;
    }
    virtual void willRestore() {}
    virtual void didRestore() {}
    virtual void didConcat(const SkMatrix& matrix) {}
    virtual void didSetMatrix(const SkMatrix& matrix) {}
    ...
    bool clipRectBounds(const SkRect* bounds, SaveLayerFlags flagsd, SkIRect* intersection,
