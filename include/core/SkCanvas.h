...
public:
    ...
    */
    ...
    /** Copies rectangle of pixels from SkCanvas into dstPixels. SkMatrix and clip are
        ignored. Source rectangle corners are (srcX, srcY) and (this->imageInfo.width(), this->imageInfo.height()) .
    ...
    */
    ...
    /** Copies rectangle from pixels to SkCanvas. SkMatrix and clip are ignored.
        ...
        Destination rectangle corners are (x, y) and (this->imageInfo.width(), this->imageInfo.height()) .

        Copies each readable pixel intersecting both rectangles, without scaling,
        converting to this->imageInfo.colorType() and this->imageInfo.alphaType() if required.
    ...
    */
    enum Flags : uint8_t {
        kTransparent_Flags = 1 << 0, //!< Set to skip lattice rectangle by making it transparent.
    };
