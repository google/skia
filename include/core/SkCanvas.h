...
private:
    ...
    struct CameraRec {
        ...
        SkM44   fLocalToWorld;  // accumulates all subsequent concats after camera

        CameraRec(MCRec* owner, const SkM44& camera) : fMCRec(owner), fCamera(camera) {}
    };
    std::stack<CameraRec> fCameraStack;
...
private:
    ...
    void validate() const;  // just debugging asserts
