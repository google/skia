...
class SkRasterAllocator {
public:
    virtual ~SkRasterAllocator() {}
...
public:
    ...
    */
    SkCanvas(const SkBitmap& bitmap) : SkCanvas(bitmap, nullptr, nullptr) {}
...
private:
    ...
    friend class SkRasterAllocator;
    ...
    SkCanvas(const SkBitmap&, SkRasterAllocator*, SkRasterAllocator::Handle);
