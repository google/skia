...
public:
    ...
    */
    struct Lattice {
        ...
        /** \enum SkCanvas::Lattice::RectangleType
            Optional setting per rectangular grid entry.
        */
        enum RectangleType : uint8_t {
            kDefault = 0,

            /** Set to skip lattice rectangle by making it transparent. */
            kTransparent,

            /** The lattice rectangle is a solid color. The color value is stored
                in fColors.
            */
            kUseSolidColor,
        };
        ...
        */
        const RectangleType* fRectTypes;
