...
public:
    ...
    */
    ...
    /** Copies rectangle of pixels from SkCanvas into dstPixels. SkMatrix and clip are
        ...
        (this->imageInfo.width(), this->imageInfo.height()). Destination rectangle corners are (0, 0) and
        (dstInfo.width(), dstInfo.height()). Copies each readable pixel intersecting both rectangles, without scaling,
    ...
    */
    ...
    /** Copies rectangle of pixels from SkCanvas into pixmap. SkMatrix and clip are
        ignored. Source rectangle corners are (srcX, srcY) and
        (this->imageInfo.width(), this->imageInfo.height()). Destination rectangle are (0, 0) and
        (pixmap.width(), pixmap.height()). Copies each readable pixel intersecting both rectangles, without scaling,
    ...
    */
    ...
    /** Copies rectangle of pixels from SkCanvas into bitmap. SkMatrix and clip are
        ignored. Source rectangle corners are (srcX, srcY) and
        (this->imageInfo.width(), this->imageInfo.height()). Destination rectangle corners are (0, 0) and (bitmap.width(), bitmap.height()).
