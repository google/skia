...
public:
    ...
    template <typename... Args> static sk_sp<SkPromiseImageTexture> Make(Args... args) {
        GrBackendTexture backendTexture(std::forward<Args>(args)...);
        return Make(backendTexture);
    }
