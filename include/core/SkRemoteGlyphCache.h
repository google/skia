...
public:
    ...
    static std::unique_ptr<SkStrikeServer> Create(DiscardableHandleManager* discardableManager);
    ...
    virtual void writeStrikeData(std::vector<uint8_t>* memory) = 0;
};
...
public:
    ...
    static sk_sp<SkStrikeClient> Create(DiscardableHandleManager*);
