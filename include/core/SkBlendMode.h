...
enum class SkBlendMode {
    ...
    kDarken,                          //!< rc = s + d - max(s*da, d*sa), ra = sa + da - sa*da
    kLighten,                         //!< rc = s + d - min(s*da, d*sa), ra = sa + da - sa*da
    ...
    kDifference,                      //!< rc = s + d - 2*(min(s*da, d*sa)), ra = sa + da - sa*da
    kExclusion,                       //!< rc = s + d - two(s*d), ra = sa + da - sa*da
