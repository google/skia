...
public:
    ...
    */
    ...
    /** \enum
        SkMatrix organizes its values in row order. This enum members corresponds to
    ...
    */
    ...
    /** Sets SkMatrix to skew by sx and sy, about a pivot point at (px, py).
        The pivot point is unchanged when mapped with SkMatrix.
    ...
    */
    ...
    /** Sets SkMatrix to skew by sx and sy, about a pivot point at (0, 0).
    ...
    */
    ...
    /** Sets SkMatrix to SkMatrix constructed from scaling by
        (1/divx, 1/divy)about pivot point (px, py), multiplied by SkMatrix.
    ...
    */
    ...
    /** Sets inverse to reciprocal matrix, returning true if SkMatrix is invertible.
        Geometrically, if SkMatrix maps from source to destination, inverse SkMatrix
        maps from destination to source. If SkMatrix is not invertible, inverse is
        unchanged.

        @param inverse  storage for inverted SkMatrix; may be nullptr
        @return         true if SkMatrix is invertible
    */
    ...
    */
    ...
    /** Compares a and b; returns true if a and b are not umerically equal. Returns false
    ...
    */
    ...
    /** Sets scaleFactors[0] to the minimum scaling factor, and scaleFactors[1] to the
        ...
        Returns true if scaleFactors are computable; otherwise, returns false and sets
    ...
    */
    ...
    /** Decomposes SkMatrix into scale components and whatever remains. Returns false if
        ...
        Returns true if scale components are computable. scale and remaining are
