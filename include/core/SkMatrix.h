...
public:
    ...
    */
    static constexpr SkMatrix MakeScale(SkScalar sx, SkScalar sy, SkScalar px, SkScalar py) {
        return SkMatrix::MakeScaleTranslate(sx, sy, px - sx * px, py - sy * py);
    }
    ...
    */
    static constexpr SkMatrix MakeScaleTranslate(
            SkScalar sx, SkScalar sy, SkScalar tx, SkScalar ty)
    {
    ...
    */
    ...
    {
        return SkMatrix(scaleX, skewX, transX,
                        skewY, scaleY, transY,
                        pers0, pers1, pers2,
                        kUnknown_Mask);
    }
