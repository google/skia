...
public:
    ...
    static sk_sp<SkEffect> Color(const SkColor4f&, sk_sp<SkColorSpace> = nullptr);
    ...
    static sk_sp<SkEffect> Lerp(float t, sk_sp<SkEffect>, sk_sp<SkEffect>);
    static sk_sp<SkEffect> Lerp(sk_sp<SkEffect> redChannel, sk_sp<SkEffect>, sk_sp<SkEffect>);
