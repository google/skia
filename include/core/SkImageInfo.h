...
enum SkColorType {
    ...
    kAlpha_F16_SkColorType,    //<! pixel with half float for alpha; in 16-bit word
    kRG_F16_SkColorType,       //<! pixel with half float for red, green; in 32-bit word
    kRGBA_16161616_SkColorType,//<! pixel with 16 bits each for red, green, blue, alpha; in 64-bit word
