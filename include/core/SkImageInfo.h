...
public:
    ...
    */
    ...
    /** Creates newAlphaType with same SkAlphaType, SkColorSpace, with SkColorType
        set to newColorType.
    */
    ...
    /** Creates SkColorInfo with same SkAlphaType, SkColorType, width, and height,
        with SkColorSpace set to cs. cs may be nullptr.
    */
