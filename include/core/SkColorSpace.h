...
public:
     ...
     *  linear sRGB.
     */
    virtual sk_sp<SkColorSpace> makeLinearGamma() const;
     ...
     *  sRGB.
     */
    virtual sk_sp<SkColorSpace> makeSRGBGamma() const;
...
private:
    ...
    friend SkColorSpace* singleton_colorspace(SkGammaNamed, const float[]);
