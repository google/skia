...
struct Sk_Color4f {
    ...
    float fB;
    float fA;
    bool operator==(const Sk_Color4f& other) const;
    bool operator!=(const Sk_Color4f& other) const;
    Sk_Color4f operator*(float scale) const;
    Sk_Color4f operator*(const Sk_Color4f& scale) const;
    const float* vec() const;
          float* vec();
    float operator[](int index) const;
    float& operator[](int index);
    static Sk_Color4f Pin(float r, float g, float b, float a);
    Sk_Color4f pin() const;
    static Sk_Color4f FromColor(SkColor);
