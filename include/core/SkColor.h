...
constexpr SkColor4f kDkGray      = {1,  4.0f/15,  4.0f/15,  4.0f/15};
constexpr SkColor4f kGray        = {1,  8.0f/15,  8.0f/15,  8.0f/15};
constexpr SkColor4f kLtGray      = {1, 12.0f/15, 12.0f/15, 12.0f/15};
