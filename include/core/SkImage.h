...
public:
    ...
    /** Creates SkImage from SkPixmap and copy of pixels. Since pixels are copied, SkPixmap
        ...
        native SkColorType and SkAlphaType are valid, and native SkColorType is not kUnknown_SkColorType;
    ...
    */
    ...
    /** Copies SkRect of pixels from SkImage to dstPixels. Copy starts at offset (srcX, srcY),
        ...
        Pixels are copied only if pixel conversion is possible. If SkImage native SkColorType is
        kGray_8_SkColorType, or kAlpha_8_SkColorType; dstInfo.colorType() must match.
        If SkImage native SkColorType is kGray_8_SkColorType, dstInfo.colorSpace() must match.
    ...
    */
    ...
    /** Copies a SkRect of pixels from SkImage to dst. Copy starts at (srcX, srcY), and
        ...
        If SkImage native SkColorType is kGray_8_SkColorType, dst.colorSpace() must match.
    ...
    */
    ...
    /** Creates SkImage in target SkColorSpace.
        ...
        pixels to a linear space, before converting to destination native SkColorType
        and SkColorSpace.

        Set premulBehavior to SkTransferFunctionBehavior::kIgnore to treat SkImage
        pixels as linear, when converting to destination native SkColorType
