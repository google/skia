...
public:
     ...
     */
    static sk_sp<SkImage> MakeFromYUVTexturesCopy1(GrContext* context, SkYUVColorSpace yuvColorSpace,
     ...
     *  deleted after the function returns. The image will have the dimensions of the y texture.
     */
    static sk_sp<SkImage> MakeFromNV12TexturesCopy1(GrContext* context,
     ...
     *  deleted after the function returns. The image will have the dimensions of the y texture.
     */
    static sk_sp<SkImage> MakeFromYUVTexturesCopy2(GrContext* context, SkYUVColorSpace yuvColorSpace,
     ...
     *  deleted after the function returns. The image will have the dimensions of the y texture.
     */
    static sk_sp<SkImage> MakeFromNV12TexturesCopy2(GrContext* context,
                                                   SkYUVColorSpace yuvColorSpace,
