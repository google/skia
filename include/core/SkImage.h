...
public:
    ...
    */
    ...
    /** Returns SkImage backed by GPU texture associated with context. Returned SkImage is
        ...
        allocates mip map levels. Returns original SkImage if the image is already texture-backed,
        the context matches, and mipMapped is compatible with the backing GPU texture regardless
        of the passed SkBudgeted.
        ...
        @param SkBudgeted     whether to count a newly created texture for the returned image
                              against the GrContext's budget.
        @return               created SkImage, or nullptr
    */
