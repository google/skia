...
public:
    ...
    */
    ...
    /**
     *  Make a shader with the specified tiling and 4x4 filtering weights.
     */
    sk_sp<SkShader> makeShader(SkTileMode tmx, SkTileMode tmy, const SkM44& weights,
                               const SkMatrix* localMatrix = nullptr) const;

    enum class FilterWeights {
        kCentripetalCatmulRom,
        kMitchellNetravali,
    };
    static SkM44 GetWeights(FilterWeights);
