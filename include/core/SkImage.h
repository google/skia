...
public:
    ...
    */
    ...
    /** Deprecated.
        ...
        However, this deprecated and the most preferred is to make a SkSurface from
        ...
        The dimensions of the result texture must match the dimensions of the YUVA planar data.
