...
public:
    ...
    */
    ...
    void asyncRescaleAndReadPixels(const SkImageInfo& info,
                                   ...
                                   SkFilterQuality rescaleQuality,
                                   ReadPixelsCallback callback,
                                   ReadPixelsContext cbContext) __attribute__((deprecated));
    ...
    */
    sk_sp<SkImage> makeWithFilter(const SkImageFilter* filter, const SkIRect& subset,
                                  const SkIRect& clipBounds, SkIRect* outSubset,
                                  SkIPoint* offset) const  __attribute__((deprecated));
    ...
    */
    ...
    /** Deprecated.
     */
    sk_sp<SkImage> makeColorSpace(sk_sp<SkColorSpace> target) const  __attribute__((deprecated));
    ...
    */
    ...
    sk_sp<SkImage> makeColorTypeAndColorSpace(SkColorType targetColorType,
                                              sk_sp<SkColorSpace> targetColorSpace) const __attribute__((deprecated));
