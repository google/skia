...
public:
    ...
    */
     ...
     *  necessary to create a new image).  If it is kPreserve, we will use F16 as necessary
     *  to preserve the precision of the original image.  Note that F16 is only supported
     *  for linear color spaces and with kRespect transfer function behavior.
     */
