...
public:
    ...
    */
    ...
    /** Encodes SkImage pixels, returning result as SkData.
        ...
        SK_CODEC_DECODES_JPEG, SK_CODEC_DECODES_PNG, SK_CODEC_DECODES_WEBP; and platform support
    ...
    */
    ...
    /** Returns encoded SkImage pixels as SkData, if SkImage was created from supported
        ...
        with one or more of: SK_CODEC_DECODES_JPEG, SK_CODEC_DECODES_PNG, SK_CODEC_DECODES_WEBP.
