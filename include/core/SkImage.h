...
class SkMipmapData {
public:
    static std::unique_ptr<SkMipmapData> Make(const SkImageInfo&, SkMipmapType);
};
...
public:
    ...
    */
    static sk_sp<SkImage> MakeRasterCopy(const SkPixmap& pixmap,
                                         std::unique_ptr<SkMipmapData> = nullptr);
    ...
    */
    static sk_sp<SkImage> MakeRasterData(const SkImageInfo& info, sk_sp<SkData> pixels,
                                         size_t rowBytes, std::unique_ptr<SkMipmapData> = nullptr);
