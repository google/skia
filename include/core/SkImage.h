...
public:
    ...
    */
    ...
    /** Creates SkImage from multiple pixmaps representing YUVA data.
        SkImage is uploaded to GPU back-end using context.

        GrBackendTextures created from the pixmaps are uploaded to match SkSurface created with
        pixmap[i].colorSpace(). SkColorSpace of SkImage is determined by imageColorSpace.
        ...
        @param yuvaPixmaps            array of (up to four) SkPixmap which contain the,
                                      possibly interleaved, YUVA planes
        @param yuvaIndices            array indicating which pixmap in yuvaTextures, and channel
