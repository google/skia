...
class SkCanvas;
class SkColorTable;
struct SkCrossContextImageData;
...
public:
    ...
    */
     ...
     *  or GrContext. The GrContext used to upload the data must be in the same GL share group,
     *  or otherwise be able to share resources with the context supplied here.
     */
