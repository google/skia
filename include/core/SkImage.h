    ...
    */
    ...
    /** Creates an SkImage from a GPU backend texture. The backend texture must stay
        ...
        @param colorSpace          This describes the color space of this image when it is sampled.
                                   ...
                                   linear colorSpace should be supplied (e.g., kLinear). If the format
                                   of the backend texture is linear than some form of sRGB color
                                   space (e.g., kSRGB) should be supplied.
