...
public:
    ...
    */
    ...
    /** Returns SkPixmap with SkBitmap pixel address, row bytes, and SkImageInfo, if address is available.
        If pixel address is not available, returns default constructed SkPixmap: nullptr pixels,
