...
public:
    ...
    */
    ...
    void allocPixelsFlags(const SkImageInfo& info, sk_sp<SkColorTable>, uint32_t flags = 0) {
    ...
    */
    bool SK_WARN_UNUSED_RESULT tryAllocPixels() {
        return this->tryAllocPixels(nullptr);
    }

    void allocPixels() {
        this->allocPixels(nullptr);
    }
...
#ifdef SK_SUPPORT_LEGACY_COLORTABLE
    void setPixels(void* p, SkColorTable* = NULL) {
        this->setPixels(p);
    }
