...
public:
    ...
    */
    ...
    /** Returns a constant reference to the SkPixmap holding the SkBitmap's pixel
    ...
    */
    void* getPixels() const { return const_cast<void*>(fPixmap.addr()); }
    ...
    */
    SkIRect getSubset() const {
        return SkIRect::MakeXYWH(fPixelRefOrigin.x(), fPixelRefOrigin.y(),
                                 fPixmap.info().width(), fPixmap.info().height());
    }
