...
public:
    ...
    */
    ...
    // Experimental
    SkPoint center(Corner corner) const { return fPts[corner]; }

    /** Experimental
     *  Specify a rrect with its bounds and the 4 centers of the ovals at each corner.
     */
    void setRectCenters(const SkRect& rect, const SkPoint centers[4]);
...
private:
    ...
    static Type ComputeType(const SkRect&, const SkPoint[4]);
