...
public:
    ...
    static sk_sp<SkVertices> MakeCopy(VertexMode mode, int vertexCount,
                                      ...
                                      const SkSkeleton::Attachment bones[],
                                      int indexCount,
    ...
    public:
        ...
        SkSkeleton::Attachment* bones(); // returns null if there are no bones
    ...
    const SkSkeleton::Attachment* bones() const { return fBones; }
