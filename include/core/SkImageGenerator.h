...
public:
     ...
     *  @param yuvaIndices How the YUV planes are organized/used
     ...
     *  @param yuvaIndices Needs to exactly match the values returned by the
     *                     query.
...
protected:
    ...
    virtual bool onQueryYUV8(SkYUVSizeInfo*, SkYUVAIndex[4], SkYUVColorSpace*) const {
        return false;
    }
    virtual bool onGetYUV8Planes(const SkYUVSizeInfo&, const SkYUVAIndex[4], void* planes[3]) {
        return false;
    }
