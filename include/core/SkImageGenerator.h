...
public:
    ...
    struct ScaledPixelsRec {
        sk_sp<SkImage>  fImage;
        SkRect          fSrcRect;
        SkFilterQuality fQuality;
    };

    bool accessScaledPixels(const SkRect& srcRect, const SkMatrix& totalMatrix,
                            SkFilterQuality quality, ScaledPixelsRec* rec);
...
protected:
    ...
    virtual bool onAccessScaledPixels(const SkRect& srcRect, const SkMatrix& totalMatrix,
                                      SkFilterQuality, ScaledPixelsRec*) {
        return false;
    }
