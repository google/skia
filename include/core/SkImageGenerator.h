...
public:
     ...
     */
    GrTexture* generateTexture(GrContext*, const SkImageInfo&, const SkIRect& subset);
...
protected:
    ...
    virtual GrTexture* onGenerateTexture(GrContext*, const SkImageInfo&, const SkIRect&) {
        return nullptr;
    }
