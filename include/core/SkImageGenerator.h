...
public:
     ...
     *
     *  If forceCopy is true and this succeeds then the texture should be newly created from the
     *  caller and not refer to a pre-existing texture internal to the generator.
     */
    GrSurfaceProxyView generateTexture(GrRecordingContext*, const SkImageInfo& info,
                                       const SkIPoint& origin, GrMipMapped, bool forceCopy);
...
protected:
    ...
    virtual GrSurfaceProxyView onGenerateTexture(GrRecordingContext*, const SkImageInfo&,
                                                 const SkIPoint&, GrMipMapped, bool forceCopy);
#endif
