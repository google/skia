...
SK_C_API sk_document_t* sk_document_create_pdf_from_stream(sk_wstream_t* stream, float dpi);
SK_C_API sk_document_t* sk_document_create_pdf_from_stream_with_metadata(sk_wstream_t* stream, float dpi, const sk_document_pdf_metadata_t* metadata);
