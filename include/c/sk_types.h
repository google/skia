...
typedef enum {
    ...
    SRC_SK_BLEND_MODE,
    DST_SK_BLEND_MODE,
    SRCOVER_SK_BLEND_MODE,
    DSTOVER_SK_BLEND_MODE,
    SRCIN_SK_BLEND_MODE,
    DSTIN_SK_BLEND_MODE,
    SRCOUT_SK_BLEND_MODE,
    DSTOUT_SK_BLEND_MODE,
    SRCATOP_SK_BLEND_MODE,
    DSTATOP_SK_BLEND_MODE,
    XOR_SK_BLEND_MODE,
    PLUS_SK_BLEND_MODE,
    MODULATE_SK_BLEND_MODE,
    SCREEN_SK_BLEND_MODE,
    OVERLAY_SK_BLEND_MODE,
    DARKEN_SK_BLEND_MODE,
    LIGHTEN_SK_BLEND_MODE,
    COLORDODGE_SK_BLEND_MODE,
    COLORBURN_SK_BLEND_MODE,
    HARDLIGHT_SK_BLEND_MODE,
    SOFTLIGHT_SK_BLEND_MODE,
    DIFFERENCE_SK_BLEND_MODE,
    EXCLUSION_SK_BLEND_MODE,
    MULTIPLY_SK_BLEND_MODE,
    HUE_SK_BLEND_MODE,
    SATURATION_SK_BLEND_MODE,
    COLOR_SK_BLEND_MODE,
    LUMINOSITY_SK_BLEND_MODE,
} sk_blend_mode_t;
