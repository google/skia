...
SK_C_API int16_t sk_stream_read_s16(sk_stream_t* cstream);
SK_C_API int32_t sk_stream_read_s32(sk_stream_t* cstream);
SK_C_API uint8_t sk_stream_read_u8(sk_stream_t* cstream);
SK_C_API uint16_t sk_stream_read_u16(sk_stream_t* cstream);
SK_C_API uint32_t sk_stream_read_u32(sk_stream_t* cstream);
SK_C_API bool sk_stream_read_bool(sk_stream_t* cstream);
