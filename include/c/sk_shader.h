...
SK_C_API sk_shader_t* sk_shader_with_local_matrix(sk_shader_t* shader, const sk_matrix_t* localMatrix);
SK_C_API sk_shader_t* sk_shader_with_color_filter(sk_shader_t* shader, sk_colorfilter_t* filter);

SK_C_API sk_shader_t* sk_shader_new_empty(void);
SK_C_API sk_shader_t* sk_shader_new_color(sk_color_t color);
SK_C_API sk_shader_t* sk_shader_new_blend(sk_blendmode_t mode, sk_shader_t* dst, sk_shader_t* src, const sk_matrix_t* localMatrix);
SK_C_API sk_shader_t* sk_shader_new_lerp(float t, sk_shader_t* dst, sk_shader_t* src, const sk_matrix_t* localMatrix);
SK_C_API sk_shader_t* sk_shader_new_lerp_red(sk_shader_t* red, sk_shader_t* dst, sk_shader_t* src, const sk_matrix_t* localMatrix);
...
SK_C_API sk_shader_t* sk_shader_new_sweep_gradient(float cx, float cy, const sk_color_t colors[], const float colorPos[], int colorCount, sk_shader_tilemode_t tileMode, float startAngle, float endAngle, const sk_matrix_t* localMatrix);
