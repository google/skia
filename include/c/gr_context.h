...
SK_C_API gr_context_t* gr_context_make_gl_with_options(const gr_glinterface_t* glInterface, const gr_context_options_t* options);
SK_C_API gr_context_t* gr_context_make_vulkan(const gr_vk_backendcontext_t vkBackendContext);
SK_C_API gr_context_t* gr_context_make_vulkan_with_options(const gr_vk_backendcontext_t vkBackendContext, const gr_context_options_t* options);
SK_C_API gr_context_t* gr_context_make_metal(void* device, void* queue);
SK_C_API gr_context_t* gr_context_make_metal_with_options(void* device, void* queue, const gr_context_options_t* options);
