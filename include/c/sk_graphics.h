...
// purge
SK_C_API void sk_graphics_purge_font_cache();
SK_C_API void sk_graphics_purge_resource_cache();
SK_C_API void sk_graphics_purge_all_caches();

// font cache
SK_C_API size_t sk_graphics_get_font_cache_used();
SK_C_API size_t sk_graphics_get_font_cache_limit();
SK_C_API size_t sk_graphics_set_font_cache_limit(size_t bytes);
SK_C_API int sk_graphics_get_font_cache_count_used();
SK_C_API int sk_graphics_get_font_cache_count_limit();
SK_C_API int sk_graphics_set_font_cache_count_limit(int count);
SK_C_API int sk_graphics_get_font_cache_point_size_limit();
SK_C_API int sk_graphics_set_font_cache_point_size_limit(int maxPointSize);

// resource cache
SK_C_API size_t sk_graphics_get_resource_cache_total_bytes_used();
SK_C_API size_t sk_graphics_get_resource_cache_total_byte_limit();
SK_C_API size_t sk_graphics_set_resource_cache_total_byte_limit(size_t newLimit);
SK_C_API size_t sk_graphics_get_resource_cache_single_allocation_byte_limit();
