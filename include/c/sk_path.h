...
SK_API void sk_pathbuilder_reset(sk_pathbuilder_t*);
...
/**
    ...
    point is automatically set to (0,0).
*/
SK_API void sk_pathbuilder_conic_to(sk_pathbuilder_t*,
                                    float x0, float y0,
                                    float x1, float y1,
                                    float w);
/**
...
/**
 *  Return an immutable sk_path_t from the builder, and reset the builder to the empty state.
 */
SK_API sk_path_t* sk_pathbuilder_detach_path(sk_pathbuilder_t*);

/*************** These are the sk_path methods, after a pathbuilder has created it **************/
