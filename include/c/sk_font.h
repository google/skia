...
SK_C_API size_t sk_font_break_text(const sk_font_t* font, const void* text, int byteLength, sk_text_encoding_t encoding, float maxWidth, float* measuredWidth, const sk_paint_t* paint);
