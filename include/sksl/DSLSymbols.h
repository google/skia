 ...
 */
DSLExpression Symbol(StringFragment name);
...
/**
 * Attaches a variable to the current symbol table. The underlying SkSL variable will persist as
 * long as the symbol table remains in memory. Note that this merely manages the lifetime, and does
 * not add the symbol's name into the table.
 */
void Retain(DSLVar& var);
