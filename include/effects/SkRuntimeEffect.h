...
public:
    ...
    // values are flexible. They are listed as being 'half4', but they can also be 'float4' or
    // 'vec4' (an alias for 'float4').
    ...
    //   -or-
    //     half4 main(float2 inCoords, half4 inColor) { ... }
    //
    ...
    // The resulting effect might return nullptr when makeColorFilter is called, if the effect
    // is dependent on position in any way.
