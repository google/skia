...
public:
    ...
    static sk_sp<SkImageFilter> MatrixTransform(const SkMatrix& transform,
     ...
     *  the targetRect is not the same as the SkIRect cropRect that many filters accept.
     ...
     *  @param cropRect     Optional rectangle that crops the input and output. */
    static sk_sp<SkImageFilter> DiffuseLightDistant(const SkPoint3& direction, SkColor lightColor,
     ...
     *                      source bitmap when null.
     *  @param cropRect     Optional rectangle that crops the input and output. */
    static sk_sp<SkImageFilter> DiffuseLightPoint(const SkPoint3& location, SkColor lightColor,
                                                  SkScalar surfaceScale, SkScalar kd,
                                                  sk_sp<SkImageFilter> input,
                                                  const SkIRect* cropRect = nullptr);
     ...
     *                         source bitmap when null.
     *  @param cropRect        Optional rectangle that crops the input and output. */
    static sk_sp<SkImageFilter> DiffuseLightSpot(const SkPoint3& location, const SkPoint3& target,
     ...
     *                      source bitmap when null.
     *  @param cropRect     Optional rectangle that crops the input and output. */
    static sk_sp<SkImageFilter> SpecularLightDistant(const SkPoint3& direction, SkColor lightColor,
     ...
     *                      source bitmap when null.
     *  @param cropRect     Optional rectangle that crops the input and output. */
    static sk_sp<SkImageFilter> SpecularLightPoint(const SkPoint3& location, SkColor lightColor,
                                                   SkScalar surfaceScale, SkScalar ks,
                                                   SkScalar shininess, sk_sp<SkImageFilter> input,
                                                   const SkIRect* cropRect = nullptr);
     ...
     *                         source bitmap when null.
     *  @param cropRect        Optional rectangle that crops the input and output. */
    static sk_sp<SkImageFilter> SpecularLightSpot(const SkPoint3& location, const SkPoint3& target,
                                                  SkScalar falloffExponent, SkScalar cutoffAngle,
                                                  SkColor lightColor, SkScalar surfaceScale,
