...
sk_sp<SkData> SkHarfbuzzFontSubset(sk_sp<SkData>, const SkGlyphSet&, const char*, int);
#endif

#if defined(SK_PDF_USE_SFNTLY)
sk_sp<SkData> SkSfntlyFontSubset(sk_sp<SkData>, const SkGlyphSet&, const char*, int);
#endif
