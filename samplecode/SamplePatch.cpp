...
struct PatchView : public Sample {
    ...
    SkString onShortName() override { return SkString("Patch"); }
...
protected:
    SkString onShortName() override { return SkString("PseudoInk"); }
...
protected:
    SkString onShortName() override { return SkString("ManyStrokes"); }
