...
struct CurveData {
    ...
    SkPath fOuter;
    CurveData* fPrev;
    SkPoint fBisects[2];  // mid angles formed by prev, this segs
...
public:
    ...
    void set_point_array() {
        ...
        while ((curCurve->fVerb = iter.next(curCurve->fPts)) != SkPath::kDone_Verb) {
            ...
            case SkPath::kCubic_Verb:
                ...
                degenerate = !curCurve->fTangents[0].setLength(fWidthControl.fValLo);
    ...
    void calc_line_bisects(CurveData* curPtData) {
        ...
        SkScalar oppSin = oppLen / fWidthControl.fValLo;
