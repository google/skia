...
protected:
    ...
    void onDrawContent(SkCanvas* canvas) override {
        ...
        canvas->drawString("AA Scaled", fCurPos.fX + SK_ARRAY_COUNT(gQualitys) * (fSize + 10), fCurPos.fY + fSize/2,
                           font, paint);
        ...
        canvas->drawString("AA No Scale", fCurPos.fX + SK_ARRAY_COUNT(gQualitys) * (fBM.width() + 10),
