...
protected:
    SkString onName() override { return SkString("Paths"); }
...
protected:
    SkString onName() override { return SkString("ArcTo"); }
...
protected:
    SkString onName() override { return SkString("FatStroke"); }
...
protected:
    SkString onName() override { return SkString("CubicCurve"); }
...
protected:
    SkString onName() override { return SkString("CubicCurve2"); }
