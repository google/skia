...
protected:
    ...
    void onDrawContent(SkCanvas* canvas) override {
        ...
        //const char* text = ">S̛̓̋ͤͣ̄͆̔ͩ̂̈́͗̓͑ͥͮ͐̃̊͊͒͋ͭ̂̊ͦ͌ͨ̐̐̽ͮ̿̋̽ͧͮ͛́͘͠͝͡҉̴̡̧́͟͜͟͞͏̫̪̬̪̩͍̻̻̮̭͚͈͈̥̤̺͈̳̟̙͍̤̩͈ͅk̸͍̻̞̲̞͕͍̭̦̪͉̰̠̪̞̮̮̗̰̱͔̣̲̗̺͚̲͉͚̥̪̬̭͕̳̩͗͒͗̈ͣ̓ͣ̀͟ͅP͂̐͐̈͑̉̄ͣͫ͌ͦ̋͂̍ͦ̂͆̓͂̒ͤ̿̇̊̋ͤ̂̂ͪͣ̓̆͗̐ͥ͌ͩͧ̃̍̀͗͟͡҉̶̛҉͝͞͏̡́́͟͞͏̢̭̩͇̺̰̺͇̱̤̝̹͎̹̳̩͚̣̼͕͚̗̹̣̰̮̝̲́̕ͅͅąͤ̊͊͐̎̎͋ͫ̆͂ͬ͌̂̄͑̈̐́̽̌̇͘͘͞͠͝͏̥̼̥̮̙̙̜͈̻̥͍̝̖̯̣̩̤͎̙̣̩̳̮͎̞̤̦̳̞͖̺͜ͅř̸̸̡̡̡̨̨ͬ̃͊̆͗ͥ̍͒ͪ̉̋̐̈͌̈́ͪͤ̿ͨͧ̂̆ͥ́͟͜͟͟͟͟͠͡͞҉́͏̧̡͔͕̲̭͎͕̙͉̪̝̼̼̹̬̞̙̹̰̝̗̰̹̦͕͔̹͔̥̟̥͓a̷̶̵̢̨̡̨̧̛̝̭̲̣̯̰̞͇̗̠̘ͧͩ͋͆ͬ̓̒͐̋̽͘̕͟͢͞ģ̵̷̴̷̴̷̸̨̀̃̃ͤ̔ͤͬ͋̈́͛̿̆̇̂͒̒ͪ̎̓͆̎̂̓̒̉͌ͪͫ͌͋͆ͭ̐͌̓ͧ̂̀̀̕͢͜͝͠͝͏̰̗͔̝͍̞̜̼̦̗̖̦͓̪̣̜̤̟̝̪̘̞͔͙̝̤͙͓͕̪̺̞̫̯̩̞̭̠̺ŗ̶̵̷̷̶̡̳̝͍̤͖̪̤̲̦̟̗̣͖͙̥̹̲̰̤̣̦̮̗̩͇͑̈́͐̇̆̆ͩ͐̂̃͛̉ͬͩͧͩ͒ͭͪ̈̉̍̋̓͌̆̂̏̐̂ͩ͊̆̔̒̒ͧͥ̅̋͒̈́͑͋͟͜ͅa̷̶͒̽ͩͤͧͦ̄ͨ͗̐̽͆͋̐̈́͗͞҉̱͓̤͙͕͙̘̬̪͔̞̱̜̺͚̗̻̝̻̠̹̺̺͎̦͈̱̳̹̯̘̠̱͍͕̤͓ͅp̷̆̏ͪ͋̈́͌͋ͨͧͮ̿̌̿ͥ͆̈ͮͫ́̀͘͜͞͡͠҉̴̵̶̵̧̡̨͘̕͟͜͞͏̝̥̩͉̠̲̣̭͖̹̼̞̬̮̣ͅh̶̵̴̡̡̢̢ͪ͊͑͂̐́̑̓̏̓͑͌ͧ̋̍̓͂̒̑̔͊ͦ̆ͧ̏ͣ̏̏ͬͤ͂̄̿̀̈́͘͟͞͡͏̶̴̶̶̵̢̩̮̗̳͙͔̟̠̪̻̖̯͖̺̪̼̻͎͚̲̖͎̜̮͚̩͕̩̟̣̲̗̳̕͢͝͡ͅͅ<";

        const char* text = "S̛̓̋ͤͣ̄͆̔ͩ̂̈́͗̓͑ͥͮ͐̃̊͊͒͋ͭ̂̊ͦ͌ͨ̐̐̽ͮ̿̋̽ͧͮ͛́͘͠͝͡҉̴̡̧́͟͜͟͞͏̫̪̬̪̩͍̻̻̮̭͚͈͈̥̤̺͈̳̟̙͍̤̩͈ͅk̸͍̻̞̲̞͕͍̭̦̪͉̰̠̪̞̮̮̗̰̱͔̣̲̗̺͚̲͉͚̥̪̬̭͕̳̩͗͒͗̈ͣ̓ͣ̀͟ͅP͂̐͐̈͑̉̄ͣͫ͌ͦ̋͂̍ͦ̂͆̓͂̒ͤ̿̇̊̋ͤ̂̂ͪͣ̓̆͗̐ͥ͌ͩͧ̃̍̀͗͟͡҉̶̛҉͝͞͏̡́́͟͞͏̢̭̩͇̺̰̺͇̱̤̝̹͎̹̳̩͚̣̼͕͚̗̹̣̰̮̝̲́̕ͅͅąͤ̊͊͐̎̎͋ͫ̆͂ͬ͌̂̄͑̈̐́̽̌̇͘͘͞͠͝͏̥̼̥̮̙̙̜͈̻̥͍̝̖̯̣̩̤͎̙̣̩̳̮͎̞̤̦̳̞͖̺͜ͅř̸̸̡̡̡̨̨ͬ̃͊̆͗ͥ̍͒ͪ̉̋̐̈͌̈́ͪͤ̿ͨͧ̂̆ͥ́͟͜͟͟͟͟͠͡͞҉́͏̧̡͔͕̲̭͎͕̙͉̪̝̼̼̹̬̞̙̹̰̝̗̰̹̦͕͔̹͔̥̟̥͓a̷̶̵̢̨̡̨̧̛̝̭̲̣̯̰̞͇̗̠̘ͧͩ͋͆ͬ̓̒͐̋̽͘̕͟͢͞ģ̵̷̴̷̴̷̸̨̀̃̃ͤ̔ͤͬ͋̈́͛̿̆̇̂͒̒ͪ̎̓͆̎̂̓̒̉͌ͪͫ͌͋͆ͭ̐͌̓ͧ̂̀̀̕͢͜͝͠͝͏̰̗͔̝͍̞̜̼̦̗̖̦͓̪̣̜̤̟̝̪̘̞͔͙̝̤͙͓͕̪̺̞̫̯̩̞̭̠̺";
