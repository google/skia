...
protected:
    ...
    void onDrawContent(SkCanvas* canvas) override {
        ...
        const char* text = "S̢̠̹̺̮̙͉̝̱̻̆̅̊̊ͤ͊̆̀̚k̶̴̛̼̦͊̓ͫ̆͂̓̚͡P̶̸̢̀̅͝ā̄҉̞̠͎͍̫͉͚ṟ̖̲̬̲̇̓̌͢͠ạ̸̷͍̫̅͋͛̐̀̓͗̇̔̕͝ͅģ̧͇̦̯͛͟r̛̉ͨ̒͛͛̑a̟̭̮͖̅͋͑̍͌̔̏͋̆ͣ̽͘p͎̮ͥ͆͌ͫ̋ͣͩ̕h̝͕̣̄͌ͣͧ̄̒̐͒̓͡";
...
class Zalgo {
    ...
    std::u16string randomMarks(std::u16string& combiningMarks) {
        std::u16string result;
        auto num = std::rand() % (combiningMarks.size() / 4);
