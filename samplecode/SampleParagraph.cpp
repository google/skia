...
protected:
    ...
    void drawTest(SkCanvas* canvas, SkScalar w, SkScalar h, SkColor fg, SkColor bg) {
        ...
        for (auto i = 1; i < 5; ++i) {
            ...
            ParagraphBuilder builder(paraStyle, sk_make_sp<FontCollection>());
...
protected:
    ...
    void drawText(SkCanvas* canvas, SkScalar w, SkScalar h, std::vector<std::string>& text,
        ...
        ParagraphBuilder builder(paraStyle, sk_make_sp<TestFontCollection>());
...
protected:
    ...
    void drawFlutter(SkCanvas* canvas, SkScalar w, SkScalar h,
                     const std::string& ff = "Google Sans", SkScalar fs = 30,
                     size_t lineLimit = std::numeric_limits<size_t>::max(),
                     const std::u16string& ellipsis = u"\u2026") {
        SkAutoCanvasRestore acr(canvas, true);
...
protected:
    ...
    void drawText(SkCanvas* canvas, SkColor background, SkScalar letterSpace, SkScalar w,
        ...
        ParagraphBuilder builder(paragraphStyle, sk_make_sp<TestFontCollection>());
...
protected:
    ...
    void onDrawContent(SkCanvas* canvas) override {
        ...
        ParagraphBuilder builder(paragraph_style, sk_make_sp<TestFontCollection>());
