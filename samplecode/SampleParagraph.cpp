...
protected:
    ...
    void onDrawContent(SkCanvas* canvas) override {
        ...
        const char* text = "Now is the time for\nall good people\nto come to the aid\nof their country.";
        ...
        SkFontStyle fs(SkFontStyle::Weight::kBlack_Weight, SkFontStyle::Width::kNormal_Width, SkFontStyle::Slant::kUpright_Slant);
        text_style.setFontStyle(fs);
        text_style.setColor(SK_ColorBLACK);
        builder.pushStyle(text_style);
        //builder.addText("test1\nhello line two really long for soft break\nfinal line 4");
        builder.addText(text);

        auto paragraph = builder.Build();
        paragraph->layout(400);

        auto boxes = paragraph->getRectsForRange(19, 20, RectHeightStyle::kTight, RectWidthStyle::kTight);
        paragraph->paint(canvas, 0, 0);
...
protected:
    ...
    void onDrawContent(SkCanvas* canvas) override {
        ...
        auto multiplier = 5.67;
        const char* up = "Aͣ̏̋̌̽̆̊́̃̓́̔";
        const char* middle = "A҉";
        const char* down = "A̞̲̣̰̬͓͔͉̮̦̮";
        ...
        text_style.setFontFamilies({SkString("Roboto")});
        text_style.setFontSize(30 * multiplier);
        builder.pushStyle(text_style);
        builder.addText(up);
        builder.addText(middle);
        builder.addText(down);
        auto paragraph = builder.Build();
        paragraph->layout(1000);
        paragraph->paint(canvas, 0, 0);
        SkRect rect;
        rect.fLeft = 0.000000;
        rect.fRight = 332.878815;
        rect.fTop = -383.140381;
        rect.fBottom = 368.273163;
        paint.setColor(SK_ColorRED);
        paint.setStyle(SkPaint::kStroke_Style);
        paint.setAntiAlias(true);
        paint.setStrokeWidth(1);
...
class Zalgo {
    private:
    static const std::string zalgo_up;
    static const std::string zalgo_down;
    static const std::string zalgo_mid;

    int rando(int max) {
        return std::rand() % (max+1);
    }

    // Get a random character from list
    std::string rand_zalgo(std::string array) {
        int ind;
        do	{
...
public:
    std::string zalgo(std::string victim){
	std::string txt = victim;
	std::string newtxt = "";
...
const std::string Zalgo::zalgo_down="\u0316\u0317\u0318\u0319\u031c\u031d\u031e\u031f\u0320\u0324\u0325\u0326\u0329\u032a\u032b\u032c\u032d\u032e\u032f\u0330\u0331\u0332\u0333\u0339\u033a\u033b\u033c\u0345\u0347\u0348\u0349\u034d\u034e\u0353\u0354\u0355\u0356\u0359\u035a\u0323";
const std::string Zalgo::zalgo_up ="\u030d\u030e\u0304\u0305\u033f\u0311\u0306\u0310\u0352\u0357\u0351\u0307\u0308\u030a\u0342\u0343\u0344\u034a\u034b\u034c\u0303\u0302\u030c\u0350\u0300\u0301\u030b\u030f\u0312\u0313\u0314\u033d\u0309\u0363\u0364\u0365\u0366\u0367\u0368\u0369\u036a\u036b\u036c\u036d\u036e\u035b\u0346\u031a";
const std::string Zalgo::zalgo_mid="\u0315\u031b\u0340\u0341\u0358\u0321\u0322\u0327\u0328\u0334\u0335\u0336\u034f\u035c\u035d\u035e\u035f\u0360\u0362\u0338\u0337\u0361\u0489";
...
protected:
    ...
    void onDrawContent(SkCanvas* canvas) override {
        ...
        TextStyle text_style;
        text_style.setFontFamilies({SkString("Roboto")});
        text_style.setFontSize(5 * multiplier);
        text_style.setColor(navy);
        SkPaint paint;
        paint.setColor(ltgray);
        text_style.setBackgroundColor(paint);
        builder.pushStyle(text_style);
        //builder.addText(u"a\u0315\u031b\u0340\u0341\u0358\u0321\u0322\u0327\u0328\u0334\u0335\u0336\u034f\u035c\u035d\u035e\u035f\u0360\u0362\u0338\u0337\u0361\u0489");
        builder.addText("S̴̢̱̗̞̲͇̺̪̻̙̘̞̥͇̯̈̈́̓͌ͩ̓̑͊̔́̚͞ͅk̡ͥ̽͐̃ͮ̐̂̒͌̀҉̷͙̱͎̦̙̪̹̰̤͔Pͨ̃̇́ͮ̾͏̛̣̬̬ả̵̢̲̻̺̱͕̣̼̭͍̯̻̥͇ͯ̒̊͋̍̂ͯ̑̈́͗͘͜r̸̃̂̑́ͧ͗ͤ̑͂͆͏̸̴̝͙̫̮à̶͖̟͈̗͓̯͍̍̏̽̀́̕͢g̢͍̠̝͖̜̗̥̞̠͈̜̭͖̯̞̹͓̣̖̓̏͆͆̓̽̅ͥ͐ͥ͂ͦ̔̿́͞͠r̷̷̫̞͎̹̻̠͈̦̻̱̩͈̝͖̪̘̞͆ͭͮ̏͗̈́̇͋͠a̸̸̡̛̲̗̳̻͕͗ͨ̂͠ṗ̆̾̓̌́̊̉̃̒́̚͢҉͏̻̙̥̜̙̩̗̣͖h̶ͧ̔̅́́̇̎ͯ̑͊̐̀͐̑͜͝҉̪̠̞̱͖̺̰̤̯͖ͅ");
        auto paragraph = builder.Build();
        paragraph->layout(50 * multiplier);

        canvas->drawRect(SkRect::MakeXYWH(0, 0, 50 * multiplier, 50 * multiplier), paint);
        paragraph->paint(canvas, 0, 0);
    }
