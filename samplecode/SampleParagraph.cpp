...
protected:
    ...
    void onDrawContent(SkCanvas* canvas) override {
        ...
        ps.fWidth = 14;
        ps.fHeight = 14;
        ps.fAlignment = PlaceholderAlignment::kBottom;
        builder.addPlaceholder(ps);
        auto paragraph = builder.Build();
        paragraph->layout(0);
        auto result = paragraph->getRectsForRange(0, 8, RectHeightStyle::kTight, RectWidthStyle::kTight);
        paragraph->paint(canvas, 0, 0);
