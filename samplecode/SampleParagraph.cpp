...
#include "modules/skparagraph/include/TestFontCollection.h"
...
protected:
    ...
    void drawText(SkCanvas* canvas, SkScalar w, SkScalar h, std::vector<std::string>& text,
        ...
        paraStyle.setTextStyle(defaultStyle);
        ParagraphBuilderImpl builder(paraStyle, sk_make_sp<TestFontCollection>(GetResourcePath("fonts").c_str()));
...
protected:
    ...
    void drawText(SkCanvas* canvas, SkColor background, SkScalar letterSpace, SkScalar w,
        ...
        ParagraphBuilderImpl builder(paragraphStyle, sk_make_sp<TestFontCollection>(GetResourcePath("fonts").c_str()));
...
/*
        ...
        */
        ...
        auto builder = ParagraphBuilder::make(
                paragraph_style,
                sk_make_sp<TestFontCollection>(GetResourcePath("fonts").c_str()));
        builder->pushStyle(text_style);
