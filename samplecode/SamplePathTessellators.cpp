...
static const char* ModeName(Mode mode) {
    switch (mode) {
        case Mode::kMiddleOutCurves:
            return "Middle-out curve tessellator";
        case Mode::kHWTessWedges:
            return "Hardware wedge tessellator";
    }
}
    ...
    void onPrepare(GrOpFlushState* flushState) override {
        ...
        switch (fMode) {
            case Mode::kMiddleOutCurves:
                ...
                shader = alloc->make<GrMiddleOutCubicShader>(fMatrix);
                break;
            case Mode::kHWTessWedges:
...
private:
    ...
    Mode fMode = Mode::kMiddleOutCurves;
...
void SamplePathTessellators::onDrawContent(SkCanvas* canvas) {
    ...
    } else if (fMode >= Mode::kHWTessWedges &&
