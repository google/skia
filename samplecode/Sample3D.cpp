...
static SkPoint project(const SkM44& m, SkScalar x, SkScalar y) {
    auto v = m * SkV4{x, y, 0, 1};
...
//        SkM44 ctm = canvas->experimental_getLocalToDevice();
    ...
    Click* onFindClickHandler(SkScalar x, SkScalar y, skui::ModifierKey modi) override {
        SkPoint c = project(fClickToWorld, x, y);
    ...
    bool onClick(Click* click) override {
        SkPoint c = project(fClickToWorld, click->fCurr.fX, click->fCurr.fY);
