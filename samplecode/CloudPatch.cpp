...
class CloudPatchView : public Sample {
...
public:
    CloudPatchView() : fXFreq(0.025f), fYFreq(0.025f), fSeed(0.0f),
...
protected:
    SkString name() override { return SkString("CloudPatch"); }
...
DEF_SAMPLE( return new CloudPatchView(); )
