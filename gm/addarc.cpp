...
DEF_GM( return new skiagm::AnimGM("addarc", addarc, {1040, 1040}); )
...
static void stroke_circle(SkCanvas* canvas, double nanos) {
...
DEF_GM( return new skiagm::AnimGM("strokecircle", stroke_circle, {520, 520}); )

////////////////////////////////////////////////////////////////////////////////

// Fill circles and rotate them to test our Analytic Anti-Aliasing.
// This test is based on StrokeCircleGM.
static void fill_circle(SkCanvas* canvas, double nanos) {
        SkScalar rotate = AnimTimer::Scaled(nanos * 1e-9, 60, 360);
        canvas->scale(20, 20);
        canvas->translate(13, 13);
...
DEF_GM( return new skiagm::AnimGM("fillcircle", fill_circle, {520, 520}); )
