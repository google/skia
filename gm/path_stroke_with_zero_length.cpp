...
DEF_SIMPLE_GM_BG(zero_length_simple, canvas, kTotalWidth, kTotalHeight, SK_ColorBLACK) {
    SkPaint paint;
    paint.setStyle(SkPaint::kStroke_Style);
    ...
    canvas->drawRect(SkRect::MakeLTRB(30, 30, 120, 70), outline);
