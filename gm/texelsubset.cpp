...
protected:
    ...
    void onOnceBeforeDraw() override {
        GetResourceAsBitmap("images/mandrill_64.png", &fBitmap);
        // Make the bitmap non-square to detect any width/height confusion.
        fBitmap.extractSubset(&fBitmap, SkIRect::MakeSize(fBitmap.dimensions()).makeInset(0, 5));
    }
    ...
    DrawResult onDraw(GrContext* context, GrRenderTargetContext* renderTargetContext,
        ...
        textureMatrices.back().postScale(1.1f, 0.85f);

        auto texelSubset = SkIRect::MakeXYWH(fBitmap.width() / 6 - 1, fBitmap.height() / 5 - 1,
