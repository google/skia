    ...
    const char* gSegmentNames[] = {
        ...
        for (size_t row = 0; row < 6; ++row) {
            ...
            for (size_t column = 0; column < 4; ++column) {
                ...
                font.setSize(10);
                skiagm::DrawShapedString(canvas, style.fName, 0, rect.height() + 12, font,
                                         labelPaint);
                skiagm::DrawShapedString(canvas, fill.fName, 0, rect.height() + 24, font,
                                         labelPaint);
                skiagm::DrawShapedString(canvas, cap.fName, 0, rect.height() + 36, font,
                                         labelPaint);
                skiagm::DrawShapedString(canvas, gSegmentNames[s1], 0, rect.height() + 48, font,
                                         labelPaint);
                skiagm::DrawShapedString(canvas, gSegmentNames[s2], 0, rect.height() + 60, font,
                                         labelPaint);
                skiagm::DrawShapedString(canvas, gSegmentNames[s3], 0, rect.height() + 72, font,
                                         labelPaint);
                skiagm::DrawShapedString(canvas, gSegmentNames[s4], 0, rect.height() + 84, font,
                                         labelPaint);
                skiagm::DrawShapedString(canvas, gSegmentNames[s5], 0, rect.height() + 96, font,
                                         labelPaint);
            }
            canvas->restore();
        }
