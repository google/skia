...
public:
    BleedGM(SkCanvas::SrcRectConstraint constraint) : fConstraint(constraint) {}
...
DEF_GM(return new BleedGM(SkCanvas::SrcRectConstraint::kStrict_SrcRectConstraint););
DEF_GM(return new BleedGM(SkCanvas::SrcRectConstraint::kFast_SrcRectConstraint););
