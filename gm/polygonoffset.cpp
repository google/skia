...
const SkPoint* gSimplePoints[] = {
    gPoints0, gPoints1, gPoints2, gPoints4, gPoints5,
    gPoints7, gPoints8, gPoints13, gPoints11, gPoints12,
};
...
private:
    ...
    static constexpr int kMaxOutset = 15;
