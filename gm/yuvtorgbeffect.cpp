...
protected:
    ...
    SkISize onISize() override {
        int numCols = kLastEnum_SkYUVColorSpace + 1;
        return SkISize::Make(238, kDrawPad + numCols * kColorSpaceOffset);
    }
...
protected:
    ...
    SkISize onISize() override {
        int numCols = kLastEnum_SkYUVColorSpace + 1;
        return SkISize::Make(48, kDrawPad + numCols * kColorSpaceOffset);
    }
