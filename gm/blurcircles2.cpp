...
protected:
    ...
    bool onAnimate(AnimationState animationState, double nanos) override {
        fAnimRadius = TimeUtils::PingPong(nanos, kRadiusPingPoingPeriod, kRadiusPingPoingShift, kMinRadius,
                                     kMaxRadius);
        fAnimBlurRadius = TimeUtils::PingPong(nanos, kBlurRadiusPingPoingPeriod, kBlurRadiusPingPoingShift,
