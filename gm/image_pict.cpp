...
protected:
    ...
    void onOnceBeforeDraw() override {
        ...
        fImage0 = SkImage::MakeFromPicture(fPicture, size, &matrix, nullptr, kN32_SkColorType,
                                           srgbColorSpace);
        matrix.postTranslate(-50, -50);
        matrix.postRotate(45);
        matrix.postTranslate(50, 50);
        fImage1 = SkImage::MakeFromPicture(fPicture, size, &matrix, nullptr, kN32_SkColorType,
                                           srgbColorSpace);
    }
