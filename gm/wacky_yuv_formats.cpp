...
public:
    ...
    enum class ImageType {
        ...
        kGenerator,        // SkImage_Lazy backed by generator that supports YUVA. This is the only mode that runs on
                           // CPU but CPU uses the flattening onGetPixels.
        kResizeOnGpu,      // Planes uploaded to GPU then resized and fed to SkImage::MakeFromYUVATextures.
    };
