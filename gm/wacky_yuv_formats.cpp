        ...
        case kY410_YUVFormat: {
            ...
            for (int y = 0; y < planes.fYFull.height(); ++y) {
                for (int x = 0; x < planes.fYFull.width(); ++x) {
                    ...
                    // NOT premul!
                    // V and Y swapped to match RGBA layout
                    *yuvaFull.getAddr32(x, y) = (A << 30) | (V << 20) | (U << 10) | (Y << 0);
                }
            }
...
protected:
    ...
    void onOnceBeforeDraw() override {
...

        {
            ...
            fOriginal8888BMs[0] = make_bitmap(kRGBA_8888_SkColorType, path, circles, false);
        }

        {
            ...
            fOriginal8888BMs[1] = make_bitmap(kRGBA_8888_SkColorType, path, circles, true);
        }
