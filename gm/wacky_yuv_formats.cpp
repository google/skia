...
sk_sp<SkImage> resize_on_gpu(GrContext* context,
    ...
    for (int i = 0; i < numTextures; ++i) {
        ...
        // TODO: right now this is being leaked. A real client would need to free it when done with it.
        shrunkTextures[i] = context->createBackendTexture(shrunkPlaneSize.width(), shrunkPlaneSize.height(),
