...
static void make_RG_88(const GrCaps* caps,
    ...
    *format = caps->getBackendFormatFromColorType1(GrColorType::kRG_88, GrRenderable::kNo);
}
...
static void make_RG_1616(const GrCaps* caps,
    ...
    *format = caps->getBackendFormatFromColorType1(GrColorType::kRG_1616, GrRenderable::kNo);
}
...
static void make_RGBA_16(const GrCaps* caps,
    ...
    *format = caps->getBackendFormatFromColorType1(GrColorType::kRGBA_16161616,
                                                  GrRenderable::kNo);
    return;
}
...
static void make_R_16(const GrCaps* caps,
    ...
    *format = caps->getBackendFormatFromColorType1(GrColorType::kR_16, GrRenderable::kNo);
}
