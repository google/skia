...
public:
    ...
    // isn't enough. This helper method encapsulates the extra work needed.
...
protected:
    ...
    sk_sp<SkImage> resizeOnGpu(GrContext* context,
                               ...
                               int numTextures,
                               SkISize imageSize) {
        YUVABackendReleaseContext* releaseContext = new YUVABackendReleaseContext(context);
...
protected:
    ...
    bool createImages(GrContext* context) {
        for (bool opaque : { false, true }) {
            ...
            YUVABackendReleaseContext* releaseContext = new YUVABackendReleaseContext(context);
            YUVABackendReleaseContext* srgbReleaseContext = new YUVABackendReleaseContext(context);
