...
SkPath p() {
    ...
    path.moveTo(189.6282043457031, 197.2497863769531);
    path.lineTo(188.8413238525391, 190.0121765136719);
    path.lineTo(188.2083587646484, 184.1902465820312);
    path.lineTo(193.5668029785156, 181.8275146484375);
    path.lineTo(200.227783203125, 178.8904418945312);
    path.lineTo(193.5668029785156, 175.953369140625);
    path.lineTo(188.2083587646484, 173.5906372070312);
    path.lineTo(188.8413238525391, 167.7687072753906);
    path.lineTo(189.6282043457031, 160.5310974121094);
    path.lineTo(183.7537231445312, 164.8315124511719);
    path.lineTo(179.0281982421875, 168.2908477783203);
    path.lineTo(174.3026733398438, 164.8315124511719);
    path.lineTo(168.4282073974609, 160.5311126708984);
    path.lineTo(169.215087890625, 167.7687072753906);
    path.lineTo(169.8480529785156, 173.5906372070312);
    path.lineTo(164.4896240234375, 175.953369140625);
    path.lineTo(157.8286285400391, 178.8904418945312);
    path.lineTo(164.4896240234375, 181.8275146484375);
    path.lineTo(169.8480529785156, 184.1902465820312);
    path.lineTo(169.215087890625, 190.0121765136719);
    path.lineTo(168.4282073974609, 197.2497711181641);
    path.lineTo(174.3026733398438, 192.9493713378906);
    path.lineTo(179.0281982421875, 189.4900360107422);
    path.lineTo(183.7537231445312, 192.9493713378906);
    path.lineTo(189.6282043457031, 197.2497863769531);
    path.moveTo(199.5423126220703, 214.4219207763672);
    path.lineTo(179.0281982421875, 199.4045562744141);
    path.lineTo(158.5141143798828, 214.4219207763672);
    path.lineTo(161.261962890625, 189.1474914550781);
    path.lineTo(138.0, 178.8904418945312);
    path.lineTo(161.261962890625, 168.6333923339844);
    path.lineTo(158.5141143798828, 143.3589935302734);
    path.lineTo(179.0281982421875, 158.3763275146484);
    path.lineTo(199.5423126220703, 143.3589935302734);
    path.lineTo(196.7944488525391, 168.6333923339844);
    path.lineTo(220.0564117431641, 178.8904418945312);
    path.lineTo(196.7944488525391, 189.1474914550781);
    path.lineTo(199.5423126220703, 214.4219207763672);
    path.close();

    return path;
}

DEF_SIMPLE_GM(bigstar, canvas, 500, 500) {
    SkPath path(p());
