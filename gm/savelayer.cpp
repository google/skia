...
DEF_SIMPLE_GM(savelayer_clipmask, canvas, 1200, 750) {
    ...
    using FilterMakerFunc = sk_sp<SkImageFilter> (*)();
    static const FilterMakerFunc kFilterMakers[] = {
        []() -> sk_sp<SkImageFilter> { return nullptr; },
        []() -> sk_sp<SkImageFilter> { return SkBlurImageFilter::Make(2, 2, nullptr); },
    };
    ...
    for (const auto& filterMaker : kFilterMakers) {
        paint.setImageFilter(filterMaker());
