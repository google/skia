...
private:
    ...
    DrawResult onCoverClipStack(const SkClipStack&, SkCanvas*, SkString* errorMsg) final;
    void visualizeAlphaMask(GrRecordingContext*,
                            GrSurfaceDrawContext*,
                            const GrReducedClip&, GrPaint&&);
    void visualizeStencilMask(GrRecordingContext*,
                              GrSurfaceDrawContext*,
                              const GrReducedClip&, GrPaint&&);
...
private:
    ...
    Effect apply(GrRecordingContext* ctx,
                 GrSurfaceDrawContext*, GrAAType, bool,
...
void WindowRectanglesMaskGM::visualizeAlphaMask(GrRecordingContext* ctx,
