...
DEF_GPU_GM_BG(bitmaptiled_fractional_horizontal, ctx, rtc, canvas, 1124, 365, SK_ColorBLACK) {
    draw_tile_bitmap_with_fractional_offset(ctx, canvas, false);
}

DEF_GPU_GM_BG(bitmaptiled_fractional_vertical, ctx, rtc, canvas, 365, 1124, SK_ColorBLACK) {
    draw_tile_bitmap_with_fractional_offset(ctx, canvas, true);
}
