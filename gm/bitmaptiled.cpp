...
void drawTileBitmapWithFractionalOffset(SkCanvas* canvas, bool vertical) {
...
DEF_SIMPLE_GM_BG(bitmaptiled_fractional_horizontal, canvas, 1124, 365, SK_ColorBLACK) {
    drawTileBitmapWithFractionalOffset(canvas, false);
}

DEF_SIMPLE_GM_BG(bitmaptiled_fractional_vertical, canvas, 1124, 365, SK_ColorBLACK) {
    drawTileBitmapWithFractionalOffset(canvas, true);
}
