...
class TessellationGM : public GpuGM {
    ...
    DrawResult onDraw1(GrContext*, GrRenderTargetContext*, SkCanvas*, SkString*) override;
};
...
DrawResult TessellationGM::onDraw1(GrContext* ctx, GrRenderTargetContext* rtc, SkCanvas* canvas,
                                  SkString* errorMsg) {
