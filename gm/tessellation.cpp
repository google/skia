...
class TessellationGM : public GpuGM {
    ...
    DrawResult onDraw1(GrRecordingContext*, GrSurfaceDrawContext*, SkCanvas*, SkString*) override;
};
...
DrawResult TessellationGM::onDraw1(GrRecordingContext* ctx, GrSurfaceDrawContext* rtc,
