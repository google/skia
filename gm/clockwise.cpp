...
class ClockwiseGM : public skiagm::GpuGM {
    ...
    void onDraw2(GrRecordingContext*, GrSurfaceDrawContext*, SkCanvas*) override;
};
...
void ClockwiseGM::onDraw2(GrRecordingContext* ctx, GrSurfaceDrawContext* rtc, SkCanvas* canvas) {
