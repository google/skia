...
struct Fade : public SkShaderBase {
    explicit Fade(sk_sp<SkShader> shader) : fShader(std::move(shader)) {
        static SkOnce once;
        once([]{ SkFlattenable::Register("Fade", Create); });
    }
    ...
    static sk_sp<SkFlattenable> Create(SkReadBuffer& b) {
        return sk_make_sp<Fade>(b.readShader());
    }

    Factory getFactory() const override { return Create; }
...
DEF_SIMPLE_GM(SkVMBlitter, canvas, 100, 100) {
    ...
    */
    ...
    /*
    5 registers, 12 instructions:
    r0 = uniform32 arg(0) 8
    r1 = splat FF (3.5733111e-43)
    r2 = extract r0 8 r1
    r3 = uniform32 arg(0) 4
    r4 = splat 40A33333 (5.0999999)
    r4 = mul_f32 r3 r4
    r4 = to_i32 r4
    r2 = pack r4 r2 8
    r0 = extract r0 16 r1
