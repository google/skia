...
DEF_GM(FilterBitmapTextGM, 3)
DEF_GM(FilterBitmapTextGM, 7)
DEF_GM(FilterBitmapTextGM, 10)
DEF_GM(FilterBitmapCheckerboardGM, 4,4)
DEF_GM(FilterBitmapCheckerboardGM, 32,32)
DEF_GM(FilterBitmapCheckerboardGM, 32,32, true)
DEF_GM(FilterBitmapCheckerboardGM, 32,8)
DEF_GM(FilterBitmapCheckerboardGM, 32,2)
DEF_GM(FilterBitmapCheckerboardGM, 192,192)
DEF_GM(FilterBitmapImageGM, "mandrill_16.png")
DEF_GM(FilterBitmapImageGM, "mandrill_32.png")
DEF_GM(FilterBitmapImageGM, "mandrill_64.png")
DEF_GM(FilterBitmapImageGM, "mandrill_64.png", true)
DEF_GM(FilterBitmapImageGM, "mandrill_128.png")
DEF_GM(FilterBitmapImageGM, "mandrill_256.png")
DEF_GM(FilterBitmapImageGM, "mandrill_512.png")
DEF_GM(FilterBitmapImageGM, "color_wheel.png")
