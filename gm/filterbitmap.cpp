...
DEF_GM( return new FilterBitmapImageGM("images/mandrill_16.png"); )
DEF_GM( return new FilterBitmapImageGM("images/mandrill_32.png"); )
DEF_GM( return new FilterBitmapImageGM("images/mandrill_64.png"); )
DEF_GM( return new FilterBitmapImageGM("images/mandrill_64.png", true); )
DEF_GM( return new FilterBitmapImageGM("images/mandrill_128.png"); )
DEF_GM( return new FilterBitmapImageGM("images/mandrill_256.png"); )
DEF_GM( return new FilterBitmapImageGM("images/mandrill_512.png"); )
DEF_GM( return new FilterBitmapImageGM("images/color_wheel.png"); )
