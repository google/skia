...
protected:
    ...
    static bool CreateYUVBackendTextures(SkBitmap bmps[4], GrContext* context,
    ...
    sk_sp<SkImage> makeYUVAImage(GrContext* context) {
        ...
        if (!CreateYUVBackendTextures(fYUVABmps, context, releaseContext)) {
    ...
    sk_sp<SkImage> createReferenceImage(GrContext* context) {
        ...
        if (!CreateYUVBackendTextures(fYUVABmps, context, planeReleaseContext)) {
