...
protected:
    ...
    static SkYUVAPixmaps CreatePlanes(const char* name) {
        SkBitmap bmp;
        ...
        SkYUVAPixmapInfo pixmapInfo({bmp.dimensions(),
                                    ...
                                    SkYUVAPixmapInfo::DataType::kUnorm8, nullptr);
    ...
    static bool CreateYUVBackendTextures(GrDirectContext* context,
    ...
    sk_sp<SkImage> makeYUVAImage(GrDirectContext* context) {
        ...
        if (!CreateYUVBackendTextures(context, fYUVAPixmaps, releaseContext)) {
            YUVABackendReleaseContext::Unwind(context, releaseContext, false);
            return nullptr;
        }
        GrYUVABackendTextures yuvaBackendTextures(fYUVAPixmaps.yuvaInfo(),
    ...
    sk_sp<SkImage> createReferenceImage(GrDirectContext* dContext) {
        ...
        auto resultInfo = SkImageInfo::Make(fYUVAPixmaps.yuvaInfo().dimensions(),
    ...
    DrawResult onGpuSetup(GrDirectContext* context, SkString* errorMsg) override {
        ...
        fYUVAPixmaps = CreatePlanes("images/mandrill_32.png");
