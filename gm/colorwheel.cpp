...
DEF_SIMPLE_GM(colorwheelnative, canvas, 128, 28) {
    ...
    skiagm::DrawShapedString(canvas, "R", 8.0f, 20.0f, font, paint);
    paint.setColor(SK_ColorGREEN);
    skiagm::DrawShapedString(canvas, "G", 24.0f, 20.0f, font, paint);
    paint.setColor(SK_ColorBLUE);
    skiagm::DrawShapedString(canvas, "B", 40.0f, 20.0f, font, paint);
    paint.setColor(SK_ColorCYAN);
    skiagm::DrawShapedString(canvas, "C", 56.0f, 20.0f, font, paint);
    paint.setColor(SK_ColorMAGENTA);
    skiagm::DrawShapedString(canvas, "M", 72.0f, 20.0f, font, paint);
    paint.setColor(SK_ColorYELLOW);
    skiagm::DrawShapedString(canvas, "Y", 88.0f, 20.0f, font, paint);
    paint.setColor(SK_ColorBLACK);
    skiagm::DrawShapedString(canvas, "K", 104.0f, 20.0f, font, paint);
}
