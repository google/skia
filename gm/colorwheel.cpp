...
DEF_SIMPLE_GM(colorwheelnative, canvas, 128, 28) {
    ...
    canvas->drawString("R", 8.0f,   20.0f, font, SkPaint(SK_ColorRED));
    canvas->drawString("G", 24.0f,  20.0f, font, SkPaint(SK_ColorGREEN));
    canvas->drawString("B", 40.0f,  20.0f, font, SkPaint(SK_ColorBLUE));
    canvas->drawString("C", 56.0f,  20.0f, font, SkPaint(SK_ColorCYAN));
    canvas->drawString("M", 72.0f,  20.0f, font, SkPaint(SK_ColorMAGENTA));
    canvas->drawString("Y", 88.0f,  20.0f, font, SkPaint(SK_ColorYELLOW) );
    canvas->drawString("K", 104.0f, 20.0f, font, SkPaint(SK_ColorBLACK));
}
