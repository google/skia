    ...
    void onDraw(SkCanvas* canvas) override {
        ...
        canvas->save();
            ...
            for (int i = 0; i <= kSubPixelSteps; ++i) {
                offset.printf("%d", i);
                canvas->drawString(offset, 0, i * kTrans + labelPaint.getTextSize(), font, labelPaint);
            }
        canvas->restore();
        ...
        canvas->save();
            ...
            for (int i = 0; i <= kSubPixelSteps; ++i) {
                offset.printf("%d", i);
                canvas->drawString(offset, i * SkIntToScalar(kTrans), labelPaint.getTextSize(), font, labelPaint);
            }
        canvas->restore();
