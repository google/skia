...
protected:
    ...
    void onDraw(SkCanvas* canvas) override {
        SkHighContrastConfig configs[] = {
            { false, HighContrastInvertStyle::kNoInvert, 0.0f },
            { false, HighContrastInvertStyle::kInvertBrightness, 0.0f },
            { false, HighContrastInvertStyle::kInvertLightness, 0.0f },
            { false, HighContrastInvertStyle::kInvertLightness, 0.2f },
            { true, HighContrastInvertStyle::kNoInvert, 0.0f },
            { true, HighContrastInvertStyle::kInvertBrightness, 0.0f },
            { true, HighContrastInvertStyle::kInvertLightness, 0.0f },
            { true, HighContrastInvertStyle::kInvertLightness, 0.2f },
        };
