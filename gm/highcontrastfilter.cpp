...
protected:
    ...
    void onDraw(SkCanvas* canvas) override {
        SkHighContrastConfig configs[] = {
            { false, HighContrastInvertStyle::kNoInvert, 1.0, 0.0 },
            { false, HighContrastInvertStyle::kInvertBrightness, 1.0, 0.0 },
            { false, HighContrastInvertStyle::kInvertLightness, 1.0, 0.0 },
            { false, HighContrastInvertStyle::kInvertLightness, 1.0, 0.3 },
            { false, HighContrastInvertStyle::kNoInvert, 0.5, 0.0 },
            { false, HighContrastInvertStyle::kInvertBrightness, 0.5, 0.0 },
            { false, HighContrastInvertStyle::kInvertLightness, 0.5, 0.0 },
            { false, HighContrastInvertStyle::kInvertLightness, 0.5, 0.3 },
            { true, HighContrastInvertStyle::kNoInvert, 1.0, 0.0 },
            { true, HighContrastInvertStyle::kInvertBrightness, 1.0, 0.0 },
            { true, HighContrastInvertStyle::kInvertLightness, 1.0, 0.0 },
            { true, HighContrastInvertStyle::kInvertLightness, 1.0, 0.3 },
            { true, HighContrastInvertStyle::kNoInvert, 0.5, 0.0 },
            { true, HighContrastInvertStyle::kInvertBrightness, 0.5, 0.0 },
            { true, HighContrastInvertStyle::kInvertLightness, 0.5, 0.0 },
            { true, HighContrastInvertStyle::kInvertLightness, 0.5, 0.3 },
        };
