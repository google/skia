...
// quad. Artifacts seemed to occur more coordinates were large, hence the large GM size. At time
// of GM creation this was fixed by dropping AA, which makes these quads practically never draw
