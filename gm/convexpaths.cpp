...
class ConvexPathsGM : public skiagm::GM {
    ...
    void makePaths() {
        ...
        fPaths.push_back(b.addRect({0, 0, 100, 100}, SkPathDirection::kCW)
                          .detach());

        fPaths.push_back(b.addRect({0, 0, 100, 100}, SkPathDirection::kCCW)
                          .detach());

        fPaths.push_back(b.addCircle(50 , 50 ,
                                     50 , SkPathDirection::kCW)
                          .detach());

        fPaths.push_back(b.addOval(SkRect::MakeXYWH(0, 0, 50, 100),
                                   SkPathDirection::kCW)
                          .detach());

        fPaths.push_back(b.addOval(SkRect::MakeXYWH(0, 0, 100, 5),
                                   SkPathDirection::kCCW)
                          .detach());

        fPaths.push_back(b.addOval(SkRect::MakeXYWH(0, 0, SK_Scalar1, 100),
                                   SkPathDirection::kCCW)
                          .detach());

        fPaths.push_back(b.addRRect(SkRRect::MakeRectXY({0, 0, 100, 100}, 40, 20),
                                    SkPathDirection::kCW)
                          .detach());
        ...
        // shallow diagonals
        fPaths.push_back(b.lineTo(100, SK_Scalar1)
                          .lineTo(98, 100)
                          .lineTo(3, 96)
                          .detach());
        ...
        fPaths.push_back(b.moveTo(SK_Scalar1 * 10, SK_Scalar1 * 10)
        ...
        fPaths.push_back(b.moveTo(0, 228 * SK_Scalar1 / 8)
                          .cubicTo(628 * SK_Scalar1 / 8, 82 * SK_Scalar1 / 8,
