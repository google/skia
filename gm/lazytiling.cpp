...
#if 0
                SkDebugf("texMatrix:\n");
                SkDebugf("%.2f %.2f %.2f\n", texMatrix[0], texMatrix[1], texMatrix[2]);
                SkDebugf("%.2f %.2f %.2f\n", texMatrix[3], texMatrix[4], texMatrix[5]);
                SkDebugf("%.2f %.2f %.2f\n", texMatrix[6], texMatrix[7], texMatrix[8]);
#endif
...
private:
    ...
    // Each cell in this GM's grid is a square - 2*kContentSize on both sides
