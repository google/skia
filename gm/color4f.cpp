...
static sk_sp<SkColorFilter> make_cf0() {
    ...
    return SkColorFilterMaker::MatrixRowMajor255(cm.fMat);
}

static sk_sp<SkColorFilter> make_cf1() {
    SkColorMatrix cm;
    cm.setSaturation(0.75f);
    auto a = SkColorFilterMaker::MatrixRowMajor255(cm.fMat);
    ...
    return a->makeComposed(SkColorFilterMaker::MatrixRowMajor255(cm.fMat));
}

static sk_sp<SkColorFilter> make_cf2() {
    return SkColorFilterMaker::Blend(0x8044CC88, SkBlendMode::kSrcATop);
}
