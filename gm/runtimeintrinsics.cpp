...
static void plot(SkCanvas* canvas,
    ...
    SkBitmap bitmap = draw_shader(canvas, builder.makeShader(nullptr, false));
...
static void plot_matrix_comp_mult(SkCanvas* canvas,
    ...
    draw_shader(canvas, builder.makeShader(nullptr, false));
...
static void plot_bvec(SkCanvas* canvas, const char* fn, const char* label) {
    ...
    draw_shader(canvas, effect->makeShader(nullptr, nullptr, 0, nullptr, false));
