...
DEF_SIMPLE_GM_BG(runtime_intrinsics_common,
    ...
    plot(canvas, "mod(x, 2)",    -4.0f, 4.0f, -2.0f, 2.0f); col(canvas);
    plot(canvas, "mod(p, -2).x", -4.0f, 4.0f, -2.0f, 2.0f); col(canvas);
    plot(canvas, "mod(p, v2).x", -4.0f, 4.0f, -2.0f, 2.0f); row(canvas);

    plot(canvas, "min(x, 1)",    0.0f, 2.0f, 0.0f, 2.0f); col(canvas);
    plot(canvas, "min(p, 1).x",  0.0f, 2.0f, 0.0f, 2.0f); col(canvas);
    plot(canvas, "min(p, v1).x", 0.0f, 2.0f, 0.0f, 2.0f); col(canvas);
    plot(canvas, "max(x, 1)",    0.0f, 2.0f, 0.0f, 2.0f); col(canvas);
    plot(canvas, "max(p, 1).x",  0.0f, 2.0f, 0.0f, 2.0f); col(canvas);
    plot(canvas, "max(p, v1).x", 0.0f, 2.0f, 0.0f, 2.0f); row(canvas);

    plot(canvas, "clamp(x, 1, 2)",     0.0f, 3.0f, 0.0f, 3.0f); col(canvas);
    plot(canvas, "clamp(p, 1, 2).x",   0.0f, 3.0f, 0.0f, 3.0f); col(canvas);
    plot(canvas, "clamp(p, v1, v2).x", 0.0f, 3.0f, 0.0f, 3.0f); col(canvas);
    plot(canvas, "saturate(x)", -1.0f, 2.0f, -0.5f, 1.5f); row(canvas);

    plot(canvas, "mix(1, 2, x)",     -1.0f, 2.0f, 0.0f, 3.0f); col(canvas);
    plot(canvas, "mix(v1, v2, x).x", -1.0f, 2.0f, 0.0f, 3.0f); col(canvas);
    plot(canvas, "mix(v1, v2, p).x", -1.0f, 2.0f, 0.0f, 3.0f); row(canvas);

    plot(canvas, "step(1, x)",    0.0f, 2.0f, -0.5f, 1.5f); col(canvas);
    plot(canvas, "step(1, p).x",  0.0f, 2.0f, -0.5f, 1.5f); col(canvas);
    plot(canvas, "step(v1, p).x", 0.0f, 2.0f, -0.5f, 1.5f); col(canvas);
