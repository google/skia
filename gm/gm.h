...
namespace skiagm {
    ...
    private:
        ...
        virtual DrawResult onDraw(GrRecordingContext*,
                                  GrSurfaceDrawContext*, SkCanvas*,
                                  SkString* errorMsg);
    ...
    public:
        using DrawProc = DrawResult(*)(GrRecordingContext*,
    ...
    private:
        SkISize onISize() override;
        SkString onShortName() override;
        DrawResult onDraw(GrRecordingContext* ctx,
