...
void DrawBigRect(SkCanvas* canvas, SkScalar big, const SkPaint& rectPaint) {
    ...
    SkRect fromLeft = SkRect::MakeLTRB(-big, 20, 15, 25);
    canvas->drawRect(fromLeft, rectPaint);

    SkRect fromTop = SkRect::MakeLTRB(20, -big, 25, 15);
    canvas->drawRect(fromTop, rectPaint);

    SkRect fromRight = SkRect::MakeLTRB(30, 20, big, 25);
    canvas->drawRect(fromRight, rectPaint);

    SkRect fromBottom = SkRect::MakeLTRB(20, 30, 25, big);
