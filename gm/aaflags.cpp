...
private:
    ...
    void onDraw(SkCanvas* canvas) override {
        ...
        matrices[1].postTranslate(d, 400.f);
        matrices[2].setRotate(-60.f);
        matrices[2].postSkew(0.5f, -1.35f);
        matrices[2].postScale(0.6, 1.05);
        matrices[2].postTranslate(d, 2.5f * d);
        dst[0] = {0, 0};
        dst[1] = {3.f / 4.f * kM * kTileW, 0};
        dst[2] = {2.f / 3.f * kM * kTileW, 1 / 4.f * kN * kTileH};
        dst[3] = {1.f / 3.f * kM * kTileW, 1 / 4.f * kN * kTileH - 25.f};
