...
void test_collapse9(SkCanvas* canvas, const SkPaint& paint) {
    SkPath path;
    path.moveTo( 13.25, 197.75);
    path.lineTo( 34.75, 174.75);
    path.lineTo( 99.0364,140.364);
    path.lineTo( 99.25, 140.25);
    path.lineTo(100.167,140.096);
    path.lineTo(130.50, 135.00);
    path.moveTo( 39.25,  47.50);
    path.lineTo(100.167,140.096);
    path.lineTo( 99.0364,140.364);
    path.lineTo( 94.25, 141.50);
    path.setFillType(SkPath::FillType::kEvenOdd_FillType);
    canvas->drawPath(path, paint);
}
