...
DEF_GM( return new ShallowGradientGM(shader_linear,  "shallow_gradient_linear",  true); )
DEF_GM( return new ShallowGradientGM(shader_radial,  "shallow_gradient_radial",  true); )
DEF_GM( return new ShallowGradientGM(shader_conical, "shallow_gradient_conical", true); )
DEF_GM( return new ShallowGradientGM(shader_sweep,   "shallow_gradient_sweep",   true); )

DEF_GM( return new ShallowGradientGM(shader_linear,  "shallow_gradient_linear_nodither",  false); )
DEF_GM( return new ShallowGradientGM(shader_radial,  "shallow_gradient_radial_nodither",  false); )
DEF_GM( return new ShallowGradientGM(shader_conical, "shallow_gradient_conical_nodither", false); )
DEF_GM( return new ShallowGradientGM(shader_sweep,   "shallow_gradient_sweep_nodither",   false); )
