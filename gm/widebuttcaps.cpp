...
protected:
    ...
    void onDraw(SkCanvas* canvas) override {
        ...
        this->drawStrokes(canvas, SkPath().moveTo(0, 0).lineTo(10, 0).lineTo(10, 10),
                          SkPath().moveTo(0, 0).cubicTo(10, 0, 10, 0, 10, 10));
        canvas->translate(0, 120);

        this->drawStrokes(canvas, SkPath().moveTo(0, 0).lineTo(0, -10).lineTo(0, 10),
                          SkPath().moveTo(0, 0).cubicTo(0, -10, 0, -10, 0, 10));
        canvas->translate(0, 120);

        this->drawStrokes(canvas,
                SkPath().moveTo(0, 0).lineTo(0, -10).lineTo(10, -10).lineTo(10, 10).lineTo(0, 10),
                SkPath().moveTo(0, 0).cubicTo(0, -10, 10, 10, 0, 10));
        canvas->translate(0, 140);

        this->drawStrokes(canvas,
                SkPath().moveTo(0, 0).lineTo(0, -10).lineTo(10, -10).lineTo(10, 0).lineTo(0, 0),
                SkPath().moveTo(0, 0).cubicTo(0, -10, 10, 0, 0, 0));
        canvas->translate(0, 120);
    }
