...
//this test exercise SkCanvas::setBoundRect behavior
...
protected:
    ...
    virtual void onDraw(SkCanvas* canvas) {
        ...
        canvas->save();
            ...
            canvas->setBoundRect(SkIRect::MakeLTRB(100, 100, 300, 300));
            ...
            canvas->setBoundRect(SkIRect::MakeLTRB(500, 100, 800, 300));
            ...
            canvas->setBoundRect(SkIRect::MakeLTRB(500, 500, 800, 700));
