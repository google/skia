...
static void draw_pair(SkCanvas* canvas, const SkFont& font, SkColor color,
    ...
    skiagm::DrawShapedString(canvas, text, 10, 20, font, paint);
    paint.setShader(SkShader::MakeColorShader(paint.getColor()));
    skiagm::DrawShapedString(canvas, text, 10, 40, font, paint);
    paint.setShader(shader);
    skiagm::DrawShapedString(canvas, text, 10, 60, font, paint);
}
