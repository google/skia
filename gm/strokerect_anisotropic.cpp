...
protected:
    ...
    void onDraw(SkCanvas* canvas) override {
        ...
        draw_sqooshed_rect(canvas, {  20.5f, 35.5f }, aaPaint);
        draw_sqooshed_rect(canvas, {  60.0f, 35.0f }, aaPaint);
//        draw_sqooshed_rect(canvas, {  20.5f, 105.5f }, bwPaint);
//        draw_sqooshed_rect(canvas, {  55.0f, 105.0f }, bwPaint);
        ...
        draw_sqooshed_rect(canvas, {  90.5f, 35.5f }, aaPaint);
        draw_sqooshed_rect(canvas, { 125.0f, 35.0f }, aaPaint);
        draw_sqooshed_rect(canvas, {  90.5f, 105.5f }, bwPaint);
