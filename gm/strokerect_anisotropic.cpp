...
protected:
    ...
    void onDraw(SkCanvas* canvas) override {
        ...
        draw_sqooshed_rect(canvas, { 100.0f, 40.5f }, aaPaint);
        draw_sqooshed_rect(canvas, { 140.5f, 40.0f }, aaPaint);
        draw_sqooshed_rect(canvas, { 100.0f, 110.5f }, bwPaint);
        draw_sqooshed_rect(canvas, { 140.5f, 110.0f }, bwPaint);
    }
