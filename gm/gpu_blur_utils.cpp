...
// Makes a src texture for as a source for blurs. If 'transparentPixelFrame' then the content will
...
static bool kShowSlowRefImages = false;

static void do_very_large_blur_gm(GrSurfaceDrawContext* sdc,
                                  GrRecordingContext* rContext,
                                  GrSurfaceProxyView src,
                                  SkIRect srcB) {
    sdc->clear(SkColor4f{0.3, 0.4, 0.2, 1});
