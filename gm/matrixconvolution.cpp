...
#if 0
        SkRect clip = SkRect::MakeWH(fBitmap.width()-2, fBitmap.height()-2);
        clip.offset(kernelOffset.fX, kernelOffset.fY);
#else
        SkRect clip = SkRect::MakeWH(fBitmap.width(), fBitmap.height());
#endif
