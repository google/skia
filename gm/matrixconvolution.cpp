    ...
    sk_sp<SkImageFilter> makeFilter(const SkIPoint &kernelOffset, SkTileMode tileMode,
        ...
        switch (fKernelFixture) {
            case kBasic_KernelFixture: {
                // All 1s except center value, which is -7.
            ...
            case kLarge_KernelFixture: {
                ...
                kernel[24] = SkIntToScalar(-7);
                return SkImageFilters::MatrixConvolution({7,7}, kernel.data(), /* gain */ 0.14f, /* bias */ SkIntToScalar(100), kernelOffset, tileMode, convolveAlpha, nullptr, cropRect);
            }
            default:
                return nullptr;
        }
