...
static sk_sp<SkImage> do_read_and_scale_yuv(SkSurface* surface, SkYUVColorSpace yuvCS,
    ...
    backendTextures[0] = gr->priv().getGpu()->createTestingOnlyBackendTexture(
            dstW, dstH, kAlpha_8_SkColorType, GrMipMapped::kNo, GrRenderable::kNo, yData.get());
    backendTextures[1] = gr->priv().getGpu()->createTestingOnlyBackendTexture(
            dstW / 2, dstH / 2, kRGBA_8888_SkColorType, GrMipMapped::kNo, GrRenderable::kNo,
            uvxxData.get());
