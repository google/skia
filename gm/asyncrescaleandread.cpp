...
static sk_sp<SkImage> do_read_and_scale_yuv(Src* src,
    ...
    SkYUVAInfo yuvaInfo(srcRect.size(), SkYUVAInfo::PlanarConfig::kY_U_V_420, yuvCS);
    GrYUVABackendTextures yuvaBackendTextures(yuvaInfo, backendTextures, kTopLeft_GrSurfaceOrigin);
    ...
    *cleanup = {[direct, backendTextures] {
    ...
    return SkImage::MakeFromYUVATextures(direct, yuvaBackendTextures, SkColorSpace::MakeSRGB());
}
