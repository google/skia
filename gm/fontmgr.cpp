...
public:
    FontMgrBoundsGM(float scale, float skew, const char* name)
        : fName(name) , fScaleX(scale) , fSkewX(skew) {}
...
DEF_GM(return new FontMgrBoundsGM(1,     0,     "fontmgr_bounds"        );)
DEF_GM(return new FontMgrBoundsGM(0.75f, 0,     "fontmgr_bounds_0.75_0" );)
DEF_GM(return new FontMgrBoundsGM(1,    -0.25f, "fontmgr_bounds_1_-0.25");)
