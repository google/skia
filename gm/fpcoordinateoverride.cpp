...
public:
    static constexpr GrProcessor::ClassID CLASS_ID = (GrProcessor::ClassID) 10000;
...
DEF_SIMPLE_GM_BG(fpcoordinateoverride, canvas, 512, 512, ToolUtils::color_to_565(0xFF66AA99)) {
    SkRect bounds = SkRect::MakeIWH(512, 512);

    GrContext* ctx = canvas->getGrContext();
    GrRenderTargetContext* rtCtx = canvas->internal_private_accessTopLayerRenderTargetContext();
    SkBitmap bmp;
