...
static SkBitmap make_text(SkImageInfo info) {
    ...
    SkFont font;
    paint.setSubpixel(true);
    paint.setSize(textSize);

    font.setTypeface(sk_tool_utils::create_portable_typeface(&paint, "serif", SkFontStyle()));
    canvas.drawString("Hamburgefons", textSize/2, 1.2f*textSize, font, paint);
    font.setTypeface(sk_tool_utils::create_portable_typeface(&paint, "serif", SkFontStyle::Bold()));
    canvas.drawString("Hamburgefons", textSize/2, 2.4f*textSize, font, paint);
    font.setTypeface(sk_tool_utils::create_portable_typeface(&paint, "serif", SkFontStyle::Italic()));
    canvas.drawString("Hamburgefons", textSize/2, 3.6f*textSize, font, paint);
    font.setTypeface(sk_tool_utils::create_portable_typeface(&paint, "serif", SkFontStyle::BoldItalic()));
