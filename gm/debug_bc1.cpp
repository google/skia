...
// behaves as expected (i.e., w/ per-block transparency) then, the opaque block(s)
// should appear as:
//    opaque black, dark grey, light grey, white
// and the transparent block(s) should appear as:
...
// This makes a 32x8 BC1 texture which has the top 4 rows be officially transparent
...
// This GM draws the BC1 compressed texture filled with "make_compressed_data"s data twice. Once
// (on the top) as a kBC1_RGB8_UNORM texture and then again (on the bottom) as a kBC1_RGBA8_UNORM
// texture.
//
// If BC1 behaves as expected we should see:
//
//    Black MidGrey   Red   White ...
//    Black DrkGrey LtGrey  White ...
//
//    Black MidGrey   Red   White ...
//    Black DrkGrey LtGrey  White ...
//
// i.e., the texture type the data is jammed into is irrelevant.
...
protected:
    ...
    void onDraw(GrContext* context, GrRenderTargetContext* renderTargetContext,
        ...
        auto rgbImg = SkImage::MakeTextureFromCompressed(context, fBC1Data,
                                                         kImgWidth,
                                                         kImgHeight,
        ...
        auto rgbaImg = SkImage::MakeTextureFromCompressed(context, fBC1Data,
                                                          kImgWidth,
                                                          kImgHeight,
