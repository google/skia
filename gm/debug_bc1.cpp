...
// Create a BC1 block that, if interpreted as opaque, should look like:
//    opaque black, dark grey, light grey, white
// but, if interpreted as transparent, should look like:
//    opaque black, medium grey, transparent black, white.
//
// Two forms are created:
//    one where fCol0 < fCol1 (transparent) -> punch through alpha
//    one where fCol0 > fCol1               -> opaque
//
...
static void create_BC1_block(BC1Block* block, bool transparent) {
    ...
    unsigned int byte = (0x0 << 6) | (0x2 << 4) | (0x3 << 2) | (0x1 << 0);
