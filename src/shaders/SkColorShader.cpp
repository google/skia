...
gr_fp<GrFragmentProcessor> SkColorShader::asFragmentProcessor(const AsFPArgs& args) const {
...
gr_fp<GrFragmentProcessor> SkColor4Shader::asFragmentProcessor(const AsFPArgs& args) const {
