...
std::unique_ptr<GrFragmentProcessor> SkColorShader::asFragmentProcessor(
    ...
    return GrFragmentProcessor::ModulateAlpha(SkColorToPMColor4f(fColor, *args.fDstColorInfo),
                                              /*child=*/nullptr);
}
...
std::unique_ptr<GrFragmentProcessor> SkColor4Shader::asFragmentProcessor(
    ...
    return GrFragmentProcessor::ModulateAlpha(color.premul(), /*child=*/nullptr);
}
