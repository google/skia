...
private:
    ...
    GrPerlinNoise2Effect(SkPerlinNoiseShaderImpl::Type type,
        ...
        this->registerChild(std::move(permutationsFP), SkSL::SampleUsage::MakeExplicitCoords());
        this->registerChild(std::move(noiseFP), SkSL::SampleUsage::MakeExplicitCoords());
...
private:
    ...
    GrImprovedPerlinNoiseEffect(int octaves,
            ...
            , fPaintingData(std::move(paintingData)) {
        this->registerChild(std::move(permutationsFP), SkSL::SampleUsage::MakeExplicitCoords());
        this->registerChild(std::move(gradientFP), SkSL::SampleUsage::MakeExplicitCoords());
        this->setUsesSampleCoordsDirectly();
    }
