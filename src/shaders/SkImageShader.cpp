...
bool SkImageShader::doStages(const SkStageRec& rec, SkImageStageUpdater* updater) const {
    ...
    auto append_tiling_and_gather = [&] {
        ...
        switch (info.colorType()) {
            ...
            case kA16_flt_SkColorType:      p->append(SkRasterPipeline::gather_af16,    ctx); break;
            ...
            case kR16G16_flt_SkColorType:   p->append(SkRasterPipeline::gather_rgf16,  ctx);  break;
