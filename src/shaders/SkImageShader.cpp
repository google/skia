...
bool SkImageShader::onProgram(skvm::Builder* p,
    ...
    // Apply tile mode.  Everything falls through to a safety clamp, so kClamp is a noop.
    ...
    // Clamp sample coordinates to [0,width), [0,height), both for safety and to handle kClamp.
