...
bool SkImageShader::doStages(const SkStageRec& rec, SkImageStageUpdater* updater) const {
    ...
    auto append_misc = [&] {
        ...
        // Color for A8 images comes from the paint.  TODO: all alpha-only images?  none?
        ...
        // TODO: let SkColorSpaceXformSteps handle this (subtle, reorders with bicubic clamp)?
