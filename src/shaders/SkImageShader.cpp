...
std::unique_ptr<GrFragmentProcessor> SkImageShader::asFragmentProcessor(
    ...
    bool bicubic;
    SkImage::CubicResampler kernel = GrBicubicEffect::gCatmullRom;
