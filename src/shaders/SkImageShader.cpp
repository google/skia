...
std::unique_ptr<GrFragmentProcessor> SkImageShader::asFragmentProcessor(
    ...
    if (fImage->isAlphaOnly()) {
        return GrBlendFragmentProcessor::Make(args.fContext, std::move(fp), nullptr, SkBlendMode::kDstIn);
    ...
    return GrBlendFragmentProcessor::Make(args.fContext, std::move(fp), nullptr, SkBlendMode::kSrcIn);
}
