...
public:
    ...
    static gr_fp<GrFragmentProcessor> Make(const CreateArgs& args) {
        auto processor = gr_fp<Edge2PtConicalEffect>(new Edge2PtConicalEffect(args));
    ...
    gr_fp<GrFragmentProcessor> clone() const override {
        return gr_fp<GrFragmentProcessor>(new Edge2PtConicalEffect(*this));
    }
 ...
 */
#if GR_TEST_UTILS
gr_fp<GrFragmentProcessor> Edge2PtConicalEffect::TestCreate(GrProcessorTestData* d) {
...
public:
    ...
    static gr_fp<GrFragmentProcessor> Make(const CreateArgs& args, SkScalar focalX) {
        auto processor =
                gr_fp<FocalOutside2PtConicalEffect>(new FocalOutside2PtConicalEffect(args, focalX));
        return processor->isValid() ? std::move(processor) : nullptr;
    }
    ...
    gr_fp<GrFragmentProcessor> clone() const override {
        return gr_fp<GrFragmentProcessor>(new FocalOutside2PtConicalEffect(*this));
    }
 ...
 */
#if GR_TEST_UTILS
gr_fp<GrFragmentProcessor> FocalOutside2PtConicalEffect::TestCreate(GrProcessorTestData* d) {
    SkPoint center1 = {d->fRandom->nextUScalar1(), d->fRandom->nextUScalar1()};
...
public:
    ...
    static gr_fp<GrFragmentProcessor> Make(const CreateArgs& args, SkScalar focalX) {
        auto processor =
                gr_fp<FocalInside2PtConicalEffect>(new FocalInside2PtConicalEffect(args, focalX));
        return processor->isValid() ? std::move(processor) : nullptr;
    }
    ...
    gr_fp<GrFragmentProcessor> clone() const override {
        return gr_fp<GrFragmentProcessor>(new FocalInside2PtConicalEffect(*this));
    }
 ...
 */
#if GR_TEST_UTILS
gr_fp<GrFragmentProcessor> FocalInside2PtConicalEffect::TestCreate(GrProcessorTestData* d) {
    SkPoint center1 = {d->fRandom->nextUScalar1(), d->fRandom->nextUScalar1()};
    SkScalar radius1 = 0.f;
    SkPoint center2;
    SkScalar radius2;
...
public:
    ...
    static gr_fp<GrFragmentProcessor> Make(const CreateArgs& args, const CircleConicalInfo& info) {
        auto processor =
                gr_fp<CircleInside2PtConicalEffect>(new CircleInside2PtConicalEffect(args, info));
        return processor->isValid() ? std::move(processor) : nullptr;
    }
    ...
    gr_fp<GrFragmentProcessor> clone() const override {
        return gr_fp<GrFragmentProcessor>(new CircleInside2PtConicalEffect(*this));
    }
 ...
 */
#if GR_TEST_UTILS
gr_fp<GrFragmentProcessor> CircleInside2PtConicalEffect::TestCreate(GrProcessorTestData* d) {
    SkPoint center1 = {d->fRandom->nextUScalar1(), d->fRandom->nextUScalar1()};
...
public:
    ...
    gr_fp<GrFragmentProcessor> clone() const override {
        return gr_fp<GrFragmentProcessor>(new CircleOutside2PtConicalEffect(*this));
    }
 ...
 */
#if GR_TEST_UTILS
gr_fp<GrFragmentProcessor> CircleOutside2PtConicalEffect::TestCreate(GrProcessorTestData* d) {
    SkPoint center1 = {d->fRandom->nextUScalar1(), d->fRandom->nextUScalar1()};
    SkScalar radius1 = d->fRandom->nextUScalar1() + 0.0001f; // make sure radius1 != 0
    SkPoint center2;
    SkScalar radius2;
...
gr_fp<GrFragmentProcessor> Gr2PtConicalGradientEffect::Make(
