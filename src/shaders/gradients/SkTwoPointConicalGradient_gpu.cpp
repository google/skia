...
private:
    ...
    explicit Edge2PtConicalEffect(const CreateArgs& args)
            : INHERITED(kEdge2PtConicalEffect_ClassID, args, false /* opaque: draws transparent black outside of the cone. */) {
...
private:
    ...
    CircleOutside2PtConicalEffect(const CreateArgs& args, const CircleConicalInfo& info)
            : INHERITED(kCircleOutside2PtConicalEffect_ClassID, args, false /* opaque: draws transparent black outside of the cone. */)
            , fInfo(info) {
        const SkTwoPointConicalGradient& shader =
            *static_cast<const SkTwoPointConicalGradient*>(args.fShader);
