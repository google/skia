...
bool SkGradientShaderBase::onProgram(skvm::Builder* p,
    ...
    // TODO: which colors to start at and which to end at here is more subtle than this;
    // see the code in onAppendStages() that strips off artificially added stops.
    // Fixing this should help some of the edge case diffs.
