...
public:
    ...
    SkScalar rasterScale() const {
        return fMetadata.fRasterDPI / SkPDFUtils::kDpiForRasterScaleOne;
    }
    SkScalar inverseRasterScale() const {
        return SkPDFUtils::kDpiForRasterScaleOne / fMetadata.fRasterDPI;
    }
