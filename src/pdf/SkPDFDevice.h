...
//
// Here are examples of how to convert to and from SkMatrix:
//    bool matrix_to_affine(const SkMatrix& m, SkAffineMatrix* a) {
//        return m.asAffine(a->fMat);
//    }
//    SkMatrix affine_to_matrix(const SkAffineMatrix& a) {
//        SkMatrix m;
//        m.setAffine(a.fMat);
//        return m;
//    }
