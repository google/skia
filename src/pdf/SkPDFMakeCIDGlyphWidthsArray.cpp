...
std::unique_ptr<SkPDFArray> SkPDFMakeCIDGlyphWidthsArray(const SkTypeface& typeface,
    ...
    //  d. Switching for 2+ repeats and 5+ don't cares wins   "0 0 adv.ances 0 0 0 adv.ances"
    //     rule: always end range for 2+ repeats with 5+ don't cares
    //
