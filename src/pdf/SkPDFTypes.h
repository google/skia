...
class SkPDFObject : public std::variant<bool,                         // Boolean
                                        int32_t,                      // Integer number
                                        SkScalar,                     // Real number
                                        SkPDFColorComponentU,         // Real number, less precision
                                        SkPDFColorComponentF,         // Real number, less precision
                                        SkString,                     // String
                                        const char*,                  // String
...
public:
    ...
    void insertRef(SkString key, SkPDFIndirectReference value) { this->insert(key, value); }
