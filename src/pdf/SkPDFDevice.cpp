...
void SkPDFDevice::drawPath1(const SkPath& origPath,
                           const SkPaint& srcPaint,
                           bool pathIsMutable) {
    this->internalDrawPath(
            this->cs(), this->ctm(), origPath, srcPaint, pathIsMutable);
}
...
static void draw_glyph_run_as_path(SkPDFDevice* dev, const SkGlyphRun& glyphRun, SkPoint offset) {
    ...
    dev->drawPath1(path, glyphRun.paint(), true);
}
...
bool SkPDFDevice::handleInversePath(const SkPath& origPath,
    ...
    if (SkPaint::kStroke_Style == paint.getStyle() ||
        ...
        if (doFillPath) {
            ...
            this->drawPath1(modifiedPath, paint, true);
            return true;
        }
    }
    ...
    this->drawPath1(modifiedPath, noInversePaint, true);
    return true;
}
