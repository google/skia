...
static const unsigned int kSplice_load_8888_lowp[] = {
    ...
    0x2e301014,                                 //  uaddw         v20.8h, v0.8h, v16.8b
    0x2f08a623,                                 //  uxtl          v3.8h, v17.8b
    0x2e311016,                                 //  uaddw         v22.8h, v0.8h, v17.8b
    0x2f08a657,                                 //  uxtl          v23.8h, v18.8b
    0x2e321019,                                 //  uaddw         v25.8h, v0.8h, v18.8b
    0x2f08a67a,                                 //  uxtl          v26.8h, v19.8b
    0x2e33101b,                                 //  uaddw         v27.8h, v0.8h, v19.8b
    0x6f1f0420,                                 //  ushr          v0.8h, v1.8h, #1
    0x2f0fa635,                                 //  ushll         v21.8h, v17.8b, #7
    0x2f0fa658,                                 //  ushll         v24.8h, v18.8b, #7
    0x2f0fa670,                                 //  ushll         v16.8h, v19.8b, #7
    0x4ea01c40,                                 //  orr           v0.16b, v2.16b, v0.16b
    0x6f1f0461,                                 //  ushr          v1.8h, v3.8h, #1
    0x6f1f06e2,                                 //  ushr          v2.8h, v23.8h, #1
    0x6f1f0743,                                 //  ushr          v3.8h, v26.8h, #1
    0x4ea11ea1,                                 //  orr           v1.16b, v21.16b, v1.16b
    0x4ea21f02,                                 //  orr           v2.16b, v24.16b, v2.16b
    0x4ea31e03,                                 //  orr           v3.16b, v16.16b, v3.16b
    0x6f181680,                                 //  usra          v0.8h, v20.8h, #8
    0x6f1816c1,                                 //  usra          v1.8h, v22.8h, #8
    0x6f181722,                                 //  usra          v2.8h, v25.8h, #8
    0x6f181763,                                 //  usra          v3.8h, v27.8h, #8
};
...
static const unsigned int kSplice_multiply_lowp[] = {
    0xf3500b04,                                 //  vqrdmulh.s16  d16, d0, d4
    0xf3511b05,                                 //  vqrdmulh.s16  d17, d1, d5
    0xf3522b06,                                 //  vqrdmulh.s16  d18, d2, d6
    0xf3533b07,                                 //  vqrdmulh.s16  d19, d3, d7
    0xf2444110,                                 //  vand          d20, d4, d0
    0xf3b50320,                                 //  vabs.s16      d0, d16
    0xf2455111,                                 //  vand          d21, d5, d1
    0xf3b51321,                                 //  vabs.s16      d1, d17
    0xf2460112,                                 //  vand          d16, d6, d2
    0xf2471113,                                 //  vand          d17, d7, d3
    0xf3b52322,                                 //  vabs.s16      d2, d18
    0xf3b53323,                                 //  vabs.s16      d3, d19
    0xf3910134,                                 //  vsra.u16      d0, d20, #15
    0xf3911135,                                 //  vsra.u16      d1, d21, #15
    0xf3912130,                                 //  vsra.u16      d2, d16, #15
    0xf3913131,                                 //  vsra.u16      d3, d17, #15
};
static const unsigned int kSplice_srcover[] = {
...
static const unsigned int kSplice_clamp_0_lowp[] = {
    0xf2c00010,                                 //  vmov.i32      d16, #0
    0xf3100620,                                 //  vmax.u16      d0, d0, d16
    0xf3111620,                                 //  vmax.u16      d1, d1, d16
    0xf3122620,                                 //  vmax.u16      d2, d2, d16
    0xf3133620,                                 //  vmax.u16      d3, d3, d16
};
static const unsigned int kSplice_clamp_1[] = {
    0xe283c004,                                 //  add           ip, r3, #4
    0xf4ec0c9f,                                 //  vld1.32       {d16[]}, [ip :32]
...
static const unsigned char kSplice_srcover_lowp[] = {
    0xc4,0x62,0x7d,0x79,0x41,0x38,              //  vpbroadcastw  0x38(%rcx),%ymm8
...
static const unsigned char kSplice_load_8888_lowp[] = {
    ...
    0xc4,0xc1,0x75,0xeb,0xca,                   //  vpor          %ymm10,%ymm1,%ymm1
    0xc4,0x62,0x7d,0x79,0x51,0x38,              //  vpbroadcastw  0x38(%rcx),%ymm10
    0xc4,0xc1,0x7d,0xfd,0xc2,                   //  vpaddw        %ymm10,%ymm0,%ymm0
    0xc5,0xfd,0x71,0xd0,0x08,                   //  vpsrlw        $0x8,%ymm0,%ymm0
    0xc5,0xfd,0xfd,0xc1,                        //  vpaddw        %ymm1,%ymm0,%ymm0
    ...
    0xc5,0xed,0xeb,0xd3,                        //  vpor          %ymm3,%ymm2,%ymm2
    0xc4,0xc1,0x75,0xfd,0xca,                   //  vpaddw        %ymm10,%ymm1,%ymm1
    0xc5,0xf5,0x71,0xd1,0x08,                   //  vpsrlw        $0x8,%ymm1,%ymm1
    0xc5,0xf5,0xfd,0xca,                        //  vpaddw        %ymm2,%ymm1,%ymm1
    ...
    0xc4,0xc1,0x65,0xeb,0xdb,                   //  vpor          %ymm11,%ymm3,%ymm3
    0xc4,0xc1,0x6d,0xfd,0xd2,                   //  vpaddw        %ymm10,%ymm2,%ymm2
    0xc5,0xed,0x71,0xd2,0x08,                   //  vpsrlw        $0x8,%ymm2,%ymm2
    0xc5,0xed,0xfd,0xd3,                        //  vpaddw        %ymm3,%ymm2,%ymm2
    ...
    0xc4,0x41,0x3d,0xeb,0xc1,                   //  vpor          %ymm9,%ymm8,%ymm8
    0xc4,0xc1,0x65,0xfd,0xda,                   //  vpaddw        %ymm10,%ymm3,%ymm3
    0xc5,0xe5,0x71,0xd3,0x08,                   //  vpsrlw        $0x8,%ymm3,%ymm3
    0xc4,0xc1,0x65,0xfd,0xd8,                   //  vpaddw        %ymm8,%ymm3,%ymm3
};
