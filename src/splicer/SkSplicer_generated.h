...
static const unsigned int kSplice_from_srgb[] = {
    0x91006068,                                 //  add           x8, x3, #0x18
    0x4d40c910,                                 //  ld1r          {v16.4s}, [x8]
    0x91005068,                                 //  add           x8, x3, #0x14
    0x2d43cc72,                                 //  ldp           s18, s19, [x3,#28]
...
static const unsigned int kSplice_clamp_x[] = {
    ...
    0x4eb0f400,                                 //  fmin          v0.4s, v0.4s, v16.4s
    0x6f00e410,                                 //  movi          v16.2d, #0x0
    0x4e20f600,                                 //  fmax          v0.4s, v16.4s, v0.4s
};
static const unsigned int kSplice_clamp_y[] = {
    ...
    0x4eb0f421,                                 //  fmin          v1.4s, v1.4s, v16.4s
    0x6f00e410,                                 //  movi          v16.2d, #0x0
    0x4e21f601,                                 //  fmax          v1.4s, v16.4s, v1.4s
};
...
static const unsigned int kSplice_from_srgb[] = {
    0xed2d8b02,                                 //  vpush         {d8}
    0xe283c01c,                                 //  add           ip, r3, #28
    0xed938a08,                                 //  vldr          s16, [r3, #32]
...
static const unsigned char kSplice_from_srgb[] = {
    0xc4,0x62,0x7d,0x18,0x41,0x20,              //  vbroadcastss  0x20(%rcx),%ymm8
    0xc5,0x3c,0x59,0xc8,                        //  vmulps        %ymm0,%ymm8,%ymm9
    0xc5,0x7c,0x59,0xd0,                        //  vmulps        %ymm0,%ymm0,%ymm10
    0xc4,0x62,0x7d,0x18,0x59,0x1c,              //  vbroadcastss  0x1c(%rcx),%ymm11
    0xc4,0x62,0x7d,0x18,0x61,0x18,              //  vbroadcastss  0x18(%rcx),%ymm12
    0xc4,0x41,0x7c,0x28,0xeb,                   //  vmovaps       %ymm11,%ymm13
    0xc4,0x42,0x7d,0xa8,0xec,                   //  vfmadd213ps   %ymm12,%ymm0,%ymm13
    0xc4,0x62,0x7d,0x18,0x71,0x14,              //  vbroadcastss  0x14(%rcx),%ymm14
    0xc4,0x42,0x2d,0xa8,0xee,                   //  vfmadd213ps   %ymm14,%ymm10,%ymm13
    0xc4,0x62,0x7d,0x18,0x51,0x24,              //  vbroadcastss  0x24(%rcx),%ymm10
...
static const unsigned char kSplice_to_srgb[] = {
    ...
    0xc4,0x62,0x7d,0x18,0x41,0x28,              //  vbroadcastss  0x28(%rcx),%ymm8
    0xc5,0x3c,0x59,0xd8,                        //  vmulps        %ymm0,%ymm8,%ymm11
    0xc4,0x62,0x7d,0x18,0x21,                   //  vbroadcastss  (%rcx),%ymm12
    0xc4,0x62,0x7d,0x18,0x69,0x2c,              //  vbroadcastss  0x2c(%rcx),%ymm13
    0xc4,0x62,0x7d,0x18,0x71,0x30,              //  vbroadcastss  0x30(%rcx),%ymm14
    0xc4,0x62,0x7d,0x18,0x79,0x34,              //  vbroadcastss  0x34(%rcx),%ymm15
    ...
    0xc4,0x62,0x7d,0x18,0x51,0x38,              //  vbroadcastss  0x38(%rcx),%ymm10
    0xc4,0xc1,0x7c,0xc2,0xc2,0x01,              //  vcmpltps      %ymm10,%ymm0,%ymm0
