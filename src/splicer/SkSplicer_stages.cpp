...
#define AI __attribute__((always_inline)) inline
    ...
    AI static F   rcp  (F v) { auto e = vrecpeq_f32 (v); return e * vrecpsq_f32 (v,e);   }
    AI static F   rsqrt(F v) { auto e = vrsqrteq_f32(v); return e * vrsqrtsq_f32(v,e*e); }
    AI static F   if_then_else(I32 c, F t, F e) { return vbslq_f32((U32)c,t,e); }
    AI static U32 round(F v) { return vcvtq_u32_f32(v); }  // TODO: this truncs; round instead
#else
