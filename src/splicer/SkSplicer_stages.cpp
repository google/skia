...
#define AI __attribute__((always_inline)) inline
    ...
    AI static F gather(const float* ptr, U32 ix) {
        return F{ ptr[ix[0]], ptr[ix[1]], ptr[ix[2]], ptr[ix[3]] };
    }
    ...
    AI static F gather(const float* ptr, U32 ix) {
        return _mm256_i32gather_ps(ptr, ix, 4);
    }
#endif
...
STAGE(load_tables) {
    ...
    r = gather(c->r, (px >>  0) & k->_0x000000ff);
