...
static const unsigned int kSplice_store_8888_lowp[] = {
    0xf9400048,                                 //  ldr           x8, [x2]
    0x6e600c10,                                 //  uqadd         v16.8h, v0.8h, v0.8h
    0x6e610c31,                                 //  uqadd         v17.8h, v1.8h, v1.8h
    0x0f088612,                                 //  shrn          v18.8b, v16.8h, #8
    0x0f088633,                                 //  shrn          v19.8b, v17.8h, #8
    0x6e620c50,                                 //  uqadd         v16.8h, v2.8h, v2.8h
    0x0f088614,                                 //  shrn          v20.8b, v16.8h, #8
    0x6e630c70,                                 //  uqadd         v16.8h, v3.8h, v3.8h
    0x8b000908,                                 //  add           x8, x8, x0, lsl #2
    0x0f088615,                                 //  shrn          v21.8b, v16.8h, #8
