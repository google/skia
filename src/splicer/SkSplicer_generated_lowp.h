...
static const unsigned char kSplice_scale_u8_lowp[] = {
    ...
    0xc4,0x41,0x3d,0xe5,0xc1,                   //  vpmulhw       %ymm9,%ymm8,%ymm8
...
static const unsigned char kSplice_load_8888_lowp[] = {
    ...
    0xc4,0xc1,0x7d,0xe5,0xc2,                   //  vpmulhw       %ymm10,%ymm0,%ymm0
    ...
    0xc4,0xc1,0x75,0xe5,0xca,                   //  vpmulhw       %ymm10,%ymm1,%ymm1
    ...
    0xc4,0xc1,0x6d,0xe5,0xd2,                   //  vpmulhw       %ymm10,%ymm2,%ymm2
    ...
    0xc4,0xc1,0x65,0xe5,0xda,                   //  vpmulhw       %ymm10,%ymm3,%ymm3
};
