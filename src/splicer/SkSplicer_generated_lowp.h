...
static const unsigned int kSplice_load_8888_lowp[] = {
    ...
    0xe1a0e00c,                                 //  mov           lr, ip
    0xf4ee030d,                                 //  vld4.8        {d16[0],d17[0],d18[0],d19[0]}, [lr]!
    0xf4ee032f,                                 //  vld4.8        {d16[1],d17[1],d18[1],d19[1]}, [lr]
    0xe28ce008,                                 //  add           lr, ip, #8
    0xe28cc00c,                                 //  add           ip, ip, #12
    0xf4ee034f,                                 //  vld4.8        {d16[2],d17[2],d18[2],d19[2]}, [lr]
    0xf26371b3,                                 //  vorr          d23, d19, d19
    0xf26261b2,                                 //  vorr          d22, d18, d18
    0xf26151b1,                                 //  vorr          d21, d17, d17
    0xf26041b0,                                 //  vorr          d20, d16, d16
    0xf4ec436f,                                 //  vld4.8        {d20[3],d21[3],d22[3],d23[3]}, [ip]
    0xf26401b4,                                 //  vorr          d16, d20, d20
    0xf26621b6,                                 //  vorr          d18, d22, d22
    0xf38f0a30,                                 //  vshll.u8      q0, d16, #7
    0xf38f2a32,                                 //  vshll.u8      q1, d18, #7
    0xf26501b5,                                 //  vorr          d16, d21, d21
    0xf26721b7,                                 //  vorr          d18, d23, d23
    0xf3980350,                                 //  vrsra.u16     q0, q0, #8
    0xf3cf0a30,                                 //  vshll.u8      q8, d16, #7
    0xf3cf2a32,                                 //  vshll.u8      q9, d18, #7
...
static const unsigned int kSplice_store_8888_lowp[] = {
    ...
    0xf22031b0,                                 //  vorr          d3, d16, d16
    0xf4ce430d,                                 //  vst4.8        {d20[0],d21[0],d22[0],d23[0]}, [lr]!
    0xf4ce432f,                                 //  vst4.8        {d20[1],d21[1],d22[1],d23[1]}, [lr]
    0xe28ce008,                                 //  add           lr, ip, #8
    0xe28cc00c,                                 //  add           ip, ip, #12
    0xf4ce434f,                                 //  vst4.8        {d20[2],d21[2],d22[2],d23[2]}, [lr]
    0xf4cc436f,                                 //  vst4.8        {d20[3],d21[3],d22[3],d23[3]}, [ip]
    0xe8bd4800,                                 //  pop           {fp, lr}
};
