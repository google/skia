...
SkCodec::Result SkWuffsGifCodec::onStartIncrementalDecode(const SkImageInfo& dstInfo,
    ...
    // TODO(nigeltao): is "clear the dst image to black (transparent or opaque
    // depending on dstInfo.colorType()" the right thing to do? The
    // AnimatedImage test passes on images/alphabetAnim.gif with it and fails
    // without it.
    //
