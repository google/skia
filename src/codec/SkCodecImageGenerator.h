...
protected:
    ...
    bool onQueryYUV8(SkYUVSizeInfo*, SkYUVAIndex[4], SkYUVColorSpace*) const override;

    bool onGetYUV8Planes(const SkYUVSizeInfo&, const SkYUVAIndex[4], void* planes[3]) override;
