...
SkCodec::Result SkWuffsCodec::onIncrementalDecode(int* rowsDecoded) {
    ...
    // Ensure that fSpySampler.fillWidth returns whatever fSwizzler->fillWidth
    // would have, if fSpySampler.fillWidth is ever called after
    // onIncrementalDecode returns.
