...
int SkWuffsSpySampler::onSetSampleX(int sampleX) {
    fSampleX = sampleX;
    // TODO: should the first argument be the frame width instead of the image
    // width? The tests pass as is. On the other hand, we don't know the frame
    // width yet. See the comment for the SkWuffsSpySampler class.
