...
// background color after drawing this frame. For incremental decodes, pixels
// inside that rect will also be temporarily set to that background color, but
// will eventually be overwritten when the incremental decode completes.
//
