...
bool GrProgramDesc::Build(GrProgramDesc* desc, const GrRenderTarget* renderTarget,
    ...
    header->fProcessorFeatures1 = (uint8_t)programInfo.requestedFeatures();
    SkASSERT(header->fProcessorFeatures1 == (int) programInfo.requestedFeatures()); // Ensure enough bits.
