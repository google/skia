...
public:
    ...
    /*
     * Removes a unique key to a proxy. If the proxy has already been instantiated, it will
    ...
    /*
     * Finds a proxy by unique key or create a new one that wraps a resource matching the unique
     * key.
     */
