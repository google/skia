...
sk_sp<GrTextureProxy> GrAndroidBufferImageGenerator::onGenerateTexture(GrContext* context,
...
bool GrAndroidBufferImageGenerator::onGetPixels(const SkImageInfo&, void*, size_t, const Options&) {
