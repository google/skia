...
GrOp* GrRenderTargetOpList::addDrawOp(const GrPipelineBuilder& pipelineBuilder,
...
#endif
    return this->recordOp(std::move(op), renderTargetContext, appliedClip.clippedDrawBounds());
}
