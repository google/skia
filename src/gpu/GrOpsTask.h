...
public:
    ...
    void addOp(GrDrawingManager* drawingMgr, GrOp::OpOwner op,
    ...
    void addDrawOp(GrDrawingManager* drawingMgr, GrOp::OpOwner op,
...
private:
    ...
    class OpChain {
    public:
        OpChain(GrOp::OpOwner, GrProcessorSet::Analysis, GrAppliedClip*, const DstProxyView*);
        ~OpChain() {
        ...
        GrOp::OpOwner appendOp(GrOp::OpOwner op, GrProcessorSet::Analysis,
    ...
    private:
        ...
        public:
            ...
            GrOp::OpOwner popHead();
            GrOp::OpOwner removeOp(GrOp* op);
            void pushHead(GrOp::OpOwner op);
            void pushTail(GrOp::OpOwner);

            void validate() const;

        private:
            GrOp::OpOwner fHead{nullptr, nullptr};
            GrOp* fTail{nullptr};
        };
    ...
    void recordOp(GrOp::OpOwner, GrProcessorSet::Analysis, GrAppliedClip*,
