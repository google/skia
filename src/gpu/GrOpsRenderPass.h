...
public:
    ...
    // upadatePrimProcTextureBindings() before drawing. The texture bindings on existing primitive
    ...
    void upadatePrimProcTextureBindings(const GrPrimitiveProcessor&, const GrPipeline&,
    ...
    // "setScissor" and "upadatePrimProcTextureBindings" on the client's behalf.
    ...
    // bindPipeline(), followed setScissor() and upadatePrimProcTextureBindings() if necessary,
