...
public:
    ...
    void setViewportOffset(SkIPoint viewportOffset) {
        fViewportOffset1 = viewportOffset;
    }
    ...
    // pipeline.
    void setScissorRect(const SkIRect& scissor);
...
private:
    ...
    virtual void onSetScissorRect(const SkIRect& scissor) = 0;
    virtual void onSetViewport(const SkIRect& viewport) = 0;
