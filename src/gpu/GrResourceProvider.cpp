...
sk_sp<GrTexture> GrResourceProvider::createTexture(const GrSurfaceDesc& desc, GrRenderable renderable, SkBudgeted budgeted,
...
sk_sp<GrTexture> GrResourceProvider::getExactScratch(const GrSurfaceDesc& desc, GrRenderable renderable,
...
sk_sp<GrTexture> GrResourceProvider::createApproxTexture(const GrSurfaceDesc& desc, GrRenderable renderable,
                                                         Flags flags) {
    ASSERT_SINGLE_OWNER
...
sk_sp<GrTexture> GrResourceProvider::refScratchTexture(const GrSurfaceDesc& desc, GrRenderable renderable, Flags flags) {
    ASSERT_SINGLE_OWNER
    ...
    if (fGpu->caps()->reuseScratchTextures() || renderable == GrRenderable::kYes) {
        ...
        GrGpuResource* resource = fCache->findAndRefScratchResource(key,
                                                                    GrSurface::WorstCaseSize(desc, renderable),
                                                                    scratchFlags);
        if (resource) {
