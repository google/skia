...
void GrImageTextureMaker::makeMipMappedKey(GrUniqueKey* paramsCopyKey) {
    if (fOriginalKey.isValid() && SkImage::kAllow_CachingHint == fCachingHint) {
        GrUniqueKey cacheKey;
        fImage->makeCacheKeyFromOrigKey(fOriginalKey, &cacheKey);
        MakeMipMappedKeyFromOriginalKey(cacheKey, paramsCopyKey);
    }
}
...
void GrYUVAImageTextureMaker::makeMipMappedKey(GrUniqueKey* paramsCopyKey) {
