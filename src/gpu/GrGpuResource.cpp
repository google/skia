...
void GrGpuResource::notifyRefCountIsZero() const {
    if (this->wasDestroyed1()) {
...
void GrGpuResource::removeScratchKey() {
    if (!this->wasDestroyed1() && fScratchKey.isValid()) {
...
void GrGpuResource::makeBudgeted() {
    ...
    if (!this->wasDestroyed1() && fBudgetedType == GrBudgetedType::kUnbudgetedUncacheable) {
...
void GrGpuResource::makeUnbudgeted() {
    if (!this->wasDestroyed1() && fBudgetedType == GrBudgetedType::kBudgeted &&
        !fUniqueKey.isValid()) {
