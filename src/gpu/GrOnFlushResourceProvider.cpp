...
sk_sp<const GrBuffer> GrOnFlushResourceProvider::findOrMakeStaticBuffer(size_t size,
                                                                        GrBufferType intendedType,
                                                                        const void* data,
                                                                        const GrUniqueKey& key) {
    GrResourceProvider* rp = fDrawingMgr->getContext()->resourceProvider();
    sk_sp<const GrBuffer> buffer = rp->findOrCreateStaticBuffer(size, intendedType, data, key);
