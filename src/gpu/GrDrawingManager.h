...
private:
    ...
    public:
        ...
        // just removes the GrRenderTasks but doesn't cleanup any refering pointers (i.e. dependency
        // pointers in the DAG). It works right now bc it is only called after the topological sort
