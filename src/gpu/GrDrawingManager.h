...
// but all of them still land in the same GrRenderTask!
//
// In the future this class will allocate a new GrRenderTargetContext for
// each GrRenderTarget/GrRenderTask and manage the DAG.
...
private:
    ...
    RenderTaskDAG                     fDAG;
    GrRenderTask*                     fActiveRenderTask = nullptr;
    ...
    SkSTArray<8, sk_sp<GrRenderTargetOpList>> fOnFlushCBOpLists;
    ...
    bool                              fFlushing;
    bool                              fReduceRenderTaskSplitting;
