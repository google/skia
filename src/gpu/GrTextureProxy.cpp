...
sk_sp<GrSurface> GrTextureProxy::foo(GrResourceProvider* resourceProvider) const {
    sk_sp<GrSurface> surface= this->fooImpl(resourceProvider, 0, kNone_GrSurfaceFlags,
