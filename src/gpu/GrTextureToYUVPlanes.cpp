...
bool GrTextureToYUVPlanes(GrContext* context, sk_sp<GrTextureProxy> proxy,
...

    {
        ...
        if (yuvRenderTargetContext) {
            if (!convert_proxy(context, proxy, yuvRenderTargetContext.get(),
            ...
            if (uvRenderTargetContext) {
                if (!convert_proxy(context, proxy, uvRenderTargetContext.get(),
                ...
                if (!convert_proxy(context, proxy, vRenderTargetContext.get(),
