 ...
 *     | ..M.. |   | ..mcoeffs.. |
 *
 * The klm coefficients are found separately, depending on the type of curve. There are 4
 * coefficients but 3 rows in the matrix, so in order to do this calculation the caller must first
 * remove a column of coefficients.
 *
