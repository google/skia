...
static void calc_serp_klm(const SkPoint pts[4], SkScalar tl, SkScalar sl, SkScalar tm,
                          SkScalar sm, SkMatrix* klm) {
    SkMatrix CIT;
...
static void calc_loop_klm(const SkPoint pts[4], SkScalar td, SkScalar sd, SkScalar te,
                          SkScalar se, SkMatrix* klm) {
    SkMatrix CIT;
    int skipCol = calc_inverse_transpose_power_basis_matrix(pts, &CIT);
