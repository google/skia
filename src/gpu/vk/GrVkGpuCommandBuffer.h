...
class GrVkGpuCommandBuffer : public GrGpuCommandBuffer, private GrMesh::SendToGpuHelper {
public:
...
private:
    ...
    // GrMesh::SendToGpuHelper implementation. These issue the actual Vulkan draw commands.
