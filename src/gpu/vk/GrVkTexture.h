...
private:
    GrVkTexture(GrVkGpu*, SkBudgeted, SkISize, const GrVkImageInfo&,
                sk_sp<GrBackendMutableStateImpl>, const GrVkImageView* imageView, GrMipMapsStatus);
    GrVkTexture(GrVkGpu*, SkISize, const GrVkImageInfo&, sk_sp<GrBackendMutableStateImpl>,
