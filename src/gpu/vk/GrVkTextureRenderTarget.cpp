...
sk_sp<GrVkTextureRenderTarget> GrVkTextureRenderTarget::Create(GrVkGpu* gpu,
...
GrVkTextureRenderTarget::CreateNewTextureRenderTarget(GrVkGpu* gpu,
    ...
    sk_sp<GrVkTextureRenderTarget> trt = Create(gpu, desc, info, budgeted, GrVkImage::kNot_Wrapped);
    if (!trt) {
