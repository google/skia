...
private:
    ...
    public:
        ...
        void setPurgeableProc(GrVkTexture* owner, GrTexture::PurgeableProc, void* context) const;
    ...
    private:
        ...
        mutable GrTexture::PurgeableProc* fPurgeableProc = nullptr;
        mutable void* fPurgeableProcCtx = nullptr;
