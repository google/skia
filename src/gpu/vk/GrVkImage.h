...
public:
    ...
    VkImageLayout currentLayout() const {
        ...
        // if the client isn't using GrBackendObjects and GrBackendTextures to update the the layout
        ...
        // TODO: Delete all this ugliness as soon as we get rid of GrBacknedObject getters.
