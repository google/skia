...
uint32_t GrVkUniformHandler::getRTHeightOffset() const {
    uint32_t currentOffset = fUsePushConstants ? fCurrentStd430Offset : fCurrentStd140Offset;
    return get_aligned_offset(&currentOffset, kFloat_GrSLType, 0,
                              fUsePushConstants ? kStd430 : kStd140);
}
...
bool GrVkUniformHandler::determineIfUsePushConstants() const {
    ...
    fUsePushConstants = fCurrentStd430Offset > 0 &&
