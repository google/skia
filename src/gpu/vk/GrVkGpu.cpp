...
bool GrVkGpu::createVkImageForBackendSurface(VkFormat vkFormat,
    ...
    if (data->type() == BackendTextureData::Type::kPixmaps) {
        ...
        size_t combinedBufferSize = GrComputeTightCombinedBufferSize(bytesPerPixel, dimensions,
...
GrBackendRenderTarget GrVkGpu::createTestingOnlyBackendRenderTarget(int w, int h, GrColorType ct) {
    ...
    GrVkImageInfo info;
    if (!this->createVkImageForBackendSurface(vkFormat, {w, h}, false, true,
                                              nullptr, 1, &info, GrProtected::kNo)) {
        return {};
    }
