...
GrVkGpu::GrVkGpu(GrContext* context, const GrContextOptions& options,
        ...
        , fOwnsInstanceAndDevice(backendContext.fOwnsInstanceAndDevice)
...
void GrVkGpu::destroyResources() {
    ...
    if (fOwnsInstanceAndDevice) {
        VK_CALL(DeviceWaitIdle(fDevice));
        VK_CALL(DestroyDevice(fDevice, nullptr));
        VK_CALL(DestroyInstance(fInstance, nullptr));
    }
