...
void GrVkGpu::onResolveRenderTarget(GrRenderTarget* target, const SkIRect& resolveRect,
    ...
    if (target->needsResolve()) {
        ...
        if (kBottomLeft_GrSurfaceOrigin == resolveOrigin) {
            originRelativeResolveRect.fTop = target->height() - resolveRect.fBottom;
            originRelativeResolveRect.fBottom = target->height() - resolveRect.fTop;
        }
        this->resolveImage(target, rt, originRelativeResolveRect,
                           {originRelativeResolveRect.fLeft, originRelativeResolveRect.fTop});
