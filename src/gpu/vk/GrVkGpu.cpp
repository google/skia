...
bool GrVkGpu::compile(const GrProgramDesc& desc, const GrProgramInfo& programInfo) {
    ...
    sk_sp<const GrVkRenderPass> renderPass(this->resourceProvider().findCompatibleRenderPass1(
                                                                         &attachmentsDescriptor,
                                                                         attachmentFlags));
    if (!renderPass) {
        return false;
    ...
    auto pipelineState = this->resourceProvider().findOrCreateCompatiblePipelineState3_2(
                                    desc,
                                    programInfo,
