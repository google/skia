...
void GrVkGpu::innerResolveRenderTarget(GrRenderTarget* target, bool requiresSubmit) {
...
void GrVkGpu::generateMipmap(GrVkTexture* tex) {
    ...
    if (texRT) {
        this->innerResolveRenderTarget(texRT, false);
    }
    ...
    if (rt) {
        ...
        switch (rt->getResolveType()) {
            ...
            case GrVkRenderTarget::kCanResolve_ResolveType:
                this->innerResolveRenderTarget(rt, false);
                break;
            default:
