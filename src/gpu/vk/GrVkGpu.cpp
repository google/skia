...
bool GrVkGpu::uploadTexDataCompressed(GrVkTexture* uploadTexture, VkFormat vkFormat, SkISize dimensions,
    ...
    SkTArray<size_t> individualMipOffsets;
    fill_in_regions(fVkCaps.get(), &regions, &individualMipOffsets, vkFormat, dimensions,
