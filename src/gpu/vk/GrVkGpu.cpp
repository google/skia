...
sk_sp<GrTexture> GrVkGpu::onWrapBackendTexture(const GrBackendTexture& backendTex,
    ...
    sk_sp<GrBackendMutableStateImpl> mutableState = backendTex.getMutableState();
...
sk_sp<GrTexture> GrVkGpu::onWrapCompressedBackendTexture(const GrBackendTexture& beTex,
    ...
    sk_sp<GrBackendMutableStateImpl> mutableState = beTex.getMutableState();
    SkASSERT(mutableState);
...
sk_sp<GrRenderTarget> GrVkGpu::onWrapBackendRenderTarget(const GrBackendRenderTarget& backendRT) {
    ...
    sk_sp<GrBackendMutableStateImpl> mutableState = backendRT.getMutableState();
    SkASSERT(mutableState);
...
sk_sp<GrRenderTarget> GrVkGpu::onWrapBackendTextureAsRenderTarget(const GrBackendTexture& tex,
    ...
    sk_sp<GrBackendMutableStateImpl> mutableState = tex.getMutableState();
    SkASSERT(mutableState);
...
bool GrVkGpu::onUpdateBackendTexture(const GrBackendTexture& backendTexture,
    ...
    sk_sp<GrBackendMutableStateImpl> mutableState = backendTexture.getMutableState();
    SkASSERT(mutableState);
