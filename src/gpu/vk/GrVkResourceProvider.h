...
public:
    ...
    const GrVkRenderPass* findCompatibleRenderPass1(GrVkRenderPass::AttachmentsDescriptor*,
    ...
    GrVkPipelineState* findOrCreateCompatiblePipelineState3_2(
            const GrProgramDesc&,
            const GrProgramInfo&,
            VkRenderPass compatibleRenderPass,
...
#define GR_PIPELINE_STATE_CACHE_STATS
    ...
    public:
        ...
        GrVkPipelineState* findOrCreatePipelineState1(GrRenderTarget*,
                                                     const GrProgramInfo&,
                                                     VkRenderPass compatibleRenderPass);
        GrVkPipelineState* findOrCreatePipelineState1_2(const GrProgramDesc& desc,
                                                     const GrProgramInfo& programInfo,
                                                     VkRenderPass compatibleRenderPass,
                                                     GrGpu::Stats::ProgramCacheResult* stat) {
            return this->findOrCreatePipelineState2(nullptr, desc, programInfo,
