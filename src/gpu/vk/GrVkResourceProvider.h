...
public:
    ...
    GrThreadSafePipelineBuilder_Base* pipelineStateCache() {
        return fPipelineStateCache.get();
    }

    sk_sp<GrThreadSafePipelineBuilder_Base> refPipelineStateCache() {
...
private:
    ...
    class PipelineStateCache : public GrThreadSafePipelineBuilder_Base {
    public:
