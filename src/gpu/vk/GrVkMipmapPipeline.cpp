...
GrVkMipmapPipeline* GrVkMipmapPipeline::Create(GrVkGpu* gpu,
    ...
    return new GrVkMipmapPipeline(vkPipeline, &renderPass);
}

bool GrVkMipmapPipeline::isCompatible(const GrVkRenderPass& rp) const {
