...
GrVkPipeline* GrVkResourceProvider::createPipeline(const GrRenderTarget* renderTarget,
    ...
    return GrVkPipeline::Create(fGpu, renderTarget, primProc, pipeline, stencil, shaderStageInfo,
...
GrVkPipelineState* GrVkResourceProvider::findOrCreateCompatiblePipelineState(
        ...
        VkRenderPass compatibleRenderPass) {
    return fPipelineStateCache->refPipelineState(renderTarget, origin, proc, primProcProxies, pipeline,
