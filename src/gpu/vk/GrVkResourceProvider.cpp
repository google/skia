...
void GrVkResourceProvider::checkCommandBuffers() {
    // When resetting a command buffer it can trigger client provide procs (e.g. release or
    ...
    // happen in the middle of us doing work. This may be just one of many potential pit falls that
