...
private:
    GrVkTextureRenderTarget(GrVkGpu* gpu, SkBudgeted budgeted, const GrSurfaceDesc& desc,
                            const GrVkImageInfo& info, const GrVkImageView* texView,
        ...
        , GrVkRenderTarget(gpu, desc, info, msaaInfo, colorAttachmentView, resolveAttachmentView,
    ...
    GrVkTextureRenderTarget(GrVkGpu* gpu, const GrSurfaceDesc& desc, const GrVkImageInfo& info,
    ...
    static GrVkTextureRenderTarget* Create(GrVkGpu*, const GrSurfaceDesc&, const GrVkImageInfo&,
                                           SkBudgeted budgeted, GrVkImage::Wrapped wrapped);
