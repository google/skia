...
sk_sp<GrVkTexture> GrVkTexture::MakeNewTexture(GrVkGpu* gpu, SkBudgeted budgeted,
    ...
    return sk_sp<GrVkTexture>(new GrVkTexture(gpu, budgeted, desc, info,
            std::move(layout), imageView, mipMapsStatus));
}
...
sk_sp<GrVkTexture> GrVkTexture::MakeWrappedTexture(GrVkGpu* gpu,
    ...
    return sk_sp<GrVkTexture>(new GrVkTexture(gpu, desc, info, std::move(layout),
