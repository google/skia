...
public:
    ...
    VkCommandBuffer externalSecondaryCommandBuffer() const {
        return fExternalSecondaryCommandBuffer;
    }
...
private:
    ...
    bool isExternal() const { return fExternalSecondaryCommandBuffer != VK_NULL_HANDLE; }
    ...
    VkCommandBuffer fExternalSecondaryCommandBuffer = VK_NULL_HANDLE;
