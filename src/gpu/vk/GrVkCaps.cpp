...
void GrVkCaps::init(const GrContextOptions& contextOptions, const GrVkInterface* vkInterface,
    ...
    if (SkToBool(extensionFlags & kKHR_get_physical_device_properties2_GrVkExtensionFlag)) {
        ...
        SkDebugf("@@@@@@@@@> vksdk=%i\n", VK_HEADER_VERSION);
        SkDebugf("@@@@@@@@@> GetPhysicalDeviceProperties2KHR=%p\n",
                 vkInterface->fFunctions.fGetPhysicalDeviceProperties2KHR);
        SkDebugf("@@@@@@@@@> CmdSetDiscardRectangleEXT=%p\n",
                 vkInterface->fFunctions.fCmdSetDiscardRectangleEXT);
        SkDebugf("@@@@@@@@@> vksdk=%i\n", VK_HEADER_VERSION);
