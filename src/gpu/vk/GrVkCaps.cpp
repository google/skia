...
bool GrVkCaps::onTransferFromBufferRequirements(GrColorType bufferColorType, int width,
    ...
    // This GrColorType has 32 bpp but the Vulkan pixel format we use for it has 24bpp. We don't
    // support post transforming the pixel data for transfer-from currently.
