...
bool GrVkCaps::canCopyAsDraw(GrPixelConfig dstConfig, bool dstIsRenderTarget,
                             GrPixelConfig srcConfig, bool srcIsTexture) const {
    ...
    if (!dstIsRenderTarget || !srcIsTexture) {
        return false;
    }
