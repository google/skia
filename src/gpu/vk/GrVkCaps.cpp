...
void GrVkCaps::init(const GrContextOptions& contextOptions, const GrVkInterface* vkInterface,
    ...
    if (properties.vendorID == kNvidia_VkVendor || properties.vendorID == kAMD_VkVendor) {
        ...
        // presistently mapped buffers for all of them since most GPUs with updated drivers do
        // expose it. If this becomes an issue we issue we can try to be more fine grained.
