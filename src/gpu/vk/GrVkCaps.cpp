...
GrPixelConfig GrVkCaps::onGetConfigFromCompressedBackendFormat(const GrBackendFormat& f) const {
    ...
    switch (vkFormat) {
        case VK_FORMAT_ETC2_R8G8B8_UNORM_BLOCK:   return kETC2_RGB8_UNORM_GrPixelConfig;
        case VK_FORMAT_ETC2_R8G8B8_SRGB_BLOCK:    return kETC2_RGB8_SRGB_GrPixelConfig;
        case VK_FORMAT_ETC2_R8G8B8A8_UNORM_BLOCK: return kETC2_RGBA8_UNORM_GrPixelConfig;
        case VK_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK:  return kETC2_RGBA8_SRGB_GrPixelConfig;
        case VK_FORMAT_BC1_RGB_UNORM_BLOCK:       return kBC1_RGB8_UNORM_GrPixelConfig;
        case VK_FORMAT_BC1_RGB_SRGB_BLOCK:        return kBC1_RGB8_SRGB_GrPixelConfig;
        case VK_FORMAT_BC1_RGBA_UNORM_BLOCK:      return kBC1_RGBA8_UNORM_GrPixelConfig;
        case VK_FORMAT_BC1_RGBA_SRGB_BLOCK:       return kBC1_RGBA8_SRGB_GrPixelConfig;
    }
...
std::vector<GrCaps::TestFormatColorTypeCombination> GrVkCaps::getTestingCombinations() const {
    std::vector<GrCaps::TestFormatColorTypeCombination> combos = {
        ...
        { GrColorType::kRGBA_8888_SRGB,   GrBackendFormat::MakeVk(VK_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK)},
        //--
        ...
        { GrColorType::kRGBA_8888_SRGB,   GrBackendFormat::MakeVk(VK_FORMAT_BC1_RGBA_SRGB_BLOCK)  },
        //--
