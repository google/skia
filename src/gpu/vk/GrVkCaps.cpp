...
void GrVkCaps::applyDriverCorrectnessWorkarounds(const VkPhysicalDeviceProperties& properties) {
    ...
    if (kQualcomm_VkVendor == properties.vendorID) {
        // http://skbug.com/7758 -- On Adreno Vulkan running Android O, we uncovered a driver bug
        // after deleting GPU clip masks. This cap is just a Band-Aid to keep the bots happy until
        // we investigate.
