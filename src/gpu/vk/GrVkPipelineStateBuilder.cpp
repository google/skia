...
void GrVkPipelineStateBuilder::finalizeFragmentOutputColor(GrShadeVar& outputColor) {
    outputColor.setLayoutQualifier("location = 0, index = 0");
}

void GrVkPipelineStateBuilder::finalizeFragmentSecondaryColor(GrShadeVar& outputColor) {
