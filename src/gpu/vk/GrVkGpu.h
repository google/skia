...
private:
    ...
    // we will signal the semaphore end the end of command this command buffer. If this GrVkGpu
    // object has any semaphores in fSemaphoresToWaitOn, we will add those wait semaphores to this
    // command buffer when submitting.
