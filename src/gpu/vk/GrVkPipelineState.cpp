...
void GrVkPipelineState::setData(GrVkGpu* gpu,
    ...
    SkAutoSTMalloc<8, TextureBinding> textureBindings(fNumSamplers);
    ...
    for (int i = 0; i < primProc.numTextureSamplers(); ++i) {
        ...
        textureBindings[currTextureBinding++] =
    ...
    if (fNumSamplers) {
        ...
        this->bindTexturesToSamplers(gpu, textureBindings.get());
    }
...
void GrVkPipelineState::bindTexturesToSamplers(GrVkGpu* gpu, const TextureBinding bindings[]) {
