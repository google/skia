...
bool GrVkOpsRenderPass::onUpdatePrimProcTextureBindings(const GrPrimitiveProcessor& primProc,
                                                        const GrPipeline& pipeline,
                                                        const GrSurfaceProxy* const proxies[]) {
    return fCurrentPipelineState->setAndBindTextures(fGpu, primProc, pipeline, proxies,
