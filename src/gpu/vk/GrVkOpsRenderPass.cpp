...
GrVkPipelineState* GrVkOpsRenderPass::prepareDrawState(
    ...
    pipelineState->setAndBindUniforms(fGpu, fRenderTarget, fOrigin1,
    ...
    bool setTextures = !(programInfo.dynamicStateArrays() &&
    ...
    } else if (!programInfo.dynamicStateArrays() ||
...
void GrVkOpsRenderPass::onDraw(const GrProgramInfo& programInfo,
    ...
    bool dynamicScissor = programInfo.pipeline().isScissorEnabled() &&
                          programInfo.dynamicStateArrays() &&
                          programInfo.dynamicStateArrays()->fScissorRects;
