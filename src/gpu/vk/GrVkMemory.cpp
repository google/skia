...
bool GrVkMemory::AllocAndBindBufferMemory(const GrVkGpu* gpu,
    ...
    AllocationPropertyFlags propFlags = AllocationPropertyFlags::kNone;
    if (usage == GrVkMemoryAllocator::BufferUsage::kCpuWritesGpuReads) {
        // In general is always fine (and often better) to keep buffers always mapped.
        // TODO: According to AMDs guide for the VulkanMemoryAllocator they suggest there are two
        // cases when keeping this maps can hurt. The first is when running on Win7 or Win8 (Win 10
