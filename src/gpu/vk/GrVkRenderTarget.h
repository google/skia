...
public:
    ...
    GrVkResourceProvider::CompatibleRPHandle compatibleRenderPassHandle() const {
        SkASSERT(!this->isForSecondaryCommandBuffer());
        return fCompatibleRPHandle;
    }

    bool isForSecondaryCommandBuffer() const { return fSecondaryCommandBuffer != VK_NULL_HANDLE; }
    ...
    bool canAttemptStencilAttachment() const override {
        return !this->isForSecondaryCommandBuffer();
    }
