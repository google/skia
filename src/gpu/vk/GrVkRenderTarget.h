...
private:
    ...
    // When we wrap a secondary command buffer, we will record GrManagedResources onto it which need to
    ...
    // SkGpuDevice on the GrVkSecondaryCBDrawContext, we assure that the GrManagedResources held by the
