...
public:
    ...
    bool avoidClearAttachmentsInPrimaryCommandBuffer() const {
        return fAvoidClearAttachmentsInPrimaryCommandBuffer;
    }
...
private:
    ...
    bool fAvoidClearAttachmentsInPrimaryCommandBuffer = false;
