...
GrVkPipelineState* GrVkResourceProvider::PipelineStateCache::findOrCreatePipelineState1(
    ...
    return this->findOrCreatePipeline2(renderTarget, desc, programInfo, compatibleRenderPass);
}

GrVkPipelineState* GrVkResourceProvider::PipelineStateCache::findOrCreatePipeline2(
        GrRenderTarget* renderTarget,
