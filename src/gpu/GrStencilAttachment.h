...
public:
    ...
    static void ComputeSharedStencilAttachmentKey(const SkISize& dimensions, int sampleCnt,
                                                  GrUniqueKey* key);

protected:
    GrStencilAttachment(GrGpu* gpu, const SkISize& dimensions, int bits, int sampleCnt,
