...
void GrNXTBuffer::onMap() {
    ...
    fStagingBuffer = getNXTGpu()->getStagingBuffer(sizeInBytes(), nxt::BufferUsageBit::TransferSrc);
...
void GrNXTBuffer::onUnmap() {
    ...
    getNXTGpu()->getCopyBuilder()
        .TransitionBufferUsage(fStagingBuffer->fBuffer, nxt::BufferUsageBit::TransferSrc)
        .TransitionBufferUsage(fBuffer, nxt::BufferUsageBit::TransferDst)
