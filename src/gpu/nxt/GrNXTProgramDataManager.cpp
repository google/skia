...
void GrNXTProgramDataManager::uploadUniformBuffers(GrNXTGpu* gpu,
                                                   ...
                                                   GrNXTRingBuffer::Slice fragmentBuffer,
    ...
    if (geom && fGeometryUniformsDirty) {
        ...
        copyBuilder
            .TransitionBufferUsage(stagingBuffer->fBuffer, nxt::BufferUsageBit::TransferSrc)
            .TransitionBufferUsage(geom, nxt::BufferUsageBit::TransferDst)
            .CopyBufferToBuffer(stagingBuffer->fBuffer, 0, geom, geomOffset, fGeometryUniformSize);
        cmdBuilder
            .TransitionBufferUsage(geom, nxt::BufferUsageBit::Uniform);
    }
    if (frag && fFragmentUniformsDirty) {
        ...
        copyBuilder
            .TransitionBufferUsage(stagingBuffer->fBuffer, nxt::BufferUsageBit::TransferSrc)
            .TransitionBufferUsage(frag, nxt::BufferUsageBit::TransferDst)
            .CopyBufferToBuffer(stagingBuffer->fBuffer, 0, frag, fragOffset, fFragmentUniformSize);
        cmdBuilder
            .TransitionBufferUsage(frag, nxt::BufferUsageBit::Uniform);
    }
}
