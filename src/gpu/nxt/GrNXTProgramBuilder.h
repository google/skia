...
struct GrNXTProgram : public SkRefCnt {
    ...
    nxt::ShaderModule fVSModule;
    nxt::ShaderModule fFSModule;
    std::unique_ptr<GrGLSLPrimitiveProcessor> fGeometryProcessor;
    std::unique_ptr<GrGLSLXferProcessor> fXferProcessor;
    GrGLSLFragProcs fFragmentProcessors;
    nxt::Buffer fGeometryUniformBuffer;
    nxt::Buffer fFragmentUniformBuffer;
    nxt::PipelineLayout fPipelineLayout;
    nxt::BindGroup fUniformBindGroup;
    nxt::BlendState fBlendState;
