...
static void callback(nxtBufferMapAsyncStatus status, const void* data, dawn::CallbackUserdata userdata) {
...
bool GrNXTGpu::onReadPixels(GrSurface* surface,
    ...
    dawn::Buffer buf = device().CreateBufferBuilder()
        .SetAllowedUsage(dawn::BufferUsageBit::TransferDst | dawn::BufferUsageBit::MapRead)
        .SetSize(sizeInBytes)
        .GetResult();
    ...
    buf.MapReadAsync(0, sizeInBytes, callback, reinterpret_cast<dawn::CallbackUserdata>(this));
