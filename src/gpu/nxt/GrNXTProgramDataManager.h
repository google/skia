...
#ifndef GrNXTProgramDataManager_DEFINED
#define GrNXTProgramDataManager_DEFINED

#include "glsl/GrGLSLProgramDataManager.h"
#include "GrNXTUniformHandler.h"
#include "nxt/nxtcpp.h"

#include "SkAutoMalloc.h"

class GrNXTGpu;
class GrNXTUniformBuffer;

class GrNXTProgramDataManager : public GrGLSLProgramDataManager {
public:
    typedef GrNXTUniformHandler::UniformInfoArray UniformInfoArray;

    GrNXTProgramDataManager(const UniformInfoArray&,
    ...
    void setPathFragmentInputTransform(VaryingHandle u, int components,
        ...
        SK_ABORT("Only supported in NVPR, which is not in NXT");
    }

    void uploadUniformBuffers(nxt::Buffer geometryBuffer, nxt::Buffer fragmentBuffer) const;
