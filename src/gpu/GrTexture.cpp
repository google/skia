...
void GrTexturePriv::ComputeScratchKey(GrPixelConfig config, int width, int height,
                                      GrSurfaceOrigin origin, bool isRenderTarget,
                                      int sampleCnt, bool isMipMapped,
                                      GrScratchKey* key) {
...
void GrTexturePriv::ComputeScratchKey(const GrSurfaceDesc& desc, GrScratchKey* key) {
    ...
    return ComputeScratchKey(desc.fConfig, desc.fWidth, desc.fHeight, origin, SkToBool(desc.fFlags & kRenderTarget_GrSurfaceFlag), desc.fSampleCnt, desc.fIsMipMapped, key);
}
