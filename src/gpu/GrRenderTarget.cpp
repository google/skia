...
GrRenderTarget::GrRenderTarget(GrGpu* gpu, const GrSurfaceDesc& desc, GrRenderTargetProxy::Flags flags,
    ...
    SkASSERT(!(fFlags & GrRenderTargetProxy::Flags::kMixedSampled) || fSampleCnt > 0);
    SkASSERT(!(fFlags & GrRenderTargetProxy::Flags::kWindowRectsSupport) || gpu->caps()->maxWindowRectangles() > 0);
