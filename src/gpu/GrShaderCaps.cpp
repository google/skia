...
void GrShaderCaps::initSamplerPrecisionTable() {
    ...
    for (int visibility = 0; visibility < (1 << kGrShaderTypeCount); ++visibility) {
        ...
        table[kPriv_Alpha_8_as_Alpha_GrPixelConfig] = lowp;
        table[kPriv_Alpha_8_as_Red_GrPixelConfig] = lowp;
        ...
        table[kPriv_Alpha_half_as_Alpha_GrPixelConfig] = mediump;
        table[kPriv_Alpha_half_as_Red_GrPixelConfig] = mediump;
