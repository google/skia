...
private:
    GrBackendTextureImageGenerator(const SkImageInfo& info,
                                   GrTexture*,
                                   GrSurfaceOrigin,
                                   GrDirectContextPriv::DirectContextID owningContextID,
                                   uint32_t familyID,
    ...
    public:
        ...
        GrDirectContextPriv::DirectContextID fOwningContextID;
        uint32_t                             fFamilyID;
        ...
        GrDirectContextPriv::DirectContextID fBorrowingContextID;
