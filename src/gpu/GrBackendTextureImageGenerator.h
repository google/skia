...
private:
    GrBackendTextureImageGenerator(const SkImageInfo& info,
                                   GrTexture*,
                                   GrSurfaceOrigin,
                                   GrDirectContextPriv::ExplicitContextID owningContextID,
                                   uint32_t familyID,
    ...
    public:
        ...
        GrDirectContextPriv::ExplicitContextID fOwningContextID;
        uint32_t                               fFamilyID;
        ...
        GrDirectContextPriv::ExplicitContextID fBorrowingContextID;
