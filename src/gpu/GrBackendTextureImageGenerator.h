...
public:
    static std::unique_ptr<SkImageGenerator> Make(GrContext*, sk_sp<GrTextureProxy>,
                                                  sk_sp<GrSemaphore>, SkAlphaType,
                                                  sk_sp<SkColorSpace>);
...
private:
    GrBackendTextureImageGenerator(const SkImageInfo& info, sk_sp<GrTextureProxy>,
