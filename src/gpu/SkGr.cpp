...
static inline bool skpaint_to_grpaint_impl(GrContext* context,
    ...
    if (shaderFP) {
        if (primColorMode) {
            ...
            shaderFP = GrXfermodeFragmentProcessor::MakeFromSrcProcessor1(std::move(shaderFP),
                                                                         *primColorMode);
        ...
        if (primColorMode) {
            ...
            processor = GrXfermodeFragmentProcessor::MakeFromSrcProcessor1(std::move(processor),
                                                                          *primColorMode);
            if (processor) {
