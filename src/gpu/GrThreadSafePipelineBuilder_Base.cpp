...
using Stats = GrThreadSafePipelineBuilder_Base::Stats;
...
void GrThreadSafePipelineBuilder_Base::Stats::dump(SkString* out) {
...
void GrThreadSafePipelineBuilder_Base::Stats::dumpKeyValuePairs(SkTArray<SkString>* keys,
