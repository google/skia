...
public:
     ...
     * upsampling. The "absClose" entry point absolutely, positively clears its given
     * (device-space) rect - ignoring clipping and never discarding/culling the operation.
     */
