...
public:
    ...
    public:
        ...
        int numScratchTexturesReused1() const { return fNumScratchTexturesReused1; }
        void incNumScratchTexturesReused1() { ++fNumScratchTexturesReused1; }
        ...
        int numInlineProgramCacheResult(ProgramCacheResult stat) {
        ...
        int numPreProgramCacheResult(ProgramCacheResult stat) {
    ...
    private:
        ...
        int fNumScratchTexturesReused1 = 0;
