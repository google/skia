...
public:
     ...
     *
     * Note: if more than one pixmap is provided they must all share the same SkColorType.
     */
    GrBackendTexture createBackendTexture1(int w, int h, const GrBackendFormat& format,
