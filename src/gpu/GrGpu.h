...
public:
     ...
     */
    bool getReadPixelsInfo(GrSurface* srcSurface, GrSurfaceOrigin srcOrigin, int readWidth,
                           int readHeight, size_t rowBytes, GrPixelConfig dstConfig,
    ...
    bool getWritePixelsInfo(GrSurface* dstSurface, GrSurfaceOrigin dstOrigin, int width, int height,
                            GrPixelConfig srcConfig, GrSRGBConversion, DrawPreference*,
