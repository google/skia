...
public:
    ...
    static bool IsACopyNeededForTextureParams1(const GrCaps&, int width, int height,
    ...
    static bool IsACopyNeededForTextureParams(const GrCaps& caps,GrTextureProxy* proxy,
