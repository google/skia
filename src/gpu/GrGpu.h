...
public:
    ...
    bool validateBackendTexture(GrBackendTexture* tex, SkColorType ct, SkAlphaType at,
...
private:
    ...
    virtual bool onValidateBackendTexture(GrBackendTexture* tex, SkColorType ct,
