...
public:
     ...
     *
     * If data represents pixmaps then it must have a complete MIP hierarchy of pixmaps and they
     * must be sized correctly according to the MIP sizes implied by dimensions. They must all
     * have the same color type and that color type must be compatible with the texture format.
     */
