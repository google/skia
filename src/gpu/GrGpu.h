...
public:
    ...
    std::unique_ptr<GrGpuRTCommandBuffer> getCommandBuffer(
        ...
        return this->createCommandBuffer1(rt, origin, colorInfo, stencilInfo);
    }
    ...
    // Retur a GrGpuTextureCommandBuffer which GrOpLists send texture commands to instead of
    ...
    std::unique_ptr<GrGpuTextureCommandBuffer> getCommandBuffer(GrTexture* tex,
        ...
        return this->createCommandBuffer2(tex, origin);
    }
...
private:
    ...
    virtual std::unique_ptr<GrGpuRTCommandBuffer> createCommandBuffer1(
            GrRenderTarget* rt, GrSurfaceOrigin origin,
            const GrGpuRTCommandBuffer::LoadAndStoreInfo& colorInfo,
            const GrGpuRTCommandBuffer::StencilLoadAndStoreInfo& stencilInfo) = 0;

    virtual std::unique_ptr<GrGpuTextureCommandBuffer> createCommandBuffer2(GrTexture*,
                                                                           GrSurfaceOrigin) = 0;
