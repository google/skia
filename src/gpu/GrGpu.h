...
public:
     ...
     */
    sk_sp<GrTexture> createTexture(const GrSurfaceDesc& desc, GrSurfaceOrigin origin, SkBudgeted budgeted);
...
private:
    ...
    virtual sk_sp<GrTexture> onCreateTexture(const GrSurfaceDesc& desc, GrSurfaceOrigin,
                                             SkBudgeted budgeted,
