...
class GrSurface;
class GrTexture;
class GrThreadSafePipelineBuilder_Base;
class SkJSONWriter;
...
public:
    ...
    virtual GrThreadSafePipelineBuilder_Base* pipelineBuilder() = 0; //{ return nullptr; }
    virtual sk_sp<GrThreadSafePipelineBuilder_Base> refPipelineBuilder() = 0; //{ return nullptr; }
