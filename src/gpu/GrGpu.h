...
public:
    ...
    virtual std::unique_ptr<GrStagingBuffer> onCreateStagingBuffer(size_t size) { return nullptr; }
...
protected:
    ...
    std::vector<GrStagingBuffer*>    fReadyStagingBuffers;
    std::vector<GrStagingBuffer*>    fBusyStagingBuffers;
