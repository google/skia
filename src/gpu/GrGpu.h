...
public:
    ...
    // inserted semaphores. This returns false if semaphores were requested, but we don't have
    // semaphore support.
    bool finishFlush(int numSemaphores, GrBackendSemaphore* backendSemaphores);
