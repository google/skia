...
GrXferProcessor::OptFlags GrXferProcessor::getOptimizations(const GrProcessorSet::FragmentProcessorAnalysis& analysis,
...
bool GrXPFactory::WillReadDst(const GrXPFactory* factory, const GrProcessorSet::FragmentProcessorAnalysis& analysis) {
    if (factory) {
