...
void GrDrawingManager::newTransferFrom(sk_sp<GrSurfaceProxy> srcProxy,
    ...
    sk_sp<GrRenderTask> task = GrTransferFromRenderTask::Make(srcProxy, srcRect, surfaceColorType,
    ...
    // Comment about needing base layer
