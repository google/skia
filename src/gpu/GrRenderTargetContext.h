...
public:
    ...
    /** Draws a set of textures with a shared filter, color/transform, view matrix, and colorspace
     * xform. The textures must all have the same GrTextureType and GrConfig. */
