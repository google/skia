...
private:
    ...
    // These perform processing specific to Gr[Mesh]DrawOp-derived ops before recording them into the
    // op list. They return the id of the opList to which the op was added, or 0, if it was
