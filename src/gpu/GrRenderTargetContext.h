...
public:
    static std::unique_ptr<GrRenderTargetContext> Make(
            GrRecordingContext*, GrColorType, sk_sp<SkColorSpace>, sk_sp<GrRenderTargetProxy>,
    ...
    // channel as the passed in GrColorType. It may also swizzle the changes (e.g., RGBA -> RGBA).
