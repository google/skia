...
bool GrSoftwarePathRenderer::onDrawPath(const DrawPathArgs& args) {
    ...
    if (useCache) {
        ...
        GrUniqueKey::Builder builder(&maskKey, kDomain, 4 + args.fShape->unstyledKeySize(), "SW Path Mask");
#else
        ...
        GrUniqueKey::Builder builder(&maskKey, kDomain, 5 + args.fShape->unstyledKeySize(), "SW Path Mask");
#endif
