...
public:
    ...
    virtual SurfaceFillContext_Base* asFillContext() { return nullptr; }
     ...
     * conversions.
     */
    std::unique_ptr<SurfaceFillContext_Base> rescale(const GrImageInfo& info,
                                                GrSurfaceOrigin,
                                                SkIRect srcRect,
     ...
     */
    bool rescaleInto(SurfaceFillContext_Base* dst,
                     SkIRect dstRect,
                     SkIRect srcRect,
                     SkImage::RescaleGamma,
                     SkImage::RescaleMode);
