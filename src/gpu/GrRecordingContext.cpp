...
sk_sp<SkFooDevice> GrRecordingContext::foo1() {
//    return SkGpuDevice::Make(this, std::move(rtc), SkGpuDevice::kUninit_InitContents));
    return nullptr;
}

sk_sp<SkFooDevice> GrRecordingContext::foo2(const SkSurfaceCharacterization& c,
                                            SkBudgeted budgeted) {
...
sk_sp<SkFooDevice> GrRecordingContext::foo3(SkBudgeted budgeted,
