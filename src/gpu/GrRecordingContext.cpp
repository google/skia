...
void GrRecordingContext::abandonContext() {
    ...
    // This assumes that all the contexts are essentially abandon at the same time. It's not the
    // case that one recording context is abandon, while another keeps functioning while sharing
    // the cache.
