...
// Purge unlocked resources. If 'scratchResourcesOnly' is true the purgeable resources containing
// persistent data are spared. If it false then all purgeable resources will be deleted.
void GrResourceCache::purgeAllUnlockedResources(bool scratchResourcesOnly) {
