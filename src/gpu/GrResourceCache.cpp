...
void GrResourceCache::abandonAll() {
    ...
    while (fNonpurgeableResources.count()) {
        ...
        // If these resources we're relying on a purgeable notification to release something, notify them now. They
        // aren't in the purgeable queue but they're getting purged anyway.
