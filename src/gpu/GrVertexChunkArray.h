...
//
// We only preallocate 1 chunk because if the array needs to grow, then we're also allocating brand
// new GPU buffers anyway.
...
private:
    ...
    const size_t fMinVerticesPerChunk;
