...
private:
    PremulInputFragmentProcessor()
            : INHERITED(kPremulInputFragmentProcessor_ClassID, kPreservesOpaqueInput_OptimizationFlag |
...
private:
    UnpremulInputFragmentProcessor()
            : INHERITED(kUnpremulInputFragmentProcessor_ClassID, kPreservesOpaqueInput_OptimizationFlag |
                        kConstantOutputForConstantInput_OptimizationFlag) {
    }
...
std::unique_ptr<GrFragmentProcessor> GrFragmentProcessor::OverrideInput(
    ...
    private:
        ...
        ReplaceInputFragmentProcessor(std::unique_ptr<GrFragmentProcessor> child, GrColor4f color)
                : INHERITED(kReplaceInputFragmentProcessor_ClassID, OptFlags(child.get(), color)), fColor(color) {
