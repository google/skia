...
sk_sp<GrFragmentProcessor> GrFragmentProcessor::MulOutputByInputAlpha1(
    sk_sp<GrFragmentProcessor> fp) {
    if (!fp) {
        return nullptr;
    }
    return GrXfermodeFragmentProcessor::MakeFromDstProcessor1(std::move(fp), SkBlendMode::kDstIn);
}
...
sk_sp<GrFragmentProcessor> GrFragmentProcessor::SwizzleOutput1(sk_sp<GrFragmentProcessor> fp,
...
sk_sp<GrFragmentProcessor> GrFragmentProcessor::MakeInputPremulAndMulByOutput1(
        sk_sp<GrFragmentProcessor> fp) {
...
sk_sp<GrFragmentProcessor> GrFragmentProcessor::OverrideInput(sk_sp<GrFragmentProcessor> fp,
    ...
    public:
        static sk_sp<GrFragmentProcessor> Make(sk_sp<GrFragmentProcessor> child, GrColor4f color) {
            return sk_sp<GrFragmentProcessor>(new ReplaceInputFragmentProcessor(std::move(child), color));
        }
