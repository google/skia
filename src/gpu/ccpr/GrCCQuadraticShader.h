...
protected:
    ...
    void onEmitFragmentCode(GrGLSLFragmentBuilder*, const char* outputCoverage) const final;
    virtual void emitCoverage(GrGLSLFragmentBuilder*, const char* outputCoverage) const = 0;
...
class GrCCQuadraticHullShader : public GrCCQuadraticShader {
    ...
    void emitCoverage(GrGLSLFragmentBuilder*, const char* outputCoverage) const override;
