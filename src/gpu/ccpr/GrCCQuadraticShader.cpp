...
void GrCCQuadraticShader::onEmitFragmentCode(GrGLSLFragmentBuilder* f,
...
void GrCCQuadraticHullShader::emitCoverage(GrGLSLFragmentBuilder* f,
                                           const char* outputCoverage) const {
...
void GrCCQuadraticCornerShader::emitCoverage(GrGLSLFragmentBuilder* f,
                                             const char* outputCoverage) const {
