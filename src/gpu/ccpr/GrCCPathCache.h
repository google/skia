...
public:
    ...
    // here to see they have already placed the path previously during the same flush. The caller is
    // required to reset all currFlushAtlas references back to null before any subsequent flush.
