...
public:
    // Defines a single triangle or closed quadratic curve segment, with transposed x,y coordinates.
    ...
    // Defines a single closed cubic curve segment, with transposed x,y coordinates.
    ...
    // coordinates in the desired primitives' final atlas-space position.
    //
