...
public:
    ...
    static inline const char* RenderPassName(RenderPass pass) {
        switch (pass) {
            ...
            case RenderPass::kTriangleHulls: return "RenderPass_kTriangleHulls";
            case RenderPass::kTriangleEdges: return "RenderPass_kTriangleEdges";
            case RenderPass::kTriangleCorners: return "RenderPass_kTriangleCorners";
            case RenderPass::kQuadraticHulls: return "RenderPass_kQuadraticHulls";
            case RenderPass::kQuadraticCorners: return "RenderPass_kQuadraticCorners";
            case RenderPass::kCubicHulls: return "RenderPass_kCubicHulls";
            case RenderPass::kCubicCorners: return "RenderPass_kCubicCorners";
        }
    }
