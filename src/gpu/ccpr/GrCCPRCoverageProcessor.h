...
protected:
    ...
    // Defines an equation ("dot(float3(pt, 1), distance_equation)") that is -1 on the outside border
    ...
    // Defines a global float2 array that contains MSAA sample locations as offsets from pixel center.
