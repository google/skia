...
public:
    ...
    static constexpr int kNumInstanceAttribs = 1 + (int)InstanceAttribs::kY;
    ...
    static constexpr int RenderPassNumInputPoints(RenderPass pass) {
        return RenderPassIsCubic(pass) ? 4 : 3;
    }
