...
public:
    ...
    public:
        ...
        // is required to provide a 4-point hull around which the Impl will generate its geometry.
        // If its value is left unchanged, the Impl will use the regular input points.
