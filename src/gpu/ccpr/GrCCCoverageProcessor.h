...
public:
    // Defines a single primitive with 3 input points (i.e. Triangles and Quadratics).
    ...
    // Defines a single primitive with 4 input points, or 3 input points plus a W parameter
    // duplicated in both 4th components (i.e. Cubics or Triangles with a custom winding).
    // X,Y point values are transposed.
    ...
    enum class WindMethod : bool {
        ...
        kInstanceData // Instance data contains custom signed wind values of any magnitude.
