    ...
    switch (stroke.getStyle()) {
        ...
        case SkStrokeRec::kHairline_Style: {
            ...
            if (inflationRadius > kMaxBoundsInflationFromStroke) {
                // Let extremely wide strokes be converted to paths and drawn by the CCPR filler.
                return CanDrawPath::kNo;
            }
...
float GrCoverageCountingPathRenderer::GetStrokeDevWidth(const SkMatrix m, const SkStrokeRec& stroke,
                                                        float* inflationRadius) {
