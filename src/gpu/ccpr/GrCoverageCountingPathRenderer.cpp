...
sk_sp<GrCoverageCountingPathRenderer> GrCoverageCountingPathRenderer::CreateIfSupported(
                                                                               const GrCaps& caps) {
    return IsSupported(caps) ?
           sk_sp<GrCoverageCountingPathRenderer>(new GrCoverageCountingPathRenderer) : nullptr;
}
...
GrCoverageCountingPathRenderer::DrawPathsOp::DrawPathsOp(GrCoverageCountingPathRenderer* ccpr,
    ...
    // (This is nontrivial due do assumptions in generating the octagon cover geometry.)
