...
static SkISize choose_initial_atlas_size(const GrCCAtlas::Specs& specs) {
    ...
    width = std::clamp(width, specs.fMinTextureSize, specs.fMaxPreferredTextureSize);
    height = std::clamp(height, specs.fMinTextureSize, specs.fMaxPreferredTextureSize);
