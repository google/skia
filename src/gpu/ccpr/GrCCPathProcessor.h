...
public:
    ...
    enum class Flags {
        kNone = 0,
        kResolveCoverageCount = (1 << 0),
        kResolveStencilCoverageInPlace = (1 << 1),
    };

    GrCCPathProcessor(Flags, const GrTexture* atlasTexture, const GrSwizzle&,
...
private:
    ...
    class DrawPathToMainCanvasImpl;
