...
private:
    ...
    static constexpr Attribute kInstanceAttribs[kNumInstanceAttribs] = {
            {"devbounds", kFloat4_GrVertexAttribType, kFloat4_GrVertexAttribType},
            {"devbounds45", kFloat4_GrVertexAttribType, kFloat4_GrVertexAttribType},
            {"dev_to_atlas_offset", kInt2_GrVertexAttribType, kInt2_GrVertexAttribType},
