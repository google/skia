...
public:
    ...
    struct Instance {
        ...
        void set(const SkRect& devBounds, const SkRect& devBounds45, const SkIVector& atlasOffset,
                 uint32_t color, DoEvenOddFill = DoEvenOddFill::kNo);
        void set(const GrCCPathCacheEntry&, const SkIVector& shift, uint32_t color,
...
inline void GrCCPathProcessor::Instance::set(const SkRect& devBounds, const SkRect& devBounds45,
                                             const SkIVector& atlasOffset, uint32_t color,
