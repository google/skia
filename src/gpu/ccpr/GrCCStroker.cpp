...
private:
    ...
    static constexpr Attribute kInstanceAttribs[2] = {
            {"endpts", kFloat4_GrVertexAttribType, kFloat4_GrVertexAttribType},
            {"stroke_radius", kFloat_GrVertexAttribType, kFloat_GrVertexAttribType}
    };
...
private:
    ...
    static constexpr Attribute kInstanceAttribs[3] = {
            {"X", kFloat4_GrVertexAttribType, kFloat4_GrVertexAttribType},
            {"Y", kFloat4_GrVertexAttribType, kFloat4_GrVertexAttribType},
            {"stroke_info", kFloat2_GrVertexAttribType, kFloat2_GrVertexAttribType}
    };
