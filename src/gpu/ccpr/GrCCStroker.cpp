...
private:
    ...
    const Attribute& onVertexAttribute(int i) const override {
        ...
        SK_ABORT("LinearStrokeProcessor does not have vertex attributes.");
        return kBogus;
    }
...
private:
    ...
    const Attribute& onVertexAttribute(int i) const override {
        static constexpr Attribute kBogus;
        SK_ABORT("CubicStrokeProcessor does not have vertex attributes.");
        return kBogus;
    }
...
public:
    ...
    void appendJoin(Verb joinType, const SkPoint& center, const SkVector& leftNorm,
        ...
        // Joins are coverage-counted, self-intersecting quadrilaterals that tie the four corners of
        // two adjoining strokes together a like a shoelace. Coverage is negative on the inside
        // half. We implement this geometry with a pair of triangles.
        ...
        if (miterCapHeightOverWidth < 0) {
            Sk2f tmp = n0;
            n0 = -n1;
            n1 = -tmp;
            miterCapHeightOverWidth = -miterCapHeightOverWidth;
        }
