...
public:
    ...
    void onExecute(GrOpFlushState* flushState, const SkRect& chainBounds) override {
        ...
        GrCCPathProcessor resolveProc(GrCCPathProcessor::Flags::kResolveStencilCoverageInPlace,
                                      nullptr, kTopLeft_GrSurfaceOrigin);
        ...
        GrPipeline resolvePipeline(
                GrScissorTest::kEnabled, SkBlendMode::kSrc, noHWAA,  stencilResolveSettings);
