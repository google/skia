...
constexpr GrPrimitiveProcessor::Attribute GrCCPathProcessor::kInstancedAttribs[];
...
GrCCPathProcessor::GrCCPathProcessor(GrResourceProvider* resourceProvider,
    ...
    this->setInstanceAttributeInfo(kNumInstanceAttribs, kInstancedAttribs[kNumInstanceAttribs-1].nextOffsetInRecord());
    GR_STATIC_ASSERT(kInstancedAttribs[kNumInstanceAttribs-1].nextOffsetInRecord() == sizeof(Instance));
