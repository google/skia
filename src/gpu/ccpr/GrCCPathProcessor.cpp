...
GrCCPathProcessor::GrCCPathProcessor(GrResourceProvider* resourceProvider,
    ...
    this->setInstanceAttributeInfo(kNumInstanceAttribs,
                                   kInstanceAttribs[kNumInstanceAttribs - 1].nextOffsetInRecord());
    GR_STATIC_ASSERT(kInstanceAttribs[kNumInstanceAttribs - 1].nextOffsetInRecord() ==
                     sizeof(Instance));
