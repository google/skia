...
public:
    ...
    public:
        ...
        const SingleDraw* head() const {
            SkASSERT(fInstanceCount_debugOnly >= 1);
            return &fHeadDraw;
        }

#ifdef SK_DEBUG
        int numSkippedInstances_debugOnly() const { return fNumSkippedInstances_debugOnly; }
#endif
    ...
    private:
        ...
        int fBaseInstance;
        SkDEBUGCODE(int fInstanceCount_debugOnly;)
        SkDEBUGCODE(int fNumSkippedInstances_debugOnly;)
