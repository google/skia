...
public:
    ...
    // Maximum inflation to path bounds due to stroking that we support (from width, miter, caps).
    // Strokes wider than this will be converted to fill paths and drawn by the CCPR filler instead.
