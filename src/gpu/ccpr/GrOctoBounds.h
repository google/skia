...
public:
    ...
    void setLTRB(float l, float t, float r, float b, float l45, float t45, float r45, float b45) {
...
#ifdef SK_DEBUG
    void assertBoundsAreTight() {
        validateBoundsAreTight([](bool test) { SkASSERT(test); });
    }
    void validateBoundsAreTight(const std::function<void(bool)>& validateFn);
#endif
