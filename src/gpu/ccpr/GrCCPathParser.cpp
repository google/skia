...
void GrCCPathParser::drawPrimitives(GrOpFlushState* flushState, const GrPipeline& pipeline,
    ...
    if (!fMeshesScratchBuffer.empty()) {
        ...
        dynamicState.fScissorRects = fScissorRectScratchBuffer.begin();
        proc.draw(flushState, pipeline, dynamicState, fMeshesScratchBuffer.begin(),
