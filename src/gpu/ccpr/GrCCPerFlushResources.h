...
struct GrCCPerFlushResourceSpecs {
    ...
    bool isEmpty() const {
        return 0 == fNumCachedPaths + fNumCopiedPaths[0] + fNumCopiedPaths[1] +
                    fNumRenderedPaths[0] + fNumRenderedPaths[1] + fNumClipPaths;
    }
...
public:
    ...
    //
    // strokeDevWidth must be 0 for fills, 1 for hairlines, or the stroke width in pixels for
    // non-hairline strokes (implicitly requiring a rigid-body transform).
