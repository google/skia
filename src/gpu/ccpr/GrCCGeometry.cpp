...
void GrCCGeometry::quadraticTo(const SkPoint& devP1, const SkPoint& devP2) {
    SkASSERT(fBuildingContour);
    Sk2f p0 = Sk2f::Load(&fPoints.back());
...
void GrCCGeometry::cubicTo(const SkPoint& devP1, const SkPoint& devP2, const SkPoint& devP3,
    ...
    SkPoint devPts[4] = {fPoints.back(), devP1, devP2, devP3};
    double tt[2], ss[2];
