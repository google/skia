...
void GrCCCubicShader::onEmitFragmentCode(GrGLSLFragmentBuilder* f,
...
void GrCCCubicHullShader::emitCoverage(GrGLSLFragmentBuilder* f,
                                       const char* outputCoverage) const {
...
void GrCCCubicCornerShader::emitCoverage(GrGLSLFragmentBuilder* f,
                                         const char* outputCoverage) const {
