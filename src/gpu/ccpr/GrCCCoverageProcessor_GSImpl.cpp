...
protected:
    ...
    void onEmitCode(EmitArgs& args, GrGPArgs* gpArgs) final {
        ...
        gpArgs->fPositionVar.set(GrVertexAttribTypeToSLType(proc.fVertexAttribute.type()),
...
void GrCCCoverageProcessor::initGS() {
    ...
    if (4 == this->numInputPoints() || this->hasInputWeight()) {
        fVertexAttribute = {"x_or_y_values", kFloat4_GrVertexAttribType, 0};
        //GR_STATIC_ASSERT(sizeof(QuadPointInstance) == 2 * GrVertexAttribTypeSize(kFloat4_GrVertexAttribType));
        //GR_STATIC_ASSERT(offsetof(QuadPointInstance, fY) == GrVertexAttribTypeSize(kFloat4_GrVertexAttribType));
        this->setVertexAttributeInfo(1, GrVertexAttribTypeSize(kFloat4_GrVertexAttribType));
    } else {
        fVertexAttribute = {"x_or_y_values", kFloat3_GrVertexAttribType, 0};
        //GR_STATIC_ASSERT(sizeof(TriPointInstance) == 2 * GrVertexAttribTypeSize(kFloat3_GrVertexAttribType));
        //GR_STATIC_ASSERT(offsetof(TriPointInstance, fY) == GrVertexAttribTypeSize(kFloat3_GrVertexAttribType));
        this->setVertexAttributeInfo(1, GrVertexAttribTypeSize(kFloat3_GrVertexAttribType));
    }
