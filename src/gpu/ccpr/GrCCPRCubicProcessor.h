 ...
 *
 * Pass 1: Draw the bezier quadrilateral, inset by 1/2 pixel all around, and use the gradient-based
 *         AA technique outlined in the Loop/Blinn paper to compute coverage.
 *
