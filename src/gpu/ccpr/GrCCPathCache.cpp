...
static inline bool operator==(const GrCCPathCache::HashKey& k1, const GrCCPathCache::HashKey& k2) {
    return k1.fData[0] == k2.fData[0] && !memcmp(&k1.fData[1], &k2.fData[1], k1.fData[0]);
}
