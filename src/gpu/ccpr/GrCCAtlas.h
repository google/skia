...
public:
    ...
    using CCAtlasList = GrTAllocator<GrCCAtlas, 4>;
    ...
    CCAtlasList::Iter atlases() { return fAtlases.items(); }
    CCAtlasList::CIter atlases() const { return fAtlases.items(); }
