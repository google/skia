...
// GrSurfaceFillContext with the first call to get an arena. Each GrOpsTask takes a ref on it to
// keep the arenas alive. When the first GrOpsTask's onExecute() is completed, the arena ref on
// the GrSurfaceFillContext is nulled out so that any new GrOpsTasks will create and ref a new
// set of arenas.
