...
bool GrConvertPixels(const GrPixelInfo& dstInfo, void* dst, const GrPixelInfo& srcInfo,
    ...
    bool alphaOrCSConversion = (srcInfo.fColorInfo.fAlphaType != dstInfo.fColorInfo.fAlphaType &&
                                srcInfo.fColorInfo.fAlphaType != kOpaque_SkAlphaType) ||
                               !SkColorSpace::Equals(srcInfo.fColorInfo.fColorSpace,
                                                     dstInfo.fColorInfo.fColorSpace);
    ...
    if (alphaOrCSConversion) {
        ...
        dstIsNormalized && dstInfo.fColorInfo.fAlphaType == kPremul_SkAlphaType;
    } else {
