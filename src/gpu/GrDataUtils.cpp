...
bool GrFillBufferWithColor(GrPixelConfig config, int width, int height,
    ...
    switch (config) {
        ...
        case kSRGBA_8888_GrPixelConfig: {
            ...
            GrColor srgbColor = color;

            sk_memset32((uint32_t *) dest, srgbColor, width * height);
            break;
        }
        case kSBGRA_8888_GrPixelConfig: {
            // TODO: ask Brian O. what to do here
            GrColor swizzledSRGBColor = GrColorPackRGBA(b, g, r, a);

            sk_memset32((uint32_t *) dest, swizzledSRGBColor, width * height);
            break;
        }
        ...
        case kRGBA_half_Clamped_GrPixelConfig: {
            ...
            uint64_t rgbaHalf = (rHalf << 48) | (gHalf << 32) | (bHalf << 16) | aHalf;
