...
std::unique_ptr<GrRenderTargetContext> GrSurfaceContext::rescale(const GrImageInfo& info,
    ...
    auto rtc = GrRenderTargetContext::MakeWithFallback(fContext,
                                                       info.colorType(),
                                                       info.refColorSpace(),
                                                       SkBackingFit::kExact,
                                                       info.dimensions(),
...
bool GrSurfaceContext::rescaleInto(GrRenderTargetContext* dst,
                                   SkIRect dstRect,
                                   SkIRect srcRect,
                                   RescaleGamma rescaleGamma,
                                   SkFilterQuality rescaleQuality) {
    ...
    while (srcRect.size() != finalSize) {
        ...
        GrRenderTargetContext* tempBPtr;
        SkIRect tempRect;
        if (nextDims == finalSize) {
            ...
            tempB = GrRenderTargetContext::MakeWithFallback(fContext,
