...
#ifndef GrPerFlushResourceProvider_DEFINED
#define GrPerFlushResourceProvider_DEFINED
...
public:
     ...
     * atlas.
     */
    virtual sk_sp<GrRenderTargetOpList> preFlush(GrPerFlushResourceProvider*,
                                                 const SkTDArray<GrOpList*>&) = 0;
