...
void GrAtlasTextContext::drawTextBlob(GrContext* context, GrTextUtils::Target* target,
    ...
    cacheBlob->flushCached(context, target, blob, props, fDistanceAdjustTable.get(), paint, drawFilter,
...
void GrAtlasTextContext::drawPosText(GrContext* context, GrTextUtils::Target* target,
    ...
    // fall back to drawing as a path
    GrTextUtils::DrawPosTextAsPath(context, target, props, clip, paint, viewMatrix, text, byteLength,
