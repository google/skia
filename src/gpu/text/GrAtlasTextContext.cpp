...
std::unique_ptr<GrDrawOp> GrAtlasTextContext::foo_test(GrContext* context,
...
GR_DRAW_OP_TEST_DEFINE(GrAtlasTextOp) {
    ...
    return gTextContext->foo_test(context, gTextContext.get(), rtc.get(), skPaint, text, xInt, yInt);
}
