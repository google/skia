...
public:
    ...
    static void DrawBmpText(GrAtlasTextBlob*, int runIndex,
                            GrAtlasFontCache*, const SkSurfaceProps&,
                            const SkPaint&,
    ...
    static void DrawBmpPosText(GrAtlasTextBlob*, int runIndex,
                               GrAtlasFontCache*, const SkSurfaceProps&, const SkPaint&,
                               GrColor, uint32_t scalerContextFlags, const SkMatrix& viewMatrix,
                               const char text[], size_t byteLength,
...
private:
    ...
    static void BmpAppendGlyph(GrAtlasTextBlob*, int runIndex, GrAtlasFontCache*,
                               GrAtlasTextStrike**, const SkGlyph&, int left, int top,
                               GrColor color, SkGlyphCache*);

    static bool DfAppendGlyph(GrAtlasTextBlob*, int runIndex, GrAtlasFontCache*,
