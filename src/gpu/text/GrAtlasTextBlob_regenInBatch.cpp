...
void GrAtlasTextBlob::regenInOp(GrDrawOp::Target* target, GrAtlasFontCache* fontCache,
...
void GrAtlasTextBlob::regenInBatch(GrDrawOp::Target* target,
    ...
    // Because the GrAtlasFontCache may evict the strike a blob depends on using for
