...
Regenerator::Result Regenerator::doRegen(GrAtlasGlyphCache* glyphCache, GrAtlasManager* atlasManager) {
    ...
    if (regenTexCoords) {
        ...
        if (regenGlyphs) {
            strike = glyphCache->getStrike(fLazyCache->get());
        } else {
...
Regenerator::Result Regenerator::regenerate(GrAtlasGlyphCache* glyphCache,
