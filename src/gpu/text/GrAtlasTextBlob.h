...
private:
    ...
    inline void flushRun(GrTextUtils::Target*, const GrClip&, int run,
                         const SkMatrix& viewMatrix, SkScalar x, SkScalar y,
    ...
    void flushRunAsPaths(GrContext* context, GrTextUtils::Target*,
    ...
    inline std::unique_ptr<GrAtlasTextOp> makeOp(const Run::SubRunInfo& info, int glyphCount, int run,
                                            int subRun, const SkMatrix& viewMatrix,
                                            SkScalar x, SkScalar y, const SkIRect& clipRect,
                                            const GrTextUtils::Paint& paint,
                                            const SkSurfaceProps& props,
                                            const GrDistanceFieldAdjustTable* distanceAdjustTable,
                                            GrAtlasGlyphCache* cache, GrTextUtils::Target*);
