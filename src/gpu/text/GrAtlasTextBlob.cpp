...
inline std::unique_ptr<GrAtlasTextOp> GrAtlasTextBlob::makeOp(
    ...
    if (info.drawAsDistanceFields()) {
        ...
        op = GrAtlasTextOp::MakeBitmap(std::move(grPaint), format, glyphCount, restrictedAtlasManager);
    }
...
void GrAtlasTextBlob::flush(GrRestrictedAtlasManager* restrictedAtlasManager, GrTextUtils::Target* target,
                            const SkSurfaceProps& props,
                            const GrDistanceFieldAdjustTable* distanceAdjustTable,
...
std::unique_ptr<GrDrawOp> GrAtlasTextBlob::test_makeOp(
        ...
        const GrDistanceFieldAdjustTable* distanceAdjustTable, GrRestrictedAtlasManager* restrictedAtlasManager,
