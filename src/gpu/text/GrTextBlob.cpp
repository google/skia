...
static void fill_transformed_vertices_2D(SkZip<Quad, const GrGlyph*, VertexData> toFrom,
                                         SkScalar dstPadding,
                                         SkScalar srcPadding,
    ...
    for (auto[quad, glyph, vertexData] : toFrom) {
        auto[pos, rect] = vertexData;
        auto[l, t, r, b] = rect;
...
template<typename Quad, typename VertexData>
static void fill_transformed_vertices_3D(SkZip<Quad, const GrGlyph*, VertexData> toFrom,
                                         SkScalar dstPadding,
                                         SkScalar srcPadding,
                                         SkScalar strikeToSource,
                                         GrColor color,
