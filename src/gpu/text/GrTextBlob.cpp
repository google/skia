...
GrTextBlob::VertexRegenerator::VertexRegenerator(GrResourceProvider* provider,
                                                 GrTextBlob::SubRun* subRun,
                                                 const SkMatrix& viewMatrix, SkScalar x, SkScalar y,
                                                 GrColor color,
                                                 GrDeferredUploadTarget* target,
                                                 GrStrikeCache* cache, GrAtlasManager* atlas)
        : fResourceProvider(provider)
        , fViewMatrix(viewMatrix)
        , fUploadTarget(target)
        , fGrStrikeCache(cache)
        , fFullAtlasManager(atlas)
        , fSubRun(subRun)
        , fColor(color) {
