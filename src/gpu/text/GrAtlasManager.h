...
public:
    ...
    ShapeData* findO(const GrStyledShape&, int desiredDimension);
    ShapeData* findO(const GrStyledShape&, const SkMatrix& ctm);

    ShapeData* addToCache(const GrStyledShape&, const SkMatrix& ctm,
                          GrDrawOpAtlas::AtlasLocator&, const SkRect& bounds);

    ShapeData* addToCache(const GrStyledShape&,int desiredDimension,
                          GrDrawOpAtlas::AtlasLocator&, const SkRect& bounds);
