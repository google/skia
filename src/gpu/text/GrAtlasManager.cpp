...
GrDrawOpAtlas::ErrorCode GrAtlasManager::addToAtlas1(GrResourceProvider* resourceProvider,
    ...
    return this->getAtlas(format)->addToAtlas1(resourceProvider, id, target, width, height,
                                                image, loc);
}
