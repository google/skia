...
public:
    ...
    sk_sp<GrTextBlob> makeBlob(int glyphCount, int runCount, GrColor color) {
        return GrTextBlob::Make(glyphCount, runCount, color);
    }

    /*
    sk_sp<GrTextBlob> makeBlob(const SkTextBlob* blob, GrColor color) {
        int glyphCount = 0;
        int runCount = 0;
