...
public:
    ...
    virtual void testing_convertToGrGlyph(GrStrikeCache* cache) = 0;
...
public:
    ...
    void covertToGrGlyph(GrStrikeCache* cache);
...
public:
    ...
    void testing_convertToGrGlyph(GrStrikeCache *cache) override;
