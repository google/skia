...
public:
    ...
    bool hasW(SubRunType type) const {
        ...
        } else if (type == kSourceMask || type == kSourcePath) {
    ...
    public:
        ...
        bool drawAsDistanceFields() const { return fType == kSourceSDFT; }
        bool drawAsPaths() const { return fType == kSourcePath; }
        bool needsTransform() const {
            return fType == kSourcePath || fType == kSourceMask || fType == kSourceSDFT;
        }
        bool hasW() const {
