...
private:
    ...
    void processDeviceMasks(const SkZip<SkBag, SkPoint>& drawables,
                            const SkStrikeSpec& strikeSpec) override;

    void processSourcePaths(const SkZip<SkBag, SkPoint>& drawables,
                            const SkStrikeSpec& strikeSpec) override;

    void processDevicePaths(SkSpan<const SkGlyphPos> paths) override;

    void processSourceSDFT(const SkZip<SkBag, SkPoint>& drawables,
    ...
    void processSourceFallback(const SkZip<SkBag, SkPoint>& drawables,
                               const SkStrikeSpec& strikeSpec,
                               bool hasW) override;

    void processDeviceFallback(const SkZip<SkBag, SkPoint>& drawables,
                               const SkStrikeSpec& strikeSpec) override;
