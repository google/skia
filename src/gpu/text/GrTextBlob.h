...
public:
    ...
    // drawMatrix - used to draw with. It has not been shifted by the blob's origin. This makes
    //              filters draw properly.
    // posMatrix  - used to produce glyph vertices and outlines. This includes the origin offset.
