...
public:
    ...
    std::unique_ptr<GrSubRun, SkArena::Destroyer> fNext;
};
...
struct GrSubRunList {
    ...
    void append(std::unique_ptr<GrSubRun, SkArena::Destroyer> subRun) {
        std::unique_ptr<GrSubRun, SkArena::Destroyer>* newTail = &subRun->fNext;
    ...
    std::unique_ptr<GrSubRun, SkArena::Destroyer> fHead{nullptr};
    std::unique_ptr<GrSubRun, SkArena::Destroyer>* fTail{&fHead};
};
...
private:
    ...
    void insertSubRun(std::unique_ptr<GrSubRun, SkArena::Destroyer> subRun);
