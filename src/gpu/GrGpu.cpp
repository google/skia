...
bool GrGpu::finishFlush(int numSemaphores, GrBackendSemaphore* backendSemaphores) {
    ...
    this->onFinishFlush(numSemaphores > 0);
    return (!numSemaphores || this->caps()->fenceSyncSupport());
}
