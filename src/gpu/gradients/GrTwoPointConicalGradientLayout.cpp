...
/**************************************************************************************************
 *** This file was autogenerated from GrTwoPointConicalGradientLayout.fp; do not
 *modify.
 **************************************************************************************************/
...
GrGLSLFragmentProcessor* GrTwoPointConicalGradientLayout::onCreateGLSLInstance()
    const {
...
bool GrTwoPointConicalGradientLayout::onIsEqual(
    const GrFragmentProcessor& other) const {
  const GrTwoPointConicalGradientLayout& that =
      other.cast<GrTwoPointConicalGradientLayout>();
  (void)that;
...
std::unique_ptr<GrFragmentProcessor> GrTwoPointConicalGradientLayout::clone()
    const {
  return std::unique_ptr<GrFragmentProcessor>(
      new GrTwoPointConicalGradientLayout(*this));
}
GR_DEFINE_FRAGMENT_PROCESSOR_TEST(GrTwoPointConicalGradientLayout);
#if GR_TEST_UTILS
std::unique_ptr<GrFragmentProcessor>
GrTwoPointConicalGradientLayout::TestCreate(GrProcessorTestData* d) {
  ...
  // should have high probability to be turned on and off as we're getting
  // random radii and centers.
...
// .fp files do not let you reference outside enum definitions, so we have to
// explicitly map between the two compatible enum defs
...
std::unique_ptr<GrFragmentProcessor> GrTwoPointConicalGradientLayout::Make(
  ...
  // Type-specific calculations: isRadiusIncreasing, focalParams, and the
  // gradient matrix. However, all types start with the total inverse local
  // matrix calculated from the shader and args
  ...
  if (isFocal) {
    ...
    // GPU radial matrix is different from the original matrix, since we map the
    // diff radius to have |dr| = 1, so manually compute the final gradient
    // matrix here.
  ...
  return std::unique_ptr<GrFragmentProcessor>(
      new GrTwoPointConicalGradientLayout(
