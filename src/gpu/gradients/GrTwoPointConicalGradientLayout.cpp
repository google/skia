...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        (void)focalParams;
        fUFocalParamsVar = args.fUniformHandler->addUniform(kFragment_GrShaderFlag, kHalf2_GrSLType,
                                                            kDefault_GrSLPrecision, "uFocalParams");
        ...
        fragBuilder->codeAppendf(
                ...
                args.fUniformHandler->getUniformCStr(fUFocalParamsVar),
                args.fUniformHandler->getUniformCStr(fUFocalParamsVar),
        ...
        fragBuilder->codeAppendf(
                ...
                "(float(x_t) <= 0.0) {\n                    t = -1.0;\n                }\n         "
                "   }\n            break;\n        }\n}\n%s = half4(t);\n",
                (_outer.isWellBehaved() ? "true" : "false"), args.fOutputColor);
    }
...
private:
    void onSetData(const GrGLSLProgramDataManager& pdman,
        ...
        auto focalParams = _outer.focalParams();
        (void)focalParams;
        UniformHandle& uFocalParams = fUFocalParamsVar;
        (void)uFocalParams;
    ...
    SkPoint prevFocalParams = half2(0);
    UniformHandle fUFocalParamsVar;
};
