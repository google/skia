...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        fragBuilder->codeAppendf("half t = %s.x;\n%s = (1.0 - t) * %s + t * %s;\n",
                                 ...
                                 args.fOutputColor, args.fUniformHandler->getUniformCStr(fStartVar),
...
private:
    void onSetData(const GrGLSLProgramDataManager& pdman,
        ...
        {
            const SkRect startValue = _outer.start();
            pdman.set4fv(fStartVar, 1, (float*)&startValue);
            const SkRect endValue = _outer.end();
            pdman.set4fv(fEndVar, 1, (float*)&endValue);
        }
    }
