...
public:
    SkColor4f start() const { return fStart; }
    SkColor4f end() const { return fEnd; }
    static std::unique_ptr<GrFragmentProcessor> Make(SkColor4f start, SkColor4f end) {
...
private:
    GrSingleIntervalGradientColorizer(SkColor4f start, SkColor4f end)
