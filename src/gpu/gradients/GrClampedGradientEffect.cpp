...
class GrGLSLClampedGradientEffect : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    const GrClampedGradientEffect& _outer =
    ...
    fragBuilder->codeAppendf(
        ...
        "%s;\n} else {",
        _child1.c_str(),
        (_outer.childProcessor(_outer.gradLayout_index()).preservesOpaqueInput()
             ? "true"
             : "false"),
 ...
 private:
  void onSetData(const GrGLSLProgramDataManager& pdman,
    ...
    const GrClampedGradientEffect& _outer =
        _proc.cast<GrClampedGradientEffect>();
    {
  ...
  SkPMColor4f fLeftBorderColorPrev = {SK_FloatNaN, SK_FloatNaN, SK_FloatNaN,
                                      SK_FloatNaN};
  SkPMColor4f fRightBorderColorPrev = {SK_FloatNaN, SK_FloatNaN, SK_FloatNaN,
                                       SK_FloatNaN};
...
bool GrClampedGradientEffect::onIsEqual(
...
GrClampedGradientEffect::GrClampedGradientEffect(
    const GrClampedGradientEffect& src)
...
std::unique_ptr<GrFragmentProcessor> GrClampedGradientEffect::clone() const {
  return std::unique_ptr<GrFragmentProcessor>(
      new GrClampedGradientEffect(*this));
}
