...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        Var _mirror(kConst_Modifier, DSLType(kBool_Type), "mirror", Bool(!!(mirror)));
        Declare(_mirror);
        ...
        Var _t_1(kNo_Modifier, DSLType(kHalf_Type), "t_1", _t.x() - 1.0f);
        Var _tiled_t(kNo_Modifier,
                     DSLType(kHalf_Type),
                     "tiled_t",
                     (_t_1 - 2.0f * Floor(_t_1 * 0.5f)) - 1.0f);
        Var _outColor(kNo_Modifier,
                      DSLType(kHalf4_Type),
                      "outColor",
                      SampleChild(0, Float2(Half2(_t.x(), 0.0f))));
        Declare(_t);
