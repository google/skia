...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        Var start(kUniform_Modifier, DSLType(kHalf4_Type), "start");
        startVar = VarUniformHandle(start);
        Var end(kUniform_Modifier, DSLType(kHalf4_Type), "end");
        endVar = VarUniformHandle(end);
        Return(Mix(start, end, Half(sk_SampleCoord().x())));
