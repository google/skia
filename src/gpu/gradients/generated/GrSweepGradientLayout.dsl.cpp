...
public:
    ...
    void emitCode(EmitArgs& args) override {
        [[maybe_unused]] const GrSweepGradientLayout& _outer =
                args.fFp.cast<GrSweepGradientLayout>();
        ...
        Var _angle(kNo_Modifier, DSLType(kHalf_Type), "angle");
        ...
        Declare(_t, ((_angle * 0.15915493667125702f + 0.5f) + _bias) * _scale);
