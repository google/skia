...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        Var bias(kUniform_Modifier, DSLType(kHalf_Type), "bias");
        biasVar = VarUniformHandle(bias);
        Var scale(kUniform_Modifier, DSLType(kHalf_Type), "scale");
        scaleVar = VarUniformHandle(scale);
        Var angle(kNo_Modifier,
                  DSLType(kHalf_Type),
                  "angle",
        ...
        Var t(kNo_Modifier,
              DSLType(kHalf_Type),
              "t",
              ((angle * 0.15915493667125702f + 0.5f) + bias) * scale);
        Declare(angle);
        Declare(t);
        Return(Half4(t, 1.0f, 0.0f, 0.0f));
