...
if (!%s && t.y < 0.0) {
    ...
    %s = %s;
        ...
        SkString _coords1872("float2(half2(t.x, 0))");
        SkString _sample1872 = this->invokeChild(0, args, _coords1872.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
    %s = %s;
}
...
%s = %s;
                ...
                args.fOutputColor, _sample1872.c_str(), (_outer.makePremul ? "true" : "false"),
