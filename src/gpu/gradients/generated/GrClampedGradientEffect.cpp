...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        SkString _sample1100 = this->invokeChild(1, args);
...
if (!%s && t.y < 0.0) {
    ...
    %s = %s;
        ...
        SkString _coords1869("float2(half2(t.x, 0))");
        SkString _sample1869 = this->invokeChild(0, args, _coords1869.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
    %s = %s;
}
...
return %s;
                ...
                args.fOutputColor, _sample1869.c_str(), (_outer.makePremul ? "true" : "false"),
