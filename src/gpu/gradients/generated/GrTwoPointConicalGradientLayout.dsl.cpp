...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        Var _type(kConst_Modifier, DSLType(kInt_Type), "type", Int((int)type));
        Declare(_type);
        [[maybe_unused]] const auto& isRadiusIncreasing = _outer.isRadiusIncreasing;
        Var _isRadiusIncreasing(kConst_Modifier,
                                DSLType(kBool_Type),
                                "isRadiusIncreasing",
                                Bool(!!(isRadiusIncreasing)));
        Declare(_isRadiusIncreasing);
        [[maybe_unused]] const auto& isFocalOnCircle = _outer.isFocalOnCircle;
        Var _isFocalOnCircle(
                kConst_Modifier, DSLType(kBool_Type), "isFocalOnCircle", Bool(!!(isFocalOnCircle)));
        Declare(_isFocalOnCircle);
        [[maybe_unused]] const auto& isWellBehaved = _outer.isWellBehaved;
        Var _isWellBehaved(
                kConst_Modifier, DSLType(kBool_Type), "isWellBehaved", Bool(!!(isWellBehaved)));
        Declare(_isWellBehaved);
        [[maybe_unused]] const auto& isSwapped = _outer.isSwapped;
        Var _isSwapped(kConst_Modifier, DSLType(kBool_Type), "isSwapped", Bool(!!(isSwapped)));
        Declare(_isSwapped);
        [[maybe_unused]] const auto& isNativelyFocal = _outer.isNativelyFocal;
        Var _isNativelyFocal(
                kConst_Modifier, DSLType(kBool_Type), "isNativelyFocal", Bool(!!(isNativelyFocal)));
        Declare(_isNativelyFocal);
        ...
        Var _t(kNo_Modifier, DSLType(kFloat_Type), "t", -1.0f);
        Var _v(kNo_Modifier, DSLType(kHalf_Type), "v", 1.0f);
        Var _r0_2(kNo_Modifier, DSLType(kHalf_Type), "r0_2", _focalParams.y());
        Var _r0(kNo_Modifier, DSLType(kHalf_Type), "r0", _focalParams.x());
        Var _invR1(kNo_Modifier, DSLType(kHalf_Type), "invR1", _focalParams.x());
        Var _fx(kNo_Modifier, DSLType(kHalf_Type), "fx", _focalParams.y());
        Var _x_t(kNo_Modifier, DSLType(kFloat_Type), "x_t", -1.0f);
        Var _temp(kNo_Modifier,
                  DSLType(kFloat_Type),
                  "temp",
