...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        if (intervalCount > 1) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "scale2_3").swap(_scale2_3);
            DeclareGlobal(_scale2_3, Float4(0));
        }
        Var _scale4_5;
        if (intervalCount > 2) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "scale4_5").swap(_scale4_5);
            DeclareGlobal(_scale4_5, Float4(0));
        }
        Var _scale6_7;
        if (intervalCount > 3) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "scale6_7").swap(_scale6_7);
            DeclareGlobal(_scale6_7, Float4(0));
        }
        Var _scale8_9;
        if (intervalCount > 4) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "scale8_9").swap(_scale8_9);
            DeclareGlobal(_scale8_9, Float4(0));
        }
        Var _scale10_11;
        if (intervalCount > 5) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "scale10_11").swap(_scale10_11);
            DeclareGlobal(_scale10_11, Float4(0));
        }
        Var _scale12_13;
        if (intervalCount > 6) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "scale12_13").swap(_scale12_13);
            DeclareGlobal(_scale12_13, Float4(0));
        }
        Var _scale14_15;
        if (intervalCount > 7) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "scale14_15").swap(_scale14_15);
            DeclareGlobal(_scale14_15, Float4(0));
        }
        ...
        if (intervalCount > 1) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "bias2_3").swap(_bias2_3);
            DeclareGlobal(_bias2_3, Float4(0));
        }
        Var _bias4_5;
        if (intervalCount > 2) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "bias4_5").swap(_bias4_5);
            DeclareGlobal(_bias4_5, Float4(0));
        }
        Var _bias6_7;
        if (intervalCount > 3) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "bias6_7").swap(_bias6_7);
            DeclareGlobal(_bias6_7, Float4(0));
        }
        Var _bias8_9;
        if (intervalCount > 4) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "bias8_9").swap(_bias8_9);
            DeclareGlobal(_bias8_9, Float4(0));
        }
        Var _bias10_11;
        if (intervalCount > 5) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "bias10_11").swap(_bias10_11);
            DeclareGlobal(_bias10_11, Float4(0));
        }
        Var _bias12_13;
        if (intervalCount > 6) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "bias12_13").swap(_bias12_13);
            DeclareGlobal(_bias12_13, Float4(0));
        }
        Var _bias14_15;
        if (intervalCount > 7) {
            ...
            Var(kConst_Modifier, DSLType(kFloat4_Type), "bias14_15").swap(_bias14_15);
            DeclareGlobal(_bias14_15, Float4(0));
        }
