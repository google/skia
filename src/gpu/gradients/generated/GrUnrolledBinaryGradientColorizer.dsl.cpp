...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        Var _scale2_3;
        if (intervalCount > 1) {
            _scale2_3.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "scale2_3"));
            scale2_3Var = VarUniformHandle(_scale2_3);
        }
        Var _scale4_5;
        if (intervalCount > 2) {
            _scale4_5.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "scale4_5"));
            scale4_5Var = VarUniformHandle(_scale4_5);
        }
        Var _scale6_7;
        if (intervalCount > 3) {
            _scale6_7.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "scale6_7"));
            scale6_7Var = VarUniformHandle(_scale6_7);
        }
        Var _scale8_9;
        if (intervalCount > 4) {
            _scale8_9.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "scale8_9"));
            scale8_9Var = VarUniformHandle(_scale8_9);
        }
        Var _scale10_11;
        if (intervalCount > 5) {
            _scale10_11.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "scale10_11"));
            scale10_11Var = VarUniformHandle(_scale10_11);
        }
        Var _scale12_13;
        if (intervalCount > 6) {
            _scale12_13.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "scale12_13"));
            scale12_13Var = VarUniformHandle(_scale12_13);
        }
        Var _scale14_15;
        if (intervalCount > 7) {
            _scale14_15.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "scale14_15"));
        ...
        Var _bias2_3;
        if (intervalCount > 1) {
            _bias2_3.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "bias2_3"));
            bias2_3Var = VarUniformHandle(_bias2_3);
        }
        Var _bias4_5;
        if (intervalCount > 2) {
            _bias4_5.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "bias4_5"));
            bias4_5Var = VarUniformHandle(_bias4_5);
        }
        Var _bias6_7;
        if (intervalCount > 3) {
            _bias6_7.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "bias6_7"));
            bias6_7Var = VarUniformHandle(_bias6_7);
        }
        Var _bias8_9;
        if (intervalCount > 4) {
            _bias8_9.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "bias8_9"));
            bias8_9Var = VarUniformHandle(_bias8_9);
        }
        Var _bias10_11;
        if (intervalCount > 5) {
            _bias10_11.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "bias10_11"));
            bias10_11Var = VarUniformHandle(_bias10_11);
        }
        Var _bias12_13;
        if (intervalCount > 6) {
            _bias12_13.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "bias12_13"));
            bias12_13Var = VarUniformHandle(_bias12_13);
        }
        Var _bias14_15;
        if (intervalCount > 7) {
            _bias14_15.assign(Var(kUniform_Modifier, DSLType(kFloat4_Type), "bias14_15"));
