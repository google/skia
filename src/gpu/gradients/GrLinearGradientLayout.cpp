...
class GrGLSLLinearGradientLayout : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    const GrLinearGradientLayout& _outer =
        args.fFp.cast<GrLinearGradientLayout>();
    (void)_outer;
...
GrLinearGradientLayout::GrLinearGradientLayout(
    const GrLinearGradientLayout& src)
...
std::unique_ptr<GrFragmentProcessor> GrLinearGradientLayout::clone() const {
  return std::unique_ptr<GrFragmentProcessor>(
      new GrLinearGradientLayout(*this));
}
GR_DEFINE_FRAGMENT_PROCESSOR_TEST(GrLinearGradientLayout);
#if GR_TEST_UTILS
std::unique_ptr<GrFragmentProcessor> GrLinearGradientLayout::TestCreate(
...
std::unique_ptr<GrFragmentProcessor> GrLinearGradientLayout::Make(
  ...
  return std::unique_ptr<GrFragmentProcessor>(
      new GrLinearGradientLayout(matrix));
}
