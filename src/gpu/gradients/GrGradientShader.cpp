...
template <int intervalCount>
static std::unique_ptr<GrFragmentProcessor> make_unrolled_colorizer_N(const SkPMColor4f* scale,
                                                                      const SkPMColor4f* bias,
                                                                      SkRect thresholds1_7,
                                                                      SkRect thresholds9_13) {
    static_assert(intervalCount >= 1 && intervalCount <= 8);
    static auto effect = [](){
        SkString sksl;
...
#define ADD_STOP(N, suffix) \
    ...
    return GrSkSLFP::Make(effect, "UnrolledBinaryColorizer", /*inputFP=*/nullptr,
                          GrSkSLFP::OptFlags::kNone,
...
static std::unique_ptr<GrFragmentProcessor> make_unrolled_binary_colorizer(
    ...
    switch (intervalCount) {
        case 1: return make_unrolled_colorizer_N<1>(scales, biases, thresholds1_7, thresholds9_13);
        case 2: return make_unrolled_colorizer_N<2>(scales, biases, thresholds1_7, thresholds9_13);
        case 3: return make_unrolled_colorizer_N<3>(scales, biases, thresholds1_7, thresholds9_13);
        case 4: return make_unrolled_colorizer_N<4>(scales, biases, thresholds1_7, thresholds9_13);
        case 5: return make_unrolled_colorizer_N<5>(scales, biases, thresholds1_7, thresholds9_13);
        case 6: return make_unrolled_colorizer_N<6>(scales, biases, thresholds1_7, thresholds9_13);
        case 7: return make_unrolled_colorizer_N<7>(scales, biases, thresholds1_7, thresholds9_13);
        case 8: return make_unrolled_colorizer_N<8>(scales, biases, thresholds1_7, thresholds9_13);
    }
