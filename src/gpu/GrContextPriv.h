...
public:
    ...
    /**
     * Finalizes all pending reads and writes to the surfaces and also performs an MSAA resolve
     * if necessary.
     *
     ...
     */
    GrSemaphoresSubmitted flushSurfaces(GrSurfaceProxy*[], int n, const GrFlushInfo&);
