...
public:
    ...
    using GrBlockAllocator::kMaxAllocationSize;
    ...
    static std::unique_ptr<GrMemoryPool> Make(size_t preallocSize) {
        return GrBlockAllocator::Prealloc<GrMemoryPool>(preallocSize);
    }
...
public:
    static std::unique_ptr<GrOpMemoryPool> Make(size_t preallocSize) {
        return GrBlockAllocator::Prealloc<GrOpMemoryPool>(preallocSize);
    }
