 ...
 * about GrGeometryProcessor creation.
 */
 ...
 * must obey the same contract as any GrGeometryProcessor, specifically it must emit a color and
...
/**
 * GrGeometryProcessor defines an interface which all subclasses must implement.  All
 * GrGeometryProcessors must proivide seed color and coverage for the Ganesh color / coverage
