...
protected:
    ...
    const Attribute& addVertexAttrib(const char* name, GrVertexAttribType type,
        ...
        return this->addAttrib<&GrPrimitiveProcessor::fVertexStride,
                               Attribute::InputRate::kPerVertex>(name, type, precision);
    }
    const Attribute& addInstanceAttrib(const char* name, GrVertexAttribType type,
                                       GrSLPrecision precision = kDefault_GrSLPrecision) {
        return this->addAttrib<&GrPrimitiveProcessor::fInstanceStride,
                               Attribute::InputRate::kPerInstance>(name, type, precision);
    }
...
private:
    ...
    template<int GrPrimitiveProcessor::* Stride, Attribute::InputRate Rate>
