...
void GrTextureAdjuster::makeMipMappedKey(GrUniqueKey* copyKey) {
    ...
    MakeMipMappedKeyFromOriginalKey(baseKey, copyKey);
}

void GrTextureAdjuster::didCacheMipMappedCopy(const GrUniqueKey& copyKey,
