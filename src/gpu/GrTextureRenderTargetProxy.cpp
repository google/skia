...
GrTextureRenderTargetProxy::GrTextureRenderTargetProxy(const GrCaps& caps,
        ...
        : GrSurfaceProxy(format, desc, GrRenderable::kYes, origin, texSwizzle, fit, budgeted, surfaceFlags)
...
GrTextureRenderTargetProxy::GrTextureRenderTargetProxy(LazyInstantiateCallback&& callback,
                                                       ...
                                                       SkBudgeted budgeted,
                                                       GrInternalSurfaceFlags surfaceFlags)
        : GrSurfaceProxy(std::move(callback), lazyType, format, desc, GrRenderable::kYes, origin, texSwizzle, fit,
