...
size_t GrTextureRenderTargetProxy::onGpuMemorySize() const {
    ...
    return 0; // GrRenderTargetProxy::ComputeSize(fDesc, fDesc.fSampleCnt+1);
}
...
sk_sp<GrTextureRenderTargetProxy> GrTextureRenderTargetProxy::Make(sk_sp<GrTexture> tex) {
    ...
    return sk_sp<GrTextureRenderTargetProxy>(new GrTextureRenderTargetProxy(sk_ref_sp(tex->asRenderTarget())));
}
