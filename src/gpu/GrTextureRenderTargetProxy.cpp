...
GrTextureRenderTargetProxy::GrTextureRenderTargetProxy(const GrCaps& caps,
        ...
        , GrRenderTargetProxy(caps, format, desc, origin, outSwizzle, fit, budgeted, surfaceFlags)
...
GrTextureRenderTargetProxy::GrTextureRenderTargetProxy(LazyInstantiateCallback&& callback,
        ...
        , GrRenderTargetProxy(LazyInstantiateCallback(), lazyType, format, desc, origin, outSwizzle,
...
GrTextureRenderTargetProxy::GrTextureRenderTargetProxy(sk_sp<GrSurface> surf,
        ...
        , GrRenderTargetProxy(surf, origin, outSwizzle)
