...
public:
    ...
    // intervals. Fully-lazy proxies are also instantiated at this point so that their size can
    // be known. Returns false if any fully-lazy proxy failed to instantiate, true otherwise.
    bool planAssignment();
