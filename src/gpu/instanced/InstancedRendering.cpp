...
void InstancedRendering::Op::finalize(const GrCaps& caps, const GrAppliedClip* clip, bool* xpRequiresDstTexture) {
    ...
    // TODO: NEED THIS FROM XPFACTORY
    fInfo.fCannotTweakAlphaForCoverage = true;//!analysis.isCompatibleWithCoverageAsAlpha();
...
void InstancedRendering::Op::onExecute(GrOpFlushState* state, const GrAppliedClip* clip, GrRenderTarget* renderTarget) {
