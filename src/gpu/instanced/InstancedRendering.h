...
protected:
    InstancedOp(uint32_t classID, GrPaint&&, InstancedRenderingAllocator*);
...
public:
    ...
    void draw2(const GrPipeline& pipeline, OpInfo info, const InstancedOp* baseOp);
...
#ifdef SK_DEBUG
    bool isFlushing() const { return InstancedRendering::State::kFlushing == fState1; }
#endif
...
protected:
    ...
    virtual void onDraw1(const GrPipeline&, const InstanceProcessor&, const InstancedOp*) = 0;
