    ...
    public:
        ...
        SkString dumpInfo() const override {
            ...
            string.printf("AA: %d, ShapeTypes: 0x%02x, IShapeTypes: 0x%02x, Persp %d, "
                          ...
                          "GeomChanges: %d\n", (int)fInfo.fAntialiasMode, fInfo.fShapeTypes,
                          fInfo.fInnerShapeTypes, fInfo.fHasPerspective, fInfo.fNonSquare,
                          fPixelLoad, fIsTracked, fNumDraws, fNumChangesInGeometry);
