...
namespace GrPathUtils {
    ...
    // the double point: t1 and t1. We chop the cubic at these values if they are between 0 and 1.
    // Return value:
    ...
    //            The flip can be done via 'klm.postScale(-1, -1)'. (NOTE: this is equivalent to
    //            negating the K and L values.)
    //
