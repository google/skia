...
// TODO: this class is basically copy and pasted from GrVkPipelineStateDataManager so that we can
// have some shaders working. The SkSL Metal code generator was written to work with GLSL generated
...
template<int N> inline void GrMtlPipelineStateDataManager::setMatrices(UniformHandle u,
                                                                      int arrayCount,
