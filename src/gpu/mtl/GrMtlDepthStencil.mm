...
sk_cfp<MTLStencilDescriptor*> skia_stencil_to_mtl(GrStencilSettings::Face face) {
    ...
    return sk_cfp<MTLStencilDescriptor*>(result);
}

GrMtlDepthStencil* GrMtlDepthStencil::Create(const GrMtlGpu* gpu,
                                             const GrStencilSettings& stencil,
                                             GrSurfaceOrigin origin) {
    sk_cfp<MTLDepthStencilDescriptor*> desc([[MTLDepthStencilDescriptor alloc] init]);
    ...
    sk_cfp<id<MTLDepthStencilState>> stencilState(
