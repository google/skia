...
public:
     ...
     * pipeline. For now we only note whether the primitive uses points. Note that some state
     * is set dynamically on the pipeline for each draw and thus is not included in this descriptor.
     * This includes the viewport, scissor, and blend constant.
     */
