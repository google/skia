...
static void init_surface_desc(GrSurfaceDesc* surfaceDesc, id<MTLTexture> mtlTexture,
                              bool isRenderTarget) {
    if (isRenderTarget) {
    ...
    surfaceDesc->fConfig = GrMTLFormatToPixelConfig(mtlTexture.pixelFormat);
...
sk_sp<GrTexture> GrMtlGpu::onWrapBackendTexture(const GrBackendTexture& backendTex,
    ...
    init_surface_desc(&surfDesc, mtlTexture, false);
...
sk_sp<GrTexture> GrMtlGpu::onWrapRenderableBackendTexture(const GrBackendTexture& backendTex,
    ...
    GrSurfaceDesc surfDesc;
    init_surface_desc(&surfDesc, mtlTexture, true);
