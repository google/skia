...
bool GrMtlGpu::createMtlTextureForBackendSurface(MTLPixelFormat mtlFormat,
    ...
    id<MTLTexture> testTexture = [*fDevice newTextureWithDescriptor: desc.get()];
    info->fTexture.reset((void*)(testTexture));
    return true;
}
...
void GrMtlGpu::resolveTexture(id<MTLTexture> resolveTexture, id<MTLTexture> colorTexture) {
    sk_cf_obj<MTLRenderPassDescriptor*> renderPassDesc(
        [MTLRenderPassDescriptor renderPassDescriptor]);
    [[*renderPassDesc colorAttachments][0] setTexture: colorTexture];
    [[*renderPassDesc colorAttachments][0] setSlice: 0];
    [[*renderPassDesc colorAttachments][0] setLevel: 0];
    [[*renderPassDesc colorAttachments][0] setResolveTexture: resolveTexture];
    [[*renderPassDesc colorAttachments][0] setLoadAction: MTLLoadActionLoad];
    [[*renderPassDesc colorAttachments][0] setStoreAction: MTLStoreActionMultisampleResolve];
