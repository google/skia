...
sk_sp<GrTexture> GrMtlGpu::onCreateTexture(SkISize dims,
    ...
    texDesc.width = dims.fWidth;
    texDesc.height = dims.fHeight;
    texDesc.depth = 1;
    ...
    if (renderable == GrRenderable::kYes) {
        tex = GrMtlTextureRenderTarget::MakeNewTextureRenderTarget(
                this, budgeted, dims, renderTargetSampleCnt, texDesc, mipMapsStatus);
    } else {
        tex = GrMtlTexture::MakeNewTexture(this, budgeted, dims, texDesc, mipMapsStatus);
    }
