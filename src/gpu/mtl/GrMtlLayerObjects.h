...
protected:
    GrMtlLayerTexture(GrMtlGpu* gpu, const GrSurfaceDesc&, CAMetalLayer* layer,
                      GrMTLHandle* drawable, GrMipMapsStatus);
...
public:
    static sk_sp<GrMtlLayerTextureRenderTarget> MakeWrappedTextureRenderTarget(
            GrMtlGpu*, const GrSurfaceDesc&, int sampleCnt, CAMetalLayer* layer,
            GrMTLHandle* drawable, GrWrapCacheable);
    GrBackendFormat backendFormat() const override {
