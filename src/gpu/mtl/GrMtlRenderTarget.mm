...
sk_sp<GrMtlRenderTarget> GrMtlRenderTarget::CreateNewRenderTarget(GrMtlGpu* gpu, SkBudgeted budgeted,
    ...
    return sk_sp<GrMtlRenderTarget>(new GrMtlRenderTarget(gpu, budgeted, desc,texture,
                                                          kNot_Wrapped));
}
