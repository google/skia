...
void GrMtlPipelineStateBuilder::storeShadersInCache(const SkSL::String shaders[],
    ...
    // TODO(skia:11372): We don't have the render target here, so pass null for now. Need to
    // plumb it in and store it on the GrMtlPipelineStateBuilder, like other backends.
