...
int GrMtlPipelineStateBuilder::loadShadersFromCache(SkReader32* cached,
    ...
    outLibraries[kVertex_GrShaderType] = this->createMtlShaderLibrary(
    ...
    outLibraries[kFragment_GrShaderType] = this->createMtlShaderLibrary(
...
id<MTLLibrary> GrMtlPipelineStateBuilder::createMtlShaderLibrary(
    ...
    id<MTLLibrary> shaderLibrary = GrCompileMtlShaderLibrary(fGpu, shader.c_str(),
