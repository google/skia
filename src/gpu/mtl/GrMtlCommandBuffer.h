...
public:
    ...
    void encodeSignalEvent(id<MTLEvent>, uint64_t value) SK_MTL_API_AVAILABLE(macos(10.14), ios(12.0));
    void encodeWaitForEvent(id<MTLEvent>, uint64_t value) SK_MTL_API_AVAILABLE(macos(10.14), ios(12.0));
