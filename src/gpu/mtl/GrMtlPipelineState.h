...
private:
    ...
    */
    ...
    struct SamplerBindings {
        ...
        SamplerBindings(GrSamplerState state, GrTexture* texture)
                : fState(state)
                , fTexture(texture) {}
    };

    void writeSamplers(const SkTArray<SamplerBindings>&);
    ...
    int fNumSamplers;
    SkTDArray<GrMtlSampler*> fSamplers;
    SkTDArray<const GrMtlTexture*> fTextures;
