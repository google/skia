...
GrMtlTextureRenderTarget::GrMtlTextureRenderTarget(GrMtlGpu* gpu,
        ...
        , GrMtlTexture(gpu, dimensions, std::move(resolveTexture), mipmapStatus)
...
GrMtlTextureRenderTarget::GrMtlTextureRenderTarget(GrMtlGpu* gpu,
                                                   ...
                                                   GrMipmapStatus mipmapStatus)
        : GrSurface(gpu, dimensions, GrProtected::kNo)
        , GrMtlTexture(gpu, dimensions, std::move(colorTexture), mipmapStatus)
...
sk_cf_obj<id<MTLTexture>> create_msaa_texture(GrMtlGpu* gpu, SkISize dimensions,
    ...
    return sk_cf_obj<id<MTLTexture>>([gpu->device() newTextureWithDescriptor:*texDesc]);
}
...
sk_sp<GrMtlTextureRenderTarget> GrMtlTextureRenderTarget::MakeNewTextureRenderTarget(
        ...
        SkISize dimensions,
        int sampleCnt,
        const sk_cf_obj<MTLTextureDescriptor*>& texDesc,
        GrMipmapStatus mipmapStatus) {
