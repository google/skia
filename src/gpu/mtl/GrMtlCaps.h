...
public:
    /**
     * Creates a GrMtlCaps that is set such that nothing is supported. The init function should
...
private:
    void init(const GrContextOptions& contextOptions, const id<MTLDevice> device);
    void initFeatureSet(const id<MTLDevice> device);
