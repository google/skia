...
public:
    ...
    int getRenderTargetSampleCount(int requestedCount, MTLPixelFormat) const override;
...
// Need this?        SkTDArray<int> fColorSampleCounts;
    };
    ...
    const FormatInfo& getFormatInfo(MTLPixelFormat) const {
