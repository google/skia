...
size_t GrMtlBackendFormatBytesPerPixel(const GrBackendFormat& format) {
    MTLPixelFormat mtlFormat = GrBackendFormatAsMTLPixelFormat(format);
    return GrMtlFormatBytesPerPixel(mtlFormat);
}

size_t GrMtlFormatBytesPerPixel(MTLPixelFormat) {
    switch (mtlFormat) {
