...
void GrMtlCaps::initFormatTable() {
    ...
    // Format: RGB10A2Unorm
    {
        ...
        {
            auto& ctInfo = info->fColorTypeInfos[ctIdx++];
            ctInfo.fColorType = GrColorType::kRGBA1_1010102;
            ctInfo.fFlags = ColorTypeInfo::kUploadData_Flag | ColorTypeInfo::kRenderable_Flag;
        }
    }
    ...
    this->setColorType(GrColorType::kRGBA1_1010102,     { MTLPixelFormatRGB10A2Unorm });
...
std::vector<GrCaps::TestFormatColorTypeCombination> GrMtlCaps::getTestingCombinations() const {
    std::vector<GrCaps::TestFormatColorTypeCombination> combos = {
        ...
        { GrColorType::kRGBA1_1010102,     GrBackendFormat::MakeMtl(MTLPixelFormatRGB10A2Unorm)    },
