...
#ifdef SK_DEBUG
static bool pixelformat_grColorType_valid_pair(MTLPixelFormat format, GrColorType colorType) {
    switch (colorType) {
...
static GrSwizzle get_swizzle(const GrBackendFormat& format, GrColorType colorType,
    ...
    SkASSERT(pixelformat_grColorType_valid_pair(mtlFormat, colorType));
