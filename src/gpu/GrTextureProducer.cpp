...
GrTextureProducer::DomainMode GrTextureProducer::DetermineDomainMode(
    ...
    SkASSERT(!textureContentArea ||
             (!textureContentArea->contains(SkIRect::MakeWH(proxy->width(), proxy->height())) &&
    ...
    if (GrResourceProvider::IsFunctionallyExact(proxy) && constraintRect.contains(proxyBounds)) {
