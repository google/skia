...
GrBackendFormat get_backend_format(GrContext* context, AHardwareBuffer* hardwareBuffer, GrBackendApi backend,
    ...
    if (backend == GrBackendApi::kOpenGL) {
        ...
        switch (bufferFormat) {
            ...
            default: {
                ...
                VkResult err = VK_CALL(GetAndroidHardwareBufferProperties(device, hardwareBuffer, &hwbProps));
                if (VK_SUCCESS != err) {
                    return GrBackendFormat();
                }
