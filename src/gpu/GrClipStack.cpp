...
static bool shape_contains_rect(const GrShape& a,
    ...
    for (int i = 0; i < 4; ++i) {
        if (!a.conservativeContains(corners[i])) {
            return false;
        }
    }
...
// GrClipStack::RawElement::RawElement(const RawElement& e) { *this = e; }
// GrClipStack::RawElement& GrClipStack::RawElement::operator=(const RawElement& e) = default;
