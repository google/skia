...
public:
    ...
    void reset(const GrPipelineInput& input) { this->internalReset(input, input.isLCDCoverage()); }
    ...
    GrKnownColorComponents knownComponents() const { return fInOut.knownComponents(); }
