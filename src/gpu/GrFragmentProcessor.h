...
public:
    ...
    */
     ...
     * std::unique_ptr<GrFragmentPocessor>s.
     */
    static inline gr_fp<GrFragmentProcessor> RunInSeries();
    template <typename T> using MustBeFP = typename std::enable_if<std::is_same<T, gr_fp<GrFragmentProcessor>>::value, gr_fp<GrFragmentProcessor>>::type;
    template <typename... FP>
    static inline gr_fp<GrFragmentProcessor> RunInSeries(gr_fp<GrFragmentProcessor>, MustBeFP<FP>... fps);
...
gr_fp<GrFragmentProcessor> GrFragmentProcessor::RunInSeries() { return nullptr; }
template <typename... FP>
gr_fp<GrFragmentProcessor> GrFragmentProcessor::RunInSeries(gr_fp<GrFragmentProcessor> first, MustBeFP<FP>... rest) {
