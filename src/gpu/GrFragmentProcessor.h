...
/**
 * Used to represent a texture that is required by a GrFragmentProcessor. It holds a GrTexture along
 * with an associated GrSamplerState. TextureSamplers don't perform any coord manipulation to
