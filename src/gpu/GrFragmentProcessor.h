...
protected:
    ...
    int registerChild(std::unique_ptr<GrFragmentProcessor> child,
                      SkSL::SampleUsage sampleUsage = SkSL::SampleUsage::MakePassThrough());
    ...
    int registerExplicitlySampledChild(std::unique_ptr<GrFragmentProcessor> child) {
        return this->registerChild(std::move(child), SkSL::SampleUsage::MakeExplicitCoords());
    }
...
private:
    ...
    void setSampleUsage(SkSL::SampleUsage usage);
