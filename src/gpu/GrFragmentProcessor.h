...
public:
    ...
    */
    ...
    // Iter. This provides access to the coord tranform and the FP that owns it. Example usage:
    ...
    // Same as CoordTranformIter but for TextureSamplers:
    ...
    // Implementation detail for using CoordTranformIter and TextureSamplerIter in range-for loops.
