...
public:
    ...
    */
     ...
     * This is equivalent to running them in series. This is not the same as xfer-mode composition,
     * which is also sometimes referred to as composition, because there is no blending step.
     */
