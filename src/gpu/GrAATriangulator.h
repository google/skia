...
private:
    ...
    int64_t countPoints(Poly* polys, SkPathFillType overrideFillType) override;
    void* polysToTriangles(Poly* polys, void* data, SkPathFillType overrideFillType) override;
    ...
    // Gets populated with the path's outer mesh during strokeBoundary(), and emits the outer mesh
    // during tessellation.
