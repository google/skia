...
//
// In practice, a path's inner fan takes up the vast majority of the pixels. So from a GPU load
...
private:
    ...
    // These methods set up the stencil and fill programs we will use prior to preparing and
    // executing.
    ...
    // This buffer gets filled by the triangulator during onPrepare.
