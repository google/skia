...
// formulated to match kMarkStencil everywhere except the ref and compare mask. This allows us to
// get away with a single program when dynamic stencil state is supported.
