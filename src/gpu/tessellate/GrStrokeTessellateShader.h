...
public:
    // The vertex array bound for this shader should contain vector of Patch structs. A Patch is
    ...
    struct Patch {
        ...
        // An absolute value >1 in fPatchType means that this patch is a join. A positive value
        ...
        // points of their adjoining cubics exactly for the seaming to be water tight.
    ...
    GrStrokeTessellateShader(float matrixScale, float miterLimit, const SkMatrix& viewMatrix,
        ...
        constexpr static Attribute kInputPointAttribs[] = {
                {"inputP01", kFloat4_GrVertexAttribType, kFloat4_GrSLType},
                {"inputP23", kFloat4_GrVertexAttribType, kFloat4_GrSLType},
