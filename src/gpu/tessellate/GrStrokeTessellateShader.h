...
public:
    ...
    struct IndirectInstance {
        ...
        // Writes the given stroke into this instance. "numTotalEdges" tells the shader the literal
        // number of edges in the triangle strip being rendered (i.e., it should be vertexCount/2).
        ...
        // A "cusp" is a circle drawn as a 180-degree point stroke. They should be drawn at cusp
        // points on the curve and for round caps.
        void setCusp(SkPoint pt, int numEdgesForCusps) {
            SkASSERT(numEdgesForCusps >= 0);
            // An empty stroke is a special case that denotes a cusp, or 180-degree point stroke.
            fPts.fill(pt);
            ...
            fNumTotalEdges = -numEdgesForCusps;
        }
        std::array<SkPoint, 4> fPts;
