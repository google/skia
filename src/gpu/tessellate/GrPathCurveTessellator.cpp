...
private:
    ...
    // If using fixed count, this us the number of segments we need to emit per instance. Always
...
GrPathTessellator* GrPathCurveTessellator::Make(SkArenaAlloc* arena, const SkMatrix& viewMatrix,
    ...
    if (caps.shaderCaps()->tessellationSupport() &&
        ...
        shader = GrPathTessellationShader::MakeMiddleOutInstancedShader(arena, viewMatrix, color);
    }
