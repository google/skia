...
private:
    ...
    void drawStencilPass(GrOpFlushState*, const GrAppliedHardClip&, const SkIRect* scissor);
    void drawCoverPass(GrOpFlushState*, GrAppliedClip&&, const SkIRect* scissor);
