...
public:
    ...
    BinningInstanceWriter(GrDrawIndirectWriter* indirectWriter, GrVertexWriter* instanceWriter,
                          ...
                          const int resolveLevelCounts[kNumBins], ShaderFlags shaderFlags)
...
void GrStrokeIndirectTessellator::prepare(GrMeshDrawOp::Target* target, const SkMatrix& viewMatrix,
    ...
    BinningInstanceWriter binningWriter(&indirectWriter, &instanceWriter, instanceStride,
                                        baseInstance, fMaxNumExtraEdgesInJoin, fResolveLevelCounts,
                                        fShaderFlags);
