...
public:
    constexpr static int kMaxResolveLevel = GrStrokeIndirectTessellator::kMaxResolveLevel;
    ...
    // Accounts for "numCircles" 180-degree point stroke instances, which render as a circles with
    // diameters equal to the stroke width. We draw circles at cusp points on curves and for round
    // caps.
    //
