...
public:
    GrMiddleOutPolygonTriangulator(SkPoint* vertexData, int perTriangleSkPointAdvance,
                                   int maxPushVertexCalls)
            : fVertexData(vertexData)
            , fPerTriangleSkPointAdvance(perTriangleSkPointAdvance) {
...
private:
    ...
    void popTopTriangle(const SkPoint& lastPt) {
        ...
        fVertexData += fPerTriangleSkPointAdvance;
    }
    ...
    StackVertex* fTop;
    SkPoint* fVertexData;
    int fPerTriangleSkPointAdvance;
