...
public:
    GrMiddleOutPolygonTriangulator(SkPoint* vertexData, int maxVertices)
        ...
        // initially, but will be overriden if moveTo() gets called before adding geometry.
    ...
    void pushVertex(const SkPoint& pt) {
        ...
        //    [0, 4, 8]
        //
        // Emit as many new triangles as we can with "equal-delta" sides and then pop their vertices
        // off the stack before adding this new one.
        //
...
private:
    struct StackVertex {
        ...
        //     fVertexStack[0].fVertexIdxDelta.
        int fVertexIdxDelta;
        SkPoint fPoint;
    };
