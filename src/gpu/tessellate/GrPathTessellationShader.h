...
// This is the base class for shaders in the GPU tessellator that fill paths (as opposed to
// stroking).
...
private:
    const char* name() const final { return "tessellate_GrTriangleTessellateShader"; }
