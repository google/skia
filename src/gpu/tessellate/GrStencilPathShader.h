...
public:
    ...
    static void WriteDrawCubicsIndirectCmd(GrDrawIndexedIndirectCmdWriter* indirectWriter,
    ...
    static void WriteDrawTrianglesIndirectCmd(GrDrawIndexedIndirectCmdWriter* indirectWriter,
