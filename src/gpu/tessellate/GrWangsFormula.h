...
//     nextlog2((4..8]) -> 3
//     ...
inline static int nextlog2(float value) {
    int32_t bits;
    memcpy(&bits, &value, 4);
...
inline static int quadratic_log2(float intolerance, const SkPoint pts[],
...
// "1/intolerance" pixels from the true curve.
inline static int cubic_log2(float intolerance, const SkPoint pts[],
                             const GrVectorXform& vectorXform = GrVectorXform()) {
