        ...
        for (auto [verb, p, w] : SkPathPriv::Iterate(path)) {
            switch (verb) {
                ...
                case SkPathVerb::kCubic:
                    ...
                    // The most common type of cusp we encounter is when p0==p1 or p2==p3. These
                    // don't actually need special treatment because the cusps occur at t=0 and t=1.
                    if (areCusps && p[0] != p[1] && p[2] != p[3]) {
