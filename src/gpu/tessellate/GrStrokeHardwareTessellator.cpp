...
void GrStrokeHardwareTessellator::joinTo(JoinType joinType, SkPoint nextControlPoint, int maxDepth) {
    SkASSERT(fHasCurrentPoint);
...
void GrStrokeHardwareTessellator::emitPatch(JoinType prevJoinType, const SkPoint p[4], SkPoint endPt) {
