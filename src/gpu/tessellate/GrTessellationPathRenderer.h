...
private:
    ...
    // This simple cache remembers the locations of cacheable paths in the atlas that have identity
    // transforms and integer translates. Its main motivation is for clip paths.
    struct AtlasPathKey {
