...
public:
    ...
    // rotation, in order to guarantee smoothness for the stroke width and view matrix.
...
private:
    ...
    // This is the number of radial segments we need to add to the quad strip for each radian of
    // rotation. This is to guarantee smoothness given the current stroke radius.
