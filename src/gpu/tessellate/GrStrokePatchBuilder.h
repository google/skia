...
private:
    ...
    float fCurrStrokeJoinType;
    float fNumRadialSegmentsPerRad;
    // The worst-case numbers of parametric segments our hardware can support for the current stroke
    // radius, in the event that there are also enough radial segments to rotate 180 and 360 degrees
    // respectively. These are used for "quick accepts" that allow us to send almost all curves
    // directly to the hardware without having to chop or think any further.
