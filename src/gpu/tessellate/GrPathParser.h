...
int EmitCenterWedgePatches(const SkPath&, GrApproxVertexAllocator*);
...
//
// Returns the number of vertices written to the array.
int EmitInnerPolygonTriangles(const SkPath&, GrApproxVertexAllocator*);
...
int EmitCubicInstances(const SkPath&, GrApproxVertexAllocator*);
