...
public:
    ...
    static GrPathTessellationShader* MakeSimpleTriangleShader(SkArenaAlloc*, const SkMatrix&,
                                                              const SkPMColor4f&);
    ...
    static GrPathTessellationShader* MakeMiddleOutInstancedShader(SkArenaAlloc*, const SkMatrix&,
                                                                  const SkPMColor4f&);
    ...
    static GrPathTessellationShader* MakeHardwareWedgeShader(SkArenaAlloc*, const SkMatrix&,
                                                             const SkPMColor4f&);

    // Uses GPU tessellation shaders to linearize, triangulate, and render standalone closed cubics.
    static GrPathTessellationShader* MakeHardwareCurveShader(SkArenaAlloc*, const SkMatrix&,
                                                             const SkPMColor4f&);
