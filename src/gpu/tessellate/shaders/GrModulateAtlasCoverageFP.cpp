...
GrModulateAtlasCoverageFP::GrModulateAtlasCoverageFP(Flags flags,
                                                     ...
                                                     const GrDynamicAtlas& atlas, const SkMatrix&
                                                     devToAtlasMatrix, const SkIRect& devIBounds,
                                                     const GrCaps& caps)
    ...
    GrSwizzle swizzle = caps.getReadSwizzle(atlas.textureProxy()->backendFormat(),
                                            GrColorType::kAlpha_8);
    GrSurfaceProxyView atlasView(sk_ref_sp(atlas.textureProxy()), GrDynamicAtlas::kTextureOrigin,
                                 swizzle);
