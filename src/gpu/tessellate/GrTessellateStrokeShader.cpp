...
private:
    ...
    void setData(const GrGLSLProgramDataManager& pdman, const GrPrimitiveProcessor& primProc,
        ...
        if (!shader.viewMatrix().isIdentity()) {
            if (fCachedViewMatrixValue != shader.viewMatrix()) {
                pdman.setSkMatrix(fViewMatrixUniform, shader.viewMatrix());
                fCachedViewMatrixValue = shader.viewMatrix();
            }
        }
...
SkString GrTessellateStrokeShader::getTessEvaluationShaderGLSL(
    ...
    code.append(R"(
            ...
            void main() {
                ...
                // Evaluate the cubic at T. Use De Casteljau's for its accuracy and stablility.
