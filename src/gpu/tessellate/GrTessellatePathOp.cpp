...
#include "src/gpu/GrApproxVertexAllocator.h"
...
void GrTessellatePathOp::onPrepare(GrOpFlushState* state) {
    GrApproxDynamicVertexAllocator pathVertexAllocator(state, &fPathVertexBuffer, &fBasePathVertex);
    GrApproxDynamicVertexAllocator cubicInstanceAllocator(state, &fCubicInstanceBuffer,
                                                          &fBaseCubicInstance);
