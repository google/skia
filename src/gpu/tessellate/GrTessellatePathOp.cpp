...
void GrTessellatePathOp::prepareMiddleOutInnerTriangles(GrMeshDrawOp::Target* target,
    ...
    constexpr static int kNumSkPointsPerTriangle = 3;
    GrMiddleOutPolygonTriangulator middleOut(vertexData, kNumSkPointsPerTriangle, maxVertices);
    ...
    fTriangleVertexCount = middleOut.close() * kNumSkPointsPerTriangle;
