...
public:
    static constexpr int kMaxNumLinearSegmentsLog2 = GrTessellationPathRenderer::kMaxResolveLevel;
...
private:
    ...
    bool recordLeftJoinIfNotEmpty(Verb joinType, SkVector nextNormal);
