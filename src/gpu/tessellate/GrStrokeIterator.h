        ...
        if (fQueueCount) {
            ...
            switch (fCapType) {
                ...
                case SkPaint::kRound_Cap: {
                    ...
                    this->enqueue(Verb::kCusp, this->backPts() + backIdx, nullptr);
                    this->enqueue(Verb::kCusp, fFirstPtsInContour, fFirstWInContour);
                    break;
                }
            ...
            switch (fCapType) {
                case SkPaint::kButt_Cap:
                    ...
                    return false;
                case SkPaint::kRound_Cap:
                    this->enqueue(Verb::kCusp, fLastDegenerateStrokePt, nullptr);
