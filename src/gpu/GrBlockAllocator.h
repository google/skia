...
#ifndef SK_DEBUG
    static_assert(offsetof(GrBlockAllocator, fTail) == 0);
    static_assert(offsetof(GrBlockAllocator, fHead) == 16);
static_assert(sizeof(GrBlockAllocator::Block) == 24);
static_assert(sizeof(GrBlockAllocator) == 48);
...
static_assert(alignof(std::max_align_t) == 16);
    ...
    // On release builds, GrBlockAllocator and head block are dense
