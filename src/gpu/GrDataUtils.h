...
// Swizzle is applied after converting from srcInfo.fColorInfo to dstInfo.fColorInfo.
bool GrConvertPixels(const GrPixelInfo& dstInfo, void* dst,
                     const GrPixelInfo& srcInfo, const void* src, GrSwizzle swizzle = GrSwizzle{});
