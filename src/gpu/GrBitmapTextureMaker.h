...
public:
    GrBitmapTextureMaker(GrRecordingContext*, const SkBitmap&, GrImageCachePolicy);
...
private:
    GrBitmapTextureMaker(GrRecordingContext*, const SkBitmap&, GrImageCachePolicy, SkBackingFit);
