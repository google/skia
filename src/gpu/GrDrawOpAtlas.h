 ...
 * draw uses enough subimage space to overflow the atlas texture then addToAtlast fails. This gives
 * the op the chance to end the draw and begin a new one. Additional uploads will succeed in inline
 * mode.
 */
class GrDrawOpAtlas {
public:
