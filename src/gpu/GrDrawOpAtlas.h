 ...
 * executed. At that the atlas fails giving the op the chance to end the draw and begin a new one.
 * Additional uploads will succeed in inline mode.
 */
class GrDrawOpAtlas {
public:
     ...
     * NOTE: When the GrDrawOp prepares a draw that reads the atlas, it must should immediately call
