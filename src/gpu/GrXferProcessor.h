...
public:
     ...
     * its state to reflected the given blend optimizations. A caller who calls this function on a
     * XP is required to honor the returned OptFlags and color values for its draw.
     */
