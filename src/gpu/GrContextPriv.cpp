...
#define RETURN_IF_ABANDONED_PRIV if (fContext->drawingManager()->wasAbandoned()) { return; }
#define RETURN_FALSE_IF_ABANDONED_PRIV if (fContext->drawingManager()->wasAbandoned()) { return false; }
...
sk_sp<GrRenderTargetContext> GrContextPriv::makeDeferredRenderTargetContext(
    ...
    sk_sp<GrRenderTargetContext> renderTargetContext(
        fContext->drawingManager()->makeRenderTargetContext(std::move(rtp),
                                                            std::move(colorSpace),
                                                            surfaceProps));
