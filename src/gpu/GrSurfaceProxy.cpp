...
sk_sp<GrSurface> GrSurfaceProxy::fooImpl(GrResourceProvider* resourceProvider, int sampleCnt,
...
bool GrSurfaceProxy::instantiateImpl(GrResourceProvider* resourceProvider, int sampleCnt,
    ...
    sk_sp<GrSurface> surface = this->fooImpl(resourceProvider, sampleCnt, flags,
