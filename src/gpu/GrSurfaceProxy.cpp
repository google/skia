...
sk_sp<GrSurfaceProxy> GrSurfaceProxy::MakeDeferred(GrResourceProvider* resourceProvider,
                                                   const GrCaps& caps,
    ...
    if (SkBackingFit::kApprox == fit) {
        surf.reset(resourceProvider->createApproxTexture(copyDesc));
    } else {
        surf.reset(resourceProvider->createTexture(copyDesc, budgeted));
    }
