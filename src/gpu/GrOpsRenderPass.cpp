...
void GrOpsRenderPass::upadatePrimProcTextureBindings(const GrPrimitiveProcessor& primProc,
...
void GrOpsRenderPass::drawMeshes(const GrProgramInfo& programInfo, const GrMesh meshes[],
    ...
    for (int i = 0; i < meshCount; ++i) {
        ...
        if (programInfo.hasDynamicPrimProcTextures()) {
            this->upadatePrimProcTextureBindings(programInfo.primProc(), programInfo.pipeline(),
