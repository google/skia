...
public:
    ...
    sk_sp<GrTextureProxy> createProxy(
        ...
        return this->createProxy(format, desc, renderable, origin, GrMipMapped::kNo, fit, budgeted, isProtected,
                                 surfaceFlags);
    }
    ...
    static sk_sp<GrTextureProxy> MakeFullyLazyProxy(
            LazyInstantiateCallback&&, const GrBackendFormat&, Renderable, GrProtected, GrSurfaceOrigin,
