...
public:
    ...
    sk_sp<GrTextureProxy> createTextureProxy(
            sk_sp<SkImage> srcImage, GrSurfaceDescFlags, int sampleCnt, GrFSAAType, SkBudgeted,
            SkBackingFit, GrInternalSurfaceFlags = GrInternalSurfaceFlags::kNone);
    ...
    sk_sp<GrTextureProxy> createMipMapProxy(
            const GrBackendFormat&, const GrSurfaceDesc&, GrFSAAType, GrSurfaceOrigin, SkBudgeted,
    ...
    sk_sp<GrTextureProxy> createProxy(
            const GrBackendFormat&, const GrSurfaceDesc&, GrFSAAType, GrSurfaceOrigin, GrMipMapped,
    ...
    sk_sp<GrTextureProxy> createProxy(
            ...
            GrInternalSurfaceFlags surfaceFlags = GrInternalSurfaceFlags::kNone) {
        return this->createProxy(format, desc, fsaaType, origin, GrMipMapped::kNo, fit, budgeted,
                                 surfaceFlags);
    }
     ...
     */
    sk_sp<GrTextureProxy> createProxy(sk_sp<SkData>, const GrSurfaceDesc& desc, GrFSAAType);
    ...
    sk_sp<GrTextureProxy> createLazyProxy(
            LazyInstantiateCallback&&, const GrBackendFormat&, const GrSurfaceDesc&, GrFSAAType,
            GrSurfaceOrigin, GrMipMapped, GrInternalSurfaceFlags, SkBackingFit, SkBudgeted,
    ...
    sk_sp<GrRenderTargetProxy> createLazyRenderTargetProxy(
            ...
            SkBudgeted, bool wrapsVkSecondaryCB);
    ...
    static sk_sp<GrTextureProxy> MakeFullyLazyProxy(
            ...
            GrPixelConfig, const GrCaps&, int sampleCnt = 1, GrFSAAType = GrFSAAType::kNone);
