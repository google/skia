...
#include "src/gpu/GrDrawIndirectCmd.h"
...
public:
    ...
    GrDrawIndirectCmdWriter makeSpace(int drawCount, sk_sp<const GrBuffer>* buffer,
                                      size_t* offset) {
        return this->GrBufferAllocPool::makeSpace(drawCount * sizeof(GrDrawIndirectCmd), 4, buffer,
                                                  offset);
    }

    void putBack(int drawCount) {
        this->GrBufferAllocPool::putBack(drawCount * sizeof(GrDrawIndirectCmd));
    }
    ...
    GrDrawIndexedIndirectCmdWriter makeIndexedSpace(int drawCount, sk_sp<const GrBuffer>* buffer,
        ...
        return this->GrBufferAllocPool::makeSpace(
                drawCount * sizeof(GrDrawIndexedIndirectCmd), 4, buffer, offset);
    }

    void putBackIndexed(int drawCount) {
        this->GrBufferAllocPool::putBack(drawCount * sizeof(GrDrawIndexedIndirectCmd));
    }
