...
public:
    ...
    public:
         ...
         * by the expected input to the first non-eliminated processor. Otherwise the original input
         * color is preserved. The only reason to use this is to save space on the op by not
