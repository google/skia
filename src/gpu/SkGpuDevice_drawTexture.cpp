...
static inline bool is_int(SkScalar s) { return SkScalarTruncToScalar(s) == s; }

static bool must_bilerp(const SkRect* src, const SkRect* dst, const SkMatrix& ctm) {
...
static void draw_texture_affine(const SkPaint& paint, const SkMatrix& ctm, const SkRect* src,
    ...
    switch (paint.getFilterQuality()) {
        ...
        case kLow_SkFilterQuality:
            filter = must_bilerp(src, dst, ctm) ? GrSamplerParams::kBilerp_FilterMode
