...
void SkGpuDevice::drawSpecial(SkSpecialImage* special,
    ...
    auto colorXform = GrColorSpaceXform::Make(colorInfo.colorSpace(), colorInfo.alphaType(),
    ...
    if (paint.fColorFilter) {
        ...
        auto fp = GrTextureEffect::MakeSubset(std::move(view), colorInfo.alphaType(), SkMatrix::I(),
        ...
        fRenderTargetContext->drawTexture(this->clip(), std::move(view), colorInfo.alphaType(),
