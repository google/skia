...
public:
    ...
    /**
     * A task can be marked as skippable. It must be used purely for optimization purposes
...
protected:
    ...
    enum Flags {
        ...
        kMerged_Flag    = 0x08,   //!< This task will be merged with another task in the same DAG.
