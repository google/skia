...
public:
    ...
    GrPipelineAnalysis(const GrPipelineInput& colorInput, const GrPipelineInput coverageInput, bool usesPLSDstRead = false) {
        this->reset(colorInput, coverageInput, usesPLSDstRead);
    }

    void reset(const GrPipelineInput& colorInput, const GrPipelineInput coverageInput, bool usesPLSDstRead = false) {
