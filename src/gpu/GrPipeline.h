...
public:
    ...
    // GrDstSampleType used by the render pass that this GrPipeline is used in. In other words, if
    // this GrPipeline does read the dst then this returns the general GrDstSampleType, otherwise
