...
public:
    ...
    // if this GrPipeline does read the dst the this returns the general GrDstSampleType otherwise
...
private:
    ...
    // used in (i.e. if this GrPipeline does read the dst, it will does so using this
    // GrDstSampleType).
    GrDstSampleType fDstSampleType = GrDstSampleType::kNone;
