...
public:
     ...
     * that logical rectangle to the bounds of the surface. If the rect does not intersect the
     * surface bounds or is empty then return a default GrPixmap. Otherwise, surfacePt is updated to
     * refer to the upper left of the clipped rectangle. The returned pixmap will refer to the
     * portion of the original pixmap inside the surface bounds.
     */
