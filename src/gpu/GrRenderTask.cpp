...
void GrRenderTask::addDependency(
    ...
    if (GrMipMapped::kYes == mipMapped && textureProxy->mipMapsAreDirty()) {
        ...
        // The GrTextureResolveTask constructor should have called addDependency (in this instance,
        ...
        // The GrTextureResolveTask constructors should have also marked the mipmaps clean and set
