...
public:
    ...
    uint32_t classID() const { SkASSERT(kIllegalProcessor_ClassID != fClassID); return fClassID; }

protected:
    GrProcessor()
    : fClassID(kIllegalProcessor_ClassID)
    ...
    void initClassId(ClassID classID) {
        fClassID = classID;
    }
