...
public:
    enum ClassID {
        ...
        kGrDSLTestDoStatement_ClassID,
        kGrDSLTestForStatement_ClassID,
        kGrDSLTestIfStatement_ClassID,
        kGrDSLTestSwitchStatement_ClassID,
        kGrDSLTestSwizzle_ClassID,
        kGrDSLTestTernary_ClassID,
        kGrDSLTestWhileStatement_ClassID,
