...
static const char* cache_result_to_str(int i) {
    const char* kCacheResultStrings[GrFooBar::Stats::kNumProgramCacheResults] = {
        "hits",
        "misses",
        "partials"
    };
    static_assert(0 == (int) GrFooBar::Stats::ProgramCacheResult::kHit);
    static_assert(1 == (int) GrFooBar::Stats::ProgramCacheResult::kMiss);
    static_assert(2 == (int) GrFooBar::Stats::ProgramCacheResult::kPartial);
    static_assert(GrFooBar::Stats::kNumProgramCacheResults == 3);
    return kCacheResultStrings[i];
}

void GrFooBar::Stats::dump(SkString* out) {
...
void GrFooBar::Stats::dumpKeyValuePairs(SkTArray<SkString>* keys, SkTArray<double>* values) {
