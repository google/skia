...
gr_fp<GrFragmentProcessor> MakeChildFP(GrProcessorTestData*);
...
using GrFragmentProcessorTestFactory = GrProcessorTestFactory<gr_fp<GrFragmentProcessor>>;
...
#define GR_DECLARE_FRAGMENT_PROCESSOR_TEST                        \
    ...
    static gr_fp<GrFragmentProcessor> TestCreate(GrProcessorTestData*);
