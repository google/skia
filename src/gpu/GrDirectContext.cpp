...
sk_sp<GrContext> GrContext::MakeGL(sk_sp<const GrGLInterface> interface,
    ...
    sk_sp<GrContext> context(new GrDirectContext(GrBackend::kOpenGL));
...
sk_sp<GrContext> GrContext::MakeMock(const GrMockOptions* mockOptions,
                                     const GrContextOptions& options) {
    sk_sp<GrContext> context(new GrDirectContext(GrBackend::kMock));
...
#ifdef SK_VULKAN
    GrContextOptions defaultOptions;
    sk_sp<GrContext> context(new GrDirectContext(GrBackend::kVulkan));
...
sk_sp<GrContext> GrContext::MakeMetal(void* device, void* queue, const GrContextOptions& options) {
    sk_sp<GrContext> context(new GrDirectContext(GrBackend::kMetal));
