...
class GrRingBuffer {
public:
    static std::unique_ptr<GrRingBuffer> Make(GrGpu* gpu, size_t size, size_t alignment,
                                    GrGpuBufferType intendedType) {
        return std::unique_ptr<GrRingBuffer>(new GrRingBuffer(gpu, size, alignment, intendedType));
    }
