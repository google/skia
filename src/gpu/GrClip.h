...
public:
     ...
     * are returned in the 'pathsForClipAtlas' array. The caller is responsible to add the atlas
     * clip FPs to the GrAppliedClip once they know exactly which opsTask the atlas will come from.
     *
     * If atlas clips are not supported, pathsForClipAtlas must be null.
     */
