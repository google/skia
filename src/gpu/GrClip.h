...
public:
     ...
     */
    virtual Effect apply(GrRecordingContext*, GrSurfaceDrawContext*, const GrOp* opBeingClipped,
...
private:
    Effect apply(GrRecordingContext*, GrSurfaceDrawContext* rtc, const GrOp* opBeingClipped,
