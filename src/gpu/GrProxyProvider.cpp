...
sk_sp<GrSurfaceProxy> GrProxyProvider::wrapBackendRenderTarget(
    ...
    return sk_sp<GrRenderTargetProxy>(new GrRenderTargetProxy(std::move(rt), origin, outSwizzle));
}
...
sk_sp<GrSurfaceProxy> GrProxyProvider::wrapBackendTextureAsRenderTarget(
    ...
    return sk_sp<GrSurfaceProxy>(new GrRenderTargetProxy(std::move(rt), origin, outSwizzle));
}
...
sk_sp<GrRenderTargetProxy> GrProxyProvider::wrapVulkanSecondaryCBAsRenderTarget(
    ...
    return sk_sp<GrRenderTargetProxy>(
            new GrRenderTargetProxy(std::move(rt),
                                    kTopLeft_GrSurfaceOrigin, outSwizzle,
...
sk_sp<GrRenderTargetProxy> GrProxyProvider::createLazyRenderTargetProxy(
    ...
    return sk_sp<GrRenderTargetProxy>(new GrRenderTargetProxy(
            std::move(callback), lazyType, format, desc, origin, outSwizzle, fit, budgeted,
            surfaceFlags, vkSCB));
}
