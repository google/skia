...
sk_sp<GrTextureProxy> GrProxyProvider::wrapCompressedBackendTexture(const GrBackendTexture& backendTex,
                                                                    GrSurfaceOrigin origin,
                                                                    GrWrapOwnership ownership,
                                                                    GrWrapCacheable cacheable,
                                                                    ReleaseProc releaseProc,
    ...
    sk_sp<GrTexture> tex =
        resourceProvider->wrapCompressedBackendTexture(backendTex,
                                                       ownership, cacheable, kRead_GrIOType);
    if (!tex) {
        return nullptr;
    }
