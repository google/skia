...
sk_sp<GrTextureProxy> GrBackendTextureImageGenerator::onGenerateTexture(
    ...
    GrPixelConfig config1 = caps->getConfigFromBackendFormat(backendFormat, grColorType);
    if (kUnknown_GrPixelConfig == config1) {
        return nullptr;
    }

    SkASSERT(GrCaps::AreConfigsCompatible(fBackendTexture.config1(),
    ...
    sk_sp<GrTextureProxy> proxy = proxyProvider->createLazyProxy(
            ...
            backendFormat, desc, fSurfaceOrigin, mipMapped, GrInternalSurfaceFlags::kReadOnly,
