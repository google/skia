...
inline GrAAType GrSurfaceDrawContext::chooseAAType(GrAA aa) {
    if (fCanUseDynamicMSAA) {
        // Always trigger dmsaa. The coverage ops that know how to handle both single and
        // multisample targets without popping will do so without calling chooseAAType.
