...
void GrSurfaceDrawContext::drawQuadSet(const GrClip* clip, GrPaint&& paint, GrAA aa,
...
bool GrSurfaceDrawContext::blitTexture(GrSurfaceProxyView view, const SkIRect& srcRect,
