 ...
 */
class GrSWMaskHelper : SkNoncopyable, public SkNVRefCnt<GrSWMaskHelper> {
public:
...
private:
    ...
    // Note: The task group fn & lazy callback will ref spThis.
    GrSurfaceProxyView threadedExecute(sk_sp<GrSWMaskHelper> spThis,
                                       SkTaskGroup*,
                                       GrRecordingContext*,
                                       SkBackingFit,
                                       DrawFunc&&);
