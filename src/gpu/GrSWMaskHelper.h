...
public:
    ...
    enum class TextureType { kExactFit, kApproximateFit };

    // Canonical usage utility that draws a single path and uploads it
    // to the GPU. The result is returned.
    static GrTexture* DrawShapeMaskToTexture(GrTextureProvider*, const GrShape&,
                                             const SkIRect& resultBounds, bool antiAlias,
                                             TextureType, const SkMatrix* matrix);
    ...
    static void DrawToTargetWithShapeMask(GrTexture* texture, GrRenderTargetContext*,
                                          const GrPaint& paint,
