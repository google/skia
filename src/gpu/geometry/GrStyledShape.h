...
public:
    ...
    explicit GrStyledShape(const SkPath& path, SimplifyStroke simplifyStroke = SimplifyStroke::kYes)
            : GrStyledShape(path, GrStyle::SimpleFill(), simplifyStroke) {}

    explicit GrStyledShape(const SkRRect& rrect,
                           SimplifyStroke simplifyStroke = SimplifyStroke::kYes)
            : GrStyledShape(rrect, GrStyle::SimpleFill(), simplifyStroke) {}

    explicit GrStyledShape(const SkRect& rect, SimplifyStroke simplifyStroke = SimplifyStroke::kYes)
            : GrStyledShape(rect, GrStyle::SimpleFill(), simplifyStroke) {}
