...
private:
    ...
    int32_t         fGenID      = 0;
    // Whether or not the shape or style were simplified. This is used by GrRenderTargetContext to
    // know if it should re-attempt optimized shape rendering, since the new state could match an op
