...
public:
    ...
    void asPath(SkPath* out) const {
        fShape.asPath(out, this->style().isSimpleFill());
    }
    ...
    bool inverseFilled() const {
        // Since the path tracks invertes-fillness itself, it should match what was recorded.
...
private:
    ...
    void simplify();
    void applySimpleStroke(bool originallyClosed);
