...
bool GrShape::simplify(unsigned flags, bool* originallyClosed) {
    Type oldType = this->type();
    // Sanity check that winding parameters are valid for the current type.
    SkASSERT((oldType == Type::kRect || oldType == Type::kRRect) ||
