...
#if GR_TEST_UTILS
    // Unfortunately we don't have a way to static_assert this, but we can runtime assert during
    // Skia testing that the kIEEE_one_minus_2_epsilon bits are correct.
