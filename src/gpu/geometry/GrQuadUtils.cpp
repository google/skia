...
TessellationHelper::EdgeEquations TessellationHelper::getEdgeEquations(const EdgeVectors& edgeVectors) const {
...
TessellationHelper::OutsetRequest TessellationHelper::getOutsetRequest(
    ...
    V4f cosTheta = mad(edgeVectors.fDX,
                   next_cw(edgeVectors.fDX),
...
V4f TessellationHelper::getDegenerateCoverage(const V4f& px, const V4f& py, const EdgeEquations& edges) {
...
V4f TessellationHelper::adjustVertices(const OutsetRequest& outsetRequest,
    ...
    // Get signed outsets after from cached outset request (which is unsigned)
