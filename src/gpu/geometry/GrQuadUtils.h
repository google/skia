...
namespace GrQuadUtils {
    ...
    private:
        ...
        struct OutsetRequest {
            ...
            // signed distance is determined by the actual function call, storing unsigned allows
            // calculations to be shared between insets and outsets).
            ...
            // If degenerate, fOutsets might produce invalid geometry.
            bool fDegenerate;
        };
        ...
        skvx::Vec<4, float> adjustVertices(const OutsetRequest& outsetRequest,
                                           ...
                                           Vertices* vertices);
        // Store the vertex data in this struct into 'deviceOut' and 'localOut'. If uvrCount is
        // 0 this ignores localOut, otherwise localOut must be non-null.
