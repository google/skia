...
namespace GrQuadUtils {
    ...
    private:
        ...
        struct Vertices {
            ...
            // inset by that distance instead. 'signedOutsets' scales the corner's edge vector,
            // 'signedOutsetsCW' scales the corner's cw-rotated edge vector.
        ...
        struct OutsetRequest {
            // Unsigned edge distances to move each edge of the quad. These distances represent the
            ...
            // Amount to move along each edge vector to outset a corner (or inset if mul. by -1).
            // (the signed distance is determined by the actual function call, storing unsigned
