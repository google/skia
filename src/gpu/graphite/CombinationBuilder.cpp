...
public:
    ...
    public:
        ...
        void addToKey(const SkKeyContext&, int desiredCombination, PaintParamsKeyBuilder*);
...
private:
    ...
    void beginBlock(const SkKeyContext&, int intrinsicCombination, PaintParamsKeyBuilder*) const;
