...
private:
    ...
    GrSurfaceProxyView internalAdd(const GrUniqueKey&, const GrSurfaceProxyView&)  SK_REQUIRES(fSpinLock);
    ...
    SkTHashMap<const GrUniqueKey*, Entry*, foo> fUniquelyKeyedProxyViews  SK_GUARDED_BY(fSpinLock);
};
