...
#ifndef GrDeferredTextureUploads_DEFINED
#define GrDeferredTextureUploads_DEFINED
...
/** A deferred upload is simply a std::function that takes a WritePixelsFn as a parameter. It is
 * called when it should perform its upload in the draw/upload sequence. */
