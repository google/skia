...
public:
    ...
    sk_sp<SkCachedData> getPlanes(SkYUVSizeInfo*, SkYUVColorSpace*, void* planes[3]);
...
private:
     ...
     */
    virtual bool onQueryYUV81(SkYUVSizeInfo* sizeInfo, SkYUVColorSpace* colorSpace) const = 0;
     ...
     */
    virtual bool onGetYUV8Planes1(const SkYUVSizeInfo& sizeInfo, void* planes[3]) = 0;
