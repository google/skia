...
GrBackendTexture::GrBackendTexture(int width, int height, const GrVkImageInfo& vkInfo)
        : GrBackendTexture(width, height, vkInfo,
                           sk_sp<GrBackendMutableStateImpl>(
                                   new GrBackendMutableStateImpl(vkInfo.fImageLayout,
                                                                 vkInfo.fCurrentQueueFamily))) {}
...
sk_sp<GrBackendMutableStateImpl> GrBackendTexture::getMutableState() const { return fMutableState; }
...
void GrBackendTexture::setBackendMutableState(const GrBackendMutableState& state) {
...
GrBackendRenderTarget::GrBackendRenderTarget(int width,
                                             ...
                                             const GrVkImageInfo& vkInfo)
        : GrBackendRenderTarget(width, height, sampleCnt, vkInfo,
                                sk_sp<GrBackendMutableStateImpl>(new GrBackendMutableStateImpl(
...
sk_sp<GrBackendMutableStateImpl> GrBackendRenderTarget::getMutableState() const {
...
void GrBackendRenderTarget::setBackendMutableState(const GrBackendMutableState& state) {
    fMutableState->set(state);
}
