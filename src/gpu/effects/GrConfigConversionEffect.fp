...
@class {
    static bool TestForPreservingPMConversions(GrContext* context) {
        ...
        auto textureFP = GrSimpleTextureEffect::Make(
                dataProxy, kPremul_SkAlphaType, SkBlendMode::kSrc, SkMatrix::I());
        ...
        textureFP = GrSimpleTextureEffect::Make(
                readRTC->asTextureProxyRef(), kUnpremul_SkAlphaType, SkBlendMode::kSrc, SkMatrix::I());
        ...
        textureFP = GrSimpleTextureEffect::Make(
                tempRTC->asTextureProxyRef(), kPremul_SkAlphaType, SkBlendMode::kSrc, SkMatrix::I());
