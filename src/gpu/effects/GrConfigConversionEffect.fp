...
@class {
    static bool TestForPreservingPMConversions(GrContext* context) {
        ...
        paint2.addColorTextureProcessor(readRTC->asTextureProxyRef(), kUnpremul_SkAlphaType, SkMatrix::I());
        ...
        paint3.addColorTextureProcessor(tempRTC->asTextureProxyRef(), kPremul_SkAlphaType, SkMatrix::I());
