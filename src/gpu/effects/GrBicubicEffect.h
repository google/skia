...
public:
    ...
    /**
     * Make a Mitchell filter of a another fragment processor. The discrete samples in the passed
     * processor that the bicubic should interpolate are assumed to be at half-integer coords.
     */
