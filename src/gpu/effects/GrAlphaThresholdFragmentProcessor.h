...
/**************************************************************************************************
 *** This file was autogenerated from GrAlphaThresholdFragmentProcessor.fp; do
 *not modify.
 **************************************************************************************************/
 ...
 public:
  ...
  static std::unique_ptr<GrFragmentProcessor> Make(sk_sp<GrTextureProxy> mask,
    ...
    return std::unique_ptr<GrFragmentProcessor>(
        new GrAlphaThresholdFragmentProcessor(mask, innerThreshold,
                                              outerThreshold, bounds));
  }
