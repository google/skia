...
class GrGLSLConfigConversionEffect : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    const GrConfigConversionEffect& _outer =
    ...
    fragBuilder->codeAppendf(
        ...
        "break;\n    case 1:\n        %s.xyz = %s.w <= 0.0 ? half3(0.0) : "
        "floor((%s.xyz / %s.w) * 255.0 + 0.5) / 255.0;\n        break;\n}\n",
...
GrGLSLFragmentProcessor* GrConfigConversionEffect::onCreateGLSLInstance()
    const {
...
bool GrConfigConversionEffect::onIsEqual(
...
GrConfigConversionEffect::GrConfigConversionEffect(
    const GrConfigConversionEffect& src)
...
std::unique_ptr<GrFragmentProcessor> GrConfigConversionEffect::clone() const {
  return std::unique_ptr<GrFragmentProcessor>(
      new GrConfigConversionEffect(*this));
}
...
std::unique_ptr<GrFragmentProcessor> GrConfigConversionEffect::TestCreate(
  ...
  return std::unique_ptr<GrFragmentProcessor>(
      new GrConfigConversionEffect(pmConv));
}
#endif
