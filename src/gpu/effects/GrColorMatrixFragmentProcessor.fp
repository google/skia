...
@make {
    static std::unique_ptr<GrFragmentProcessor> Make(const float matrix[20], bool unpremulInput, bool clampOutput, bool premulOutput) {
        const float m[] {
        ...
        return std::unique_ptr<GrFragmentProcessor>(new GrColorMatrixFragmentProcessor(m44, v4, unpremulInput, clampOutput, premulOutput));
    }
}
