...
void GrBicubicEffect::Impl::onSetData(const GrGLSLProgramDataManager& pdm,
    ...
    switch (bicubicEffect.fKernel) {
        case Kernel::kMitchell: {
            ...
            */
            static constexpr SkM44 kMitchell( 1.0/18.f, -9.0/18.f,  15.0/18.f,  -7.0/18.f,
                                             16.0/18.f,  0.0/18.f, -36.0/18.f,  21.0/18.f,
                                              1.0/18.f,  9.0/18.f,  27.0/18.f, -21.0/18.f,
                                              0.0/18.f,  0.0/18.f,  -6.0/18.f,   7.0/18.f);
            coeffs = &kMitchell;
            break;
        }
