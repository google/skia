    ...
    public:
        void emitCode(EmitArgs& args) override {
            ...
            if (te.fShaderModes[0] == ShaderMode::kNone &&
                ...
                // on whether both modes are kRepeat whether we're near a single subset edge
                // or a corner.
                const char* ifStr = "if";
                if (filterLogic[0] == FilterLogic::kRepeatBilerp &&
                ...
                // Do soft edge shader filtering against transparent black for kDecalFilter.
                ...
                // Do hard-edge shader transition to transparent black for kDecalNearest.
