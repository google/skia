    ...
    public:
        void emitCode(EmitArgs& args) override {
            ...
            if (te.fShaderModes[0] == ShaderMode::kNone &&
                ...
                auto modeRequiesUnormCoords = [](ShaderMode m) {
                  switch (m) {
                      case ShaderMode::kNone:                     return false;
                      case ShaderMode::kClamp:                    return false;
                      case ShaderMode::kRepeatNearest:            return true;
                ...
                const char* norm = nullptr;
                if (normCoords && (modeRequiesUnormCoords(m[0]) || modeRequiesUnormCoords(m[1]))) {
...
inline bool GrTextureEffect::hasClampToBorderShaderMode() const {
