                    ...
                    switch (mode) {
                        ...
                        case ShaderMode::kRepeat:
                            if (filter == Filter::kMipMap) {
                                ...
                                // that blends between the two near the reflection points. The
                                // weight is also a saw-tooth function shifted from the coord
                                // saw-tooth, vertically shifted, and clamped to 0..1.
                                SkASSERT(extraCoord);
