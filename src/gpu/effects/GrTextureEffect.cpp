    ...
    public:
        void emitCode(EmitArgs& args) override {
            ...
            if (te.fShaderModes[0] == ShaderMode::kNone &&
                ...
                auto modeUsesSubset = [filter](ShaderMode m) {
                ...
                if (m[0] == m[1]) {
                    ...
                    appendWrap(fb, m[0], "inCoords", start.c_str(), end.c_str(), true,
                               "subsetCoord");
                    ...
                    appendWrap(fb, m[0], "inCoords.x", start.c_str(), end.c_str(), false,
                               "subsetCoord.x");
                    // Repeat the same logic for y.
                    start.printf("%s.y", subsetName);
                    end.printf("%s.w", subsetName);
                    appendWrap(fb, m[1], "inCoords.y", start.c_str(), end.c_str(), false,
                               "subsetCoord.y");
