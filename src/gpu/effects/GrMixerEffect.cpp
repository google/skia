...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        fragBuilder->codeAppendf("half4 in0 = %s;\nif (%s) {", _child0.c_str(),
        ...
        fragBuilder->codeAppendf(
                "\n    %s = mix(in0, %s, %s);\n} else {\n    %s = mix(in0, %s, %s);\n}\n",
                args.fOutputColor, _child1.c_str(),
                args.fUniformHandler->getUniformCStr(fWeightVar), args.fOutputColor,
                args.fInputColor, args.fUniformHandler->getUniformCStr(fWeightVar));
    }
