...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        fragBuilder->codeAppendf("%s = mix(%s, %s, %s);\n", args.fOutputColor, _child0.c_str(),
                                 _child1.c_str(), args.fUniformHandler->getUniformCStr(fWeightVar));
    }
...
GrMixerEffect::GrMixerEffect(const GrMixerEffect& src)
        : INHERITED(kGrMixerEffect_ClassID, src.optimizationFlags()), fWeight(src.fWeight) {
