...
/**************************************************************************************************
 *** This file was autogenerated from GrBlurredEdgeFragmentProcessor.fp; do not
 *modify.
 **************************************************************************************************/
...
GrGLSLFragmentProcessor* GrBlurredEdgeFragmentProcessor::onCreateGLSLInstance()
    const {
...
bool GrBlurredEdgeFragmentProcessor::onIsEqual(
  ...
  const GrBlurredEdgeFragmentProcessor& that =
      other.cast<GrBlurredEdgeFragmentProcessor>();
  (void)that;
...
GrBlurredEdgeFragmentProcessor::GrBlurredEdgeFragmentProcessor(
    ...
    : INHERITED(kGrBlurredEdgeFragmentProcessor_ClassID,
                src.optimizationFlags()),
      fMode(src.fMode) {}
std::unique_ptr<GrFragmentProcessor> GrBlurredEdgeFragmentProcessor::clone()
    const {
  return std::unique_ptr<GrFragmentProcessor>(
      new GrBlurredEdgeFragmentProcessor(*this));
}
