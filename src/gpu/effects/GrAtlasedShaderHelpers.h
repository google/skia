...
static void append_index_uv_varyings(GrGLSLPrimitiveProcessor::EmitArgs& args,
                                     ...
                                     GrGLSLVertToFrag *st) {
    SkDebugf("append_index_uv_varyings: in\n");
    ...
    SkDebugf("append_index_uv_varyings: out\n");
}
...
static void append_multitexture_lookup(GrGLSLPrimitiveProcessor::EmitArgs& args,
    ...
    SkDebugf("append_multitexture_lookup: in\n");
    ...
    SkDebugf("append_multitexture_lookup: out\n");
}
