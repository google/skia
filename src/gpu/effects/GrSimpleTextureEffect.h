...
private:
    ...
    GrSimpleTextureEffect(sk_sp<GrTextureProxy> proxy,
                          ...
                          const SkMatrix& matrix,
                          GrSamplerParams::FilterMode filterMode)
        : GrSingleTextureEffect(std::move(proxy), std::move(colorSpaceXform), matrix, filterMode) {
        this->initClassID<GrSimpleTextureEffect>();
    }
    ...
    GrSimpleTextureEffect(sk_sp<GrTextureProxy> proxy,
                          ...
                          const SkMatrix& matrix,
                          const GrSamplerParams& params)
        : GrSingleTextureEffect(std::move(proxy), std::move(colorSpaceXform), matrix, params) {
        this->initClassID<GrSimpleTextureEffect>();
    }
