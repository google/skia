...
public:
    ...
    static sk_sp<GrFragmentProcessor> Make(GrTexture* tex,
        ...
        return sk_sp<GrFragmentProcessor>(
            new GrSimpleTextureEffect(tex, std::move(colorSpaceXform), matrix, bFoo,
    ...
    static sk_sp<GrFragmentProcessor> Make(GrTexture* tex,
        ...
        return sk_sp<GrFragmentProcessor>(
            new GrSimpleTextureEffect(tex, std::move(colorSpaceXform), matrix, bFoo, filterMode));
    }
...
private:
    ...
    GrSimpleTextureEffect(GrTexture* texture,
        ...
        : GrSingleTextureEffect(texture, std::move(colorSpaceXform), matrix, bFoo, params) {
        this->initClassID<GrSimpleTextureEffect>();
    }
