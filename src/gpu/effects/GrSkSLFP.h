...
private:
    ...
    static void checkArgs(uniform_iterator uIter,
        ...
        // does not use it. checkArgs is called to verify the accompanying names, before appendArgs
        // is called to do the real work. We leave it intact, and our caller (Make) will pass
        // another rvalue reference to appendArgs, which will then move it to call addChild.
