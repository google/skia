...
class GrRuntimeFPBuilder
        : public SkRuntimeEffectBuilder_Base<std::unique_ptr<GrFragmentProcessor>> {
public:
    ~GrRuntimeFPBuilder();
...
private:
    ...
    using INHERITED = SkRuntimeEffectBuilder_Base<std::unique_ptr<GrFragmentProcessor>>;
};
