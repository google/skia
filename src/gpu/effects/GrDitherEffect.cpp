...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        (void) _outer;
        fragBuilder->codeAppendf("float r = 2.0 * fract(sin(dot(sk_FragCoord.xy, vec2(12.989800000000001, 78.233000000000004))) * 43758.545299999998) - 0.5;\n%s = clamp(0.0019607843137254902 * vec4(r) + %s, 0.0, 1.0);\n", args.fOutputColor, args.fInputColor ? args.fInputColor : "vec4(1)");
    }
private:
