...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        Var _x(kNo_Modifier, DSLType(kInt_Type), "x");
        Var _y(kNo_Modifier, DSLType(kInt_Type), "y");
        Var _m(kNo_Modifier, DSLType(kInt_Type), "m");
        ...
        StaticIf(
                ...
                /*Then:*/
                Block(Declare(_x, Int(sk_FragCoord().x())),
                      Declare(_y, Int(sk_FragCoord().y()) ^ _x),
                      Declare(_m,
