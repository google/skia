...
public:
    static bool TestForPreservingPMConversions(GrContext* context) {
        ...
        readRTC->fillRectToRect(nullptr, std::move(paint1), GrAA::kNo, SkMatrix::I(), kRect,
                                kRect);
        ...
        tempRTC->fillRectToRect(nullptr, std::move(paint2), GrAA::kNo, SkMatrix::I(), kRect,
                                kRect);
        ...
        readRTC->fillRectToRect(nullptr, std::move(paint3), GrAA::kNo, SkMatrix::I(), kRect,
                                kRect);
