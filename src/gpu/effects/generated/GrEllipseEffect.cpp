...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        fragBuilder->codeAppendf(
                ...
                "0.0, 1.0);\n        break;\n    default:\n        discard;\n}",
                (int)_outer.edgeType);
        SkString _input4620 = SkStringPrintf("%s", args.fInputColor);
        SkString _sample4620;
        if (_outer.inputFP_index >= 0) {
            _sample4620 = this->invokeChild(_outer.inputFP_index, _input4620.c_str(), args);
        } else {
            _sample4620 = _input4620;
        }
        fragBuilder->codeAppendf("\nhalf4 inputColor = %s;\n%s = inputColor * alpha;\n",
                                 _sample4620.c_str(), args.fOutputColor);
    }
