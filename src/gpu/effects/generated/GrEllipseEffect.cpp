...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        fragBuilder->codeAppendf(
                ...
                "discard;\n}",
                (int)_outer.edgeType);
        SkString _input4506 = SkStringPrintf("%s", args.fInputColor);
        SkString _sample4506;
        if (_outer.inputFP_index >= 0) {
            _sample4506 = this->invokeChild(_outer.inputFP_index, _input4506.c_str(), args);
        } else {
            _sample4506 = _input4506;
        }
        fragBuilder->codeAppendf("\nhalf4 inputColor = %s;\n%s = inputColor * alpha;\n",
                                 _sample4506.c_str(), args.fOutputColor);
    }
