...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        SkString _input1354 = SkStringPrintf("%s", args.fInputColor);
        SkString _sample1354;
        if (_outer.inputFP_index >= 0) {
            _sample1354 = this->invokeChild(_outer.inputFP_index, _input1354.c_str(), args);
        } else {
            _sample1354 = "half4(1)";
        }
        ...
        fragBuilder->codeAppendf(
                ...
                "color.xyz *= scale;\n    color.w = %s;\n}\n%s = color;\n",
                _outer.inputFP_index >= 0 ? "true" : "false", _sample1354.c_str(), args.fInputColor,
