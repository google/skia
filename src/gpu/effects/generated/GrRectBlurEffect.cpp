...
@if (%s) {
    ...
    @if (highp) {
        ...
        _sample7211 = this->invokeChild(1, args, _coords7211.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
    xCoverage = %s.w;)SkSL",
                _sample7211.c_str());
        ...
        _sample7269 = this->invokeChild(1, args, _coords7269.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
    yCoverage = %s.w;
} else {
    ...
    @if (highp) {
        ...
        _sample8636 = this->invokeChild(1, args, _coords8636.c_str());
        SkString _coords8699("float2(half2(rect.z, 0.5))");
        SkString _sample8699;
        _sample8699 = this->invokeChild(1, args, _coords8699.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
    xCoverage = (1.0 - %s.w) - %s.w;)SkSL",
        ...
        _sample8763 = this->invokeChild(1, args, _coords8763.c_str());
        SkString _coords8826("float2(half2(rect.w, 0.5))");
        SkString _sample8826;
        _sample8826 = this->invokeChild(1, args, _coords8826.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
    yCoverage = (1.0 - %s.w) - %s.w;
        ...
        if (_outer.childProcessor(0)) {
            _sample8895 = this->invokeChild(0, _input8895.c_str(), args);
        } else {
