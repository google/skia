...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        fragBuilder->codeAppendf(
                ...
                "= 0.4375 + ((-y3 / 6.0 - (3.0 * y2) * 0.25) - 1.125 * y);\n}\nyCoverage = "
                "clamp(yCoverage, 0.0, 1.0);\n%s = (%s * xCoverage) * yCoverage;\n",
