...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        Var _enforcePMColor(kConst_Modifier, DSLType(kBool_Type), "enforcePMColor");
        Declare(_enforcePMColor, Bool(!!(enforcePMColor)));
        Var _k(kUniform_Modifier, DSLType(kFloat4_Type), "k");
        kVar = VarUniformHandle(_k);
        DeclareGlobal(_k);
        Var _src(kNo_Modifier, DSLType(kHalf4_Type), "src");
        Var _dst(kNo_Modifier, DSLType(kHalf4_Type), "dst");
        Var _color(kNo_Modifier, DSLType(kHalf4_Type), "color");
        Declare(_src, SampleChild(0));
        Declare(_dst, SampleChild(1));
        Declare(_color,
