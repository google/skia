...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        Var _sigma(kConst_Modifier, DSLType(kFloat_Type), "sigma", Float(sigma));
        Declare(_sigma);
        ...
        Var _translatedFragPosFloat(kNo_Modifier,
                                    DSLType(kFloat2_Type),
                                    "translatedFragPosFloat",
                                    Swizzle(sk_FragCoord(), X, Y) - Swizzle(_proxyRect, X, Y));
        Var _proxyCenter(kNo_Modifier,
                         DSLType(kFloat2_Type),
                         "proxyCenter",
                         (Swizzle(_proxyRect, Z, W) - Swizzle(_proxyRect, X, Y)) * 0.5f);
        Var _edgeSize(kNo_Modifier,
                      DSLType(kHalf_Type),
                      "edgeSize",
                      (2.0f * _blurRadius + _cornerRadius) + 0.5f);
        Var _fragDirection(kNo_Modifier,
                           DSLType(kHalf2_Type),
                           "fragDirection",
                           Half2(Sign(_translatedFragPosFloat)));
        Var _translatedFragPosHalf(
                kNo_Modifier,
                DSLType(kHalf2_Type),
                "translatedFragPosHalf",
                Half2(_translatedFragPosFloat - (_proxyCenter - Float(_edgeSize))));
        Var _proxyDims(kNo_Modifier, DSLType(kHalf2_Type), "proxyDims", Half2(2.0f * _edgeSize));
        Var _texCoord(kNo_Modifier,
                      DSLType(kHalf2_Type),
                      "texCoord",
                      _translatedFragPosHalf / _proxyDims);
        Declare(_translatedFragPosFloat);
        Declare(_proxyCenter);
        Declare(_edgeSize);
        _translatedFragPosFloat -= _proxyCenter;
        Declare(_fragDirection);
