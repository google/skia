...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        fragBuilder->codeAppendf(
                "@if (%s) {\n    %s = half4(clamp(%s.xyz, 0.0, %s.w), %s.w);\n} else {\n    %s = "
                "clamp(%s, 0.0, 1.0);\n}\n",
                (_outer.clampToPremul ? "true" : "false"), args.fOutputColor, args.fInputColor,
                args.fInputColor, args.fInputColor, args.fOutputColor, args.fInputColor);
    }
