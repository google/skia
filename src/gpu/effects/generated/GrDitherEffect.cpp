...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        (void)range;
        SkString _input430(args.fInputColor);
        SkString _sample430;
        _sample430 = this->invokeChild(_outer.inputFP_index, _input430.c_str(), args);
...
%s = half4(clamp(color.xyz + value * %f, 0.0, color.w), color.w);
                ...
                _sample430.c_str(), args.fOutputColor, _outer.range);
    }
