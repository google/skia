...
public:
    static sk_sp<GrTextureProxy> CreateBlurProfileTexture(GrProxyProvider* proxyProvider,
                                                          float sigma) {
        // The "profile" we are caclulating is the integral of a Gaussian with 'sigma' and a half
        // plane. All blur profiles are just scales of each other. So all we really care about is
