...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        SkString _sample5937;
        _sample5937 = this->invokeChild(_outer.inputFP_index, args);
...
@switch (%d) {
    ...
    case 1:
        ...
        break;
                ...
                args.fOutputColor, _sample5937.c_str(), (int)_outer.pmConversion, args.fOutputColor,
