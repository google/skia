...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        fragBuilder->codeAppendf(
                "half3 hsl = %s.xyz;\n\nhalf3 p = abs(fract(hsl.xxx + half3(0.0, "
                "0.66666666666666663, 0.33333333333333331).xyz) * 6.0 - 3.0);\nhalf3 rgb = clamp(p "
                "- 1.0, 0.0, 1.0);\nhalf C = (1.0 - abs(2.0 * hsl.z - 1.0)) * hsl.y;\n%s.xyz = "
                "(rgb - 0.5) * C + hsl.z;\n%s.w = %s.w;\n%s = clamp(%s, 0.0, 1.0);\n%s.xyz *= "
                "%s.w;\n",
                args.fInputColor, args.fOutputColor, args.fOutputColor, args.fInputColor,
