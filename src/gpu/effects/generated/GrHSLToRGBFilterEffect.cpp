...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        fragBuilder->codeAppendf(
                "half3 hsl = %s.xyz;\n\nhalf3 rgb = clamp(abs(fract(hsl.xxx + half3(0.0, "
                "0.66666666666666663, 0.33333333333333331)) * 6.0 - 3.0) - 1.0, 0.0, 1.0);\nhalf C "
                "= (1.0 - abs(2.0 * hsl.z - 1.0)) * hsl.y;\n%s = clamp(half4((rgb - 0.5) * C + "
                "hsl.z, %s.w), 0.0, 1.0);\n%s.xyz *= %s.w;\n",
