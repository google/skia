...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        kVar = args.fUniformHandler->addUniform(&_outer, kFragment_GrShaderFlag, kFloat4_GrSLType,
                                                "k");
        SkString _sample386 = this->invokeChild(0, args);
        fragBuilder->codeAppendf(
                R"SkSL(half4 src = %s;)SkSL", _sample386.c_str());
        SkString _sample417 = this->invokeChild(1, args);
        fragBuilder->codeAppendf(
                R"SkSL(
half4 dst = %s;
...
return %s;
                ...
                _sample417.c_str(), args.fOutputColor, args.fUniformHandler->getUniformCStr(kVar),
