...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        fragBuilder->codeAppendf(R"SkSL(half4 inputColor = %s;
@if (%s) {
...
@if (%s) {
    %s.xyz *= %s.w;
                                 ...
                                 _sample585.c_str(), (_outer.unpremulInput ? "true" : "false"),
                                 args.fOutputColor, args.fUniformHandler->getUniformCStr(mVar),
                                 args.fUniformHandler->getUniformCStr(vVar),
                                 (_outer.clampRGBOutput ? "true" : "false"), args.fOutputColor,
                                 args.fOutputColor, args.fOutputColor, args.fOutputColor,
                                 (_outer.premulOutput ? "true" : "false"), args.fOutputColor,
                                 args.fOutputColor);
    }
