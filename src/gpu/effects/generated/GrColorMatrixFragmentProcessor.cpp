...
@if (%s) {
    half4 _inlineResult0;
    half4 _inlineArg1_0 = inputColor;
    {
        _inlineResult0 = half4(_inlineArg1_0.xyz / max(_inlineArg1_0.w, 9.9999997473787516e-05), _inlineArg1_0.w);
    }
    inputColor = _inlineResult0;
