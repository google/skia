...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        fragBuilder->codeAppendf(
                ...
                args.fUniformHandler->getUniformCStr(circleVar),
                args.fUniformHandler->getUniformCStr(circleVar));
        SkString _input2589 = SkStringPrintf("%s", args.fInputColor);
        SkString _sample2589;
        if (_outer.inputFP_index >= 0) {
            _sample2589 = this->invokeChild(_outer.inputFP_index, _input2589.c_str(), args);
        } else {
            _sample2589 = "half4(1)";
        }
        fragBuilder->codeAppendf(
                ...
                "half4(0.0);\n}\n",
                _outer.inputFP_index >= 0 ? "true" : "false", _sample2589.c_str(), args.fInputColor,
                (int)_outer.edgeType, (int)_outer.edgeType, (int)_outer.edgeType, args.fOutputColor,
                args.fOutputColor);
    }
