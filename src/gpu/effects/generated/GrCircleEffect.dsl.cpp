    ...
    void emitCode(EmitArgs& args) override {
        ...
        If(_edgeType == 2 || _edgeType == 3,
           ...
           Block(_d = Half((Length((Swizzle(_circle, X, Y) - Swizzle(sk_FragCoord(), X, Y)) *
                           ...
                           _circle.z())),
           /*Else:*/
           Block(_d = Half((1.0f - Length((Swizzle(_circle, X, Y) - Swizzle(sk_FragCoord(), X, Y)) *
                                          _circle.w())) *
                           _circle.z())));
        Declare(_inputColor);
        If(_edgeType == 1 || _edgeType == 3,
           /*Then:*/ Block(Return(_inputColor * Saturate(_d))),
           /*Else:*/
           Block(Return(Select(_d > 0.5f, /*If True:*/ _inputColor, /*If False:*/ Half4(0.0f)))));
