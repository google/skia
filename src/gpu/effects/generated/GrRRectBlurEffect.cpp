...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        SkString _input8210 = SkStringPrintf("%s", args.fInputColor);
        SkString _sample8210;
        if (_outer.inputFP_index >= 0) {
            _sample8210 = this->invokeChild(_outer.inputFP_index, _input8210.c_str(), args);
        } else {
            _sample8210 = _input8210;
        }
        fragBuilder->codeAppendf(
                "\nhalf4 inputColor = %s;\n%s = inputColor * sample(%s, float2(texCoord)).%s;\n",
                _sample8210.c_str(), args.fOutputColor,
