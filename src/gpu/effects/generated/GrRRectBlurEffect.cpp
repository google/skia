...
static GrSurfaceProxyView create_mask_on_gpu(GrRecordingContext* rContext,
                                             const SkRRect& rrectToDraw,
                                             const SkISize& dimensions,
                                             float xformedSigma) {
    auto rtc = GrRenderTargetContext::MakeWithFallback(
            rContext, GrColorType::kAlpha_8, nullptr, SkBackingFit::kExact, dimensions, 1,
    ...
    auto rtc2 = SkGpuBlurUtils::GaussianBlur(rContext,
                                             std::move(srcView),
...
#else
    auto threadSafeViewCache = context->priv().threadSafeViewCache();
