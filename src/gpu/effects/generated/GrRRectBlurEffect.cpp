...
half2 texCoord = translatedFragPosHalf / proxyDims;)SkSL",
        ...
        SkString _sample17283 = this->invokeChild(0, args);
        fragBuilder->codeAppendf(
                R"SkSL(
half4 inputColor = %s;)SkSL",
                _sample17283.c_str());
        SkString _coords17331("float2(texCoord)");
        SkString _sample17331 = this->invokeChild(1, args, _coords17331.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
%s = inputColor * %s;
)SkSL",
                args.fOutputColor, _sample17331.c_str());
    }
