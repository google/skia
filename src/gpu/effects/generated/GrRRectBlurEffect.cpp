...
half2 texCoord = translatedFragPos / proxyDims;)SkSL",
        ...
        SkString _sample15471 = this->invokeChild(0, args);
        fragBuilder->codeAppendf(
                R"SkSL(
half4 inputColor = %s;)SkSL",
                _sample15471.c_str());
        SkString _coords15519("float2(texCoord)");
        SkString _sample15519 = this->invokeChild(1, args, _coords15519.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
%s = inputColor * %s;
)SkSL",
                args.fOutputColor, _sample15519.c_str());
    }
