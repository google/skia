...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        SkString _input8005 = SkStringPrintf("%s", args.fInputColor);
        SkString _sample8005;
        if (_outer.inputFP_index >= 0) {
            _sample8005 = this->invokeChild(_outer.inputFP_index, _input8005.c_str(), args);
        } else {
            _sample8005 = _input8005;
        }
        fragBuilder->codeAppendf(
                "\nhalf4 inputColor = %s;\n%s = inputColor * sample(%s, float2(texCoord)).%s;\n",
                _sample8005.c_str(), args.fOutputColor,
