...
half2 texCoord = translatedFragPos / proxyDims;)SkSL",
        ...
        SkString _sample19336 = this->invokeChild(0, args);
        fragBuilder->codeAppendf(
                R"SkSL(
half4 inputColor = %s;)SkSL",
                _sample19336.c_str());
        SkString _coords19384("float2(texCoord)");
        SkString _sample19384 = this->invokeChild(1, args, _coords19384.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
%s = inputColor * %s;
)SkSL",
                args.fOutputColor, _sample19384.c_str());
    }
