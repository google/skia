...
half2 texCoord = translatedFragPos / proxyDims;)SkSL",
        ...
        SkString _sample19258 = this->invokeChild(0, args);
        fragBuilder->codeAppendf(
                R"SkSL(
half4 inputColor = %s;)SkSL",
                _sample19258.c_str());
        SkString _coords19306("float2(texCoord)");
        SkString _sample19306 = this->invokeChild(1, args, _coords19306.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
%s = inputColor * %s;
)SkSL",
                args.fOutputColor, _sample19306.c_str());
    }
