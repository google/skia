...
half2 texCoord = translatedFragPos / proxyDims;)SkSL",
        ...
        SkString _sample15490 = this->invokeChild(0, args);
        fragBuilder->codeAppendf(
                R"SkSL(
half4 inputColor = %s;)SkSL",
                _sample15490.c_str());
        SkString _coords15538("float2(texCoord)");
        SkString _sample15538 = this->invokeChild(1, args, _coords15538.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
%s = inputColor * %s;
)SkSL",
                args.fOutputColor, _sample15538.c_str());
    }
