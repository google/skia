...
half2 texCoord = translatedFragPos / proxyDims;)SkSL",
        ...
        SkString _sample19753 = this->invokeChild(0, args);
        fragBuilder->codeAppendf(
                R"SkSL(
half4 inputColor = %s;)SkSL",
                _sample19753.c_str());
        SkString _coords19801("float2(texCoord)");
        SkString _sample19801 = this->invokeChild(1, args, _coords19801.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
%s = inputColor * %s;
)SkSL",
                args.fOutputColor, _sample19801.c_str());
    }
