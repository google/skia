...
half2 texCoord = translatedFragPos / proxyDims;)SkSL",
        ...
        SkString _sample10101 = this->invokeChild(0, args);
        fragBuilder->codeAppendf(
                R"SkSL(
half4 inputColor = %s;)SkSL",
                _sample10101.c_str());
        SkString _coords10149("float2(texCoord)");
        SkString _sample10149 = this->invokeChild(1, args, _coords10149.c_str());
        fragBuilder->codeAppendf(
                R"SkSL(
%s = inputColor * %s;
)SkSL",
                args.fOutputColor, _sample10149.c_str());
    }
