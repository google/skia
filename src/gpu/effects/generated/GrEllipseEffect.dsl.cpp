...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        Declare(_prevCenter);
        Var _prevRadii(kNo_Modifier, DSLType(kFloat2_Type), "prevRadii", Float2(-1.0f));
        Declare(_prevRadii);
        Var _d(kNo_Modifier,
        ...
        If(_medPrecision, /*Then:*/ Block(_d *= _scale.y()));
        Declare(_0_Z);
        Declare(_implicit);
        Declare(_grad_dot);
        If(_medPrecision,
        ...
        If(_medPrecision, /*Then:*/ Block(_approx_dist *= _scale.x()));
        Declare(_alpha);
        Switch(_edgeType,
               Case(0,
                    _alpha = Half(
                            Select(_approx_dist > 0.0f, /*If True:*/ 0.0f, /*If False:*/ 1.0f)),
                    Break()),
               Case(1, _alpha = Saturate(0.5f - Half(_approx_dist)), Break()),
               Case(2,
                    _alpha = Half(
                            Select(_approx_dist > 0.0f, /*If True:*/ 1.0f, /*If False:*/ 0.0f)),
                    Break()),
