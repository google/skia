...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        Var _center(kConst_Modifier, DSLType(kFloat2_Type), "center", Float2(center.fX, center.fY));
        Declare(_center);
        [[maybe_unused]] const auto& radii = _outer.radii;
        Var _radii(kConst_Modifier, DSLType(kFloat2_Type), "radii", Float2(radii.fX, radii.fY));
        Declare(_radii);
        ...
        Declare(_prevCenter);
        Var _prevRadii(kNo_Modifier,
                       DSLType(kFloat2_Type),
                       "prevRadii",
                       Float2(prevRadii.fX, prevRadii.fY));
        Declare(_prevRadii);
        Var _d(kNo_Modifier,
               DSLType(kFloat2_Type),
               "d",
               Swizzle(sk_FragCoord(), X, Y) - Swizzle(_ellipse, X, Y));
        Var _medPrecision(
                kConst_Modifier, DSLType(kBool_Type), "medPrecision", !sk_Caps.floatIs32Bits);
        Var _0_Z(kNo_Modifier, DSLType(kFloat2_Type), "Z", _d * Swizzle(_ellipse, Z, W));
        Var _implicit(kNo_Modifier, DSLType(kFloat_Type), "implicit", Dot(_0_Z, _d) - 1.0f);
        Var _grad_dot(kNo_Modifier, DSLType(kFloat_Type), "grad_dot", 4.0f * Dot(_0_Z, _0_Z));
        Var _approx_dist(kNo_Modifier,
                         DSLType(kFloat_Type),
                         "approx_dist",
                         _implicit * Inversesqrt(_grad_dot));
        Var _alpha(kNo_Modifier, DSLType(kHalf_Type), "alpha");
        Declare(_d);
        Declare(_medPrecision);
