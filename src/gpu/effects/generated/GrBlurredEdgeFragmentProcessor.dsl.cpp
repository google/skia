...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        Var inputAlpha(kNo_Modifier, DSLType(kHalf_Type), "inputAlpha", SampleChild(0).w());
        Var factor(kNo_Modifier, DSLType(kHalf_Type), "factor", 1.0f - inputAlpha);
        Declare(inputAlpha);
        Declare(factor);
        factor = Exp((-factor * factor) * 4.0f) - 0.017999999225139618f;
        Return(Half4(factor));
