...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        Var _unpremulInput(kConst_Modifier, DSLType(kBool_Type), "unpremulInput");
        Declare(_unpremulInput, Bool(!!(unpremulInput)));
        [[maybe_unused]] const auto& clampRGBOutput = _outer.clampRGBOutput;
        Var _clampRGBOutput(kConst_Modifier, DSLType(kBool_Type), "clampRGBOutput");
        Declare(_clampRGBOutput, Bool(!!(clampRGBOutput)));
        [[maybe_unused]] const auto& premulOutput = _outer.premulOutput;
        Var _premulOutput(kConst_Modifier, DSLType(kBool_Type), "premulOutput");
        Declare(_premulOutput, Bool(!!(premulOutput)));
