...
public:
    ...
    void emitCode(EmitArgs& args) override {
        ...
        fragBuilder->codeAppendf(
                ...
                args.fUniformHandler->getUniformCStr(circleDataVar));
        SkString _input13371 = SkStringPrintf("%s", args.fInputColor);
        SkString _sample13371;
        if (_outer.inputFP_index >= 0) {
            _sample13371 = this->invokeChild(_outer.inputFP_index, _input13371.c_str(), args);
        } else {
            _sample13371 = _input13371;
        }
        fragBuilder->codeAppendf("\nhalf4 inputColor = %s;", _sample13371.c_str());
        SkString _sample13431;
        SkString _coords13431("float2(half2(dist, 0.5))");
        _sample13431 = this->invokeChild(_outer.blurProfile_index, args, _coords13431.c_str());
        fragBuilder->codeAppendf("\n%s = inputColor * %s.w;\n", args.fOutputColor,
                                 _sample13431.c_str());
    }
