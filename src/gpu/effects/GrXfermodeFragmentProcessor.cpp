...
protected:
    GrColor4f constantOutputColorForConstantInput(const GrColor4f& inputColor, GrColor4f* outputColor) const override {
        GrColor4f srcColor = this->childProcessor(0).constantOutputForConstantInput(GrColor4f::OpaqueWhite());
        GrColor4f dstColor = this->childProcessor(1).constantOutputForConstantInput(GrColor4f::OpaqueWhite());
