...
sk_sp<GrFragmentProcessor> GrXfermodeFragmentProcessor::MakeFromTwoProcessors1(
...
public:
    ...
    static sk_sp<GrFragmentProcessor> Make(sk_sp<GrFragmentProcessor> fp, SkBlendMode mode, Child child) {
        if (!fp) {
            return nullptr;
        }
        return sk_sp<GrFragmentProcessor>(new ComposeOneFragmentProcessor(std::move(fp), mode, child));
    }
...
sk_sp<GrFragmentProcessor> GrXfermodeFragmentProcessor::MakeFromDstProcessor1(
...
sk_sp<GrFragmentProcessor> GrXfermodeFragmentProcessor::MakeFromSrcProcessor1(
