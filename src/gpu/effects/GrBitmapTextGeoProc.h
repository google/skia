...
public:
    static sk_sp<GrGeometryProcessor> Make(GrColor color, const sk_sp<GrTextureProxy>* proxies,
...
private:
    GrBitmapTextGeoProc(GrColor, const sk_sp<GrTextureProxy>*, const GrSamplerState& params,
