...
std::unique_ptr<GrFragmentProcessor> GrSkSLFP::clone() const {
    // GrSkSLFP requires alignment 16 on some systems, whereas the GrProcessor new operator uses 8
    void* placement = GrProcessor::Alloc(sizeof(GrSkSLFP), alignof(GrSkSLFP));
