...
bool GrSkSLFP::onIsEqual(const GrFragmentProcessor& other) const {
    ...
    SkASSERT(fEffect->fIndex != sk.fEffect->fIndex || fInputSize == sk.fInputSize);
    return fEffect->fIndex == sk.fEffect->fIndex &&
