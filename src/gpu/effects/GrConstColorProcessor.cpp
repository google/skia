...
class GrGLSLConstColorProcessor : public GrGLSLFragmentProcessor {
 public:
  ...
  void emitCode(EmitArgs& args) override {
    ...
    const GrConstColorProcessor& _outer =
        args.fFp.cast<GrConstColorProcessor>();
    (void)_outer;
    auto color = _outer.color();
    (void)color;
    auto mode = _outer.mode();
    (void)mode;
    fColorVar = args.fUniformHandler->addUniform(kFragment_GrShaderFlag,
...
#if GR_TEST_UTILS
std::unique_ptr<GrFragmentProcessor> GrConstColorProcessor::TestCreate(
  ...
  InputMode mode =
      static_cast<InputMode>(d->fRandom->nextULessThan(kInputModeCnt));
