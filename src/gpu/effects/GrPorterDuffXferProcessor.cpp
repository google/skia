...
GrXferProcessor::OptFlags PorterDuffXferProcessor::onGetOptimizations(
    ...
    if (!fBlendFormula.modifiesDst() || !fBlendFormula.usesInputColor()) {
...
GrXPFactory::AnalysisProperties GrPorterDuffXPFactory::analysisProperties(const GrPipelineAnalysisColor& color,
...
GrXPFactory::AnalysisProperties GrPorterDuffXPFactory::SrcOverAnalysisProperties(const GrPipelineAnalysisColor& color,
                                                                                 const GrPipelineAnalysisCoverage& coverage,
                                                                                 const GrCaps& caps) {
