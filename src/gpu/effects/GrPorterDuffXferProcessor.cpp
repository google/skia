...
private:
     ...
     */
    static inline constexpr Properties GetProperties(OutputType PrimaryOut, OutputType SecondaryOut,
 ...
 * Porter Duff formula.
 */
static constexpr BlendFormula MakeSimpleCoeffFormula(GrBlendCoeff srcCoeff, GrBlendCoeff dstCoeff) {
    return BlendFormula(BlendFormula::kModulate_OutputType, BlendFormula::kNone_OutputType,
                        kAdd_GrBlendEquation, srcCoeff, dstCoeff);
}

/**
 * Basic coeff formula similar to MakeSimpleCoeffFormula but we will make the src f*Sa. This is used
 * in LCD dst-out.
 */
...
/**
 * When the coeffs are (Zero, Zero), we clear the dst. This formula has its own factory so we can
 * set the primary output type to none.
 */
static constexpr BlendFormula MakeDstClearFormula() {
    return BlendFormula(BlendFormula::kNone_OutputType, BlendFormula::kNone_OutputType,
                        kAdd_GrBlendEquation, kZero_GrBlendCoeff, kZero_GrBlendCoeff);
}

/**
 * When the coeffs are (Zero, One), we don't write to the dst at all. This formula has its own
 * factory so we can set the primary output type to none.
 */
static constexpr BlendFormula MakeNoDstWriteFormula() {
    return BlendFormula(BlendFormula::kNone_OutputType, BlendFormula::kNone_OutputType,
...
static constexpr BlendFormula gBlendTable[2][2][(int)SkBlendMode::kLastCoeffMode + 1] = {
    ...
    /* clear */      MakeDstClearFormula(),
    /* src */        MakeSimpleCoeffFormula(kOne_GrBlendCoeff,  kZero_GrBlendCoeff),
    /* dst */        MakeNoDstWriteFormula(),
    /* src-over */   MakeSimpleCoeffFormula(kOne_GrBlendCoeff,  kISA_GrBlendCoeff),
    /* dst-over */   MakeSimpleCoeffFormula(kIDA_GrBlendCoeff,  kOne_GrBlendCoeff),
    /* src-in */     MakeSimpleCoeffFormula(kDA_GrBlendCoeff,   kZero_GrBlendCoeff),
    /* dst-in */     MakeSimpleCoeffFormula(kZero_GrBlendCoeff, kSA_GrBlendCoeff),
    /* src-out */    MakeSimpleCoeffFormula(kIDA_GrBlendCoeff,  kZero_GrBlendCoeff),
    /* dst-out */    MakeSimpleCoeffFormula(kZero_GrBlendCoeff, kISA_GrBlendCoeff),
    /* src-atop */   MakeSimpleCoeffFormula(kDA_GrBlendCoeff,   kISA_GrBlendCoeff),
    /* dst-atop */   MakeSimpleCoeffFormula(kIDA_GrBlendCoeff,  kSA_GrBlendCoeff),
    /* xor */        MakeSimpleCoeffFormula(kIDA_GrBlendCoeff,  kISA_GrBlendCoeff),
    /* plus */       MakeSimpleCoeffFormula(kOne_GrBlendCoeff,  kOne_GrBlendCoeff),
    /* modulate */   MakeSimpleCoeffFormula(kZero_GrBlendCoeff, kSC_GrBlendCoeff),
    /* screen */     MakeSimpleCoeffFormula(kOne_GrBlendCoeff,  kISC_GrBlendCoeff),
    ...
    /* src */        MakeSimpleCoeffFormula(kOne_GrBlendCoeff,  kZero_GrBlendCoeff),
    /* dst */        MakeNoDstWriteFormula(),
    /* src-over */   MakeSimpleCoeffFormula(kOne_GrBlendCoeff,  kZero_GrBlendCoeff),
    /* dst-over */   MakeSimpleCoeffFormula(kIDA_GrBlendCoeff,  kOne_GrBlendCoeff),
    /* src-in */     MakeSimpleCoeffFormula(kDA_GrBlendCoeff,   kZero_GrBlendCoeff),
    /* dst-in */     MakeNoDstWriteFormula(),
    /* src-out */    MakeSimpleCoeffFormula(kIDA_GrBlendCoeff,  kZero_GrBlendCoeff),
    /* dst-out */    MakeDstClearFormula(),
    /* src-atop */   MakeSimpleCoeffFormula(kDA_GrBlendCoeff,   kZero_GrBlendCoeff),
    /* dst-atop */   MakeSimpleCoeffFormula(kIDA_GrBlendCoeff,  kOne_GrBlendCoeff),
    /* xor */        MakeSimpleCoeffFormula(kIDA_GrBlendCoeff,  kZero_GrBlendCoeff),
    /* plus */       MakeSimpleCoeffFormula(kOne_GrBlendCoeff,  kOne_GrBlendCoeff),
    /* modulate */   MakeSimpleCoeffFormula(kZero_GrBlendCoeff, kSC_GrBlendCoeff),
    /* screen */     MakeSimpleCoeffFormula(kOne_GrBlendCoeff,  kISC_GrBlendCoeff),
    ...
    /* clear */      MakeCoverageSrcCoeffZeroFormula(BlendFormula::kCoverage_OutputType),
    /* src */        MakeSimpleCoeffFormula(kOne_GrBlendCoeff,  kISA_GrBlendCoeff),
    /* dst */        MakeNoDstWriteFormula(),
    /* src-over */   MakeSimpleCoeffFormula(kOne_GrBlendCoeff,  kISA_GrBlendCoeff),
    /* dst-over */   MakeSimpleCoeffFormula(kIDA_GrBlendCoeff,  kOne_GrBlendCoeff),
    /* src-in */     MakeSimpleCoeffFormula(kDA_GrBlendCoeff,   kISA_GrBlendCoeff),
    /* dst-in */     MakeNoDstWriteFormula(),
    /* src-out */    MakeSimpleCoeffFormula(kIDA_GrBlendCoeff,  kISA_GrBlendCoeff),
...
const GrXferProcessor& GrPorterDuffXPFactory::SimpleSrcOverXP() {
    static BlendFormula gSrcOverBlendFormula =
            MakeSimpleCoeffFormula(kOne_GrBlendCoeff, kISA_GrBlendCoeff);
