...
constexpr GrPorterDuffXPFactory::GrPorterDuffXPFactory(SkBlendMode xfermode) : fBlendMode(xfermode) {
}
...
const GrXPFactory* GrPorterDuffXPFactory::Get(SkBlendMode blendMode) {
    ...
    static const GrPorterDuffXPFactory* gFactories[] = {
    ...
    if ((int)blendMode < 0 || (int)blendMode > (int)SkBlendMode::kLastCoeffMode) {
        return nullptr;
    }
    return gFactories[(int)blendMode];
}
