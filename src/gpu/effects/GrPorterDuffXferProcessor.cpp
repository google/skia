...
GrXferProcessor* PDLCDXferProcessor::Create(SkBlendMode xfermode, const FragmentProcessorAnalysis& analysis) {
...
bool GrPorterDuffXPFactory::onWillReadDstInShader(const GrCaps& caps, const FragmentProcessorAnalysis& analysis) const {
