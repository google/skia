...
private:
    ...
    GrXferBarrierType onXferBarrier(const GrRenderTargetProxy*, const GrCaps&) const override;
...
GrXferBarrierType CustomXP::onXferBarrier(const GrRenderTargetProxy* rtp, const GrCaps& caps) const {
