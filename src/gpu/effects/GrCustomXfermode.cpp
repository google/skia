...
GrXferProcessor::OptFlags CustomXP::onGetOptimizations(const FragmentProcessorAnalysis&) const {
...
GrXPFactory::AnalysisProperties CustomXPFactory::analysisProperties(
                                      ...
                                      const GrPipelineAnalysisCoverage& coverage, const GrCaps& caps) const {
    /*
