...
public:
    ...
    static sk_sp<GrGeometryProcessor> Make(GrColor color, const SkMatrix& viewMatrix,
                                           GrTexture* tex, const GrSamplerParams& params, float lum,
                                           uint32_t flags, bool usesLocalCoords) {
        return sk_sp<GrGeometryProcessor>(new GrDistanceFieldA8TextGeoProc(
                color, viewMatrix, tex, params, lum, flags, usesLocalCoords));
    }
#else
    static sk_sp<GrGeometryProcessor> Make(GrColor color, const SkMatrix& viewMatrix,
                                           ...
                                           uint32_t flags, bool usesLocalCoords) {
        return sk_sp<GrGeometryProcessor>(new GrDistanceFieldA8TextGeoProc(
                color, viewMatrix, tex, params, flags, usesLocalCoords));
    }
#endif
...
private:
    GrDistanceFieldA8TextGeoProc(GrColor, const SkMatrix& viewMatrix, GrTexture* texture,
...
private:
    GrDistanceFieldPathGeoProc(GrColor, const SkMatrix& viewMatrix, GrTexture* texture,
                               const GrSamplerParams& params, uint32_t flags, bool usesLocalCoords);
...
private:
    GrDistanceFieldLCDTextGeoProc(GrColor, const SkMatrix& viewMatrix, GrTexture* texture,
                                  const GrSamplerParams& params, DistanceAdjust wa, uint32_t flags,
                                  bool usesLocalCoords);
