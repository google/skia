...
GrSingleTextureEffect::GrSingleTextureEffect(GrTexture* texture,
                                             sk_sp<GrColorSpaceXform> colorSpaceXform,
                                             const SkMatrix& m,
                                             const GrSamplerParams& params, OptimizationFlags optFlags)
    : INHERITED(optFlags)
...
GrSingleTextureEffect::GrSingleTextureEffect(GrContext* ctx, sk_sp<GrTextureProxy> proxy,
                                             ...
                                             const SkMatrix& m)
    : INHERITED(optFlags)
    , fCoordTransform(ctx, m, proxy.get(), GrSamplerParams::kNone_FilterMode, uint32_t optFlags)
...
GrSingleTextureEffect::GrSingleTextureEffect(GrContext* ctx, sk_sp<GrTextureProxy> proxy,
                                             sk_sp<GrColorSpaceXform> colorSpaceXform,
                                             const SkMatrix& m,
                                             GrSamplerParams::FilterMode filterMode, uint32_t optFlags)
    : INHERITED(optFlags)
...
GrSingleTextureEffect::GrSingleTextureEffect(GrContext* ctx, sk_sp<GrTextureProxy> proxy,
                                             sk_sp<GrColorSpaceXform> colorSpaceXform,
                                             const SkMatrix& m,
                                             const GrSamplerParams& params, uint32_t optFlags)
    : INHERITED(optFlags)
