...
/**************************************************************************************************
 *** This file was autogenerated from GrPremulInputFragmentProcessor.fp; do not
 *modify.
 **************************************************************************************************/
...
GrGLSLFragmentProcessor* GrPremulInputFragmentProcessor::onCreateGLSLInstance()
    const {
  return new GrGLSLPremulInputFragmentProcessor();
}
void GrPremulInputFragmentProcessor::onGetGLSLProcessorKey(
    const GrShaderCaps& caps, GrProcessorKeyBuilder* b) const {}
bool GrPremulInputFragmentProcessor::onIsEqual(
    const GrFragmentProcessor& other) const {
  const GrPremulInputFragmentProcessor& that =
      other.cast<GrPremulInputFragmentProcessor>();
  (void)that;
  return true;
}
...
std::unique_ptr<GrFragmentProcessor> GrPremulInputFragmentProcessor::clone()
    const {
  return std::unique_ptr<GrFragmentProcessor>(
      new GrPremulInputFragmentProcessor(*this));
}
