...
public:
    ...
    public:
        ...
        /**
         * Call this from GrGLSLFragmentProcessor::emitCode() to sample a child processor.
         * domain and mode.
         *
...
public:
    ...
    SkString dumpInfo() const override {
        ...
        str.appendf("Domain: [L: %.2f, T: %.2f, R: %.2f, B: %.2f]",
                    fDomain.domain().fLeft, fDomain.domain().fTop,
                    fDomain.domain().fRight, fDomain.domain().fBottom);
...
private:
    GrFragmentProcessor::OptimizationFlags Flags(GrFragmentProcessor*, GrTextureDomain::Mode, GrTextureDomain::Mode);
