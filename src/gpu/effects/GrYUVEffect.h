...
namespace GrYUVEffect {
     ...
     */
    sk_sp<GrFragmentProcessor> MakeYUVToRGB1(sk_sp<GrTextureProxy> yProxy,
     ...
     */
    sk_sp<GrFragmentProcessor> MakeRGBToYUV1(sk_sp<GrFragmentProcessor>, SkYUVColorSpace);
     ...
     * processor's alpha output.
     */
    sk_sp<GrFragmentProcessor> MakeRGBToUV1(sk_sp<GrFragmentProcessor>, SkYUVColorSpace);
    /**
     ...
     */
    sk_sp<GrFragmentProcessor> MakeRGBToY1(sk_sp<GrFragmentProcessor>, SkYUVColorSpace);
    sk_sp<GrFragmentProcessor> MakeRGBToU1(sk_sp<GrFragmentProcessor>, SkYUVColorSpace);
    sk_sp<GrFragmentProcessor> MakeRGBToV1(sk_sp<GrFragmentProcessor>, SkYUVColorSpace);
};
