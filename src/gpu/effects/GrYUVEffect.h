...
namespace GrYUVEffect {
     ...
     */
    gr_fp<GrFragmentProcessor> MakeYUVToRGB(sk_sp<GrTextureProxy> yProxy,
     ...
     */
    gr_fp<GrFragmentProcessor> MakeRGBToYUV(gr_fp<GrFragmentProcessor>, SkYUVColorSpace);
     ...
     * processor's alpha output.
     */
    gr_fp<GrFragmentProcessor> MakeRGBToUV(gr_fp<GrFragmentProcessor>, SkYUVColorSpace);
    /**
     ...
     */
    gr_fp<GrFragmentProcessor> MakeRGBToY(gr_fp<GrFragmentProcessor>, SkYUVColorSpace);
    gr_fp<GrFragmentProcessor> MakeRGBToU(gr_fp<GrFragmentProcessor>, SkYUVColorSpace);
    gr_fp<GrFragmentProcessor> MakeRGBToV(gr_fp<GrFragmentProcessor>, SkYUVColorSpace);
};
