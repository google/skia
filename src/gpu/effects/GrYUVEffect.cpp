...
public:
    static sk_sp<GrFragmentProcessor> Make(GrTexture* yTexture, GrTexture* uTexture,
        ...
        bool foos[3];
        yuvMatrix[0] = SkMatrix::I(); //GrCoordTransform::MakeDivByTextureWHMatrix(yTexture);
        foos[0] = true;
...
private:
    YUVtoRGBEffect(GrTexture* yTexture, GrTexture* uTexture, GrTexture* vTexture,
                   ...
                   SkYUVColorSpace colorSpace, bool nv12)
        : fYTransform(yuvMatrix[0], foos[0], yTexture, GrSamplerParams::FilterMode::kNone_FilterMode)
        , fYSampler(yTexture)
