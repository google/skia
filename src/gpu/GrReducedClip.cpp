...
GrReducedClip::GrReducedClip(const SkClipStack& stack, const SkRect& queryBounds,
    ...
    if (SK_InvalidGenID != fAAClipRectGenID) { // Is there ia an AA clip rect?
...
GrReducedClip::ClipResult GrReducedClip::clipOutsideElement(const Element* element,
    ...
    switch (element->getDeviceSpaceType()) {
        ...
        case Element::DeviceSpaceType::kRect:
            // Clip out the insides all rectangles. We still won't be able to skip the AA ones, but
        ...
        case Element::DeviceSpaceType::kRRect: {
            // Clip out the interior of the round rect with two window rectangles in the shape of a
