...
public:
    ...
    /**
     * Does GrGpu::transferPixelsTo() support a src buffer where the row  is not equal to bpp * w?
     */
    bool transferPixelsRowBytesSupport() const { return fTransferPixelsRowBytesSupport; }
...
protected:
    ...
    bool fTransferPixelsRowBytesSupport              : 1;
