...
public:
    ...
    /**
     * Used by implementation of shouldInitializeTextures(). Indicates whether GrGpu implement the
     * clear in GrGpu::createTexture() or if false then the caller provide cleared MIP level data or
     * GrGpu::createTexture() will fail.
     *
