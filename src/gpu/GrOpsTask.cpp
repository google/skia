...
void GrOpsTask::recordOp(
    ...
    // Account for this draw's bounds before we attempt to combine and return early. The caller
    // should have already called "op->setClippedBounds()" by this point.
    SkASSERT(op->areBoundsIntersectedWithClip());
