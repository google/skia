...
bool GrCaps::AreConfigsCompatible(GrPixelConfig genericConfig, GrPixelConfig specificConfig) {
    ...
    case kAlpha_8_GrPixelConfig:
        compatible = kAlpha_8_GrPixelConfig == specificConfig ||    // this is here bc of the mock context
    ...
    case kAlpha_half_GrPixelConfig:
        compatible = kAlpha_half_GrPixelConfig == specificConfig || // here bc of the mock context
