...
GrRenderTargetProxy::GrRenderTargetProxy(const GrCaps& caps, const GrBackendFormat& format,
        ...
        : INHERITED(format, desc, GrRenderable::kYes, origin, textureSwizzle, fit, budgeted, surfaceFlags)
...
GrRenderTargetProxy::GrRenderTargetProxy(LazyInstantiateCallback&& callback,
        ...
        : INHERITED(std::move(callback), lazyType, format, desc, GrRenderable::kYes, origin, textureSwizzle, fit,
