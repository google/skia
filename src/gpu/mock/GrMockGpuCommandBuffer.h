...
private:
    void onDraw(const GrPipeline&, const GrPipeline::FixedDynamicState*, const GrPipeline::DynamicStateArrays*,
                const GrPrimitiveProcessor&, const GrMesh[], int meshCount, const SkRect& bounds) override {
        ++fNumDraws;
    }
