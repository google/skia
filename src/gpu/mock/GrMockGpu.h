...
private:
    ...
    GrBackendTexture createBackendTexture(int w, int h, const GrBackendFormat& format,
                                          GrMipMapped mipMapped, GrRenderable renderable,
                                          const SkColor4f& color) override {
        return this->createBackendTexture(w, h, format, mipMapped, renderable, nullptr, 0);
    }
