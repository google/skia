...
sk_sp<GrTexture> GrMockGpu::onCreateTexture(const GrSurfaceDesc& desc, GrRenderable renderable,
    ...
    return sk_sp<GrTexture>(new GrMockTexture(this, budgeted, desc, isProtected, mipMapsStatus, texInfo));
}
...
sk_sp<GrTexture> GrMockGpu::onWrapBackendTexture(const GrBackendTexture& tex,
    ...
    return sk_sp<GrTexture>(new GrMockTexture(this, desc, isProtected, mipMapsStatus, info,
            wrapType, ioType));
}
...
sk_sp<GrTexture> GrMockGpu::onWrapRenderableBackendTexture(const GrBackendTexture& tex,
    ...
    return sk_sp<GrTexture>(
            new GrMockTextureRenderTarget(this, desc, isProtected, mipMapsStatus, texInfo, rtInfo,
                                          cacheable));
}
