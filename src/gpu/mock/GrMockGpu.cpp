...
GrAttachment* GrMockGpu::createStencilAttachmentForRenderTarget(const GrRenderTarget* rt,
                                                                SkISize dimensions,
                                                                int numStencilSamples) {
    SkASSERT(numStencilSamples == rt->numSamples());
    fStats.incStencilAttachmentCreates();
    return new GrMockAttachment(this, dimensions, GrAttachment::UsageFlags::kStencil,
                                rt->numSamples());
}
