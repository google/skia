...
std::unique_ptr<GrGpuRTCommandBuffer> GrMockGpu::createCommandBuffer1(
...
std::unique_ptr<GrGpuTextureCommandBuffer> GrMockGpu::createCommandBuffer2(GrTexture* texture,
