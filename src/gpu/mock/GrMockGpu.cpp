...
sk_sp<GrTexture> GrMockGpu::onWrapRenderableBackendTexture(const GrBackendTexture& tex,
    ...
    return sk_sp<GrTexture>(new GrMockTextureRenderTarget(this, desc, mipMapsStatus, texInfo, rtInfo));
}
...
sk_sp<GrRenderTarget> GrMockGpu::onWrapBackendRenderTarget(const GrBackendRenderTarget& rt)  {
    ...
    return sk_sp<GrRenderTarget>(new GrMockRenderTarget(this, GrMockRenderTarget::kWrapped, desc, info));
}
