...
protected:
    ...
    // This is protected so that GrMockRenderTargetTexture can have a using declaration to
    // suppress the inherit via dominance warning.
...
private:
    ...
    using GrMockTexture::becamePurgeable;
