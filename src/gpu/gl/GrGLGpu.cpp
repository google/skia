...
GrBackendTexture GrGLGpu::onCreateCompressedBackendTexture(SkISize dimensions,
    ...
    if (data && data->type() == BackendTextureData::Type::kCompressed) {
        ...
        rawDataSize = GrCompressedDataSize(compression, dimensions,
                                           nullptr, mipMapped);
...
static GrPixelConfig gl_format_to_pixel_config(GrGLFormat format) {
    switch (format) {
        ...
        case GrGLFormat::kCOMPRESSED_RGB8_ETC2: return kRGB_ETC1_GrPixelConfig2;
        case GrGLFormat::kCOMPRESSED_ETC1_RGB8: return kRGB_ETC1_GrPixelConfig2;
