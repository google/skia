...
GrAttachment* GrGLGpu::createStencilAttachmentForRenderTarget(const GrRenderTarget* rt,
                                                              SkISize dimensions,
    ...
    GrGLAttachment* stencil = new GrGLAttachment(this, sbDesc, dimensions, numStencilSamples, sFmt);
    return stencil;
}
