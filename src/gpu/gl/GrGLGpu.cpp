...
sk_sp<GrTexture> GrGLGpu::onWrapBackendTexture(const GrBackendTexture& backendTex,
    ...
    if (!idDesc.fInfo.fFormat) {
        idDesc.fInfo.fFormat = this->glCaps().getFormatFromColorType(backendTex.config1());
    }
    ...
    GrPixelConfig config1 = this->caps()->getConfigFromBackendFormat(backendTex.getBackendFormat(),
                                                                     grColorType);
...
sk_sp<GrTexture> GrGLGpu::onWrapRenderableBackendTexture(const GrBackendTexture& backendTex,
    ...
    if (!idDesc.fInfo.fFormat) {
        idDesc.fInfo.fFormat = this->glCaps().configSizedInternalFormat(backendTex.config1());
    }
    ...
    GrPixelConfig config1 = caps->getConfigFromBackendFormat(backendTex.getBackendFormat(),
                                                             colorType);
    SkASSERT(kUnknown_GrPixelConfig != config1);
...
sk_sp<GrRenderTarget> GrGLGpu::onWrapBackendRenderTarget(const GrBackendRenderTarget& backendRT,
    ...
    GrPixelConfig config1 = this->caps()->getConfigFromBackendFormat(backendRT.getBackendFormat(),
                                                                     grColorType);
    SkASSERT(kUnknown_GrPixelConfig != config1);
...
sk_sp<GrRenderTarget> GrGLGpu::onWrapBackendTextureAsRenderTarget(const GrBackendTexture& tex,
    ...
    GrPixelConfig config1 = this->caps()->getConfigFromBackendFormat(tex.getBackendFormat(),
                                                                     grColorType);
    SkASSERT(kUnknown_GrPixelConfig != config1);
