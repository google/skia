...
using gr_instanced::GLInstancedRenderingAllocator;
...
std::unique_ptr<InstancedRenderingAllocator> GrGLGpu::onCreateInstancedRenderingAllocator() {
    return std::unique_ptr<InstancedRenderingAllocator>(new GLInstancedRenderingAllocator(this->caps()));
}
