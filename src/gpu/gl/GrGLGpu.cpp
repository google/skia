...
public:
    SamplerObjectCache(GrGLGpu* gpu) : fGpu(gpu) {
        ...
        fTextureUnitStates.reset(new UnitState[fNumTextureUnits]());
    ...
    void bindSampler(int unitIdx, GrSamplerState state) {
        ...
        if (!fTextureUnitStates[unitIdx].fKnown ||
            fTextureUnitStates[unitIdx].fSamplerIfKnown != fSamplers[index]) {
    ...
    void unbindSampler(int unitIdx) {
        if (!fTextureUnitStates[unitIdx].fKnown ||
            fTextureUnitStates[unitIdx].fSamplerIfKnown != 0) {
