...
size_t GrGLGpu::onTransferPixelsFrom(GrSurface* surface, int left, int top, int width, int height, GrColorType dstColorType,
    ...
    if (offset + tightRowBytes * width > transferBuffer->size()) {
        return false;
    }
    ...
    return this->readOrTransferPixelsFrom(surface, left, top, width, height, dstColorType,
                                          offsetAsPtr, tightRowBytes) ? tightRowBytes : 0;
}
...
bool GrGLGpu::readOrTransferPixelsFrom(GrSurface* surface, int left, int top, int width, int height, GrColorType dstColorType, void* offsetOrPtr, size_t rowBytes) {
    SkASSERT(surface);
...
bool GrGLGpu::onReadPixels(GrSurface* surface, int left, int top, int width, int height,
    ...
    if (!this->readOrTransferPixelsFrom(surface, left, top, width, height, dstColorType, readDst, readDstRowBytes)) {
        return false;
    }
