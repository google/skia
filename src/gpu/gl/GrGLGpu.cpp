...
bool GrGLGpu::createRenderTargetObjects(const GrSurfaceDesc3& desc,
...
sk_sp<GrTexture> GrGLGpu::onCreateTexture(const GrSurfaceDesc3& desc,
                                          SkBudgeted budgeted,
                                          const GrMipLevel texels[],
                                          int mipLevelCount) {
...
bool GrGLGpu::createTextureImpl(const GrSurfaceDesc3& desc, GrGLTextureInfo* info,
