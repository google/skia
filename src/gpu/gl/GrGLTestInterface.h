...
public:
    ...
    virtual GrGLvoid texParameterf(GrGLenum target, GrGLenum pname, GrGLint param) {}
    virtual GrGLvoid texParameterfv(GrGLenum target, GrGLenum pname, const GrGLint* params) {}
