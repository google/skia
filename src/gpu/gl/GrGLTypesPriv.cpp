...
GrGLTextureParameters::SamplerParams::SamplerParams()
...
void GrGLTextureParameters::SamplerParams::invalidate() {
    fMinFilter = ~0U;
    fMagFilter = ~0U;
    fWrapS = ~0U;
    fWrapT = ~0U;
...
GrGLTextureParameters::NonSamplerParams::NonSamplerParams()
        // These are the OpenGL defaults.
        : fSwizzleKey(GrSwizzle::RGBA().asKey()), fBaseMipMapLevel(0), fMaxMipMapLevel(1000) {}

void GrGLTextureParameters::NonSamplerParams::invalidate() {
    fSwizzleKey = ~0U;
    fBaseMipMapLevel = ~0;
    fMaxMipMapLevel = ~0;
}
...
void GrGLTextureParameters::set(const SamplerParams* samplerParams,
