...
public:
    ...
    */
     ...
     */
    GrGLenum getTexInternalFormat(GrGLSizedInternalFormat format) const {
        return fUseSizedInternalFormatsForTextures ? this->getSizedInternalFormat(format)
                                                   : this->getBaseInternalFormat(format);
    }
...
private:
    ...
    bool fUseSizedInternalFormatsForTextures : 1;
    ...
    struct FormatInfo {
        ...
        // Not defined for uncompressed formats.
