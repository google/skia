...
public:
    ...
    */
    ...
    // Returns the observed maximum number of instances the driver can handle in a single instanced
    // draw without crashing, or 'pendingInstanceCount' if this workaround is not necessary.
