...
bool GrGLGpu::ProgramCache::compileShader(const GrProgramDesc& desc,
                                          const GrProgramInfo& programInfo) {
    sk_sp<GrGLProgram> tmp = this->findOrCreateProgram(nullptr, desc, programInfo);
    return SkToBool(tmp);
}

sk_sp<GrGLProgram> GrGLGpu::ProgramCache::refProgram1(GrRenderTarget* renderTarget,
                                               const GrProgramInfo& programInfo) {
