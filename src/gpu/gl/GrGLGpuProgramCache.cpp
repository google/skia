...
sk_sp<GrGLProgram> GrGLGpu::ProgramCache::findOrCreateProgram_inline_path(GrRenderTarget* renderTarget,
    ...
    sk_sp<GrGLProgram> tmp = this->findOrCreateProgram_central(renderTarget, desc, programInfo, &stat);
    if (!tmp) {
...
sk_sp<GrGLProgram> GrGLGpu::ProgramCache::findOrCreateProgram_central(GrRenderTarget* renderTarget,
