...
static constexpr GrGLFormat GrGLFormatFromGLEnum(GrGLenum glFormat) {
    switch (glFormat) {
        ...
        //--
        case GR_GL_COMPRESSED_ETC1_RGB8_1: return GrGLFormat::kCOMPRESSED_ETC1_RGB8_1;
        //--
        case GR_GL_COMPRESSED_RGB8_ETC2_1:           return GrGLFormat::kCOMPRESSED_RGB8_ETC2_1;
        case GR_GL_COMPRESSED_SRGB8_ETC2:            return GrGLFormat::kCOMPRESSED_SRGB8_ETC2;
        case GR_GL_COMPRESSED_RGBA8_ETC2_EAC:        return GrGLFormat::kCOMPRESSED_RGBA8_ETC2;
        case GR_GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC: return GrGLFormat::kCOMPRESSED_SRGBA8_ETC2;
        //--
        case GR_GL_COMPRESSED_RGB_S3TC_DXT1_EXT:        return GrGLFormat::kCOMPRESSED_RGB8_BC1;
        case GR_GL_COMPRESSED_SRGB_S3TC_DXT1_EXT:       return GrGLFormat::kCOMPRESSED_SRGB8_BC1;
        case GR_GL_COMPRESSED_RGBA_S3TC_DXT1_EXT:       return GrGLFormat::kCOMPRESSED_RGBA8_BC1;
        case GR_GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT: return GrGLFormat::kCOMPRESSED_SRGBA8_BC1;
        //--
...
static constexpr GrGLenum GrGLFormatToEnum(GrGLFormat format) {
    switch (format) {
        ...
        //--
        case GrGLFormat::kCOMPRESSED_ETC1_RGB8_1: return GR_GL_COMPRESSED_ETC1_RGB8_1;
        //--
        case GrGLFormat::kCOMPRESSED_RGB8_ETC2_1: return GR_GL_COMPRESSED_RGB8_ETC2_1;
        case GrGLFormat::kCOMPRESSED_SRGB8_ETC2:  return GR_GL_COMPRESSED_SRGB8_ETC2;
        case GrGLFormat::kCOMPRESSED_RGBA8_ETC2:  return GR_GL_COMPRESSED_RGBA8_ETC2_EAC;
        case GrGLFormat::kCOMPRESSED_SRGBA8_ETC2: return GR_GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC;
        //--
        case GrGLFormat::kCOMPRESSED_RGB8_BC1:    return GR_GL_COMPRESSED_RGB_S3TC_DXT1_EXT;
        case GrGLFormat::kCOMPRESSED_SRGB8_BC1:   return GR_GL_COMPRESSED_SRGB_S3TC_DXT1_EXT;
        case GrGLFormat::kCOMPRESSED_RGBA8_BC1:   return GR_GL_COMPRESSED_RGBA_S3TC_DXT1_EXT;
        case GrGLFormat::kCOMPRESSED_SRGBA8_BC1:  return GR_GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
        //--
...
static constexpr const char* GrGLFormatToStr(GrGLenum glFormat) {
    switch (glFormat) {
        ...
        //--
        case GR_GL_COMPRESSED_ETC1_RGB8_1:           return "ETC1";
        //--
        case GR_GL_COMPRESSED_RGB8_ETC2_1:           return "RGB8_ETC2";
        case GR_GL_COMPRESSED_SRGB8_ETC2:            return "SRGB8_ETC2";
        case GR_GL_COMPRESSED_RGBA8_ETC2_EAC:        return "RGBA8_ETC2";
        case GR_GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC: return "SRGBA8_ETC2";
        //--
        case GR_GL_COMPRESSED_RGB_S3TC_DXT1_EXT:        return "RGB8_BC1";
        case GR_GL_COMPRESSED_SRGB_S3TC_DXT1_EXT:       return "SRGB8_BC1";
        case GR_GL_COMPRESSED_RGBA_S3TC_DXT1_EXT:       return "RGBA8_BC1";
        case GR_GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT: return "SRGBA8_BC1";
        //--
