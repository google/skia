...
static constexpr GrGLFormat GrGLFormatFromGLEnum(GrGLenum glFormat) {
    switch (glFormat) {
        ...
        case GR_GL_COMPRESSED_RGB_S3TC_DXT1_EXT: return GrGLFormat::kCOMPRESSED_RGB8_BC1_1;
...
static constexpr GrGLenum GrGLFormatToEnum(GrGLFormat format) {
    switch (format) {
        ...
        case GrGLFormat::kCOMPRESSED_RGB8_BC1_1:  return GR_GL_COMPRESSED_RGB_S3TC_DXT1_EXT;
