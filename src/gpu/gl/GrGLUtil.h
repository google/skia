...
static constexpr GrGLFormat GrGLFormatFromGLEnum(GrGLenum glFormat) {
    switch (glFormat) {
        ...
        //---
        case GR_GL_COMPRESSED_RGB8_ETC2: return GrGLFormat::kCOMPRESSED_RGB8_ETC22;
        //---
        case GR_GL_COMPRESSED_ETC1_RGB8: return GrGLFormat::kCOMPRESSED_ETC1_RGB82;
        //---
...
static constexpr GrGLenum GrGLFormatToEnum(GrGLFormat format) {
    switch (format) {
        ...
        case GrGLFormat::kCOMPRESSED_RGB8_ETC22: return GR_GL_COMPRESSED_RGB8_ETC2;
        case GrGLFormat::kCOMPRESSED_ETC1_RGB82: return GR_GL_COMPRESSED_ETC1_RGB8;
