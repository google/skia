...
protected:
    ...
    GrGLRenderTarget(GrGLGpu*, const GrSurfaceDesc3&, const IDDesc&);

    void init(const GrSurfaceDesc3&, const IDDesc&);
...
private:
    ...
    GrGLRenderTarget(GrGLGpu*, const GrSurfaceDesc3&, const IDDesc&, GrGLStencilAttachment*);
