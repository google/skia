...
bool GrGLRenderTarget::completeStencilAttachment(GrAttachment* stencil, bool useMSAASurface) {
...
bool GrGLRenderTarget::canAttemptStencilAttachment(bool useMSAASurface) const {
