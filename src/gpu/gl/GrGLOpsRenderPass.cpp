...
void GrGLOpsRenderPass::set(GrRenderTarget* rt, bool useMultisampleFBO,
                            const SkIRect& contentBounds, GrSurfaceOrigin origin,
    ...
    this->INHERITED::set(rt, useMultisampleFBO, origin);
