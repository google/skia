        ...
        // kBGRA_8888
        {
            if (GR_IS_GR_GL(standard)) {
                if (version >= GR_GL_VER(1, 2) || ctxInfo.hasExtension("GL_EXT_bgra")) {
                    ...
                    this->setColorTypeFormat(GrColorType::kBGRA_8888,
                                             GrGLFormat::kRGBA8);
                }
            }
        }
    ...
    // R8
    {
        ...
        if (textureRedSupport) {
            ...
            // kAlpha_8
            {
                ...
                this->setColorTypeFormat(GrColorType::kAlpha_8,
                                         GrGLFormat::kR8);
            }
    ...
    // LUMINANCE8
    {
        ...
        if (supportsLum) {
            // kGray_8
            {
                ...
                if (fColorTypeToFormatTable[idx] == GrGLFormat::kUnknown) {
                    this->setColorTypeFormat(GrColorType::kGray_8,
                                             GrGLFormat::kLUMINANCE8);
                }
            }
        }
    ...
    // RGBA16F
    {
        ...
        if (hasFP16Textures) {
            ...
            // kRGBA_F16_Clamped
            {
                ...
                this->setColorTypeFormat(GrColorType::kRGBA_F16_Clamped,
                                         GrGLFormat::kRGBA16F);
            }
        }
    }
    ...
    // RGB10_A2
    {
        ...
        if (SkToBool(info.fFlags &FormatInfo::kTextureable_Flag)) {
            // kRGBA_1010102
            {
                ...
                this->setColorTypeFormat(GrColorType::kRGBA_1010102,
                                         GrGLFormat::kRGB10_A2);
            }
        }
    }
    ...
    // SRGB8_ALPHA8
    {
        ...
        if (fSRGBSupport) {
            // kRGBA_8888_SRGB
            {
                ...
                this->setColorTypeFormat(GrColorType::kRGBA_8888_SRGB,
                                         GrGLFormat::kSRGB8_ALPHA8);
            }
        }
    }
    ...
    // GR_GL_RGBA16
    {
        ...
        if (rgba16161616Supported) {
            // kRGBA_16161616
            {
                ...
                this->setColorTypeFormat(GrColorType::kRGBA_16161616,
                                         GrGLFormat::kRGBA16);
            }
        }
    }
...
GrGLFormat GrGLCaps::pixelConfigToFormat(GrPixelConfig config) const {
    switch (config) {
        ...
        case kRGB_ETC1_GrPixelConfig:
            return fEtc1UsesEtc1 ? GrGLFormat::kCOMPRESSED_ETC1_RGB8
