...
const GrGLCaps::FormatInfo& GrGLCaps::getFormatInfo(GrGLSizedInternalFormat format) const {
    return fFormatTable[static_cast<int>(format)];
}

GrGLCaps::FormatInfo& GrGLCaps::getFormatInfo(GrGLSizedInternalFormat format) {
    return fFormatTable[static_cast<int>(format)];
}
