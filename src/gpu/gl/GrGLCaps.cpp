...
void GrGLCaps::applyDriverCorrectnessWorkarounds(const GrGLContextInfo& ctxInfo,
...
#ifdef SK_BUILD_FOR_ANDROID
    // On the Nexus 9 running Android 6.0.1 formats added by GL_EXT_texure_rg and
    // GL_EXT_texure_norm16 cause errors if they are created with glTexImage2D() with
    ...
    // reasons. We override that with this workaroud.
