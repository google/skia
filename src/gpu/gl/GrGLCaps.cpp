...
void GrGLCaps::initConfigTable(const GrContextOptions& contextOptions,
    ...
    */
    ...
    ConfigInfo& alphaInfo = fConfigTable[kPriv_Alpha_8_as_Alpha_GrPixelConfig];
    ...
    ConfigInfo& redInfo = fConfigTable[kPriv_Alpha_8_as_Red_GrPixelConfig];
    ...
    ConfigInfo& alphaHalf = fConfigTable[kPriv_Alpha_half_as_Alpha_GrPixelConfig];
    ...
    ConfigInfo& redHalf = fConfigTable[kPriv_Alpha_half_as_Red_GrPixelConfig];
    ...
    if(kGalliumLLVM_GrGLRenderer == ctxInfo.renderer()) {
        SkASSERT(fConfigTable[kAlpha_8_GrPixelConfig].fFormats.fBaseInternalFormat ==
                 fConfigTable[kPriv_Alpha_8_as_Alpha_GrPixelConfig].fFormats.fBaseInternalFormat);
        ...
        fConfigTable[kPriv_Alpha_8_as_Alpha_GrPixelConfig].fFormats.fInternalFormatTexImage =
            fConfigTable[kPriv_Alpha_8_as_Alpha_GrPixelConfig].fFormats.fBaseInternalFormat;
    }
