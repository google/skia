...
void GrGLCaps::initGLSL(const GrGLContextInfo& ctxInfo, const GrGLInterface* gli) {
    ...
    **************************************************************************/
    ...
    // FIXME: The sample mask round rect op draws nothing on several Adreno and Radeon bots. Other
    // ops that use sample mask while rendering to stencil seem to work fine. Temporarily disable
    // sample mask on color buffers while we investigate.
    // http://skbug.com/8921
