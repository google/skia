...
void GrGLCaps::applyDriverCorrectnessWorkarounds(const GrGLContextInfo& ctxInfo,
    ...
    // On a NVIDIA Shield TV running Android 7 creating a texture with glTexImage2D() with internal
    // format GL_LUMINANCE8 fails. However, it succeedes with glTexStorage2D. We usually disable
    // glTexStorage2D().
