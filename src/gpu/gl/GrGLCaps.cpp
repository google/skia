...
void GrGLCaps::initFormatTable(const GrGLContextInfo& ctxInfo, const GrGLInterface* gli,
    ...
    // Format: RGBA16F
    {
        ...
        // We can remove the check for fDisablePerFormatTextureStorageForCommandBufferES2 when
        // crbug.com/1008003 is fixed.
        if (texStorageSupported &&
            !formatWorkarounds.fDisablePerFormatTextureStorageForCommandBufferES2) {
            info.fFlags |= FormatInfo::kUseTexStorage_Flag;
    ...
    // Format: LUMINANCE16F
    {
        ...
        if (GR_IS_GR_GL(standard)) {
            ...
            if (ctxInfo.hasExtension("GL_OES_texture_half_float_linear") &&
                ...
                lum16FSupported = true;
                // Even on ES3 this extension is required to defined LUMINANCE16F.
