...
void GrGLCaps::initConfigTable(const GrContextOptions& contextOptions,
    ...
    */
    ...
    // want to read to kRGB_888x color type and ensure that gets 0xFF written. Using GL_RGB would read back
    // unaligned 24bit RGB color values.
   ...
   // GL_EXT_texture_format_BGRA8888.
    ...
    for (int i = 0; i < kGrPixelConfigCnt; ++i) {
        // Almost always we want to pass fExternalFormat[kReadPixels_ExternalFormatUsage] as the <format>
    ...
    // be sure that we write 1 for alpha not whatever happens to be in client provided the 'x' slot.
