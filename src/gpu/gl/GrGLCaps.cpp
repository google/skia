...
SkImage::CompressionType GrGLCaps::compressionType1(const GrBackendFormat& format) const {
    auto fmt = format.asGLFormat();

    switch (fmt) {
        case GrGLFormat::kCOMPRESSED_ETC1_RGB8: // same compression layout as ETC2
