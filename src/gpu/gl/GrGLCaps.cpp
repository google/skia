...
void GrGLCaps::init(const GrContextOptions& contextOptions,
    ...
    **************************************************************************/
    ...
    // GL_INVALID_OPERATION thrown by glDrawArrays from a buffer than was mapped. The same bug did
    // not reproduce on a Nexus7 2013 with a 320 running Android M with driver 127.0. It's unclear
    // whether this really affects a wide range of devices.
