...
void GrGLCaps::init(const GrContextOptions& contextOptions,
    ...
    **************************************************************************/
    ...
    if (kIntel_GrGLVendor == ctxInfo.vendor()) {
        SkDebugf("@@@@@@@@@@@@> GL Version: 0x%x\n", version);
        SkDebugf("@@@@@@@@@@@@@> GL Driver: %i\n", ctxInfo.driver());
        SkDebugf("@@@@@@@@@@@@@> GL Renderer: %i\n", ctxInfo.renderer());
        if (kIntel_GrGLDriver == ctxInfo.driver()) {
            ...
            if (fBlacklistCoverageCounting) {
                SkASSERT(!"Blocking kIntel4xxx_GrGLRenderer kIntel6xxx_GrGLRenderer");
            }
