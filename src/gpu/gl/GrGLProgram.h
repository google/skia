...
public:
     ...
     */
    void updateUniformsAndTextureBindings(GrRenderTarget*, GrSurfaceOrigin,
...
private:
    ...
    void setRenderTargetState(GrRenderTarget*, GrSurfaceOrigin, const GrPrimitiveProcessor&);
