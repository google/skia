...
void GrGLProgram::updateUniformsAndTextureBindings(GrRenderTarget* renderTarget, GrSurfaceOrigin origin,
...
void GrGLProgram::setRenderTargetState(GrRenderTarget* rt, GrSurfaceOrigin origin,
                                       const GrPrimitiveProcessor& primProc) {
