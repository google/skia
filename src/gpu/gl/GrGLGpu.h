...
private:
    ...
    GrGLuint createCompressedTexture2D(int width, int height,
                                       SkImage::CompressionType compression,
                                       GrGLTextureParameters::SamplerOverriddenState* initialState,
                                       const void* data, GrGLFormat* format);
    ...
    GrGLFormat uploadCompressedTexData(SkImage::CompressionType, int width, int height,
