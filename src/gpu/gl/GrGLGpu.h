...
private:
    ...
    sk_sp<GrTexture> onCreateTexture(const GrSurfaceDesc& desc, GrSurfaceOrigin origin,
    ...
    bool createTextureImpl(const GrSurfaceDesc& desc, GrSurfaceOrigin, GrGLTextureInfo* info,
