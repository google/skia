...
private:
    ...
    void flushStencilFace(GrGLenum faceID, const GrStencilSettings::Face&);
    void flushStencilFunc(GrGLenum faceID, GrStencilTest, uint16_t ref, uint16_t mask);
    void flushStencilOp(GrGLenum faceID, GrStencilOp failOp, GrStencilOp passOp);
    void flushStencilWriteMask(GrGLenum faceID, uint16_t writeMask);
    void disableStencil();
