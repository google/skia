...
private:
    ...
    sk_sp<GrTexture> onCreateTexture(const GrSurfaceDesc&, GrRenderable, int renderTargetSampleCount,
    ...
    bool createRenderTargetObjects(const GrSurfaceDesc&, int sampleCount, const GrGLTextureInfo& texInfo,
