...
private:
    ...
    bool createTextureImpl(const GrSurfaceDesc3& desc, GrGLTextureInfo* info,
    ...
    bool createRenderTargetObjects(const GrSurfaceDesc3&, const GrGLTextureInfo& texInfo,
