...
public:
    ...
    void flushScissorRect(const SkIRect& scissor, int rtWidth, int rtHeight, GrSurfaceOrigin);

    // The flushRenderTarget methods will all set the initial viewport to the full extent of the
    // backing render target.
    void flushViewport(const SkIRect& viewport, int rtHeight, GrSurfaceOrigin rtOrigin);
