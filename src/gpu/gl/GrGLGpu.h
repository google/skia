...
private:
    ...
    // The passed bounds contains the pixels of the render target will be written. It may be an
    // empty rect if no writes will occur.
    ...
    void flushRenderTargetCommon(GrGLRenderTarget*, bool disableSRGB = false);
