...
public:
    ...
    // Binds the vertex array that should be used for internal draws, and returns its attrib state.
    ...
    GrGLAttribArrayState* bindInternalVertexArray(const GrBuffer* indexBuffer) {
        return fHWVertexArrayState.bindInternalVertexArray(this, indexBuffer);
    }
