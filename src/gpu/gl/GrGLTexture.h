...
public:
    ...
    GrGLTexture(GrGLGpu*, SkBudgeted, const GrSurfaceDesc3&, const IDDesc&);
    GrGLTexture(GrGLGpu*, SkBudgeted, const GrSurfaceDesc3&, const IDDesc&,
    ...
    static sk_sp<GrGLTexture> MakeWrapped(GrGLGpu*, const GrSurfaceDesc3&, const IDDesc&);

protected:
    // Constructor for subclasses.
    GrGLTexture(GrGLGpu*, const GrSurfaceDesc3&, const IDDesc&, bool wasMipMapDataProvided);

    enum Wrapped { kWrapped };
    // Constructor for instances wrapping backend objects.
    GrGLTexture(GrGLGpu*, Wrapped, const GrSurfaceDesc3&, const IDDesc&);
