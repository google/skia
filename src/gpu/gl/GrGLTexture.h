...
public:
    ...
    bool hasLevel0BeenBoundToFBO() const { return fHasLevel0BeenBoundToFBO; }
    void level0WasBoundToFBO() { fHasLevel0BeenBoundToFBO = true; }
...
private:
    ...
    bool                            fHasLevel0BeenBoundToFBO = false;
