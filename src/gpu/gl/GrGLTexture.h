...
public:
    ...
    static sk_sp<GrGLTexture> MakeWrapped(GrGLGpu*, GrMipMapsStatus,
                                          const Desc&, sk_sp<GrGLTextureParameters>,
...
protected:
    ...
    GrGLTexture(GrGLGpu*, const Desc&, GrMipMapsStatus, sk_sp<GrGLTextureParameters>,
            GrWrapCacheable, GrIOType);
