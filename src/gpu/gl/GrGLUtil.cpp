    ...
    *renderer = GrGLANGLERenderer::kUnknown;
    ...
    if (strstr(rendererString, "Intel")) {
        *vendor = GrGLANGLEVendor::kIntel;
        ...
        } else if (1 == sscanf(rendererString, "Iris(TM) Graphics %i", &modelNumber) ||
                   1 == sscanf(rendererString, "Iris(TM) Pro Graphics %i", &modelNumber) ||
                   1 == sscanf(rendererString, "Iris(TM) Pro Graphics P%i", &modelNumber)) {
            switch (modelNumber) {
                case 540:
                case 550:
                case 555:
