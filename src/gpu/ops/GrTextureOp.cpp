    ...
    GrGLSLPrimitiveProcessor* createGLSLInstance(const GrShaderCaps& caps) const override {
        ...
        private:
            void onEmitCode(EmitArgs& args, GrGPArgs* gpArgs) override {
                ...
                // FIXME have fAttrs.needsPerspective()
                if (kFloat2_GrVertexAttribType == textureGP.fAttrs.positions().cpuType()) {
                ...
                textureGP.fAttrs.emitColor(args, &fPaintColorSpaceXformHelper, "color");
...
private:
    // FIXME switch coverageAA and perspective to match Attributes types?
    TextureGeometryProcessor(GrTextureType textureType, GrPixelConfig textureConfig,
            ...
            , fAttrs(perspective ? 3 : 2, 2, true, coverageAA ? GrAA::kYes : GrAA::kNo, domain)
