...
private:
    ...
    static ColorType ToVertexColor(const SkPMColor4f&);

    template <>
    static GrColor ToVertexColor<GrColor>(const SkPMColor4f& c) {
        return c.toBytes_RGBA();
    }

    template <>
    static GrColor4h ToVertexColor<GrColor4h>(const SkPMColor4f& c) {
