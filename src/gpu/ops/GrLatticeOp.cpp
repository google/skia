...
private:
    ...
    static constexpr Attribute kTextureCoords = {"textureCoords", kFloat2_GrVertexAttribType, kPositions};
    static constexpr Attribute kTextureDomain = {"textureDomain", kFloat4_GrVertexAttribType, kTextureCoords};
