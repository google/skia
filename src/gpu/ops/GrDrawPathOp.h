...
protected:
    ...
    bool willXPNeedDstTexture(const GrCaps& caps, const GrAppliedClip& appliedClip) const override {
        GrProcessorSet::FragmentProcessorAnalysis analysis;
        analysis.reset(fColor, GrColor_WHITE, fProcessorSet, false, appliedClip, caps);
        return GrXPFactory::WillNeedDstTexture(fProcessorSet.xpFactory(), caps, analysis);
    }
