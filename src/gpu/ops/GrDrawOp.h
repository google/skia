...
public:
    ...
    /**
     * Caled after finalize, at which point every op should know whether it will need stencil.
     */
...
protected:
    /**
     * This is a legacy implementation for usesMSAA() and usesStencil(). Newer ops should override
