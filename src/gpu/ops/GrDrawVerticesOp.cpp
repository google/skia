...
GrGeometryProcessor* DrawCustomVerticesOp::makeGP(SkArenaAlloc* arena) {
    auto gp =
            VerticesGP::Make(arena, LocalCoordsType::kUnused, ColorArrayType::kUnused, {1, 1, 1, 1},
                             nullptr, fViewMatrix, fAttrWidths.data(), fAttrWidths.size());
