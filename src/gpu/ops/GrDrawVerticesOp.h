...
public:
     ...
     * 'colorArrayType' specifies whether the colors are premul GrColors or unpremul SkColors.
     */
     ...
     * per-vertex color should be ignored. GrPrimitiveType overrides the SkVertices::mode(), if
     * not null. The 'flags' options are those specified by SkCanvas::VerticesFlags.
     */
