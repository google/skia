...
std::unique_ptr<GrDrawOp> GrDrawAtlasOpFactory::Make(GrRecordingContext* context,
                                                     GrPaint&& paint,
    ...
    return GrSimpleMeshDrawOpHelper::FactoryHelper<GrDrawAtlasOp>(context, std::move(paint),
                                                                  viewMatrix, aaType,
                                                                  spriteCount, xforms,
                                                                  rects, colors);
}
...
GR_DRAW_OP_TEST_DEFINE(GrDrawAtlasOp) {
    ...
    return GrDrawAtlasOpFactory::Make(context, std::move(paint), viewMatrix, aaType, spriteCount,
