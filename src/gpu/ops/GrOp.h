...
public:
    ...
    CombineResult combineIfPossible(GrOp* that, SkArenaAlloc*, const GrCaps& caps);
...
private:
    ...
    virtual CombineResult onCombineIfPossible(GrOp*, SkArenaAlloc* alloc, const GrCaps&) {
