        ...
        if (devStrokeWidth > 0) {
            ...
            if (strokeOnly) {
                ...
                if (isCircle) {
                    ...
                    SkScalar devRectWidth = devRect.width();
                    SkScalar devRectHeight = devRect.height();
                    if (devStrokeWidth <= devRectWidth && devStrokeWidth <= devRectHeight) {
...
DRAW_OP_TEST_DEFINE(ShadowRRectOp) {
    ...
    if (isCircle) {
        ...
        return GrShadowRRectOp::Make(color, viewMatrix, rrect, blurRadius,
