...
public:
    ...
    static std::unique_ptr<GrMeshDrawOp> Make(GrColor color, const SkMatrix& viewMatrix, SkPoint center,
...
DRAW_OP_TEST_DEFINE(ShadowCircleOp) {
    do {
        ...
        std::unique_ptr<GrMeshDrawOp> op = ShadowCircleOp::Make(color, viewMatrix, center, radius,
