...
protected:
    ...
    void applyPipelineAnalysis(const GrPipelineAnalysisResult& analysis) override {
        ...
        fOptimizations.fColorIgnored = !analysis.readsColor();
        fOptimizations.fUsesLocalCoords = analysis.readsLocalCoords();
        fOptimizations.fCoverageIgnored = !analysis.readsCoverage();
    }
