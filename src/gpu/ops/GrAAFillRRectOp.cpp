...
struct Vertex {
    std::array<int8_t, 4> fRadiiSelector;
    std::array<int8_t, 2> fCorner;
    std::array<int8_t, 2> fRadiusOutsetDirection;
    std::array<int8_t, 2> fAABloatDirection;
    int8_t fCoverage;
    int8_t fIsLinearCoverage;
    std::array<int8_t, 4> fArcCoordMatrix;
};

// This matrix is used to calculate normalized arc coordinates at each vertex of a corner segment
// (i.e., x^2 + y^2 == 1). See onEmitCode.
static constexpr std::array<int8_t, 4> kArcMatrices[] = {
    {{+127,  +127,     0,     0}},
    {{-128,  +127,     0,     0}},
    {{   0,     0,  -128,  +127}},
    {{   0,     0,  +127,  +127}},
...
static constexpr Vertex kVertexData[] = {
    // Left inset edge.
    {{{0, 0, 0, 127}},  {{-128, +127}},  {{0, -128}},  {{+127, 0}},  127,  127,  {{0, 0, 0, 0}}},
    {{{127, 0, 0, 0}},  {{-128, -128}},  {{0, +127}},  {{+127, 0}},  127,  127,  {{0, 0, 0, 0}}},

    // Top inset edge.
    {{{127, 0, 0, 0}},  {{-128, -128}},  {{+127, 0}},  {{0, +127}},  127,  127,  {{0, 0, 0, 0}}},
    {{{0, 127, 0, 0}},  {{+127, -128}},  {{-128, 0}},  {{0, +127}},  127,  127,  {{0, 0, 0, 0}}},

    // Right inset edge.
    {{{0, 127, 0, 0}},  {{+127, -128}},  {{0, +127}},  {{-128, 0}},  127,  127,  {{0, 0, 0, 0}}},
    {{{0, 0, 127, 0}},  {{+127, +127}},  {{0, -128}},  {{-128, 0}},  127,  127,  {{0, 0, 0, 0}}},

    // Bottom inset edge.
    {{{0, 0, 127, 0}},  {{+127, +127}},  {{-128, 0}},  {{0, -128}},  127,  127,  {{0, 0, 0, 0}}},
    {{{0, 0, 0, 127}},  {{-128, +127}},  {{+127, 0}},  {{0, -128}},  127,  127,  {{0, 0, 0, 0}}},


    // Left outset edge.
    {{{0, 0, 0, 127}},  {{-128, +127}},  {{0, -128}},  {{-128, 0}},    0,  127,  {{0, 0, 0, 0}}},
    {{{127, 0, 0, 0}},  {{-128, -128}},  {{0, +127}},  {{-128, 0}},    0,  127,  {{0, 0, 0, 0}}},

    // Top outset edge.
    {{{127, 0, 0, 0}},  {{-128, -128}},  {{+127, 0}},  {{0, -128}},    0,  127,  {{0, 0, 0, 0}}},
    {{{0, 127, 0, 0}},  {{+127, -128}},  {{-128, 0}},  {{0, -128}},    0,  127,  {{0, 0, 0, 0}}},

    // Right outset edge.
    {{{0, 127, 0, 0}},  {{+127, -128}},  {{0, +127}},  {{+127, 0}},    0,  127,  {{0, 0, 0, 0}}},
    {{{0, 0, 127, 0}},  {{+127, +127}},  {{0, -128}},  {{+127, 0}},    0,  127,  {{0, 0, 0, 0}}},

    // Bottom outset edge.
    {{{0, 0, 127, 0}},  {{+127, +127}},  {{-128, 0}},  {{0, +127}},    0,  127,  {{0, 0, 0, 0}}},
    {{{0, 0, 0, 127}},  {{-128, +127}},  {{+127, 0}},  {{0, +127}},    0,  127,  {{0, 0, 0, 0}}},


    // Top-left corner.
    {{{127, 0, 0, 0}},  {{-128, -128}},  {{0, +127}},  {{-128, 0}},    0,  0,  kArcMatrices[0]},
    {{{127, 0, 0, 0}},  {{-128, -128}},  {{0, +127}},  {{+127, 0}},  127,  0,  kArcMatrices[1]},
    {{{127, 0, 0, 0}},  {{-128, -128}},  {{+127, 0}},  {{0, +127}},  127,  0,  kArcMatrices[2]},
    {{{127, 0, 0, 0}},  {{-128, -128}},  {{+127, 0}},  {{0, -128}},    0,  0,  kArcMatrices[3]},
    {{{127, 0, 0, 0}},  {{-128, -128}},  {{0, 0}},  {{-128, -128}},    0,  0,  kArcMatrices[4]},

    // Top-right corner.
    {{{0, 127, 0, 0}},  {{+127, -128}},  {{-128, 0}},  {{0, -128}},    0,  0,  kArcMatrices[3]},
    {{{0, 127, 0, 0}},  {{+127, -128}},  {{-128, 0}},  {{0, +127}},  127,  0,  kArcMatrices[2]},
    {{{0, 127, 0, 0}},  {{+127, -128}},  {{0, +127}},  {{-128, 0}},  127,  0,  kArcMatrices[1]},
    {{{0, 127, 0, 0}},  {{+127, -128}},  {{0, +127}},  {{+127, 0}},    0,  0,  kArcMatrices[0]},
    {{{0, 127, 0, 0}},  {{+127, -128}},  {{0, 0}},  {{+127, -128}},    0,  0,  kArcMatrices[4]},

    // Bottom-right corner.
    {{{0, 0, 127, 0}},  {{+127, +127}},  {{0, -128}},  {{+127, 0}},    0,  0,  kArcMatrices[0]},
    {{{0, 0, 127, 0}},  {{+127, +127}},  {{0, -128}},  {{-128, 0}},  127,  0,  kArcMatrices[1]},
    {{{0, 0, 127, 0}},  {{+127, +127}},  {{-128, 0}},  {{0, -128}},  127,  0,  kArcMatrices[2]},
    {{{0, 0, 127, 0}},  {{+127, +127}},  {{-128, 0}},  {{0, +127}},    0,  0,  kArcMatrices[3]},
    {{{0, 0, 127, 0}},  {{+127, +127}},  {{0, 0}},  {{+127, +127}},    0,  0,  kArcMatrices[4]},

    // Bottom-left corner.
    {{{0, 0, 0, 127}},  {{-128, +127}},  {{+127, 0}},  {{0, +127}},    0,  0,  kArcMatrices[3]},
    {{{0, 0, 0, 127}},  {{-128, +127}},  {{+127, 0}},  {{0, -128}},  127,  0,  kArcMatrices[2]},
    {{{0, 0, 0, 127}},  {{-128, +127}},  {{0, -128}},  {{+127, 0}},  127,  0,  kArcMatrices[1]},
    {{{0, 0, 0, 127}},  {{-128, +127}},  {{0, -128}},  {{-128, 0}},    0,  0,  kArcMatrices[0]},
    {{{0, 0, 0, 127}},  {{-128, +127}},  {{0, 0}},  {{-128, +127}},    0,  0,  kArcMatrices[4]}
};
...
class GrAAFillRRectOp::RoundRectProc : public GrGeometryProcessor {
public:
    ...
    const char* name() const override { return "GrAAFillRRectOp::RoundRectProc"; }
...
private:
    static constexpr Attribute kVertexAttribs[] = {
            {"radii_selector", kByte4_norm_GrVertexAttribType, kHalf4_GrSLType},
            {"corner_and_radius_outsets", kByte4_norm_GrVertexAttribType, kHalf4_GrSLType},
            {"aa_bloat_and_coverage", kByte4_norm_GrVertexAttribType, kHalf4_GrSLType},
            {"arc_coord_matrix", kByte4_norm_GrVertexAttribType, kHalf4_GrSLType}};
...
constexpr GrPrimitiveProcessor::Attribute GrAAFillRRectOp::RoundRectProc::kVertexAttribs[];
constexpr GrPrimitiveProcessor::Attribute GrAAFillRRectOp::RoundRectProc::kInstanceAttribs[];

class GrAAFillRRectOp::RoundRectProc::Impl : public GrGLSLGeometryProcessor {
public:
    void onEmitCode(EmitArgs& args, GrGPArgs* gpArgs) override {
        ...
        v->codeAppend("half2 corner = corner_and_radius_outsets.xy;");
        v->codeAppend("half2 radius_outset_direction = corner_and_radius_outsets.zw;");
        v->codeAppend("half2 aa_bloat_direction = aa_bloat_and_coverage.xy;");
        v->codeAppend("half coverage = aa_bloat_and_coverage.z;");
        v->codeAppend("half is_linear_coverage = aa_bloat_and_coverage.w;");

        // Find our AA bloat width.
        ...
        // Find our radii.
        v->codeAppend("float2 radii = radii_selector * float2x4(radii_x, radii_y);");
        ...
        v->codeAppend("if (any(greaterThan(aa_bloatradius, float2(1)))) {");
                          ...
                          // or else opposite AA borders will overlap. Instead, demote it to a
                          // generic rect with sharp corners, fudge the size up to the width of a
                          // coverage ramp, and reduce coverage to make it appear more thin.
        ...
        v->codeAppend("} else if (any(lessThan(radii, aa_bloatradius * 1.25))) {");
        ...
        f->codeAppendf(    "coverage = clamp(.5 - fn/fnwidth, 0, 1);");
        f->codeAppendf("}");
...
GrGLSLPrimitiveProcessor* GrAAFillRRectOp::RoundRectProc::createGLSLInstance(
