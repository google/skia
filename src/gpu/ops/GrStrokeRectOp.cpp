...
public:
    ...
    NonAAStrokeRectOp(const Helper::MakeArgs& helperArgs, const SkPMColor4f& color,
        ...
        if (inputFlags & Helper::InputFlags::kSnapVerticesToPixelCenters) {
            ...
            this->setBounds(bounds, HasAABloat::kNo, HasZeroWidthEdge::kNo);
        } else {
            ...
            this->setTransformedBounds(bounds, fViewMatrix, aaBloat,
                                       fStrokeWidth ? HasZeroWidthEdge::kNo : HasZeroWidthEdge::kYes);
        }
    }
...
public:
    ...
    AAStrokeRectOp(const Helper::MakeArgs& helperArgs, const SkPMColor4f& color,
        ...
        this->setBounds(devOutside, HasAABloat::kYes, HasZeroWidthEdge::kNo);
        fMiterStroke = true;
    }
    ...
    AAStrokeRectOp(const Helper::MakeArgs& helperArgs, const SkPMColor4f& color,
        ...
        info.fColor = color;
        if (isMiter) {
            this->setBounds(info.fDevOutside, HasAABloat::kYes, HasZeroWidthEdge::kNo);
        } else {
            ...
            this->setBounds(bounds, HasAABloat::kYes, HasZeroWidthEdge::kNo);
        }
    }
