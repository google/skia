...
private:
   ...
   void onPrepareDraws(Target* target) override {
        ...
        VertexSpec vertexSpec(this->deviceQuadType(), /* hasColor */ true, this->srcQuadType(),
        ...
        for (int i = 0; i < fQuads.count(); ++i) {
            ...
            GrColor color = q.color().toBytes_RGBA();
            vertices = GrQuadPerEdgeAA::Tessellate(vertices, vertexSpec, q.deviceQuad(), color,
