...
GrOp::OpOwner GrFillRectOp::Make(GrRecordingContext* context,
                                 GrPaint&& paint,
                                 GrAAType aaType,
                                 DrawQuad* quad,
...
GrOp::OpOwner GrFillRectOp::MakeNonAARect(GrRecordingContext* context,
                                          GrPaint&& paint,
                                          const SkMatrix& view,
                                          const SkRect& rect,
                                          const GrUserStencilSettings* stencil) {
...
GrOp::OpOwner GrFillRectOp::MakeOp(GrRecordingContext* context,
                                   GrPaint&& paint,
                                   GrAAType aaType,
    ...
    GrOp::OpOwner op = FillRectOp::Make(context, std::move(paint), aaType,
...
void GrFillRectOp::AddFillRectOps(GrRenderTargetContext* rtc,
    ...
    while (numLeft) {
        ...
        GrOp::OpOwner op = MakeOp(context, GrPaint::Clone(paint), aaType, viewMatrix,
