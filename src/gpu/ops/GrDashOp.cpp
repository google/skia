...
public:
    ...
    constexpr const Attribute& inPosition() const { return kInPosition; }

    constexpr const Attribute& inDashParams() const { return kInDashParams; }

    constexpr const Attribute& inCircleParams() const { return kInCircleParams; }
...
private:
    ...
    static constexpr Attribute kInDashParams = {"inDashParams", kHalf3_GrVertexAttribType, kInPosition};
    static constexpr Attribute kInCircleParams = {"inCircleParams", kHalf2_GrVertexAttribType, kInDashParams};
...
public:
    ...
    constexpr const Attribute& inRectParams() const { return kInRectParams; }
