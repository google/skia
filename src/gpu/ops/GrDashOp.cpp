...
private:
    ...
    static constexpr Attribute kInPosition =
            {"inPosition", kFloat2_GrVertexAttribType, kFloat2_GrVertexAttribType};
    static constexpr Attribute kInDashParams =
            {"inDashParams", kFloat3_GrVertexAttribType, kHalf3_GrVertexAttribType};
    static constexpr Attribute kInCircleParams =
            {"inCircleParams", kFloat2_GrVertexAttribType, kHalf2_GrVertexAttribType};
...
private:
    ...
    static constexpr Attribute kInRectParams =
            {"inRect", kFloat4_GrVertexAttribType, kHalf4_GrVertexAttribType};
