...
void GrAtlasTextOp::onPrepareDraws(Target* target) {
    ...
    if (this->usesDistanceFields()) {
        flushInfo.fGeometryProcessor1 = this->setupDfProcessor(target->allocator(),
    ...
    size_t vertexStride = flushInfo.fGeometryProcessor1->vertexStride();
...
void GrAtlasTextOp::flush(GrMeshDrawOp::Target* target, FlushInfo* flushInfo) const {
    ...
    target->recordDraw(flushInfo->fGeometryProcessor1, mesh, 1, flushInfo->fFixedDynamicState,
