...
public:
    ...
    SkString dumpInfo() const override {
        ...
        string.appendf("RT: %d", fProxyUniqueID.asUInt());
...
private:
    GrStencilPathOp(const SkMatrix& viewMatrix,
        ...
        fRenderTarget1.reset(renderTargetContext->accessRenderTarget());
    }
    ...
    void onExecute(GrOpFlushState* state) override {
        ...
        GrPathRendering::StencilPathArgs args(fUseHWAA, fRenderTarget1.get(), &fViewMatrix,
                                              &fScissor, &fStencil);
