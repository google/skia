...
private:
    ...
    public:
        ...
        static void GenKey(const GrGeometryProcessor& gp,
            ...
            b->addBits(1, cgp.fStroke,                                     "stroked");
            b->addBits(1, cgp.fInClipPlane.isInitialized(),                "clipPlane");
            b->addBits(1, cgp.fInIsectPlane.isInitialized(),               "isectPlane");
            b->addBits(1, cgp.fInUnionPlane.isInitialized(),               "unionPlane");
            b->addBits(1, cgp.fInRoundCapCenters.isInitialized(),          "roundCapCenters");
...
private:
    ...
    public:
        ...
        static void GenKey(const GrGeometryProcessor& gp,
            ...
            b->addBits(1, egp.fStroke, "stroked");
