...
public:
    ...
    static std::unique_ptr<GrDrawOp> Make(GrContext* context,
                                          ...
                                          bool strokeOnly) {
        return Helper::FactoryHelper<CircularRRectOp>(context, std::move(paint), viewMatrix, devRect,
...
std::unique_ptr<GrDrawOp> GrOvalOpFactory::MakeRRectOp(GrContext* context, GrPaint&& paint,
                                                       const SkMatrix& viewMatrix,
                                                       const SkRRect& rrect,
                                                       const SkStrokeRec& stroke,
