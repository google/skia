...
private:
    void onPrepareDraws(Target* target) override {
        ...
        for (const auto& circle : fCircles) {
            ...
            if (!circle.fStroked && fClipPlane && fClipPlaneIsect &&
                    (circle.fClipPlane.fX * circle.fIsectPlane.fX +
                     circle.fClipPlane.fY * circle.fIsectPlane.fY) < 0.0f) {
                ...
                geoClipPlane.set(circle.fClipPlane.fY - circle.fIsectPlane.fY,
                                 circle.fIsectPlane.fX - circle.fClipPlane.fX);
            ...
            for (int i = 0; i < 8; ++i) {
                ...
                if (fRoundCaps) {
                    vertices = writeVertexData(vertices, circle.fRoundCapCenters[0],
                                                         circle.fRoundCapCenters[1]);
                }
            }
    ...
    struct Circle {
        ...
        SkScalar fInnerRadius;
        SkScalar fOuterRadius;
        SkVector3 fClipPlane;
        SkVector3 fIsectPlane;
        SkVector3 fUnionPlane;
