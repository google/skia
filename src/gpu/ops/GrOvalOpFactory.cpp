...
public:
    ...
    CircleOp(const Helper::MakeArgs& helperArgs, GrColor4h color,
...
public:
    ...
    EllipseOp(const Helper::MakeArgs& helperArgs, GrColor4h color,
...
public:
    ...
    DIEllipseOp(Helper::MakeArgs& helperArgs, GrColor4h color,
...
public:
    ...
    CircularRRectOp(Helper::MakeArgs& helperArgs, GrColor4h color,
...
public:
    ...
    EllipticalRRectOp(Helper::MakeArgs helperArgs, GrColor4h color,
