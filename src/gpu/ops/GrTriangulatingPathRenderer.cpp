...
private:
    ...
    void onPrePrepareDraws(GrRecordingContext* rContext,
        ...
        // will replace its version in the cache if 'fVertexData'. This will leave some other
        // recording threads using a poorer version but will result in a version with greater
        // applicability being in the cache.
