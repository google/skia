...
public:
    ...
    /**
     * Mesh draw ops use a legacy system in GrRenderTargetOpList where the pipeline is created when
    ...
    void finalize(const GrCaps&, const GrAppliedClip*, bool*) override {
...
private:
    ...
    */
    ...
    void onExecute(GrOpFlushState* state, const SkRect& bounds, const GrAppliedClip*, GrRenderTarget*) final;
