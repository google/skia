...
public:
    ...
    // This should be called during onPrepare of a GrOp. The caller should then add any proxies to
    // the array it will use that it did not access during a call to visitProxies. This is usually
    // the case for atlases.
