...
public:
     ...
     */
    virtual void* makeVertexSpace(size_t vertexSize, int vertexCount, const GrBuffer**, int* startVertex) = 0;
    ...
    virtual void* makeVertexSpaceAtLeast(size_t vertexSize, int minVertexCount, int fallbackVertexCount,
                                 const GrBuffer**, int* startVertex, int* actualVertexCount) = 0;
    ...
    virtual uint16_t* makeIndexSpaceAtLeast(int minIndexCount, int fallbackIndexCount,
                                    const GrBuffer**, int* startIndex, int* actualIndexCount) = 0;
    ...
    // TODO: SPECIFY THESE SEPARATELY?
    virtual GrRenderTargetProxy* proxy() const = 0;

    virtual const GrAppliedClip* clip() const  = 0;
