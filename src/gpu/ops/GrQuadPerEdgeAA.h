...
public:
    ...
    public:
        ...
        GPAttributes(int posDim, int localDim, bool hasColor, GrAA aa, Domain domain);
        ...
        void emitColor(GrGLSLPrimitiveProcessor::EmitArgs& args, GrGLSLColorSpaceXformHelper* colorSpaceXformHelper,
        ...
        void emitExplicitLocalCoords(GrGLSLPrimitiveProcessor::EmitArgs& args, const char* localCoordName,
                                     const char* domainVarName) const;

        void emitCoverage(GrGLSLPrimitiveProcessor::EmitArgs& args, const char* edgeDistName) const;
    private:
        Attribute fPositions;   // named "position"
        Attribute fColors;      // named "color"
        Attribute fLocalCoords; // named "localCoord"
        Attribute fDomain;      // named "domain"
