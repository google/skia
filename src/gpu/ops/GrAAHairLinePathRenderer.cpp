...
static sk_sp<const GrBuffer> ref_quads_index_buffer(GrResourceProvider* resourceProvider) {
...
static sk_sp<const GrBuffer> ref_lines_index_buffer(GrResourceProvider* resourceProvider) {
