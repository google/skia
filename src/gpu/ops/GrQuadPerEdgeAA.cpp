...
// outset and outsetCW are provided separately to allow for different magnitude outsets for with-edge
// and "perpendicular" edge shifts. This is needed when one axis cannot be inset the full half
// pixel without crossing over the other side.
