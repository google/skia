 ...
 */
class GrStencilMeshDrawOpHelperWithStencil : private GrSimpleMeshDrawOpHelper {
public:
    ...
    GrStencilMeshDrawOpHelperWithStencil(const MakeArgs& args, GrAAType aaType,
    ...
    bool isCompatible(const GrStencilMeshDrawOpHelperWithStencil& that) const {
