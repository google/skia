 ...
 */
class GrSimplelMeshDrawOpHelperWithStencil : private GrSimpleMeshDrawOpHelper {
public:
    ...
    GrSimplelMeshDrawOpHelperWithStencil(const MakeArgs& args, GrAAType aaType,
    ...
    bool isCompatible(const GrSimplelMeshDrawOpHelperWithStencil& that) const {
