...
public:
    ...
    /**
     * Version of above that can be used by ops that have a constant color geometry processor output.
     * The op passes this color as 'geometryColor' and after return if 'geometryColor' has changed the
     * op must override its geometry processor color output with the new color.
     */
