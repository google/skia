...
public:
    ...
    GrProcessorSet::Analysis finalizeProcessors(
            ...
            GrNeedsClamp needsClamp, GrProcessorAnalysisCoverage geometryCoverage,
            GrProcessorAnalysisColor* geometryColor) {
        return this->finalizeProcessors(caps, clip, &GrUserStencilSettings::kUnused, fsaaType,
                                        needsClamp, geometryCoverage, geometryColor);
    }
...
protected:
    ...
    GrProcessorSet::Analysis finalizeProcessors(
            ...
            GrNeedsClamp, GrProcessorAnalysisCoverage geometryCoverage,
            GrProcessorAnalysisColor* geometryColor);
...
public:
    ...
    GrProcessorSet::Analysis finalizeProcessors(
        ...
        return this->INHERITED::finalizeProcessors(
                caps, clip, fStencilSettings, fsaaType, needsClamp, geometryCoverage, geometryColor);
    }
