...
public:
    ...
    GrPixelInfo(GrColorType ct, SkAlphaType at, sk_sp<SkColorSpace> cs, const SkISize& dimensions)
    ...
    SkImageInfo asImageInfo() const {
        return SkImageInfo::Make(this->width(),
                                 this->height(),
                                 GrColorTypeToSkColorType(fColorInfo.colorType()),
                                 this->alphaType(),
                                 this->refColorSpace());
    }
