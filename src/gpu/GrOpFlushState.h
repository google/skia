...
public:
    ...
    // viewports and scissors. This is used to offset all the renderTasks within a DDL.
...
private:
    ...
    SkIPoint fViewportOffset = { 0, 0 };  // only valid when fViewportOffsetVictim is set
