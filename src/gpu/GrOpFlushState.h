...
public:
    ...
    // This is a convenience for for when the primitive processor has exactly one texture. It binds
    // one texture for the primitive processor, and any others for FPs on the pipeline.
