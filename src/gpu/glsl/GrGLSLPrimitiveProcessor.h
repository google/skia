...
public:
    ...
    using CoordTransformRange   = GrFragmentProcessor::CoordTransformRange<GrPipeline>;
     ...
     * transforms of the FPs that part of the program, , such as updating matrix uniforms. The
     * range will iterate over the transforms in the same order as the TransformHandler passed to
     * emitCode.
     */
