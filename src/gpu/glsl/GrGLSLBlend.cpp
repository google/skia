...
static void add_lum_function(GrGLSLFragmentBuilder* fsBuilder, SkString* setLumFunction) {
    ...
    GrShadeVar getLumArgs[] = {
        GrShadeVar("color", kVec3f_GrSLType),
    };
    ...
    GrShadeVar setLumArgs[] = {
        GrShadeVar("hueSat", kVec3f_GrSLType),
        GrShadeVar("alpha", kFloat_GrSLType),
        GrShadeVar("lumColor", kVec3f_GrSLType),
    };
    SkString setLumBody;
...
static void add_sat_function(GrGLSLFragmentBuilder* fsBuilder, SkString* setSatFunction) {
    ...
    SkString getFunction;
    GrShadeVar getSatArgs[] = { GrShadeVar("color", kVec3f_GrSLType) };
    SkString getSatBody;
    ...
    GrShadeVar helperArgs[] = {
        GrShadeVar("minComp", kFloat_GrSLType),
        GrShadeVar("midComp", kFloat_GrSLType),
        GrShadeVar("maxComp", kFloat_GrSLType),
        GrShadeVar("sat", kFloat_GrSLType),
    };
    ...
    GrShadeVar setSatArgs[] = {
        GrShadeVar("hueLumColor", kVec3f_GrSLType),
        GrShadeVar("satColor", kVec3f_GrSLType),
    };
