...
void GrGLSLShaderBuilder::declAppend(const GrShadeVar& var) {
    SkString tempDecl;
...
void GrGLSLShaderBuilder::appendColorGamutXform(SkString* out,
    ...
    static const GrShadeVar gColorGamutXformArgs[] = {
        GrShadeVar("color", kVec4f_GrSLType),
        GrShadeVar("xform", kMat44f_GrSLType),
    };
