...
protected:
    ...
    struct GrGPArgs {
        // Used to specify yhe output variable used by a GP to store its device position. It can be
        // either a float2 or a float3 depending on the presence of perspective. The subclass sets
        // this in its onEmitCode().
