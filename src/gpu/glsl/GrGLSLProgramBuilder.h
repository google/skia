...
public:
    ...
    const GrShaderVar& storageImageVariable(StorageImageHandle handle) const {
        return this->uniformHandler()->storageImageVariable(handle);
    }
...
private:
    ...
    void emitSamplersAndImages(const GrProcessor& processor,
    ...
    void emitImage(GrPixelConfig,
                   const char* name,
                   GrShaderFlags visibility,
                   SkTArray<StorageImageHandle>* outStorageImageHandles);
    void emitFSOutputSwizzle(bool hasSecondaryOutput);
    bool checkSamplerCounts();
    bool checkImageCounts();
    ...
    int                         fNumVertexImages;
    int                         fNumGeometryImages;
    int                         fNumFragmentImages;
