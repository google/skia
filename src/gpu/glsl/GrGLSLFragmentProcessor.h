...
public:
    ...
    using StorageImages = BuilderInputProvider<StorageImageHandle, GrProcessor,
                                               &GrProcessor::numStorageImages>;
    ...
    /** Called when the program stage should insert its code into the shaders. The code in each
        ...
        @param bufferSamplers    Contains one entry for each BufferAccess of the GrProcessor. These
                                 ...
                                 code.
        @param storageImages     Contains one entry for each StorageImageAccess of the GrProcessor.
    ...
    struct EmitArgs {
        EmitArgs(GrGLSLFPFragmentBuilder* fragBuilder,
                 ...
                 const StorageImages& storageImages,
        ...
        const StorageImages& fStorageImages;
