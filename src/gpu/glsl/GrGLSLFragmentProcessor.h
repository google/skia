...
public:
    ...
    struct EmitArgs {
        EmitArgs(GrGLSLFPFragmentBuilder* fragBuilder,
                ...
                , fHasCoordOverrides(hasCoordOverrides)
...
private:
    ...
    // one per child; true if the child is called with overridden coordinates
    SkTArray<bool> fHasCoordOverrides;
