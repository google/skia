...
private:
    ...
    void onPrepareDraws(Target* target) const override {
        ...
        for (int i = 0; i < instanceCount; i++) {
            ...
            ShapeData::Key key(args.fShape, SkScalarFloorToInt(desiredDimension));
            ...
            if (nullptr == shapeData || !atlas->hasID(shapeData->fID)) {
                ...
                if (!this->addPathToAtlas(target,
                                          ...
                                          args.fShape,
                                          args.fAntiAlias,
                                          SkScalarFloorToInt(desiredDimension),
                                          scale)) {
                    delete shapeData;
    ...
    bool addPathToAtlas(GrMeshDrawOp::Target* target, FlushInfo* flushInfo, GrBatchAtlas* atlas,
        ...
        devPathBounds.fRight = width;
        devPathBounds.fBottom = height;
        ...
        shapeData->fScaleToDev = 1.0f/scale;
