...
class GrNonAAFillRectPerspectiveOp : public GrMeshDrawOp {
public:
    DEFINE_OP_CLASS_ID

    GrNonAAFillRectPerspectiveOp(GrColor color, const SkMatrix& viewMatrix, const SkRect& rect,
...
private:
    GrNonAAFillRectPerspectiveOp() : INHERITED(ClassID()) {}
    ...
    bool onCombineIfPossible(GrOp* t, const GrCaps& caps) override {
        GrNonAAFillRectPerspectiveOp* that = t->cast<GrNonAAFillRectPerspectiveOp>();
...
sk_sp<GrDrawOp> MakeWithPerspective(GrColor color,
                                    ...
                                    const SkMatrix* localMatrix) {
    return new GrNonAAFillRectPerspectiveOp(color, viewMatrix, rect, localRect, localMatrix);
}
};
