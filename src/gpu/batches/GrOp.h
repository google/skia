 ...
 * the draw, ie whether or not the GrOp is allowed to tweak alpha for coverage, then this
...
protected:
    ...
    /**
     * Indicates that the geometry represented by the op has zero area (i.e. it is hairline or
     * points).
     */
