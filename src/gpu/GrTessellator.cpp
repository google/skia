 ...
 *    active edge list. This is handled by detecting potential violatins and rewinding
...
void merge_edges_above(Edge* edge, Edge* other, EdgeList* activeEdges, Vertex** current, Comparator& c) {
...
void merge_edges_below(Edge* edge, Edge* other, EdgeList* activeEdges, Vertex** current, Comparator& c) {
...
void split_edge(Edge* edge, Vertex* v, EdgeList* activeEdges, Vertex** current, Comparator& c, SkArenaAlloc& alloc) {
