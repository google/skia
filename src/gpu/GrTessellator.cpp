...
void remove_non_boundary_edges(const VertexList& mesh, SkPath::FillType fillType, SkChunkAlloc& alloc) {
...
EdgeList* extract_boundaries(const VertexList& mesh, SkPath::FillType fillType, SkChunkAlloc& alloc) {
