...
static D3D12_PRIMITIVE_TOPOLOGY_TYPE gr_primitive_type_to_d3d(GrPrimitiveType primitiveType) {
    switch (primitiveType) {
        ...
        case GrPrimitiveType::kTriangleStrip:[[fallthrough]];
        ...
        case GrPrimitiveType::kPatches: [[fallthrough]]; // unsupported
        case GrPrimitiveType::kPath: [[fallthrough]]; // unsupported
        default:
            SkUNREACHABLE;
    }
}
