...
private:
    ...
    public:
        ...
        ID3D12DescriptorHeap* d3dHeap() const { return fHeap->descriptorHeap(); }
        D3D12_DESCRIPTOR_HEAP_TYPE type() const { return fType; }
        unsigned int size() { return fNumDescriptors; }
