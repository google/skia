...
private:
    ...
    void bindHeapsIfNecessary(GrD3DGpu*);
    void resetCurrentHeaps() {
        fCurrentCBVSRVDescriptorHeap = nullptr;
        fCurrentSamplerDescriptorHeap = nullptr;
    }
    void recycle(Heap*);

    HeapPool fCBVSRVDescriptorPool;
    Heap* fCurrentCBVSRVDescriptorHeap;
    HeapPool fSamplerDescriptorPool;
    Heap* fCurrentSamplerDescriptorHeap;
};
