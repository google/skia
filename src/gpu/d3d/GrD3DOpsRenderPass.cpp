...
void GrD3DOpsRenderPass::inlineUpload(GrOpFlushState* state, GrDeferredTextureUploadFn& upload) {
    // If we even start using copy command lists for doing uploads then we'll need to make sure
    // we stop our main command list before doing the copy here and then start a new main command
    // list
