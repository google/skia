...
ComPtr<ID3D12Resource> GrD3DAMDMemoryAllocator::createResource(
        ...
        const D3D12_CLEAR_VALUE* clearValue, REFIID riidResource,
        void** ppvResource) {
    D3D12MA::ALLOCATION_DESC allocationDesc = {};
    allocationDesc.HeapType = heapType;
    // TODO: determine flags. For now just use standard allocation
