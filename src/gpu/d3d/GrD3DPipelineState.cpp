...
std::unique_ptr<GrD3DPipelineState> GrD3DPipelineState::Make(GrD3DGpu* gpu,
    ...
    // actually definite what quality levels are and leaves it up to driver implementations to
    // define them for themselves. In many cases the increased quality is simple a different sample
    // pattern in the pixel.
