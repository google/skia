...
GrD3DTextureRenderTarget::GrD3DTextureRenderTarget(GrD3DGpu* gpu,
        ...
        , GrD3DSurfaceResource(info, state, GrBackendObjectOwnership::kOwned)
...
static std::pair<GrD3DTextureInfo, sk_sp<GrD3DResourceState>> create_msaa_resource(
...
sk_sp<GrD3DTextureRenderTarget> GrD3DTextureRenderTarget::MakeNewTextureRenderTarget(
    ...
    if (!GrD3DSurfaceResource::InitTextureInfo(gpu, resourceDesc, isProtected, &info)) {
        return nullptr;
    }
