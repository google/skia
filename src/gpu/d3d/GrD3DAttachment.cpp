...
GrD3DAttachment::GrD3DAttachment(GrD3DGpu* gpu,
        ...
        : GrAttachment(gpu, dimensions, desc.SampleDesc.Count, GrProtected::kNo)
...
GrD3DAttachment* GrD3DAttachment::Make(GrD3DGpu* gpu,
                                       SkISize dimensions,
                                       int sampleCnt,
                                       DXGI_FORMAT format) {
    ...
    GrD3DAttachment* stencil = new GrD3DAttachment(gpu, dimensions, format, resourceDesc, info,
                                                   std::move(state), view);
    return stencil;
}
