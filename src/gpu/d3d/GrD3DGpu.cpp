...
bool GrD3DGpu::onClearBackendTexture(const GrBackendTexture& backendTexture,
    ...
    SkDebugf(" - about to get copyable footprints\n");
    ...
    SkDebugf(" - copied buffer to texture\n");
    if (finishedCallback) {
        SkDebugf(" - calling finished\n");
