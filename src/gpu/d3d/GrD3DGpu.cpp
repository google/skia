...
GrAttachment* GrD3DGpu::createStencilAttachmentForRenderTarget(const GrRenderTarget* rt,
                                                               SkISize dimensions,
    ...
    GrD3DAttachment* stencil(GrD3DAttachment::Make(this, dimensions, numStencilSamples, sFmt));
