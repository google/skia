...
bool GrD3DGpu::onRegenerateMipMapLevels(GrTexture * tex) {
    ...
    if (caps.isFormatUnorderedAccessible(d3dTex->dxgiFormat()) &&
        ...
        if (isBGR) {
            ...
            this->currentCommandList()->copyTextureToTexture(bgrAlias.get(), d3dTex);
            ...
            this->currentCommandList()->copyTextureToTexture(uavTexture.get(), d3dTex);
        }
    }
    ...
    if (uavTexture.get() != d3dTex) {
        ...
        if (bgrAlias) {
            ...
            this->currentCommandList()->copyTextureToTexture(d3dTex, bgrAlias.get());
        } else {
