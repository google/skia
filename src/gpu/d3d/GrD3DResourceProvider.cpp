...
void GrD3DResourceProvider::bindDescriptorTableHeaps(bool doBind) {
    if (doBind) {
        fDescriptorTableManager.bindHeaps(fGpu->currentCommandList());
    } else {
        fDescriptorTableManager.unbindHeaps();
    }
}
