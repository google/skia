...
class GrD3DTexture : public GrTexture, public virtual GrD3DTextureBase {
public:
...
private:
    GrD3DTexture(GrD3DGpu*, SkBudgeted, SkISize, const GrD3DTextureInfo&, sk_sp<GrD3DResourceState>,
                 GrMipMapsStatus);
    GrD3DTexture(GrD3DGpu*, SkISize, const GrD3DTextureInfo&, sk_sp<GrD3DResourceState>,
