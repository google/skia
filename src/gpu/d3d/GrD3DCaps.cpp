...
void GrD3DCaps::initStencilFormat(ID3D12Device* device) {
    ...
    // DXGI_FORMAT_D32_FLOAT_S8X24_UINT has 24 unused bits at the end so the total bits is 64.
    static const StencilFormat
        // internal Format                         stencil bits      total bits        packed?
        gD24S8 = { DXGI_FORMAT_D24_UNORM_S8_UINT,    8,                32,               true },
        gD32S8 = { DXGI_FORMAT_D32_FLOAT_S8X24_UINT, 8,                64,               true };
