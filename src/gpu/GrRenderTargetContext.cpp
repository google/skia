...
void GrRenderTargetContext::drawPosText(const GrClip& clip,
    ...
    GrAtlasTextContext* atlasTextContext = fDrawingManager->getAtlasTextContext();
    atlasTextContext->drawPosText(fContext, this, clip, paint, viewMatrix,
...
void GrRenderTargetContext::drawTextBlob(const GrClip& clip, const SkPaint& paint,
    ...
    GrAtlasTextContext* atlasTextContext = fDrawingManager->getAtlasTextContext();
    atlasTextContext->drawTextBlob(fContext, this, clip, paint, viewMatrix, fSurfaceProps, blob,
