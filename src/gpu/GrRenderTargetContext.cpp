...
void GrRenderTargetContext::drawTextureSet(const GrClip& clip, const TextureSetEntry set[], int cnt, GrSamplerState::Filter filter, GrColor color, const SkMatrix& viewMatrix, sk_sp<GrColorSpaceXform> texXform, sk_sp<GrColorSpaceXform> colorXform) {
    ASSERT_SINGLE_OWNER
    RETURN_IF_ABANDONED
    SkDEBUGCODE(this->validate();)
