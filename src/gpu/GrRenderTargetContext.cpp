...
void GrRenderTargetContext::internalStencilClear(const GrFixedClip& clip, bool insideStencilMask) {
    ...
    // clear. If the render target has msaa or if another draw requires mixed samples, then the
    // stencil buffer will be upgraded automatically to multisampled at that point.
