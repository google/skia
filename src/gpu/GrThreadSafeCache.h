...
public:
    ...
    // To hold vertex data in the cache and have it transparently transistion from cpu-side to
    ...
    // This call takes ownership of 'vertices' which had better have been allocated with malloc!
