...
void SkGpuDevice::drawBitmapTile(const SkBitmap& bitmap,
    ...
    sk_sp<GrTexture> texture = GrMakeCachedBitmapTexture(
        fContext, bitmap, params, fRenderTargetContext->colorMode());
    if (nullptr == texture) {
        return;
    }
...
void SkGpuDevice::drawSprite(const SkDraw& draw, const SkBitmap& bitmap,
    ...
    sk_sp<GrTexture> texture;
    {
        ...
        texture.reset(
            GrRefCachedBitmapTexture(fContext, bitmap, GrTextureParams::ClampNoFilter(),
...
sk_sp<SkSpecialImage> SkGpuDevice::makeSpecial(const SkBitmap& bitmap) {
    ...
    sk_sp<GrTexture> texture =
        GrMakeCachedBitmapTexture(fContext, bitmap, GrTextureParams::ClampNoFilter(),
                                  SkDestinationSurfaceColorMode::kGammaAndColorSpaceAware);
    if (!texture) {
        return nullptr;
    }
