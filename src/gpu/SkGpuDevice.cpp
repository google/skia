    ...
    if (needsTextureDomain && (SkCanvas::kStrict_SrcRectConstraint == constraint)) {
        ...
        if (bicubic) {
            fp = GrBicubicEffect::Make(std::move(proxy), texMatrix, domain,
                    GrBicubicEffect::Kernel::kMitchell, bitmap.alphaType());
        } else {
        ...
        fp = GrBicubicEffect::Make(std::move(proxy), texMatrix, GrBicubicEffect::Kernel::kMitchell,
                wrapMode, bitmap.alphaType());
    } else {
