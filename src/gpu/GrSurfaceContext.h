...
public:
     ...
     * @param GrDirectContext The direct context to use. If null will use our GrRecordingContext
     *                        if it is a GrDirectContext and fail otherwise.
     ...
     */
    bool readPixels(GrDirectContext* ,const GrImageInfo& dstInfo, void* dst,
                    size_t rowBytes, SkIPoint srcPt);
     ...
     */
    bool writePixels(GrDirectContext*, const GrImageInfo& srcInfo, const void* src,
                     size_t rowBytes, SkIPoint dstPt);
...
protected:
    ...
    void asyncReadPixels(GrDirectContext*, const SkIRect&,
                         SkColorType,
                         ReadPixelsCallback,
                         ReadPixelsContext);
