...
public:
    ...
    /**
     * Rescales the contents of srcRect. The gamma in which the rescaling occurs is controlled by RescaleGamma. It
     * is always in original gamut. The result is converted to the color type and color space of info after rescaling.
     * Note: this currently requires that the info have a different size than srcCect. Though, it could be relaxed to
     * allow non-scaling color conversions.
     */
