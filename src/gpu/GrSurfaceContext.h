...
protected:
    ...
    GrDrawingManager* drawingManager1() { return fDrawingManager1; }
    const GrDrawingManager* drawingManager1() const { return fDrawingManager1; }
