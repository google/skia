...
public:
     ...
     * RescaleGamma. It is always in original gamut. The result is converted to the color type and
     * color space of info after rescaling. Note: this currently requires that the info have a
