...
bool GrContext::initCommon17(const GrContextOptions& options) {
    ASSERT_SINGLE_OWNER
...
//    fSharpenMipmappedTextures = options.fSharpenMipmappedTextures;
    ...
    fGlyphCache = new GrStrikeCache(this->caps(), options.fGlyphCacheTextureMaximumBytes);
...
bool GrContextWeakest::matches(GrContextWeakest* context) const {
