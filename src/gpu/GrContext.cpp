...
GrBackendTexture GrContext::createCompressedBackendTexture(int width, int height,
    ...
    return this->createCompressedBackendTexture(width, height, format, mipMapped, isProtected);
}
...
GrBackendTexture GrContext::createCompressedBackendTexture(int width, int height,
                                                           const GrBackendFormat& backendFormat,
                                                           void* compressedData, size_t dataSize,
                                                           GrMipMapped mipMapped,
                                                           GrProtected isProtected) {
    TRACE_EVENT0("skia.gpu", TRACE_FUNC);
    if (!this->asDirectContext()) {
...
GrBackendTexture GrContext::createCompressedBackendTexture(int width, int height,
    ...
    return this->createCompressedBackendTexture(width, height, format, data, dataSize, mipMapped, isProtected);
}
