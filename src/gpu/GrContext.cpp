...
bool GrContext::writeSurfacePixels(GrSurface* surface, SkColorSpace* dstColorSpace,
    ...
    if (GrGpu::kNoDraw_DrawPreference != drawPreference) {
        sk_sp<GrSurfaceProxy> temp = GrSurfaceProxy::MakeDeferred(this,
...
sk_sp<GrSurfaceContext> GrContextPriv::makeDeferredSurfaceContext(const GrSurfaceDesc& dstDesc,
    ...
    sk_sp<GrSurfaceProxy> proxy = GrSurfaceProxy::MakeDeferred(fContext, dstDesc,
                                                               fit, isDstBudgeted);
    if (!proxy) {
        return nullptr;
    }
...
sk_sp<GrRenderTargetContext> GrContext::makeDeferredRenderTargetContext(
    ...
    sk_sp<GrSurfaceProxy> rtp = GrSurfaceProxy::MakeDeferred(this, desc, fit, budgeted);
    if (!rtp) {
        return nullptr;
    }
