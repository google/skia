...
void GrContext::initCommon(const GrContextOptions& options) {
    ...
    // GrAtlasFontCache will eventually replace GrFontCache
    fAtlasFontCache = new GrAtlasFontCache(this);
