...
GrDawnBuffer::GrDawnBuffer(GrDawnGpu* gpu, size_t sizeInBytes, GrGpuBufferType type,
    ...
    if (bufferDesc.usage & wgpu::BufferUsage::MapRead) {
        // Currently everything we create that is mapable is both ReandAndWrite supported cause we
        ...
        fMapable = bufferDesc.usage & wgpu::BufferUsage::MapWrite ? Mapable::kReadOnly
                                                                  : Mapable::kReadAndWrite;
    }
