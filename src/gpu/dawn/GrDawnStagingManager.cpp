...
static void init_callback(dawnBufferMapAsyncStatus status, void* data, uint32_t dataLength,
...
static void callback(dawnBufferMapAsyncStatus status, void* data, uint32_t dataLength,
                     dawnCallbackUserdata userData) {
