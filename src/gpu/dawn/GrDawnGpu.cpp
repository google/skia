...
static dawn::Texture getDawnTextureFromSurface(GrSurface* src) {
...
bool GrDawnGpu::onCopySurface(GrSurface* dst,
    ...
    dawn::Texture srcTexture = getDawnTextureFromSurface(src);
    dawn::Texture dstTexture = getDawnTextureFromSurface(dst);
...
bool GrDawnGpu::onReadPixels(GrSurface* surface, int left, int top, int width, int height,
                             ...
                             size_t rowBytes) {
    dawn::Texture tex = getDawnTextureFromSurface(surface);
