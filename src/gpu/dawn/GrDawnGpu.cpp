...
void GrDawnGpu::onFinishFlush(GrSurfaceProxy*, SkSurface::BackendSurfaceAccess access,
...
static void callback(DawnBufferMapAsyncStatus status, const void* data, uint64_t dataLength, dawn::CallbackUserdata userdata) {
...
bool GrDawnGpu::onReadPixels(GrSurface* surface,
    ...
    buf.MapReadAsync(callback, reinterpret_cast<dawn::CallbackUserdata>(this));
