...
GrAttachment* GrDawnGpu::createStencilAttachmentForRenderTarget(const GrRenderTarget* rt,
                                                                SkISize dimensions,
                                                                int numStencilSamples) {
    GrDawnAttachment* stencil(GrDawnAttachment::Create(
            this, dimensions, GrAttachment::UsageFlags::kStencil, numStencilSamples));
