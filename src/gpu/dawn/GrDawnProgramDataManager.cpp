...
#include "GrDawnProgramDataManager.h"
...
void GrDawnProgramDataManager::set4i(UniformHandle u, int32_t i0, int32_t i1, int32_t i2, int32_t i3) const {
    const Uniform& uni = fUniforms[u.toIndex()];
    void* buffer = this->getBufferPtrAndMarkDirty(uni);
...
void GrDawnProgramDataManager::set4f(UniformHandle u, float v0, float v1, float v2, float v3) const {
    const Uniform& uni = fUniforms[u.toIndex()];
    void* buffer = this->getBufferPtrAndMarkDirty(uni);
...
void GrDawnProgramDataManager::setMatrix2fv(UniformHandle u, int arrayCount, const float m[]) const {
...
void GrDawnProgramDataManager::setMatrix3fv(UniformHandle u, int arrayCount, const float m[]) const {
...
void GrDawnProgramDataManager::setMatrix4fv(UniformHandle u, int arrayCount, const float m[]) const {
...
void GrDawnProgramDataManager::uploadUniformBuffers(GrDawnGpu* gpu,
    ...
    dawn::Buffer geom = geometryBuffer.fBuffer.Clone();
    uint32_t geomOffset = geometryBuffer.fOffset;
    dawn::Buffer frag = fragmentBuffer.fBuffer.Clone();
