...
public:
    static GrDawnStencilAttachment* Create(GrDawnGpu* gpu, const SkISize& dimensions,
                                           int sampleCnt);
...
private:
    ...
    GrDawnStencilAttachment(GrDawnGpu* gpu, const SkISize& dimensions, int bits, int samples,
