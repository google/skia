...
sk_sp<GrDawnProgram> GrDawnProgramBuilder::Build(GrDawnGpu* gpu,
    ...
    if (0 != geometryUniformSize) {
        ...
        bindings.push_back(MakeBindGroupBinding(0, result->fGeometryUniformBuffer, 0, geometryUniformSize));
        layoutBindings.push_back({ 0, dawn::ShaderStageBit::Vertex, dawn::BindingType::UniformBuffer});
    }
    if (0 != fragmentUniformSize) {
        ...
        bindings.push_back(MakeBindGroupBinding(1, result->fFragmentUniformBuffer, 0, fragmentUniformSize));
        layoutBindings.push_back({ 1, dawn::ShaderStageBit::Fragment, dawn::BindingType::UniformBuffer});
    }
