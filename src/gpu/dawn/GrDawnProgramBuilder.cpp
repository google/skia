...
SkSL::String sksl_to_spirv(const GrDawnGpu* gpu, const char* shaderString,
...
sk_sp<GrDawnProgram> GrDawnProgramBuilder::Build(GrDawnGpu* gpu,
    ...
    if (0 != geometryUniformSize) {
        ...
        bindings.push_back(MakeBindGroupBinding(0, result->fGeometryUniformBuffer, 0,
                                                geometryUniformSize));
    ...
    if (0 != fragmentUniformSize) {
        ...
        bindings.push_back(MakeBindGroupBinding(1, result->fFragmentUniformBuffer, 0,
                                                fragmentUniformSize));
