...
struct GrDawnProgram : public SkRefCnt {
    ...
    dawn::BindGroup setData(GrDawnGpu* gpu, const GrPrimitiveProcessor&, const GrPipeline&,
                            const GrTextureProxy* const primProcTextures[]);
};
...
private:
    GrDawnProgramBuilder(GrDawnGpu*, const GrPrimitiveProcessor&, const GrPipeline&,
                        GrProgramDesc*);
