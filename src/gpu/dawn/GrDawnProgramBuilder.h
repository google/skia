...
struct GrDawnProgram : public SkRefCnt {
    ...
    static constexpr int kMaxBindGroupCacheEntries = 4096;
    ...
    struct UniformBindGroupKey {
        static constexpr int kPreAllocSize = 128;
        UniformBindGroupKey() {}
    ...
    SkLRUCache<UniformBindGroupKey, wgpu::BindGroup, UniformBindGroupKey::Hash> fUniformBindGroupCache;
