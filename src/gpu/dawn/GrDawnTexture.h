...
public:
    static sk_sp<GrDawnTexture> Make(GrDawnGpu*, const GrSurfaceDesc&, GrRenderable, SkBudgeted,
                                     GrMipMapsStatus);

    static sk_sp<GrDawnTexture> MakeWrapped(GrDawnGpu*, const GrSurfaceDesc&, GrRenderable,
