...
GrDawnAttachment::GrDawnAttachment(GrDawnGpu* gpu,
        ...
        : INHERITED(gpu, dimensions, samples, GrProtected::kNo), fTexture(texture), fView(view) {
    this->registerWithCache(SkBudgeted::kYes);
}

GrDawnAttachment* GrDawnAttachment::Create(GrDawnGpu* gpu, SkISize dimensions, int sampleCnt) {
