...
private:
    GrDawnGpu*                         fGpu;
    dawn::CommandBufferBuilder        fBuilder;
...
public:
    ...
    dawn::RenderPassDescriptor createRenderPassDescriptor(dawn::LoadOp colorOp,
...
private:
    ...
    GrDawnGpu*                   fGpu;
    dawn::RenderPassDescriptor  fRenderPassDescriptor;
    dawn::CommandBufferBuilder  fBuilder;
    dawn::RenderPassEncoder     fEncoder;
