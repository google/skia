...
public:
    ...
    dawn::Device device() const { return fDevice.Clone(); }
    dawn::Queue  queue() const { return fQueue.Clone(); }
    ...
    dawn::CommandBufferBuilder getCopyBuilder() { return fCopyBuilder.Clone(); }
