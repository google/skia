...
#include "dawn/GrDawnRingBuffer.h"
#include "dawn/GrDawnStagingManager.h"
...
public:
    static sk_sp<GrGpu> Make(sk_sp<const GrDawnBackendContext>, const GrContextOptions&, GrContext*);
    GrDawnGpu(GrContext* context, const GrContextOptions& options, sk_sp<const GrDawnBackendContext>);

    ~GrDawnGpu() override;

    void disconnect(DisconnectType) override;

    dawn::Device device() const { return fDevice; }
    dawn::Queue  queue() const { return fQueue; }
    ...
    dawn::CommandBufferBuilder getCopyBuilder() { return fCopyBuilder; }
...
private:
    ...
    sk_sp<GrTexture> onWrapBackendTexture(const GrBackendTexture&, GrWrapOwnership, bool purgeImmediately) override;
    ...
    dawn::CommandBufferBuilder                   fCopyBuilder;
