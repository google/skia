...
#include "dawn/GrDawnCaps.h"
#include "dawn/GrDawnGpu.h"
#include "dawn/GrDawnProgramBuilder.h"
...
GrGLSLUniformHandler::SamplerHandle GrDawnUniformHandler::addSampler(uint32_t visibility,
                                                                   GrSwizzle swizzle,
                                                                   GrTextureType type,
                                                                   GrSLPrecision precision,
                                                                   const char* name) {
...
const char* GrDawnUniformHandler::samplerVariable(GrGLSLUniformHandler::SamplerHandle handle) const {
