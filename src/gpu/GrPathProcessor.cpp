...
public:
    ...
    void emitTransforms(GrGLSLVaryingHandler* varyingHandler,
        ...
        for (int i = 0; *transformHandler; ++*transformHandler, ++i) {
                ...
                if (coordTransform.isNoOp()) {
                    ...
                    uni.fHandle = uniformHandler
                                          ->addUniform(kFragment_GrShaderFlag,
                                                       ...
                                                       &name)
                                          .toIndex();
                    tranformVar = uniformHandler->getUniformVariable(uni.fHandle);
                }
            } else {
            ...
            transformHandler->specifyCoordsForCurrCoordTransform(tranformVar, fragmentVar);
        }
    }
