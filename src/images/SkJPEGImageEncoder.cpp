...
void SkJpegEncoder::encodeRows(int numRows) {
    ((SkJpegEncoder_Base*) this)->onEncodeRows(numRows);
}

void SkJpegEncoder_Base::onEncodeRows(int numRows) {
