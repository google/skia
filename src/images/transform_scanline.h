...
static void transform_scanline_legacy_rgbA(char* SK_RESTRICT dst, const char* SK_RESTRICT src,
                                           int width, int) {
    transform_scanline_legacy_unpremultiply<true>(dst, src, width);
}
...
static void transform_scanline_legacy_bgrA(char* SK_RESTRICT dst, const char* SK_RESTRICT src,
                                           int width, int) {
    transform_scanline_legacy_unpremultiply<false>(dst, src, width);
}

template <bool kIsRGBA>
static inline void transform_scanline_unpremultiply(void* dst, const void* src, int width) {
    SkRasterPipeline p;
