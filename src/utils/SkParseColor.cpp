...
//    // strcmp semantics for six match values
//    auto compare = [&](const unsigned int* six_char_a, const unsigned int* six_char_b) -> int {
//        while (*six_char_a == *six_char_b) {
//            // bit one is cleared for the last word only
//            if ((*six_char_a & 1) == 0) {
//                // full match
//                return 0;
//            }
...
//        // clear the rec start tag for comparison
//        const auto a = static_cast<int>(*six_char_a & ~0x80000000),
//                   b = static_cast<int>(*six_char_b & ~0x80000000);

//        SkASSERT(a != b);
//        return a - b;

////        sixMatchPtr = sixMatches;
////        while (gColorNames[i] == *sixMatchPtr) {
////            ++i;
////            if ((*sixMatchPtr & 1) == 0) { // last word has bit 1 cleared
////                // full match
////                return 0;
////            }
////            ++sixMatchPtr;
...
////        int curMask = gColorNames[i] & ~0x80000000;

////        SkASSERT(sixMask != curMask);
////        return sixMask - curMask;
//    };
