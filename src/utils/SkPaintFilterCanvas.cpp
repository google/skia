...
void SkPaintFilterCanvas::onDrawEdgeAAQuad(const SkRect& rect, const SkPoint clip[], int clipCount,
    ...
    AutoPaintFilter apf(this, kRect_Type, paint);
    if (apf.shouldDraw()) {
        this->SkNWayCanvas::onDrawEdgeAAQuad(rect, clip, clipCount, aa,
                                             apf.paint()->getColor(), apf.paint()->getBlendMode());
    }
}
