...
void SkPaintFilterCanvas::onDrawImageSet(const SkCanvas::ImageSetEntry set[], int cnt, float alpha,
    ...
    if (apf.shouldDraw()) {
        this->SkNWayCanvas::onDrawImageSet(set, cnt, alpha, filterQuality, mode);
    }
}
