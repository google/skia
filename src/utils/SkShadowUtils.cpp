...
struct AmbientVerticesFactory {
    ...
    sk_sp<SkVertices> makeVertices(const SkPath& devPath) const {
        return SkShadowTessellator::MakeAmbient(devPath, fRadius, fUmbraColor, fPenumbraColor,
                                                fTransparent);
    }
};
...
struct SpotVerticesFactory {
    ...
    sk_sp<SkVertices> makeVertices(const SkPath& devPath) const {
        ...
        return SkShadowTessellator::MakeSpot(devPath, fScale, fOffset, fRadius, fUmbraColor,
...
private:
    ...
    public:
        ...
        sk_sp<SkVertices> add(const SkPath& devPath, const FACTORY& factory,
                              const SkMatrix& matrix) {
            sk_sp<SkVertices> vertices = factory.makeVertices(devPath);
            if (!vertices) {
                return nullptr;
            }
            int i;
