...
#endif
#include "shadows/SkAmbientShadowMaskFilter.h"
#include "shadows/SkSpotShadowMaskFilter.h"
...
void SkShadowUtils::DrawShadow(SkCanvas* canvas, const SkPath& path, SkScalar occluderHeight,
    ...
    SkRect rect;
    if (viewMatrix.getMinMaxScales(scaleFactors) && scaleFactors[0] == scaleFactors[1] &&
