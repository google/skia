 ...
 */
sk_sp<SkVertices> MakeAmbient(const SkPath& path, SkScalar radius, SkColor umbraColor,
 ...
 */
sk_sp<SkVertices> MakeSpot(const SkPath& path, SkScalar scale, const SkVector& translate,
