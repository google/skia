...
*/
SK_API int CountUTF8(const char* utf8, size_t byteLength);
...
/** Given a sequence of aligned UTF-16 characters in machine-endian form,
    ...
    UTF-16, return -1.
*/
SK_API int CountUTF16(const uint16_t* utf16, size_t byteLength);

/** Given a sequence of aligned UTF-32 characters in machine-endian form,
    return the number of unicode codepoints.  If the sequence is invalid
    UTF-32, return -1.
*/
SK_API int CountUTF32(const int32_t* utf32, size_t byteLength);
...
*/
SK_API SkUnichar NextUTF8(const char** ptr, const char* end);
...
*/
SK_API SkUnichar NextUTF16(const uint16_t** ptr, const uint16_t* end);
...
/** Given a sequence of aligned UTF-32 characters in machine-endian form,
    ...
    set *ptr to end and return -1.
*/
SK_API SkUnichar NextUTF32(const int32_t** ptr, const int32_t* end);
...
*/
SK_API size_t ToUTF8(SkUnichar uni, char utf8[kMaxBytesInUTF8Sequence] = nullptr);
...
*/
SK_API size_t ToUTF16(SkUnichar uni, uint16_t utf16[2] = nullptr);
