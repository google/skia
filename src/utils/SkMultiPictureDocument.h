...
#define SkMakeMultiPictureDocument SkMultiPictureDocument::Make
#define SkMultiPictureDocumentReadPageCount SkMultiPictureDocument::ReadPageCount
#define SkMultiPictureDocumentRead SkMultiPictureDocument::Read
