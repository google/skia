...
struct MultiPictureDocument final : public SkDocument {
    ...
    SkExtPictureUIDMap* fIds;
    MultiPictureDocument(SkWStream* s, void (*d)(SkWStream*, bool), SkExtPictureUIDMap* ids)
...
sk_sp<SkDocument> SkMakeMultiPictureContainerDocument(SkWStream* wStream, SkExtPictureUIDMap* ids) {
