...
// returns pointer to beginning of string in buffer
// See definitions of SkString::insertHex() and SkWStreamWriteHexAsText()
// for example of how to use this.
char*   SkStrFillU32Hex(char buffer[8], uint32_t value, int minDigits = 0);
