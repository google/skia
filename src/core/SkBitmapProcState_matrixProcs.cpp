...
SkBitmapProcState::MatrixProc SkBitmapProcState::chooseMatrixProc(bool translate_only_matrix) {
    ...
    SkASSERT(index < SK_ARRAY_COUNT(  ClampX_ClampY_Procs));
    SkASSERT(index < SK_ARRAY_COUNT(RepeatX_RepeatY_Procs));
    SkASSERT(index < SK_ARRAY_COUNT(MirrorX_MirrorY_Procs));
