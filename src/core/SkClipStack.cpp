...
void SkClipStack::Element::dump() const {
    ...
    static_assert(0 == static_cast<int>(DeviceSpaceType::kEmpty), "type_str");
    static_assert(1 == static_cast<int>(DeviceSpaceType::kRect), "type_str");
    static_assert(2 == static_cast<int>(DeviceSpaceType::kRRect), "type_str");
    static_assert(3 == static_cast<int>(DeviceSpaceType::kPath), "type_str");
