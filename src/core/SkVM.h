...
namespace skvm {
    ...
    #define SKVM_OPS(M)                                                              \
        ...
        M(load128_r) M(load128_g) M(load128_b) M(load128_a)                          \
    ...
    public:
        ...
        I32 load128_r(Arg ptr);  // Lowest 32 bits of 128-bit lane.
        I32 load128_g(Arg ptr);  // Bits 32-63,
        I32 load128_b(Arg ptr);  // Bits 64-95,
        I32 load128_a(Arg ptr);  // Highest 32 bits of 128-bit lane.
