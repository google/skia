...
namespace skvm {
    ...
    struct I32 {
        I32()                   : builder(nullptr), val( NA), imm(0) {}
      //I32(int x)              : builder(nullptr), val(IMM), imm(x) {}
        I32(Builder* b, Val id) : builder(b      ), val( id), imm(0) {}
    ...
    struct F32 {
        F32()                   : builder(nullptr), val( NA), imm(0) {}
      //F32(float x)            : builder(nullptr), val(IMM), imm(x) {}
        F32(Builder* b, Val id) : builder(b      ), val( id), imm(0) {}
