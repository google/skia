...
namespace skvm {
    ...
    public:
        ...
        Half uniformH (Ptr ptr, int offset) { return to_Half(uniformF(ptr, offset)); }
    ...
    static inline Half clamp01(Half x) { return x->clamp01(x); }
    static inline Half     abs(Half x) { return x->    abs(x); }
    static inline Half    ceil(Half x) { return x->   ceil(x); }
    static inline Half   fract(Half x) { return x->  fract(x); }
    static inline Half   floor(Half x) { return x->  floor(x); }
