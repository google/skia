...
namespace skvm {
    ...
    // ↑ always varying / uniforms, constants, Just Math ↓
        ...
        mad_f32,
         ...
         eq_f32,  eq_i32,  eq_i16,
        neq_f32, neq_i32, neq_i16,
         lt_f32,  lt_i32,  lt_i16,
        lte_f32, lte_i32, lte_i16,
         gt_f32,  gt_i32,  gt_i16,
        gte_f32, gte_i32, gte_i16,

        sel_f32, sel_i32, sel_i16,
    ...
    public:
        ...
        // Load {8,16,32}-bit varying.
        I32 load8 (Arg ptr);
        I32 load16(Arg ptr);
        I32 load32(Arg ptr);

        // Load {8,16,32}-bit uniform, starting from optional byte offset.
        I32 uniform8 (Arg ptr, int offset=0);
        I32 uniform16(Arg ptr, int offset=0);
        I32 uniform32(Arg ptr, int offset=0);

        // Gather {8,16,32}-bit with varying offset.
        ...
        I32 gt (F32 x, F32 y);
        I32 gte(F32 x, F32 y);
        F32 select(I32 mask, F32 t, F32 f);
        ...
        I32 gt (I32 x, I32 y);
        I32 gte(I32 x, I32 y);
        I32 select(I32 mask, I32 t, I32 f);
        ...
        I32 select_16x2(I32 mask, I32 t, I32 f);
