...
namespace skvm {
    ...
    static inline I32 operator+(I32 x, I32 y) { return x.builder->add(x,y); }
    static inline I32 operator+(I32 x, int y) { return x.builder->add(x,y); }
    static inline I32 operator+(int x, I32 y) { return y.builder->add(x,y); }

    static inline I32 operator-(I32 x, I32 y) { return x.builder->sub(x,y); }
    static inline I32 operator-(I32 x, int y) { return x.builder->sub(x,y); }
    static inline I32 operator-(int x, I32 y) { return y.builder->sub(x,y); }

    static inline I32 operator*(I32 x, I32 y) { return x.builder->mul(x,y); }
    static inline I32 operator*(I32 x, int y) { return x.builder->mul(x,y); }
    static inline I32 operator*(int x, I32 y) { return y.builder->mul(x,y); }

    static inline I32 min(I32 x, I32 y) { return x.builder->min(x,y); }
    static inline I32 min(I32 x, int y) { return x.builder->min(x,y); }
    static inline I32 min(int x, I32 y) { return y.builder->min(x,y); }

    static inline I32 max(I32 x, I32 y) { return x.builder->max(x,y); }
    static inline I32 max(I32 x, int y) { return x.builder->max(x,y); }
    static inline I32 max(int x, I32 y) { return y.builder->max(x,y); }

    static inline I32 operator==(I32 x, I32 y) { return x.builder->eq(x,y); }
    static inline I32 operator==(I32 x, int y) { return x.builder->eq(x,y); }
    static inline I32 operator==(int x, I32 y) { return y.builder->eq(x,y); }

    static inline I32 operator!=(I32 x, I32 y) { return x.builder->neq(x,y); }
    static inline I32 operator!=(I32 x, int y) { return x.builder->neq(x,y); }
    static inline I32 operator!=(int x, I32 y) { return y.builder->neq(x,y); }

    static inline I32 operator< (I32 x, I32 y) { return x.builder->lt(x,y); }
    static inline I32 operator< (I32 x, int y) { return x.builder->lt(x,y); }
    static inline I32 operator< (int x, I32 y) { return y.builder->lt(x,y); }

    static inline I32 operator<=(I32 x, I32 y) { return x.builder->lte(x,y); }
    static inline I32 operator<=(I32 x, int y) { return x.builder->lte(x,y); }
    static inline I32 operator<=(int x, I32 y) { return y.builder->lte(x,y); }

    static inline I32 operator> (I32 x, I32 y) { return x.builder->gt(x,y); }
    static inline I32 operator> (I32 x, int y) { return x.builder->gt(x,y); }
    static inline I32 operator> (int x, I32 y) { return y.builder->gt(x,y); }

    static inline I32 operator>=(I32 x, I32 y) { return x.builder->gte(x,y); }
    static inline I32 operator>=(I32 x, int y) { return x.builder->gte(x,y); }
    ...
    static inline F32 operator+(F32   x, float y) { return x.builder->add(x,y); }
    ...
    static inline F32 operator-(F32   x, float y) { return x.builder->sub(x,y); }
    ...
    static inline F32 operator*(F32   x, float y) { return x.builder->mul(x,y); }
    ...
    static inline F32 min(F32   x, F32   y) { return x.builder->min(x,y); }
    static inline F32 min(F32   x, float y) { return x.builder->min(x,y); }
    static inline F32 min(float x, F32   y) { return y.builder->min(x,y); }

    static inline F32 max(F32   x, F32   y) { return x.builder->max(x,y); }
    static inline F32 max(F32   x, float y) { return x.builder->max(x,y); }
    static inline F32 max(float x, F32   y) { return y.builder->max(x,y); }

    static inline I32 operator==(F32   x, F32   y) { return x.builder->eq(x,y); }
    static inline I32 operator==(F32   x, float y) { return x.builder->eq(x,y); }
    static inline I32 operator==(float x, F32   y) { return y.builder->eq(x,y); }

    static inline I32 operator!=(F32   x, F32   y) { return x.builder->neq(x,y); }
    static inline I32 operator!=(F32   x, float y) { return x.builder->neq(x,y); }
    static inline I32 operator!=(float x, F32   y) { return y.builder->neq(x,y); }

    static inline I32 operator< (F32   x, F32   y) { return x.builder->lt(x,y); }
    static inline I32 operator< (F32   x, float y) { return x.builder->lt(x,y); }
    static inline I32 operator< (float x, F32   y) { return y.builder->lt(x,y); }

    static inline I32 operator<=(F32   x, F32   y) { return x.builder->lte(x,y); }
    static inline I32 operator<=(F32   x, float y) { return x.builder->lte(x,y); }
    static inline I32 operator<=(float x, F32   y) { return y.builder->lte(x,y); }

    static inline I32 operator> (F32   x, F32   y) { return x.builder->gt(x,y); }
    static inline I32 operator> (F32   x, float y) { return x.builder->gt(x,y); }
    static inline I32 operator> (float x, F32   y) { return y.builder->gt(x,y); }

    static inline I32 operator>=(F32   x, F32   y) { return x.builder->gte(x,y); }
    static inline I32 operator>=(F32   x, float y) { return x.builder->gte(x,y); }
    static inline I32 operator>=(float x, F32   y) { return y.builder->gte(x,y); }


    static inline I32& operator+=(I32& x, int y) { return (x = x + y); }
    static inline I32& operator-=(I32& x, int y) { return (x = x - y); }
    static inline I32& operator*=(I32& x, int y) { return (x = x * y); }

    static inline F32& operator+=(F32& x, float y) { return (x = x + y); }
    static inline F32& operator-=(F32& x, float y) { return (x = x - y); }
    static inline F32& operator*=(F32& x, float y) { return (x = x * y); }
