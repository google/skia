...
namespace skvm {
    ...
    public:
        ...
        void add(Operand, int imm);
        void sub(Operand, int imm);
        void cmp(Operand, int imm);
    ...
    private:
        ...
        // Helper for GP64 instructions with an immediate.
        void op(int opcode, int opcode_ext, Operand, int imm);
