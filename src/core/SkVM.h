...
namespace skvm {
    ...
    public:
        ...
        // Gather {8,16,32}-bit with varying element-count offset.
        I32 gather8 (Arg ptr, I32 offset);
        I32 gather16(Arg ptr, I32 offset);
        I32 gather32(Arg ptr, I32 offset);

        // Load {8,16,32}-bit uniform with optional byte-count offset.
        // TODO: how best to handle 2-imm instructions like this?
        // For now, lame out with 16-bit for each.
