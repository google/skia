...
namespace skvm {
    ...
    public:
        ...
        //
        // So, e.g.,
        //    - bytes(x, 0x0000) splats the low byte of x to all four bytes
        //    - bytes(x, 0x3210) is x, an identity
        //    - bytes(x, 0xffff) is 0
        //    - bytes(x, 0xf3f3) transforms an RGBA pixel into an A0A0 bit pattern.
        //
