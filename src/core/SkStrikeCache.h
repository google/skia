...
public:
    ...
    static ExclusiveStrikePtr CreateStrikeExclusive(
            ...
            SkStrikeClient::DiscardableHandle discardableHandle =
                    SkStrikeClient::DiscardableHandle());
...
private:
    ...
    struct Node {
        Node(const SkDescriptor& desc, const SkStrikeClient::DiscardableHandle& handle)
        ...
        SkStrikeClient::DiscardableHandle fDiscardableHandle;
    };
