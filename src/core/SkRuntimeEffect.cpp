        ...
        switch (inst) {
            ...
            case Inst::kReturn: {
                ...
                if (count == 4) {
                    ...
                    skvm::F32 a = select(mask_stack.back(), pop(), result.a),
                              b = select(mask_stack.back(), pop(), result.b),
                              g = select(mask_stack.back(), pop(), result.g),
                              r = select(mask_stack.back(), pop(), result.r);
                    result = {r,g,b,a};
                }
            } break;
        }
