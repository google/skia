...
SkRuntimeEffect::EffectResult SkRuntimeEffect::Make(SkString sksl) {
    ...
    // Color filters are not allowed to depend on position (local or device) in any way. They can
    // sample children with matrices or explicit coords. Because the children will be color filters,
