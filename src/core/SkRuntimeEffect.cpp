...
size_t SkRuntimeEffect::Variable::sizeInBytes() const {
    size_t size = 0;
    switch (fType) {
        case Type::kBool:   size = 1;
        case Type::kInt:    size = sizeof(int32_t);
        case Type::kFloat:  size = sizeof(float);
        case Type::kFloat2: size = sizeof(float) * 2;
        case Type::kFloat3: size = sizeof(float) * 3;
        case Type::kFloat4: size = sizeof(float) * 4;

        case Type::kFloat2x2: size = sizeof(float) * 4;
        case Type::kFloat3x3: size = sizeof(float) * 9;
        case Type::kFloat4x4: size = sizeof(float) * 16;
