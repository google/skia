...
SkRuntimeEffect::Result SkRuntimeEffect::Make(SkString sksl,
    ...
    // this can be simpler. There is no way for color filters to refer to sk_FragCoord in that mode.
    if (SkSL::Analysis::ReferencesFragCoords(*program) || (flags & kUsesSampleCoords_Flag)) {
