...
public:
    ...
    static void AddGenIDChangeListener2(const SkPath& path,
                                       sk_sp<SkPathRef::GenIDChangeListener2> listener) {
        path.fPathRef->addGenIDChangeListener2(std::move(listener));
    }
