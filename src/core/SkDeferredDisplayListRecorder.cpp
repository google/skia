...
SkDeferredDisplayListRecorder::PromiseImageTexture::PromiseImageTexture(const GrBackendTexture& backendTexture)  {
...
SkDeferredDisplayListRecorder::PromiseImageTexture::PromiseImageTexture(PromiseImageTexture&& that) {
    *this = std::move(that);
}

SkDeferredDisplayListRecorder::PromiseImageTexture& SkDeferredDisplayListRecorder::PromiseImageTexture::operator=(PromiseImageTexture&& that) {
...
void SkDeferredDisplayListRecorder::PromiseImageTexture::addKeyToInvalidate(uint32_t contextID, const GrUniqueKey& key) {
...
#if GR_TEST_UTILS
SkTArray<GrUniqueKey> SkDeferredDisplayListRecorder::PromiseImageTexture::testingOnly_uniqueKeysToInvalidate() const {
...
static void wrap_legacy(SkDeferredDisplayListRecorder::LegacyPromiseImageTextureFulfillProc textureFulfillProc,
    ...
    *wrappedFulfillProc = [](SkDeferredDisplayListRecorder::PromiseImageTextureContext context) {
        ...
        wc->fPromiseImageTexture = std::make_unique<SkDeferredDisplayListRecorder::PromiseImageTexture>(backendTexture);
    ...
    *wrappedDoneProc = [](SkDeferredDisplayListRecorder::PromiseImageTextureContext context) {
    ...
    for (int i = 0; i < numTextures; ++i) {
        wrappedTextureContext[i] = new WrapperContext{textureFulfillProc, textureReleaseProc, textureDoneProc, textureContexts[i], nullptr};
    }
}
...
sk_sp<SkImage> SkDeferredDisplayListRecorder::makePromiseTexture(
    ...
    wrap_legacy(textureFulfillProc, textureReleaseProc, textureDoneProc, &textureContext, 1, &wrappedFulfillProc, &wrappedReleaseProc, &wrappedDoneProc, &wrappedTextureContext);
    return SkImage_Gpu::MakePromiseTexture(fContext.get(),
                                           backendFormat,
                                           width,
                                           height,
...
sk_sp<SkImage> SkDeferredDisplayListRecorder::makeYUVAPromiseTexture(
    ...
    wrap_legacy(textureFulfillProc, textureReleaseProc, textureDoneProc, textureContexts, numTextures, &wrappedFulfillProc, &wrappedReleaseProc, &wrappedDoneProc, wrappedTextureContexts);
