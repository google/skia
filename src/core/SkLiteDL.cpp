    ...
    struct DrawImageLattice final : Op {
        ...
        void draw(SkCanvas* c, const SkMatrix&) const {
            ...
            auto flags = (0 == fs) ? nullptr :
                         pod<SkCanvas::Lattice::RectangleType>(this, (xs+ys)*sizeof(int));
            auto colors = (0 == fs) ? nullptr :
                          pod<SkColor>(this, (xs+ys)*sizeof(SkColor));
...
void SkLiteDL::drawImageLattice(sk_sp<const SkImage> image, const SkCanvas::Lattice& lattice,
    ...
    size_t bytes = (xs + ys) * sizeof(int) + fs * sizeof(SkCanvas::Lattice::RectangleType)
                   + fs * sizeof(SkColor);
