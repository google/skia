...
public:
    ...
    public:
        ...
        void addResourceInvalidationMessage(GrProxyProvider* proxyProvider,
            ...
            fMessages.emplace_back(InvalMsg(proxyProvider, key));
        }
#endif
...
#if SK_SUPPORT_GPU
        struct InvalMsg {
            InvalMsg(GrProxyProvider* proxyProvider, const GrUniqueKey& key)
                    : fProxyProvider(proxyProvider), fKey(key) {}

            GrProxyProvider*  fProxyProvider;
            const GrUniqueKey fKey;
        };

        mutable SkTArray<InvalMsg> fMessages;
#endif
