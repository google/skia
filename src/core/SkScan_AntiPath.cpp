...
void SkScan::SAAFillPath(const SkPath& path, SkBlitter* blitter, bool isInverse, const SkIRect& ir,
...
void SkScan::AntiFillPath(const SkPath& path, const SkRegion& origClip,
    ...
    if (ShouldUseDAA(path)) {
        SkScan::DAAFillPath(path, blitter, isInverse, ir, clipRgn->getBounds(),
                            clipRect == nullptr, forceRLE);
        ...
        SkScan::AAAFillPath(path, blitter, isInverse, ir, clipRgn->getBounds(),
                            clipRect == nullptr, forceRLE);
    } else {
        SkScan::SAAFillPath(path, blitter, isInverse, ir, clipRgn->getBounds(),
                             clipRect == nullptr, forceRLE);
    }
