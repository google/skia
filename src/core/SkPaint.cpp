    ...
    SkAutoDescriptor* ad)
{
    ...
    ad->reset(CalculateSizeAndFlatten(rec, effects, &peBuffer, &mfBuffer));

    GenerateDescriptor(rec, effects, &peBuffer, &mfBuffer, ad->getDesc());
    ...
    const SkScalerContextEffects& effects)
{
    ...
    auto desc = SkDescriptor::Alloc(CalculateSizeAndFlatten(rec, effects, &peBuffer, &mfBuffer));

    GenerateDescriptor(rec, effects, &peBuffer, &mfBuffer, desc.get());
