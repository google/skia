...
int SkUTFN_CountUnichars(
    ...
    switch (encoding) {
        case SkTypeface::kUTF8_Encoding:
            return SkUTF::CountUTF8((const char*)utfN, byteLength);
        case SkTypeface::kUTF16_Encoding:
            return SkUTF::CountUTF16((const uint16_t*)utfN, byteLength);
        case SkTypeface::kUTF32_Encoding:
            return SkUTF::CountUTF32((const int32_t*)utfN, byteLength);
        default:
