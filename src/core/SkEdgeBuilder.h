...
class SkEdgeBuilder {
public:
    int buildEdges(const SkSPath&, const SkIRect* shiftedClip);
...
private:
    int build    (const SkSPath&, const SkIRect* clip, bool clipToTheRight);
    int buildPoly(const SkSPath&, const SkIRect* clip, bool clipToTheRight);
