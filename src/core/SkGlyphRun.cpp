...
// -- SkGlyphDraw ----------------------------------------------------------------------------------
SkGlyphDraw::SkGlyphDraw(SkScalerContextFlags flags)
...
bool SkGlyphDraw::ensureBitmapBuffers(size_t runSize) {
...
void SkGlyphDraw::drawGlyphRunAsSubpixelMask(
...
void SkGlyphDraw::drawGlyphRunAsFullpixelMask(
        SkGlyphCache* cache, SkGlyphRun* glyphRun,
        SkPoint origin, const SkMatrix& deviceMatrix,
        PerMask perMask) {
    auto runSize = glyphRun->runSize();
...
void SkGlyphDraw::drawForBitmap(
        SkGlyphRunList* glyphRunList, const SkMatrix& deviceMatrix, const SkSurfaceProps& props,
