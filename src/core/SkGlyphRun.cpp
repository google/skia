...
void SkGlyphRunBuilder::prepareDrawText(
    ...
    this->initialize();
    this->drawText(paint, bytes, byteLength, origin);
}
...
void SkGlyphRunBuilder::prepareDrawPosTextH(const SkPaint& paint, const void* bytes,
                                            ...
                                            SkScalar constY) {
    this->initialize();
    this->drawPosTextH(paint, bytes, byteLength, xpos, constY);
}
    ...
    for (;!it.done(); it.next()) {
        ...
        switch (it.positioning()) {
            case SkTextBlob::kDefault_Positioning: {
                ...
                this->drawText(runPaint, it.glyphs(), glyphLen, dtOrigin);
            }
            break;
            case SkTextBlob::kHorizontal_Positioning: {
                auto constY = origin.y() + offset.y();
                this->drawPosTextH(runPaint, it.glyphs(), glyphLen, it.pos(), constY);
            }
            break;
