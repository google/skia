...
SkFont SkFont::makeWithSize(SkScalar newSize) const {
    return SkFont(this->refTypeface(), newSize, this->getScaleX(), this->getSkewX(),
                  this->getFlags());
}

SkFont SkFont::makeWithFlags(uint32_t newFlags) const {
    return SkFont(this->refTypeface(), this->getSize(), this->getScaleX(), this->getSkewX(),
                  newFlags);
}
///////////////////////////////////////////////////////////////////////////////////////////////////
