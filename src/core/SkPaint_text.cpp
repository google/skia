...
int GetTextIntercepts(const SkFont& font, const SkPaint& paint, const SkGlyphID glyphs[],
                      size_t glyphCount, const SkScalar bounds[2], SkScalar* array, Func posMaker) {
...
SkTextBaseIter::SkTextBaseIter(const SkGlyphID glyphs[], size_t count, const SkFont& font,
                               const SkPaint& paint)
