...
// we do that, be caureful that blitRect may throw exception is the rect is empty.
void SkScan::DAAFillPath(const SkPath& path, SkBlitter* blitter, bool isInverse, const SkIRect& ir,
