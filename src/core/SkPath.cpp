...
SkPath SkPathPriv::CreateDrawArcPath(const SkRect& oval, SkScalar startAngle,
    ...
    SetConvexity(&builder, convex ? SkPathConvexity::kConvex : SkPathConvexity::kConcave);
//    builder.setFirstDirection(firstDir);
