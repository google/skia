...
void SkPath::setPt(int index, SkScalar x, SkScalar y) {
    ...
    if (count <= index) {
        ...
        ed.updateFracPoint(count - 1, *ed.atPoint(count - 1), {x, y});
...
void SkPath::moveTo(SkScalar x, SkScalar y) {
    ...
    ed.addFracPoint(fLastMoveToIndex, {x, y});
...
void SkPath::lineTo(SkScalar x, SkScalar y) {
    ...
    ed.addFracPoint(this->countPoints() - 1, {x, y});
...
void SkPath::quadTo(SkScalar x1, SkScalar y1, SkScalar x2, SkScalar y2) {
    ...
    ed.addFracPoint(this->countPoints() - 2, pts[0]);
    ed.addFracPoint(this->countPoints() - 1, pts[1]);
...
void SkPath::cubicTo(SkScalar x1, SkScalar y1, SkScalar x2, SkScalar y2,
    ...
    ed.addFracPoint(this->countPoints() - 3, pts[0]);
    ed.addFracPoint(this->countPoints() - 2, pts[1]);
    ed.addFracPoint(this->countPoints() - 1, pts[2]);
...
void SkPath::addPoly(const SkPoint pts[], int count, bool close) {
    ...
    for(int i = 0; i < count; ++i) {
        ed.addFracPoint(this->countPoints() - count + i, pts[i]);
    }
