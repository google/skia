...
void SkPath::arcTo(SkScalar rx, SkScalar ry, SkScalar angle, SkPath::ArcSize arcLarge,
    ...
    SkASSERT(!SkScalarIsFinite(thetaWidth_degrees) || -90 == thetaWidth_degrees ||
            0 == thetaWidth_degrees || 90 == thetaWidth_degrees);
    SkScalar t = SkScalarIsFinite(thetaWidth_degrees) ? thetaWidth_degrees / 90 :
    ...
    bool expectIntegers = SkScalarIsFinite(thetaWidth_degrees) &&
