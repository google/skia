...
#elif defined(SK_BUILD_FOR_FUCHSIA)
...
#else // !SK_BUILD_FOR_ANDROID_FRAMEWORK && !SK_DISABLE_TRACING && !SK_BUILD_FOR_FUCHSIA
...
#define TRACE_EVENT_SCOPE_GLOBAL (TRACE_SCOPE_GLOBAL)
