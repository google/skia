...
const float BT2020_full_rgb_to_yuv[] = {
...
const float BT2020_full_yuv_to_rgb[] = {
...
const float BT2020_10bit_limited_rgb_to_yuv[] = {
     ...
     -0.122296f, -0.315632f,  0.437928f,  0.000000f,  0.501961f,
      0.437928f, -0.402706f, -0.035222f,  0.000000f,  0.501961f,
      0.000000f,  0.000000f,  0.000000f,  1.000000f,  0.000000f,
};
const float BT2020_10bit_limited_yuv_to_rgb[] = {
      1.167808f, -0.000000f,  1.683611f,  0.000000f, -0.918166f,
      1.167808f, -0.187877f, -0.652337f,  0.000000f,  0.348695f,
      1.167808f,  2.148072f, -0.000000f,  0.000000f, -1.151307f,
      0.000000f,  0.000000f,  0.000000f,  1.000000f,  0.000000f,
};
const float BT2020_12bit_limited_rgb_to_yuv[] = {
      0.224787f,  0.580149f,  0.050742f,  0.000000f,  0.062515f,
     -0.122206f, -0.315401f,  0.437607f,  0.000000f,  0.501961f,
      0.437607f, -0.402411f, -0.035196f,  0.000000f,  0.501961f,
      0.000000f,  0.000000f,  0.000000f,  1.000000f,  0.000000f,
};
const float BT2020_12bit_limited_yuv_to_rgb[] = {
      1.168664f, -0.000000f,  1.684846f,  0.000000f, -0.918786f,
      1.168664f, -0.188015f, -0.652816f,  0.000000f,  0.349005f,
      1.168664f,  2.149647f, -0.000000f,  0.000000f, -1.152098f,
      0.000000f,  0.000000f,  0.000000f,  1.000000f,  0.000000f,
};
...
static_assert(kBT2020_Full_SkYUVColorSpace          == 4, "");
static_assert(kBT2020_8bit_Limited_SkYUVColorSpace  == 5, "");
static_assert(kBT2020_10bit_Limited_SkYUVColorSpace == 6, "");
static_assert(kBT2020_12bit_Limited_SkYUVColorSpace == 7, "");
...
const YUVCoeff gCoeff[] = {
    ...
    { 0.2126f, 0.0722f, 1, 0, 1, },

    // kRec709_Limited_SkYUVColorSpace
    { 0.2126f, 0.0722f, 219/255.f, 16/255.f, 224/255.f, },

    // kBT2020_Full_SkYUVColorSpace
    { 0.2627f, 0.0593f, 1, 0, 1 },

    // kBT2020_8bit_Limited_SkYUVColorSpace
    { 0.2627f, 0.0593f, 219/255.f, 16/255.f, 224/255.f, },

    // kBT2020_10bit_Limited_SkYUVColorSpace
    { 0.2627f, 0.0593f, 876/1023.f, 64/1023.f, 896/1023.f, },

    // kBT2020_12bit_Limited_SkYUVColorSpace
    { 0.2627f, 0.0593f, 3504/4095.f, 256/4095.f, 3584/4095.f, },
};
...
static void dump(const float m[20], SkYUVColorSpace cs, bool rgb2yuv) {
    const char* names[] = {
        "JPEG_full", "Rec601_limited", "Rec709_full", "Rec709_limited",
        "BT2020_full", "BT2020_8bit_limited", "BT2020_10bit_limited", "BT2020_12bit_limited",
    };
    const char* dirnames[] = {
