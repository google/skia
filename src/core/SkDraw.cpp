...
SkGlyphDraw::PerMask SkDraw::drawOneMaskCreator(
...
void SkDraw::drawGlyphRunList(
        SkGlyphRunList* glyphRunList, SkGlyphDraw* glyphDraw, const SkSurfaceProps& props) const {
    ...
    glyphDraw->drawForBitmap(glyphRunList, *fMatrix, props, perMaskBuilder, perPathBuilder);
}
