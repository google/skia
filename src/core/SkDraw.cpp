...
void SkDraw::drawDevPath(const SkPath& devPath, const SkPaint& paint, bool drawCoverage,
    ...
    if (iData == nullptr) {
        ...
        // TODO remove true in the if above so we can proceed to DAA.
        ...
        iData->fElement->fDrawFn = [proc, devPath, blitter](
                SkArenaAlloc* alloc, const SkThreadedBMPDevice::DrawState& ds, const SkIRect& tileBounds) {
