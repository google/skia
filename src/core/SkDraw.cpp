        ...
        if (SkMask::kARGB32_Format == mask.fFormat && !paint) {
          ...
          switch (mask.fFormat) {
            case SkMask::kARGB32_Format:
              // Initialized for this mask type.
              break;
            case SkMask::kA8_Format:
              colorType = kAlpha_8_SkColorType;
              break;
            case SkMask::kBW_Format:
              // See below, this format we can blit using the drawDevMask function.
              break;
          ...
          SkBitmap bm;
          SkImageInfo imageInfo = SkImageInfo::Make(mask.fBounds.width(), mask.fBounds.height(),
                                                    colorType, alphaType);
          bm.installPixels(imageInfo, (SkPMColor*)mask.fImage, mask.fRowBytes);
