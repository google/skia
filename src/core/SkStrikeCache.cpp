...
bool operator == (const SkStrikeCache::ExclusiveStrikePtr& lhs, nullptr_t) {
    return lhs.fNode == nullptr;
}
bool operator == (nullptr_t, const SkStrikeCache::ExclusiveStrikePtr& rhs) {
