...
sk_sp<SkSpecialImage> SkLocalMatrixImageFilter::onFilterImage(const SkFilterContext& ctx,
                                                              SkIPoint* offset) const {
    SkFilterContext localCtx = ctx.withLayerCTM(SkMatrix::Concat(ctx.layerCTM(), fLocalM));
