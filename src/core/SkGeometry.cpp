...
static SkCubicType classify_cubic(const double d[4], double t[2], double s[2]) {
    ...
    // This also attempts detect near-quadratics in a resolution independent fashion, however it is
    // still on the caller to check for almost-linear curves if needed.
