...
int SkYUVAInfo::ExpectedPlaneDims(Planes planes,
    ...
    planeDims[0] = {w, h};
    switch (planes) {
        case SkYUVAInfo::Planes::kY_U_V_444:
            planeDims[0] = planeDims[1] = planeDims[2] = {w, h};
            return 3;
        case SkYUVAInfo::Planes::kY_U_V_422:
            planeDims[0] = {w, h};
            planeDims[1] = planeDims[2] = {down2(w), h};
            return 3;
        case SkYUVAInfo::Planes::kY_U_V_420:
            planeDims[0] = {w, h};
            planeDims[1] = planeDims[2] = {down2(w), down2(h)};
            return 3;
        case SkYUVAInfo::Planes::kY_U_V_440:
            planeDims[0] = {w, h};
            planeDims[1] = planeDims[2] = {w, down2(h)};
            return 3;
        case SkYUVAInfo::Planes::kY_U_V_411:
            planeDims[1] = {w, h};
            planeDims[1] = planeDims[2] = {down4(w), h};
            return 3;
        case SkYUVAInfo::Planes::kY_U_V_410:
            planeDims[0] = {w, h};
...
int SkYUVAInfo::NumPlanes(Planes planes) {
    switch (planes) {
        case SkYUVAInfo::Planes::kY_U_V_444: return 3;
        case SkYUVAInfo::Planes::kY_U_V_422: return 3;
        case SkYUVAInfo::Planes::kY_U_V_420: return 3;
        case SkYUVAInfo::Planes::kY_U_V_440: return 3;
        case SkYUVAInfo::Planes::kY_U_V_411: return 3;
        case SkYUVAInfo::Planes::kY_U_V_410: return 3;
    }
    SkUNREACHABLE;
}
