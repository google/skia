...
private:
     ...
     *  and accounting for what they require to meet this filters input requirements. It is up to
     ...
     *  required inputs, evaluated on what this filter requires for itself. 'recurse' is false
     ...
     *  'targetOutputBounds', and passes this down to its child filters, and returns the union of
