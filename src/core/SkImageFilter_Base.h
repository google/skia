...
public:
     ...
     *  some of them can handle affine (or more complex) matrices. And some can't handle any CTM.
...
private:
     ...
     *  space to a layer space). If this returns anything less than kCompex, the filter only needs
