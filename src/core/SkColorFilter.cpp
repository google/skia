...
struct SkColorXformColorFilter : public SkColorFilterBase {
    ...
    SkColorInfo dstInfo(const sk_sp<SkColorSpace>& dstCS) const {
        return {kUnknown_SkColorType, kPremul_SkAlphaType, dstCS};
    }

    SkColorInfo xformInfo(const sk_sp<SkColorSpace>& dstCS) const {
