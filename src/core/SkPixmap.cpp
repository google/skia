...
bool SkPixmap::scalePixels(const SkPixmap& actualDst, SkFilterQuality quality) const {
    ...
    // If src and dst are both unpremul, we'll fake them out to be appear as if premul.
    bool needUnpremulBicubicClamp = false;
