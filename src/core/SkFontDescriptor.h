...
public:
    ...
    const SkFontArguments::VariationPosition::Coordinate* getVariation() const { return fVariation.get(); }
    ...
    void setVariationCoordinates(Coordinates c, size_t coordinateCount) {
        fVariation = std::move(c);
...
private:
    ...
    bool fVariationIsOrderedNotNamed = false;
