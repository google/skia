...
void NAME_WRAP(S32_D32_nofilter_DXDY)(const SkBitmapProcState&, const uint32_t*, int, SkPMColor*);
void NAME_WRAP(S32_D32_nofilter_DX)  (const SkBitmapProcState&, const uint32_t*, int, SkPMColor*);
void NAME_WRAP(S32_D32_filter_DX)    (const SkBitmapProcState&, const uint32_t*, int, SkPMColor*);
void NAME_WRAP(S32_D32_filter_DXDY)  (const SkBitmapProcState&, const uint32_t*, int, SkPMColor*);

void NAME_WRAP(S32_D32_nofilter_DXDY)(const SkBitmapProcState& s,
...
void NAME_WRAP(S32_D32_nofilter_DX)(const SkBitmapProcState& s,
                                    const uint32_t* xy, int count, SkPMColor* colors) {
    SkASSERT(count > 0 && colors != nullptr);
...
void NAME_WRAP(S32_D32_filter_DX)(const SkBitmapProcState& s,
                                  const uint32_t* xy, int count, SkPMColor* colors) {
    SkASSERT(count > 0 && colors != nullptr);
...
void NAME_WRAP(S32_D32_filter_DXDY)(const SkBitmapProcState& s,
                                    const uint32_t* xy, int count, SkPMColor* colors) {
    SkASSERT(count > 0 && colors != nullptr);
    SkASSERT(s.fFilterQuality != kNone_SkFilterQuality);
    SkASSERT(4 == s.fPixmap.info().bytesPerPixel());
