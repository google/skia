...
sk_sp<GrRenderTargetContext> GaussianBlur(GrContext* context,
    ...
    if (sigmaX > 0.0f && sigmaY > 0.0f &&
        ...
        dstRenderTargetContext = context->makeDeferredRenderTargetContext(
            fit, width, height, config, colorSpace, "GaussianBlur 2d", 0, kBottomLeft_GrSurfaceOrigin);
    ...
    for (int i = 1; i < scaleFactorX || i < scaleFactorY; i *= 2) {
        ...
        dstRenderTargetContext = context->makeDeferredRenderTargetContext(
            fit, dstRect.fRight, dstRect.fBottom, config, colorSpace, "GaussianBlur decimate", 0, kBottomLeft_GrSurfaceOrigin);
        if (!dstRenderTargetContext) {
            return nullptr;
        }
    ...
    if (sigmaX > 0.0f) {
        ...
        dstRenderTargetContext = context->makeDeferredRenderTargetContext(
            fit, width, height, config, colorSpace, "GaussianBlur x-pass", 0, kBottomLeft_GrSurfaceOrigin);
        if (!dstRenderTargetContext) {
            return nullptr;
        }
    ...
    if (sigmaY > 0.0f) {
        ...
        dstRenderTargetContext = context->makeDeferredRenderTargetContext(
            fit, width, height, config, colorSpace, "GaussianBlur y-pass", 0, kBottomLeft_GrSurfaceOrigin);
        if (!dstRenderTargetContext) {
            return nullptr;
        }
    ...
    if (scaleFactorX > 1 || scaleFactorY > 1) {
        ...
        dstRenderTargetContext = context->makeDeferredRenderTargetContext(
            fit, width, height, config, colorSpace, "GaussianBlur re-inflate", 0, kBottomLeft_GrSurfaceOrigin);
        if (!dstRenderTargetContext) {
            return nullptr;
        }
