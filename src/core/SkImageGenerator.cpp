...
bool SkImageGenerator::queryYUVAInfo(SkYUVAInfo* yuvaInfo,
    ...
    return this->onQueryYUVAInfo(yuvaInfo, colorTypes, rowBytes);
}

bool SkImageGenerator::getYUVAPlanes(const SkPixmap planes[SkYUVAInfo::kMaxPlanes]) {
    SkASSERT(planes);
