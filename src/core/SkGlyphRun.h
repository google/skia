...
private:
    void initialize(size_t runListSize, size_t totalGlyphs, uint16_t glyphUniverseSize);
    ...
    size_t fMaxRunListSize{0};
    size_t fGlyphRunListSize{0};
