...
static inline bool can_memcpy(const SkImageInfo& dstInfo, const SkImageInfo& srcInfo) {
    ...
    return SkColorSpace::Equals(dstInfo.colorSpace(), srcInfo.colorSpace());
}

static inline void do_memcpy(const SkImageInfo& dstInfo, void* dstPixels, size_t dstRB,
                             const SkImageInfo& srcInfo, const void* srcPixels, size_t srcRB) {
    size_t bytes = dstInfo.width() * dstInfo.bytesPerPixel();
...
bool SkPixelInfo::CopyPixels(const SkImageInfo& dstInfo, void* dstPixels, size_t dstRB,
    ...
    if (can_memcpy(dstInfo, srcInfo)) {
        do_memcpy(dstInfo, dstPixels, dstRB, srcInfo, srcPixels, srcRB);
        return true;
    }
