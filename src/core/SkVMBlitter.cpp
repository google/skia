...
namespace {
    ...
    struct Builder : public skvm::Builder {
        ...
        skvm::I32 scale(skvm::I32 x, skvm::I32 y) {
        ...
        skvm::I32 pack_565(Color c) {
        #if 0   // need to work out /74 and /85
            ...
            skvm::I32 r = (c.r *  9 + 36) / 74,   //  9/74 ≈ 31/255, plus 36/74, about half.
                      g = (c.g * 21 + 42) / 85,   // 21/85 = 63/255 exactly.
                      b = (c.b *  9 + 36) / 74;
        #else
            skvm::I32 r = shr(c.r, 3),
                      g = shr(c.g, 2),
                      b = shr(c.b, 3);
        #endif
        ...
        Builder(const SkPixmap& device, const SkPaint& paint, Coverage coverage) {
            ...
            // and whenc overage is Mask3D there will be three more mask varyings.
