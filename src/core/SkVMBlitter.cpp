...
skvm::Color skvm::BlendModeProgram(skvm::Builder* p,
    ...
    skvm::F32 invSA = p->sub(p->splat(1.0f), src.a),
              invDA = p->sub(p->splat(1.0f), dst.a);
    ...
    switch (mode) {
        ...
        case SkBlendMode::kSrcOver: return {
            p->mad(dst.r, invSA, src.r),
            p->mad(dst.g, invSA, src.g),
            p->mad(dst.b, invSA, src.b),
            p->mad(dst.a, invSA, src.a),
        };
        ...
        case SkBlendMode::kSrcATop: return {
            mma(src.r, dst.a,  dst.r, invSA),
            mma(src.g, dst.a,  dst.g, invSA),
            mma(src.b, dst.a,  dst.b, invSA),
            mma(src.a, dst.a,  dst.a, invSA),
        };

        case SkBlendMode::kXor: return {
            mma(src.r, invDA,  dst.r, invSA),
            mma(src.g, invDA,  dst.g, invSA),
            mma(src.b, invDA,  dst.b, invSA),
            mma(src.a, invDA,  dst.a, invSA),
        };
