    ...
    struct Builder : public skvm::Builder {
        ...
        Builder(const Params& params, skvm::Uniforms* uniforms, SkArenaAlloc* alloc) {
            ...
            if (src_in_gamut) {
                ...
                assert_true(eq(src.r, clamp(src.r, splat(0.0f), bit_cast(splat(0x3f80'0001)))), src.r);
                assert_true(eq(src.g, clamp(src.g, splat(0.0f), bit_cast(splat(0x3f80'0001)))), src.g);
                assert_true(eq(src.b, clamp(src.b, splat(0.0f), bit_cast(splat(0x3f80'0001)))), src.b);
                assert_true(eq(src.a, clamp(src.a, splat(0.0f), bit_cast(splat(0x3f80'0001)))), src.a);
