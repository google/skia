...
bool SkImageFilter_Base::applyCropRect(const SkFilterContext& ctx, const SkIRect& srcBounds,
...
// around it.
static sk_sp<SkSpecialImage> pad_image(SkSpecialImage* src, const SkFilterContext& ctx,
...
sk_sp<SkSpecialImage> SkImageFilter_Base::applyCropRectAndPad(const SkFilterContext& ctx,
                                                              SkSpecialImage* src,
                                                              SkIPoint* srcOffset,
