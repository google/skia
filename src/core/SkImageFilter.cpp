...
sk_sp<SkSpecialImage> SkImageFilter_Base::filterImage(const skif::Context& context,
...
sk_sp<SkSpecialImage> SkImageFilter_Base::filterInput(int index, const Context& ctx,
                                                      SkIPoint* offset) const {
