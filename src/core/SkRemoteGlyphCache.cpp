...
public:
    ...
    void prepareForDrawingRemoveEmpty(int maxDimension, SkDrawableGlyphBuffer* drawables) override;
...
void SkStrikeServer::RemoteStrike::prepareForDrawingRemoveEmpty(
