...
SkRendererStrikeCacheGenerator::SkRendererStrikeCacheGenerator(DiscardableHandleManager* discardableHandleManager)
...
SkRendererStrikeCacheGenerator::SkGlyphCacheState::SkGlyphCacheState(std::unique_ptr<SkDescriptor> desc,
...
SkGPUStikeCachePopulator::SkGPUStikeCachePopulator(sk_sp<DiscardableHandleManager> discardableManager)
