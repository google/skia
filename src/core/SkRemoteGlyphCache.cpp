...
// Be sure to read and understand the comment for prepareForDrawingRemoveEmpty in SkStrikeInterface.h before
...
SkStrikeServer::SkGlyphCacheState::prepareForDrawingRemoveEmpty(
    ...
    for (size_t i = 0; i < n; i++) {
        ...
        // Each non-empty glyph needs to be added as per the contract for prepareForDrawingRemoveEmpty.
