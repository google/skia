...
*/
float SkMeasureAngleInsideVectors(const SkVector&, const SkVector&);

/** Returns an arbitrarily scaled vector that bisects a and b. The returned bisector will always
    point toward the interior of a and b.
*/
