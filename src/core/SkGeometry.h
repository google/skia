...
/** Given a src quadratic bezier, finds the T value whose tangent whose angle is halfway between the
...
/** Given a src cubic bezier, finds the T value whose tangent whose angle is halfway between the
    tangents at p0 and p3.
*/
