...
static inline bool is_close_to_d50(const SkMatrix44& matrix) {
    // rX + gX + bX
    float X = matrix.getFloat(0, 0) + matrix.getFloat(1, 0) + matrix.getFloat(2, 0);

    // rY + gY + bY
    float Y = matrix.getFloat(0, 1) + matrix.getFloat(1, 1) + matrix.getFloat(2, 1);

    // rZ + gZ + bZ
    float Z = matrix.getFloat(0, 2) + matrix.getFloat(1, 2) + matrix.getFloat(2, 2);
