...
SkTypeface::LocalizedStrings* SkTypeface::createVariationDesignInstanceIterator(int axis) const {
    return this->onCreateVariationDesignInstanceIterator(axis);
}
...
SkTypeface::LocalizedStrings* SkTypeface::onCreateVariationDesignInstanceIterator(int axis) const {
    return nullptr;
}
///////////////////////////////////////////////////////////////////////////////
