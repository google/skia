...
// This is like SkFloatToFixed, but rounds to nearest, preserving as much precision as possible
// when going float -> fixed -> float. The use of double is necessary to avoid rounding problems
// with float. Also, see the comment in SkFixed.h.
