...
private:
    ...
    public:
        ...
        StrikeDifferences(StrikeDifferences&&) = default;
        StrikeDifferences& operator= (StrikeDifferences&&) = default;
        StrikeDifferences(const StrikeDifferences&) = delete;
        StrikeDifferences& operator= (const StrikeDifferences&) = delete;
