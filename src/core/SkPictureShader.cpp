...
#if SK_SUPPORT_GPU
sk_sp<GrFragmentProcessor> SkPictureShader::asFragmentProcessor(const AsFPArgs& args,
    ...
    return bitmapShader->asFragmentProcessor(
            SkShader::AsFPArgs(args.fContext, args.fViewMatrix, nullptr, args.fFilterQuality,
                               args.fDstColorSpace),
            out);
}
#endif
