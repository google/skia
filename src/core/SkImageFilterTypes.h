...
private:
    ...
    // layer matrix to define the layer-space coordinate system. Depending on how it's decomposed,
    // either the layer matrix or the device matrix could be the identity matrix (but sometimes
    // neither).
