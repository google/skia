...
// SkGlyphRunPainterInterface are all the ways that the GPU generates glyphs. The first
...
//   deviceView matrix to transform the cache data onto the screen.
//
// In addition to transformation type above, Masks, Paths, SDFT, and Fallback are the different
