...
void SkColorSpaceXform_A2B::addTransferFn(const SkColorSpaceTransferFn& fn, int channelIndex) {
    ...
    switch (channelIndex) {
        case 0:
            fElementsPipeline.append(SkRasterPipeline::parametric_r, f);
            break;
        case 1:
            fElementsPipeline.append(SkRasterPipeline::parametric_g, f);
            break;
        case 2:
            fElementsPipeline.append(SkRasterPipeline::parametric_b, f);
            break;
        case 3:
            fElementsPipeline.append(SkRasterPipeline::parametric_a, f);
            break;
        default:
            SkASSERT(false);
    }
...
void SkColorSpaceXform_A2B::addTableFn(const SkTableTransferFn& fn, int channelIndex) {
    ...
    switch (channelIndex) {
        case 0:
            fElementsPipeline.append(SkRasterPipeline::table_r, f);
            break;
        case 1:
            fElementsPipeline.append(SkRasterPipeline::table_g, f);
            break;
        case 2:
            fElementsPipeline.append(SkRasterPipeline::table_b, f);
            break;
        case 3:
            fElementsPipeline.append(SkRasterPipeline::table_a, f);
            break;
        default:
            SkASSERT(false);
    }
