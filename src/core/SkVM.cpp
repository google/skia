...
namespace skvm {
    ...
    // Pack mandatory SSE opcode prefix byte to 2-bit encoding for VEX.
    ...
    // Pack leading SSE opcode map prefix to 5-bit encoding for VEX.
    static int map_select(int prefix) {
        switch (prefix) {
    ...
    static VEX vex(bool WE,   // Like REX W for int operations, or opcode extension for float?
                   ...
                   int map,   // 5-bit opcode map selector, from map_select().
