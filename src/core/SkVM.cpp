...
namespace skvm {
    ...
    bool Program::jit(const std::vector<OptimizedInstruction>& instructions, Assembler* a) const {
        ...
        auto emit = [&](Val id, bool scalar) {
            ...
            // Allocate a register until you call free_reg().
            auto alloc_reg = [&]() -> Reg {
            ...
            auto make_available = [&](int r) {
                ...
                // Spill any values we'll need again to the stack.
            ...
            // TODO: hitting asserts when I try to be more careful than "free everything".
            if (true) {
                for (Val v : reg_to_val) {
                    if (v != NA) {
