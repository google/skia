...
namespace skvm {
    ...
    void Assembler::vfmadd132ps(Ymm dst, Ymm x, YmmOperand y) { this->op(0x66,0x380f,0x98, dst,x,y); }
    void Assembler::vfmadd213ps(Ymm dst, Ymm x, YmmOperand y) { this->op(0x66,0x380f,0xa8, dst,x,y); }
    void Assembler::vfmadd231ps(Ymm dst, Ymm x, YmmOperand y) { this->op(0x66,0x380f,0xb8, dst,x,y); }

    void Assembler::vfmsub132ps(Ymm dst, Ymm x, YmmOperand y) { this->op(0x66,0x380f,0x9a, dst,x,y); }
    void Assembler::vfmsub213ps(Ymm dst, Ymm x, YmmOperand y) { this->op(0x66,0x380f,0xaa, dst,x,y); }
    void Assembler::vfmsub231ps(Ymm dst, Ymm x, YmmOperand y) { this->op(0x66,0x380f,0xba, dst,x,y); }

    void Assembler::vfnmadd132ps(Ymm dst, Ymm x, YmmOperand y) { this->op(0x66,0x380f,0x9c, dst,x,y); }
    void Assembler::vfnmadd213ps(Ymm dst, Ymm x, YmmOperand y) { this->op(0x66,0x380f,0xac, dst,x,y); }
    void Assembler::vfnmadd231ps(Ymm dst, Ymm x, YmmOperand y) { this->op(0x66,0x380f,0xbc, dst,x,y); }
    ...
    void Assembler::op(int prefix, int map, int opcode, Ymm dst, Ymm x, Mem m, bool W) {
        VEX v = vex(W, dst>>3, 0, m.base>>3,
                    map, x, /*ymm?*/1, prefix);
        this->bytes(v.bytes, v.len);
        this->byte (opcode);
        this->byte (mod_rm(mod(m.disp), dst&7, m.base&7));
