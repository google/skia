    ...
    bool Program::jit(const std::vector<OptimizedInstruction>& instructions, Assembler* a) const {
        ...
        auto emit = [&](Val id, bool scalar) {
            ...
            switch (op) {
                ...
                case Op::add_i32: a->vpaddd (dst(), r(x), any(y)); break;   // TODO
                case Op::sub_i32: a->vpsubd (dst(), r(x), any(y)); break;
                case Op::mul_i32: a->vpmulld(dst(), r(x), any(y)); break;   // TODO

                case Op::bit_and  : a->vpand (dst(), r(x), any(y)); break;   // TODO
                case Op::bit_or   : a->vpor  (dst(), r(x), any(y)); break;   // TODO
                case Op::bit_xor  : a->vpxor (dst(), r(x), any(y)); break;   // TODO
                ...
                case Op::eq_i32: a->vpcmpeqd(dst(), r(x), any(y)); break;   // TODO
                case Op::gt_i32: a->vpcmpgtd(dst(), r(x), any(y)); break;

                case Op:: eq_f32: a->vcmpeqps (dst(), r(x), any(y)); break;   // TODO
                case Op::neq_f32: a->vcmpneqps(dst(), r(x), any(y)); break;   // TODO
