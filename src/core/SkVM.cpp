...
namespace skvm {
    ...
    static void write(SkWStream* o, Val v) {
        write(o, "v");
    ...
    template <typename T>
    static void writeln(SkWStream* o, T v) {
        write(o, v);
        write(o, "\n");
    }

    template <typename T, typename... Ts>
    static void writeln(SkWStream* o, T first, Ts... rest) {
        write(o, first);
        write(o, " ");
        writeln(o, rest...);
    }
    ...
    void Program::dump(SkWStream* o) const {
        for (int i = 0; i < (int)fInstructions.size(); i++) {
            ...
            write(o, inst.live ? " " : "☠️");
            switch (op) {
                case Op::store8:  writeln(o, "store8" , Arg{x}, Val{y}); break;
                case Op::store32: writeln(o, "store32", Arg{x}, Val{y}); break;

                case Op::load8:  writeln(o, Val{id}, "= load8" , Arg{x}); break;
                case Op::load32: writeln(o, Val{id}, "= load32", Arg{x}); break;

                case Op::splat:  writeln(o, Val{id}, "= splat", imm); break;

                case Op::add_f32: writeln(o, Val{id}, "= add_f32", Val{x}, Val{y}        ); break;
                case Op::sub_f32: writeln(o, Val{id}, "= sub_f32", Val{x}, Val{y}        ); break;
                case Op::mul_f32: writeln(o, Val{id}, "= mul_f32", Val{x}, Val{y}        ); break;
                case Op::div_f32: writeln(o, Val{id}, "= div_f32", Val{x}, Val{y}        ); break;
                case Op::mad_f32: writeln(o, Val{id}, "= mad_f32", Val{x}, Val{y}, Val{z}); break;

                case Op::add_i32: writeln(o, Val{id}, "= add_i32", Val{x}, Val{y}); break;
                case Op::sub_i32: writeln(o, Val{id}, "= sub_i32", Val{x}, Val{y}); break;
                case Op::mul_i32: writeln(o, Val{id}, "= mul_i32", Val{x}, Val{y}); break;
                case Op::div_i32: writeln(o, Val{id}, "= div_i32", Val{x}, Val{y}); break;

                case Op::bit_and: writeln(o, Val{id}, "= bit_and", Val{x}, Val{y}); break;
                case Op::bit_or : writeln(o, Val{id}, "= bit_or" , Val{x}, Val{y}); break;
                case Op::bit_xor: writeln(o, Val{id}, "= bit_xor", Val{x}, Val{y}); break;

                case Op::shl: writeln(o, Val{id}, "= shl", Val{x}, imm); break;
                case Op::shr: writeln(o, Val{id}, "= shr", Val{x}, imm); break;
                case Op::sra: writeln(o, Val{id}, "= sra", Val{x}, imm); break;

                case Op::to_f32: writeln(o, Val{id}, "= to_f32", Val{x}); break;
                case Op::to_i32: writeln(o, Val{id}, "= to_i32", Val{x}); break;
            }
        }
    }
