...
namespace skvm {
    ...
    // x86 32-bit byte count, from the end of this intruction.
    ...
    void Assembler::jne(Label l) {
        ...
        // As usual, all x86 displacements relative to the end of this instruction.
        this->byte(0x0f, 0x85);
        this->word(this->disp32(l));
    }
