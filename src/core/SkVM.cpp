...
namespace skvm {
    ...
    static void write_one_instruction(Val id, const OptimizedInstruction& inst, SkWStream* o) {
        ...
        switch (op) {
            ...
            case Op::part64: write(o, V{id}, "=", op, V{x}, Hex{immA}); break;
    ...
    void Program::dump(SkWStream* o) const {
        ...
        for (Val i = 0; i < (Val)fImpl->instructions.size(); i++) {
            ...
            switch (op) {
                ...
                case Op::part64: write(o, R{d}, "=", op, R{x}, Hex{immA}); break;
    ...
    I32 Builder::part(I64 x, int lane) { return {this, push(Op::part64, x.id,NA,NA,NA, lane)}; }
    ...
    bool Program::jit(const std::vector<OptimizedInstruction>& instructions,
        ...
        *registers_used = 0;  // We'll update this as we go.
        ...
        auto emit = [&](Val id, bool scalar) {
            ...
            switch (op) {
            ...
            #if defined(__x86_64__) || defined(_M_X64)
                case Op::load64:
                case Op::part64:  return false;  // TODO
                ...
                case Op::part64: a->orr16b(dst(), r(x,immA), r(x,immA)); break;
            #else
                case Op::load64:
                case Op::part64:  return false;  // TODO
            #endif
