...
namespace skvm {
    ...
    static void write_one_instruction(Val id, const I& inst, SkWStream* o, Fs... fs) {
        ...
        switch (op) {
            ...
            case Op::q14_to_f32: write(o, V{id}, "=", op, V{x}, fs(id)...); break;
            case Op::q14_to_i32: write(o, V{id}, "=", op, V{x}, fs(id)...); break;
            case Op::f32_to_q14: write(o, V{id}, "=", op, V{x}, fs(id)...); break;
            case Op::i32_to_q14: write(o, V{id}, "=", op, V{x}, fs(id)...); break;
    ...
    void Program::dump(SkWStream* o) const {
        ...
        for (Val i = 0; i < (Val)fImpl->instructions.size(); i++) {
            ...
            switch (op) {
                ...
                case Op::q14_to_f32: write(o, R{d}, "=", op, R{x}); break;
                case Op::q14_to_i32: write(o, R{d}, "=", op, R{x}); break;
                case Op::f32_to_q14: write(o, R{d}, "=", op, R{x}); break;
                case Op::i32_to_q14: write(o, R{d}, "=", op, R{x}); break;
    ...
    Q14 Builder::to_q14(F32 x) { return {this, this->push(Op::f32_to_q14, x.id) }; }
    Q14 Builder::to_q14(I32 x) { return {this, this->push(Op::i32_to_q14, x.id) }; }
    F32 Builder::to_f32(Q14 x) { return {this, this->push(Op::q14_to_f32, x.id) }; }
    I32 Builder::to_i32(Q14 x) { return {this, this->push(Op::q14_to_i32, x.id) }; }
        ...
        *registers_used = 0;  // We'll update this as we go.
        ...
        auto emit = [&](Val id, bool scalar) {
            ...
            switch (op) {
                ...
                case Op::q14_to_i32:
                case Op::f32_to_q14:
                case Op::i32_to_q14: return false;  // TODO
