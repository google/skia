...
SkSurfaceProps SkBaseDevice::filterGeometry(const SkPaint& paint) const {
    if (this->onShouldDisableLCD(paint)) {
        return SkSurfaceProps(fSurfaceProps.flags(), kUnknown_SkPixelGeometry);
    }
