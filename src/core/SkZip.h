...
public:
    ...
    template<size_t Index> auto get() { return SkMakeSpan(std::get<Index>(fPointers), fSize); }
    template<typename T> auto get() { return SkMakeSpan(std::get<T*>(fPointers), fSize); }
