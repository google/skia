...
// Internal APIs that assume (and assert) that the shader code is valid, but do no internal caching.
// Used when the caller will cache the result in a static variable.
