...
public:
    ...
    uint32_t uniqueID() const { return fUniqueIDs[SkConservativeInfo::kLegacy_Format]; }
    ...
    bool lockAsBitmapOnlyIfAlreadyCached(SkBitmap*, SkConservativeInfo::Format);
...
private:
    ...
    bool tryLockAsBitmap(SkBitmap*, const SkImage*, SkImage::CachingHint,
                         SkConservativeInfo::Format, const SkImageInfo&);
    ...
    void makeCacheKeyFromOrigKey(const GrUniqueKey& origKey, SkConservativeInfo::Format,
    ...
    uint32_t               fUniqueIDs[SkConservativeInfo::kNumFormats];
