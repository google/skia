...
public:
     ...
     */
    sk_sp<GrTextureProxy> lockAsTexture(GrContext*, const GrSamplerParams&, SkColorSpace* dstColorSpace,
...
private:
    ...
    sk_sp<GrTextureProxy> lockTexture(GrContext*, const GrUniqueKey& key, const SkImage* client,
