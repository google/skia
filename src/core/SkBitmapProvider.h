...
public:
    explicit SkBitmapProvider(const SkBitmap& bm, SkSourceGammaTreatment treatment)
        : fBitmap(bm)
        , fTreatment(treatment)
    {}
    explicit SkBitmapProvider(const SkImage* img, SkSourceGammaTreatment treatment)
        : fImage(img)
        , fTreatment(treatment)
    {}
