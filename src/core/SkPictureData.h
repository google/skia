...
public:
    ...
    void serialize(SkWStream*, SkPixelSerializer*, SkRefCntSet*, SkExtPictureUIDs*) const;
...
protected:
    ...
    // Does not affect ownership of SkStream.
    bool parseStream(SkStream*, SkImageDeserializer*, SkTypefacePlayback*, SkExtPictures*);
