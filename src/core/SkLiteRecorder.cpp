...
void SkLiteRecorder::onDrawEdgeAAQuad(const SkRect& rect, const SkPoint clip[], int clipCount,
                                      SkCanvas::QuadAAFlags aaFlags, SkColor color,
                                      SkBlendMode mode) {
  fDL->drawEdgeAAQuad(rect, clip, clipCount, aaFlags, color, mode);
}
void SkLiteRecorder::onDrawEdgeAAImageSet(const SkCanvas::ImageSetEntry set[], int count,
