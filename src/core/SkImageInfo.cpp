...
enum Stored_SkColorType {
    ...
    kRGBX_1010102_Stored_SkColorType        = 11,
};
...
static uint8_t live_to_stored(unsigned ct) {
    switch (ct) {
        ...
        case kRGBX_8888_SkColorType:    return kRGBX_8888_Stored_SkColorType;
        ...
        case kRGBX_1010102_SkColorType: return kRGBX_1010102_Stored_SkColorType;
...
static SkColorType stored_to_live(unsigned stored) {
    switch (stored) {
        ...
        case kRGBX_8888_Stored_SkColorType:          return kRGBX_8888_SkColorType;
        ...
        case kRGBX_1010102_Stored_SkColorType:       return kRGBX_1010102_SkColorType;
