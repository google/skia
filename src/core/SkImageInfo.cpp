...
enum Stored_SkColorType {
    ...
    kRGBX_8888_Stored_SkColorType           = 9,

    kLast_Stored_SkColorType                = kRGBX_8888_Stored_SkColorType,
};
...
static uint8_t live_to_stored(unsigned ct) {
    switch (ct) {
        ...
        case kAlpha_8_SkColorType:
            return kAlpha_8_Stored_SkColorType;
        case kRGB_565_SkColorType:
            return kRGB_565_Stored_SkColorType;
        case kARGB_4444_SkColorType:
            return kARGB_4444_Stored_SkColorType;
        case kRGBA_8888_SkColorType:
            return kRGBA_8888_Stored_SkColorType;
        case kBGRA_8888_SkColorType:
            return kBGRA_8888_Stored_SkColorType;
        case kGray_8_SkColorType:
            return kGray_8_Stored_SkColorType;
        case kRGBA_F16_SkColorType:
            return kRGBA_F16_Stored_SkColorType;
        case kRGBX_8888_SkColorType:
            return kRGBX_8888_Stored_SkColorType;
    }
    return kUnknown_Stored_SkColorType;
}
...
static SkColorType stored_to_live(unsigned stored) {
    switch (stored) {
        case kUnknown_Stored_SkColorType:
            return kUnknown_SkColorType;
        case kAlpha_8_Stored_SkColorType:
            return kAlpha_8_SkColorType;
        case kRGB_565_Stored_SkColorType:
            return kRGB_565_SkColorType;
        case kARGB_4444_Stored_SkColorType:
            return kARGB_4444_SkColorType;
        case kRGBA_8888_Stored_SkColorType:
            return kRGBA_8888_SkColorType;
        case kBGRA_8888_Stored_SkColorType:
            return kBGRA_8888_SkColorType;
        case kIndex_8_Stored_SkColorType_DEPRECATED:
            return kUnknown_SkColorType;
        case kGray_8_Stored_SkColorType:
            return kGray_8_SkColorType;
        case kRGBA_F16_Stored_SkColorType:
            return kRGBA_F16_SkColorType;
        case kRGBX_8888_Stored_SkColorType:
            return kRGBX_8888_SkColorType;
    }
    return kUnknown_SkColorType;
}
