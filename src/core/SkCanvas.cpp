...
void SkCanvas::drawBitmap(const SkBitmap& bitmap, SkScalar dx, SkScalar dy, const SkPaint* paint) {
    sk_sp<SkImage> asImage = SkImage::MakeFromBitmap(bitmap);
    this->drawImage(asImage.get(), dx, dy, paint);
}

void SkCanvas::drawBitmapRect(const SkBitmap& bitmap, const SkRect& src, const SkRect& dst,
                              const SkPaint* paint, SrcRectConstraint constraint) {
    sk_sp<SkImage> asImage = SkImage::MakeFromBitmap(bitmap);
    this->drawImageRect(asImage.get(), src, dst, paint, constraint);
}
...
void SkCanvas::drawBitmapNine(const SkBitmap& bitmap, const SkIRect& center, const SkRect& dst,
                              const SkPaint* paint) {
    sk_sp<SkImage> asImage = SkImage::MakeFromBitmap(bitmap);
    this->drawImageNine(asImage.get(), center, dst, paint);
}

void SkCanvas::drawBitmapLattice(const SkBitmap& bitmap, const Lattice& lattice, const SkRect& dst,
                                 const SkPaint* paint) {
    sk_sp<SkImage> asImage = SkImage::MakeFromBitmap(bitmap);
    this->drawImageLattice(asImage.get(), lattice, dst, paint);
}
