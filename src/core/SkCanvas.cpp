...
static SkSamplingOptions sampling_from_paint(const SkPaint* paint) {
...
#else
    this->drawImage(image, x, y, sampling_from_paint(paint), paint);
#endif
}
...
#else
    this->drawImageRect(image, src, dst, sampling_from_paint(paint), paint, constraint);
#endif
}
