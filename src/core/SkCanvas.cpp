...
void SkCanvas::internalSave() {
    ...
    fClipStack->save();
    fMCRec->fRasterClip.setBoundRect(fBoundRect);
}
...
void SkCanvas::setBoundRect(const SkIRect& rect) {
    fBoundRect = rect;
    fClipStack->setBoundRect(rect);
    fMCRec->fRasterClip.setBoundRect(rect);
}
