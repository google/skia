...
void SkCanvas::internalSaveLayer(const SaveLayerRec& rec, SaveLayerStrategy strategy) {
    ...
    if (filter) {
        printf("*** internalSaveLayer dump ***\n");
        printf("  -- layer bounds: %d %d %d %d\n", layerBounds.left(), layerBounds.top(), layerBounds.right(), layerBounds.bottom());

        SkMatrix m = priorDevice->deviceToGlobal();
        printf("  -- P->G [%f %f %f | %f %f %f | %f %f %f]\n",
                m.get(0), m.get(1), m.get(2),
                m.get(3), m.get(4), m.get(5),
                m.get(6), m.get(7), m.get(8));

        m = newLayerMapping.deviceMatrix();
        printf("  -- D->P [%f %f %f | %f %f %f | %f %f %f]\n",
                m.get(0), m.get(1), m.get(2),
                m.get(3), m.get(4), m.get(5),
                m.get(6), m.get(7), m.get(8));

        m = newLayerMapping.layerMatrix();
        printf("  -- L->D [%f %f %f | %f %f %f | %f %f %f]\n",
                m.get(0), m.get(1), m.get(2),
                m.get(3), m.get(4), m.get(5),
                m.get(6), m.get(7), m.get(8));
    }
