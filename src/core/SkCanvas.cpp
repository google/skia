...
void SkCanvas::onDrawGlyphs(const SkPaint& paint, const SkFont& font, int n,
    ...
    SkGlyphRun glyphRun{font,
                        ...
                        SkSpan(text, textSize), SkSpan(clusters, n)};
...
void SkCanvas::drawGlyphs(const SkPaint& paint, const SkFont& font, int n,
                          const SkGlyphID* glyphs, const SkPoint* locations,
                          const uint32_t* clusters, int textSize, const char* text) {
    TRACE_EVENT0("skia", TRACE_FUNC);
    ...
    this->onDrawGlyphs(paint, font, n, glyphs, locations, clusters, textSize, text);
}
