...
SkRuntimeEffect* make_matrix_conv_effect(MatrixConvolutionImpl impl,
    ...
    static const auto makeTextureEffect = [options](int maxTextureKernelSize) {
        return SkMakeRuntimeEffect(SkRuntimeEffect::MakeForShader,
    ...
    switch (impl) {
        ...
        case MatrixConvolutionImpl::kTextureBasedSm:
            return makeTextureEffect(MatrixConvolutionImageFilter::kSmallKernelSize);
        case MatrixConvolutionImpl::kTextureBasedLg:
            return makeTextureEffect(MatrixConvolutionImageFilter::kLargeKernelSize);
    }
