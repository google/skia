...
public:
    ...
    // prepareForDrawingRemoveEmpty takes glyphIDs, and position in the form of
    ...
    // prepareForDrawingRemoveEmpty should remove all empty glyphs from the drawable glyphs.
    virtual void
    prepareForDrawingRemoveEmpty(int maxGlyphDimension, SkDrawableGlyphBuffer* drawables) = 0;
