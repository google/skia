...
void SkVerticesPriv::encode(SkWriteBuffer& buffer) const {
    // packed has room for addtional flags in the future
...
#define RETURN_INVALID_BUFFER do { buffer.validate(false); return nullptr; } while(false)
