...
void SkRasterPipeline::append_load(SkColorType ct, const SkRasterPipeline_MemoryCtx* ctx) {
    switch (ct) {
        ...
        case kA16_flt_SkColorType:           this->append(load_af16,    ctx); break;
        ...
        case kR16G16_flt_SkColorType:        this->append(load_rgf16,   ctx); break;
...
void SkRasterPipeline::append_load_dst(SkColorType ct, const SkRasterPipeline_MemoryCtx* ctx) {
    switch (ct) {
        ...
        case kA16_flt_SkColorType:            this->append(load_af16_dst,    ctx); break;
        ...
        case kR16G16_flt_SkColorType:         this->append(load_rgf16_dst,   ctx); break;
...
void SkRasterPipeline::append_store(SkColorType ct, const SkRasterPipeline_MemoryCtx* ctx) {
    switch (ct) {
        ...
        case kA16_flt_SkColorType:            this->append(store_af16,    ctx); break;
        ...
        case kR16G16_flt_SkColorType:         this->append(store_rgf16,   ctx); break;
