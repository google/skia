...
#else // #ifndef SK_DISABLE_READ_BUFFER
...
public:
    ...
    void readPath   (SkPath*    out) { *out = SkPaint();          }
    bool readPaint  (SkPaint* paint) { *out = SkPaint();          }
...
#endif // #ifndef SK_DISABLE_READ_BUFFER
