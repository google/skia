...
public:
    ...
    static void HairPath(const SkSPath&, const SkRasterClip&, SkBlitter*);
    static void AntiHairPath(const SkSPath&, const SkRasterClip&, SkBlitter*);
    static void HairSquarePath(const SkSPath&, const SkRasterClip&, SkBlitter*);
    static void AntiHairSquarePath(const SkSPath&, const SkRasterClip&, SkBlitter*);
    static void HairRoundPath(const SkSPath&, const SkRasterClip&, SkBlitter*);
    static void AntiHairRoundPath(const SkSPath&, const SkRasterClip&, SkBlitter*);
