...
SkPictInfo SkPicture::createHeader() const {
    ...
    info.setVersion(SkPicturePriv::CURRENT_PICTURE_VERSION);
...
bool SkPicture::IsValidPictInfo(const SkPictInfo& info) {
    ...
    if (info.getVersion() < SkPicturePriv::MIN_PICTURE_VERSION ||
        info.getVersion() > SkPicturePriv::CURRENT_PICTURE_VERSION) {
        return false;
    }
    return true;
}
