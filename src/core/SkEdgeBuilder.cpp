...
int SkEdgeBuilder::buildPoly(const SkSPath& path, const SkIRect* iclip, bool canCullToTheRight) {
    size_t maxEdgeCount = path.fPoints.count();
    if (iclip) {
...
int SkEdgeBuilder::build(const SkSPath& path, const SkIRect* iclip, bool canCullToTheRight) {
...
int SkEdgeBuilder::buildEdges(const SkSPath& path,
