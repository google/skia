...
template <typename Message, bool AllowCopyableMessage>
template <typename T>
/* static */ void SkMessageBus<Message, AllowCopyableMessage>::AssertMessageUnique(const T& m) {}

template <typename Message, bool AllowCopyableMessage>
template <typename T>
/* static */ void SkMessageBus<Message, AllowCopyableMessage>::AssertMessageUnique(
        const sk_sp<T>& m) {
    SkASSERT(AllowCopyableMessage || m->unique());
}
