...
DRAW(DrawEdgeAARect, experimental_DrawEdgeAARectV1(r.rect, r.aa, r.paint));
...
private:
    ...
    Bounds bounds(const DrawEdgeAARect& op) const { return this->adjustAndMap(op.rect, &op.paint); }
