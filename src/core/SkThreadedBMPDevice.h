...
struct DrawElement {
    ...
    std::function<void(SkArenaAlloc* threadAlloc, DrawElement*)>        fInitFn;
    std::function<void(SkArenaAlloc* threadAlloc, const SkIRect& threadBounds, DrawElement*)>      fDrawFn;
};
