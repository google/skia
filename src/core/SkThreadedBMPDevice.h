...
private:
    ...
    public:
        ...
        // Push a draw command with init-once function initFn. Note that drawFn of the drawElement
        // will not be set until the finish of initFn (i.e., initFn is responsible for setting up
        // drawFn).
        SK_ALWAYS_INLINE void push(const SkRect& rawDrawBounds,
