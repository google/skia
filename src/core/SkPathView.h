...
static constexpr uint8_t gLineVerbs4[] = {
...
struct SkPathView_triangle : public SkPathView {
    SkPathView_triangle(const SkPoint pts[3], const SkRect& bounds)
        : SkPathView({pts, 3}, {gLineVerbs4, 3}, {nullptr, 0},
                     SkPathFillType::kWinding, SkPathConvexityType::kConvex,
                     bounds, kLine_SkPathSegmentMask, true)
    {}
};

struct SkPathView_quad : public SkPathView {
    SkPathView_quad(const SkPoint pts[4], const SkRect& bounds)
        : SkPathView({pts, 4}, {gLineVerbs4, 4}, {nullptr, 0},
                     SkPathFillType::kWinding, SkPathConvexityType::kConvex,
                     bounds, kLine_SkPathSegmentMask, true)
    {}
};
