...
public:
    ...
    SkGlyphRunListDrawer::PerMask drawOneMaskCreator(const SkPaint& paint, SkArenaAlloc* alloc) const;

    void    drawGlyphRunList(SkGlyphRunList* glyphRunList, SkGlyphRunListDrawer* glyphDraw,
