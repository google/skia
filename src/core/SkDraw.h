...
private:
    ...
    void draw_fixed_vertices(const SkVertices*, SkBlendMode, const SkPaint&, const SkMatrix&) const;
    void draw_vdata_vertices(const SkVertices*, const SkPaint&, const SkMatrix&) const;
