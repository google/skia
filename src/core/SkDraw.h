...
public:
    ...
    SkGlyphDraw::PerMask drawOneMaskCreator(const SkPaint& paint, SkArenaAlloc* alloc) const;

    void    drawGlyphRunList(SkGlyphRunList* glyphRunList, SkGlyphDraw* glyphDraw,
