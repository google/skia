...
bool SkM4::operator==(const SkM4& other) const {
    ...
    return eq4(&a[12], &b[12]);
        ...
        sk4f a0 = sk4f::Load(a +  0);
        sk4f a1 = sk4f::Load(a +  4);
        sk4f a2 = sk4f::Load(a +  8);
        sk4f a3 = sk4f::Load(a + 12);

        sk4f b0 = sk4f::Load(b +  0);
        sk4f b1 = sk4f::Load(b +  4);
        sk4f b2 = sk4f::Load(b +  8);
        sk4f b3 = sk4f::Load(b + 12);
...
SkM4& SkM4::setConcat(const SkM4& a, const SkM4& b) {
    ...
    sk4f c1 = sk4f::Load(&a.fMat[1]);
    sk4f c2 = sk4f::Load(&a.fMat[2]);
    sk4f c3 = sk4f::Load(&a.fMat[3]);
...
//        return c0 * r[0] + c1 * r[1] + c2 * r[2] + c3 * r[3];
    ...
    sk4f m1 = compute(sk4f::Load(&b.fMat[1]));
    sk4f m2 = compute(sk4f::Load(&b.fMat[2]));
    sk4f m3 = compute(sk4f::Load(&b.fMat[3]));
