...
#include "SkBitmapProcState_filter.h"  // Filter_32_alpha() for portable path.
...
namespace SK_OPTS_NS {
    ...
    #else
        // from SkBitmapProcState_filter.h
        constexpr auto filter_and_scale_by_alpha = Filter_32_alpha;
    #endif
