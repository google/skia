    ...
    *w = (packed >> 14) & 0xf;
    ...
    void S32_alpha_D32_filter_DX(const SkBitmapProcState& s,
        ...
        auto interpolate_in_x_and_y = [&](uint32_t A0, uint32_t A1,
            ...
            // Interpolate in Y and scale everything down by total max weight 16x16 = 256.
            return _mm_srli_epi16(_mm_add_epi16(_mm_mullo_epi16(row0, _mm_set1_epi16(16-wy)),
                                                _mm_mullo_epi16(row1, _mm_set1_epi16(   wy))), 8);
        };

        // Return (px * alpha) / 256, where alpha is in [0,256].
        auto scale_by_alpha = [&](__m128i px) {
