...
STAGE_GP(bilerp_clamp_8888, const SkJumper_GatherCtx* ctx) {
    ...
    // The first three sample points will calculate their are using math
    // just like in the float code above, but the fourth will take up all the rest.
    //
    // Logically this is the same as doing the math, but rounding error makes this
    // strategy better, keeping opaque opaque, etc.
    //
