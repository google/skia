...
SI void next_body(SkRasterPipeline::Stage* st, size_t x,
                  SkNf  r, SkNf  g, SkNf  b, SkNf  a,
                  SkNf dr, SkNf dg, SkNf db, SkNf da) {
    ((Body)st->fNext)(st+1, x, r,g,b,a, dr,db,db,da);
}
SI void next_tail(SkRasterPipeline::Stage* st, size_t x, size_t tail,
                  SkNf  r, SkNf  g, SkNf  b, SkNf  a,
                  SkNf dr, SkNf dg, SkNf db, SkNf da) {
    ((Tail)st->fNext)(st+1, x,tail, r,g,b,a, dr,db,db,da);
}
