...
void start_pipeline(size_t dx, size_t dy, size_t xlimit, size_t ylimit, void** program) {
    ...
    #define STAGE(name, ...)                                                    \
        ...
        ABI void name(Params* params, void** program,                           \
                      F r, F g, F b, F a) {                                     \
    ...
    #define STAGE(name, ...)                                                         \
        SI void name##_k(__VA_ARGS__, size_t dx, size_t dy, size_t tail,             \
                         F& r, F& g, F& b, F& a, F& dr, F& dg, F& db, F& da);        \
        ABI void name(size_t tail, void** program, size_t dx, size_t dy,             \
                      F r, F g, F b, F a, F dr, F dg, F db, F da) {                  \
...
#if defined(__i386__) || defined(_M_IX86) || defined(__arm__)
    ABI void just_return(Params*, void**, F,F,F,F) {}
#else
    ABI void just_return(size_t, void**, size_t,size_t, F,F,F,F, F,F,F,F) {}
#endif
...
void start_pipeline(const size_t x0,     const size_t y0,
...
ABI void just_return(size_t,void**,size_t,size_t, U16,U16,U16,U16, U16,U16,U16,U16) {}
