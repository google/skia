...
#include "src/core/SkMSAN.h"
    ...
    static inline __m512i SkPMSrcOver_SKX(const __m512i& src, const __m512i& dst) {
        // Detailed explainations in SkPMSrcOver_AVX2
        // b = s + (d*(256-srcA)) >> 8
        const int _ = -1;   // fills a literal 0 byte.
        __m512i srcA_x2 = _mm512_shuffle_epi8(src,
                _mm512_set_epi8(_,63,_,63, _,59,_,59, _,55,_,55, _,51,_,51,
                                _,47,_,47, _,43,_,43, _,39,_,39, _,35,_,35,
                                _,31,_,31, _,27,_,27, _,23,_,23, _,19,_,19,
