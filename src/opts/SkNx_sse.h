...
public:
    ...
    AI static void Load3(const void* ptr, SkNx* r, SkNx* g, SkNx* b) {
        ...
        __m128i rgb1 = _mm_bsrli_si128(rgb0, 3*2);
        __m128i rgb2 = _mm_bsrli_si128(_mm_loadu_si128((const __m128i*) (ptr8 + 4*2)), 2*2);
        __m128i rgb3 = _mm_bsrli_si128(rgb2, 3*2);
