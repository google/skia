...
public:
    ...
    AI Sk2u operator == (const SkNx& o) const { return _mm_castps_si128(_mm_cmpeq_ps (fVec, o.fVec)); }
    AI Sk2u operator != (const SkNx& o) const { return _mm_castps_si128(_mm_cmpneq_ps(fVec, o.fVec)); }
    AI Sk2u operator  < (const SkNx& o) const { return _mm_castps_si128(_mm_cmplt_ps (fVec, o.fVec)); }
    AI Sk2u operator  > (const SkNx& o) const { return _mm_castps_si128(_mm_cmpgt_ps (fVec, o.fVec)); }
    AI Sk2u operator <= (const SkNx& o) const { return _mm_castps_si128(_mm_cmple_ps (fVec, o.fVec)); }
    AI Sk2u operator >= (const SkNx& o) const { return _mm_castps_si128(_mm_cmpge_ps (fVec, o.fVec)); }
...
public:
    ...
    AI Sk4u operator == (const SkNx& o) const { return _mm_castps_si128(_mm_cmpeq_ps (fVec, o.fVec)); }
    AI Sk4u operator != (const SkNx& o) const { return _mm_castps_si128(_mm_cmpneq_ps(fVec, o.fVec)); }
    AI Sk4u operator  < (const SkNx& o) const { return _mm_castps_si128(_mm_cmplt_ps (fVec, o.fVec)); }
    AI Sk4u operator  > (const SkNx& o) const { return _mm_castps_si128(_mm_cmpgt_ps (fVec, o.fVec)); }
    AI Sk4u operator <= (const SkNx& o) const { return _mm_castps_si128(_mm_cmple_ps (fVec, o.fVec)); }
    AI Sk4u operator >= (const SkNx& o) const { return _mm_castps_si128(_mm_cmpge_ps (fVec, o.fVec)); }
