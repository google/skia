...
namespace SkOpts {
    ...
    #define STAGE(stage, kCallNext) \
        ...
        stages_7[SkRasterPipeline::stage] = stage_7<SK_OPTS_NS::stage, kCallNext>
...
/*
    ...
    #define STAGE(stage) \
        stages_8[SkRasterPipeline::stage] = SK_OPTS_NS::stage; \
        stages_7[SkRasterPipeline::stage] = SK_OPTS_NS::stage
