...
public:
    ...
    , fInt_Type(new Type(SkString("int"), true, { fUInt_Type.get(), fFloat_Type.get(), fDouble_Type.get() }))
    ...
    , fSamplerExternalOES_Type(new Type(SkString("samplerExternalOES"), SpvDim2D, false, false, false, true))
