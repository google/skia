...
void MetalCodeGenerator::writeExpression(const Expression& expr, Precedence parentPrecedence) {
    switch (expr.kind()) {
        ...
        case Expression::Kind::kConstructorArray:
            this->writeAnyConstructor(expr.as<ConstructorArray>(), "{", "}", parentPrecedence);
            break;
        case Expression::Kind::kConstructorDiagonalMatrix:
            this->writeAnyConstructor(expr.as<ConstructorDiagonalMatrix>(), "(", ")",
                                      parentPrecedence);
            break;
        case Expression::Kind::kConstructorScalarCast:
            this->writeConstructorAsNecessary(expr.as<ConstructorScalarCast>(), "(", ")",
                                              parentPrecedence);
            break;
        case Expression::Kind::kConstructorSplat:
            this->writeAnyConstructor(expr.as<ConstructorSplat>(), "(", ")", parentPrecedence);
            break;
        case Expression::Kind::kConstructorVectorCast:
            this->writeConstructorAsNecessary(expr.as<ConstructorVectorCast>(), "(", ")",
                                              parentPrecedence);
            break;
...
void MetalCodeGenerator::writeConstructorAsNecessary(const AnyConstructor& c,
                                                     const char* leftBracket,
                                                     const char* rightBracket,
                                                     Precedence parentPrecedence) {
