...
SkTArray<dsl::DSLVar> DSLParser::varDeclarationEnd(DSLModifiers mods, DSLType baseType,
    ...
    result.push_back(DSLVar(mods, type, Retain(String(name))->c_str(), std::move(initializer)));
    ...
    while (this->checkNext(Token::Kind::TK_COMMA)) {
        ...
        result.push_back(DSLVar(mods, type, Retain(String(this->text(identifierName)))->c_str(),
