...
DSLParser::DSLParser(Compiler* compiler, ProgramKind kind, const char* text, size_t length)
    : fCompiler(*compiler)
    , fText(text, length)
    , fPushback(Token::Kind::TK_NONE, -1, -1) {
    Start(compiler, kind);
    // FIXME can't leave this in
...
std::unique_ptr<Program> DSLParser::program() {
    ...
    std::unique_ptr<Program> result = DSLWriter::ReleaseProgram();
    End();
    fCompiler.context().fConfig = nullptr;
    return result;
}
...
//        return this->createNode(lookahead.fOffset, ASTNode::Kind::kModifiers, modifiers);
    ...
    std::optional<DSLType> type = this->type();
    if (!type) {
        return false;
    }
    Token name;
    ...
    if (this->checkNext(Token::Kind::TK_LPAREN)) {
        SkTArray<std::optional<DSLWrapper<DSLVar>>> parameters;
        SkTArray<DSLVar*> parameterPointers;
        if (this->peek().fKind != Token::Kind::TK_RPAREN) {
            for (;;) {
                std::optional<DSLWrapper<DSLVar>> parameter = this->parameter();
                if (!parameter) {
                    return false;
                }
        ...
        DSLFunction result(*type, c_name, std::move(parameterPointers));
        ...
        std::optional<DSLStatement> result = this->varDeclarationEnd(modifiers, *type,
                                                                     this->text(name));
        if (!result) {
            return false;
        }
        abort(); // no globals in DSL yet
        return true;
    }
}

/* (varDeclarations | expressionStatement) */
std::optional<DSLStatement> DSLParser::varDeclarationsOrExpressionStatement() {
    if (this->isType(this->text(this->peek()))) {
        VarDeclarationsPrefix prefix;
        // FIXME speculative parse
        if (this->varDeclarationsPrefix(&prefix)) {
            return this->varDeclarationEnd(prefix.modifiers, prefix.type,
...
std::optional<DSLStatement> DSLParser::varDeclarations() {
    VarDeclarationsPrefix prefix;
    if (!this->varDeclarationsPrefix(&prefix)) {
        return {};
    }
...
std::optional<DSLStatement> DSLParser::varDeclarationEnd(DSLModifiers mods, DSLType type,
                                                         StringFragment name) {
...
/*    if (!parseArrayDimensions(currentVar, &vd)) {
    ...
    std::optional<DSLWrapper<DSLExpression>> value;
    if (this->checkNext(Token::Kind::TK_EQ)) {
    ...
    DSLVar var(mods, type, this->symbols().takeOwnershipOfString(name)->c_str(),
               value ? std::move(**value) : DSLExpression());
    DSLStatement result = Declare(var);
...
std::optional<DSLWrapper<DSLVar>> DSLParser::parameter() {
...
//    Layout layout = this->layout();
    ...
    return DSLModifiers(/*layout, */flags);
}
...
std::optional<DSLStatement> DSLParser::statement() {
    ...
    switch (start.fKind) {
        ...
        case Token::Kind::TK_LBRACE: {
            ...
            return result ? std::optional<DSLStatement>(std::move(*result))
                          : std::optional<DSLStatement>();
        }
        case Token::Kind::TK_SEMICOLON:
            this->nextToken();
            return dsl::Block();
...
std::optional<DSLType> DSLParser::type() {
    Token type;
...
std::optional<DSLStatement> DSLParser::ifStatement() {
    Token start;
    ...
    std::optional<DSLWrapper<DSLExpression>> test = this->expression();
    if (!test) {
        return {};
    }
    if (!this->expect(Token::Kind::TK_RPAREN, "')'")) {
    ...
    std::optional<DSLStatement> ifTrue = this->statement();
    if (!ifTrue) {
        return {};
    }
    std::optional<DSLStatement> ifFalse;
    ...
    return If(std::move(**test), std::move(*ifTrue), ifFalse ? std::move(*ifFalse) : DSLStatement(),
              isStatic);
}

/* DO statement WHILE LPAREN expression RPAREN SEMICOLON */
std::optional<DSLStatement> DSLParser::doStatement() {
    Token start;
    if (!this->expect(Token::Kind::TK_DO, "'do'", &start)) {
        return {};
    }
    std::optional<DSLStatement> statement = this->statement();
    if (!statement) {
        return {};
    }
...
std::optional<DSLStatement> DSLParser::whileStatement() {
    Token start;
...
std::optional<DSLCase> DSLParser::switchCase() {
    ...
    std::optional<DSLWrapper<DSLExpression>> value = this->expression();
    if (!value) {
        return {};
    }
    if (!this->expect(Token::Kind::TK_COLON, "':'")) {
    ...
    while (this->peek().fKind != Token::Kind::TK_RBRACE &&
        ...
        std::optional<DSLStatement> s = this->statement();
        if (!s) {
            return {};
        }
...
std::optional<DSLStatement> DSLParser::switchStatement() {
    Token start;
...
/* FOR LPAREN (declaration | expression)? SEMICOLON expression? SEMICOLON expression? RPAREN
   STATEMENT */
std::optional<dsl::DSLStatement> DSLParser::forStatement() {
    Token start;
    ...
    std::optional<dsl::DSLStatement> initializer;
    ...
    std::optional<DSLWrapper<DSLExpression>> test;
    ...
    std::optional<DSLWrapper<DSLExpression>> next;
    if (this->peek().fKind != Token::Kind::TK_RPAREN) {
    ...
    std::optional<dsl::DSLStatement> statement = this->statement();
    if (!statement) {
        return {};
    }
...
std::optional<DSLStatement> DSLParser::returnStatement() {
    Token start;
    if (!this->expect(Token::Kind::TK_RETURN, "'return'", &start)) {
        return {};
    }
    std::optional<DSLWrapper<DSLExpression>> expression;
    if (this->peek().fKind != Token::Kind::TK_SEMICOLON) {
...
/* BREAK SEMICOLON */
std::optional<DSLStatement> DSLParser::breakStatement() {
    Token start;
...
/* CONTINUE SEMICOLON */
std::optional<DSLStatement> DSLParser::continueStatement() {
    Token start;
...
/* DISCARD SEMICOLON */
std::optional<DSLStatement> DSLParser::discardStatement() {
    Token start;
...
std::optional<DSLStatement> DSLParser::expressionStatement() {
    std::optional<DSLWrapper<DSLExpression>> expr = this->expression();
    if (expr) {
        if (this->expect(Token::Kind::TK_SEMICOLON, "';'")) {
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::expression() {
    std::optional<DSLWrapper<DSLExpression>> result = this->assignmentExpression();
    if (!result) {
        return {};
    }
    Token t;
    ...
    while (this->checkNext(Token::Kind::TK_COMMA, &t)) {
        ...
        std::optional<DSLWrapper<DSLExpression>> right = this->expression();
        if (!right) {
            return {};
        }
        //result = std::optional<DSLWrapper<DSLExpression>>(std::move(**result) , std::move(**right));
        abort();
        break;
    }
    return result;
...
#define OPERATOR_RIGHT(op, exprType)                                       \
    {                                                                      \
        ...
        std::optional<DSLWrapper<DSLExpression>> right = this->exprType(); \
        if (!right) {                                                      \
            return {};                                                     \
        }                                                                  \
 ...
 */
std::optional<DSLWrapper<DSLExpression>> DSLParser::assignmentExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->ternaryExpression();
    if (!result) {
        return {};
    }
    for (;;) {
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::ternaryExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> base = this->logicalOrExpression();
    if (!base) {
        return {};
    }
    if (this->checkNext(Token::Kind::TK_QUESTION)) {
        ...
        std::optional<DSLWrapper<DSLExpression>> trueExpr = this->expression();
        if (!trueExpr) {
            return {};
        }
        if (this->expect(Token::Kind::TK_COLON, "':'")) {
            std::optional<DSLWrapper<DSLExpression>> falseExpr = this->assignmentExpression();
            if (!falseExpr) {
                return {};
            }
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::logicalOrExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->logicalXorExpression();
    if (!result) {
        return {};
    }
    Token t;
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::logicalXorExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->logicalAndExpression();
    if (!result) {
        return {};
    }
    Token t;
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::logicalAndExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->bitwiseOrExpression();
    if (!result) {
        return {};
    }
    Token t;
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::bitwiseOrExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->bitwiseXorExpression();
    if (!result) {
        return {};
    }
    Token t;
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::bitwiseXorExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->bitwiseAndExpression();
    if (!result) {
        return {};
    }
    Token t;
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::bitwiseAndExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->equalityExpression();
    if (!result) {
        return {};
    }
    Token t;
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::equalityExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->relationalExpression();
    if (!result) {
        return {};
    }
    for (;;) {
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::relationalExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->shiftExpression();
    if (!result) {
        return {};
    }
    for (;;) {
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::shiftExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->additiveExpression();
    if (!result) {
        return {};
    }
    for (;;) {
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::additiveExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->multiplicativeExpression();
    if (!result) {
        return {};
    }
    for (;;) {
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::multiplicativeExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->unaryExpression();
    if (!result) {
        return {};
    }
    for (;;) {
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::unaryExpression() {
    AutoDSLDepth depth(this);
    switch (this->peek().fKind) {
        ...
        case Token::Kind::TK_MINUSMINUS: {
            ...
            Token t = this->nextToken();
            std::optional<DSLWrapper<DSLExpression>> expr = this->unaryExpression();
            if (!expr) {
                return {};
            }
...
/* term suffix* */
std::optional<DSLWrapper<DSLExpression>> DSLParser::postfixExpression() {
    AutoDSLDepth depth(this);
    std::optional<DSLWrapper<DSLExpression>> result = this->term();
    if (!result) {
        return {};
    }
    for (;;) {
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::swizzle(int offset,
        std::optional<DSLWrapper<DSLExpression>> base, const char* swizzleMask) {
...
std::optional<dsl::Wrapper<dsl::DSLExpression>> DSLParser::call(int offset,
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::suffix(
        std::optional<DSLWrapper<DSLExpression>> base) {
    SkASSERT(base);
    Token next = this->nextToken();
    AutoDSLDepth depth(this);
    if (!depth.increase()) {
    ...
    switch (next.fKind) {
        case Token::Kind::TK_LBRACKET: {
            std::optional<DSLWrapper<DSLExpression>> index = this->expression();
            if (!index) {
                return {};
            }
        ...
        case Token::Kind::TK_LPAREN: {
            ...
            if (this->peek().fKind != Token::Kind::TK_RPAREN) {
                for (;;) {
                    std::optional<DSLWrapper<DSLExpression>> expr = this->assignmentExpression();
                    if (!expr) {
                        return {};
                    }
...
std::optional<DSLWrapper<DSLExpression>> DSLParser::term() {
    Token t = this->peek();
    switch (t.fKind) {
        case Token::Kind::TK_IDENTIFIER: {
            StringFragment text;
        ...
        case Token::Kind::TK_LPAREN: {
            ...
            std::optional<DSLWrapper<DSLExpression>> result = this->expression();
            if (result) {
