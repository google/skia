...
/*  TODO(ethannicholas): implement this
    ...
    result.push_back(DSLVar(mods, type, Retain(String(name))->c_str(),
...
skstd::optional<DSLWrapper<DSLExpression>> DSLParser::swizzle(int offset,
        skstd::optional<DSLWrapper<DSLExpression>> base, skstd::string_view swizzleMask) {
