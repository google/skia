...
std::unique_ptr<Expression> Inliner::inlineExpression(int offset,
    ...
    switch (expression.kind()) {
        case Expression::Kind::kBinary:
            return Expression::MakeBinary(offset,
                                          expr(expression.expressionPointer(
                                                                       IRNode::Index::kBinaryLeft)),
                                          expression.getBinaryData().fOperator,
                                          expr(expression.expressionPointer(
                                                                      IRNode::Index::kBinaryRight)),
                                          *expression.getBinaryData().fType);
