...
// Given a string containing an SkSL program, searches for a settings comment in this format:
//    /*#pragma settings Default*/
// and, if found, updates the passed-in Settings to honor those caps/flags.
