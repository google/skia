...
private:
    ...
    friend DSLStatement Declare(DSLVar& var);
    ...
    friend DSLStatement For(DSLStatement initializer, DSLExpression test, DSLExpression next,
                            DSLStatement stmt);
    friend DSLStatement If(DSLExpression test, DSLStatement ifTrue);
    ...
    friend DSLExpression dsl_function1(const char* name, DSLExpression a);
    friend DSLExpression dsl_function2(const char* name, DSLExpression a, DSLExpression b);
    friend DSLExpression dsl_function3(const char* name, DSLExpression a, DSLExpression b,
                                       DSLExpression c);
