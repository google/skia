...
// maybe avoid need for thread_local on iPhone by naming these some fixed token that gets string
// replaced?
thread_local extern Var sk_SampleCoord;
thread_local extern Var sk_OutColor;
thread_local extern Var sk_InColor;
