...
public:
    ...
    const GrFragmentProcessor* currentProcessor() {
        return fCurrentProcessor;
    }

    void setCurrentProcessor(const GrFragmentProcessor* processor) {
        fCurrentProcessor = processor;
    }

    const GrGLSLFragmentProcessor::EmitArgs* currentEmitArgs() {
        return fEmitArgs;
    }

    void setCurrentEmitArgs(const GrGLSLFragmentProcessor::EmitArgs* emitArgs) {
        fEmitArgs = emitArgs;
    }
...
private:
    ...
    const GrFragmentProcessor* fCurrentProcessor;
    const GrGLSLFragmentProcessor::EmitArgs* fEmitArgs;
};
