...
public:
    ...
    enum class Instruction : uint8_t {
        ...
        kCall,
        // uint8_t functionIndex, [Register param1, ...]
        kCallVoid,
        // Register target, Register src1, Register src2
        kCompareEQI,
        // Register target, Register src1, Register src2
        ...
        // Register target, Pointer src
        kLoadStackDirect,
        // Stores the depth of the mask stack onto the loop stack so break and continue can work
        // no parameters
        kLoopBegin,
        // Pops the loop stack
        // no parameters
        ...
        // Register target, Register src1, Register src2
        kRemainderU,
        // Register test, Register ifTrue, Register ifFalse
        kSelect,
