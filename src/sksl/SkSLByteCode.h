...
enum class ByteCodeInstruction : uint16_t {
    ...
    kReturn,
    // Followed by a byte indicating dimension of matrix (2, 3, or 4).
    // Takes a single value from the top of the stack, and converts to an NxN matrix with that value
