...
static bool InnerRun(const ByteCode* byteCode, const ByteCodeFunction* f, VValue* stack,
    ...
    for (;;) {
        ...
        switch (inst) {
            ...
            LABEL(kDup4) PUSH(sp[(int)ByteCodeInstruction::kDup - (int)inst]);
            ...
            LABEL(kLoadGlobal4) sp[4] = globals[*ip + 3];
            ...
            LABEL(kLoadUniform4) sp[4].fFloat = uniforms[*ip + 3];
            LABEL(kLoadUniform3) sp[3].fFloat = uniforms[*ip + 2];
            LABEL(kLoadUniform2) sp[2].fFloat = uniforms[*ip + 1];
            LABEL(kLoadUniform)  sp[1].fFloat = uniforms[*ip + 0];
                                ++ip;
