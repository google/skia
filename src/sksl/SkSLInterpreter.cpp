    ...
    for (;;) {
        ...
        switch (inst) {
            ...
            case ByteCodeInstruction::kLoadExtended: {
                ...
                for (int i = 0; i < count; ++i) {
                    sp[i + 1].fUnsigned[0] = stack[src[0]].fUnsigned[0];
                    sp[i + 1].fUnsigned[1] = stack[src[1]].fUnsigned[1];
                    sp[i + 1].fUnsigned[2] = stack[src[2]].fUnsigned[2];
                    sp[i + 1].fUnsigned[3] = stack[src[3]].fUnsigned[3];
                }
                sp += count;
                break;
            }
            ...
            case ByteCodeInstruction::kLoadExtendedGlobal: {
                ...
                int4 src = POP().fSigned;
                for (int i = 0; i < count; ++i) {
                    sp[i + 1].fUnsigned[0] = fGlobals[src[0]].fUnsigned[0];
                    sp[i + 1].fUnsigned[1] = fGlobals[src[1]].fUnsigned[1];
                    sp[i + 1].fUnsigned[2] = fGlobals[src[2]].fUnsigned[2];
                    sp[i + 1].fUnsigned[3] = fGlobals[src[3]].fUnsigned[3];
                }
                sp += count;
                break;
            }
            ...
            case ByteCodeInstruction::kStore4: {
                ...
                if (skvx::all(m)) {
                    ...
                    int4 tmp[4] = { POP().fSigned, POP().fSigned, POP().fSigned, POP().fSigned };
                    for (int lane = 0; lane < 4; ++lane) {
                        if (m[lane]) {
                            stack[*ip + 3].fUnsigned[lane] = tmp[0][lane];
                            stack[*ip + 2].fUnsigned[lane] = tmp[1][lane];
                            stack[*ip + 1].fUnsigned[lane] = tmp[2][lane];
                            stack[*ip + 0].fUnsigned[lane] = tmp[3][lane];
                        }
                    }
                }
                ++ip;
            ...
            case ByteCodeInstruction::kStore3: {
                ...
                if (skvx::all(m)) {
                    ...
                    int4 tmp[3] = { POP().fSigned, POP().fSigned, POP().fSigned };
                    for (int lane = 0; lane < 4; ++lane) {
                        if (m[lane]) {
                            stack[*ip + 2].fUnsigned[lane] = tmp[0][lane];
                            stack[*ip + 1].fUnsigned[lane] = tmp[1][lane];
                            stack[*ip + 0].fUnsigned[lane] = tmp[2][lane];
                        }
                    }
                }
                ++ip;
            ...
            case ByteCodeInstruction::kStore2: {
                ...
                if (skvx::all(m)) {
                    ...
                    int4 tmp[2] = { POP().fSigned, POP().fSigned };
                    for (int lane = 0; lane < 4; ++lane) {
                        if (m[lane]) {
                            stack[*ip + 1].fUnsigned[lane] = tmp[0][lane];
                            stack[*ip + 0].fUnsigned[lane] = tmp[1][lane];
                        }
                    }
                }
                ++ip;
            ...
            case ByteCodeInstruction::kStore: {
                ...
                if (skvx::all(m)) {
                    ...
                    int4 tmp[1] = { POP().fSigned };
                    for (int lane = 0; lane < 4; ++lane) {
                        if (m[lane]) {
                            stack[*ip + 0].fUnsigned[lane] = tmp[0][lane];
                        }
                    }
                }
                ++ip;
            ...
            case ByteCodeInstruction::kStoreGlobal4: {
                ...
                if (skvx::all(m)) {
                    ...
                    for (int lane = 0; lane < 4; ++lane) {
                        if (m[lane]) {
                            fGlobals[*ip + 3].fUnsigned[lane] = tmp[0][lane];
                            fGlobals[*ip + 2].fUnsigned[lane] = tmp[1][lane];
                            fGlobals[*ip + 1].fUnsigned[lane] = tmp[2][lane];
                            fGlobals[*ip + 0].fUnsigned[lane] = tmp[3][lane];
                        }
                    }
                }
                ++ip;
            ...
            case ByteCodeInstruction::kStoreGlobal3: {
                ...
                if (skvx::all(m)) {
                    ...
                    for (int lane = 0; lane < 4; ++lane) {
                        if (m[lane]) {
                            fGlobals[*ip + 2].fUnsigned[lane] = tmp[0][lane];
                            fGlobals[*ip + 1].fUnsigned[lane] = tmp[1][lane];
                            fGlobals[*ip + 0].fUnsigned[lane] = tmp[2][lane];
                        }
                    }
                }
                ++ip;
            ...
            case ByteCodeInstruction::kStoreGlobal2: {
                ...
                if (skvx::all(m)) {
                    ...
                    for (int lane = 0; lane < 4; ++lane) {
                        if (m[lane]) {
                            fGlobals[*ip + 1].fUnsigned[lane] = tmp[0][lane];
                            fGlobals[*ip + 0].fUnsigned[lane] = tmp[1][lane];
                        }
                    }
                }
                ++ip;
            ...
            case ByteCodeInstruction::kStoreGlobal: {
                ...
                if (skvx::all(m)) {
                    ...
                    for (int lane = 0; lane < 4; ++lane) {
                        if (m[lane]) {
                            fGlobals[*ip + 0].fUnsigned[lane] = tmp[0][lane];
                        }
                    }
                }
                ++ip;
            ...
            case ByteCodeInstruction::kStoreExtended: {
                ...
                VValue* src = sp - count + 1;
                for (int i = 0; i < count; ++i) {
                    stack[target[0]].fUnsigned[0] = src[i].fUnsigned[0];
                    stack[target[1]].fUnsigned[1] = src[i].fUnsigned[1];
                    stack[target[2]].fUnsigned[2] = src[i].fUnsigned[2];
                    stack[target[3]].fUnsigned[3] = src[i].fUnsigned[3];
                }
                sp -= count;
                break;
            }
            case ByteCodeInstruction::kStoreExtendedGlobal: {
                ...
                VValue* src = sp - count + 1;
                for (int i = 0; i < count; ++i) {
                    fGlobals[target[0]].fUnsigned[0] = src[i].fUnsigned[0];
                    fGlobals[target[1]].fUnsigned[1] = src[i].fUnsigned[1];
                    fGlobals[target[2]].fUnsigned[2] = src[i].fUnsigned[2];
                    fGlobals[target[3]].fUnsigned[3] = src[i].fUnsigned[3];
                }
                sp -= count;
                break;
            }
            ...
            case ByteCodeInstruction::kStoreSwizzleIndirect: {
                ...
                int4 target = POP().fSigned;
                for (int i = count - 1; i >= 0; --i) {
                    uint4 v = POP().fUnsigned;
                    stack[target[0] + *(ip + i)].fUnsigned[0] = v[0];
                    stack[target[1] + *(ip + i)].fUnsigned[1] = v[1];
                    stack[target[2] + *(ip + i)].fUnsigned[2] = v[2];
                    stack[target[3] + *(ip + i)].fUnsigned[3] = v[3];
                }
                ip += count;
                break;
            }
            case ByteCodeInstruction::kStoreSwizzleIndirectGlobal: {
                ...
                for (int i = count - 1; i >= 0; --i) {
                    uint4 v = POP().fUnsigned;
                    fGlobals[target[0] + *(ip + i)].fUnsigned[0] = v[0];
                    fGlobals[target[1] + *(ip + i)].fUnsigned[1] = v[1];
                    fGlobals[target[2] + *(ip + i)].fUnsigned[2] = v[2];
                    fGlobals[target[3] + *(ip + i)].fUnsigned[3] = v[3];
                }
                ip += count;
                break;
            }
