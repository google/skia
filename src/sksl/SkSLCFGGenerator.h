...
struct BasicBlock {
     ...
     * regenerated).
     */
    bool SKSL_WARN_UNUSED_RESULT tryRemoveExpression(std::vector<BasicBlock::Node>::iterator* iter);
     ...
     */
    bool SKSL_WARN_UNUSED_RESULT tryRemoveExpressionBefore(
     ...
     */
    bool SKSL_WARN_UNUSED_RESULT tryRemoveLValueBefore(std::vector<BasicBlock::Node>::iterator* iter,
                                                     Expression* lvalue);
     ...
     */
    bool SKSL_WARN_UNUSED_RESULT tryInsertExpression(std::vector<BasicBlock::Node>::iterator* iter,
