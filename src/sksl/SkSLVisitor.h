...
// FIXME also make sure that sksl sample matrix merging works with the visitor too
// but this seems like a good middle ground in terms of flexibility; not sure it'll work for the
// compiler visiting, but I can leave that to ethan.
