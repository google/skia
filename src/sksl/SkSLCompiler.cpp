...
bool Compiler::toSPIRV(Program& program, OutputStream& out) {
    ...
    if (result && program.fSettings.fValidateSPIRV) {
        ...
        // explaining the error. In standalone mode (unit tests), we will send the message, plus
        // the entire disassembled SPIR-V (for easier context & debugging) as *our* error message.
