...
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(0, 0) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(1, 0) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(2, 0) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(3, 0) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(4, 0) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(0, 1) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(1, 1) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(2, 1) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(3, 1) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(4, 1) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(0, 2) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(1, 2) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(2, 2) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(3, 2) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(4, 2) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(0, 3) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(1, 3) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(2, 3) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(3, 3) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(4, 3) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(0, 4) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(1, 4) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(2, 4) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(3, 4) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        {\n"
...
"                bvec4 outside = bvec4(true);\n"
"                outside.z = (uTexDom_Stage1).x < 0.0;\n"
"                c = any(outside) ? vec4(0.0, 0.0, 0.0, 0.0) : texture(uTextureSampler_0_Stage1, coord + vec2(4, 4) * uImageIncrement_Stage1);\n"
"            }\n"
"            sum += c * k;\n"
"        }\n"
"        output_Stage1 = sum * uGain_Stage1 + uBias_Stage1;\n"
"        output_Stage1.a = clamp(output_Stage1.a, 0, 1);\n"
"        output_Stage1.rgb = clamp(output_Stage1.rgb, 0.0, output_Stage1.a);\n"
