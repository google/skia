    ...
    switch (expr->fKind) {
        ...
        case Expression::kTernary_Kind: {
            ...
            if (t->fTest.expressionNode().fKind == Expression::kBoolLiteral_Kind) {
                ...
                *outUpdated = true;
                printf("rescan: simplifyExpression 2\n");
                *outNeedsRescan = true;
            }
            break;
        }
    ...
    switch (stmt.fKind) {
            ...
            if (((Variable&) varDecl.fVar.node()).dead() &&
                ...
                if (varDecl.fValue) {
                    ...
                    if (!b.tryRemoveExpressionBefore(iter, varDecl.fValue)) {
                        printf("rescan: simplifyStatement 1\n");
                        *outNeedsRescan = true;
                    }
                }
        ...
        case Statement::kIf_Kind: {
            ...
            if (i.fTest.expressionNode().fKind == Expression::kBoolLiteral_Kind) {
                ...
                *outUpdated = true;
                printf("rescan: simplifyStatement 2\n");
                *outNeedsRescan = true;
                break;
            }
            if (i.fIfFalse && i.fIfFalse.statementNode().isEmpty()) {
                ...
                *outUpdated = true;
                printf("rescan: simplifyStatement 3\n");
                *outNeedsRescan = true;
            }
        ...
        case Statement::kSwitch_Kind: {
            ...
            if (s.fValue.expressionNode().isConstant()) {
                ...
                *outUpdated = true;
                printf("rescan: simplifyStatement 5\n");
                *outNeedsRescan = true;
            }
            break;
        }
