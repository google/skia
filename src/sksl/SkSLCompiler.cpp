...
// TODO(skia:11319): Set these flags to `false` to disable optimization passes unilaterally.
// Meant to allow tools like Viewer or Nanobench to override compiler ProgramSettings.
