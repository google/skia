        ...
        bool visitStatementPtr(std::unique_ptr<Statement>& stmt) override {
            ...
            switch (stmt->kind()) {
                ...
                case Statement::Kind::kContinue:
                    // We found a loop exit on this path.
                ...
                case Statement::Kind::kFor: {
                    // These statements are loops and enclose an inner section of code. We don't
                    // allow exits to propagate outside of loops, since we treat break and continue
                    // as exits.
                    fFoundLoopExit.push(false);
                ...
                case Statement::Kind::kIf: {
                    ...
                    // If both sides exit, the exit is allowed to propagate out.
                ...
                case Statement::Kind::kSwitchCase:
                    // We ignore switch statements entirely when scanning for dead code. Their
