                        ...
                        case Expression::kTernary_Kind: {
                            ...
                            if (t->fTest->fKind == Expression::kBoolLiteral_Kind) {
                                ...
                                if (((BoolLiteral&) *t->fTest).fValue) {
                                    iter->fExpression->reset(t->fIfTrue.release());
                                    updated = true;
                                    needsRescan = true;
                                } else {
                                    iter->fExpression->reset(t->fIfFalse.release());
                                    updated = true;
                                    needsRescan = true;
                                }
                            }
                                ...
                                if (assignment_to_dead_var(bin)) {
                                    if (bin.fRight->hasSideEffects()) {
                                        ...
                                        if (bin.fOperator == Token::EQ) {
                                            if (!cfg.tryRemoveLValueBefore(&b, &iter,
                                                                           bin.fLeft.get())) {
                                                needsRescan = true;
                                            }
                                        } else if (!cfg.tryRemoveExpressionBefore(
                                                                                 &b, &iter,
                                                                                 bin.fLeft.get())) {
                                            needsRescan = true;
                                        }
