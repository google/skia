...
public:
    ...
    DSLParser(Compiler* compiler, ProgramKind kind, const char* text, size_t length);
...
private:
    ...
    std::optional<dsl::DSLStatement> varDeclarationsOrExpressionStatement();

    std::optional<dsl::DSLStatement> varDeclarations();

    ASTNode::ID structDeclaration();

    ASTNode::ID structVarDeclaration(Modifiers modifiers);

    std::optional<dsl::DSLStatement> varDeclarationEnd(dsl::DSLModifiers modifiers,
                                                       dsl::DSLType type,
                                                       StringFragment name);

    std::optional<dsl::DSLWrapper<dsl::DSLVar>> parameter();
    ...
    std::optional<dsl::DSLStatement> statement();

    std::optional<dsl::DSLType> type();

    ASTNode::ID interfaceBlock(Modifiers mods);

    std::optional<dsl::DSLStatement> ifStatement();

    std::optional<dsl::DSLStatement> doStatement();

    std::optional<dsl::DSLStatement> whileStatement();

    std::optional<dsl::DSLStatement> forStatement();

    std::optional<dsl::DSLCase> switchCase();

    std::optional<dsl::DSLStatement> switchStatement();

    std::optional<dsl::DSLStatement> returnStatement();

    std::optional<dsl::DSLStatement> breakStatement();

    std::optional<dsl::DSLStatement> continueStatement();

    std::optional<dsl::DSLStatement> discardStatement();

    std::optional<dsl::DSLBlock> block();

    std::optional<dsl::DSLStatement> expressionStatement();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> expression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> assignmentExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> ternaryExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> logicalOrExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> logicalXorExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> logicalAndExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> bitwiseOrExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> bitwiseXorExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> bitwiseAndExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> equalityExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> relationalExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> shiftExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> additiveExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> multiplicativeExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> unaryExpression();

    std::optional<dsl::DSLWrapper<dsl::DSLExpression>> postfixExpression();

    std::optional<dsl::Wrapper<dsl::DSLExpression>> swizzle(int offset,
            std::optional<dsl::Wrapper<dsl::DSLExpression>> base, const char* swizzleMask);

    std::optional<dsl::Wrapper<dsl::DSLExpression>> call(int offset,
            std::optional<dsl::Wrapper<dsl::DSLExpression>> base,
            SkTArray<dsl::Wrapper<dsl::DSLExpression>> args);

    std::optional<dsl::Wrapper<dsl::DSLExpression>> suffix(
            std::optional<dsl::Wrapper<dsl::DSLExpression>> base);

    std::optional<dsl::Wrapper<dsl::DSLExpression>> term();
