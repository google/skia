...
private:
    ...
    SkTArray<dsl::DSLVar> structVarDeclaration(dsl::DSLModifiers modifiers);

    SkTArray<dsl::DSLVar> varDeclarationEnd(dsl::DSLModifiers modifiers, dsl::DSLType type,
                                       StringFragment name);

    skstd::optional<dsl::DSLWrapper<dsl::DSLVar>> parameter();
    ...
    skstd::optional<dsl::Wrapper<dsl::DSLExpression>> swizzle(int offset,
            skstd::optional<dsl::Wrapper<dsl::DSLExpression>> base, const char* swizzleMask);

    skstd::optional<dsl::Wrapper<dsl::DSLExpression>> call(int offset,
            skstd::optional<dsl::Wrapper<dsl::DSLExpression>> base,
            SkTArray<dsl::Wrapper<dsl::DSLExpression>> args);

    skstd::optional<dsl::Wrapper<dsl::DSLExpression>> suffix(
            skstd::optional<dsl::Wrapper<dsl::DSLExpression>> base);
    ...
    static std::unordered_map<StringFragment, LayoutToken>* layoutTokens;

    Compiler& fCompiler;
    const ProgramSettings& fSettings;
    ErrorReporter* fErrorReporter;
    ProgramKind fKind;
