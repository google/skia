...
Context::Context(IRGenerator* irGenerator)
    ...
    , fMat_Type(irGenerator->createNode(new Type(irGenerator, "$mat", { fFloat2x2_Type,  fFloat2x3_Type,
                                   ...
                                   fDouble4x4_Type })))
    , fVec_Type(irGenerator->createNode(new Type(irGenerator, "$vec", { IRNode::ID(), fFloat2_Type,
                                           fFloat3_Type, fFloat4_Type })))
    ...
    , fHVec_Type(irGenerator->createNode(new Type(irGenerator, "$hvec", { IRNode::ID(), fHalf2_Type,
                                     fHalf3_Type, fHalf4_Type })))
    , fDVec_Type(irGenerator->createNode(new Type(irGenerator, "$dvec", { IRNode::ID(), fDouble2_Type,
                                     fDouble3_Type, fDouble4_Type })))
    , fIVec_Type(irGenerator->createNode(new Type(irGenerator, "$ivec", { IRNode::ID(), fInt2_Type,
                                     fInt3_Type, fInt4_Type })))
    , fUVec_Type(irGenerator->createNode(new Type(irGenerator, "$uvec", { IRNode::ID(), fUInt2_Type,
                                     fUInt3_Type, fUInt4_Type })))
    , fSVec_Type(irGenerator->createNode(new Type(irGenerator, "$svec", { IRNode::ID(), fShort2_Type,
                                     fShort3_Type, fShort4_Type })))
    , fUSVec_Type(irGenerator->createNode(new Type(irGenerator, "$usvec", { IRNode::ID(), fUShort2_Type,
                                       fUShort3_Type, fUShort4_Type })))
    , fByteVec_Type(irGenerator->createNode(new Type(irGenerator, "$bytevec", { IRNode::ID(), fByte2_Type,
                                     fByte3_Type, fByte4_Type })))
    , fUByteVec_Type(irGenerator->createNode(new Type(irGenerator, "$ubytevec", { IRNode::ID(), fUByte2_Type,
                                       fUByte3_Type, fUByte4_Type })))
    , fBVec_Type(irGenerator->createNode(new Type(irGenerator, "$bvec", { IRNode::ID(), fBool2_Type,
                                     fBool3_Type, fBool4_Type })))
    ...
    , fDefined_Expression(irGenerator->createNode(new Defined(irGenerator, IRNode::ID()))) {}

IRNode::ID Context::Defined::clone() const {
    return fIRGenerator->createNode(new Defined(fIRGenerator, fType));
}
