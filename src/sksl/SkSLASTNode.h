...
struct ASTNode {
    ...
    Token getToken() const {
        ...
        return *reinterpret_cast<const Token*>(fData.fBytes);
    }
    ...
    Modifiers& getModifiers() {
        ...
        return *reinterpret_cast<Modifiers*>(fData.fBytes);
    }
    ...
    TypeData& getTypeData() {
        ...
        return *reinterpret_cast<TypeData*>(fData.fBytes);
    }

    const TypeData& getTypeData() const {
        SkASSERT(fData.fKind == NodeData::Kind::kTypeData);
        return *reinterpret_cast<const TypeData*>(fData.fBytes);
    }

    ParameterData& getParameterData() {
        SkASSERT(fData.fKind == NodeData::Kind::kParameterData);
        return *reinterpret_cast<ParameterData*>(fData.fBytes);
    }
    ...
    VarData& getVarData() {
        ...
        return *reinterpret_cast<VarData*>(fData.fBytes);
    }
    ...
    FunctionData& getFunctionData() {
        ...
        return *reinterpret_cast<FunctionData*>(fData.fBytes);
    }
    ...
    InterfaceBlockData& getInterfaceBlockData() {
        SkASSERT(fData.fKind == NodeData::Kind::kInterfaceBlockData);
        return *reinterpret_cast<InterfaceBlockData*>(fData.fBytes);
    }
