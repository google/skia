...
struct ASTNode {
    ...
    enum class Kind {
        ...
        kDo,
        // data: name(skstd::string_view), children: enumCases
        kEnum,
        // data: name(skstd::string_view), children: value?
        kEnumCase,
        // data: name(skstd::string_view)
        kExtension,
        // data: field(skstd::string_view), children: base
        kField,
        ...
        kTernary,
        // data: name(skstd::string_view), children: sizes
        kType,
    ...
    struct InterfaceBlockData {
        ...
        InterfaceBlockData(Modifiers modifiers, skstd::string_view typeName, size_t declarationCount,
