...
SkVMGenerator::Slot SkVMGenerator::getSlot(const Expression& e) {
    switch (e.kind()) {
        ...
        case Expression::Kind::kIndex: {
            ...
            // For indexing by a literal, the front-end guarantees that we don't go out of bounds.
            // But with an unrolled loop, it's possible to generate out-of-bounds access. The GLSL
            // spec leaves that behavior undefined - we'll just clamp everything here.
