...
struct Program {
    ...
    bool toSPIRV(SkWStream& out, ErrorReporter& errors);

    bool toSPIRV(SkString* out, ErrorReporter& errors);

    bool toGLSL(SkWStream& out, ErrorReporter& errors);

    bool toGLSL(SkString* out, ErrorReporter& errors);
