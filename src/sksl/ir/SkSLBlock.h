...
public:
    ...
    // An unscoped Block is just a collection of Statements. For a single-statement Block, this will
    // return the Statement as-is; for an empty Block, this returns Nop.
    static std::unique_ptr<Statement> MakeUnscoped(int offset, StatementArray statements);

    // This always makes a real Block object. This is important because many callers rely on Blocks
