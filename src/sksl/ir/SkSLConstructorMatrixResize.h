 ...
 *
 * These always contain exactly 1 matrix of non-matching size, and are never constant. Cells that
 * aren't present in the input matrix are populated with the identity matrix.
 */
