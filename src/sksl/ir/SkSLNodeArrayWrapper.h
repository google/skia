...
public:
    ...
    explicit NodeArrayWrapper(int reserveCount)
    ...
    T& push_back(const T& t) {
        return static_cast<T&>(*fContents.push_back(t));
    }
...
public:
    ...
    explicit ConstNodeArrayWrapper(int reserveCount)
        : fContents(reserveCount) {}
