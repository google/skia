    ...
    switch (intrinsic) {
        ...
        case k_inverse_IntrinsicKind: {
            ...
            switch (arguments[0]->type().slotCount()) {
                ...
                case 16: {
                    SkM44 mat4{M(0, 0), M(1, 0), M(2, 0), M(3, 0),
                    ...
                    return DSLType::Construct(&arguments[0]->type(),
                        mat4.rc(0, 0), mat4.rc(1, 0), mat4.rc(2, 0), mat4.rc(3, 0),
                        mat4.rc(0, 1), mat4.rc(1, 1), mat4.rc(2, 1), mat4.rc(3, 1),
                        mat4.rc(0, 2), mat4.rc(1, 2), mat4.rc(2, 2), mat4.rc(3, 2),
                        mat4.rc(0, 3), mat4.rc(1, 3), mat4.rc(2, 3), mat4.rc(3, 3)
                    ).release();
                }
            }
