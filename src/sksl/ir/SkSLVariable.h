...
public:
    ...
    Variable(int offset, Modifiers::Handle modifiers, StringFragment name, const Type* type,
    ...
    const Modifiers& modifiers() const {
        return this->variableData().fModifiersHandle.get();
    }

    const Modifiers::Handle& modifiersHandle() const {
        return this->variableData().fModifiersHandle;
    }

    void setModifiersHandle(const Modifiers::Handle& handle) {
