...
public:
    ...
    /**
     * For arrays, matrices, and vectors, returns the type of individual cells (e.g. float2 has a
     * component type of kFloat_Type). For all other types, causes an assertion failure.
     */
    ...
    /**
     * For matrices and vectors, returns the number of columns (e.g. both float3x3 and float3 return
     * 3). For scalars, returns 1. For arrays, returns either the size of the array (if known) or
     * -1. For all other types, causes an assertion failure.
     */
    int columns() const {
    ...
    /**
     * For matrices, returns the number of rows (e.g. float2x4 returns 4). For vectors and scalars,
