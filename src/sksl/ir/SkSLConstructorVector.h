...
public:
    ...
    SKSL_FLOAT getFVecComponent(int column) const override;

    SKSL_INT getIVecComponent(int column) const override;

    bool getBVecComponent(int column) const override;
