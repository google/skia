...
SpvId SPIRVCodeGenerator::writeBinaryExpression(const BinaryExpression& b, OutputStream& out) {
    ...
    switch (b.fOperator) {
        case Token::EQEQ: {
            ...
            Type compareType = *fContext.fBool_Type;
            if (Type::kVector_Kind == b.fLeft->fType.kind()) {
                compareType = compareType.toCompound(fContext, b.fLeft->fType.columns(), 1);
            }
            return this->foldToBool(this->writeBinaryOperation(compareType, *operandType, lhs, rhs,
                                                               SpvOpFOrdEqual, SpvOpIEqual,
