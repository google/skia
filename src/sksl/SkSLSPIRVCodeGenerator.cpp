...
SpvId SPIRVCodeGenerator::writeGLSLExtendedInstruction(const Type& type, SpvId floatInst,
...
SpvId SPIRVCodeGenerator::writeSpecialIntrinsic(const FunctionCall& c, SpecialIntrinsic kind,
    ...
    switch (kind) {
        ...
        case kClamp_SpecialIntrinsic: {
            std::vector<SpvId> args = this->vectorize(c.fArguments, out);
            ASSERT(args.size() == 3);
            this->writeGLSLExtendedInstruction(c.fType, GLSLstd450FClamp, GLSLstd450SClamp,
        ...
        case kMax_SpecialIntrinsic: {
            std::vector<SpvId> args = this->vectorize(c.fArguments, out);
            ASSERT(args.size() == 2);
            this->writeGLSLExtendedInstruction(c.fType, GLSLstd450FMax, GLSLstd450SMax,
        ...
        case kMin_SpecialIntrinsic: {
            std::vector<SpvId> args = this->vectorize(c.fArguments, out);
            ASSERT(args.size() == 2);
            this->writeGLSLExtendedInstruction(c.fType, GLSLstd450FMin, GLSLstd450SMin,
        ...
        case kMix_SpecialIntrinsic: {
            std::vector<SpvId> args = this->vectorize(c.fArguments, out);
            ASSERT(args.size() == 3);
            this->writeGLSLExtendedInstruction(c.fType, GLSLstd450FMix, SpvOpUndef, SpvOpUndef,
                                               args, out);
            break;
        }
    }
