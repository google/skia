...
private:
    ...
    // functions which have definitions in the include files. The bool tells us whether this
    // intrinsic has been included already.
    std::map<StringFragment, std::pair<std::unique_ptr<ProgramElement>, bool>> fIntrinsics;
