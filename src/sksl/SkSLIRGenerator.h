...
private:
     ...
     */
    void start(std::unordered_map<std::string, CapValue>* caps);
    ...
    std::unique_ptr<Expression> getCap(Position position, std::string name);
    ...
    const std::unordered_map<std::string, CapValue>* fCapsMap;
