...
protected:
    ...
    virtual bool visitProgramElementPtr(typename T::UniquePtrProgramElement& pe) = 0;
};
...
struct ProgramVisitorTypes {
    ...
    using UniquePtrProgramElement = const std::unique_ptr<SkSL::ProgramElement>;
};
...
struct ProgramWriterTypes {
    ...
    using UniquePtrProgramElement = std::unique_ptr<SkSL::ProgramElement>;
};
