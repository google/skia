...
private:
    ...
    bool visitExpressionPtr(const std::unique_ptr<Expression>& e) override final {
        return this->visitExpression(*e);
    }
    bool visitStatementPtr(const std::unique_ptr<Statement>& s) override final {
        return this->visitStatement(*s);
    }
    bool visitProgramElementPtr(const std::unique_ptr<ProgramElement>& p) override final {
