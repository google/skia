...
public:
    ...
    UniformCTypeMapper(Layout::CType ctype, const std::vector<String>& skslTypes,
            const char* setUniformSingleFormat, const char* setUniformArrayFormat)
        : UniformCTypeMapper(ctype, skslTypes, setUniformSingleFormat, setUniformArrayFormat, false,
                             "", "", "") { }
