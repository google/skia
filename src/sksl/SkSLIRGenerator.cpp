...
static void ensure_scoped_blocks(Statement* stmt) {
    ...
    // represent textually; a must be added for the generated code to match the intent. In the case
    // of Blocks nested inside other Blocks, we add the scope to the outermost block if needed.
