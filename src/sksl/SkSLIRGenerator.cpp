...
void IRGenerator::CheckModifiers(ErrorReporter& errorReporter,
                                 int offset,
                                 const Modifiers& modifiers,
...
void IRGenerator::checkModifiers(int offset,
                                 ...
                                 int permittedModifierFlags,
                                 int permittedLayoutFlags) {
    return CheckModifiers(this->errorReporter(), offset, modifiers, permittedModifierFlags,
...
void IRGenerator::convertFunction(const ASTNode& f) {
    ...
    std::vector<Variable*> parameterPointers;
    for (size_t i = 0; i < funcData.fParameterCount; ++i) {
        ...
        parameters.push_back(std::make_unique<Variable>(param.fOffset,
                                                        fModifiers->addToPool(pd.fModifiers),
                                                        pd.fName,
                                                        type,
                                                        fIsBuiltinCode,
