...
public:
    ...
    bool visitExpression(const Expression& e) override {
        ...
        switch (e.kind()) {
            ...
            // but GLSL allows 'const' variables, because it requires that const variable be
            // initialized with constant-expressions. We could support that usage by checking
            // for variables that are const, and whose initializing expression also passes our
