...
public:
    ...
    virtual bool visitExpression(const Expression& e) override {
        ++fCount;
        return this->INHERITED::visitExpression(e);
    }

    virtual bool visitProgramElement(const ProgramElement& p) override {
        ++fCount;
        return this->INHERITED::visitProgramElement(p);
    }

    virtual bool visitStatement(const Statement& s) override {
        ++fCount;
