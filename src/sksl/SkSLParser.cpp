            ...
            if (token != Token::INVALID_TOKEN) {
                switch (token) {
                    ...
                    case Token::BUILTIN:
                        ...
                        break;
                    case Token::INPUTATTACHMENTINDEX:
                        inputAttachmentIndex = this->layoutInt();
                        break;
                    case Token::ORIGINUPPERLEFT:
                        originUpperLeft = true;
                        break;
                    case Token::OVERRIDECOVERAGE:
                        overrideCoverage = true;
                        break;
                    case Token::BLENDSUPPORTALLEQUATIONS:
                        blendSupportAllEquations = true;
                        break;
                    case Token::PUSHCONSTANT:
                        pushConstant = true;
                        break;
                    case Token::POINTS:
