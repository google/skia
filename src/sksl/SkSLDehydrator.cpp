    ...
    if (s) {
        switch (s->fKind) {
            ...
            case Statement::kIf_Kind: {
                ...
                this->writeU8(Rehydrator::kIfStatement_Command);
            ...
            case Statement::kSwitch_Kind: {
                ...
                this->writeU8(Rehydrator::kSwitchStatement_Command);
            ...
            case Statement::kVarDeclaration_Kind: {
                ...
                printf("referencing var %s\n", v.fVar->description().c_str());
