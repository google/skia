...
protected:
    ...
    void writeFunctionRequirementInputs(const FunctionDeclaration& f,
    ...
    String getSwizzleHelper(const FunctionDeclaration& function,
                            const ExpressionArray& arguments,
                            const SkTArray<VariableReference*>& swizzleVars);
