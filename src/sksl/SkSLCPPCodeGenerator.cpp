...
String CPPCodeGenerator::formatRuntimeValue(const Type& type,
    ...
    if (type == *fContext.fFloat2x2_Type || type == *fContext.fHalf2x2_Type ||
        type == *fContext.fFloat2x3_Type || type == *fContext.fHalf2x3_Type ||
        type == *fContext.fFloat2x4_Type || type == *fContext.fHalf2x4_Type ||
        type == *fContext.fFloat3x2_Type || type == *fContext.fHalf3x2_Type ||
        type == *fContext.fFloat3x3_Type || type == *fContext.fHalf3x3_Type ||
        type == *fContext.fFloat3x4_Type || type == *fContext.fHalf3x4_Type ||
        type == *fContext.fFloat4x2_Type || type == *fContext.fHalf4x2_Type ||
        type == *fContext.fFloat4x3_Type || type == *fContext.fHalf4x3_Type ||
        type == *fContext.fFloat4x4_Type || type == *fContext.fHalf4x4_Type) {
