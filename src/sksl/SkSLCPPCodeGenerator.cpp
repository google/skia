                ...
                switch (var.fModifiers.fLayout.fKey) {
                    case Layout::kKey_Key:
                        ...
                        if (var.fType == *fContext.fFloat2_Type) {
                            this->writef("    b->add32(bit_cast<uint32_t>(%s.fX));\n",
                                         HCodeGenerator::FieldName(name).c_str());
                            this->writef("    b->add32(bit_cast<uint32_t>(%s.fY));\n",
                                         HCodeGenerator::FieldName(name).c_str());
                        } else if (var.fType == *fContext.fFloat4_Type) {
                            this->writef("    b->add32(bit_cast<uint32_t>(%s.x()));\n",
                                         HCodeGenerator::FieldName(name).c_str());
                            this->writef("    b->add32(bit_cast<uint32_t>(%s.y()));\n",
                                         HCodeGenerator::FieldName(name).c_str());
                            this->writef("    b->add32(bit_cast<uint32_t>(%s.width()));\n",
                                         HCodeGenerator::FieldName(name).c_str());
                            this->writef("    b->add32(bit_cast<uint32_t>(%s.height()));\n",
                                         HCodeGenerator::FieldName(name).c_str());
                            ...
                            this->writef("    b->add32(bit_cast<uint32_t>(%s));\n",
                                         HCodeGenerator::FieldName(name).c_str());
