...
private:
    ...
    // collapse transition rows with the same transitions to a single row. This is common, as each
    // row represents a character and often there are many characters for which all transitions are
