...
sk_sp<SkSurface> SkSurface::MakeFromBackendTexture(GrContext* context,
    ...
    if (!SkSurface_Gpu::Valid(context->priv().caps(), backendTexture.getBackendFormat())) {
        return nullptr;
    }
...
sk_sp<SkSurface> SkSurface::MakeFromBackendTexture(GrContext* context, const GrBackendTexture& tex,
    ...
    if (!SkSurface_Gpu::Valid(context->priv().caps(), tex.getBackendFormat())) {
        return nullptr;
    }
...
sk_sp<SkSurface> SkSurface::MakeFromBackendRenderTarget(GrContext* context,
    ...
    if (!SkSurface_Gpu::Valid(context->priv().caps(), rt.getBackendFormat())) {
        return nullptr;
    }
