...
sk_sp<SkSurface> SkSurface::MakeRenderTarget(GrContext* context, SkBudgeted budgeted,
                                             ...
                                             bool shouldCreateWithMips) {
    return MakeRenderTarget((GrRecordingContext*)context, budgeted, imageInfo, sampleCount,
                            surfaceOrigin, surfaceProps, shouldCreateWithMips);
}
...
sk_sp<SkSurface> SkSurface::MakeRenderTarget(GrContext* context, SkBudgeted budgeted,
                                             const SkImageInfo& imageInfo) {
    return MakeRenderTarget((GrRecordingContext*) context, budgeted, imageInfo);
}
