...
public:
    ...
    /**
     * Default implementations do a synchronous rescale (if appropriate), read, and callback.
     */
    ...
    virtual void onAsyncRescaleAndReadPixels(SkColorType ct, SkAlphaType at, sk_sp<SkColorSpace> cs,
