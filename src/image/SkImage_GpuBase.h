...
public:
    ...
    sk_sp<GrTextureProxy> asTextureProxyRef1(GrRecordingContext* context) const override {
        // we shouldn't end up calling this
        SkASSERT(false);
        return this->INHERITED::asTextureProxyRef1(context);
    }
    ...
    sk_sp<GrTextureProxy> refPinnedTextureProxy(GrRecordingContext* context,
        ...
        *uniqueID = this->uniqueID();
        return this->asTextureProxyRef1(context);
    }
