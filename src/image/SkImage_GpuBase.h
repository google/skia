...
public:
    ...
    sk_sp<GrTextureProxy> asTextureProxyRef(GrRecordingContext* ctx) const override {
        // we shouldn't end up calling this
        SkASSERT(false);
        return this->INHERITED::asTextureProxyRef(ctx);
    }
    ...
    sk_sp<GrTextureProxy> refPinnedTextureProxy(GrRecordingContext* ctx,
        ...
        *uniqueID = this->uniqueID();
        return this->asTextureProxyRef(ctx);
    }
