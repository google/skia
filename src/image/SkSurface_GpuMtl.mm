...
sk_sp<SkSurface> SkSurface::MakeFromCAMetalLayer(GrContext* context,
    ...
    sk_cf_obj<CAMetalLayer*> metalLayer;
    metalLayer.retain((CAMetalLayer*)layer);
    ...
    sk_sp<GrRenderTargetProxy> proxy = proxyProvider->createLazyRenderTargetProxy(
            [layer, drawable](GrResourceProvider* resourceProvider,
                ...
                sk_cf_obj<id<MTLTexture>> drawableTexture;
                drawableTexture.retain(currentDrawable.texture);
...
sk_sp<SkSurface> SkSurface::MakeFromMTKView(GrContext* context,
    ...
    sk_cf_obj<MTKView*> mtkView;
    mtkView.retain((MTKView*)view);
