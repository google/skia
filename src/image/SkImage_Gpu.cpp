...
#ifdef SK_BUILD_FOR_ANDROID_FRAMEWORK
sk_sp<SkImage> SkImage::MakeFromHardwareBuffer(AHardwareBuffer* graphicBuffer, SkAlphaType at,
                                               sk_sp<SkColorSpace> cs) {
    auto gen = GrAndroidBufferImageGenerator::Make(graphicBuffer, at, cs);
    return SkImage::MakeFromGenerator(std::move(gen));
}
#endif
