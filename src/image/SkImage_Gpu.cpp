...
sk_sp<SkImage> SkImage::makeTextureImage(GrContext* context,
    ...
    auto policy = budgeted == SkBudgeted::kYes ? GrImageCachePolicy::kUncached_Budgeted
                                               : GrImageCachePolicy::kUncached_Unbudgeted;
...
sk_sp<SkImage> SkImage::MakeCrossContextFromPixmap(GrContext* context,
    ...
    GrBitmapTextureMaker bitmapMaker(context, bmp, GrImageCachePolicy::kUncached_Unbudgeted);
