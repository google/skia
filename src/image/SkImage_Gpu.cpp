...
GrSurfaceProxyView SkImage_Gpu::asView(GrRecordingContext* context,
...
sk_sp<SkImage> SkImage_Gpu::onMakeColorTypeAndColorSpace(SkColorType targetCT,
    ...
    auto texFP = GrTextureEffect::Make(this->asView(direct, GrMipmapped(this->hasMipmaps())),
                                       this->alphaType());
...
sk_sp<SkImage> SkImage::makeTextureImage(GrDirectContext* dContext,
    ...
    GrSurfaceProxyView view = as_IB(this)->asView(dContext, mipmapped, policy);
...
bool SkImage::MakeBackendTextureFromSkImage(GrDirectContext* direct,
    ...
    GrSurfaceProxyView view = as_IB(image)->asView(direct, GrMipmapped::kNo);
