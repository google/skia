...
std::unique_ptr<SkCrossContextImageData> SkCrossContextImageData::MakeFromEncoded(
    ...
    std::unique_ptr<GrExternalTextureData> textureData = texture->detachBackendTexture();

    return skstd::make_unique<SkCrossContextImageData>(desc, std::move(textureData),
