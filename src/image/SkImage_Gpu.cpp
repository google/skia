...
sk_sp<SkImage> SkImage::MakeFromYUVTexturesCopy(GrContext* ctx, SkYUVColorSpace colorSpace,
                                                ...
                                                GrSurfaceOrigin origin,
                                                sk_sp<SkColorSpace> imageColorSpace) {
    return SkImage_Gpu::MakeFromYUVTexturesCopyImpl(ctx, colorSpace, false, yuvBackendTextures,
...
sk_sp<SkImage> SkImage::MakeFromYUVTexturesCopy(GrContext* ctx, SkYUVColorSpace colorSpace,
                                                ...
                                                sk_sp<SkColorSpace> imageColorSpace) {
    for (int i = 0; i < 3; ++i) {
        if (yuvSizes[i].fWidth != yuvBackendTextures[i].width() ||
            yuvSizes[i].fHeight != yuvBackendTextures[i].height()) {
            return nullptr;
        }
    }
    return SkImage::MakeFromYUVTexturesCopy(ctx, colorSpace, yuvBackendTextures, origin,
...
sk_sp<SkImage> SkImage::MakeFromNV12TexturesCopy(GrContext* ctx, SkYUVColorSpace colorSpace,
                                                 ...
                                                 GrSurfaceOrigin origin,
                                                 sk_sp<SkColorSpace> imageColorSpace) {
    return SkImage_Gpu::MakeFromYUVTexturesCopyImpl(ctx, colorSpace, true, yuvBackendTextures,
                                                    origin, std::move(imageColorSpace));
}
...
sk_sp<SkImage> SkImage::MakeFromNV12TexturesCopy(GrContext* ctx, SkYUVColorSpace colorSpace,
    ...
    return SkImage_Gpu::MakeFromNV12TexturesCopy(ctx, colorSpace, yuvBackendTextures, origin,
                                                 std::move(imageColorSpace));
}
