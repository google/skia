...
sk_sp<GrTextureProxy> SkImage_GpuBase::MakePromiseImageLazyProxy(
    ...
    public:
        ...
        GrSurfaceProxy::LazyInstantiationResult operator()(GrResourceProvider* resourceProvider) {
            ...
            GrPixelConfig config1 = resourceProvider->caps()->getConfigFromBackendFormat(
                                                                backendTexture.getBackendFormat(),
                                                                fColorType);
            SkASSERT(kUnknown_GrPixelConfig != config1);
            backendTexture.fConfig1 = config1;
    ...
    GrPixelConfig config1 = context->priv().caps()->getConfigFromBackendFormat(
                                                                     backendFormat,
                                                                     colorType);
