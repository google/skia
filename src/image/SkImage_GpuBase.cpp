...
sk_sp<GrTextureProxy> SkImage_GpuBase::MakePromiseImageLazyProxy(
    ...
    private:
        // A Done helper is owned by the IdleContext that is used to call the client's ReleaseProc.
        // The IdleContext is in turn ref'ed by the PromiseLazyInstantiateCallback. Thus, the Done
        // helper's ref count reaches zero and the Done proc is called after the last fulfilled
        // texture is released or the proxy's destructor destroys the lazy callback, whichever comes
        // last.
