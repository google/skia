...
sk_sp<GrTextureProxy> SkImage_GpuBase::MakePromiseImageLazyProxy(
    ...
    public:
        ...
        GrSurfaceProxy::LazyCallbackResult operator()(GrResourceProvider* resourceProvider,
            ...
            if (kDisableCaching) {
                tex = tex = resourceProvider->wrapBackendTexture(
                ...
                // Because we're caching the GrTextureObject we have to use this "idle proc" mechanism to know when it's safe to delete the underlying backend texture.
