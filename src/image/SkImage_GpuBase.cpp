...
sk_sp<GrTextureProxy> SkImage_GpuBase::MakePromiseImageLazyProxy(
     ...
     * like to relax that so that a PromiseImageTexture can be reused with different promise
     * SkImages and without recreating a GrTexture.
     */
    ...
    public:
        ...
        sk_sp<GrSurface> operator()(GrResourceProvider* resourceProvider) {
            ...
            SkDeferredDisplayListRecorder::PromiseImageTexture* promiseTexture =
                    fFulfillProc(fContext);
            if (!promiseTexture) {
