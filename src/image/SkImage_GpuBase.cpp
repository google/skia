...
sk_sp<GrTextureProxy> SkImage_GpuBase::MakePromiseImageLazyProxy(
     ...
     * using GrTexture's idle proc mechanism. If the same PromiseImageTexture is provided for
     ...
     * destroys their PromiseImageTexture we invalidate the key.
     *
    ...
    public:
        ...
        sk_sp<GrSurface> operator()(GrResourceProvider* resourceProvider) {
            ...
            SkDeferredDisplayListRecorder::PromiseImageTexture* promiseTexture = fFulfillProc(fContext);
            if (!promiseTexture) {
