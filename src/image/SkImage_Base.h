...
public:
    ...
    static constexpr auto kDefaultTexGenPolicy = GrImageTexGenPolicy::kDraw;
    virtual GrSurfaceProxyView refView(GrRecordingContext*,
                                       GrMipmapped,
                                       GrImageTexGenPolicy policy = kDefaultTexGenPolicy) const = 0;
