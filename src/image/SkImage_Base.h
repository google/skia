...
public:
     ...
     */
    virtual void onAsyncRescaleAndReadPixels(GrDirectContext*,
                                             const SkImageInfo&,
     ...
     */
    virtual void onAsyncRescaleAndReadPixelsYUV420(GrDirectContext*,
                                                   SkYUVColorSpace,
    ...
    // TODO: Remove helpers once users are migrated to new API that takes the powered up contexts.
    GrRecordingContext* recordingContext_deprecated() const;
    GrDirectContext* directContext_deprecated() const;
