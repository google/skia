...
public:
     ...
     * y tile modes. The passed matrix is applies to the coordinates before sampling the image.
     * Optional 'subset' indicates whether the tile modes in should be applied to a subset of the
     * image. Optional 'domain' is a bound on the coordinates of the image that will be required and
     * can be used to optimize the shader if 'subset' is also specified.
     */
