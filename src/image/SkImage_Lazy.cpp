...
bool SkImage_Lazy::lockAsBitmap(SkBitmap* bitmap, const SkImage* client, SkImage::CachingHint chint,
...
bool SkImage_Lazy::getROPixels(SkBitmap* bitmap, SkColorSpace* dstColorSpace,
    ...
    return this->lockAsBitmap(bitmap, this, chint, cacheFormat, cacheInfo);
}
...
sk_sp<GrTextureProxy> SkImage_Lazy::asTextureProxyRef(GrContext* context,
    ...
    GrImageTextureMaker textureMaker(context, this->peekCacherator(), this, kAllow_CachingHint);
