...
void SkImage::asyncRescaleAndReadPixels(const SkImageInfo& info,
    ...
    this->asyncRescaleAndReadPixels(as_IB(this)->directContext_deprecated(),
                                    info,
                                    srcRect,
                                    rescaleGamma,
                                    rescaleQuality,
...
void SkImage::asyncRescaleAndReadPixels(GrDirectContext* context,
    ...
    as_IB(this)->onAsyncRescaleAndReadPixels(context,
                                             info,
                                             srcRect,
                                             rescaleGamma,
                                             rescaleQuality,
...
void SkImage::asyncRescaleAndReadPixelsYUV420(SkYUVColorSpace yuvColorSpace,
                                              ...
                                              ReadPixelsCallback callback,
                                              ReadPixelsContext cbContext) {
    this->asyncRescaleAndReadPixelsYUV420(as_IB(this)->directContext_deprecated(),
                                          yuvColorSpace,
...
void SkImage::asyncRescaleAndReadPixelsYUV420(GrDirectContext* context,
    ...
    as_IB(this)->onAsyncRescaleAndReadPixelsYUV420(context,
                                                   yuvColorSpace,
                                                   std::move(dstColorSpace),
                                                   srcRect,
                                                   dstSize,
...
GrDirectContext* SkImage_Base::directContext_deprecated() const {
#if SK_SUPPORT_GPU
    GrImageContext* ctx = this->context();
    return ctx ? ctx->asDirectContext() : nullptr;
#else
    return nullptr;
#endif
}

void SkImage_Base::onAsyncRescaleAndReadPixels(GrDirectContext*,
                                               const SkImageInfo& info,
...
void SkImage_Base::onAsyncRescaleAndReadPixelsYUV420(GrDirectContext*,
                                                     SkYUVColorSpace,
                                                     sk_sp<SkColorSpace> dstColorSpace,
                                                     const SkIRect& srcRect,
                                                     const SkISize& dstSize,
