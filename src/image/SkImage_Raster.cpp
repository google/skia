...
sk_sp<SkImage> SkMakeImageFromRasterBitmapWithColorSpace(const SkBitmap& bm, sk_sp<SkColorSpace> dstCS,
    ...
    return SkImage::MakeFromGenerator(SkColorSpaceXformImageGenerator::Make(bm, dstCS, cpm));
}
