...
public:
    ...
    sk_sp<SkImage> onMakeWithAssignedColorSpace(sk_sp<SkColorSpace>) const override;
...
sk_sp<SkImage> SkImage_Raster::onMakeWithAssignedColorSpace(sk_sp<SkColorSpace> newCS) const {
