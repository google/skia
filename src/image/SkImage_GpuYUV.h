...
public:
    SkImage_GpuYUV(sk_sp<GrContext>, uint32_t uniqueID, SkAlphaType, SkYUVColorSpace,
                   SkTDArray<sk_sp<GrTextureProxy>>, SkYUVAIndex yuvaIndices[4], SkISize size,
                   sk_sp<SkColorSpace>, SkBudgeted);
    ~SkImage_GpuYUV() override;

    SkImageInfo onImageInfo() const override;
    SkColorType onColorType() const override { return kRGBA_8888_SkColorType; }
...
private:
    ...
    SkTDArray<sk_sp<GrTextureProxy>> fProxies;
