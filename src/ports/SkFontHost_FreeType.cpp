...
FT_Error SkScalerContext_FreeType::setupSize() {
    ...
    printf("Configuring fMatrix22: [ %f %f, %f, %f ]\n", SkFixedToScalar(fMatrix22.xx), SkFixedToScalar(fMatrix22.xy), SkFixedToScalar(fMatrix22.yx), SkFixedToScalar(fMatrix22.yy) );
