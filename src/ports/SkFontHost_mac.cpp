...
static sk_sp<SkTypeface> create_from_desc_and_style(CTFontDescriptorRef desc,
    ...
    bool lost_italic = (style.slant() != SkFontStyle::kUpright_Slant) && !(traits & kCTFontItalicTrait);
    bool lost_bold = (style.weight() >= SkFontStyle::kBold_Weight) && !(traits & kCTFontBoldTrait);
    if (lost_italic || lost_bold) {
        traits |= (lost_italic ? kCTFontTraitItalic : 0) | (lost_bold ? kCTFontBoldTrait : 0);
