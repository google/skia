...
protected:
    ...
    int onGetVariationDesignPosition(SkFontArguments::VariationCoordinate position[]) const override;
...
int SkTypeface_Mac::onGetVariationDesignPosition(SkFontArguments::VariationCoordinate position[], size_t count) const {
    ...
    for (int i = 0; i < axisCount; ++i) {
        ...
        position[i].value = CGToScalar(variationCGFloat);
