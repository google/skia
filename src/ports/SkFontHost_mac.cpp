...
static constexpr const unsigned char kSpiderSymbol_ttf[] = {
...
static bool supports_LCD() {
    static bool gSupportsLCD = []{
        ...
        UniqueCFRef<CGDataProviderRef> data(CGDataProviderCreateWithData(nullptr, kSpiderSymbol_ttf, SK_ARRAY_COUNT(kSpiderSymbol_ttf), nullptr));
        UniqueCFRef<CGFontRef> cgFont(CGFontCreateWithDataProvider(data));
        SkASSERT(cgFont);
        UniqueCFRef<CTFontRef> ctFont(CTFontCreateWithGraphicsFont(cgFont, 16, nullptr, nullptr));
        SkASSERT(ctFont);
