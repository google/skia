...
sk_sp<SkTypeface::LocalizedStrings> SkTypeface_Mac::onCreateFamilyNameIterator() const {
...
sk_sp<SkTypeface::LocalizedStrings> SkTypeface_Mac::onCreateAxisNameIterator(int axis) const {
    // The CGFont variation data does not contain the tag.
    ...
    return sk_make_sp<SkOTUtils::LocalizedStrings_SingleName>(skAxisName, skLanguage);
}

sk_sp<SkTypeface::LocalizedStrings>
SkTypeface_Mac::onCreateVariationDesignInstanceNameIterator(int instance) const {
    // Unable to retrieve variation instance info currently
    // Need to be fixed
    return nullptr;
}
