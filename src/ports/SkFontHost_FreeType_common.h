...
protected:
    ...
    LocalizedStrings* onCreateVariationDesignInstanceNameIterator(int instance) const override;
    LocalizedStrings* onCreatePaletteNameIterator(int palette) const override;
