...
protected:
    ...
    void onCharsToGlyphs(const void* chars, SkTextEncoding encoding,
                         SkGlyphID glyphs[], int glyphCount) const override;
...
void LogFontTypeface::onCharsToGlyphs(const void* chars, SkTextEncoding encoding,
