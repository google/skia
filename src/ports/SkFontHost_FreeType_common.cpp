...
void colrv1_configure_skpaint(FT_Face face, const FT_Color* palette,
    ...
    auto fetch_color_stops = [&face, &palette](std::vector<SkScalar>& stops,
    ...
    switch (colrv1_paint.format) {
        ...
        case FT_COLR_PAINTFORMAT_LINEAR_GRADIENT: {
            ...
            SkPoint p3 = p0 + SkVectorProjection((p1 - p0), perpendicular_to_p2_p0);
            line_positions[1] = p3;
        ...
        case FT_COLR_PAINTFORMAT_RADIAL_GRADIENT: {
            ...
            std::vector<SkScalar> stops;
            std::vector<SkColor> colors;
            fetch_color_stops(stops, colors, colrv1_paint.u.radial_gradient.colorline.color_stop_iterator);
        ...
        case FT_COLR_PAINTFORMAT_SWEEP_GRADIENT: {
            ...
            std::vector<SkScalar> stops;
            std::vector<SkColor> colors;
            fetch_color_stops(stops, colors, colrv1_paint.u.sweep_gradient.colorline.color_stop_iterator);
