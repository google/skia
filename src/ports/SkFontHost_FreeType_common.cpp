...
void colrv1_draw_paint(SkCanvas* canvas,
    ...
    switch (colrv1_paint.format) {
        ...
        case FT_COLR_PAINTFORMAT_LINEAR_GRADIENT: {
            ...
            line_positions[0].fX = SkFixedToScalar(colrv1_paint.u.linear_gradient.p0.x);
            line_positions[0].fY = -SkFixedToScalar(colrv1_paint.u.linear_gradient.p0.y);
            line_positions[1].fX = SkFixedToScalar(colrv1_paint.u.linear_gradient.p1.x);
            line_positions[1].fY = -SkFixedToScalar(colrv1_paint.u.linear_gradient.p1.y);

            SkPoint& p0 = line_positions[0];
            SkPoint& p1 = line_positions[1];
            SkPoint p2;
            p2.set(SkFixedToScalar(colrv1_paint.u.linear_gradient.p2.x),
                   -SkFixedToScalar(colrv1_paint.u.linear_gradient.p2.y));
        ...
        case FT_COLR_PAINTFORMAT_RADIAL_GRADIENT: {
            SkPoint start =
                SkPoint::Make(SkFixedToScalar(colrv1_paint.u.radial_gradient.c0.x),
                              -SkFixedToScalar(colrv1_paint.u.radial_gradient.c0.y));
            SkScalar radius = SkFixedToScalar(colrv1_paint.u.radial_gradient.r0);
            SkPoint end = SkPoint::Make(SkFixedToScalar(colrv1_paint.u.radial_gradient.c1.x),
                                        -SkFixedToScalar(colrv1_paint.u.radial_gradient.c1.y));
            SkScalar end_radius = SkFixedToScalar(colrv1_paint.u.radial_gradient.r1);
