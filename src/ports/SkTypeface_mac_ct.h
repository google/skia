...
// The CG versions require making a copy of the CGRect on the stack.

static inline bool CGRectIsEmpty_inline(const CGRect& rect) {
    return rect.size.width <= 0 || rect.size.height <= 0;
}

static inline CGFloat CGRectGetMinX_inline(const CGRect& rect) {
    return rect.origin.x;
}

static inline CGFloat CGRectGetMaxX_inline(const CGRect& rect) {
    return rect.origin.x + rect.size.width;
}

static inline CGFloat CGRectGetMinY_inline(const CGRect& rect) {
    return rect.origin.y;
}

static inline CGFloat CGRectGetMaxY_inline(const CGRect& rect) {
    return rect.origin.y + rect.size.height;
}

static inline CGFloat CGRectGetWidth_inline(const CGRect& rect) {
    return rect.size.width;
}

static inline CGFloat ScalarToCG(SkScalar scalar) {
...
static inline SkScalar CGToScalar(CGFloat cgFloat) {
    if (sizeof(CGFloat) == sizeof(float)) {
...
static inline float CGToFloat(CGFloat cgFloat) {
    if (sizeof(CGFloat) == sizeof(float)) {
        return cgFloat;
    } else {
        SkASSERT(sizeof(CGFloat) == sizeof(double));
