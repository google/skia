...
MAYBE_MSABI
ABI extern "C" void WRAP(start_pipeline)(size_t dx, size_t dy, size_t xlimit, size_t ylimit,
                                         void** program) {
    ...
    #define STAGE(name, ...)                                                          \
        ...
        ABI extern "C" void WRAP(name)(Params* params, void** program,                \
                                       F r, F g, F b, F a) {                          \
...
#if defined(__i386__) || defined(_M_IX86) || defined(__arm__)
    ABI extern "C" void WRAP(just_return)(Params*, void**, F,F,F,F) {}
#else
    ABI extern "C" void WRAP(just_return)(size_t, void**, size_t,size_t, F,F,F,F, F,F,F,F) {}
#endif
