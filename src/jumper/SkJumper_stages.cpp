...
STAGE(xy_to_2pt_conical_well_behaved, const SkJumper_2PtConicalCtx* ctx) {
    r = sqrt_(r * r + g * g) - r * ctx->fP0; // ctx->p0 = 1/r1
}
...
STAGE(xy_to_2pt_conical_compensate_focal, const SkJumper_2PtConicalCtx* ctx) {
    r = r + ctx->fP1; // ctx->p1 = f
}
