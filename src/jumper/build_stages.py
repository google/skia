...
stages_lowp   = sys.argv[6] if len(sys.argv) > 5 else stages_lowp
generated     = sys.argv[7] if len(sys.argv) > 6 else generated
generated_win = sys.argv[8] if len(sys.argv) > 7 else generated_win
