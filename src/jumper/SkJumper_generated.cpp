...
CODE const uint32_t sk_start_pipeline_aarch64[] = {
  ...
  0xf8408696,                             //ldr           x22, [x20], #8
  0xaa0003f5,                             //mov           x21, x0
  0xaa0203f3,                             //mov           x19, x2
  0x910012a8,                             //add           x8, x21, #0x4
  0xeb13011f,                             //cmp           x8, x19
  0x54000069,                             //b.ls          30 <sk_start_pipeline_aarch64+0x30>  // b.plast
  0xaa1503e0,                             //mov           x0, x21
  0x14000011,                             //b             70 <sk_start_pipeline_aarch64+0x70>
  ...
  0xeb13011f,                             //cmp           x8, x19
  0xaa0003f5,                             //mov           x21, x0
  0x54fffe29,                             //b.ls          30 <sk_start_pipeline_aarch64+0x30>  // b.plast
  0xa9427bf3,                             //ldp           x19, x30, [sp, #32]
  0xa94153f5,                             //ldp           x21, x20, [sp, #16]
  0xf84307f6,                             //ldr           x22, [sp], #48
  0xd65f03c0,                             //ret
};
...
CODE const uint32_t sk_start_pipeline_vfp4[] = {
  ...
  0xe4967004,                             //ldr           r7, [r6], #4
  0xe2840002,                             //add           r0, r4, #2
  0xea00000c,                             //b             50 <sk_start_pipeline_vfp4+0x50>
  ...
  0x9afffff0,                             //bls           1c <sk_start_pipeline_vfp4+0x1c>
  0xe1a00004,                             //mov           r0, r4
  0xe8bd88f0,                             //pop           {r4, r5, r6, r7, fp, pc}
};
...
CODE const uint32_t sk_seed_shader_vfp4[] = {
  ...
  0xf2000da2,                             //vadd.f32      d0, d16, d18
  0xf2803010,                             //vmov.i32      d3, #0
  0xf2804010,                             //vmov.i32      d4, #0
...
CODE const uint32_t sk_set_rgb_vfp4[] = {
  0xe8b11008,                             //ldm           r1!, {r3, ip}
  0xe2832008,                             //add           r2, r3, #8
  0xf4a30c9f,                             //vld1.32       {d0[]}, [r3 :32]
  0xf4a22c9f,                             //vld1.32       {d2[]}, [r2 :32]
  0xe2832004,                             //add           r2, r3, #4
  0xf4a21c9f,                             //vld1.32       {d1[]}, [r2 :32]
  0xe12fff1c,                             //bx            ip
};
...
CODE const uint32_t sk_load_tables_vfp4[] = {
  ...
  0xe0823103,                             //add           r3, r2, r3, lsl #2
  0xe0822105,                             //add           r2, r2, r5, lsl #2
  0xee105b90,                             //vmov.32       r5, d16[0]
  0xedd30a00,                             //vldr          s1, [r3]
  0xee323b90,                             //vmov.32       r3, d18[1]
  0xed920a00,                             //vldr          s0, [r2]
  0xee302b90,                             //vmov.32       r2, d16[1]
  0xf3e80031,                             //vshr.u32      d16, d17, #24
  0xeddf1b0d,                             //vldr          d17, [pc, #52]
  0xf3fb0620,                             //vcvt.f32.s32  d16, d16
  0xf3003db1,                             //vmul.f32      d3, d16, d17
  0xe086e103,                             //add           lr, r6, r3, lsl #2
  0xee123b90,                             //vmov.32       r3, d18[0]
  0xe0842102,                             //add           r2, r4, r2, lsl #2
  0xedde2a00,                             //vldr          s5, [lr]
  0xedd21a00,                             //vldr          s3, [r2]
  0xe0842105,                             //add           r2, r4, r5, lsl #2
  0xed921a00,                             //vldr          s2, [r2]
  0xe0862103,                             //add           r2, r6, r3, lsl #2
  0xed922a00,                             //vldr          s4, [r2]
  0xe8bd4070,                             //pop           {r4, r5, r6, lr}
  0xe12fff1c,                             //bx            ip
  0xe320f000,                             //nop           {0}
  0x3b808081,                             //.word         0x3b808081
  0x3b808081,                             //.word         0x3b808081
...
CODE const uint32_t sk_store_a8_vfp4[] = {
  ...
  0xee10cb90,                             //vmov.32       ip, d16[0]
  0xee303b90,                             //vmov.32       r3, d16[1]
  0xe7e2c000,                             //strb          ip, [r2, r0]!
  0xe5c23001,                             //strb          r3, [r2, #1]
  0xe5912004,                             //ldr           r2, [r1, #4]
  0xe2811008,                             //add           r1, r1, #8
  0xe12fff12,                             //bx            r2
  0xe320f000,                             //nop           {0}
...
CODE const uint32_t sk_load_565_vfp4[] = {
  ...
  0xee803b90,                             //vdup.32       d16, r3
  0xf24411b1,                             //vand          d17, d20, d17
  0xeddf5b0f,                             //vldr          d21, [pc, #60]
  0xf24421b2,                             //vand          d18, d20, d18
  0xf24401b0,                             //vand          d16, d20, d16
  0xeddf4b0a,                             //vldr          d20, [pc, #40]
  0xf3fb2622,                             //vcvt.f32.s32  d18, d18
  0xf3fb0620,                             //vcvt.f32.s32  d16, d16
  0xf3fb1621,                             //vcvt.f32.s32  d17, d17
...
CODE const uint32_t sk_store_f16_vfp4[] = {
  0xeef01b43,                             //vmov.f64      d17, d3
  0xeef03b42,                             //vmov.f64      d19, d2
  0xf2610111,                             //vorr          d16, d1, d1
  ...
  0xe5922000,                             //ldr           r2, [r2]
  0xe0822180,                             //add           r2, r2, r0, lsl #3
  0xf442084f,                             //vst2.16       {d16-d17}, [r2]
  0xe5912004,                             //ldr           r2, [r1, #4]
  0xe2811008,                             //add           r1, r1, #8
  0xe12fff12,                             //bx            r2
};
...
CODE const uint32_t sk_store_f32_vfp4[] = {
  0xe5912000,                             //ldr           r2, [r1]
  0xe5922000,                             //ldr           r2, [r2]
  0xe0822200,                             //add           r2, r2, r0, lsl #4
  0xf402008f,                             //vst4.32       {d0-d3}, [r2]
  0xe5912004,                             //ldr           r2, [r1, #4]
  0xe2811008,                             //add           r1, r1, #8
  0xe12fff12,                             //bx            r2
};
...
CODE const uint32_t sk_matrix_3x4_vfp4[] = {
  0xe8911008,                             //ldm           r1, {r3, ip}
  0xe2811008,                             //add           r1, r1, #8
  0xe2832020,                             //add           r2, r3, #32
  0xf4e23c9f,                             //vld1.32       {d19[]}, [r2 :32]
  0xe283202c,                             //add           r2, r3, #44
  0xf4e20c9f,                             //vld1.32       {d16[]}, [r2 :32]
  0xe283201c,                             //add           r2, r3, #28
  0xf2420c33,                             //vfma.f32      d16, d2, d19
  0xf4e24c9f,                             //vld1.32       {d20[]}, [r2 :32]
  0xe2832018,                             //add           r2, r3, #24
  0xf4e22c9f,                             //vld1.32       {d18[]}, [r2 :32]
  0xe2832024,                             //add           r2, r3, #36
  0xf4e21c9f,                             //vld1.32       {d17[]}, [r2 :32]
  0xe2832028,                             //add           r2, r3, #40
...
CODE const uint32_t sk_matrix_4x5_vfp4[] = {
  ...
  0xe283201c,                             //add           r2, r3, #28
  0xf4e34c9f,                             //vld1.32       {d20[]}, [r3 :32]
  0xf4e25c9f,                             //vld1.32       {d21[]}, [r2 :32]
  0xe283202c,                             //add           r2, r3, #44
  0xf4e26c9f,                             //vld1.32       {d22[]}, [r2 :32]
  0xe283203c,                             //add           r2, r3, #60
  0xf4e27c9f,                             //vld1.32       {d23[]}, [r2 :32]
  0xe283204c,                             //add           r2, r3, #76
  0xf4a23c9f,                             //vld1.32       {d3[]}, [r2 :32]
  0xe2832038,                             //add           r2, r3, #56
  0xf2003cb7,                             //vfma.f32      d3, d16, d23
  0xf4e28c9f,                             //vld1.32       {d24[]}, [r2 :32]
  0xe2832048,                             //add           r2, r3, #72
  0xf4e21c9f,                             //vld1.32       {d17[]}, [r2 :32]
  0xe2832034,                             //add           r2, r3, #52
  0xf2401cb8,                             //vfma.f32      d17, d16, d24
  0xf4e29c9f,                             //vld1.32       {d25[]}, [r2 :32]
  0xe2832030,                             //add           r2, r3, #48
  0xf4e23c9f,                             //vld1.32       {d19[]}, [r2 :32]
  0xe2832040,                             //add           r2, r3, #64
  0xf2023c36,                             //vfma.f32      d3, d2, d22
  0xf4e22c9f,                             //vld1.32       {d18[]}, [r2 :32]
  0xe2832044,                             //add           r2, r3, #68
  ...
  0xf2422c37,                             //vfma.f32      d18, d2, d23
  0xf4e27c9f,                             //vld1.32       {d23[]}, [r2 :32]
  0xf2421c37,                             //vfma.f32      d17, d2, d23
  0xe2832014,                             //add           r2, r3, #20
  0xf2423c30,                             //vfma.f32      d19, d2, d16
  0xf4e20c9f,                             //vld1.32       {d16[]}, [r2 :32]
  0xe2832010,                             //add           r2, r3, #16
  ...
  0xf4e26c9f,                             //vld1.32       {d22[]}, [r2 :32]
  0xf2411c36,                             //vfma.f32      d17, d1, d22
  0xe2832008,                             //add           r2, r3, #8
  ...
  0xf4e24c9f,                             //vld1.32       {d20[]}, [r2 :32]
  0xf2401c30,                             //vfma.f32      d17, d0, d16
  0xf2403c35,                             //vfma.f32      d19, d0, d21
  0xf2003c34,                             //vfma.f32      d3, d0, d20
  0xf22201b2,                             //vorr          d0, d18, d18
  0xf22121b1,                             //vorr          d2, d17, d17
...
CODE const uint8_t sk_start_pipeline_hsw[] = {
  ...
  83,                                     //push          %rbx
  80,                                     //push          %rax
  73,137,212,                             //mov           %rdx,%r12
  72,137,251,                             //mov           %rdi,%rbx
  72,173,                                 //lods          %ds:(%rsi),%rax
  73,137,198,                             //mov           %rax,%r14
  73,137,247,                             //mov           %rsi,%r15
  72,141,67,8,                            //lea           0x8(%rbx),%rax
  76,57,224,                              //cmp           %r12,%rax
  118,5,                                  //jbe           24 <_sk_start_pipeline_hsw+0x24>
  72,137,223,                             //mov           %rbx,%rdi
  235,59,                                 //jmp           5f <_sk_start_pipeline_hsw+0x5f>
  49,210,                                 //xor           %edx,%edx
  ...
  72,137,223,                             //mov           %rbx,%rdi
  76,137,254,                             //mov           %r15,%rsi
  65,255,214,                             //callq         *%r14
  72,141,123,8,                           //lea           0x8(%rbx),%rdi
  72,131,195,16,                          //add           $0x10,%rbx
  76,57,227,                              //cmp           %r12,%rbx
  72,137,251,                             //mov           %rdi,%rbx
  118,197,                                //jbe           24 <_sk_start_pipeline_hsw+0x24>
  76,137,226,                             //mov           %r12,%rdx
  72,41,250,                              //sub           %rdi,%rdx
  116,38,                                 //je            8d <_sk_start_pipeline_hsw+0x8d>
  197,252,87,192,                         //vxorps        %ymm0,%ymm0,%ymm0
  197,244,87,201,                         //vxorps        %ymm1,%ymm1,%ymm1
  197,236,87,210,                         //vxorps        %ymm2,%ymm2,%ymm2
  197,228,87,219,                         //vxorps        %ymm3,%ymm3,%ymm3
  ...
  76,137,254,                             //mov           %r15,%rsi
  65,255,214,                             //callq         *%r14
  76,137,224,                             //mov           %r12,%rax
  72,131,196,8,                           //add           $0x8,%rsp
  91,                                     //pop           %rbx
  65,92,                                  //pop           %r12
  65,94,                                  //pop           %r14
  65,95,                                  //pop           %r15
...
CODE const uint8_t sk_scale_u8_hsw[] = {
  ...
  72,133,210,                             //test          %rdx,%rdx
  117,53,                                 //jne           4a8 <_sk_scale_u8_hsw+0x42>
  ...
  255,224,                                //jmpq          *%rax
  49,201,                                 //xor           %ecx,%ecx
  73,137,209,                             //mov           %rdx,%r9
  69,49,192,                              //xor           %r8d,%r8d
  68,15,182,16,                           //movzbl        (%rax),%r10d
  72,255,192,                             //inc           %rax
  73,211,226,                             //shl           %cl,%r10
  77,9,208,                               //or            %r10,%r8
  72,131,193,8,                           //add           $0x8,%rcx
  73,255,201,                             //dec           %r9
  117,234,                                //jne           4b0 <_sk_scale_u8_hsw+0x4a>
  196,65,249,110,192,                     //vmovq         %r8,%xmm8
  235,170,                                //jmp           477 <_sk_scale_u8_hsw+0x11>
};
...
CODE const uint8_t sk_lerp_u8_hsw[] = {
  ...
  72,1,248,                               //add           %rdi,%rax
  72,133,210,                             //test          %rdx,%rdx
  117,73,                                 //jne           552 <_sk_lerp_u8_hsw+0x56>
  197,123,16,0,                           //vmovsd        (%rax),%xmm8
  196,66,125,49,192,                      //vpmovzxbd     %xmm8,%ymm8
  196,65,124,91,192,                      //vcvtdq2ps     %ymm8,%ymm8
  184,129,128,128,59,                     //mov           $0x3b808081,%eax
  ...
  72,131,193,8,                           //add           $0x8,%rcx
  73,255,201,                             //dec           %r9
  117,234,                                //jne           55a <_sk_lerp_u8_hsw+0x5e>
  196,65,249,110,192,                     //vmovq         %r8,%xmm8
  235,150,                                //jmp           50d <_sk_lerp_u8_hsw+0x11>
};
...
CODE const uint8_t sk_lerp_565_hsw[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  15,133,178,0,0,0,                       //jne           637 <_sk_lerp_565_hsw+0xc0>
  197,250,111,28,120,                     //vmovdqu       (%rax,%rdi,2),%xmm3
  ...
  255,224,                                //jmpq          *%rax
  137,209,                                //mov           %edx,%ecx
  128,225,7,                              //and           $0x7,%cl
  197,225,239,219,                        //vpxor         %xmm3,%xmm3,%xmm3
  254,201,                                //dec           %cl
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  15,135,60,255,255,255,                  //ja            58a <_sk_lerp_565_hsw+0x13>
  76,141,5,67,0,0,0,                      //lea           0x43(%rip),%r8        # 698 <_sk_lerp_565_hsw+0x121>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  197,225,239,219,                        //vpxor         %xmm3,%xmm3,%xmm3
  197,225,196,92,120,12,6,                //vpinsrw       $0x6,0xc(%rax,%rdi,2),%xmm3,%xmm3
  197,225,196,92,120,10,5,                //vpinsrw       $0x5,0xa(%rax,%rdi,2),%xmm3,%xmm3
  197,225,196,92,120,8,4,                 //vpinsrw       $0x4,0x8(%rax,%rdi,2),%xmm3,%xmm3
  197,225,196,92,120,6,3,                 //vpinsrw       $0x3,0x6(%rax,%rdi,2),%xmm3,%xmm3
  197,225,196,92,120,4,2,                 //vpinsrw       $0x2,0x4(%rax,%rdi,2),%xmm3,%xmm3
  197,225,196,92,120,2,1,                 //vpinsrw       $0x1,0x2(%rax,%rdi,2),%xmm3,%xmm3
  197,225,196,28,120,0,                   //vpinsrw       $0x0,(%rax,%rdi,2),%xmm3,%xmm3
  233,243,254,255,255,                    //jmpq          58a <_sk_lerp_565_hsw+0x13>
  144,                                    //nop
  244,                                    //hlt
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_load_tables_hsw[] = {
  72,173,                                 //lods          %ds:(%rsi),%rax
  76,141,4,189,0,0,0,0,                   //lea           0x0(,%rdi,4),%r8
  76,3,0,                                 //add           (%rax),%r8
  72,133,210,                             //test          %rdx,%rdx
  117,118,                                //jne           73c <_sk_load_tables_hsw+0x88>
  196,193,126,111,24,                     //vmovdqu       (%r8),%ymm3
  ...
  196,130,45,146,12,136,                  //vgatherdps    %ymm10,(%r8,%ymm9,4),%ymm1
  ...
  73,199,193,255,255,255,255,             //mov           $0xffffffffffffffff,%r9
  73,211,233,                             //shr           %cl,%r9
  196,193,249,110,193,                    //vmovq         %r9,%xmm0
  196,226,125,33,192,                     //vpmovsxbd     %xmm0,%ymm0
  196,194,125,140,24,                     //vpmaskmovd    (%r8),%ymm0,%ymm3
  233,103,255,255,255,                    //jmpq          6cb <_sk_load_tables_hsw+0x17>
};
...
CODE const uint8_t sk_load_a8_hsw[] = {
  ...
  72,1,248,                               //add           %rdi,%rax
  72,133,210,                             //test          %rdx,%rdx
  117,47,                                 //jne           7a0 <_sk_load_a8_hsw+0x3c>
  ...
  72,131,193,8,                           //add           $0x8,%rcx
  73,255,201,                             //dec           %r9
  117,234,                                //jne           7a8 <_sk_load_a8_hsw+0x44>
  196,193,249,110,192,                    //vmovq         %r8,%xmm0
  235,176,                                //jmp           775 <_sk_load_a8_hsw+0x11>
};
...
CODE const uint8_t sk_store_a8_hsw[] = {
  ...
  197,121,110,193,                        //vmovd         %ecx,%xmm8
  196,66,125,24,192,                      //vbroadcastss  %xmm8,%ymm8
  ...
  72,133,210,                             //test          %rdx,%rdx
  117,9,                                  //jne           7ff <_sk_store_a8_hsw+0x3a>
  197,123,17,4,56,                        //vmovsd        %xmm8,(%rax,%rdi,1)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  137,209,                                //mov           %edx,%ecx
  128,225,7,                              //and           $0x7,%cl
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  119,237,                                //ja            7fb <_sk_store_a8_hsw+0x36>
  196,66,121,48,192,                      //vpmovzxbw     %xmm8,%xmm8
  76,141,5,66,0,0,0,                      //lea           0x42(%rip),%r8        # 85c <_sk_store_a8_hsw+0x97>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  196,99,121,20,68,56,6,12,               //vpextrb       $0xc,%xmm8,0x6(%rax,%rdi,1)
  196,99,121,20,68,56,5,10,               //vpextrb       $0xa,%xmm8,0x5(%rax,%rdi,1)
  196,99,121,20,68,56,4,8,                //vpextrb       $0x8,%xmm8,0x4(%rax,%rdi,1)
  196,99,121,20,68,56,3,6,                //vpextrb       $0x6,%xmm8,0x3(%rax,%rdi,1)
  196,99,121,20,68,56,2,4,                //vpextrb       $0x4,%xmm8,0x2(%rax,%rdi,1)
  196,99,121,20,68,56,1,2,                //vpextrb       $0x2,%xmm8,0x1(%rax,%rdi,1)
  196,99,121,20,4,56,0,                   //vpextrb       $0x0,%xmm8,(%rax,%rdi,1)
  235,159,                                //jmp           7fb <_sk_store_a8_hsw+0x36>
  247,255,                                //idiv          %edi
  255,                                    //(bad)
  255,                                    //(bad)
  239,                                    //out           %eax,(%dx)
...
CODE const uint8_t sk_load_565_hsw[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  15,133,148,0,0,0,                       //jne           91a <_sk_load_565_hsw+0xa2>
  197,250,111,4,120,                      //vmovdqu       (%rax,%rdi,2),%xmm0
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  15,135,90,255,255,255,                  //ja            88b <_sk_load_565_hsw+0x13>
  76,141,5,68,0,0,0,                      //lea           0x44(%rip),%r8        # 97c <_sk_load_565_hsw+0x104>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  197,249,239,192,                        //vpxor         %xmm0,%xmm0,%xmm0
  197,249,196,68,120,12,6,                //vpinsrw       $0x6,0xc(%rax,%rdi,2),%xmm0,%xmm0
  197,249,196,68,120,10,5,                //vpinsrw       $0x5,0xa(%rax,%rdi,2),%xmm0,%xmm0
  197,249,196,68,120,8,4,                 //vpinsrw       $0x4,0x8(%rax,%rdi,2),%xmm0,%xmm0
  197,249,196,68,120,6,3,                 //vpinsrw       $0x3,0x6(%rax,%rdi,2),%xmm0,%xmm0
  197,249,196,68,120,4,2,                 //vpinsrw       $0x2,0x4(%rax,%rdi,2),%xmm0,%xmm0
  197,249,196,68,120,2,1,                 //vpinsrw       $0x1,0x2(%rax,%rdi,2),%xmm0,%xmm0
  197,249,196,4,120,0,                    //vpinsrw       $0x0,(%rax,%rdi,2),%xmm0,%xmm0
  233,17,255,255,255,                     //jmpq          88b <_sk_load_565_hsw+0x13>
  102,144,                                //xchg          %ax,%ax
  243,255,                                //repz          (bad)
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_store_565_hsw[] = {
  ...
  197,121,110,209,                        //vmovd         %ecx,%xmm10
  196,66,125,24,210,                      //vbroadcastss  %xmm10,%ymm10
  ...
  196,66,57,43,193,                       //vpackusdw     %xmm9,%xmm8,%xmm8
  72,133,210,                             //test          %rdx,%rdx
  117,9,                                  //jne           a03 <_sk_store_565_hsw+0x6b>
  197,122,127,4,120,                      //vmovdqu       %xmm8,(%rax,%rdi,2)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  137,209,                                //mov           %edx,%ecx
  128,225,7,                              //and           $0x7,%cl
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  119,237,                                //ja            9ff <_sk_store_565_hsw+0x67>
  76,141,5,67,0,0,0,                      //lea           0x43(%rip),%r8        # a5c <_sk_store_565_hsw+0xc4>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  196,99,121,21,68,120,12,6,              //vpextrw       $0x6,%xmm8,0xc(%rax,%rdi,2)
  196,99,121,21,68,120,10,5,              //vpextrw       $0x5,%xmm8,0xa(%rax,%rdi,2)
  196,99,121,21,68,120,8,4,               //vpextrw       $0x4,%xmm8,0x8(%rax,%rdi,2)
  196,99,121,21,68,120,6,3,               //vpextrw       $0x3,%xmm8,0x6(%rax,%rdi,2)
  196,99,121,21,68,120,4,2,               //vpextrw       $0x2,%xmm8,0x4(%rax,%rdi,2)
  196,99,121,21,68,120,2,1,               //vpextrw       $0x1,%xmm8,0x2(%rax,%rdi,2)
  197,121,126,193,                        //vmovd         %xmm8,%ecx
  102,137,12,120,                         //mov           %cx,(%rax,%rdi,2)
  235,163,                                //jmp           9ff <_sk_store_565_hsw+0x67>
  246,255,                                //idiv          %bh
  255,                                    //(bad)
  255,                                    //(bad)
  238,                                    //out           %al,(%dx)
...
CODE const uint8_t sk_load_8888_hsw[] = {
  ...
  76,3,0,                                 //add           (%rax),%r8
  72,133,210,                             //test          %rdx,%rdx
  117,101,                                //jne           aef <_sk_load_8888_hsw+0x77>
  196,193,126,111,24,                     //vmovdqu       (%r8),%ymm3
  ...
  196,226,125,33,192,                     //vpmovsxbd     %xmm0,%ymm0
  196,194,125,140,24,                     //vpmaskmovd    (%r8),%ymm0,%ymm3
  233,120,255,255,255,                    //jmpq          a8f <_sk_load_8888_hsw+0x17>
};
...
CODE const uint8_t sk_store_8888_hsw[] = {
  ...
  196,65,53,235,192,                      //vpor          %ymm8,%ymm9,%ymm8
  72,133,210,                             //test          %rdx,%rdx
  117,9,                                  //jne           b85 <_sk_store_8888_hsw+0x6e>
  196,65,126,127,0,                       //vmovdqu       %ymm8,(%r8)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  185,8,0,0,0,                            //mov           $0x8,%ecx
  41,209,                                 //sub           %edx,%ecx
  ...
  196,66,53,142,0,                        //vpmaskmovd    %ymm8,%ymm9,(%r8)
  235,215,                                //jmp           b81 <_sk_store_8888_hsw+0x6a>
};
...
CODE const uint8_t sk_load_f16_hsw[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  117,97,                                 //jne           c15 <_sk_load_f16_hsw+0x6b>
  ...
  72,131,250,1,                           //cmp           $0x1,%rdx
  117,6,                                  //jne           c2b <_sk_load_f16_hsw+0x81>
  197,250,126,201,                        //vmovq         %xmm1,%xmm1
  235,30,                                 //jmp           c49 <_sk_load_f16_hsw+0x9f>
  197,241,22,76,248,8,                    //vmovhpd       0x8(%rax,%rdi,8),%xmm1,%xmm1
  72,131,250,3,                           //cmp           $0x3,%rdx
  114,18,                                 //jb            c49 <_sk_load_f16_hsw+0x9f>
  197,251,16,84,248,16,                   //vmovsd        0x10(%rax,%rdi,8),%xmm2
  72,131,250,3,                           //cmp           $0x3,%rdx
  117,19,                                 //jne           c56 <_sk_load_f16_hsw+0xac>
  197,250,126,210,                        //vmovq         %xmm2,%xmm2
  235,46,                                 //jmp           c77 <_sk_load_f16_hsw+0xcd>
  197,225,87,219,                         //vxorpd        %xmm3,%xmm3,%xmm3
  197,233,87,210,                         //vxorpd        %xmm2,%xmm2,%xmm2
  233,117,255,255,255,                    //jmpq          bcb <_sk_load_f16_hsw+0x21>
  197,233,22,84,248,24,                   //vmovhpd       0x18(%rax,%rdi,8),%xmm2,%xmm2
  72,131,250,5,                           //cmp           $0x5,%rdx
  114,21,                                 //jb            c77 <_sk_load_f16_hsw+0xcd>
  197,251,16,92,248,32,                   //vmovsd        0x20(%rax,%rdi,8),%xmm3
  72,131,250,5,                           //cmp           $0x5,%rdx
  117,18,                                 //jne           c80 <_sk_load_f16_hsw+0xd6>
  197,250,126,219,                        //vmovq         %xmm3,%xmm3
  233,84,255,255,255,                     //jmpq          bcb <_sk_load_f16_hsw+0x21>
  197,225,87,219,                         //vxorpd        %xmm3,%xmm3,%xmm3
  233,75,255,255,255,                     //jmpq          bcb <_sk_load_f16_hsw+0x21>
  197,225,22,92,248,40,                   //vmovhpd       0x28(%rax,%rdi,8),%xmm3,%xmm3
  72,131,250,7,                           //cmp           $0x7,%rdx
  15,130,59,255,255,255,                  //jb            bcb <_sk_load_f16_hsw+0x21>
  197,123,16,68,248,48,                   //vmovsd        0x30(%rax,%rdi,8),%xmm8
  233,48,255,255,255,                     //jmpq          bcb <_sk_load_f16_hsw+0x21>
};
...
CODE const uint8_t sk_store_f16_hsw[] = {
  ...
  72,133,210,                             //test          %rdx,%rdx
  117,27,                                 //jne           d00 <_sk_store_f16_hsw+0x65>
...
CODE const uint8_t sk_store_f32_hsw[] = {
  ...
  72,133,210,                             //test          %rdx,%rdx
  117,51,                                 //jne           db0 <_sk_store_f32_hsw+0x69>
  ...
  197,125,17,36,136,                      //vmovupd       %ymm12,(%rax,%rcx,4)
  197,125,17,108,136,32,                  //vmovupd       %ymm13,0x20(%rax,%rcx,4)
  197,125,17,76,136,64,                   //vmovupd       %ymm9,0x40(%rax,%rcx,4)
  197,125,17,68,136,96,                   //vmovupd       %ymm8,0x60(%rax,%rcx,4)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  197,121,17,20,136,                      //vmovupd       %xmm10,(%rax,%rcx,4)
  72,131,250,1,                           //cmp           $0x1,%rdx
  116,241,                                //je            dac <_sk_store_f32_hsw+0x65>
  197,121,17,76,136,16,                   //vmovupd       %xmm9,0x10(%rax,%rcx,4)
  72,131,250,3,                           //cmp           $0x3,%rdx
  114,229,                                //jb            dac <_sk_store_f32_hsw+0x65>
  197,121,17,68,136,32,                   //vmovupd       %xmm8,0x20(%rax,%rcx,4)
  116,221,                                //je            dac <_sk_store_f32_hsw+0x65>
  197,121,17,92,136,48,                   //vmovupd       %xmm11,0x30(%rax,%rcx,4)
  72,131,250,5,                           //cmp           $0x5,%rdx
  114,209,                                //jb            dac <_sk_store_f32_hsw+0x65>
  196,99,125,25,84,136,64,1,              //vextractf128  $0x1,%ymm10,0x40(%rax,%rcx,4)
  116,199,                                //je            dac <_sk_store_f32_hsw+0x65>
  196,99,125,25,76,136,80,1,              //vextractf128  $0x1,%ymm9,0x50(%rax,%rcx,4)
  72,131,250,7,                           //cmp           $0x7,%rdx
  114,185,                                //jb            dac <_sk_store_f32_hsw+0x65>
  196,99,125,25,68,136,96,1,              //vextractf128  $0x1,%ymm8,0x60(%rax,%rcx,4)
  235,175,                                //jmp           dac <_sk_store_f32_hsw+0x65>
};
...
CODE const uint8_t sk_start_pipeline_avx[] = {
  ...
  72,141,67,8,                            //lea           0x8(%rbx),%rax
  76,57,224,                              //cmp           %r12,%rax
  118,5,                                  //jbe           24 <_sk_start_pipeline_avx+0x24>
  72,137,223,                             //mov           %rbx,%rdi
  235,59,                                 //jmp           5f <_sk_start_pipeline_avx+0x5f>
  49,210,                                 //xor           %edx,%edx
  197,252,87,192,                         //vxorps        %ymm0,%ymm0,%ymm0
  197,244,87,201,                         //vxorps        %ymm1,%ymm1,%ymm1
  197,236,87,210,                         //vxorps        %ymm2,%ymm2,%ymm2
  ...
  76,57,227,                              //cmp           %r12,%rbx
  72,137,251,                             //mov           %rdi,%rbx
  118,197,                                //jbe           24 <_sk_start_pipeline_avx+0x24>
  76,137,226,                             //mov           %r12,%rdx
  72,41,250,                              //sub           %rdi,%rdx
  116,38,                                 //je            8d <_sk_start_pipeline_avx+0x8d>
  197,252,87,192,                         //vxorps        %ymm0,%ymm0,%ymm0
  197,244,87,201,                         //vxorps        %ymm1,%ymm1,%ymm1
  197,236,87,210,                         //vxorps        %ymm2,%ymm2,%ymm2
  197,228,87,219,                         //vxorps        %ymm3,%ymm3,%ymm3
...
CODE const uint8_t sk_scale_u8_avx[] = {
  ...
  72,1,248,                               //add           %rdi,%rax
  72,133,210,                             //test          %rdx,%rdx
  117,77,                                 //jne           58b <_sk_scale_u8_avx+0x5a>
  197,123,16,0,                           //vmovsd        (%rax),%xmm8
  ...
  72,131,193,8,                           //add           $0x8,%rcx
  73,255,201,                             //dec           %r9
  117,234,                                //jne           593 <_sk_scale_u8_avx+0x62>
  196,65,249,110,192,                     //vmovq         %r8,%xmm8
  235,146,                                //jmp           542 <_sk_scale_u8_avx+0x11>
};
...
CODE const uint8_t sk_lerp_u8_avx[] = {
  ...
  72,1,248,                               //add           %rdi,%rax
  72,133,210,                             //test          %rdx,%rdx
  117,113,                                //jne           66d <_sk_lerp_u8_avx+0x7e>
  197,123,16,0,                           //vmovsd        (%rax),%xmm8
  196,66,121,49,200,                      //vpmovzxbd     %xmm8,%xmm9
  196,67,121,4,192,229,                   //vpermilps     $0xe5,%xmm8,%xmm8
  196,66,121,49,192,                      //vpmovzxbd     %xmm8,%xmm8
  ...
  72,131,193,8,                           //add           $0x8,%rcx
  73,255,201,                             //dec           %r9
  117,234,                                //jne           675 <_sk_lerp_u8_avx+0x86>
  196,65,249,110,192,                     //vmovq         %r8,%xmm8
  233,107,255,255,255,                    //jmpq          600 <_sk_lerp_u8_avx+0x11>
};
...
CODE const uint8_t sk_lerp_565_avx[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  15,133,249,0,0,0,                       //jne           79c <_sk_lerp_565_avx+0x107>
  197,122,111,4,120,                      //vmovdqu       (%rax,%rdi,2),%xmm8
  197,225,239,219,                        //vpxor         %xmm3,%xmm3,%xmm3
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  15,135,244,254,255,255,                 //ja            6a8 <_sk_lerp_565_avx+0x13>
  76,141,5,69,0,0,0,                      //lea           0x45(%rip),%r8        # 800 <_sk_lerp_565_avx+0x16b>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  197,225,239,219,                        //vpxor         %xmm3,%xmm3,%xmm3
  197,97,196,68,120,12,6,                 //vpinsrw       $0x6,0xc(%rax,%rdi,2),%xmm3,%xmm8
  197,57,196,68,120,10,5,                 //vpinsrw       $0x5,0xa(%rax,%rdi,2),%xmm8,%xmm8
  197,57,196,68,120,8,4,                  //vpinsrw       $0x4,0x8(%rax,%rdi,2),%xmm8,%xmm8
  197,57,196,68,120,6,3,                  //vpinsrw       $0x3,0x6(%rax,%rdi,2),%xmm8,%xmm8
  197,57,196,68,120,4,2,                  //vpinsrw       $0x2,0x4(%rax,%rdi,2),%xmm8,%xmm8
  197,57,196,68,120,2,1,                  //vpinsrw       $0x1,0x2(%rax,%rdi,2),%xmm8,%xmm8
  197,57,196,4,120,0,                     //vpinsrw       $0x0,(%rax,%rdi,2),%xmm8,%xmm8
  233,171,254,255,255,                    //jmpq          6a8 <_sk_lerp_565_avx+0x13>
  15,31,0,                                //nopl          (%rax)
  242,255,                                //repnz         (bad)
  255,                                    //(bad)
  255,                                    //(bad)
  235,255,                                //jmp           805 <_sk_lerp_565_avx+0x170>
  255,                                    //(bad)
  255,228,                                //jmpq          *%rsp
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_load_tables_avx[] = {
  ...
  72,133,210,                             //test          %rdx,%rdx
  15,133,47,2,0,0,                        //jne           a62 <_sk_load_tables_avx+0x246>
  196,65,124,16,4,186,                    //vmovups       (%r10,%rdi,4),%ymm8
  185,255,0,0,0,                          //mov           $0xff,%ecx
  197,249,110,193,                        //vmovd         %ecx,%xmm0
  197,249,112,192,0,                      //vpshufd       $0x0,%xmm0,%xmm0
  196,99,125,24,200,1,                    //vinsertf128   $0x1,%xmm0,%ymm0,%ymm9
  196,193,52,84,192,                      //vandps        %ymm8,%ymm9,%ymm0
  196,193,249,126,192,                    //vmovq         %xmm0,%r8
  69,137,194,                             //mov           %r8d,%r10d
  196,195,249,22,193,1,                   //vpextrq       $0x1,%xmm0,%r9
  69,137,203,                             //mov           %r9d,%r11d
  73,193,233,32,                          //shr           $0x20,%r9
  73,193,232,32,                          //shr           $0x20,%r8
  196,227,125,25,192,1,                   //vextractf128  $0x1,%ymm0,%xmm0
  196,193,249,126,197,                    //vmovq         %xmm0,%r13
  69,137,238,                             //mov           %r13d,%r14d
  196,227,249,22,193,1,                   //vpextrq       $0x1,%xmm0,%rcx
  65,137,204,                             //mov           %ecx,%r12d
  72,193,233,32,                          //shr           $0x20,%rcx
  73,193,237,32,                          //shr           $0x20,%r13
  72,139,88,8,                            //mov           0x8(%rax),%rbx
  76,139,120,16,                          //mov           0x10(%rax),%r15
  196,161,122,16,4,179,                   //vmovss        (%rbx,%r14,4),%xmm0
  196,163,121,33,4,171,16,                //vinsertps     $0x10,(%rbx,%r13,4),%xmm0,%xmm0
  196,161,122,16,12,163,                  //vmovss        (%rbx,%r12,4),%xmm1
  196,227,121,33,193,32,                  //vinsertps     $0x20,%xmm1,%xmm0,%xmm0
  197,250,16,12,139,                      //vmovss        (%rbx,%rcx,4),%xmm1
  196,227,121,33,193,48,                  //vinsertps     $0x30,%xmm1,%xmm0,%xmm0
  196,161,122,16,12,147,                  //vmovss        (%rbx,%r10,4),%xmm1
  196,163,113,33,12,131,16,               //vinsertps     $0x10,(%rbx,%r8,4),%xmm1,%xmm1
  196,161,122,16,28,155,                  //vmovss        (%rbx,%r11,4),%xmm3
  196,227,113,33,203,32,                  //vinsertps     $0x20,%xmm3,%xmm1,%xmm1
  196,161,122,16,28,139,                  //vmovss        (%rbx,%r9,4),%xmm3
  ...
  196,193,249,126,200,                    //vmovq         %xmm1,%r8
  69,137,194,                             //mov           %r8d,%r10d
  196,195,249,22,201,1,                   //vpextrq       $0x1,%xmm1,%r9
  69,137,203,                             //mov           %r9d,%r11d
  73,193,233,32,                          //shr           $0x20,%r9
  73,193,232,32,                          //shr           $0x20,%r8
  196,227,125,25,201,1,                   //vextractf128  $0x1,%ymm1,%xmm1
  196,225,249,126,201,                    //vmovq         %xmm1,%rcx
  65,137,206,                             //mov           %ecx,%r14d
  196,227,249,22,203,1,                   //vpextrq       $0x1,%xmm1,%rbx
  65,137,220,                             //mov           %ebx,%r12d
  72,193,235,32,                          //shr           $0x20,%rbx
  72,193,233,32,                          //shr           $0x20,%rcx
  196,129,122,16,12,183,                  //vmovss        (%r15,%r14,4),%xmm1
  196,195,113,33,12,143,16,               //vinsertps     $0x10,(%r15,%rcx,4),%xmm1,%xmm1
  196,129,122,16,20,167,                  //vmovss        (%r15,%r12,4),%xmm2
  196,227,113,33,202,32,                  //vinsertps     $0x20,%xmm2,%xmm1,%xmm1
  196,193,122,16,20,159,                  //vmovss        (%r15,%rbx,4),%xmm2
  196,227,113,33,202,48,                  //vinsertps     $0x30,%xmm2,%xmm1,%xmm1
  196,129,122,16,20,151,                  //vmovss        (%r15,%r10,4),%xmm2
  196,131,105,33,20,135,16,               //vinsertps     $0x10,(%r15,%r8,4),%xmm2,%xmm2
  196,129,122,16,28,159,                  //vmovss        (%r15,%r11,4),%xmm3
  196,227,105,33,211,32,                  //vinsertps     $0x20,%xmm3,%xmm2,%xmm2
  196,129,122,16,28,143,                  //vmovss        (%r15,%r9,4),%xmm3
  ...
  196,195,249,22,214,1,                   //vpextrq       $0x1,%xmm2,%r14
  69,137,242,                             //mov           %r14d,%r10d
  73,193,238,32,                          //shr           $0x20,%r14
  73,193,232,32,                          //shr           $0x20,%r8
  196,227,125,25,210,1,                   //vextractf128  $0x1,%ymm2,%xmm2
  196,225,249,126,211,                    //vmovq         %xmm2,%rbx
  65,137,219,                             //mov           %ebx,%r11d
  196,227,249,22,209,1,                   //vpextrq       $0x1,%xmm2,%rcx
  65,137,207,                             //mov           %ecx,%r15d
  72,193,233,32,                          //shr           $0x20,%rcx
  72,193,235,32,                          //shr           $0x20,%rbx
  ...
  196,227,105,33,211,32,                  //vinsertps     $0x20,%xmm3,%xmm2,%xmm2
  197,250,16,28,136,                      //vmovss        (%rax,%rcx,4),%xmm3
  ...
  196,161,122,16,20,144,                  //vmovss        (%rax,%r10,4),%xmm2
  196,227,97,33,210,32,                   //vinsertps     $0x20,%xmm2,%xmm3,%xmm2
  196,161,122,16,28,176,                  //vmovss        (%rax,%r14,4),%xmm3
  196,227,105,33,211,48,                  //vinsertps     $0x30,%xmm3,%xmm2,%xmm2
  ...
  65,95,                                  //pop           %r15
  255,224,                                //jmpq          *%rax
  65,137,208,                             //mov           %edx,%r8d
  65,128,224,7,                           //and           $0x7,%r8b
  196,65,60,87,192,                       //vxorps        %ymm8,%ymm8,%ymm8
  65,254,200,                             //dec           %r8b
  69,15,182,192,                          //movzbl        %r8b,%r8d
  65,128,248,6,                           //cmp           $0x6,%r8b
  15,135,186,253,255,255,                 //ja            839 <_sk_load_tables_avx+0x1d>
  76,141,13,138,0,0,0,                    //lea           0x8a(%rip),%r9        # b10 <_sk_load_tables_avx+0x2f4>
  75,99,12,129,                           //movslq        (%r9,%r8,4),%rcx
  76,1,201,                               //add           %r9,%rcx
  255,225,                                //jmpq          *%rcx
  ...
  196,99,61,24,192,1,                     //vinsertf128   $0x1,%xmm0,%ymm8,%ymm8
  196,195,57,34,68,186,12,3,              //vpinsrd       $0x3,0xc(%r10,%rdi,4),%xmm8,%xmm0
  196,99,61,12,192,15,                    //vblendps      $0xf,%ymm0,%ymm8,%ymm8
  196,195,57,34,68,186,8,2,               //vpinsrd       $0x2,0x8(%r10,%rdi,4),%xmm8,%xmm0
  196,99,61,12,192,15,                    //vblendps      $0xf,%ymm0,%ymm8,%ymm8
  196,195,57,34,68,186,4,1,               //vpinsrd       $0x1,0x4(%r10,%rdi,4),%xmm8,%xmm0
  196,99,61,12,192,15,                    //vblendps      $0xf,%ymm0,%ymm8,%ymm8
  196,195,57,34,4,186,0,                  //vpinsrd       $0x0,(%r10,%rdi,4),%xmm8,%xmm0
  196,99,61,12,192,15,                    //vblendps      $0xf,%ymm0,%ymm8,%ymm8
  233,42,253,255,255,                     //jmpq          839 <_sk_load_tables_avx+0x1d>
  144,                                    //nop
  237,                                    //in            (%dx),%eax
  255,                                    //(bad)
  255,                                    //(bad)
  ...
  255,                                    //(bad)
  255,                                    //(bad)
  255,175,255,255,255,155,                //ljmp          *-0x64000001(%rdi)
  255,                                    //(bad)
  255,                                    //(bad)
  255,                                    //(bad)
  127,255,                                //jg            b29 <_sk_load_tables_avx+0x30d>
  255,                                    //(bad)
  255,                                    //.byte         0xff
};
...
CODE const uint8_t sk_load_a8_avx[] = {
  ...
  72,1,248,                               //add           %rdi,%rax
  72,133,210,                             //test          %rdx,%rdx
  117,71,                                 //jne           b80 <_sk_load_a8_avx+0x54>
  197,251,16,0,                           //vmovsd        (%rax),%xmm0
  ...
  72,131,193,8,                           //add           $0x8,%rcx
  73,255,201,                             //dec           %r9
  117,234,                                //jne           b88 <_sk_load_a8_avx+0x5c>
  196,193,249,110,192,                    //vmovq         %r8,%xmm0
  235,152,                                //jmp           b3d <_sk_load_a8_avx+0x11>
};
...
CODE const uint8_t sk_store_a8_avx[] = {
  ...
  196,65,57,103,192,                      //vpackuswb     %xmm8,%xmm8,%xmm8
  72,133,210,                             //test          %rdx,%rdx
  117,9,                                  //jne           be6 <_sk_store_a8_avx+0x41>
  197,123,17,4,56,                        //vmovsd        %xmm8,(%rax,%rdi,1)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  137,209,                                //mov           %edx,%ecx
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  119,237,                                //ja            be2 <_sk_store_a8_avx+0x3d>
  196,66,121,48,192,                      //vpmovzxbw     %xmm8,%xmm8
  76,141,5,67,0,0,0,                      //lea           0x43(%rip),%r8        # c44 <_sk_store_a8_avx+0x9f>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  196,99,121,20,68,56,6,12,               //vpextrb       $0xc,%xmm8,0x6(%rax,%rdi,1)
  ...
  196,99,121,20,68,56,1,2,                //vpextrb       $0x2,%xmm8,0x1(%rax,%rdi,1)
  196,99,121,20,4,56,0,                   //vpextrb       $0x0,%xmm8,(%rax,%rdi,1)
  235,159,                                //jmp           be2 <_sk_store_a8_avx+0x3d>
  144,                                    //nop
  246,255,                                //idiv          %bh
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_load_565_avx[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  15,133,208,0,0,0,                       //jne           d3e <_sk_load_565_avx+0xde>
  197,250,111,4,120,                      //vmovdqu       (%rax,%rdi,2),%xmm0
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  15,135,30,255,255,255,                  //ja            c73 <_sk_load_565_avx+0x13>
  76,141,5,68,0,0,0,                      //lea           0x44(%rip),%r8        # da0 <_sk_load_565_avx+0x140>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  197,249,239,192,                        //vpxor         %xmm0,%xmm0,%xmm0
  ...
  197,249,196,68,120,2,1,                 //vpinsrw       $0x1,0x2(%rax,%rdi,2),%xmm0,%xmm0
  197,249,196,4,120,0,                    //vpinsrw       $0x0,(%rax,%rdi,2),%xmm0,%xmm0
  233,213,254,255,255,                    //jmpq          c73 <_sk_load_565_avx+0x13>
  102,144,                                //xchg          %ax,%ax
  243,255,                                //repz          (bad)
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_store_565_avx[] = {
  ...
  196,66,57,43,193,                       //vpackusdw     %xmm9,%xmm8,%xmm8
  72,133,210,                             //test          %rdx,%rdx
  117,9,                                  //jne           e59 <_sk_store_565_avx+0x9d>
  197,122,127,4,120,                      //vmovdqu       %xmm8,(%rax,%rdi,2)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  137,209,                                //mov           %edx,%ecx
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  119,237,                                //ja            e55 <_sk_store_565_avx+0x99>
  76,141,5,69,0,0,0,                      //lea           0x45(%rip),%r8        # eb4 <_sk_store_565_avx+0xf8>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  196,99,121,21,68,120,12,6,              //vpextrw       $0x6,%xmm8,0xc(%rax,%rdi,2)
  ...
  197,121,126,193,                        //vmovd         %xmm8,%ecx
  102,137,12,120,                         //mov           %cx,(%rax,%rdi,2)
  235,163,                                //jmp           e55 <_sk_store_565_avx+0x99>
  102,144,                                //xchg          %ax,%ax
  244,                                    //hlt
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_load_8888_avx[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  15,133,156,0,0,0,                       //jne           f7a <_sk_load_8888_avx+0xaa>
  197,124,16,12,184,                      //vmovups       (%rax,%rdi,4),%ymm9
  184,255,0,0,0,                          //mov           $0xff,%eax
  197,249,110,192,                        //vmovd         %eax,%xmm0
  197,249,112,192,0,                      //vpshufd       $0x0,%xmm0,%xmm0
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  15,135,81,255,255,255,                  //ja            ee3 <_sk_load_8888_avx+0x13>
  76,141,5,139,0,0,0,                     //lea           0x8b(%rip),%r8        # 1024 <_sk_load_8888_avx+0x154>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  197,249,110,68,184,24,                  //vmovd         0x18(%rax,%rdi,4),%xmm0
  197,249,112,192,68,                     //vpshufd       $0x44,%xmm0,%xmm0
  196,227,125,24,192,1,                   //vinsertf128   $0x1,%xmm0,%ymm0,%ymm0
  197,244,87,201,                         //vxorps        %ymm1,%ymm1,%ymm1
  196,99,117,12,200,64,                   //vblendps      $0x40,%ymm0,%ymm1,%ymm9
  196,99,125,25,200,1,                    //vextractf128  $0x1,%ymm9,%xmm0
  196,227,121,34,68,184,20,1,             //vpinsrd       $0x1,0x14(%rax,%rdi,4),%xmm0,%xmm0
  196,99,53,24,200,1,                     //vinsertf128   $0x1,%xmm0,%ymm9,%ymm9
  196,99,125,25,200,1,                    //vextractf128  $0x1,%ymm9,%xmm0
  196,227,121,34,68,184,16,0,             //vpinsrd       $0x0,0x10(%rax,%rdi,4),%xmm0,%xmm0
  196,99,53,24,200,1,                     //vinsertf128   $0x1,%xmm0,%ymm9,%ymm9
  196,227,49,34,68,184,12,3,              //vpinsrd       $0x3,0xc(%rax,%rdi,4),%xmm9,%xmm0
  196,99,53,12,200,15,                    //vblendps      $0xf,%ymm0,%ymm9,%ymm9
  196,227,49,34,68,184,8,2,               //vpinsrd       $0x2,0x8(%rax,%rdi,4),%xmm9,%xmm0
  196,99,53,12,200,15,                    //vblendps      $0xf,%ymm0,%ymm9,%ymm9
  196,227,49,34,68,184,4,1,               //vpinsrd       $0x1,0x4(%rax,%rdi,4),%xmm9,%xmm0
  196,99,53,12,200,15,                    //vblendps      $0xf,%ymm0,%ymm9,%ymm9
  196,227,49,34,4,184,0,                  //vpinsrd       $0x0,(%rax,%rdi,4),%xmm9,%xmm0
  196,99,53,12,200,15,                    //vblendps      $0xf,%ymm0,%ymm9,%ymm9
  233,194,254,255,255,                    //jmpq          ee3 <_sk_load_8888_avx+0x13>
  15,31,0,                                //nopl          (%rax)
  235,255,                                //jmp           1025 <_sk_load_8888_avx+0x155>
  255,                                    //(bad)
  255,                                    //(bad)
  221,255,                                //(bad)
  255,                                    //(bad)
  ...
  255,                                    //(bad)
  255,                                    //(bad)
  255,173,255,255,255,153,                //ljmp          *-0x66000001(%rbp)
  255,                                    //(bad)
  255,                                    //(bad)
  255,                                    //(bad)
  126,255,                                //jle           103d <_sk_load_8888_avx+0x16d>
  255,                                    //(bad)
  255,                                    //.byte         0xff
};
...
CODE const uint8_t sk_store_8888_avx[] = {
  ...
  196,65,53,86,192,                       //vorpd         %ymm8,%ymm9,%ymm8
  72,133,210,                             //test          %rdx,%rdx
  117,9,                                  //jne           10e3 <_sk_store_8888_avx+0xa3>
  197,124,17,4,184,                       //vmovups       %ymm8,(%rax,%rdi,4)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  137,209,                                //mov           %edx,%ecx
  128,225,7,                              //and           $0x7,%cl
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  119,237,                                //ja            10df <_sk_store_8888_avx+0x9f>
  76,141,5,83,0,0,0,                      //lea           0x53(%rip),%r8        # 114c <_sk_store_8888_avx+0x10c>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  196,67,125,25,193,1,                    //vextractf128  $0x1,%ymm8,%xmm9
  196,99,121,22,76,184,24,2,              //vpextrd       $0x2,%xmm9,0x18(%rax,%rdi,4)
  196,67,125,25,193,1,                    //vextractf128  $0x1,%ymm8,%xmm9
  196,99,121,22,76,184,20,1,              //vpextrd       $0x1,%xmm9,0x14(%rax,%rdi,4)
  196,67,125,25,193,1,                    //vextractf128  $0x1,%ymm8,%xmm9
  197,121,126,76,184,16,                  //vmovd         %xmm9,0x10(%rax,%rdi,4)
  196,99,121,22,68,184,12,3,              //vpextrd       $0x3,%xmm8,0xc(%rax,%rdi,4)
  196,99,121,22,68,184,8,2,               //vpextrd       $0x2,%xmm8,0x8(%rax,%rdi,4)
  196,99,121,22,68,184,4,1,               //vpextrd       $0x1,%xmm8,0x4(%rax,%rdi,4)
  197,121,126,4,184,                      //vmovd         %xmm8,(%rax,%rdi,4)
  235,150,                                //jmp           10df <_sk_store_8888_avx+0x9f>
  15,31,0,                                //nopl          (%rax)
  246,255,                                //idiv          %bh
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_load_f16_avx[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  15,133,8,1,0,0,                         //jne           127e <_sk_load_f16_avx+0x116>
  197,249,16,12,248,                      //vmovupd       (%rax,%rdi,8),%xmm1
  197,249,16,84,248,16,                   //vmovupd       0x10(%rax,%rdi,8),%xmm2
  197,249,16,92,248,32,                   //vmovupd       0x20(%rax,%rdi,8),%xmm3
  197,121,16,68,248,48,                   //vmovupd       0x30(%rax,%rdi,8),%xmm8
  ...
  196,65,57,87,192,                       //vxorpd        %xmm8,%xmm8,%xmm8
  72,131,250,1,                           //cmp           $0x1,%rdx
  117,6,                                  //jne           1294 <_sk_load_f16_avx+0x12c>
  197,250,126,201,                        //vmovq         %xmm1,%xmm1
  235,30,                                 //jmp           12b2 <_sk_load_f16_avx+0x14a>
  197,241,22,76,248,8,                    //vmovhpd       0x8(%rax,%rdi,8),%xmm1,%xmm1
  72,131,250,3,                           //cmp           $0x3,%rdx
  114,18,                                 //jb            12b2 <_sk_load_f16_avx+0x14a>
  197,251,16,84,248,16,                   //vmovsd        0x10(%rax,%rdi,8),%xmm2
  72,131,250,3,                           //cmp           $0x3,%rdx
  117,19,                                 //jne           12bf <_sk_load_f16_avx+0x157>
  197,250,126,210,                        //vmovq         %xmm2,%xmm2
  235,46,                                 //jmp           12e0 <_sk_load_f16_avx+0x178>
  197,225,87,219,                         //vxorpd        %xmm3,%xmm3,%xmm3
  197,233,87,210,                         //vxorpd        %xmm2,%xmm2,%xmm2
  233,206,254,255,255,                    //jmpq          118d <_sk_load_f16_avx+0x25>
  197,233,22,84,248,24,                   //vmovhpd       0x18(%rax,%rdi,8),%xmm2,%xmm2
  72,131,250,5,                           //cmp           $0x5,%rdx
  114,21,                                 //jb            12e0 <_sk_load_f16_avx+0x178>
  197,251,16,92,248,32,                   //vmovsd        0x20(%rax,%rdi,8),%xmm3
  72,131,250,5,                           //cmp           $0x5,%rdx
  117,18,                                 //jne           12e9 <_sk_load_f16_avx+0x181>
  197,250,126,219,                        //vmovq         %xmm3,%xmm3
  233,173,254,255,255,                    //jmpq          118d <_sk_load_f16_avx+0x25>
  197,225,87,219,                         //vxorpd        %xmm3,%xmm3,%xmm3
  233,164,254,255,255,                    //jmpq          118d <_sk_load_f16_avx+0x25>
  197,225,22,92,248,40,                   //vmovhpd       0x28(%rax,%rdi,8),%xmm3,%xmm3
  72,131,250,7,                           //cmp           $0x7,%rdx
  15,130,148,254,255,255,                 //jb            118d <_sk_load_f16_avx+0x25>
  197,123,16,68,248,48,                   //vmovsd        0x30(%rax,%rdi,8),%xmm8
  233,137,254,255,255,                    //jmpq          118d <_sk_load_f16_avx+0x25>
};
...
CODE const uint8_t sk_store_f16_avx[] = {
  ...
  72,133,210,                             //test          %rdx,%rdx
  117,27,                                 //jne           13d6 <_sk_store_f16_avx+0xd2>
  197,120,17,28,248,                      //vmovups       %xmm11,(%rax,%rdi,8)
  197,120,17,84,248,16,                   //vmovups       %xmm10,0x10(%rax,%rdi,8)
  197,120,17,76,248,32,                   //vmovups       %xmm9,0x20(%rax,%rdi,8)
  197,122,127,68,248,48,                  //vmovdqu       %xmm8,0x30(%rax,%rdi,8)
  ...
  197,121,214,28,248,                     //vmovq         %xmm11,(%rax,%rdi,8)
  72,131,250,1,                           //cmp           $0x1,%rdx
  116,241,                                //je            13d2 <_sk_store_f16_avx+0xce>
  197,121,23,92,248,8,                    //vmovhpd       %xmm11,0x8(%rax,%rdi,8)
  72,131,250,3,                           //cmp           $0x3,%rdx
  114,229,                                //jb            13d2 <_sk_store_f16_avx+0xce>
  197,121,214,84,248,16,                  //vmovq         %xmm10,0x10(%rax,%rdi,8)
  116,221,                                //je            13d2 <_sk_store_f16_avx+0xce>
  197,121,23,84,248,24,                   //vmovhpd       %xmm10,0x18(%rax,%rdi,8)
  72,131,250,5,                           //cmp           $0x5,%rdx
  114,209,                                //jb            13d2 <_sk_store_f16_avx+0xce>
  197,121,214,76,248,32,                  //vmovq         %xmm9,0x20(%rax,%rdi,8)
  116,201,                                //je            13d2 <_sk_store_f16_avx+0xce>
  197,121,23,76,248,40,                   //vmovhpd       %xmm9,0x28(%rax,%rdi,8)
  72,131,250,7,                           //cmp           $0x7,%rdx
  114,189,                                //jb            13d2 <_sk_store_f16_avx+0xce>
  197,121,214,68,248,48,                  //vmovq         %xmm8,0x30(%rax,%rdi,8)
  235,181,                                //jmp           13d2 <_sk_store_f16_avx+0xce>
};
...
CODE const uint8_t sk_store_f32_avx[] = {
  ...
  196,65,37,21,220,                       //vunpckhpd     %ymm12,%ymm11,%ymm11
  72,133,210,                             //test          %rdx,%rdx
  117,51,                                 //jne           1486 <_sk_store_f32_avx+0x69>
  196,67,45,24,225,1,                     //vinsertf128   $0x1,%xmm9,%ymm10,%ymm12
  196,67,61,24,235,1,                     //vinsertf128   $0x1,%xmm11,%ymm8,%ymm13
  196,67,45,6,201,49,                     //vperm2f128    $0x31,%ymm9,%ymm10,%ymm9
  196,67,61,6,195,49,                     //vperm2f128    $0x31,%ymm11,%ymm8,%ymm8
  ...
  197,121,17,20,136,                      //vmovupd       %xmm10,(%rax,%rcx,4)
  72,131,250,1,                           //cmp           $0x1,%rdx
  116,241,                                //je            1482 <_sk_store_f32_avx+0x65>
  197,121,17,76,136,16,                   //vmovupd       %xmm9,0x10(%rax,%rcx,4)
  72,131,250,3,                           //cmp           $0x3,%rdx
  114,229,                                //jb            1482 <_sk_store_f32_avx+0x65>
  197,121,17,68,136,32,                   //vmovupd       %xmm8,0x20(%rax,%rcx,4)
  116,221,                                //je            1482 <_sk_store_f32_avx+0x65>
  197,121,17,92,136,48,                   //vmovupd       %xmm11,0x30(%rax,%rcx,4)
  72,131,250,5,                           //cmp           $0x5,%rdx
  114,209,                                //jb            1482 <_sk_store_f32_avx+0x65>
  196,99,125,25,84,136,64,1,              //vextractf128  $0x1,%ymm10,0x40(%rax,%rcx,4)
  116,199,                                //je            1482 <_sk_store_f32_avx+0x65>
  196,99,125,25,76,136,80,1,              //vextractf128  $0x1,%ymm9,0x50(%rax,%rcx,4)
  72,131,250,7,                           //cmp           $0x7,%rdx
  114,185,                                //jb            1482 <_sk_store_f32_avx+0x65>
  196,99,125,25,68,136,96,1,              //vextractf128  $0x1,%ymm8,0x60(%rax,%rcx,4)
  235,175,                                //jmp           1482 <_sk_store_f32_avx+0x65>
};
...
CODE const uint8_t sk_start_pipeline_sse41[] = {
  ...
  76,57,240,                              //cmp           %r14,%rax
  118,5,                                  //jbe           24 <_sk_start_pipeline_sse41+0x24>
  72,137,216,                             //mov           %rbx,%rax
  235,49,                                 //jmp           55 <_sk_start_pipeline_sse41+0x55>
  ...
  76,57,243,                              //cmp           %r14,%rbx
  72,137,195,                             //mov           %rax,%rbx
  118,207,                                //jbe           24 <_sk_start_pipeline_sse41+0x24>
  72,131,196,8,                           //add           $0x8,%rsp
  91,                                     //pop           %rbx
  65,92,                                  //pop           %r12
  65,94,                                  //pop           %r14
...
CODE const uint8_t sk_load_tables_sse41[] = {
  72,173,                                 //lods          %ds:(%rsi),%rax
  72,139,16,                              //mov           (%rax),%rdx
  76,139,64,8,                            //mov           0x8(%rax),%r8
  243,68,15,111,4,186,                    //movdqu        (%rdx,%rdi,4),%xmm8
  186,255,0,0,0,                          //mov           $0xff,%edx
  102,15,110,194,                         //movd          %edx,%xmm0
  102,15,112,192,0,                       //pshufd        $0x0,%xmm0,%xmm0
  ...
  102,72,15,58,22,194,1,                  //pextrq        $0x1,%xmm0,%rdx
  65,137,209,                             //mov           %edx,%r9d
  72,193,234,32,                          //shr           $0x20,%rdx
  102,72,15,126,193,                      //movq          %xmm0,%rcx
  65,137,202,                             //mov           %ecx,%r10d
  72,193,233,32,                          //shr           $0x20,%rcx
  243,67,15,16,4,144,                     //movss         (%r8,%r10,4),%xmm0
  102,65,15,58,33,4,136,16,               //insertps      $0x10,(%r8,%rcx,4),%xmm0
  102,67,15,58,33,4,136,32,               //insertps      $0x20,(%r8,%r9,4),%xmm0
  102,65,15,58,33,4,144,48,               //insertps      $0x30,(%r8,%rdx,4),%xmm0
  72,139,72,16,                           //mov           0x10(%rax),%rcx
  102,72,15,58,22,202,1,                  //pextrq        $0x1,%xmm1,%rdx
  65,137,208,                             //mov           %edx,%r8d
  72,193,234,32,                          //shr           $0x20,%rdx
  102,73,15,126,201,                      //movq          %xmm1,%r9
  69,137,202,                             //mov           %r9d,%r10d
  73,193,233,32,                          //shr           $0x20,%r9
  243,66,15,16,12,145,                    //movss         (%rcx,%r10,4),%xmm1
  102,66,15,58,33,12,137,16,              //insertps      $0x10,(%rcx,%r9,4),%xmm1
  243,66,15,16,28,129,                    //movss         (%rcx,%r8,4),%xmm3
  102,15,58,33,203,32,                    //insertps      $0x20,%xmm3,%xmm1
  243,15,16,28,145,                       //movss         (%rcx,%rdx,4),%xmm3
  102,15,58,33,203,48,                    //insertps      $0x30,%xmm3,%xmm1
  72,139,64,24,                           //mov           0x18(%rax),%rax
  102,72,15,58,22,209,1,                  //pextrq        $0x1,%xmm2,%rcx
  65,137,200,                             //mov           %ecx,%r8d
  72,193,233,32,                          //shr           $0x20,%rcx
  102,72,15,126,210,                      //movq          %xmm2,%rdx
  65,137,209,                             //mov           %edx,%r9d
  72,193,234,32,                          //shr           $0x20,%rdx
  243,66,15,16,20,136,                    //movss         (%rax,%r9,4),%xmm2
  102,15,58,33,20,144,16,                 //insertps      $0x10,(%rax,%rdx,4),%xmm2
...
CODE const uint8_t sk_start_pipeline_sse2[] = {
  ...
  72,141,67,4,                            //lea           0x4(%rbx),%rax
  76,57,240,                              //cmp           %r14,%rax
  118,5,                                  //jbe           24 <_sk_start_pipeline_sse2+0x24>
  72,137,216,                             //mov           %rbx,%rax
  235,49,                                 //jmp           55 <_sk_start_pipeline_sse2+0x55>
  15,87,192,                              //xorps         %xmm0,%xmm0
  15,87,201,                              //xorps         %xmm1,%xmm1
  15,87,210,                              //xorps         %xmm2,%xmm2
  15,87,219,                              //xorps         %xmm3,%xmm3
  ...
  76,57,243,                              //cmp           %r14,%rbx
  72,137,195,                             //mov           %rax,%rbx
  118,207,                                //jbe           24 <_sk_start_pipeline_sse2+0x24>
  72,131,196,8,                           //add           $0x8,%rsp
  91,                                     //pop           %rbx
  65,92,                                  //pop           %r12
  65,94,                                  //pop           %r14
...
CODE const uint8_t sk_load_tables_sse2[] = {
  ...
  102,72,15,126,218,                      //movq          %xmm3,%rdx
  65,137,209,                             //mov           %edx,%r9d
  72,193,234,32,                          //shr           $0x20,%rdx
  102,72,15,126,193,                      //movq          %xmm0,%rcx
  65,137,202,                             //mov           %ecx,%r10d
  72,193,233,32,                          //shr           $0x20,%rcx
  243,65,15,16,28,136,                    //movss         (%r8,%rcx,4),%xmm3
  243,65,15,16,4,144,                     //movss         (%r8,%rdx,4),%xmm0
  ...
  102,72,15,126,202,                      //movq          %xmm1,%rdx
  65,137,208,                             //mov           %edx,%r8d
  72,193,234,32,                          //shr           $0x20,%rdx
  102,77,15,126,201,                      //movq          %xmm9,%r9
  69,137,202,                             //mov           %r9d,%r10d
  73,193,233,32,                          //shr           $0x20,%r9
  243,66,15,16,28,137,                    //movss         (%rcx,%r9,4),%xmm3
  243,15,16,12,145,                       //movss         (%rcx,%rdx,4),%xmm1
  15,20,217,                              //unpcklps      %xmm1,%xmm3
  243,66,15,16,12,145,                    //movss         (%rcx,%r10,4),%xmm1
  243,66,15,16,20,129,                    //movss         (%rcx,%r8,4),%xmm2
  ...
  65,137,200,                             //mov           %ecx,%r8d
  72,193,233,32,                          //shr           $0x20,%rcx
  102,76,15,126,210,                      //movq          %xmm10,%rdx
  65,137,209,                             //mov           %edx,%r9d
  72,193,234,32,                          //shr           $0x20,%rdx
  243,68,15,16,12,144,                    //movss         (%rax,%rdx,4),%xmm9
...
CODE const uint8_t sk_start_pipeline_hsw[] = {
  ...
  87,                                     //push          %rdi
  83,                                     //push          %rbx
  72,129,236,168,0,0,0,                   //sub           $0xa8,%rsp
  ...
  72,141,67,8,                            //lea           0x8(%rbx),%rax
  76,57,224,                              //cmp           %r12,%rax
  118,5,                                  //jbe           70 <_sk_start_pipeline_hsw+0x70>
  72,137,223,                             //mov           %rbx,%rdi
  235,59,                                 //jmp           ab <_sk_start_pipeline_hsw+0xab>
  49,210,                                 //xor           %edx,%edx
  197,252,87,192,                         //vxorps        %ymm0,%ymm0,%ymm0
  197,244,87,201,                         //vxorps        %ymm1,%ymm1,%ymm1
  197,236,87,210,                         //vxorps        %ymm2,%ymm2,%ymm2
  ...
  76,57,227,                              //cmp           %r12,%rbx
  72,137,251,                             //mov           %rdi,%rbx
  118,197,                                //jbe           70 <_sk_start_pipeline_hsw+0x70>
  76,137,226,                             //mov           %r12,%rdx
  72,41,250,                              //sub           %rdi,%rdx
  116,38,                                 //je            d9 <_sk_start_pipeline_hsw+0xd9>
  197,252,87,192,                         //vxorps        %ymm0,%ymm0,%ymm0
  197,244,87,201,                         //vxorps        %ymm1,%ymm1,%ymm1
  197,236,87,210,                         //vxorps        %ymm2,%ymm2,%ymm2
  197,228,87,219,                         //vxorps        %ymm3,%ymm3,%ymm3
  ...
  72,129,196,168,0,0,0,                   //add           $0xa8,%rsp
  91,                                     //pop           %rbx
  95,                                     //pop           %rdi
  94,                                     //pop           %rsi
  65,92,                                  //pop           %r12
...
CODE const uint8_t sk_scale_u8_hsw[] = {
  ...
  72,1,248,                               //add           %rdi,%rax
  72,133,210,                             //test          %rdx,%rdx
  117,53,                                 //jne           53a <_sk_scale_u8_hsw+0x42>
  197,123,16,0,                           //vmovsd        (%rax),%xmm8
  196,66,125,49,192,                      //vpmovzxbd     %xmm8,%ymm8
  196,65,124,91,192,                      //vcvtdq2ps     %ymm8,%ymm8
  184,129,128,128,59,                     //mov           $0x3b808081,%eax
  ...
  72,131,193,8,                           //add           $0x8,%rcx
  73,255,201,                             //dec           %r9
  117,234,                                //jne           542 <_sk_scale_u8_hsw+0x4a>
  196,65,249,110,192,                     //vmovq         %r8,%xmm8
  235,170,                                //jmp           509 <_sk_scale_u8_hsw+0x11>
};
...
CODE const uint8_t sk_lerp_u8_hsw[] = {
  ...
  72,1,248,                               //add           %rdi,%rax
  72,133,210,                             //test          %rdx,%rdx
  117,73,                                 //jne           5e4 <_sk_lerp_u8_hsw+0x56>
  197,123,16,0,                           //vmovsd        (%rax),%xmm8
  196,66,125,49,192,                      //vpmovzxbd     %xmm8,%ymm8
  196,65,124,91,192,                      //vcvtdq2ps     %ymm8,%ymm8
  184,129,128,128,59,                     //mov           $0x3b808081,%eax
  ...
  72,131,193,8,                           //add           $0x8,%rcx
  73,255,201,                             //dec           %r9
  117,234,                                //jne           5ec <_sk_lerp_u8_hsw+0x5e>
  196,65,249,110,192,                     //vmovq         %r8,%xmm8
  235,150,                                //jmp           59f <_sk_lerp_u8_hsw+0x11>
};
...
CODE const uint8_t sk_lerp_565_hsw[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  15,133,178,0,0,0,                       //jne           6c9 <_sk_lerp_565_hsw+0xc0>
  197,250,111,28,120,                     //vmovdqu       (%rax,%rdi,2),%xmm3
  196,98,125,51,195,                      //vpmovzxwd     %xmm3,%ymm8
  184,0,248,0,0,                          //mov           $0xf800,%eax
  197,249,110,216,                        //vmovd         %eax,%xmm3
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  15,135,60,255,255,255,                  //ja            61c <_sk_lerp_565_hsw+0x13>
  76,141,5,69,0,0,0,                      //lea           0x45(%rip),%r8        # 72c <_sk_lerp_565_hsw+0x123>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  197,225,239,219,                        //vpxor         %xmm3,%xmm3,%xmm3
  ...
  197,225,196,92,120,2,1,                 //vpinsrw       $0x1,0x2(%rax,%rdi,2),%xmm3,%xmm3
  197,225,196,28,120,0,                   //vpinsrw       $0x0,(%rax,%rdi,2),%xmm3,%xmm3
  233,243,254,255,255,                    //jmpq          61c <_sk_lerp_565_hsw+0x13>
  15,31,0,                                //nopl          (%rax)
  242,255,                                //repnz         (bad)
  255,                                    //(bad)
  255,                                    //(bad)
  235,255,                                //jmp           731 <_sk_lerp_565_hsw+0x128>
  255,                                    //(bad)
  255,228,                                //jmpq          *%rsp
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_load_tables_hsw[] = {
  ...
  76,3,0,                                 //add           (%rax),%r8
  72,133,210,                             //test          %rdx,%rdx
  117,118,                                //jne           7d0 <_sk_load_tables_hsw+0x88>
  196,193,126,111,24,                     //vmovdqu       (%r8),%ymm3
  185,255,0,0,0,                          //mov           $0xff,%ecx
  197,249,110,193,                        //vmovd         %ecx,%xmm0
  196,226,125,88,208,                     //vpbroadcastd  %xmm0,%ymm2
  ...
  196,226,125,33,192,                     //vpmovsxbd     %xmm0,%ymm0
  196,194,125,140,24,                     //vpmaskmovd    (%r8),%ymm0,%ymm3
  233,103,255,255,255,                    //jmpq          75f <_sk_load_tables_hsw+0x17>
};
...
CODE const uint8_t sk_load_a8_hsw[] = {
  ...
  72,1,248,                               //add           %rdi,%rax
  72,133,210,                             //test          %rdx,%rdx
  117,47,                                 //jne           834 <_sk_load_a8_hsw+0x3c>
  197,251,16,0,                           //vmovsd        (%rax),%xmm0
  196,226,125,49,192,                     //vpmovzxbd     %xmm0,%ymm0
  197,252,91,192,                         //vcvtdq2ps     %ymm0,%ymm0
  184,129,128,128,59,                     //mov           $0x3b808081,%eax
  ...
  72,131,193,8,                           //add           $0x8,%rcx
  73,255,201,                             //dec           %r9
  117,234,                                //jne           83c <_sk_load_a8_hsw+0x44>
  196,193,249,110,192,                    //vmovq         %r8,%xmm0
  235,176,                                //jmp           809 <_sk_load_a8_hsw+0x11>
};
...
CODE const uint8_t sk_store_a8_hsw[] = {
  ...
  196,65,57,103,192,                      //vpackuswb     %xmm8,%xmm8,%xmm8
  72,133,210,                             //test          %rdx,%rdx
  117,9,                                  //jne           893 <_sk_store_a8_hsw+0x3a>
  197,123,17,4,56,                        //vmovsd        %xmm8,(%rax,%rdi,1)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  137,209,                                //mov           %edx,%ecx
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  119,237,                                //ja            88f <_sk_store_a8_hsw+0x36>
  196,66,121,48,192,                      //vpmovzxbw     %xmm8,%xmm8
  76,141,5,66,0,0,0,                      //lea           0x42(%rip),%r8        # 8f0 <_sk_store_a8_hsw+0x97>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  196,99,121,20,68,56,6,12,               //vpextrb       $0xc,%xmm8,0x6(%rax,%rdi,1)
  ...
  196,99,121,20,68,56,1,2,                //vpextrb       $0x2,%xmm8,0x1(%rax,%rdi,1)
  196,99,121,20,4,56,0,                   //vpextrb       $0x0,%xmm8,(%rax,%rdi,1)
  235,159,                                //jmp           88f <_sk_store_a8_hsw+0x36>
  247,255,                                //idiv          %edi
  255,                                    //(bad)
  255,                                    //(bad)
  239,                                    //out           %eax,(%dx)
...
CODE const uint8_t sk_load_565_hsw[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  15,133,148,0,0,0,                       //jne           9ae <_sk_load_565_hsw+0xa2>
  197,250,111,4,120,                      //vmovdqu       (%rax,%rdi,2),%xmm0
  196,226,125,51,208,                     //vpmovzxwd     %xmm0,%ymm2
  184,0,248,0,0,                          //mov           $0xf800,%eax
  197,249,110,192,                        //vmovd         %eax,%xmm0
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  15,135,90,255,255,255,                  //ja            91f <_sk_load_565_hsw+0x13>
  76,141,5,68,0,0,0,                      //lea           0x44(%rip),%r8        # a10 <_sk_load_565_hsw+0x104>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  197,249,239,192,                        //vpxor         %xmm0,%xmm0,%xmm0
  ...
  197,249,196,68,120,2,1,                 //vpinsrw       $0x1,0x2(%rax,%rdi,2),%xmm0,%xmm0
  197,249,196,4,120,0,                    //vpinsrw       $0x0,(%rax,%rdi,2),%xmm0,%xmm0
  233,17,255,255,255,                     //jmpq          91f <_sk_load_565_hsw+0x13>
  102,144,                                //xchg          %ax,%ax
  243,255,                                //repz          (bad)
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_store_565_hsw[] = {
  ...
  196,66,57,43,193,                       //vpackusdw     %xmm9,%xmm8,%xmm8
  72,133,210,                             //test          %rdx,%rdx
  117,9,                                  //jne           a97 <_sk_store_565_hsw+0x6b>
  197,122,127,4,120,                      //vmovdqu       %xmm8,(%rax,%rdi,2)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  137,209,                                //mov           %edx,%ecx
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  119,237,                                //ja            a93 <_sk_store_565_hsw+0x67>
  76,141,5,67,0,0,0,                      //lea           0x43(%rip),%r8        # af0 <_sk_store_565_hsw+0xc4>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  196,99,121,21,68,120,12,6,              //vpextrw       $0x6,%xmm8,0xc(%rax,%rdi,2)
  ...
  197,121,126,193,                        //vmovd         %xmm8,%ecx
  102,137,12,120,                         //mov           %cx,(%rax,%rdi,2)
  235,163,                                //jmp           a93 <_sk_store_565_hsw+0x67>
  246,255,                                //idiv          %bh
  255,                                    //(bad)
  255,                                    //(bad)
  238,                                    //out           %al,(%dx)
...
CODE const uint8_t sk_load_8888_hsw[] = {
  ...
  76,3,0,                                 //add           (%rax),%r8
  72,133,210,                             //test          %rdx,%rdx
  117,101,                                //jne           b83 <_sk_load_8888_hsw+0x77>
  196,193,126,111,24,                     //vmovdqu       (%r8),%ymm3
  184,255,0,0,0,                          //mov           $0xff,%eax
  197,249,110,192,                        //vmovd         %eax,%xmm0
  196,226,125,88,208,                     //vpbroadcastd  %xmm0,%ymm2
  ...
  196,226,125,33,192,                     //vpmovsxbd     %xmm0,%ymm0
  196,194,125,140,24,                     //vpmaskmovd    (%r8),%ymm0,%ymm3
  233,120,255,255,255,                    //jmpq          b23 <_sk_load_8888_hsw+0x17>
};
...
CODE const uint8_t sk_store_8888_hsw[] = {
  ...
  196,65,53,235,192,                      //vpor          %ymm8,%ymm9,%ymm8
  72,133,210,                             //test          %rdx,%rdx
  117,9,                                  //jne           c19 <_sk_store_8888_hsw+0x6e>
  196,65,126,127,0,                       //vmovdqu       %ymm8,(%r8)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  185,8,0,0,0,                            //mov           $0x8,%ecx
  ...
  196,66,125,33,201,                      //vpmovsxbd     %xmm9,%ymm9
  196,66,53,142,0,                        //vpmaskmovd    %ymm8,%ymm9,(%r8)
  235,215,                                //jmp           c15 <_sk_store_8888_hsw+0x6a>
};
...
CODE const uint8_t sk_load_f16_hsw[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  117,97,                                 //jne           ca9 <_sk_load_f16_hsw+0x6b>
  197,249,16,12,248,                      //vmovupd       (%rax,%rdi,8),%xmm1
  197,249,16,84,248,16,                   //vmovupd       0x10(%rax,%rdi,8),%xmm2
  197,249,16,92,248,32,                   //vmovupd       0x20(%rax,%rdi,8),%xmm3
  197,121,16,68,248,48,                   //vmovupd       0x30(%rax,%rdi,8),%xmm8
  ...
  196,65,57,87,192,                       //vxorpd        %xmm8,%xmm8,%xmm8
  72,131,250,1,                           //cmp           $0x1,%rdx
  117,6,                                  //jne           cbf <_sk_load_f16_hsw+0x81>
  197,250,126,201,                        //vmovq         %xmm1,%xmm1
  235,30,                                 //jmp           cdd <_sk_load_f16_hsw+0x9f>
  197,241,22,76,248,8,                    //vmovhpd       0x8(%rax,%rdi,8),%xmm1,%xmm1
  72,131,250,3,                           //cmp           $0x3,%rdx
  114,18,                                 //jb            cdd <_sk_load_f16_hsw+0x9f>
  197,251,16,84,248,16,                   //vmovsd        0x10(%rax,%rdi,8),%xmm2
  72,131,250,3,                           //cmp           $0x3,%rdx
  117,19,                                 //jne           cea <_sk_load_f16_hsw+0xac>
  197,250,126,210,                        //vmovq         %xmm2,%xmm2
  235,46,                                 //jmp           d0b <_sk_load_f16_hsw+0xcd>
  197,225,87,219,                         //vxorpd        %xmm3,%xmm3,%xmm3
  197,233,87,210,                         //vxorpd        %xmm2,%xmm2,%xmm2
  233,117,255,255,255,                    //jmpq          c5f <_sk_load_f16_hsw+0x21>
  197,233,22,84,248,24,                   //vmovhpd       0x18(%rax,%rdi,8),%xmm2,%xmm2
  72,131,250,5,                           //cmp           $0x5,%rdx
  114,21,                                 //jb            d0b <_sk_load_f16_hsw+0xcd>
  197,251,16,92,248,32,                   //vmovsd        0x20(%rax,%rdi,8),%xmm3
  72,131,250,5,                           //cmp           $0x5,%rdx
  117,18,                                 //jne           d14 <_sk_load_f16_hsw+0xd6>
  197,250,126,219,                        //vmovq         %xmm3,%xmm3
  233,84,255,255,255,                     //jmpq          c5f <_sk_load_f16_hsw+0x21>
  197,225,87,219,                         //vxorpd        %xmm3,%xmm3,%xmm3
  233,75,255,255,255,                     //jmpq          c5f <_sk_load_f16_hsw+0x21>
  197,225,22,92,248,40,                   //vmovhpd       0x28(%rax,%rdi,8),%xmm3,%xmm3
  72,131,250,7,                           //cmp           $0x7,%rdx
  15,130,59,255,255,255,                  //jb            c5f <_sk_load_f16_hsw+0x21>
  197,123,16,68,248,48,                   //vmovsd        0x30(%rax,%rdi,8),%xmm8
  233,48,255,255,255,                     //jmpq          c5f <_sk_load_f16_hsw+0x21>
};
...
CODE const uint8_t sk_store_f16_hsw[] = {
  ...
  196,65,57,106,197,                      //vpunpckhdq    %xmm13,%xmm8,%xmm8
  72,133,210,                             //test          %rdx,%rdx
  117,27,                                 //jne           d94 <_sk_store_f16_hsw+0x65>
  197,120,17,28,248,                      //vmovups       %xmm11,(%rax,%rdi,8)
  197,120,17,84,248,16,                   //vmovups       %xmm10,0x10(%rax,%rdi,8)
  197,120,17,76,248,32,                   //vmovups       %xmm9,0x20(%rax,%rdi,8)
  197,122,127,68,248,48,                  //vmovdqu       %xmm8,0x30(%rax,%rdi,8)
  ...
  197,121,214,28,248,                     //vmovq         %xmm11,(%rax,%rdi,8)
  72,131,250,1,                           //cmp           $0x1,%rdx
  116,241,                                //je            d90 <_sk_store_f16_hsw+0x61>
  197,121,23,92,248,8,                    //vmovhpd       %xmm11,0x8(%rax,%rdi,8)
  72,131,250,3,                           //cmp           $0x3,%rdx
  114,229,                                //jb            d90 <_sk_store_f16_hsw+0x61>
  197,121,214,84,248,16,                  //vmovq         %xmm10,0x10(%rax,%rdi,8)
  116,221,                                //je            d90 <_sk_store_f16_hsw+0x61>
  197,121,23,84,248,24,                   //vmovhpd       %xmm10,0x18(%rax,%rdi,8)
  72,131,250,5,                           //cmp           $0x5,%rdx
  114,209,                                //jb            d90 <_sk_store_f16_hsw+0x61>
  197,121,214,76,248,32,                  //vmovq         %xmm9,0x20(%rax,%rdi,8)
  116,201,                                //je            d90 <_sk_store_f16_hsw+0x61>
  197,121,23,76,248,40,                   //vmovhpd       %xmm9,0x28(%rax,%rdi,8)
  72,131,250,7,                           //cmp           $0x7,%rdx
  114,189,                                //jb            d90 <_sk_store_f16_hsw+0x61>
  197,121,214,68,248,48,                  //vmovq         %xmm8,0x30(%rax,%rdi,8)
  235,181,                                //jmp           d90 <_sk_store_f16_hsw+0x61>
};
...
CODE const uint8_t sk_store_f32_hsw[] = {
  ...
  196,65,37,21,220,                       //vunpckhpd     %ymm12,%ymm11,%ymm11
  72,133,210,                             //test          %rdx,%rdx
  117,51,                                 //jne           e44 <_sk_store_f32_hsw+0x69>
  196,67,45,24,225,1,                     //vinsertf128   $0x1,%xmm9,%ymm10,%ymm12
  196,67,61,24,235,1,                     //vinsertf128   $0x1,%xmm11,%ymm8,%ymm13
  196,67,45,6,201,49,                     //vperm2f128    $0x31,%ymm9,%ymm10,%ymm9
  196,67,61,6,195,49,                     //vperm2f128    $0x31,%ymm11,%ymm8,%ymm8
  ...
  197,121,17,20,136,                      //vmovupd       %xmm10,(%rax,%rcx,4)
  72,131,250,1,                           //cmp           $0x1,%rdx
  116,241,                                //je            e40 <_sk_store_f32_hsw+0x65>
  197,121,17,76,136,16,                   //vmovupd       %xmm9,0x10(%rax,%rcx,4)
  72,131,250,3,                           //cmp           $0x3,%rdx
  114,229,                                //jb            e40 <_sk_store_f32_hsw+0x65>
  197,121,17,68,136,32,                   //vmovupd       %xmm8,0x20(%rax,%rcx,4)
  116,221,                                //je            e40 <_sk_store_f32_hsw+0x65>
  197,121,17,92,136,48,                   //vmovupd       %xmm11,0x30(%rax,%rcx,4)
  72,131,250,5,                           //cmp           $0x5,%rdx
  114,209,                                //jb            e40 <_sk_store_f32_hsw+0x65>
  196,99,125,25,84,136,64,1,              //vextractf128  $0x1,%ymm10,0x40(%rax,%rcx,4)
  116,199,                                //je            e40 <_sk_store_f32_hsw+0x65>
  196,99,125,25,76,136,80,1,              //vextractf128  $0x1,%ymm9,0x50(%rax,%rcx,4)
  72,131,250,7,                           //cmp           $0x7,%rdx
  114,185,                                //jb            e40 <_sk_store_f32_hsw+0x65>
  196,99,125,25,68,136,96,1,              //vextractf128  $0x1,%ymm8,0x60(%rax,%rcx,4)
  235,175,                                //jmp           e40 <_sk_store_f32_hsw+0x65>
};
...
CODE const uint8_t sk_start_pipeline_avx[] = {
  ...
  72,141,67,8,                            //lea           0x8(%rbx),%rax
  76,57,224,                              //cmp           %r12,%rax
  118,5,                                  //jbe           70 <_sk_start_pipeline_avx+0x70>
  72,137,223,                             //mov           %rbx,%rdi
  235,59,                                 //jmp           ab <_sk_start_pipeline_avx+0xab>
  49,210,                                 //xor           %edx,%edx
  197,252,87,192,                         //vxorps        %ymm0,%ymm0,%ymm0
  197,244,87,201,                         //vxorps        %ymm1,%ymm1,%ymm1
  197,236,87,210,                         //vxorps        %ymm2,%ymm2,%ymm2
  ...
  76,57,227,                              //cmp           %r12,%rbx
  72,137,251,                             //mov           %rdi,%rbx
  118,197,                                //jbe           70 <_sk_start_pipeline_avx+0x70>
  76,137,226,                             //mov           %r12,%rdx
  72,41,250,                              //sub           %rdi,%rdx
  116,38,                                 //je            d9 <_sk_start_pipeline_avx+0xd9>
  197,252,87,192,                         //vxorps        %ymm0,%ymm0,%ymm0
  197,244,87,201,                         //vxorps        %ymm1,%ymm1,%ymm1
  197,236,87,210,                         //vxorps        %ymm2,%ymm2,%ymm2
  197,228,87,219,                         //vxorps        %ymm3,%ymm3,%ymm3
...
CODE const uint8_t sk_scale_u8_avx[] = {
  ...
  72,1,248,                               //add           %rdi,%rax
  72,133,210,                             //test          %rdx,%rdx
  117,77,                                 //jne           61d <_sk_scale_u8_avx+0x5a>
  197,123,16,0,                           //vmovsd        (%rax),%xmm8
  196,66,121,49,200,                      //vpmovzxbd     %xmm8,%xmm9
  196,67,121,4,192,229,                   //vpermilps     $0xe5,%xmm8,%xmm8
  196,66,121,49,192,                      //vpmovzxbd     %xmm8,%xmm8
  ...
  72,131,193,8,                           //add           $0x8,%rcx
  73,255,201,                             //dec           %r9
  117,234,                                //jne           625 <_sk_scale_u8_avx+0x62>
  196,65,249,110,192,                     //vmovq         %r8,%xmm8
  235,146,                                //jmp           5d4 <_sk_scale_u8_avx+0x11>
};
...
CODE const uint8_t sk_lerp_u8_avx[] = {
  ...
  72,1,248,                               //add           %rdi,%rax
  72,133,210,                             //test          %rdx,%rdx
  117,113,                                //jne           6ff <_sk_lerp_u8_avx+0x7e>
  197,123,16,0,                           //vmovsd        (%rax),%xmm8
  196,66,121,49,200,                      //vpmovzxbd     %xmm8,%xmm9
  196,67,121,4,192,229,                   //vpermilps     $0xe5,%xmm8,%xmm8
  196,66,121,49,192,                      //vpmovzxbd     %xmm8,%xmm8
  ...
  72,131,193,8,                           //add           $0x8,%rcx
  73,255,201,                             //dec           %r9
  117,234,                                //jne           707 <_sk_lerp_u8_avx+0x86>
  196,65,249,110,192,                     //vmovq         %r8,%xmm8
  233,107,255,255,255,                    //jmpq          692 <_sk_lerp_u8_avx+0x11>
};
...
CODE const uint8_t sk_lerp_565_avx[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  15,133,249,0,0,0,                       //jne           82e <_sk_lerp_565_avx+0x107>
  197,122,111,4,120,                      //vmovdqu       (%rax,%rdi,2),%xmm8
  197,225,239,219,                        //vpxor         %xmm3,%xmm3,%xmm3
  197,185,105,219,                        //vpunpckhwd    %xmm3,%xmm8,%xmm3
  196,66,121,51,192,                      //vpmovzxwd     %xmm8,%xmm8
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  15,135,244,254,255,255,                 //ja            73a <_sk_lerp_565_avx+0x13>
  76,141,5,67,0,0,0,                      //lea           0x43(%rip),%r8        # 890 <_sk_lerp_565_avx+0x169>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  197,225,239,219,                        //vpxor         %xmm3,%xmm3,%xmm3
  ...
  197,57,196,68,120,2,1,                  //vpinsrw       $0x1,0x2(%rax,%rdi,2),%xmm8,%xmm8
  197,57,196,4,120,0,                     //vpinsrw       $0x0,(%rax,%rdi,2),%xmm8,%xmm8
  233,171,254,255,255,                    //jmpq          73a <_sk_lerp_565_avx+0x13>
  144,                                    //nop
  244,                                    //hlt
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_load_tables_avx[] = {
  ...
  76,139,16,                              //mov           (%rax),%r10
  72,133,210,                             //test          %rdx,%rdx
  15,133,47,2,0,0,                        //jne           af2 <_sk_load_tables_avx+0x246>
  196,65,124,16,4,186,                    //vmovups       (%r10,%rdi,4),%ymm8
  185,255,0,0,0,                          //mov           $0xff,%ecx
  197,249,110,193,                        //vmovd         %ecx,%xmm0
  197,249,112,192,0,                      //vpshufd       $0x0,%xmm0,%xmm0
  ...
  69,15,182,192,                          //movzbl        %r8b,%r8d
  65,128,248,6,                           //cmp           $0x6,%r8b
  15,135,186,253,255,255,                 //ja            8c9 <_sk_load_tables_avx+0x1d>
  76,141,13,138,0,0,0,                    //lea           0x8a(%rip),%r9        # ba0 <_sk_load_tables_avx+0x2f4>
  75,99,12,129,                           //movslq        (%r9,%r8,4),%rcx
  76,1,201,                               //add           %r9,%rcx
  255,225,                                //jmpq          *%rcx
  196,193,121,110,68,186,24,              //vmovd         0x18(%r10,%rdi,4),%xmm0
  ...
  196,195,57,34,4,186,0,                  //vpinsrd       $0x0,(%r10,%rdi,4),%xmm8,%xmm0
  196,99,61,12,192,15,                    //vblendps      $0xf,%ymm0,%ymm8,%ymm8
  233,42,253,255,255,                     //jmpq          8c9 <_sk_load_tables_avx+0x1d>
  144,                                    //nop
  237,                                    //in            (%dx),%eax
  255,                                    //(bad)
  255,                                    //(bad)
  ...
  255,                                    //(bad)
  255,                                    //(bad)
  127,255,                                //jg            bb9 <_sk_load_tables_avx+0x30d>
  255,                                    //(bad)
  255,                                    //.byte         0xff
};
...
CODE const uint8_t sk_load_a8_avx[] = {
  ...
  72,1,248,                               //add           %rdi,%rax
  72,133,210,                             //test          %rdx,%rdx
  117,71,                                 //jne           c10 <_sk_load_a8_avx+0x54>
  197,251,16,0,                           //vmovsd        (%rax),%xmm0
  196,226,121,49,200,                     //vpmovzxbd     %xmm0,%xmm1
  196,227,121,4,192,229,                  //vpermilps     $0xe5,%xmm0,%xmm0
  196,226,121,49,192,                     //vpmovzxbd     %xmm0,%xmm0
  ...
  72,131,193,8,                           //add           $0x8,%rcx
  73,255,201,                             //dec           %r9
  117,234,                                //jne           c18 <_sk_load_a8_avx+0x5c>
  196,193,249,110,192,                    //vmovq         %r8,%xmm0
  235,152,                                //jmp           bcd <_sk_load_a8_avx+0x11>
};
...
CODE const uint8_t sk_store_a8_avx[] = {
  ...
  196,65,57,103,192,                      //vpackuswb     %xmm8,%xmm8,%xmm8
  72,133,210,                             //test          %rdx,%rdx
  117,9,                                  //jne           c76 <_sk_store_a8_avx+0x41>
  197,123,17,4,56,                        //vmovsd        %xmm8,(%rax,%rdi,1)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  137,209,                                //mov           %edx,%ecx
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  119,237,                                //ja            c72 <_sk_store_a8_avx+0x3d>
  196,66,121,48,192,                      //vpmovzxbw     %xmm8,%xmm8
  76,141,5,67,0,0,0,                      //lea           0x43(%rip),%r8        # cd4 <_sk_store_a8_avx+0x9f>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  196,99,121,20,68,56,6,12,               //vpextrb       $0xc,%xmm8,0x6(%rax,%rdi,1)
  ...
  196,99,121,20,68,56,1,2,                //vpextrb       $0x2,%xmm8,0x1(%rax,%rdi,1)
  196,99,121,20,4,56,0,                   //vpextrb       $0x0,%xmm8,(%rax,%rdi,1)
  235,159,                                //jmp           c72 <_sk_store_a8_avx+0x3d>
  144,                                    //nop
  246,255,                                //idiv          %bh
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_load_565_avx[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  15,133,208,0,0,0,                       //jne           dce <_sk_load_565_avx+0xde>
  197,250,111,4,120,                      //vmovdqu       (%rax,%rdi,2),%xmm0
  197,241,239,201,                        //vpxor         %xmm1,%xmm1,%xmm1
  197,249,105,201,                        //vpunpckhwd    %xmm1,%xmm0,%xmm1
  196,226,121,51,192,                     //vpmovzxwd     %xmm0,%xmm0
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  15,135,30,255,255,255,                  //ja            d03 <_sk_load_565_avx+0x13>
  76,141,5,68,0,0,0,                      //lea           0x44(%rip),%r8        # e30 <_sk_load_565_avx+0x140>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  197,249,239,192,                        //vpxor         %xmm0,%xmm0,%xmm0
  ...
  197,249,196,68,120,2,1,                 //vpinsrw       $0x1,0x2(%rax,%rdi,2),%xmm0,%xmm0
  197,249,196,4,120,0,                    //vpinsrw       $0x0,(%rax,%rdi,2),%xmm0,%xmm0
  233,213,254,255,255,                    //jmpq          d03 <_sk_load_565_avx+0x13>
  102,144,                                //xchg          %ax,%ax
  243,255,                                //repz          (bad)
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_store_565_avx[] = {
  ...
  196,66,57,43,193,                       //vpackusdw     %xmm9,%xmm8,%xmm8
  72,133,210,                             //test          %rdx,%rdx
  117,9,                                  //jne           ee9 <_sk_store_565_avx+0x9d>
  197,122,127,4,120,                      //vmovdqu       %xmm8,(%rax,%rdi,2)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  137,209,                                //mov           %edx,%ecx
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  119,237,                                //ja            ee5 <_sk_store_565_avx+0x99>
  76,141,5,69,0,0,0,                      //lea           0x45(%rip),%r8        # f44 <_sk_store_565_avx+0xf8>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  196,99,121,21,68,120,12,6,              //vpextrw       $0x6,%xmm8,0xc(%rax,%rdi,2)
  ...
  197,121,126,193,                        //vmovd         %xmm8,%ecx
  102,137,12,120,                         //mov           %cx,(%rax,%rdi,2)
  235,163,                                //jmp           ee5 <_sk_store_565_avx+0x99>
  102,144,                                //xchg          %ax,%ax
  244,                                    //hlt
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_load_8888_avx[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  15,133,156,0,0,0,                       //jne           100a <_sk_load_8888_avx+0xaa>
  197,124,16,12,184,                      //vmovups       (%rax,%rdi,4),%ymm9
  184,255,0,0,0,                          //mov           $0xff,%eax
  197,249,110,192,                        //vmovd         %eax,%xmm0
  197,249,112,192,0,                      //vpshufd       $0x0,%xmm0,%xmm0
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  15,135,81,255,255,255,                  //ja            f73 <_sk_load_8888_avx+0x13>
  76,141,5,139,0,0,0,                     //lea           0x8b(%rip),%r8        # 10b4 <_sk_load_8888_avx+0x154>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  197,249,110,68,184,24,                  //vmovd         0x18(%rax,%rdi,4),%xmm0
  ...
  196,227,49,34,4,184,0,                  //vpinsrd       $0x0,(%rax,%rdi,4),%xmm9,%xmm0
  196,99,53,12,200,15,                    //vblendps      $0xf,%ymm0,%ymm9,%ymm9
  233,194,254,255,255,                    //jmpq          f73 <_sk_load_8888_avx+0x13>
  15,31,0,                                //nopl          (%rax)
  235,255,                                //jmp           10b5 <_sk_load_8888_avx+0x155>
  255,                                    //(bad)
  255,                                    //(bad)
  221,255,                                //(bad)
  255,                                    //(bad)
  ...
  255,                                    //(bad)
  255,                                    //(bad)
  126,255,                                //jle           10cd <_sk_load_8888_avx+0x16d>
  255,                                    //(bad)
  255,                                    //.byte         0xff
};
...
CODE const uint8_t sk_store_8888_avx[] = {
  ...
  196,65,53,86,192,                       //vorpd         %ymm8,%ymm9,%ymm8
  72,133,210,                             //test          %rdx,%rdx
  117,9,                                  //jne           1173 <_sk_store_8888_avx+0xa3>
  197,124,17,4,184,                       //vmovups       %ymm8,(%rax,%rdi,4)
  72,173,                                 //lods          %ds:(%rsi),%rax
  255,224,                                //jmpq          *%rax
  137,209,                                //mov           %edx,%ecx
  ...
  15,182,201,                             //movzbl        %cl,%ecx
  128,249,6,                              //cmp           $0x6,%cl
  119,237,                                //ja            116f <_sk_store_8888_avx+0x9f>
  76,141,5,83,0,0,0,                      //lea           0x53(%rip),%r8        # 11dc <_sk_store_8888_avx+0x10c>
  73,99,12,136,                           //movslq        (%r8,%rcx,4),%rcx
  76,1,193,                               //add           %r8,%rcx
  255,225,                                //jmpq          *%rcx
  196,67,125,25,193,1,                    //vextractf128  $0x1,%ymm8,%xmm9
  ...
  196,99,121,22,68,184,4,1,               //vpextrd       $0x1,%xmm8,0x4(%rax,%rdi,4)
  197,121,126,4,184,                      //vmovd         %xmm8,(%rax,%rdi,4)
  235,150,                                //jmp           116f <_sk_store_8888_avx+0x9f>
  15,31,0,                                //nopl          (%rax)
  246,255,                                //idiv          %bh
  255,                                    //(bad)
  255,                                    //(bad)
...
CODE const uint8_t sk_load_f16_avx[] = {
  ...
  72,139,0,                               //mov           (%rax),%rax
  72,133,210,                             //test          %rdx,%rdx
  15,133,8,1,0,0,                         //jne           130e <_sk_load_f16_avx+0x116>
  197,249,16,12,248,                      //vmovupd       (%rax,%rdi,8),%xmm1
  197,249,16,84,248,16,                   //vmovupd       0x10(%rax,%rdi,8),%xmm2
  197,249,16,92,248,32,                   //vmovupd       0x20(%rax,%rdi,8),%xmm3
  197,121,16,68,248,48,                   //vmovupd       0x30(%rax,%rdi,8),%xmm8
  ...
  196,65,57,87,192,                       //vxorpd        %xmm8,%xmm8,%xmm8
  72,131,250,1,                           //cmp           $0x1,%rdx
  117,6,                                  //jne           1324 <_sk_load_f16_avx+0x12c>
  197,250,126,201,                        //vmovq         %xmm1,%xmm1
  235,30,                                 //jmp           1342 <_sk_load_f16_avx+0x14a>
  197,241,22,76,248,8,                    //vmovhpd       0x8(%rax,%rdi,8),%xmm1,%xmm1
  72,131,250,3,                           //cmp           $0x3,%rdx
  114,18,                                 //jb            1342 <_sk_load_f16_avx+0x14a>
  197,251,16,84,248,16,                   //vmovsd        0x10(%rax,%rdi,8),%xmm2
  72,131,250,3,                           //cmp           $0x3,%rdx
  117,19,                                 //jne           134f <_sk_load_f16_avx+0x157>
  197,250,126,210,                        //vmovq         %xmm2,%xmm2
  235,46,                                 //jmp           1370 <_sk_load_f16_avx+0x178>
  197,225,87,219,                         //vxorpd        %xmm3,%xmm3,%xmm3
  197,233,87,210,                         //vxorpd        %xmm2,%xmm2,%xmm2
  233,206,254,255,255,                    //jmpq          121d <_sk_load_f16_avx+0x25>
  197,233,22,84,248,24,                   //vmovhpd       0x18(%rax,%rdi,8),%xmm2,%xmm2
  72,131,250,5,                           //cmp           $0x5,%rdx
  114,21,                                 //jb            1370 <_sk_load_f16_avx+0x178>
  197,251,16,92,248,32,                   //vmovsd        0x20(%rax,%rdi,8),%xmm3
  72,131,250,5,                           //cmp           $0x5,%rdx
  117,18,                                 //jne           1379 <_sk_load_f16_avx+0x181>
  197,250,126,219,                        //vmovq         %xmm3,%xmm3
  233,173,254,255,255,                    //jmpq          121d <_sk_load_f16_avx+0x25>
  197,225,87,219,                         //vxorpd        %xmm3,%xmm3,%xmm3
  233,164,254,255,255,                    //jmpq          121d <_sk_load_f16_avx+0x25>
  197,225,22,92,248,40,                   //vmovhpd       0x28(%rax,%rdi,8),%xmm3,%xmm3
  72,131,250,7,                           //cmp           $0x7,%rdx
  15,130,148,254,255,255,                 //jb            121d <_sk_load_f16_avx+0x25>
  197,123,16,68,248,48,                   //vmovsd        0x30(%rax,%rdi,8),%xmm8
  233,137,254,255,255,                    //jmpq          121d <_sk_load_f16_avx+0x25>
};
...
CODE const uint8_t sk_store_f16_avx[] = {
  ...
  196,65,25,106,197,                      //vpunpckhdq    %xmm13,%xmm12,%xmm8
  72,133,210,                             //test          %rdx,%rdx
  117,27,                                 //jne           1466 <_sk_store_f16_avx+0xd2>
  197,120,17,28,248,                      //vmovups       %xmm11,(%rax,%rdi,8)
  197,120,17,84,248,16,                   //vmovups       %xmm10,0x10(%rax,%rdi,8)
  197,120,17,76,248,32,                   //vmovups       %xmm9,0x20(%rax,%rdi,8)
  197,122,127,68,248,48,                  //vmovdqu       %xmm8,0x30(%rax,%rdi,8)
  ...
  197,121,214,28,248,                     //vmovq         %xmm11,(%rax,%rdi,8)
  72,131,250,1,                           //cmp           $0x1,%rdx
  116,241,                                //je            1462 <_sk_store_f16_avx+0xce>
  197,121,23,92,248,8,                    //vmovhpd       %xmm11,0x8(%rax,%rdi,8)
  72,131,250,3,                           //cmp           $0x3,%rdx
  114,229,                                //jb            1462 <_sk_store_f16_avx+0xce>
  197,121,214,84,248,16,                  //vmovq         %xmm10,0x10(%rax,%rdi,8)
  116,221,                                //je            1462 <_sk_store_f16_avx+0xce>
  197,121,23,84,248,24,                   //vmovhpd       %xmm10,0x18(%rax,%rdi,8)
  72,131,250,5,                           //cmp           $0x5,%rdx
  114,209,                                //jb            1462 <_sk_store_f16_avx+0xce>
  197,121,214,76,248,32,                  //vmovq         %xmm9,0x20(%rax,%rdi,8)
  116,201,                                //je            1462 <_sk_store_f16_avx+0xce>
  197,121,23,76,248,40,                   //vmovhpd       %xmm9,0x28(%rax,%rdi,8)
  72,131,250,7,                           //cmp           $0x7,%rdx
  114,189,                                //jb            1462 <_sk_store_f16_avx+0xce>
  197,121,214,68,248,48,                  //vmovq         %xmm8,0x30(%rax,%rdi,8)
  235,181,                                //jmp           1462 <_sk_store_f16_avx+0xce>
};
...
CODE const uint8_t sk_store_f32_avx[] = {
  ...
  196,65,37,21,220,                       //vunpckhpd     %ymm12,%ymm11,%ymm11
  72,133,210,                             //test          %rdx,%rdx
  117,51,                                 //jne           1516 <_sk_store_f32_avx+0x69>
  196,67,45,24,225,1,                     //vinsertf128   $0x1,%xmm9,%ymm10,%ymm12
  196,67,61,24,235,1,                     //vinsertf128   $0x1,%xmm11,%ymm8,%ymm13
  196,67,45,6,201,49,                     //vperm2f128    $0x31,%ymm9,%ymm10,%ymm9
  196,67,61,6,195,49,                     //vperm2f128    $0x31,%ymm11,%ymm8,%ymm8
  ...
  197,121,17,20,136,                      //vmovupd       %xmm10,(%rax,%rcx,4)
  72,131,250,1,                           //cmp           $0x1,%rdx
  116,241,                                //je            1512 <_sk_store_f32_avx+0x65>
  197,121,17,76,136,16,                   //vmovupd       %xmm9,0x10(%rax,%rcx,4)
  72,131,250,3,                           //cmp           $0x3,%rdx
  114,229,                                //jb            1512 <_sk_store_f32_avx+0x65>
  197,121,17,68,136,32,                   //vmovupd       %xmm8,0x20(%rax,%rcx,4)
  116,221,                                //je            1512 <_sk_store_f32_avx+0x65>
  197,121,17,92,136,48,                   //vmovupd       %xmm11,0x30(%rax,%rcx,4)
  72,131,250,5,                           //cmp           $0x5,%rdx
  114,209,                                //jb            1512 <_sk_store_f32_avx+0x65>
  196,99,125,25,84,136,64,1,              //vextractf128  $0x1,%ymm10,0x40(%rax,%rcx,4)
  116,199,                                //je            1512 <_sk_store_f32_avx+0x65>
  196,99,125,25,76,136,80,1,              //vextractf128  $0x1,%ymm9,0x50(%rax,%rcx,4)
  72,131,250,7,                           //cmp           $0x7,%rdx
  114,185,                                //jb            1512 <_sk_store_f32_avx+0x65>
  196,99,125,25,68,136,96,1,              //vextractf128  $0x1,%ymm8,0x60(%rax,%rcx,4)
  235,175,                                //jmp           1512 <_sk_store_f32_avx+0x65>
};
...
CODE const uint8_t sk_start_pipeline_sse41[] = {
  ...
  72,141,67,4,                            //lea           0x4(%rbx),%rax
  76,57,240,                              //cmp           %r14,%rax
  118,5,                                  //jbe           6e <_sk_start_pipeline_sse41+0x6e>
  72,137,216,                             //mov           %rbx,%rax
  235,49,                                 //jmp           9f <_sk_start_pipeline_sse41+0x9f>
  15,87,192,                              //xorps         %xmm0,%xmm0
  15,87,201,                              //xorps         %xmm1,%xmm1
  15,87,210,                              //xorps         %xmm2,%xmm2
  15,87,219,                              //xorps         %xmm3,%xmm3
  ...
  76,57,243,                              //cmp           %r14,%rbx
  72,137,195,                             //mov           %rax,%rbx
  118,207,                                //jbe           6e <_sk_start_pipeline_sse41+0x6e>
...
CODE const uint8_t sk_start_pipeline_sse2[] = {
  ...
  72,141,67,4,                            //lea           0x4(%rbx),%rax
  76,57,240,                              //cmp           %r14,%rax
  118,5,                                  //jbe           6e <_sk_start_pipeline_sse2+0x6e>
  72,137,216,                             //mov           %rbx,%rax
  235,49,                                 //jmp           9f <_sk_start_pipeline_sse2+0x9f>
  15,87,192,                              //xorps         %xmm0,%xmm0
  15,87,201,                              //xorps         %xmm1,%xmm1
  15,87,210,                              //xorps         %xmm2,%xmm2
  15,87,219,                              //xorps         %xmm3,%xmm3
  ...
  76,57,243,                              //cmp           %r14,%rbx
  72,137,195,                             //mov           %rax,%rbx
  118,207,                                //jbe           6e <_sk_start_pipeline_sse2+0x6e>
  15,40,52,36,                            //movaps        (%rsp),%xmm6
  15,40,124,36,16,                        //movaps        0x10(%rsp),%xmm7
  68,15,40,68,36,32,                      //movaps        0x20(%rsp),%xmm8
  68,15,40,76,36,48,                      //movaps        0x30(%rsp),%xmm9
