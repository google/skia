...
STAGE(constant_color) {
    ...
    r = _mm256_broadcastw_epi16(_mm_srli_si128(bits,  0));
    g = _mm256_broadcastw_epi16(_mm_srli_si128(bits,  4));
    b = _mm256_broadcastw_epi16(_mm_srli_si128(bits,  8));
    a = _mm256_broadcastw_epi16(_mm_srli_si128(bits, 12));
#else
    __m128i bits = _mm_loadu_ps((const float*)ctx) + _mm_set1_ps(256.0f);
