...
#endif
#if !defined(SK_JUMPER_ENABLED)
#if __has_feature(memory_sanitizer)
#define SK_JUMPER_ENABLED 0
#else
#define SK_JUMPER_ENABLED 1
#endif
#endif
...
#undef M
    ...
    #if SK_JUMPER_ENABLED && (defined(__x86_64__) || defined(_M_X64))
        #include <atomic>
