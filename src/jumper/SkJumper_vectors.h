...
// Every function in this file should be marked static and inline using SI (see SkJumper_misc.h).
    ...
    SI void load3(const uint16_t* ptr, size_t tail, U16* r, U16* g, U16* b) {
        ...
        auto _01 = _mm_unpacklo_epi16(_0, _1),  // r0 r1 g0 g1 b0 b1 xx xx
             _23 = _mm_unpacklo_epi16(_2, _3);  // r2 r3 g2 g3 b2 b3 xx xx

        auto R = _mm_unpacklo_epi32(_01, _23),  // r0 r1 r2 r3 g0 g1 g2 g3
             G = _mm_srli_si128(R, 8),
             B = _mm_unpackhi_epi32(_01, _23);  // b0 b1 b2 b3 xx xx xx xx
