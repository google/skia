...
SI U16 to_half(F f) {
    ...
    // Convert to 1-5-10 half with 15 bias.
    // TODO: What exactly are we doing to denorms here?  And how does 0 (unexpectedly) work already?
    return pack( (s>>16) + (em>>13) - C((127-15)<<10) );
#endif
}
