...
std::unique_ptr<SkInternalAtlasTextContext> SkInternalAtlasTextContext::Make(sk_sp<SkAtlasTextRenderer> renderer) {
...
void SkInternalAtlasTextContext::recordDraw(const void* srcVertexData, int glyphCnt, void* targetHandle) {
