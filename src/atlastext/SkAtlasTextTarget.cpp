...
public:
    ...
    void drawText(const SkGlyphID*, size_t byteLength, SkScalar x, SkScalar y, uint32_t color,
...
void SkInternalAtlasTextTarget::drawText(const SkGlyphID* glyphs, size_t byteLength, SkScalar x,
