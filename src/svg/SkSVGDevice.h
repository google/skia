...
public:
    static SkBaseDevice* Create(const SkISize& size, SkXMLWriter* writer, bool owns_writer=false);
...
private:
    SkSVGDevice(const SkISize& size, SkXMLWriter* writer, bool owns_writer=false);
