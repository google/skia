...
bool SkSpotShadowMaskFilterImpl::directFilterRRectMaskGPU(GrContext*,
    ...
    SkASSERT(SkScalarNearlyEqual(devRRect.radii(SkRRect::kUpperLeft_Corner).fX,
                                 devRRect.radii(SkRRect::kUpperLeft_Corner).fY) &&
             SkScalarNearlyEqual(devRRect.radii(SkRRect::kUpperRight_Corner).fX,
                                 devRRect.radii(SkRRect::kUpperRight_Corner).fY) &&
             SkScalarNearlyEqual(devRRect.radii(SkRRect::kLowerLeft_Corner).fX,
                                 devRRect.radii(SkRRect::kLowerLeft_Corner).fY) &&
             SkScalarNearlyEqual(devRRect.radii(SkRRect::kLowerRight_Corner).fX,
                                 devRRect.radii(SkRRect::kLowerRight_Corner).fY));
