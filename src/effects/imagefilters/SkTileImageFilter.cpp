...
sk_sp<SkSpecialImage> SkTileImageFilterImpl::onFilterImage(const SkFilterContext& ctx,
    ...
    SkRect dstRect;
    ctx.layerCTM().mapRect(&dstRect, fDstRect);
    ...
    SkRect srcRect;
    ctx.layerCTM().mapRect(&srcRect, fSrcRect);
    SkIRect srcIRect;
