...
sk_sp<SkImageFilter> SkImageFilters::DiffuseLightDistant(
...
sk_sp<SkImageFilter> SkImageFilters::DiffuseLightPoint(
...
sk_sp<SkImageFilter> SkImageFilters::DiffuseLightSpot(
...
sk_sp<SkImageFilter> SkImageFilters::SpecularLightDistant(
...
sk_sp<SkImageFilter> SkImageFilters::SpecularLightPoint(
...
sk_sp<SkImageFilter> SkImageFilters::SpecularLightSpot(
        const SkPoint3& location, const SkPoint3& target, SkScalar falloffExponent,
