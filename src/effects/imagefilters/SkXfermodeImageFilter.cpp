...
sk_sp<SkSpecialImage> SkXfermodeImageFilter_Base::filterImageGPU(
    ...
    if (backgroundProxy) {
        ...
        SkMatrix bgMatrix = SkMatrix::MakeTrans(
                -SkIntToScalar(backgroundOffset.fX - bgSubset.left()),
                -SkIntToScalar(backgroundOffset.fY - bgSubset.top()));
    ...
    if (foregroundProxy) {
        ...
        SkMatrix fgMatrix = SkMatrix::MakeTrans(
                -SkIntToScalar(foregroundOffset.fX - fgSubset.left()),
                -SkIntToScalar(foregroundOffset.fY - fgSubset.top()));
