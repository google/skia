...
#if SK_SUPPORT_GPU
    sk_sp<SkSpecialImage> filterImageGPU(const SkFilterContext& ctm,
...
sk_sp<SkSpecialImage> SkXfermodeImageFilterImpl::onFilterImage(const SkFilterContext& ctx,
...
sk_sp<SkSpecialImage> SkXfermodeImageFilterImpl::filterImageGPU(
    ...
    sk_sp<GrRenderTargetContext> renderTargetContext(
            context->priv().makeDeferredRenderTargetContext(
                    ...
                    SkColorTypeToGrColorType(ctx.colorType()), sk_ref_sp(ctx.colorSpace())));
