...
void SkAlphaThresholdImageFilter::RegisterFlattenables() {
    SK_REGISTER_FLATTENABLE(SkAlphaThresholdImageFilter);
    // TODO(michaelludwig): Remove deprecated names after grace period for SKPs
    SkFlattenable::Register("SkAlphaThresholdFilter", SkAlphaThresholdImageFilter::CreateProc);
