...
GrGradientEffect::GrGradientEffect(const CreateArgs& args, bool isOpaque) : INHERITED(isOpaque ? kPreservesOpaqueInput_OptimizationFlag : kNone_OptimizationFlags) {
