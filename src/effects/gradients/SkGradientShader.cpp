...
GrGradientEffect::GrGradientEffect(const CreateArgs& args) {
    ...
    switch (fColorType) {
        ...
        case kSingleHardStop_ColorType:
            ...
            fCoordTransform.reset2(*args.fMatrix);
        ...
        case kTexture_ColorType:
            ...
            if (-1 != fRow) {
                ...
                fCoordTransform.reset10(*args.fMatrix, fAtlas->getTexture(), params.filterMode(), false);
                ...
                fCoordTransform.reset10(*args.fMatrix, texture.get(), params.filterMode(), false);
