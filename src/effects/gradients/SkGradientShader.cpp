...
//                fYCoord = fRow+SK_ScalarHalf; 
                fCoordTransform.reset10(*args.fMatrix, args.fFoo, fAtlas->getTexture(), params.filterMode());
                ...
                fCoordTransform.reset10(*args.fMatrix, args.fFoo, texture.get(), params.filterMode());
