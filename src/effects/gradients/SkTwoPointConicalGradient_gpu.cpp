...
void FocalInside2PtConicalEffect::GLSLFocalInside2PtConicalProcessor::emitCode(EmitArgs& args) {
    ...
    GrShadeVar focal = uniformHandler->getUniformVariable(fFocalUni);
...
void CircleInside2PtConicalEffect::GLSLCircleInside2PtConicalProcessor::emitCode(EmitArgs& args) {
    ...
    GrShadeVar center = uniformHandler->getUniformVariable(fCenterUni);
    // params.x = A
    // params.y = B
    // params.z = C
    GrShadeVar params = uniformHandler->getUniformVariable(fParamUni);
