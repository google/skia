...
protected:
    GrGradientEffect(const CreateArgs&, bool isOpaque) : INHERITED(kModulatesInput_OptimizationFlag | (isOpaque ? kPreservesOpaqueInput_OptimizationFlag : kNone_OptimizationFlags)) {}
