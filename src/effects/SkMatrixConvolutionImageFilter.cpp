...
sk_sp<SkSpecialImage> SkMatrixConvolutionImageFilter::onFilterImage(SkSpecialImage* source,
    ...
    this->filterBorderPixels(inputBM, &dst, *offset, top, srcBounds);
    this->filterBorderPixels(inputBM, &dst, *offset, left, srcBounds);
    this->filterInteriorPixels(inputBM, &dst, *offset, interior, srcBounds);
    this->filterBorderPixels(inputBM, &dst, *offset, right, srcBounds);
    this->filterBorderPixels(inputBM, &dst, *offset, bottom, srcBounds);
