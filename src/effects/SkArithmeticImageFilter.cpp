...
SkIRect ArithmeticImageFilterImpl::onFilterBounds(const SkIRect& src,
    ...
    auto i2 = this->getInput(0) ? this->getInput(0)->filterBounds(src, ctm, nullptr, dir) : src;
    auto i1 = this->getInput(1) ? this->getInput(1)->filterBounds(src, ctm, nullptr, dir) : src;
