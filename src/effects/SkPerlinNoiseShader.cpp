...
sk_sp<SkShader> SkPerlinNoiseShader::MakeTurbulence(SkScalar baseFrequencyX,
                                                     ...
                                                     int numOctaves, SkScalar seed,
                                                     const SkISize* tileSize) {
    return sk_sp<SkShader>(new SkPerlinNoiseShader(kTurbulence_Type, baseFrequencyX,
                                                    baseFrequencyY, numOctaves, seed, tileSize));
}
...
sk_sp<SkShader> SkPerlinNoiseShader::MakeImprovedNoise(SkScalar baseFrequencyX,
    ...
    return sk_sp<SkShader>(new SkPerlinNoiseShader(kImprovedNoise_Type, baseFrequencyX,
...
sk_sp<SkFlattenable> SkPerlinNoiseShader::CreateProc(SkReadBuffer& buffer) {
    ...
    switch (type) {
        ...
        case kTurbulence_Type:
            return SkPerlinNoiseShader::MakeTubulence(freqX, freqY, octaves, seed, &tileSize);
...
SkScalar SkPerlinNoiseShader::PerlinNoiseShaderContext::calculateImprovedNoiseValueForPoint(
