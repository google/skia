    ...
    public:
        ...
        void emitModeCode(Mode mode,
            ...
            case kSimpleCircular_Mode:
                ...
                // "maxValue" is a correction term for if the blurRadius. If it is larger than the
                // size of the RRect we'll don't want to go all the way to black.
