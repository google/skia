...
The merging kernels also exploit the register file by loading, merging
and storing a large number of strided slab rows.

HotSort implements several different merging kernels.

As an example, the two steps of the *Streaming Flip Merge* kernel are
illustrated below:
