...
possible on small GPUs when sorting modestly-sized arrays -- 1000's
to 100's of thousands of 64‑bit keys.
...
registers, sorts the slabs, merges one or more slabs, and stores the
...
Similarly, the subgroup-centric merging kernels exploit the register
file by loading, merging and storing a large number of keys at once.

Step 1:

![](images/hs_flip_merge_step_1.svg)

Step 2:

![](images/hs_flip_merge_step_2.svg)
