...
static void test_surface_creation_and_snapshot_with_color_space(
    ...
    const struct {
        ...
        { kRGBA_F32_SkColorType,  nullptr,          true,  "F32-nullptr" },
        { kRGBA_F32_SkColorType,  linearColorSpace, true,  "F32-linear"  },
        { kRGBA_F32_SkColorType,  srgbColorSpace,   true,  "F32-srgb"    },
        { kRGBA_F32_SkColorType,  oddColorSpace,    true,  "F32-odd"     },
