...
DEF_GPUTEST_FOR_GL_RENDERING_CONTEXTS(SRGBMipMaps, reporter, ctxInfo) {
    ...
    GrSamplerParams mipMapParams(SkShader::kRepeat_TileMode, GrSamplerParams::FilterMode::kMipMap_FilterMode);
    paint.addColorTextureProcessor(texture.get(), nullptr, SkMatrix::MakeScale(0.5f*texS), true, mipMapParams); //!!!!!!
