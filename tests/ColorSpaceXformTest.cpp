...
public:
    ...
    static sk_sp<SkColorSpace> CreateA2BSpace(SkColorSpace_A2B::PCS pcs, SkColorSpace_A2B::ICS ics,
                                              std::vector<SkColorSpace_A2B::Element> elements) {
        return sk_sp<SkColorSpace>(new SkColorSpace_A2B(pcs, ics, nullptr, std::move(elements)));
    }
};
