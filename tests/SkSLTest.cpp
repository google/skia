...
static void test(skiatest::Reporter* r, const char* testFile) {
...
DEF_TEST(SkSLBoolFolding, r)             { test(r, "folding/BoolFolding.sksl"); }
DEF_TEST(SkSLFloatFolding, r)            { test(r, "folding/FloatFolding.sksl"); }
DEF_TEST(SkSLIntFoldingES2, r)           { test(r, "folding/IntFoldingES2.sksl"); }
DEF_TEST(SkSLMatrixFoldingES2, r)        { test(r, "folding/MatrixFoldingES2.sksl"); }
DEF_TEST(SkSLShortCircuitBoolFolding, r) { test(r, "folding/ShortCircuitBoolFolding.sksl"); }
DEF_TEST(SkSLVectorScalarFolding, r)     { test(r, "folding/VectorScalarFolding.sksl"); }
DEF_TEST(SkSLVectorVectorFolding, r)     { test(r, "folding/VectorVectorFolding.sksl"); }

/*
TODO(johnstiles): enable these tests when Runtime Effects have support for ES3
