...
SKSL_TEST(SkSLMatrixEquality1,                  "shared/MatrixEquality1.sksl")
SKSL_TEST(SkSLMatrixEquality2,                  "shared/MatrixEquality2.sksl")
SKSL_TEST(SkSLMatrixEquality3,                  "shared/MatrixEquality3.sksl")
SKSL_TEST(SkSLMatrixEquality4,                  "shared/MatrixEquality4.sksl")
SKSL_TEST(SkSLMatrixEquality5,                  "shared/MatrixEquality5.sksl")
SKSL_TEST(SkSLMatrixEquality6,                  "shared/MatrixEquality6.sksl")
SKSL_TEST(SkSLMatrixEquality7,                  "shared/MatrixEquality7.sksl")
SKSL_TEST(SkSLMatrixEquality8,                  "shared/MatrixEquality8.sksl")
SKSL_TEST(SkSLMatrixEquality9,                  "shared/MatrixEquality9.sksl")
