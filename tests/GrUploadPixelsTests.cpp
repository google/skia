...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(GrUploadPixelsTests, reporter, ctxInfo) {
    ...
    // RGBA
    basic_texture_test(reporter, context, kRGBA_8888_SkColorType, GrRenderable::kNo);
    basic_texture_test(reporter, context, kRGBA_8888_SkColorType, GrRenderable::kYes);

    // BGRA
    basic_texture_test(reporter, context, kBGRA_8888_SkColorType, GrRenderable::kNo);
    basic_texture_test(reporter, context, kBGRA_8888_SkColorType, GrRenderable::kYes);
}
