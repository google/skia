...
static void check_serialize_behaviors(sk_sp<SkTypeface> tf, bool isLocalData,
    ...
    auto data0 = tf->serialize(SkTypeface::kDoIncludeData_SerializeBehavior);
    auto data1 = tf->serialize(SkTypeface::kDontIncludeData_SerializeBehavior);
    auto data2 = tf->serialize(SkTypeface::kIncludeDataIfLocal_SerializeBehavior);
...
DEF_TEST(Typeface_serialize, reporter) {
    ...
    check_serialize_behaviors(SkTypeface::MakeFromStream(
                                             GetResourceAsStream("fonts/Distortable.ttf").get()),
                              true, reporter);
