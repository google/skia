...
DEF_TEST(SkSLFPColorSpaceXform, r) {
    test(r,
         ...
         *SkSL::ShaderCapsFactory::Default(),
         ...
         {
             "fragBuilder->codeAppendf(\"vec4 tmpVar;%s = %s * %stexture(%s, vec2(0.0, 0.0)).%s%s;"
             "\\n\", args.fOutputColor, args.fInputColor ? args.fInputColor : \"vec4(1)\", "
             "fColorSpaceHelper.isValid() ? \"(tmpVar = \" : \"\", "
             "fragBuilder->getProgramBuilder()->samplerVariable(args.fTexSamplers[0]).c_str(), "
             "fragBuilder->getProgramBuilder()->samplerSwizzle(args.fTexSamplers[0]).c_str(), "
             "fColorSpaceHelper.isValid() ? SkStringPrintf(\", vec4(clamp((%s * vec4(tmpVar.rgb, "
             "1.0)).rgb, 0.0, tmpVar.a), tmpVar.a))\", args.fUniformHandler->getUniformCStr("
