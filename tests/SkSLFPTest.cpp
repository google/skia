    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            R"__Cpp__(
        fragBuilder->codeAppendf(
R"SkSL(half4 value = %s;)SkSL"
, args.fUniformHandler->getUniformCStr(colorVar));
        SkString _input225("value");
        SkString _sample225 = this->invokeChild(0, _input225.c_str(), args);
        fragBuilder->codeAppendf(
R"SkSL(
half4 childOut1 = %s;)SkSL"
, _sample225.c_str());
        SkString _input283("childOut1");
        SkString _sample283 = this->invokeChild(1, _input283.c_str(), args);
        fragBuilder->codeAppendf(
R"SkSL(
half4 childOut2 = %s;
%s = childOut2;
)SkSL"
, _sample283.c_str(), args.fOutputColor);
)__Cpp__"});
}
