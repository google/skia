    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            "R\"SkSL(%s = half4(%s, %s);\n"
            ")SkSL\"\n"
            ", args.fOutputColor, args.fLocalCoord, args.fLocalCoord);"
         });
}
    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            "SkString _sample166;\n",
            "SkString _coords166 = SkStringPrintf(\"%s / 2.0\", args.fLocalCoord);\n",
...
DEF_TEST(SkSLFPMatrixSampleConstantAndExplicitly, r) {
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
             "this->invokeChildWithMatrix(_outer.child_index, args)",
             "SkString _coords168 = SkStringPrintf(\"%s / 2.0\", args.fLocalCoord);",
    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
             ...
             "SkString _coords220 = SkStringPrintf(\"%s / 2.0\", args.fLocalCoord);",
