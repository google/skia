...
DEF_TEST(SkSLFPChildProcessors, r) {
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedH=*/{
            "child1_index = this->registerChild(std::move(child1), SkSL::SampleUsage::MakePassThrough());",
            "child2_index = this->registerChild(std::move(child2), SkSL::SampleUsage::MakePassThrough());"
         },
         /*expectedCPP=*/{
            "SkString _sample149;\n",
...
DEF_TEST(SkSLFPChildProcessorWithInputExpression, r) {
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedH=*/{
            "child_index = this->registerChild(std::move(child), SkSL::SampleUsage::MakePassThrough());",
         },
         /*expectedCPP=*/{
...
DEF_TEST(SkSLFPMatrixSampleConstantAndExplicitly, r) {
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedH=*/{
             "this->registerChild(std::move(child), "
                    "SkSL::SampleUsage(SkSL::SampleUsage::Kind::kConstantOrUniform, \"float3x3(0.5)\", true, true, false));"
         },
         /*expectedCPP=*/{
             "this->invokeChildWithMatrix(_outer.child_index, args)",
