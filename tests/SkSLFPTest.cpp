    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            "fragBuilder->codeAppendf(\"\\nhalf4 childOut1 = %s;\", _sample198.c_str());",
         ...
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            "fragBuilder->codeAppendf(\"bool hasCap = %s;\\nif (hasCap) {\", (hasCap ? \"true\" : "
                                     "\"false\"));",
            "SkString _input200 = SkStringPrintf(\"%s\", args.fInputColor);",
            "SkString _sample200;",
    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            "SkString _input161 = SkStringPrintf(\"%s\", args.fInputColor);",
            "SkString _sample161;",
    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            "fragBuilder->codeAppendf(\"%s = %s + %s;\\n\", args.fOutputColor, _sample150.c_str(), "
                                     "_sample166.c_str());\n"
         });
}
