...
DEF_TEST(SkSLFPChildProcessors, r) {
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            "SkString _sample149;\n",
            "_sample149 = this->invokeChild(0, args);\n",
            "SkString _sample166;\n",
            "_sample166 = this->invokeChild(1, args);\n",
            "fragBuilder->codeAppendf(\n"
            "R\"SkSL(%s = %s * %s;\n"
            ")SkSL\"\n"
    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            "SkString _sample198;",
            "_sample198 = this->invokeChild(0, _input198.c_str(), args);",
            "fragBuilder->codeAppendf(\n"
            "R\"SkSL(\n"
            ...
            "SkString _sample258;",
            "_sample258 = this->invokeChild(1, _input258.c_str(), args);",
            "this->cloneAndRegisterAllChildProcessors(src);",
         });
}
    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            "SkString _sample106;",
            "_sample106 = this->invokeChild(0, _input106.c_str(), args);",
            "fragBuilder->codeAppendf(\n"
            "R\"SkSL(%s = %s;\n"
            ")SkSL\"\n"
    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            "SkString _sample177;",
            "_sample177 = this->invokeChild(0, _input177.c_str(), args);",
            "SkString _input149 = SkStringPrintf(\"%s * %s\", args.fInputColor, _sample177.c_str());",
            "SkString _sample149;",
            "_sample149 = this->invokeChild(1, _input149.c_str(), args);",
            "fragBuilder->codeAppendf(\n"
            "R\"SkSL(%s = %s;\n"
            ")SkSL\"\n"
    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            "SkString _sample200;",
            "_sample200 = this->invokeChild(0, _input200.c_str(), args);",
            "fragBuilder->codeAppendf(\n"
            "R\"SkSL(\n"
            "    %s = %s;\n"
            "} else {\n"
    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            "SkString _sample161;",
            "_sample161 = this->invokeChild(0, _input161.c_str(), args);",
            "fragBuilder->codeAppendf(\n"
            "R\"SkSL(\n"
            "    %s = %s;\n"
            "} else {\n"
    ...
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            ...
            ", (opaque ? \"true\" : \"false\"));",
            "SkString _sample196;",
            "_sample196 = this->invokeChild(0, args);",
            "fragBuilder->codeAppendf(\n"
            "R\"SkSL(\n"
            "    %s = %s;\n"
            "} else {\n"
...
DEF_TEST(SkSLFPSampleCoords, r) {
    test(r,
         *SkSL::ShaderCapsFactory::Default(),
         ...
         /*expectedCPP=*/{
            "SkString _sample118;\n",
            "_sample118 = this->invokeChild(0, args);\n",
            "SkString _sample118;\n",
            "SkString _coords134 = SkStringPrintf(\"%s / 2.0\", args.fSampleCoord);\n",
            "_sample134 = this->invokeChild(0, args, _coords134.c_str());\n",
            "fragBuilder->codeAppendf(\n"
            "R\"SkSL(%s = %s + %s;\n"
            ")SkSL\"\n"
