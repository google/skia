    ...
    test(r,
         ...
         *SkSL::ShaderCapsFactory::Default(),
         ...
         },
         {
            ...
            "            !src.childProcessor(child1_index).coordTransformsApplyToLocalCoords());",
            "    this->registerChildProcessor(std::move(clone));",
            "}",
            "{",
            "    auto clone = src.childProcessor(child2_index).clone();",
            "    clone->setSampledWithExplicitCoords(",
            "            !src.childProcessor(child2_index).coordTransformsApplyToLocalCoords());",
            "    this->registerChildProcessor(std::move(clone));",
            "}",
         });
}
    ...
    test(r,
         ...
         *SkSL::ShaderCapsFactory::Default(),
         ...
         },
         {
            ...
            "    clone->setSampledWithExplicitCoords(",
            "            !src.childProcessor(child_index).coordTransformsApplyToLocalCoords());",
            "    this->registerChildProcessor(std::move(clone));",
            "}",
         });
}
