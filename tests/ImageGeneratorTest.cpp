...
DEF_TEST(ImageGenerator, reporter) {
    ...
    sizeInfo.fWidthBytes1[0] = 0;
    sizeInfo.fWidthBytes1[1] = 0;
    sizeInfo.fWidthBytes1[2] = 0;
    sizeInfo.fWidthBytes1[3] = 0;
    ...
    sizeInfo.fWidthBytes1[0] = 250;
    sizeInfo.fWidthBytes1[1] = 250;
    sizeInfo.fWidthBytes1[2] = 250;
    sizeInfo.fWidthBytes1[3] = 250;
    int dummy;
