...
public:
    void run(skiatest::Reporter* reporter, bool doStroke) {
        ...
        mockOptions.fConfigOptions1[(int)GrColorType::kAlpha_F16].fRenderability =
                GrMockOptions::ConfigOptions::Renderability::kNonMSAA;
        mockOptions.fConfigOptions1[(int)GrColorType::kAlpha_F16].fTexturable = true;
        mockOptions.fConfigOptions1[(int)GrColorType::kAlpha_8].fRenderability =
                GrMockOptions::ConfigOptions::Renderability::kNonMSAA;
        mockOptions.fConfigOptions1[(int)GrColorType::kAlpha_8].fTexturable = true;
