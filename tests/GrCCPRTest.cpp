    ...
    void onRun(skiatest::Reporter* reporter, CCPRPathDrawer& ccpr) override {
        ...
        for (int flushIdx = 0; flushIdx < 10; ++flushIdx) {
            ...
            if (0 == flushIdx) {
                ...
                onlyAtlasID = stashedAtlasInfo.fID;
                continue;
            }
            ...
            switch (flushIdx % 3) {
                ...
                case 2:
                    ...
                    // 'onlyAtlasID' should be kept as a scratch texture in the resource cache.
                    REPORTER_ASSERT(reporter, stashedAtlasInfo.fID = onlyAtlasID);
                ...
                case 0:
                    ...
                    // 'onlyAtlasID' is the same texture that got stashed away last time (assuming
