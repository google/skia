...
DEF_GPUTEST_FOR_NULLGL_CONTEXT(GrSurface, reporter, ctxInfo) {
    ...
    desc.fHeight = 256;
    desc.fSampleCnt = 0;
    sk_sp<GrSurface> texRT1 = context->resourceProvider()->createTexture4(desc, SkBudgeted::kNo);
    ...
    sk_sp<GrTexture> tex1 = context->resourceProvider()->createTexture4(desc, SkBudgeted::kNo);
