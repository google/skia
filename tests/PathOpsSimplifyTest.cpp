...
static void path_addRect(SkPath* path
...
static void testLine15(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 9, 9, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine16(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 4, 9, 9, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine17(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 4, 12, 13, 13, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine18(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 4, 21, 21, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine19(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 16, 21, 21, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine20(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 12, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 12, 9, 9, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine21(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 12, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 16, 9, 9, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine23(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 12, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 0, 21, 21, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine24(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 18, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 4, 12, 13, 13, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine25(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 6, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 0, 21, 21, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine27(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 18, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 8, 21, 21, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine29(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 18, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 12, 21, 21, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine30(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 0, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 4, 4, 13, 13, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine33(skiatest::Reporter* reporter, const char* filename) {
    ...
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 0, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 4, 16, 13, 13, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine35(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 6, 0, 18, 18, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 4, 16, 13, 13, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine36(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 10, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 6, 12, 18, 18, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 4, 16, 13, 13, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine37(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 20, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 18, 24, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 0, 9, 9, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine38(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 10, 0, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 6, 12, 18, 18, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 12, 21, 21, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine40(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 10, 0, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 18, 24, 24, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 4, 16, 13, 13, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine42(skiatest::Reporter* reporter, const char* filename) {
    ...
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 0, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 8, 16, 17, 17, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine43(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 6, 24, 18, 18, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 32, 9, 36, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine44(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 10, 40, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 18, 0, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 18, 32, 27, 36, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine45(skiatest::Reporter* reporter, const char* filename) {
    ...
    path_addRect(path.addRect(path, 10, 0, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 18, 0, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 24, 32, 33, 36, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine46(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 10, 40, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 24, 0, 36, 36, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 24, 32, 33, 36, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine47(skiatest::Reporter* reporter, const char* filename) {
    ...
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 0, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 0, 9, 9, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine50(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 10, 30, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 24, 20, 36, 30, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine51(skiatest::Reporter* reporter, const char* filename) {
    ...
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 12, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 4, 12, 13, 13, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine52(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 30, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 6, 20, 18, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 32, 0, 36, 41, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine53(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 10, 30, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 20, 24, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 32, 21, 36, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine54(skiatest::Reporter* reporter, const char* filename) {
    ...
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 6, 0, 18, 18, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 8, 4, 17, 17, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine55(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 6, 6, 18, 18, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 4, 4, 13, 13, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine56(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 20, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 18, 20, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 0, 21, 21, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine57(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 20, 0, 40, 40, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 20, 0, 30, 40, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 0, 21, 21, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine58(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 0, 12, 12, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 0, 12, 9, 9, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine59(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 6, 6, 18, 18, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 4, 4, 13, 13, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine60(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 6, 12, 18, 18, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 4, 12, 13, 13, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine61(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 0, 24, 24, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 12, 0, 21, 21, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine62(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 60, 60, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 12, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 4, 12, 13, 13, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
...
static void testLine63(skiatest::Reporter* reporter, const char* filename) {
    ...
    path_addRect(path.addRect(path, 0, 0, 60, 60, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 10, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 6, 12, 12, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 0, 32, 9, 36, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine64(skiatest::Reporter* reporter, const char* filename) {
    ...
    path_addRect(path.addRect(path, 0, 0, 60, 60, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 10, 40, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 18, 6, 30, 30, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine65(skiatest::Reporter* reporter, const char* filename) {
    ...
    path_addRect(path.addRect(path, 10, 0, 30, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 24, 0, 36, 36, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 32, 6, 36, 41, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine68a(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 8, 8, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 2, 2, 6, 6, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 1, 2, 4, 2, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine68b(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 8, 8, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 2, 2, 6, 6, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 1, 2, 2, 2, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine68c(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 8, 8, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 2, 2, 6, 6, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 1, 2, 4, 2, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine69(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 20, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 20, 12, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 32, 21, 36, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine70(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 24, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 32, 21, 36, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine71(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 0, 24, 24, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 12, 32, 21, 36, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine73(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 60, 60, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 40, 20, 20, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 20, 12, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 0, 9, 9, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine74(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 20, 30, 40, 40, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 24, 20, 36, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 32, 24, 36, 41, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine75(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 60, 60, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 10, 0, 30, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 18, 0, 30, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 12, 0, 21, 21, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine76(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 36, 0, 66, 60, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 10, 20, 40, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 24, 20, 36, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 32, 6, 36, 41, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine77(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 20, 0, 40, 40, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 24, 6, 36, 36, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 24, 32, 33, 36, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine78(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 30, 60, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 10, 20, 30, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 18, 20, 30, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 32, 0, 36, 41, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine79(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 36, 60, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 10, 30, 40, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 20, 12, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 0, 32, 9, 36, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine81(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, -1, -1, 3, 3, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 0, 1, 1, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 0, 1, 1, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 0, 1, 1, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 1, 1, 2, 2, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine1a(skiatest::Reporter* reporter, const char* filename) {
    ...
    path_addRect(path.addRect(path, 0, 0, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 4, 0, 13, 13, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine82(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 20, 0, 40, 40, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 24, 20, 36, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 24, 32, 33, 36, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine82a(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 6, 10, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 2, 2, 4, 4, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 2, 6, 4, 8, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine82b(skiatest::Reporter* reporter, const char* filename) {
    ...
    path_addRect(path.addRect(path, 0, 0, 6, 10, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 2, 2, 4, 4, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 2, 6, 4, 8, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine82c(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 6, 10, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 2, 2, 4, 4, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 2, 6, 4, 8, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine82e(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 6, 10, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 2, 2, 4, 4, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 2, 6, 4, 8, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine83(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
path_addRect(path.addRect(path, 10, 30, 30, 40, SkPathDirection::kCCW);
path_addRect(path.addRect(path, 0, 12, 12, 18, SkPathDirection::kCCW);
path_addRect(path.addRect(path, 4, 13, 13, 16, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}

static void testLine84(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 12, 60, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 10, 20, 40, 30, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 0, 12, 12, 12, SkPathDirection::kCW);
    path_addRect(path.addRect(path, 4, 12, 13, 13, SkPathDirection::kCW);
    testSimplify(reporter, path, filename);
...
static void testLine84x(skiatest::Reporter* reporter, const char* filename) {
    ...
    path.setFillType(SkPathFillType::kEvenOdd);
    path_addRect(path.addRect(path, 0, 12, 60, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 10, 20, 40, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 0, 12, 12, 12, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 4, 12, 13, 13, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testLine85(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 36, 0, 66, 60, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 20, 0, 40, 40, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 12, 0, 24, 24, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 32, 0, 36, 41, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
...
static void testRect1s(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path_addRect(path.addRect(path, 0, 0, 60, 60, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 30, 20, 50, 50, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 24, 20, 36, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 32, 24, 36, 41, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testRect3(skiatest::Reporter* reporter, const char* filename) {
    ...
    path.setFillType(SkPathFillType::kEvenOdd);
    path_addRect(path.addRect(path, 0, 0, 60, 60, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 10, 30, 40, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 24, 6, 36, 36, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 32, 6, 36, 41, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
...
static void testRect4(skiatest::Reporter* reporter, const char* filename) {
    SkPath path;
    path.setFillType(SkPathFillType::kEvenOdd);
    path_addRect(path.addRect(path, 0, 0, 30, 60, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 10, 0, 40, 30, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 20, 0, 30, 40, SkPathDirection::kCCW);
    path_addRect(path.addRect(path, 32, 0, 36, 41, SkPathDirection::kCCW);
    testSimplify(reporter, path, filename);
}
