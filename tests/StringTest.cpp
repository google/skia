...
void utf8_to_utf16(skiatest::Reporter* r, const uint16_t* utf16, size_t count, const char* utf8) {
    SkString s;
    s.setUTF16(utf16, len);
    REPORTER_ASSERT(r, s.equals(utf8);
}

DEF_TEST(SkString_fromUTF16, r) {
