...
using SkPDF::Attribute;
using SkPDF::AttributeType;
...
DEF_TEST(SkPDF_tagged_table, r) {
    ...
    table.fChildCount = 5;
    table.fAttributes.push_back(
        Attribute("Layout", "BBox", {72, 72, 360, 360}));
