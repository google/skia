...
static constexpr auto cubicLineFailures = std::to_array<CubicLineFailures>({
        CubicLineFailures{{{{-164.3726806640625, 36.826904296875},
        ...
        CubicLineFailures{{{{784.056884765625, -554.8350830078125},
        ...
        CubicLineFailures{{{{-580.6834716796875, -127.044921875},
...
DEF_TEST(PathOpsCubicLineRoots, reporter) {
    ...
    SkRandom ran;
    std::array<double, 256> worstStep = {0};
    int errors = 0;
    int iters = 0;
    double smallestR2 = 0;
    double largestR2 = 0;
