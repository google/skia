...
DEF_GPUTEST(GrContextFactory_sharedContexts, reporter, /*factory*/) {
    GrContextFactory testFactory;
    GrContextFactory::ContextOptions optionsNone = GrContextFactory::ContextOptions::kNone;
    ...
    for (int i = 0; i < GrContextFactory::kContextTypeCnt; ++i) {
        ...
        ContextInfo info2 = testFactory.getContextInfo(ctxType, optionsNone, info1.grContext());
        REPORTER_ASSERT(reporter, !info2.grContext());
        info1.grContext()->unref();
        ...
        ContextInfo info4 = testFactory.getContextInfo(ctxType, optionsNone, info3.grContext());
        if (!info4.grContext()) {
            continue;
        }
        ...
        ContextInfo info5 = testFactory.getContextInfo(ctxType, optionsNone, info3.grContext(), 1);
        ...
        for (int j = 0; j < GrContextFactory::kContextTypeCnt; ++j) {
            ...
            ContextInfo info6 = testFactory.getContextInfo(differentCtxType, optionsNone,
                                                           info3.grContext());
