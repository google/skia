...
DEF_TEST(SkParagraph_RainbowParagraph, reporter) {
    ...
    impl->lines()[0].scanStyles(SkStyleType::kAllAttributes,
                                [&](SkSpan<const char> text, SkTextStyle style, SkScalar) {
                                    switch (index) {
                                        case 0:
...
DEF_TEST(SkParagraph_SpacingParagraph, reporter) {
    ...
    impl->lines().begin()->scanStyles(
            ...
            [&index](SkSpan<const char> text, SkTextStyle style, SkScalar) {
                ++index;
                return true;
            });
    REPORTER_ASSERT(reporter, index == 4);
...
DEF_TEST(SkParagraph_SimpleShadow, reporter) {
    ...
    for (auto& line : impl->lines()) {
        line.scanStyles(SkStyleType::kShadow,
                        [&index, text_style, reporter](SkSpan<const char> text, SkTextStyle style,
                                                       SkScalar) {
