...
DEF_TEST(SkParagraph_RightAlignParagraph, reporter) {
    ...
    canvas.get()->drawRect(SkRect::MakeXYWH(0, 0, paragraph->getMaxWidth(), paragraph->getHeight()), paint);
...
DEF_TEST(SkParagraph_NewlineParagraph, reporter) {
    ...
    SkScalar epsilon = 0.1f;
    REPORTER_ASSERT(reporter, SkScalarNearlyEqual(impl->lines()[0].width(), 127.705f, epsilon));
    REPORTER_ASSERT(reporter, SkScalarNearlyEqual(impl->lines()[1].width(), 579.111f, epsilon));
    REPORTER_ASSERT(reporter, SkScalarNearlyEqual(impl->lines()[2].width(), 587.021f, epsilon));
    REPORTER_ASSERT(reporter, SkScalarNearlyEqual(impl->lines()[3].width(), 127.705f, epsilon));
    REPORTER_ASSERT(reporter,
                    SkScalarNearlyEqual(impl->lines()[4].width(), 0, epsilon));  // Empty line
    REPORTER_ASSERT(reporter, SkScalarNearlyEqual(impl->lines()[5].width(), 579.111f, epsilon));
    REPORTER_ASSERT(reporter, SkScalarNearlyEqual(impl->lines()[6].width(), 135.615f, epsilon));
...
DEF_TEST(SkParagraph_StrutParagraph1, reporter) {
    ...
    }
    {
        ...
        //canvas.drawRects(SK_ColorBLACK, boxes);
        REPORTER_ASSERT(reporter, boxes.size() == 1);
        REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.left(), 300, EPSILON100));
        REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.top(), 0, EPSILON100));
        REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.right(), 500, EPSILON100));
    ...
    }
    {
        ...
        //canvas.drawRects(SK_ColorMAGENTA, boxes);
        REPORTER_ASSERT(reporter, boxes.size() == 1);
        REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.left(), 0, EPSILON100));
    ...
    }
    {
        ...
        //canvas.drawRects(SK_ColorCYAN, boxes);
        REPORTER_ASSERT(reporter, boxes.size() == 1);
