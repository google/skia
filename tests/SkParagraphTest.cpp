...
DEF_TEST(SkParagraph_SimpleParagraph, reporter) {
    sk_sp<FontCollection> fontCollection = sk_make_sp<TestFontCollection>();
    const char* text = "Hello World Text Dialog";

    ParagraphStyle paragraph_style;
    paragraph_style.turnHintingOff();
    ParagraphBuilder builder(paragraph_style, fontCollection);
...
DEF_TEST(SkParagraph_RainbowParagraph, reporter) {
    ...
    text_style2.setDecoration((TextDecoration)(TextDecoration::kUnderline |
    ...
    text_style4.setDecoration((TextDecoration)(TextDecoration::kUnderline |
                                                 TextDecoration::kOverline |
                                                 TextDecoration::kLineThrough));
...
DEF_TEST(SkParagraph_DefaultStyleParagraph, reporter) {
    ...
    size_t index = 0;
    impl->lines()[0].scanStyles(SkStyleType::kAllAttributes, [&](SkSpan<const char> text1,
                                                                 TextStyle style, SkScalar) {
...
DEF_TEST(SkParagraph_DecorationsParagraph, reporter) {
    ...
    text_style.setDecoration(TextDecoration::kUnderline);
    text_style.setDecorationColor(SK_ColorBLACK);
    text_style.setDecoration((TextDecoration)(TextDecoration::kUnderline |
                                                TextDecoration::kOverline |
                                                TextDecoration::kLineThrough));
...
DEF_TEST(SkParagraph_UnderlineShiftParagraph, reporter) {
    ...
    ParagraphBuilder builder1(paragraph_style, fontCollection);
...
DEF_TEST(SkParagraph_SimpleShadow, reporter) {
    ...
    text_style.setFontFamilies({"Roboto"});
    text_style.setColor(SK_ColorBLACK);
    text_style.addShadow(TextShadow(SK_ColorBLACK, SkPoint::Make(2.0, 2.0), 1.0));
    builder.pushStyle(text_style);
    builder.addText(text);
    ...
    for (auto& line : impl->lines()) {
        line.scanStyles(SkStyleType::kShadow,
                        [&index, text_style, reporter](SkSpan<const char> text, TextStyle style,
                                                       SkScalar) {
...
DEF_TEST(SkParagraph_ComplexShadow, reporter) {
    ...
    text_style.addShadow(TextShadow(SK_ColorRED, SkPoint::Make(2.0, 2.0), 5.0));
    text_style.addShadow(TextShadow(SK_ColorGREEN, SkPoint::Make(10.0, -5.0), 3.0));
    builder.pushStyle(text_style);
    builder.addText(text);
    builder.pop();
    ...
    text_style.addShadow(TextShadow(SK_ColorRED, SkPoint::Make(0.0, 1.0), 0.0));
    builder.pushStyle(text_style);
    builder.addText(text);
    builder.pop();
