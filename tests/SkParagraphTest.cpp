...
DEF_TEST(SkParagraph_Bidi1, reporter) {
    ...
    //text_style.setFontStyle(SkFontStyle(100, SkFontStyle::kNormal_Width, SkFontStyle::kUpright_Slant));
    //builder.pushStyle(text_style);
    builder.addText(abc);

    //text_style.setFontStyle(SkFontStyle(300, SkFontStyle::kNormal_Width, SkFontStyle::kUpright_Slant));
    //builder.pushStyle(text_style);
    builder.addText(DEF);

    //text_style.setFontStyle(SkFontStyle(400, SkFontStyle::kNormal_Width, SkFontStyle::kUpright_Slant));
    //builder.pushStyle(text_style);
    builder.addText(ghi);

    //text_style.setFontStyle(SkFontStyle(500, SkFontStyle::kNormal_Width, SkFontStyle::kUpright_Slant));
    //builder.pushStyle(text_style);
    builder.addText(JKL);

    //text_style.setFontStyle(SkFontStyle(900, SkFontStyle::kNormal_Width, SkFontStyle::kUpright_Slant));
    //builder.pushStyle(text_style);
    builder.addText(mno);
...
DEF_TEST(SkParagraph_Bidi2, reporter) {
    ...
    text_style.setFontSize(40);
    text_style.setFontStyle(SkFontStyle(SkFontStyle::kThin_Weight, SkFontStyle::kNormal_Weight, SkFontStyle::kUpright_Slant));
    builder.pushStyle(text_style);
    builder.addText(abcD);

    text_style.setColor(SK_ColorRED);
    text_style.setFontSize(50);
    text_style.setFontStyle(SkFontStyle(SkFontStyle::kMedium_Weight, SkFontStyle::kNormal_Weight, SkFontStyle::kUpright_Slant));
    builder.pushStyle(text_style);
    builder.addText(EFgh);

    text_style.setColor(SK_ColorMAGENTA);
    text_style.setFontSize(60);
    text_style.setFontStyle(SkFontStyle(SkFontStyle::kExtraBold_Weight, SkFontStyle::kNormal_Weight, SkFontStyle::kUpright_Slant));
    builder.pushStyle(text_style);
