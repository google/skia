...
DEF_TEST(SkParagraph_InlinePlaceholderBaselineParagraph, reporter) {
    ...
    REPORTER_ASSERT(reporter, SkScalarNearlyEqual(boxes[0].rect.bottom(), 44.694, EPSILON100));
}
...
DEF_TEST(SkParagraph_InlinePlaceholderAboveBaselineParagraph, reporter) {
    ...
    PlaceholderStyle placeholder(55, 50, PlaceholderAlignment::kAboveBaseline, TextBaseline::kAlphabetic, 903129.129308);
    builder.addPlaceholder(placeholder);
    builder.addText(text);
...
DEF_TEST(SkParagraph_InlinePlaceholderBelowBaselineParagraph, reporter) {
    ...
    PlaceholderStyle placeholder(55, 50, PlaceholderAlignment::kBelowBaseline, TextBaseline::kAlphabetic, 903129.129308);
    builder.addPlaceholder(placeholder);
    builder.addText(text);
