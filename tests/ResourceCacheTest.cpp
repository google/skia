...
static sk_sp<GrRenderTarget> create_RT_with_SB(GrResourceProvider* provider,
    ...
    sk_sp<GrTexture> tex(provider->createTexture(desc, GrRenderable::kYes, budgeted, GrProtected::kNo,
...
static sk_sp<GrTextureProxy> make_mipmap_proxy(GrProxyProvider* proxyProvider,
    ...
    return proxyProvider->createMipMapProxy(format, desc, renderable, origin, SkBudgeted::kYes, GrProtected::kNo);
}
