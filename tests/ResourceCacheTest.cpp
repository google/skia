...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(ResourceCacheWrappedResources, reporter, ctxInfo) {
    ...
    backendTextures[0] = gpu->createTestingOnlyBackendTexture(
            nullptr, kW, kH, GrColorType::kRGBA_8888, GrSRGBEncoded::kNo, false, GrMipMapped::kNo);
    backendTextures[1] = gpu->createTestingOnlyBackendTexture(
            nullptr, kW, kH, GrColorType::kRGBA_8888, GrSRGBEncoded::kNo, false, GrMipMapped::kNo);
