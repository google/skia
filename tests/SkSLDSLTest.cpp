...
DEF_GPUTEST_FOR_MOCK_CONTEXT(DSLSwizzle, r, ctxInfo) {
    ...
    Expression e10 = Swizzle(a, R, G);
    REPORTER_ASSERT(r, e10.release()->description() == "a.xy");

    Expression e11 = Swizzle(a, R, G, B);
    REPORTER_ASSERT(r, e11.release()->description() == "a.xyz");
