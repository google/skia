...
DEF_GPUTEST_FOR_MOCK_CONTEXT(DSLModifiers, r, ctxInfo) {
    ...
    // uniforms aren't supposed to be created outside of a fragment processor, so instead of testing
    // the uniform flag here we have an end-to-end uniform test in dsl_processor_tests.cpp
}
