...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(AsyncReadPixels, reporter, ctxInfo) {
    ...
    for (auto origin : {kTopLeft_GrSurfaceOrigin, kBottomLeft_GrSurfaceOrigin}) {
        ...
        for (int sct = 0; sct <= kLastEnum_SkColorType; ++sct) {
            ...
            auto info = SkImageInfo::Make(kW, kH, surfCT, kPremul_SkAlphaType, SkColorSpace::MakeSRGB());
            ...
            for (int rct = 0; rct <= kLastEnum_SkColorType; ++rct) {
                ...
                for (const sk_sp<SkColorSpace>& readCS :
                    ...
                    auto refImg = refSurf->makeImageSnapshot()->makeColorTypeAndColorSpace(readCT, readCS);
                        ...
                        if (context.fSuceeded) {
                            ...
                            if (readCT != kUnknown_SkColorType && readCT != kGray_8_SkColorType &&
                                ...
                                ERRORF(reporter,
                                       ...
                                       SkColorTypeToStr(surfCT), SkColorTypeToStr(readCT),
                        ...
                        auto error = std::function<ComparePixmapsErrorReporter>(
                                [&](int x, int y, const float diffs[4]) {
                                    ...
                                    ERRORF(reporter,
                                           ...
                                           origin, (bool)readCS, x, y, diffs[0],
