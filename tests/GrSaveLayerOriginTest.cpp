...
static void run_test(skiatest::Reporter* reporter, GrContext* context, GrSurfaceOrigin origin) {
    ...
    DeleteBackendTexture(context, beTexture);
}

DEF_GPUTEST_FOR_RENDERING_CONTEXTS(GrSaveLayerOrigin, reporter, context_info) {
