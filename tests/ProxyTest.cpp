...
static void check_surface(skiatest::Reporter* reporter,
                          ...
                          const GrGpuResource::UniqueResourceID& uniqueID,
                          SkBudgeted budgeted) {
...
static void check_rendertarget(skiatest::Reporter* reporter,
    ...
    GrSurfaceProxy::UniqueProxyID idBefore = rtProxy->uniqueID();
...
static void check_texture(skiatest::Reporter* reporter,
                          ...
                          SkBackingFit fit,
                          bool wasWrapped) {
    GrSurfaceProxy::UniqueProxyID idBefore = texProxy->uniqueID();
...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(DeferredProxyTest, reporter, ctxInfo) {
    ...
    const GrGpuResource::UniqueResourceID kInvalidResourceID = 
                                                    GrGpuResource::UniqueResourceID::InvalidID();
                ...
                for (auto numSamples: { 0, 4}) {
                    ...
                    if (renderable && kOpenGL_GrBackend == ctxInfo.backend()) {
                        ...
                        check_rendertarget(reporter, provider, sProxy->asRenderTargetProxy(),
                                           numSamples, SkBackingFit::kExact, true);
                    }
