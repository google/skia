...
static void check_rendertarget(skiatest::Reporter* reporter,
    ...
    if (SkBackingFit::kExact == fit) {
        REPORTER_ASSERT(reporter, rt->dimensions() == rtProxy->size());
    } else {
...
static void check_texture(skiatest::Reporter* reporter,
    ...
    // NOTE: we store these before instantiating, since after instantiation worstCaseSize() just
    ...
    SkISize expectedSize = texProxy->worstCaseSize();
