...
DEF_TEST(thin_line, r) {
    SkPaint paint;  // set to default stroke width of zero, aliased
    canvas->drawLine(10, 10, 20, 60);
    paint.setAntiAlias(true);
    canvas->drawLine(30, 10, 40, 60);
    paint.setStrokeWidth(1);
    paint.setAntiAlias(false);
    canvas->drawLine(50, 10, 60, 60);
    paint.setAntiAlias(true);
    canvas->drawLine(70, 10, 80, 60);
}
