...
const char* ContextTypeName(sk_gpu_test::GrContextFactory::ContextType contextType) {
    switch (contextType) {
        case sk_gpu_test::GrContextFactory::kGL_ContextType:
            return "OpenGL";
        case sk_gpu_test::GrContextFactory::kGLES_ContextType:
            return "OpenGLES";
        case sk_gpu_test::GrContextFactory::kANGLE_D3D9_ES2_ContextType:
            return "ANGLE D3D9 ES2";
        case sk_gpu_test::GrContextFactory::kANGLE_D3D11_ES2_ContextType:
            return "ANGLE D3D11 ES2";
        case sk_gpu_test::GrContextFactory::kANGLE_D3D11_ES3_ContextType:
            return "ANGLE D3D11 ES3";
        case sk_gpu_test::GrContextFactory::kANGLE_GL_ES2_ContextType:
            return "ANGLE GL ES2";
        case sk_gpu_test::GrContextFactory::kANGLE_GL_ES3_ContextType:
            return "ANGLE GL ES3";
        case sk_gpu_test::GrContextFactory::kCommandBuffer_ContextType:
            return "Command Buffer";
        case sk_gpu_test::GrContextFactory::kMESA_ContextType:
            return "Mesa";
        case sk_gpu_test::GrContextFactory::kNullGL_ContextType:
            return "Null GL";
        case sk_gpu_test::GrContextFactory::kDebugGL_ContextType:
            return "Debug GL";
        case sk_gpu_test::GrContextFactory::kVulkan_ContextType:
            return "Vulkan";
    }
...
DEF_GPUTEST(SurfaceSemaphores, reporter, factory) {
    ...
    for (int typeInt = 0; typeInt < sk_gpu_test::GrContextFactory::kContextTypeCnt; ++typeInt) {
        ...
        skiatest::ReporterContext ctx(reporter, SkString(ContextTypeName(contextType)));
