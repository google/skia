...
void draw_child(skiatest::Reporter* reporter,
    ...
    sk_sp<SkSurface> childSurface(SkSurface::MakeRenderTarget(
            childCtx, SkBudgeted::kNo, childII, 1, GrFSAAType::kNone, kTopLeft_GrSurfaceOrigin,
            nullptr));
...
void surface_semaphore_test(skiatest::Reporter* reporter,
    ...
    sk_sp<SkSurface> mainSurface(SkSurface::MakeRenderTarget(
            mainCtx, SkBudgeted::kNo, ii, 1, GrFSAAType::kNone, kTopLeft_GrSurfaceOrigin, nullptr));
...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(EmptySurfaceSemaphoreTest, reporter, ctxInfo) {
    ...
    sk_sp<SkSurface> mainSurface(SkSurface::MakeRenderTarget(
            ctx, SkBudgeted::kNo, ii, 1, GrFSAAType::kNone, kTopLeft_GrSurfaceOrigin, nullptr));
