...
DEF_TEST(ParseConfigs_DefaultConfigs, reporter) {
    ...
    SkCommandLineFlags::StringArray config1 = make_string_array({
        ...
        "nonrendering", "null", "nullgpu", "nvpr16", "nvpr4", "glnvprdit16", "glesnvprdit4", "pdf",
        "skp", "svg", "xps", "angle_d3d11_es2", "angle_gl_es2", "commandbuffer", "mesa", "hwui",
        "gpuf16", "gpusrgb", "gl", "glnvpr4", "glnvprdit4", "glsrgb", "glmsaa4", "vk", "glinst",
        "glinst4", "glinstdit4", "glinst16", "glinstdit16", "glesinst", "glesinst4", "glesinstdit4",
        "glwide", "glnarrow"
    });
