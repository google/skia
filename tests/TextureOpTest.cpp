...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(TextureOpTest, reporter, ctxInfo) {
    ...
    OpsTaskTestingAccess::OpChain chain1(std::move(opA), arenas.recordTimeAllocator(),
    ...
    OpsTaskTestingAccess::OpChain chain2(std::move(opC), arenas.recordTimeAllocator(),
                                         GrProcessorSet::EmptySetAnalysis(),
                                         &noClip, nullptr);
