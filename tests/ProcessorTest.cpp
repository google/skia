...
bool legal_modulation(const GrColor& in1, const GrColor& in2, const GrColor& in3,
    ...
    SkPMColor4f expected1 = alphaModulation ? (fpPreModulation * in1f)
                                            : (fpPreModulation * in1f.fA);
    SkPMColor4f expected2 = alphaModulation ? (fpPreModulation * in2f)
                                            : (fpPreModulation * in2f.fA);
    SkPMColor4f expected3 = alphaModulation ? (fpPreModulation * in3f)
                                            : (fpPreModulation * in3f.fA);
