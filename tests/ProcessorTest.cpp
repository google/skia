...
public:
    ...
    gr_fp<GrFragmentProcessor> clone() const override {
        gr_fp<GrFragmentProcessor> child;
        ...
        return gr_fp<GrFragmentProcessor> (new TestFP(*this, std::move(child)));
    }
...
private:
    ...
    explicit TestFP(const TestFP& that, gr_fp<GrFragmentProcessor> child)
