...
void test_draw_op(GrSurfaceDrawContext* sdc, std::unique_ptr<GrFragmentProcessor> fp) {
    sdc->fillRectWithFP(SkIRect::MakeSize(sdc->dimensions()), std::move(fp));
}
