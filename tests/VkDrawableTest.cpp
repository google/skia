...
public:
    ...
    void drawBackendGpu(const GrBackendDrawableInfo& info, SubmitProc* proc,
                        SubmitContext* ctx) override {
    ...
    bool isGpuDrawSupported(GrBackend backend) override {
        return backend == kVulkan_GrBackend;
    }
