...
struct PromiseTextureChecker {
     ...
     * valid replacement.
     */
    SkDeferredDisplayListRecorder::PromiseImageTexture replaceTexture(
...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(PromiseImageTextureReuse, reporter, ctxInfo) {
    ...
    sk_sp<SkImage> refImg(SkImage_Gpu::MakePromiseTexture(
            ...
            PromiseTextureChecker::Release, PromiseTextureChecker::Done, &promiseChecker));
    ...
    SkDeferredDisplayListRecorder::PromiseImageTexture promiseImageTexture2 =
    ...
    sk_sp<SkImage> refImg2(SkImage_Gpu::MakePromiseTexture(
            ctx, backendFormat, kWidth, kHeight, GrMipMapped::kNo, texOrigin,
            kRGBA_8888_SkColorType, kPremul_SkAlphaType, nullptr, PromiseTextureChecker::Fulfill,
            PromiseTextureChecker::Release, PromiseTextureChecker::Done, &promiseChecker));
    canvas->drawImage(refImg, 0, 0);
