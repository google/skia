...
// Test initialization of GrBackendTextures to a specific color
static void test_compressed_color_init(GrContext* context,
    ...
    check_compressed_mipmaps(context, img, compression, expectedColors, mipMapped,
                             reporter, "colorinit");
    check_readback(context, std::move(img), color, reporter, "readback");
...
static void test_compressed_data_init(GrContext* context,
    ...
    check_readback(context, std::move(img), expectedColors[0], reporter, "readback");
