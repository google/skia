...
public:
    ...
    GrThreadSafeUniquelyKeyedCache* threadSafeCache() {
        return fDContext->priv().threadSafeCache();
    }
...
private:
    static GrSurfaceProxyView AccessCachedView(GrRecordingContext*,
                                               GrThreadSafeUniquelyKeyedCache*,
                                               int wh,
    ...
    static bool FillInViewOnGpu(GrDirectContext*, int wh, Stats*,
                                ...
                                sk_sp<GrThreadSafeUniquelyKeyedCache::Trampoline>);
...
bool TestHelper::FillInViewOnGpu(GrDirectContext* dContext, int wh, Stats* stats,
                                 const GrSurfaceProxyView& lazyView,
                                 sk_sp<GrThreadSafeUniquelyKeyedCache::Trampoline> trampoline) {
...
GrSurfaceProxyView TestHelper::AccessCachedView(
    ...
    if (GrDirectContext* dContext = rContext->asDirectContext()) {
        ...
        auto [lazyView, trampoline] = GrThreadSafeUniquelyKeyedCache::CreateLazyView(
