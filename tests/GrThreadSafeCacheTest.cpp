...
void TestHelper::addVertAccess(SkCanvas* canvas,
    ...
    if (GrDirectContext* dContext = rContext->asDirectContext()) {
        // The vertex variant doesn't have a correlate to lazyProxies but increment this here
...
// There is no vertex version of test_2 bc vertices always go through SW and don't have a lazy
// proxy equivalent.
