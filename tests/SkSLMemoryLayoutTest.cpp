...
DEF_TEST(SkSLMemoryLayout140Test, r) {
    ...
    std::unique_ptr<SkSL::Type> s1 = std::make_unique<SkSL::StructType>(-1, SkSL::String("s1"),
                                                                        fields1);
    ...
    std::unique_ptr<SkSL::Type> s2 = std::make_unique<SkSL::StructType>(-1, SkSL::String("s2"),
                                                                        fields1);
    ...
    std::unique_ptr<SkSL::Type> s3 = std::make_unique<SkSL::StructType>(-1, SkSL::String("s3"),
                                                                        fields1);
    ...
    std::unique_ptr<SkSL::Type> s4 = std::make_unique<SkSL::StructType>(-1, SkSL::String("s4"),
                                                                        fields2);
    ...
    fields2.emplace_back(SkSL::Modifiers(), skstd::string_view("b"),
                         context.fTypes.fFloat3.get());
    std::unique_ptr<SkSL::Type> s5 = std::make_unique<SkSL::StructType>(-1, SkSL::String("s5"),
                                                                        fields2);
