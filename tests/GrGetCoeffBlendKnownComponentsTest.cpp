...
DEF_TEST(GrGetCoeffBlendKnownComponents, reporter) {
    ...
    GrGetCoeffBlendKnownComponents(
        ...
        GrKnownColorComponents(0x80FF0100, (kG_GrColorComponentFlag | kB_GrColorComponentFlag | kA_GrColorComponentFlag)),
        GrKnownColorComponents(0x7F00FFFF, (kR_GrColorComponentFlag | kG_GrColorComponentFlag | kA_GrColorComponentFlag)),
        &outComponents);
    REPORTER_ASSERT(reporter, GrColor_WHITE == outComponents.color() && outComponents.isKnownColor());
    ...
    GrGetCoeffBlendKnownComponents(
        kOne_GrBlendCoeff, kISA_GrBlendCoeff,
        GrKnownColorComponents(0xFF808080, (kG_GrColorComponentFlag | kB_GrColorComponentFlag | kA_GrColorComponentFlag)),
        GrKnownColorComponents(0xFF606060, kRGBA_GrColorComponentFlags),
        &outComponents);
    REPORTER_ASSERT(reporter,
                    (kG_GrColorComponentFlag | kB_GrColorComponentFlag | kA_GrColorComponentFlag) == outComponents.knownComponentFlags() &&
