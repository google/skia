...
DEF_GPUTEST_FOR_VULKAN_CONTEXT(VkBackendSurfaceMutableStateTest, reporter, ctxInfo) {
    ...
    dContext->setBackendTextureState(backendTex, newState, nullptr, nullptr, &previousState);
    ...
    dContext->setBackendTextureState(backendTex, noopState, nullptr, nullptr, &previousState);
    REPORTER_ASSERT(reporter, backendTex.getVkImageInfo(&info));
    REPORTER_ASSERT(reporter, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL == info.fImageLayout);
    REPORTER_ASSERT(reporter, gpu->queueIndex() == info.fCurrentQueueFamily);
    ...
    if (gpu->vkCaps().supportsExternalMemory()) {
        ...
        dContext->setBackendTextureState(backendTex, externalState, nullptr, nullptr,
                                         &previousState);
        ...
        dContext->setBackendTextureState(backendTex, externalState2, nullptr, nullptr,
                                         &previousState);
