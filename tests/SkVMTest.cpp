...
DEF_TEST(SkVM_Assembler, r) {
    ...
    test_asm(r, [&](A& a) {
        ...
        a.vmovd(A::Direct{A::rax}, A::xmm0);
        a.vmovd(A::Direct{A::rax}, A::xmm8);
        a.vmovd(A::Direct{A::r8 },  A::xmm0);

        a.vmovd(A::xmm0, A::Direct{A::rax});
        a.vmovd(A::xmm8, A::Direct{A::rax});
        a.vmovd(A::xmm0, A::Direct{A::r8 });
