...
void test_read_pixels1(skiatest::Reporter* reporter,
...
void test_write_pixels1(skiatest::Reporter* reporter,
    ...
    test_read_pixels1(reporter, dstContext, pixels.get(), testName);
}
...
void test_copy_from_surface(skiatest::Reporter* reporter, GrContext* context,
    ...
    for (auto flags : { kNone_GrSurfaceFlags, kRenderTarget_GrSurfaceFlag }) {
        ...
        test_read_pixels1(reporter, dstContext.get(), expectedPixelValues, testName);
    }
}

void test_copy_to_surface1(skiatest::Reporter* reporter, GrResourceProvider* resourceProvider,
