...
// This test fuzzes all the combinations of these rects to test out the 
// GrTextureProducer::DetermineDomainMode method.
...
static const GrTextureProducer_TestAccess::DomainMode kNoDomain_DomainMode = 
                                GrTextureProducer_TestAccess::DomainMode::kNoDomain_DomainMode;
static const GrTextureProducer_TestAccess::DomainMode kDomain_DomainMode =
                                GrTextureProducer_TestAccess::DomainMode::kDomain_DomainMode;
static const GrTextureProducer_TestAccess::DomainMode kTightCopy_DomainMode =
                                GrTextureProducer_TestAccess::DomainMode::kTightCopy_DomainMode;
                            ...
                            for (auto constraintRectMaker : { left_only, top_only, right_only,
                                ...
                                for (auto insetAmt : { 0.25f, 0.75f, 1.25f, 1.75f, 5.0f }) {
                                    ...
                                    if (contentRect) {
                                        ...
                                        outermost.rect().contains(*constraintRect);
                                    }
                                    ...
                                    expectedMode = kNoDomain_DomainMode;
                                    if (constraintRectStorage.hasABad()) {
                                        if (3 == filterMode) {
                                            expectedMode = kTightCopy_DomainMode;
                                        } else {
                                            expectedMode = kDomain_DomainMode;
                                        }
                                    }
