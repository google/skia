...
DEF_TEST(Vertices, reporter) {
    ...
    {   // negative count is bad
        SkVertices::Builder builder(SkVertices::kTriangleFan_VertexMode, 10, 0, -1);
        REPORTER_ASSERT(reporter, !builder.isValid());
    }
    {   // zero-per-vertex-data should be ok
        SkVertices::Builder builder(SkVertices::kTriangleFan_VertexMode, 10, 0, 0);
        REPORTER_ASSERT(reporter, builder.isValid());
    ...
    {   // "normal" number of per-vertex-data
        SkVertices::Builder builder(SkVertices::kTriangleFan_VertexMode, 10, 0, 4);
        REPORTER_ASSERT(reporter, builder.isValid());
