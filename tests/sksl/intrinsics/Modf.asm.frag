          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %value "value"                    ; id %23
               OpName %ok "ok"                          ; id %30
               OpName %whole "whole"                    ; id %36
               OpName %fraction "fraction"              ; id %37
...
%_entrypoint_v = OpFunction %void None %12
   ...
   %fraction =   OpVariable %_ptr_Function_v4float Function
        ...
        %122 =   OpAccessChain %_ptr_Function_bool %ok %int_3
                 OpStore %122 %121
        %125 =   OpLoad %v4bool %ok                 ; RelaxedPrecision
        %124 =   OpAll %bool %125
        ...
        %132 =       OpLoad %v4float %130           ; RelaxedPrecision
                     OpStore %126 %132
                     OpBranch %129
        ...
        %129 = OpLabel
        %135 =   OpLoad %v4float %126               ; RelaxedPrecision
                 OpReturnValue %135
               OpFunctionEnd
