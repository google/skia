...
%_entrypoint_v = OpFunction %void None %12
  ...
  %expectedB =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
        %165 =   OpVariable %_ptr_Function_v4float Function
         ...
         %34 =   OpExtInst %float %1 FMax %40 %float_0_5    ; RelaxedPrecision
         ...
         %44 =       OpExtInst %v2float %1 FMax %47 %48     ; RelaxedPrecision
         %49 =       OpVectorShuffle %v2float %28 %28 0 1   ; RelaxedPrecision
         ...
         %56 =       OpExtInst %v3float %1 FMax %59 %61         ; RelaxedPrecision
         ...
         %69 =       OpExtInst %v4float %1 FMax %71 %72     ; RelaxedPrecision
         ...
         %81 =     OpLabel
         %83 =       OpVectorShuffle %v2float %28 %28 0 1   ; RelaxedPrecision
         ...
         %87 =     OpLabel
         %90 =       OpVectorShuffle %v3float %28 %28 0 1 2     ; RelaxedPrecision
        ...
        %106 =       OpCompositeExtract %float %105 0   ; RelaxedPrecision
         %99 =       OpExtInst %float %1 FMax %102 %106     ; RelaxedPrecision
        ...
        %111 =       OpExtInst %v2float %1 FMax %114 %117       ; RelaxedPrecision
        %118 =       OpVectorShuffle %v2float %31 %31 0 1       ; RelaxedPrecision
        ...
        %124 =       OpExtInst %v3float %1 FMax %127 %130       ; RelaxedPrecision
        %131 =       OpVectorShuffle %v3float %31 %31 0 1 2     ; RelaxedPrecision
        ...
        %137 =       OpExtInst %v4float %1 FMax %139 %141   ; RelaxedPrecision
        ...
        %148 =     OpLabel
        %151 =       OpVectorShuffle %v2float %31 %31 0 1   ; RelaxedPrecision
        ...
        %155 =     OpLabel
        %158 =       OpVectorShuffle %v3float %31 %31 0 1 2     ; RelaxedPrecision
        ...
        %173 =       OpLoad %v4float %171           ; RelaxedPrecision
                     OpStore %165 %173
                     OpBranch %168

        %168 = OpLabel
        %174 =   OpLoad %v4float %165               ; RelaxedPrecision
                 OpReturnValue %174
               OpFunctionEnd
