...
%_ptr_Uniform_uint = OpTypePointer Uniform %uint
    ...
    %v2float = OpTypeVector %float 2
       ...
       %main = OpFunction %void None %12
         ...
         %21 =   OpLoad %v4float %sk_FragColor      ; RelaxedPrecision
         %22 =   OpVectorShuffle %v4float %21 %14 4 5 2 3   ; RelaxedPrecision
                 OpStore %sk_FragColor %22
         %24 =   OpAccessChain %_ptr_Uniform_uint %7 %int_0
         %25 =   OpLoad %uint %24
         %23 =   OpExtInst %v2float %1 UnpackUnorm2x16 %25
         %26 =   OpLoad %v4float %sk_FragColor      ; RelaxedPrecision
         %27 =   OpVectorShuffle %v4float %26 %23 4 5 2 3   ; RelaxedPrecision
                 OpStore %sk_FragColor %27
         %29 =   OpAccessChain %_ptr_Uniform_uint %7 %int_0
         %30 =   OpLoad %uint %29
         %28 =   OpExtInst %v2float %1 UnpackSnorm2x16 %30
         %31 =   OpLoad %v4float %sk_FragColor      ; RelaxedPrecision
         %32 =   OpVectorShuffle %v4float %31 %28 4 5 2 3   ; RelaxedPrecision
