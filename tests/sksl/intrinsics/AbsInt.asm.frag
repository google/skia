...
%_entrypoint_v = OpFunction %void None %12
   ...
   %expected =   OpVariable %_ptr_Function_v4int Function
        %116 =   OpVariable %_ptr_Function_v4float Function
         ...
         %64 =       OpCompositeExtract %float %62 0            ; RelaxedPrecision
         %65 =       OpConvertFToS %int %64
         %66 =       OpCompositeExtract %float %62 1    ; RelaxedPrecision
         %67 =       OpConvertFToS %int %66
         %68 =       OpCompositeExtract %float %62 2    ; RelaxedPrecision
         ...
         %84 =       OpCompositeExtract %float %81 1    ; RelaxedPrecision
         %85 =       OpConvertFToS %int %84
         %86 =       OpCompositeExtract %float %81 2    ; RelaxedPrecision
         %87 =       OpConvertFToS %int %86
         %88 =       OpCompositeExtract %float %81 3    ; RelaxedPrecision
        ...
        %120 = OpLabel
        %125 =   OpLoad %v4float %116               ; RelaxedPrecision
                 OpReturnValue %125
               OpFunctionEnd
