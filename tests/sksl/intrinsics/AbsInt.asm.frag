...
%104 = OpVectorShuffle %v4int %103 %103 0 1 2 3
%92 = OpExtInst %v4int %1 SAbs %104
%105 = OpLoad %v4int %expected
%106 = OpVectorShuffle %v4int %105 %105 0 1 2 3
%107 = OpIEqual %v4bool %92 %106
%109 = OpAll %bool %107
OpBranch %91
%91 = OpLabel
%110 = OpPhi %bool %false %69 %109 %90
