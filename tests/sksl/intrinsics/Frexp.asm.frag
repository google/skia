          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %checkIntrinsicAsFunctionArg_bf3i3 "checkIntrinsicAsFunctionArg_bf3i3"    ; id %2
               OpName %main "main"                                                              ; id %3
               OpName %value "value"                                                            ; id %49
               OpName %exp "exp"                                                                ; id %58
               OpName %result "result"                                                          ; id %61
               OpName %ok "ok"                                                                  ; id %62
               OpName %funcOk "funcOk"                                                          ; id %134
...
%checkIntrinsicAsFunctionArg_bf3i3 = OpFunction %bool None %27
     ...
     %funcOk =   OpVariable %_ptr_Function_bool Function
        ...
        %152 =   OpVariable %_ptr_Function_v4float Function
         ...
         %54 =   OpLoad %v4float %51                ; RelaxedPrecision
         %55 =   OpVectorShuffle %v4float %54 %54 1 1 1 1   ; RelaxedPrecision
         %57 =   OpVectorTimesScalar %v4float %55 %float_6  ; RelaxedPrecision
                 OpStore %value %57
        ...
        %146 =   OpFunctionCall %bool %checkIntrinsicAsFunctionArg_bf3i3 %143 %145
                 OpStore %funcOk %146
        %148 =   OpLoad %v4bool %ok                 ; RelaxedPrecision
        %147 =   OpAll %bool %148
        ...
        %159 =       OpLoad %v4float %158           ; RelaxedPrecision
                     OpStore %152 %159
                     OpBranch %155

        %155 = OpLabel
        %160 =   OpLoad %v4float %152               ; RelaxedPrecision
                 OpReturnValue %160
               OpFunctionEnd
