          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %intGreen "intGreen"              ; id %23
               OpName %intRed "intRed"                  ; id %42
...
%_entrypoint_v = OpFunction %void None %12
   ...
   %intGreen =   OpVariable %_ptr_Function_v4int Function
     %intRed =   OpVariable %_ptr_Function_v4int Function
        ...
        %188 =       OpLoad %v4float %187           ; RelaxedPrecision
        %189 =       OpCompositeExtract %float %188 0   ; RelaxedPrecision
        ...
        %186 =       OpSelect %float %false %198 %195   ; RelaxedPrecision
        ...
        %209 =       OpVectorShuffle %v2float %208 %208 0 1     ; RelaxedPrecision
        ...
        %206 =       OpSelect %v2float %69 %218 %215            ; RelaxedPrecision
        ...
        %230 =       OpVectorShuffle %v3float %229 %229 0 1 2   ; RelaxedPrecision
        %232 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_1
        %233 =       OpLoad %v4float %232           ; RelaxedPrecision
        %234 =       OpVectorShuffle %v3float %233 %233 0 1 2   ; RelaxedPrecision
        ...
        %227 =       OpSelect %v3float %83 %240 %237            ; RelaxedPrecision
        ...
        %251 =       OpLoad %v4float %250           ; RelaxedPrecision
        %252 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_1
        %253 =       OpLoad %v4float %252           ; RelaxedPrecision
        %254 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_0
        %255 =       OpLoad %v4float %254           ; RelaxedPrecision
        %256 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_1
        %257 =       OpLoad %v4float %256           ; RelaxedPrecision
        %249 =       OpSelect %v4float %94 %257 %255    ; RelaxedPrecision
        %258 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_0
        %259 =       OpLoad %v4float %258           ; RelaxedPrecision
        ...
        %267 =       OpLoad %v4float %266           ; RelaxedPrecision
        %268 =       OpCompositeExtract %float %267 0   ; RelaxedPrecision
        ...
        %265 =       OpSelect %float %true %277 %274    ; RelaxedPrecision
        ...
        %288 =       OpVectorShuffle %v2float %287 %287 0 1     ; RelaxedPrecision
        ...
        %285 =       OpSelect %v2float %109 %297 %294           ; RelaxedPrecision
        ...
        %308 =       OpLoad %v4float %307           ; RelaxedPrecision
        %309 =       OpVectorShuffle %v3float %308 %308 0 1 2   ; RelaxedPrecision
        ...
        %306 =       OpSelect %v3float %121 %318 %315           ; RelaxedPrecision
        ...
        %331 =       OpLoad %v4float %330           ; RelaxedPrecision
        %332 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_0
        %333 =       OpLoad %v4float %332           ; RelaxedPrecision
        %334 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_1
        %335 =       OpLoad %v4float %334           ; RelaxedPrecision
        %327 =       OpSelect %v4float %131 %335 %333   ; RelaxedPrecision
        %336 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_1
        %337 =       OpLoad %v4float %336           ; RelaxedPrecision
        ...
        %344 =       OpLoad %v4float %343           ; RelaxedPrecision
        %345 =       OpCompositeExtract %float %344 0   ; RelaxedPrecision
        ...
        %353 =       OpLoad %v4float %352           ; RelaxedPrecision
        %354 =       OpVectorShuffle %v2float %353 %353 0 1     ; RelaxedPrecision
        ...
        %363 =       OpVectorShuffle %v3float %362 %362 0 1 2   ; RelaxedPrecision
        ...
        %378 =       OpLoad %v4float %377           ; RelaxedPrecision
        %379 =       OpCompositeExtract %float %378 0   ; RelaxedPrecision
        ...
        %386 =       OpLoad %v4float %385           ; RelaxedPrecision
        %387 =       OpVectorShuffle %v2float %386 %386 0 1     ; RelaxedPrecision
        ...
        %395 =       OpLoad %v4float %394           ; RelaxedPrecision
        %396 =       OpVectorShuffle %v3float %395 %395 0 1 2   ; RelaxedPrecision
        ...
        %404 =       OpLoad %v4float %403           ; RelaxedPrecision
        ...
        %414 =       OpLoad %v4float %413           ; RelaxedPrecision
                     OpStore %408 %414
                     OpBranch %412

        %411 =     OpLabel
        %415 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_1
        %416 =       OpLoad %v4float %415           ; RelaxedPrecision
                     OpStore %408 %416
                     OpBranch %412

        %412 = OpLabel
        %417 =   OpLoad %v4float %408               ; RelaxedPrecision
                 OpReturnValue %417
               OpFunctionEnd
