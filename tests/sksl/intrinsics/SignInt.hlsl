...
float4 main(float2 _24)
{
    ...
    bool _61 = false;
    if (sign(int(_10_testInputs.x)) == expected.x)
    {
        int2 _46 = sign(int2(int(_10_testInputs.xy.x), int(_10_testInputs.xy.y)));
    ...
    if (_61)
    {
        int3 _64 = sign(int3(int(_10_testInputs.xyz.x), int(_10_testInputs.xyz.y), int(_10_testInputs.xyz.z)));
    ...
    if (_82)
    {
        int4 _85 = sign(int4(int(_10_testInputs.x), int(_10_testInputs.y), int(_10_testInputs.z), int(_10_testInputs.w)));
    ...
    if (_123)
    {
        _129 = all(bool4(int4(-1, 0, 0, 1).x == expected.x, int4(-1, 0, 0, 1).y == expected.y, int4(-1, 0, 0, 1).z == expected.z, int4(-1, 0, 0, 1).w == expected.w));
    }
    else
    {
        _129 = false;
