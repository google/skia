...
%_entrypoint_v = OpFunction %void None %12
       ...
       %main = OpFunction %v4float None %20         ; RelaxedPrecision
        ...
        %107 =   OpVariable %_ptr_Function_v4float Function
         ...
         %25 =   OpExtInst %float %1 Tanh %31       ; RelaxedPrecision
         ...
         %39 =       OpExtInst %v2float %1 Tanh %42         ; RelaxedPrecision
         ...
         %52 =       OpExtInst %v3float %1 Tanh %55             ; RelaxedPrecision
         ...
         %66 =       OpExtInst %v4float %1 Tanh %68     ; RelaxedPrecision
