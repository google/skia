          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %expectedBW "expectedBW"          ; id %23
               OpName %expectedWT "expectedWT"          ; id %28
...
%_entrypoint_v = OpFunction %void None %12
 ...
 %expectedWT =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
        %230 =   OpVariable %_ptr_Function_v4float Function
         ...
         %33 =   OpExtInst %v4float %1 FMix %38 %41 %42     ; RelaxedPrecision
         ...
         %49 =       OpExtInst %v4float %1 FMix %51 %53 %55     ; RelaxedPrecision
         ...
         %63 =       OpExtInst %v4float %1 FMix %65 %67 %68     ; RelaxedPrecision
         ...
         %75 =       OpExtInst %v4float %1 FMix %77 %79 %80     ; RelaxedPrecision
         ...
         %91 =       OpCompositeExtract %float %90 0    ; RelaxedPrecision
         ...
         %87 =       OpExtInst %float %1 FMix %91 %95 %float_0_5    ; RelaxedPrecision
        ...
        %100 =       OpExtInst %v2float %1 FMix %103 %106 %107  ; RelaxedPrecision
        %108 =       OpVectorShuffle %v2float %27 %27 0 1       ; RelaxedPrecision
        ...
        %122 =       OpVectorShuffle %v3float %121 %121 0 1 2   ; RelaxedPrecision
        %115 =       OpExtInst %v3float %1 FMix %118 %122 %123  ; RelaxedPrecision
        %124 =       OpVectorShuffle %v3float %27 %27 0 1 2     ; RelaxedPrecision
        ...
        %131 =       OpExtInst %v4float %1 FMix %133 %135 %136  ; RelaxedPrecision
        ...
        %144 =     OpLabel
        %146 =       OpVectorShuffle %v2float %27 %27 0 1   ; RelaxedPrecision
        ...
        %150 =     OpLabel
        %152 =       OpVectorShuffle %v3float %27 %27 0 1 2     ; RelaxedPrecision
        ...
        %167 =       OpLoad %v4float %165           ; RelaxedPrecision
        %168 =       OpCompositeExtract %float %167 0   ; RelaxedPrecision
        %161 =       OpExtInst %float %1 FMix %164 %168 %float_0    ; RelaxedPrecision
        ...
        %176 =       OpVectorShuffle %v2float %175 %175 0 1     ; RelaxedPrecision
        ...
        %173 =       OpExtInst %v2float %1 FMix %176 %179 %180  ; RelaxedPrecision
        %181 =       OpVectorShuffle %v2float %30 %30 0 1       ; RelaxedPrecision
        ...
        %187 =       OpExtInst %v3float %1 FMix %190 %193 %194  ; RelaxedPrecision
        %195 =       OpVectorShuffle %v3float %30 %30 0 1 2     ; RelaxedPrecision
        ...
        %201 =       OpExtInst %v4float %1 FMix %203 %205 %206  ; RelaxedPrecision
        ...
        %213 =     OpLabel
        %216 =       OpVectorShuffle %v2float %30 %30 0 1   ; RelaxedPrecision
        ...
        %220 =     OpLabel
        %223 =       OpVectorShuffle %v3float %30 %30 0 1 2     ; RelaxedPrecision
        ...
        %237 =       OpLoad %v4float %236           ; RelaxedPrecision
                     OpStore %230 %237
                     OpBranch %233

        %233 = OpLabel
        %238 =   OpLoad %v4float %230               ; RelaxedPrecision
                 OpReturnValue %238
               OpFunctionEnd
