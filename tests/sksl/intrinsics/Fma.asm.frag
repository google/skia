          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %one "one"                        ; id %26
               OpName %two "two"                        ; id %35
               OpName %three "three"                    ; id %40
               OpName %four "four"                      ; id %44
               OpName %five "five"                      ; id %49
...
%_entrypoint_v = OpFunction %void None %15
         ...
         %22 =   OpFunctionCall %v4float %main %20
               ...
               ; Function main
       %main = OpFunction %v4float None %23         ; RelaxedPrecision
      ...
      %three =   OpVariable %_ptr_Function_float Function
       ...
       %five =   OpVariable %_ptr_Function_float Function   ; RelaxedPrecision
         ...
         %59 =     OpLabel
         %61 =       OpExtInst %float %1 Fma %43 %48 %53    ; RelaxedPrecision
