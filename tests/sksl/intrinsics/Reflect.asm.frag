          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %expectedX "expectedX"            ; id %23
               OpName %expectedXY "expectedXY"          ; id %29
               OpName %expectedXYZ "expectedXYZ"        ; id %33
               OpName %expectedXYZW "expectedXYZW"      ; id %40
...
%expectedXYZW =   OpVariable %_ptr_Function_v4float Function    ; RelaxedPrecision
        %111 =   OpVariable %_ptr_Function_v4float Function
         %25 =   OpExtInst %float %1 Reflect %float_996878592 %float_n1_99999996e_34    ; RelaxedPrecision
         ...
         %54 =   OpLoad %v4float %50                ; RelaxedPrecision
         ...
         %49 =   OpExtInst %float %1 Reflect %55 %59    ; RelaxedPrecision
         ...
         %63 =       OpExtInst %v2float %1 Reflect %66 %69  ; RelaxedPrecision
         ...
         %79 =       OpVectorShuffle %v3float %78 %78 0 1 2     ; RelaxedPrecision
         ...
         %76 =       OpExtInst %v3float %1 Reflect %79 %82      ; RelaxedPrecision
         ...
         %89 =       OpExtInst %v4float %1 Reflect %91 %93  ; RelaxedPrecision
        ...
        %114 = OpLabel
        %121 =   OpLoad %v4float %111               ; RelaxedPrecision
                 OpReturnValue %121
               OpFunctionEnd
