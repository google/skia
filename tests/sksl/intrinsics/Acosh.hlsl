...
float4 main(float2 _21)
{
    ...
    if (_99)
    {
        _108 = all(bool4(float4(0.0f, 0.0f, 1.0f, 2.0f).x == _7_expected.x, float4(0.0f, 0.0f, 1.0f, 2.0f).y == _7_expected.y, float4(0.0f, 0.0f, 1.0f, 2.0f).z == _7_expected.z, float4(0.0f, 0.0f, 1.0f, 2.0f).w == _7_expected.w));
    }
    else
    {
        _108 = false;
