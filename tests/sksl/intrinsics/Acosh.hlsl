...
float4 main(float2 _25)
{
    ...
    if (_102)
    {
        _111 = all(bool4(float4(0.0f, 0.0f, 1.0f, 2.0f).x == _11_expected.x, float4(0.0f, 0.0f, 1.0f, 2.0f).y == _11_expected.y, float4(0.0f, 0.0f, 1.0f, 2.0f).z == _11_expected.z, float4(0.0f, 0.0f, 1.0f, 2.0f).w == _11_expected.w));
    }
    else
    {
        _111 = false;
