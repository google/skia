...
%_ptr_Uniform_v4float = OpTypePointer Uniform %v4float
    ...
    %float_2 = OpConstant %float 2
         %95 = OpConstantComposite %v3float %float_0 %float_1 %float_2
    %float_3 = OpConstant %float 3
        %105 = OpConstantComposite %v4float %float_0 %float_1 %float_2 %float_3
...
%_entrypoint_v = OpFunction %void None %12
       ...
       %main = OpFunction %v4float None %20         ; RelaxedPrecision
        ...
        %111 =   OpVariable %_ptr_Function_v4float Function
         ...
         %25 =   OpExtInst %float %1 Log2 %31       ; RelaxedPrecision
         ...
         %39 =       OpExtInst %v2float %1 Log2 %42         ; RelaxedPrecision
         ...
         %52 =       OpExtInst %v3float %1 Log2 %55             ; RelaxedPrecision
         ...
         %66 =       OpExtInst %v4float %1 Log2 %68     ; RelaxedPrecision
        ...
        %115 = OpLabel
        %122 =   OpLoad %v4float %111               ; RelaxedPrecision
                 OpReturnValue %122
               OpFunctionEnd
