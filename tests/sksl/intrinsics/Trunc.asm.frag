...
%_ptr_Uniform_v4float = OpTypePointer Uniform %v4float
   ...
   %float_n1 = OpConstant %float -1
    ...
    %v3float = OpTypeVector %float 3
         %55 = OpConstantComposite %v3float %float_n1 %float_0 %float_0
     %v3bool = OpTypeVector %bool 3
    %float_2 = OpConstant %float 2
         %66 = OpConstantComposite %v4float %float_n1 %float_0 %float_0 %float_2
...
%_entrypoint_v = OpFunction %void None %16
       ...
       %main = OpFunction %v4float None %24         ; RelaxedPrecision
         ...
         %29 =   OpExtInst %float %5 Trunc %34      ; RelaxedPrecision
         ...
         %39 =       OpExtInst %v2float %5 Trunc %42        ; RelaxedPrecision
         ...
         %50 =       OpExtInst %v3float %5 Trunc %53            ; RelaxedPrecision
         ...
         %62 =       OpExtInst %v4float %5 Trunc %64    ; RelaxedPrecision
