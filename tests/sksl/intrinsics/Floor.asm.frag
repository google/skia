...
%_ptr_Function_v4float = OpTypePointer Function %v4float
   %float_n2 = OpConstant %float -2
    %float_2 = OpConstant %float 2
         %31 = OpConstantComposite %v4float %float_n2 %float_0 %float_0 %float_2
       %bool = OpTypeBool
    ...
    %v3float = OpTypeVector %float 3
     ...
     %v4bool = OpTypeVector %bool 4
       %true = OpConstantTrue %bool
         %79 = OpConstantComposite %v2float %float_n2 %float_0
         %86 = OpConstantComposite %v3float %float_n2 %float_0 %float_0
...
%_entrypoint_v = OpFunction %void None %16
   ...
   %expected =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
         ...
         %34 =   OpExtInst %float %5 Floor %39      ; RelaxedPrecision
         %40 =   OpFOrdEqual %bool %34 %float_n2
         ...
         %43 =       OpExtInst %v2float %5 Floor %46        ; RelaxedPrecision
         ...
         %54 =       OpExtInst %v3float %5 Floor %57            ; RelaxedPrecision
         ...
         %66 =       OpExtInst %v4float %5 Floor %68    ; RelaxedPrecision
