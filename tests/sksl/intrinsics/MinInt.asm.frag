          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %intValues "intValues"            ; id %23
               OpName %intGreen "intGreen"              ; id %42
               OpName %expectedA "expectedA"            ; id %56
               OpName %expectedB "expectedB"            ; id %60
...
%_entrypoint_v = OpFunction %void None %12
  ...
  %expectedB =   OpVariable %_ptr_Function_v4int Function
        %168 =   OpVariable %_ptr_Function_v4float Function
         ...
         %32 =   OpVectorTimesScalar %v4float %30 %float_100    ; RelaxedPrecision
         ...
         %46 =   OpVectorTimesScalar %v4float %45 %float_100    ; RelaxedPrecision
         %47 =   OpCompositeExtract %float %46 0                ; RelaxedPrecision
         %48 =   OpConvertFToS %int %47
         %49 =   OpCompositeExtract %float %46 1    ; RelaxedPrecision
         %50 =   OpConvertFToS %int %49
         %51 =   OpCompositeExtract %float %46 2    ; RelaxedPrecision
         %52 =   OpConvertFToS %int %51
         %53 =   OpCompositeExtract %float %46 3    ; RelaxedPrecision
