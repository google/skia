...
%104 = OpLabel
%106 = OpFOrdEqual %bool %float_n1 %float_n1
OpBranch %105
%105 = OpLabel
%107 = OpPhi %bool %false %92 %106 %104
...
%122 = OpLabel
%124 = OpFOrdEqual %v4bool %32 %32
%125 = OpAll %bool %124
OpBranch %123
%123 = OpLabel
%126 = OpPhi %bool %false %116 %125 %122
...
OpBranch %130
%129 = OpLabel
%134 = OpAccessChain %_ptr_Uniform_v4float %10 %int_4
