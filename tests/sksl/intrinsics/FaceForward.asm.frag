          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %huge "huge"                      ; id %23
               OpName %huge2 "huge2"                    ; id %28
               OpName %huge3 "huge3"                    ; id %32
               OpName %huge4 "huge4"                    ; id %38
               OpName %expectedPos "expectedPos"        ; id %43
               OpName %expectedNeg "expectedNeg"        ; id %47
...
%expectedNeg =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
        %146 =   OpVariable %_ptr_Function_v4float Function
         %25 =   OpExtInst %float %1 FaceForward %float_1 %float_1_00000002e_30 %float_1_00000002e_30   ; RelaxedPrecision
                 OpStore %huge %25
         ...
         %76 =   OpCompositeExtract %float %75 0    ; RelaxedPrecision
         %62 =   OpExtInst %float %1 FaceForward %68 %72 %76    ; RelaxedPrecision
         ...
         %80 =       OpExtInst %v2float %1 FaceForward %83 %86 %89  ; RelaxedPrecision
         %90 =       OpVectorShuffle %v2float %59 %59 0 1           ; RelaxedPrecision
        ...
        %106 =       OpVectorShuffle %v3float %105 %105 0 1 2   ; RelaxedPrecision
         %97 =       OpExtInst %v3float %1 FaceForward %100 %103 %106   ; RelaxedPrecision
        %107 =       OpVectorShuffle %v3float %54 %54 0 1 2             ; RelaxedPrecision
        ...
        %114 =       OpExtInst %v4float %1 FaceForward %116 %118 %120   ; RelaxedPrecision
        ...
        %129 =     OpLabel
        %132 =       OpVectorShuffle %v2float %59 %59 0 1   ; RelaxedPrecision
        ...
        %136 =     OpLabel
        %139 =       OpVectorShuffle %v3float %54 %54 0 1 2     ; RelaxedPrecision
        ...
        %152 =       OpLoad %v4float %150           ; RelaxedPrecision
                     OpStore %146 %152
                     OpBranch %149
        ...
        %149 = OpLabel
        %156 =   OpLoad %v4float %146               ; RelaxedPrecision
                 OpReturnValue %156
               OpFunctionEnd
