...
%_ptr_Uniform_v4float = OpTypePointer Uniform %v4float
    ...
    %float_2 = OpConstant %float 2
        %106 = OpConstantComposite %v4float %float_0 %float_0 %float_1 %float_2
...
%_entrypoint_v = OpFunction %void None %16
       ...
       %main = OpFunction %v4float None %24         ; RelaxedPrecision
        ...
        %112 =   OpVariable %_ptr_Function_v4float Function
         ...
         %29 =   OpExtInst %float %5 Acosh %34      ; RelaxedPrecision
         ...
         %42 =       OpExtInst %v2float %5 Acosh %45        ; RelaxedPrecision
         ...
         %55 =       OpExtInst %v3float %5 Acosh %58            ; RelaxedPrecision
         ...
         %69 =       OpExtInst %v4float %5 Acosh %71    ; RelaxedPrecision
