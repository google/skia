...
%_ptr_Uniform_v4float = OpTypePointer Uniform %v4float
    ...
    %float_1 = OpConstant %float 1
         ...
         %96 = OpConstantComposite %v2float %float_0 %float_1
...
%_entrypoint_v = OpFunction %void None %16
   ...
   %expected =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
        %100 =   OpVariable %_ptr_Function_v4float Function
         ...
         %32 =   OpDPdy %float %37                  ; RelaxedPrecision
         ...
         %41 =       OpDPdy %v2float %44                    ; RelaxedPrecision
         ...
         %52 =       OpDPdy %v3float %55                        ; RelaxedPrecision
         ...
         %64 =       OpDPdy %v4float %66            ; RelaxedPrecision
         ...
         %74 =       OpDPdy %v2float %76
         %73 =       OpExtInst %v2float %5 FSign %74
         %77 =       OpFOrdEqual %v2bool %73 %20
         %78 =       OpAll %bool %77
                     OpBranch %72

         %72 = OpLabel
         %79 =   OpPhi %bool %false %63 %78 %71
                 OpSelectionMerge %81 None
                 OpBranchConditional %79 %80 %81

         %80 =     OpLabel
         %84 =       OpLoad %v2float %25
         %85 =       OpVectorShuffle %v2float %84 %84 1 1
         %83 =       OpDPdy %v2float %85
         %82 =       OpExtInst %v2float %5 FSign %83
         %88 =       OpFOrdEqual %v2bool %82 %87
         %89 =       OpAll %bool %88
                     OpBranch %81

         %81 = OpLabel
         %90 =   OpPhi %bool %false %72 %89 %80
                 OpSelectionMerge %92 None
                 OpBranchConditional %90 %91 %92

         %91 =     OpLabel
         %95 =       OpLoad %v2float %25
         %94 =       OpDPdy %v2float %95
