...
fn _skslMain(coords: vec2<f32>) -> vec4<f32> {
  {
    let _skTemp0 = acos(_globalUniforms.inputVal.x);
    let _skTemp1 = acos(_globalUniforms.inputVal.xy);
    let _skTemp2 = acos(_globalUniforms.inputVal.xyz);
    let _skTemp3 = acos(_globalUniforms.inputVal);
