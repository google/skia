          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %uintGreen "uintGreen"            ; id %44
               OpName %expectedA "expectedA"            ; id %58
 ...
 %uintValues =   OpVariable %_ptr_Function_v4uint Function
  ...
  %expectedB =   OpVariable %_ptr_Function_v4uint Function
        %173 =   OpVariable %_ptr_Function_v4float Function
         ...
         %27 =   OpExtInst %v4float %1 FAbs %32     ; RelaxedPrecision
         %34 =   OpVectorTimesScalar %v4float %27 %float_100    ; RelaxedPrecision
         ...
         %48 =   OpVectorTimesScalar %v4float %47 %float_100    ; RelaxedPrecision
        ...
        %182 =       OpLoad %v4float %180           ; RelaxedPrecision
                     OpStore %173 %182
                     OpBranch %177

        %177 = OpLabel
        %183 =   OpLoad %v4float %173               ; RelaxedPrecision
                 OpReturnValue %183
               OpFunctionEnd
