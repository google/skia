...
%_ptr_Uniform_v4float = OpTypePointer Uniform %v4float
      %int_1 = OpConstant %int 1
       ...
       %main = OpFunction %void None %12
         ...
         %19 =   OpLoad %v2float %15                ; RelaxedPrecision
         %14 =   OpExtInst %uint %1 PackHalf2x16 %19
         %21 =   OpConvertUToF %float %14           ; RelaxedPrecision
         ...
         %39 =   OpConvertUToF %float %34           ; RelaxedPrecision
         ...
         %44 =   OpConvertUToF %float %41           ; RelaxedPrecision
