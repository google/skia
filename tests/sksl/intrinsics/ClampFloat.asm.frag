          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %expectedB "expectedB"            ; id %29
...
%_entrypoint_v = OpFunction %void None %12
  ...
  %expectedB =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
        %166 =   OpVariable %_ptr_Function_v4float Function
         ...
         %35 =   OpExtInst %float %1 FClamp %41 %float_n1 %float_1  ; RelaxedPrecision
         ...
         %45 =       OpExtInst %v2float %1 FClamp %48 %49 %50   ; RelaxedPrecision
         %51 =       OpVectorShuffle %v2float %28 %28 0 1       ; RelaxedPrecision
         ...
         %58 =       OpExtInst %v3float %1 FClamp %61 %63 %64   ; RelaxedPrecision
         %65 =       OpVectorShuffle %v3float %28 %28 0 1 2     ; RelaxedPrecision
         ...
         %72 =       OpExtInst %v4float %1 FClamp %74 %75 %76   ; RelaxedPrecision
         ...
         %83 =       OpExtInst %float %1 FClamp %86 %float_n1 %float_1  ; RelaxedPrecision
         ...
         %94 =       OpVectorShuffle %v2float %93 %93 0 1   ; RelaxedPrecision
         %91 =       OpExtInst %v2float %1 FClamp %94 %96 %98   ; RelaxedPrecision
         %99 =       OpVectorShuffle %v2float %32 %32 0 1       ; RelaxedPrecision
        ...
        %105 =       OpExtInst %v3float %1 FClamp %108 %109 %110    ; RelaxedPrecision
        %111 =       OpVectorShuffle %v3float %32 %32 0 1 2         ; RelaxedPrecision
        ...
        %117 =       OpExtInst %v4float %1 FClamp %119 %120 %122    ; RelaxedPrecision
        ...
        %130 =     OpLabel
        %133 =       OpVectorShuffle %v2float %28 %28 0 1   ; RelaxedPrecision
        ...
        %137 =     OpLabel
        %140 =       OpVectorShuffle %v3float %28 %28 0 1 2     ; RelaxedPrecision
        ...
        %150 =     OpLabel
        %152 =       OpVectorShuffle %v2float %32 %32 0 1   ; RelaxedPrecision
        ...
        %156 =     OpLabel
        %159 =       OpVectorShuffle %v3float %32 %32 0 1 2     ; RelaxedPrecision
        ...
        %169 = OpLabel
        %176 =   OpLoad %v4float %166               ; RelaxedPrecision
                 OpReturnValue %176
               OpFunctionEnd
