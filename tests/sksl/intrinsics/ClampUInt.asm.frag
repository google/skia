          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %uintValues "uintValues"          ; id %23
               OpName %expectedA "expectedA"            ; id %46
               OpName %expectedB "expectedB"            ; id %52
 ...
 %uintValues =   OpVariable %_ptr_Function_v4uint Function
  ...
  %expectedB =   OpVariable %_ptr_Function_v4uint Function
        %170 =   OpVariable %_ptr_Function_v4float Function
         ...
         %33 =   OpVectorTimesScalar %v4float %31 %float_100    ; RelaxedPrecision
         %36 =   OpFAdd %v4float %33 %35                        ; RelaxedPrecision
         %37 =   OpCompositeExtract %float %36 0                ; RelaxedPrecision
         %38 =   OpConvertFToU %uint %37
         %39 =   OpCompositeExtract %float %36 1    ; RelaxedPrecision
         %40 =   OpConvertFToU %uint %39
         %41 =   OpCompositeExtract %float %36 2    ; RelaxedPrecision
         %42 =   OpConvertFToU %uint %41
         %43 =   OpCompositeExtract %float %36 3    ; RelaxedPrecision
        ...
        %174 = OpLabel
        %181 =   OpLoad %v4float %170               ; RelaxedPrecision
                 OpReturnValue %181
               OpFunctionEnd
