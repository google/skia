...
%_ptr_Uniform_v4float = OpTypePointer Uniform %v4float
    ...
    %float_2 = OpConstant %float 2
         %86 = OpConstantComposite %v2float %float_1 %float_2
    %float_4 = OpConstant %float 4
         %96 = OpConstantComposite %v3float %float_1 %float_2 %float_4
    %float_8 = OpConstant %float 8
        %106 = OpConstantComposite %v4float %float_1 %float_2 %float_4 %float_8
...
%_entrypoint_v = OpFunction %void None %12
       ...
       %main = OpFunction %v4float None %20         ; RelaxedPrecision
        ...
        %112 =   OpVariable %_ptr_Function_v4float Function
         ...
         %25 =   OpExtInst %float %1 Exp2 %31       ; RelaxedPrecision
         ...
         %39 =       OpExtInst %v2float %1 Exp2 %42         ; RelaxedPrecision
         ...
         %52 =       OpExtInst %v3float %1 Exp2 %55             ; RelaxedPrecision
         ...
         %66 =       OpExtInst %v4float %1 Exp2 %68     ; RelaxedPrecision
        ...
        %114 =     OpLabel
        %117 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_2
