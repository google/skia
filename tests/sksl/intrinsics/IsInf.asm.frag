          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %infiniteValue "infiniteValue"    ; id %24
               OpName %finiteValue "finiteValue"        ; id %44
...
%finiteValue =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
        %108 =   OpVariable %_ptr_Function_v4float Function
         ...
         %30 =   OpLoad %mat2v2float %26            ; RelaxedPrecision
         %31 =   OpCompositeExtract %float %30 0 0  ; RelaxedPrecision
         %32 =   OpCompositeExtract %float %30 0 1  ; RelaxedPrecision
         %33 =   OpCompositeExtract %float %30 1 0  ; RelaxedPrecision
         %34 =   OpCompositeExtract %float %30 1 1  ; RelaxedPrecision
         %35 =   OpCompositeConstruct %v4float %31 %32 %33 %34  ; RelaxedPrecision
         ...
         %42 =   OpFDiv %float %float_1 %40         ; RelaxedPrecision
         %43 =   OpVectorTimesScalar %v4float %35 %42   ; RelaxedPrecision
                 OpStore %infiniteValue %43
         %45 =   OpAccessChain %_ptr_Uniform_mat2v2float %7 %int_0
         %46 =   OpLoad %mat2v2float %45            ; RelaxedPrecision
         %47 =   OpCompositeExtract %float %46 0 0  ; RelaxedPrecision
         %48 =   OpCompositeExtract %float %46 0 1  ; RelaxedPrecision
         %49 =   OpCompositeExtract %float %46 1 0  ; RelaxedPrecision
         %50 =   OpCompositeExtract %float %46 1 1  ; RelaxedPrecision
         %51 =   OpCompositeConstruct %v4float %47 %48 %49 %50  ; RelaxedPrecision
         %52 =   OpAccessChain %_ptr_Uniform_v4float %7 %int_1
         %53 =   OpLoad %v4float %52                ; RelaxedPrecision
         %54 =   OpCompositeExtract %float %53 1    ; RelaxedPrecision
         %55 =   OpFDiv %float %float_1 %54         ; RelaxedPrecision
         %56 =   OpVectorTimesScalar %v4float %51 %55   ; RelaxedPrecision
                 OpStore %finiteValue %56
         %60 =   OpCompositeExtract %float %43 0    ; RelaxedPrecision
         %59 =   OpIsInf %bool %60
                 OpSelectionMerge %62 None
                 OpBranchConditional %59 %61 %62

         %61 =     OpLabel
         %65 =       OpVectorShuffle %v2float %43 %43 0 1   ; RelaxedPrecision
         ...
         %68 =     OpLabel
         %72 =       OpVectorShuffle %v3float %43 %43 0 1 2     ; RelaxedPrecision
         ...
         %82 =     OpLabel
         %86 =       OpCompositeExtract %float %56 0    ; RelaxedPrecision
         %85 =       OpIsInf %bool %86
         ...
         %88 =     OpLabel
         %93 =       OpVectorShuffle %v2float %56 %56 0 1   ; RelaxedPrecision
         ...
         %95 =     OpLabel
        %100 =       OpVectorShuffle %v3float %56 %56 0 1 2     ; RelaxedPrecision
        ...
        %111 = OpLabel
        %117 =   OpLoad %v4float %108               ; RelaxedPrecision
                 OpReturnValue %117
               OpFunctionEnd
