          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %matrix2x2 "matrix2x2"            ; id %23
               OpName %inv2x2 "inv2x2"                  ; id %33
               OpName %inv3x3 "inv3x3"                  ; id %40
               OpName %inv4x4 "inv4x4"                  ; id %55
               OpName %Zero "Zero"                      ; id %66
     ...
     %inv4x4 =   OpVariable %_ptr_Function_mat4v4float Function
       %Zero =   OpVariable %_ptr_Function_float Function
        %203 =   OpVariable %_ptr_Function_v4float Function
         ...
         %72 =   OpLoad %v4float %68                ; RelaxedPrecision
         %73 =   OpCompositeExtract %float %72 2    ; RelaxedPrecision
                 OpStore %Zero %73
        ...
        %212 =       OpLoad %v4float %210           ; RelaxedPrecision
                     OpStore %203 %212
                     OpBranch %207

        %207 = OpLabel
        %213 =   OpLoad %v4float %203               ; RelaxedPrecision
                 OpReturnValue %213
               OpFunctionEnd
