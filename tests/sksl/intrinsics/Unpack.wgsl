...
fn _skslMain(_stageOut: ptr<function, FSOut>) {
  {
    ...
    (*_stageOut).sk_FragColor = vec4<f32>((vec2<f32>(_skTemp0)), (*_stageOut).sk_FragColor.zw);
    let _skTemp1 = unpack2x16unorm(_globalUniforms.a);
    (*_stageOut).sk_FragColor = vec4<f32>((vec2<f32>(_skTemp1)), (*_stageOut).sk_FragColor.zw);
    let _skTemp2 = unpack2x16snorm(_globalUniforms.a);
    (*_stageOut).sk_FragColor = vec4<f32>((vec2<f32>(_skTemp2)), (*_stageOut).sk_FragColor.zw);
