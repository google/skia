...
fn _skslMain(coords: vec2<f32>) -> vec4<f32> {
  {
    let _skTemp0 = asin(_globalUniforms.inputVal.x);
    let _skTemp1 = asin(_globalUniforms.inputVal.xy);
    let _skTemp2 = asin(_globalUniforms.inputVal.xyz);
    let _skTemp3 = asin(_globalUniforms.inputVal);
