          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %expected "expected"              ; id %24
...
%_entrypoint_v = OpFunction %void None %14
   ...
   %expected =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
        %128 =   OpVariable %_ptr_Function_v4float Function
         ...
         %45 =       OpDPdy %v2float %48                    ; RelaxedPrecision
         %49 =       OpAccessChain %_ptr_Uniform_v2float %8 %int_3
         %50 =       OpLoad %v2float %49
         %51 =       OpVectorShuffle %v2float %50 %50 1 1
         %52 =       OpFMul %v2float %45 %51        ; RelaxedPrecision
         %53 =       OpVectorShuffle %v2float %26 %26 0 1   ; RelaxedPrecision
         ...
         %60 =       OpDPdy %v3float %63                        ; RelaxedPrecision
         %65 =       OpAccessChain %_ptr_Uniform_v2float %8 %int_3
         %66 =       OpLoad %v2float %65
         %67 =       OpVectorShuffle %v3float %66 %66 1 1 1
         %68 =       OpFMul %v3float %60 %67        ; RelaxedPrecision
         %69 =       OpVectorShuffle %v3float %26 %26 0 1 2     ; RelaxedPrecision
        ...
        %131 = OpLabel
        %138 =   OpLoad %v4float %128               ; RelaxedPrecision
                 OpReturnValue %138
               OpFunctionEnd
