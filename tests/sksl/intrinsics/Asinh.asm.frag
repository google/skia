...
%_ptr_Uniform_v4float = OpTypePointer Uniform %v4float
   ...
   %float_n1 = OpConstant %float -1
        %106 = OpConstantComposite %v4float %float_0 %float_0 %float_1 %float_n1
...
%_entrypoint_v = OpFunction %void None %16
       ...
       %main = OpFunction %v4float None %24         ; RelaxedPrecision
        ...
        %112 =   OpVariable %_ptr_Function_v4float Function
         ...
         %29 =   OpExtInst %float %5 Asinh %34      ; RelaxedPrecision
         ...
         %42 =       OpExtInst %v2float %5 Asinh %45        ; RelaxedPrecision
         ...
         %55 =       OpExtInst %v3float %5 Asinh %58            ; RelaxedPrecision
         ...
         %69 =       OpExtInst %v4float %5 Asinh %71    ; RelaxedPrecision
        ...
        %101 =       OpAll %bool %100
         ...
         %94 = OpLabel
        %102 =   OpPhi %bool %false %86 %101 %93
