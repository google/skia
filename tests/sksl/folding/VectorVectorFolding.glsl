...
vec4 main() {
    ...
    _2_ok = _2_ok;
    _2_ok = _2_ok;
    _2_ok = _2_ok && -vec4(1.0) == -vec4(1.0);
    _2_ok = _2_ok && vec4(1.0) != -vec4(1.0);
    _2_ok = _2_ok && -vec4(1.0) != vec4(1.0);
    _2_ok = _2_ok && vec4(0.0) != -vec4(1.0);
    _2_ok = _2_ok && -vec4(0.0) != vec4(1.0);
    _2_ok = _2_ok && -vec4(0.0) != -vec4(1.0);
    _2_ok = _2_ok && !(-vec4(1.0) == vec4(1.0));
    _2_ok = _2_ok && !(vec4(1.0) == -vec4(1.0));
    ...
    _2_ok = _2_ok && !(-vec4(0.0) == -vec4(1.0));
    _2_ok = _2_ok && !(-vec4(1.0) != -vec4(1.0));
    _2_ok = _2_ok && vec4(_1_unknown) * vec4(1.0) == vec4(_1_unknown);
    _2_ok = _2_ok && vec4(1.0) * vec4(_1_unknown) == vec4(_1_unknown);
    _2_ok = _2_ok && vec4(_1_unknown) * vec4(0.0) == vec4(0.0);
    _2_ok = _2_ok && vec4(0.0) * vec4(_1_unknown) == vec4(0.0);
    _2_ok = _2_ok && vec4(0.0) / vec4(_1_unknown) == vec4(0.0);
    _2_ok = _2_ok && vec4(_1_unknown) + vec4(0.0) == vec4(_1_unknown);
    _2_ok = _2_ok && vec4(0.0) + vec4(_1_unknown) == vec4(_1_unknown);
    _2_ok = _2_ok && vec4(_1_unknown) - vec4(0.0) == vec4(_1_unknown);
