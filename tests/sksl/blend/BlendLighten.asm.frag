          ...
          %5 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %_0_result "_0_result"        ; id %17
...
%_ptr_Uniform_v4float = OpTypePointer Uniform %v4float
  ...
  %_0_result =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
         ...
         %34 =   OpVectorShuffle %v3float %32 %32 0 1 2     ; RelaxedPrecision
         ...
         %33 =   OpExtInst %v3float %5 FMax %34 %47         ; RelaxedPrecision
         %48 =   OpLoad %v4float %_0_result                 ; RelaxedPrecision
         %49 =   OpVectorShuffle %v4float %48 %33 4 5 6 3   ; RelaxedPrecision
