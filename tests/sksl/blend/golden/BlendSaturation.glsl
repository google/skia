...
vec3 _blend_set_color_saturation(vec3 hueLumColor, vec3 satColor) {
    ...
    if (hueLumColor.x <= hueLumColor.y) {
        if (hueLumColor.y <= hueLumColor.z) {
            ...
            do {
                if (hueLumColor.x < hueLumColor.z) {
                    {
                        _3_blend_set_color_saturation_helper = vec3(0.0, (sat * (hueLumColor.y - hueLumColor.x)) / (hueLumColor.z - hueLumColor.x), sat);
                        break;
                    }
                }
                {
                    _3_blend_set_color_saturation_helper = vec3(0.0);
                    break;
                }
            } while (false);
            ...
            do {
                if (_5_minMidMax.x < _5_minMidMax.z) {
                    {
                        _4_blend_set_color_saturation_helper = vec3(0.0, (sat * (_5_minMidMax.y - _5_minMidMax.x)) / (_5_minMidMax.z - _5_minMidMax.x), sat);
                        break;
                    }
                }
                {
                    _4_blend_set_color_saturation_helper = vec3(0.0);
                    break;
                }
            } while (false);
            ...
            do {
                if (_7_minMidMax.x < _7_minMidMax.z) {
                    {
                        _6_blend_set_color_saturation_helper = vec3(0.0, (sat * (_7_minMidMax.y - _7_minMidMax.x)) / (_7_minMidMax.z - _7_minMidMax.x), sat);
                        break;
                    }
                }
                {
                    _6_blend_set_color_saturation_helper = vec3(0.0);
                    break;
                }
            } while (false);
        ...
        do {
            if (_9_minMidMax.x < _9_minMidMax.z) {
                {
                    _8_blend_set_color_saturation_helper = vec3(0.0, (sat * (_9_minMidMax.y - _9_minMidMax.x)) / (_9_minMidMax.z - _9_minMidMax.x), sat);
                    break;
                }
            }
            {
                _8_blend_set_color_saturation_helper = vec3(0.0);
                break;
            }
        } while (false);
        ...
        do {
            if (_11_minMidMax.x < _11_minMidMax.z) {
                {
                    _10_blend_set_color_saturation_helper = vec3(0.0, (sat * (_11_minMidMax.y - _11_minMidMax.x)) / (_11_minMidMax.z - _11_minMidMax.x), sat);
                    break;
                }
            }
            {
                _10_blend_set_color_saturation_helper = vec3(0.0);
                break;
            }
        } while (false);
        ...
        do {
            if (_13_minMidMax.x < _13_minMidMax.z) {
                {
                    _12_blend_set_color_saturation_helper = vec3(0.0, (sat * (_13_minMidMax.y - _13_minMidMax.x)) / (_13_minMidMax.z - _13_minMidMax.x), sat);
                    break;
                }
            }
            {
                _12_blend_set_color_saturation_helper = vec3(0.0);
                break;
            }
        } while (false);
