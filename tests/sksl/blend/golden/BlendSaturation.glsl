...
void main() {
    vec4 _0_blend_saturation;
    {
        ...
        vec3 _13_blend_set_color_saturation;
        {
            ...
            {
                _15_blend_color_saturation = max(max(_2_sda.x, _2_sda.y), _2_sda.z) - min(min(_2_sda.x, _2_sda.y), _2_sda.z);
            }
            ...
            if (_3_dsa.x <= _3_dsa.y) {
                if (_3_dsa.y <= _3_dsa.z) {
                    ...
                    {
                        _16_blend_set_color_saturation_helper = _3_dsa.x < _3_dsa.z ? vec3(0.0, (_14_sat * (_3_dsa.y - _3_dsa.x)) / (_3_dsa.z - _3_dsa.x), _14_sat) : vec3(0.0);
                    }
                    ...
                    {
                        _17_blend_set_color_saturation_helper = _3_dsa.x < _3_dsa.y ? vec3(0.0, (_14_sat * (_3_dsa.z - _3_dsa.x)) / (_3_dsa.y - _3_dsa.x), _14_sat) : vec3(0.0);
                    }
                    ...
                    {
                        _18_blend_set_color_saturation_helper = _3_dsa.z < _3_dsa.y ? vec3(0.0, (_14_sat * (_3_dsa.x - _3_dsa.z)) / (_3_dsa.y - _3_dsa.z), _14_sat) : vec3(0.0);
                    }
                    _13_blend_set_color_saturation = _18_blend_set_color_saturation_helper.zxy;

                }
            } else if (_3_dsa.x <= _3_dsa.z) {
                vec3 _19_blend_set_color_saturation_helper;
                {
                    _19_blend_set_color_saturation_helper = _3_dsa.y < _3_dsa.z ? vec3(0.0, (_14_sat * (_3_dsa.x - _3_dsa.y)) / (_3_dsa.z - _3_dsa.y), _14_sat) : vec3(0.0);
                }
                ...
                {
                    _20_blend_set_color_saturation_helper = _3_dsa.y < _3_dsa.x ? vec3(0.0, (_14_sat * (_3_dsa.z - _3_dsa.y)) / (_3_dsa.x - _3_dsa.y), _14_sat) : vec3(0.0);
                }
                _13_blend_set_color_saturation = _20_blend_set_color_saturation_helper.yzx;

            } else {
                vec3 _21_blend_set_color_saturation_helper;
                {
                    _21_blend_set_color_saturation_helper = _3_dsa.z < _3_dsa.x ? vec3(0.0, (_14_sat * (_3_dsa.y - _3_dsa.z)) / (_3_dsa.x - _3_dsa.z), _14_sat) : vec3(0.0);
                }
        ...
        _0_blend_saturation = vec4((((_22_blend_set_color_luminance + dst.xyz) - _3_dsa) + src.xyz) - _2_sda, (src.w + dst.w) - _1_alpha);
