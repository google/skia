...
%172 = OpDot %float %173 %177
OpStore %_7_lum %172
%178 = OpLoad %float %_7_lum
%181 = OpLoad %v3float %_4_blend_set_color_saturation
%179 = OpDot %float %180 %181
%182 = OpFSub %float %178 %179
...
%187 = OpExtInst %float %1 FMin %189 %191
%192 = OpLoad %v3float %_8_result
%193 = OpCompositeExtract %float %192 2
%186 = OpExtInst %float %1 FMin %187 %193
OpStore %_9_minComp %186
