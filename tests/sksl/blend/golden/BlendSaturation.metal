...
fragment Outputs fragmentMain(Inputs _in [[stage_in]], bool _frontFacing [[front_facing]], float4 _fragCoord [[position]]) {
    ...
    float4 _12_blend_saturation;
    {
        ...
        _12_blend_saturation = float4((((_blend_set_color_luminance(_blend_set_color_saturation(_15_dsa, _14_sda), _13_alpha, _15_dsa) + _in.dst.xyz) - _15_dsa) + _in.src.xyz) - _14_sda, (_in.src.w + _in.dst.w) - _13_alpha);
    }
