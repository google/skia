...
fragment Outputs fragmentMain(Inputs _in [[stage_in]], bool _frontFacing [[front_facing]], float4 _fragCoord [[position]]) {
    ...
    float4 _0_blend_saturation;
    {
        ...
        float3 _13_blend_set_color_saturation;
        {
            ...
            if (_3_dsa.x <= _3_dsa.y) {
                if (_3_dsa.y <= _3_dsa.z) {
                    ...
                    {
                        _16_blend_set_color_saturation_helper = _3_dsa.x < _3_dsa.z ? float3(0.0, (_14_sat * (_3_dsa.y - _3_dsa.x)) / (_3_dsa.z - _3_dsa.x), _14_sat) : float3(0.0);
                    }
                    ...
                    {
                        _17_blend_set_color_saturation_helper = _3_dsa.x < _3_dsa.y ? float3(0.0, (_14_sat * (_3_dsa.z - _3_dsa.x)) / (_3_dsa.y - _3_dsa.x), _14_sat) : float3(0.0);
                    }
                    ...
                    {
                        _18_blend_set_color_saturation_helper = _3_dsa.z < _3_dsa.y ? float3(0.0, (_14_sat * (_3_dsa.x - _3_dsa.z)) / (_3_dsa.y - _3_dsa.z), _14_sat) : float3(0.0);
                    }
                ...
                {
                    _19_blend_set_color_saturation_helper = _3_dsa.y < _3_dsa.z ? float3(0.0, (_14_sat * (_3_dsa.x - _3_dsa.y)) / (_3_dsa.z - _3_dsa.y), _14_sat) : float3(0.0);
                }
                ...
                {
                    _20_blend_set_color_saturation_helper = _3_dsa.y < _3_dsa.x ? float3(0.0, (_14_sat * (_3_dsa.z - _3_dsa.y)) / (_3_dsa.x - _3_dsa.y), _14_sat) : float3(0.0);
                }
                ...
                {
                    _21_blend_set_color_saturation_helper = _3_dsa.z < _3_dsa.x ? float3(0.0, (_14_sat * (_3_dsa.y - _3_dsa.z)) / (_3_dsa.x - _3_dsa.z), _14_sat) : float3(0.0);
                }
        ...
        _0_blend_saturation = float4((((_22_blend_set_color_luminance + _in.dst.xyz) - _3_dsa) + _in.src.xyz) - _2_sda, (_in.src.w + _in.dst.w) - _1_alpha);
