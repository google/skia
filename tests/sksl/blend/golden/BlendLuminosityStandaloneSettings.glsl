...
void main() {
    vec4 _7_blend_luminosity;
    {
        ...
        vec3 _11_blend_set_color_luminance;
        {
            ...
            {
                _16_blend_color_luminance = dot(vec3(0.30000001192092896, 0.5899999737739563, 0.10999999940395355), _9_sda);
            }
            float _12_lum = _16_blend_color_luminance;

            float _17_blend_color_luminance;
            {
                _17_blend_color_luminance = dot(vec3(0.30000001192092896, 0.5899999737739563, 0.10999999940395355), _10_dsa);
            }
            vec3 _13_result = (_12_lum - _17_blend_color_luminance) + _10_dsa;
        ...
        _7_blend_luminosity = vec4((((_11_blend_set_color_luminance + dst.xyz) - _10_dsa) + src.xyz) - _9_sda, (src.w + dst.w) - _8_alpha);

    }
    sk_FragColor = _7_blend_luminosity;
