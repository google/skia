...
fragment Outputs fragmentMain(Inputs _in [[stage_in]], bool _frontFacing [[front_facing]], float4 _fragCoord [[position]]) {
    ...
    float4 _7_blend_luminosity;
    {
        ...
        float3 _11_blend_set_color_luminance;
        {
            ...
            {
                _16_blend_color_luminance = dot(float3(0.30000001192092896, 0.5899999737739563, 0.10999999940395355), _9_sda);
            }
            float _12_lum = _16_blend_color_luminance;

            float _17_blend_color_luminance;
            {
                _17_blend_color_luminance = dot(float3(0.30000001192092896, 0.5899999737739563, 0.10999999940395355), _10_dsa);
            }
            float3 _13_result = (_12_lum - _17_blend_color_luminance) + _10_dsa;
        ...
        _7_blend_luminosity = float4((((_11_blend_set_color_luminance + _in.dst.xyz) - _10_dsa) + _in.src.xyz) - _9_sda, (_in.src.w + _in.dst.w) - _8_alpha);

    }
    _out->sk_FragColor = _7_blend_luminosity;
