...
fragment Outputs fragmentMain(Inputs _in [[stage_in]], bool _frontFacing [[front_facing]], float4 _fragCoord [[position]]) {
    ...
    float4 _0_blend_luminosity;
    {
        ...
        {
            float _9_blend_color_luminance;
            {
                _9_blend_color_luminance = dot(float3(0.30000001192092896, 0.5899999737739563, 0.10999999940395355), _2_sda);
            }
            float _5_lum = _9_blend_color_luminance;

            float _10_blend_color_luminance;
            {
                _10_blend_color_luminance = dot(float3(0.30000001192092896, 0.5899999737739563, 0.10999999940395355), _3_dsa);
            }
            float3 _6_result = (_5_lum - _10_blend_color_luminance) + _3_dsa;
            ...
            _4_blend_set_color_luminance = _8_maxComp > _1_alpha && _8_maxComp != _5_lum ? _5_lum + ((_6_result - _5_lum) * (_1_alpha - _5_lum)) / (_8_maxComp - _5_lum) : _6_result;
        }
