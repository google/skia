...
void main() {
    vec4 _12_blend_hue;
    {
        ...
        _12_blend_hue = vec4((((_blend_set_color_luminance(_blend_set_color_saturation(_14_sda, _15_dsa), _13_alpha, _15_dsa) + dst.xyz) - _15_dsa) + src.xyz) - _14_sda, (src.w + dst.w) - _13_alpha);
    }
