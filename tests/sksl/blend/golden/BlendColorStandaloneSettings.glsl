...
void main() {
    vec4 _0_blend_color;
    {
        ...
        vec3 _4_blend_set_color_luminance;
        {
            ...
            {
                _9_blend_color_luminance = dot(vec3(0.30000001192092896, 0.5899999737739563, 0.10999999940395355), _3_dsa);
            }
            float _5_lum = _9_blend_color_luminance;

            float _10_blend_color_luminance;
            {
                _10_blend_color_luminance = dot(vec3(0.30000001192092896, 0.5899999737739563, 0.10999999940395355), _2_sda);
            }
            vec3 _6_result = (_5_lum - _10_blend_color_luminance) + _2_sda;
