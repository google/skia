...
%49 = OpConstantComposite %v3float %float_0_300000012 %float_0_589999974 %float_0_109999999
...
OpStore %_5_lum %41
%47 = OpLoad %float %_5_lum
%50 = OpLoad %v3float %_3_dsa
%48 = OpDot %float %49 %50
%51 = OpFSub %float %47 %48
...
%56 = OpExtInst %float %1 FMin %58 %60
%61 = OpLoad %v3float %_6_result
%62 = OpCompositeExtract %float %61 2
%55 = OpExtInst %float %1 FMin %56 %62
OpStore %_7_minComp %55
