...
fragment Outputs fragmentMain(Inputs _in [[stage_in]], bool _frontFacing [[front_facing]], float4 _fragCoord [[position]]) {
    ...
    float _6_lum = dot(float3(0.30000001192092896, 0.5899999737739563, 0.10999999940395355), _2_sda);

    float _7_blend_color_luminance;
    float3 _8_result = (_6_lum - dot(float3(0.30000001192092896, 0.5899999737739563, 0.10999999940395355), _3_dsa)) + _3_dsa;
    ...
    if (_10_maxComp > _1_alpha && _10_maxComp != _6_lum) {
        float3 _13_guarded_divide;
        float3 _14_n = (_8_result - _6_lum) * (_1_alpha - _6_lum);
