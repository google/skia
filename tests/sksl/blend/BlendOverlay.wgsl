...
fn _skslMain(_stageOut: ptr<function, FSOut>) {
  {
    var _0_result: vec4<f32> = vec4<f32>(blend_overlay_component_Qhh2h2(_globalUniforms.src.xw, _globalUniforms.dst.xw), blend_overlay_component_Qhh2h2(_globalUniforms.src.yw, _globalUniforms.dst.yw), blend_overlay_component_Qhh2h2(_globalUniforms.src.zw, _globalUniforms.dst.zw), _globalUniforms.src.w + (1.0 - _globalUniforms.src.w) * _globalUniforms.dst.w);
