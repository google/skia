...
%_ptr_Uniform_v4float = OpTypePointer Uniform %v4float
    ...
    %float_1 = OpConstant %float 1
       ...
       %main = OpFunction %void None %11
         ...
         %18 =   OpCompositeExtract %float %17 3    ; RelaxedPrecision
         %19 =   OpAccessChain %_ptr_Uniform_v4float %7 %int_0
         %21 =   OpLoad %v4float %19                ; RelaxedPrecision
         %22 =   OpVectorTimesScalar %v4float %21 %18   ; RelaxedPrecision
         ...
         %30 =   OpVectorTimesScalar %v4float %29 %27   ; RelaxedPrecision
         %31 =   OpFAdd %v4float %22 %30                ; RelaxedPrecision
