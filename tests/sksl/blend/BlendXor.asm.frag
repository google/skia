...
%_ptr_Uniform_v4float = OpTypePointer Uniform %v4float
      ...
      %int_0 = OpConstant %int 0
       ...
       %main = OpFunction %void None %11
         ...
         %27 =   OpCompositeExtract %float %26 3    ; RelaxedPrecision
         %28 =   OpFSub %float %float_1 %27         ; RelaxedPrecision
         %29 =   OpAccessChain %_ptr_Uniform_v4float %7 %int_1
         %30 =   OpLoad %v4float %29                ; RelaxedPrecision
         %31 =   OpVectorTimesScalar %v4float %30 %28   ; RelaxedPrecision
         %32 =   OpFAdd %v4float %24 %31                ; RelaxedPrecision
