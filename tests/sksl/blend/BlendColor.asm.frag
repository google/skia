...
OpName %l "l"
OpName %r "r"
OpName %_1_blend_set_color_saturation "_1_blend_set_color_saturation"
OpName %_2_sat "_2_sat"
...
OpDecorate %_1_blend_set_color_saturation RelaxedPrecision
OpDecorate %_2_sat RelaxedPrecision
...
%_1_blend_set_color_saturation = OpVariable %_ptr_Function_v3float Function
%_2_sat = OpVariable %_ptr_Function_float Function
...
OpBranch %117
%117 = OpLabel
%190 = OpLoad %v3float %_1_blend_set_color_saturation
OpStore %l %190
...
%235 = OpLabel
%237 = OpLoad %float %_4_lum
%238 = OpLoad %v3float %_5_result
%239 = OpLoad %float %_4_lum
%240 = OpCompositeConstruct %v3float %239 %239 %239
%241 = OpFSub %v3float %238 %240
%242 = OpLoad %float %_4_lum
%243 = OpLoad %float %_4_lum
%244 = OpLoad %float %_6_minComp
...
OpStore %_5_result %249
OpBranch %236
%236 = OpLabel
%250 = OpLoad %float %_7_maxComp
%251 = OpLoad %float %alpha
%252 = OpFOrdGreaterThan %bool %250 %251
OpSelectionMerge %254 None
OpBranchConditional %252 %253 %254
%253 = OpLabel
%255 = OpLoad %float %_7_maxComp
%256 = OpLoad %float %_4_lum
...
OpStore %_3_blend_set_color_luminance %278
OpBranch %261
%260 = OpLabel
%279 = OpLoad %v3float %_5_result
OpStore %_3_blend_set_color_luminance %279
OpBranch %261
%261 = OpLabel
%280 = OpLoad %v3float %_3_blend_set_color_luminance
...
OpStore %315 %float_0
OpStore %316 %false
%317 = OpFunctionCall %v4float %blend_hslc_h4h4h4hb %310 %314 %315 %316
OpStore %sk_FragColor %317
OpReturn
OpFunctionEnd
