...
OpName %l "l"
OpName %r "r"
OpName %blend_color_h4h4h4 "blend_color_h4h4h4"
OpName %main "main"
...
%262 = OpConstantComposite %v2float %float_0 %float_0
%void = OpTypeVoid
...
OpReturnValue %253
OpFunctionEnd
%blend_color_h4h4h4 = OpFunction %v4float None %254
...
OpStore %277 %276
%278 = OpFunctionCall %v4float %blend_color_h4h4h4 %273 %277
