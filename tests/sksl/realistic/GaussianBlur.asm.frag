          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %uTextureSampler_0_Stage1 "uTextureSampler_0_Stage1"  ; id %17
               OpName %vLocalCoord_Stage0 "vLocalCoord_Stage0"              ; id %21
               OpName %MatrixEffect_Stage1_c0_c0_h4h4f2 "MatrixEffect_Stage1_c0_c0_h4h4f2"  ; id %2
               OpName %_1_inCoord "_1_inCoord"                                              ; id %29
               OpName %_2_subsetCoord "_2_subsetCoord"                                      ; id %47
               OpName %_3_clampedCoord "_3_clampedCoord"                                    ; id %56
               OpName %_4_textureColor "_4_textureColor"                                    ; id %58
               OpName %_5_snappedX "_5_snappedX"                                            ; id %65
               OpName %main "main"                                                          ; id %3
               OpName %outputColor_Stage0 "outputColor_Stage0"                              ; id %96
               OpName %outputCoverage_Stage0 "outputCoverage_Stage0"                        ; id %97
               OpName %_6_output "_6_output"                                                ; id %99
               OpName %_7_coord "_7_coord"                                                  ; id %102
               OpName %_8_coordSampled "_8_coordSampled"                                    ; id %110
               OpName %output_Stage1 "output_Stage1"                                        ; id %389
...
%_ptr_Uniform_uniformBuffer = OpTypePointer Uniform %uniformBuffer
          %4 = OpVariable %_ptr_Uniform_uniformBuffer Uniform   ; Binding 0, DescriptorSet 0
%_ptr_Output_v4float = OpTypePointer Output %v4float
%sk_FragColor = OpVariable %_ptr_Output_v4float Output  ; RelaxedPrecision, Location 0, Index 0
         %18 = OpTypeImage %float 2D 0 0 0 1 Unknown
         %19 = OpTypeSampledImage %18
%_ptr_UniformConstant_19 = OpTypePointer UniformConstant %19
%uTextureSampler_0_Stage1 = OpVariable %_ptr_UniformConstant_19 UniformConstant     ; RelaxedPrecision, Binding 0, DescriptorSet 0
...
%MatrixEffect_Stage1_c0_c0_h4h4f2 = OpFunction %v4float None %25    ; RelaxedPrecision
...
%_5_snappedX =   OpVariable %_ptr_Function_float Function
         ...
         %60 =   OpLoad %19 %uTextureSampler_0_Stage1   ; RelaxedPrecision
         %61 =   OpAccessChain %_ptr_Uniform_v4float %4 %int_6
         %62 =   OpLoad %v4float %61
         %63 =   OpVectorShuffle %v2float %62 %62 2 3
         %64 =   OpFMul %v2float %57 %63
         %59 =   OpImageSampleImplicitLod %v4float %60 %64  ; RelaxedPrecision
         ...
         %88 = OpLabel
         %92 =   OpLoad %v4float %_4_textureColor   ; RelaxedPrecision
                 OpReturnValue %92
               OpFunctionEnd
...
%output_Stage1 =   OpVariable %_ptr_Function_v4float Function   ; RelaxedPrecision
        ...
        %107 =   OpLoad %v2float %105               ; RelaxedPrecision
        %108 =   OpVectorTimesScalar %v2float %107 %float_12    ; RelaxedPrecision
        ...
        %119 =   OpVectorTimesScalar %v4float %114 %118     ; RelaxedPrecision
        %120 =   OpFAdd %v4float %101 %119                  ; RelaxedPrecision
                 OpStore %_6_output %120
        %121 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %122 =   OpLoad %v2float %121               ; RelaxedPrecision
        ...
        %130 =   OpVectorTimesScalar %v4float %126 %129     ; RelaxedPrecision
        %131 =   OpFAdd %v4float %120 %130                  ; RelaxedPrecision
                 OpStore %_6_output %131
        %132 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %133 =   OpLoad %v2float %132               ; RelaxedPrecision
        ...
        %141 =   OpVectorTimesScalar %v4float %137 %140     ; RelaxedPrecision
        %142 =   OpFAdd %v4float %131 %141                  ; RelaxedPrecision
                 OpStore %_6_output %142
        %143 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %144 =   OpLoad %v2float %143               ; RelaxedPrecision
        ...
        %151 =   OpCompositeExtract %float %150 3   ; RelaxedPrecision
        %152 =   OpVectorTimesScalar %v4float %148 %151     ; RelaxedPrecision
        %153 =   OpFAdd %v4float %142 %152                  ; RelaxedPrecision
                 OpStore %_6_output %153
        %154 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %155 =   OpLoad %v2float %154               ; RelaxedPrecision
        ...
        %163 =   OpVectorTimesScalar %v4float %159 %162     ; RelaxedPrecision
        %164 =   OpFAdd %v4float %153 %163                  ; RelaxedPrecision
                 OpStore %_6_output %164
        %165 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %166 =   OpLoad %v2float %165               ; RelaxedPrecision
        ...
        %174 =   OpVectorTimesScalar %v4float %170 %173     ; RelaxedPrecision
        %175 =   OpFAdd %v4float %164 %174                  ; RelaxedPrecision
                 OpStore %_6_output %175
        %176 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %177 =   OpLoad %v2float %176               ; RelaxedPrecision
        ...
        %184 =   OpCompositeExtract %float %183 2   ; RelaxedPrecision
        %185 =   OpVectorTimesScalar %v4float %181 %184     ; RelaxedPrecision
        %186 =   OpFAdd %v4float %175 %185                  ; RelaxedPrecision
                 OpStore %_6_output %186
        %187 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %188 =   OpLoad %v2float %187               ; RelaxedPrecision
        ...
        %195 =   OpCompositeExtract %float %194 3   ; RelaxedPrecision
        %196 =   OpVectorTimesScalar %v4float %192 %195     ; RelaxedPrecision
        %197 =   OpFAdd %v4float %186 %196                  ; RelaxedPrecision
                 OpStore %_6_output %197
        %198 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %199 =   OpLoad %v2float %198               ; RelaxedPrecision
        ...
        %206 =   OpCompositeExtract %float %205 0   ; RelaxedPrecision
        %207 =   OpVectorTimesScalar %v4float %203 %206     ; RelaxedPrecision
        %208 =   OpFAdd %v4float %197 %207                  ; RelaxedPrecision
                 OpStore %_6_output %208
        %209 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %210 =   OpLoad %v2float %209               ; RelaxedPrecision
        ...
        %216 =   OpLoad %v4float %215               ; RelaxedPrecision
        %217 =   OpCompositeExtract %float %216 1   ; RelaxedPrecision
        %218 =   OpVectorTimesScalar %v4float %214 %217     ; RelaxedPrecision
        %219 =   OpFAdd %v4float %208 %218                  ; RelaxedPrecision
                 OpStore %_6_output %219
        %220 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %221 =   OpLoad %v2float %220               ; RelaxedPrecision
        ...
        %227 =   OpLoad %v4float %226               ; RelaxedPrecision
        %228 =   OpCompositeExtract %float %227 2   ; RelaxedPrecision
        %229 =   OpVectorTimesScalar %v4float %225 %228     ; RelaxedPrecision
        %230 =   OpFAdd %v4float %219 %229                  ; RelaxedPrecision
                 OpStore %_6_output %230
        %231 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %232 =   OpLoad %v2float %231               ; RelaxedPrecision
        ...
        %240 =   OpVectorTimesScalar %v4float %236 %239     ; RelaxedPrecision
        %241 =   OpFAdd %v4float %230 %240                  ; RelaxedPrecision
                 OpStore %_6_output %241
        %242 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %243 =   OpLoad %v2float %242               ; RelaxedPrecision
        ...
        %249 =   OpLoad %v4float %248               ; RelaxedPrecision
        %250 =   OpCompositeExtract %float %249 0   ; RelaxedPrecision
        %251 =   OpVectorTimesScalar %v4float %247 %250     ; RelaxedPrecision
        %252 =   OpFAdd %v4float %241 %251                  ; RelaxedPrecision
                 OpStore %_6_output %252
        %253 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %254 =   OpLoad %v2float %253               ; RelaxedPrecision
        ...
        %261 =   OpCompositeExtract %float %260 1   ; RelaxedPrecision
        %262 =   OpVectorTimesScalar %v4float %258 %261     ; RelaxedPrecision
        %263 =   OpFAdd %v4float %252 %262                  ; RelaxedPrecision
                 OpStore %_6_output %263
        %264 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %265 =   OpLoad %v2float %264               ; RelaxedPrecision
        ...
        %272 =   OpCompositeExtract %float %271 2   ; RelaxedPrecision
        %273 =   OpVectorTimesScalar %v4float %269 %272     ; RelaxedPrecision
        %274 =   OpFAdd %v4float %263 %273                  ; RelaxedPrecision
                 OpStore %_6_output %274
        %275 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %276 =   OpLoad %v2float %275               ; RelaxedPrecision
        ...
        %283 =   OpCompositeExtract %float %282 3   ; RelaxedPrecision
        %284 =   OpVectorTimesScalar %v4float %280 %283     ; RelaxedPrecision
        %285 =   OpFAdd %v4float %274 %284                  ; RelaxedPrecision
                 OpStore %_6_output %285
        %286 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %287 =   OpLoad %v2float %286               ; RelaxedPrecision
        ...
        %294 =   OpCompositeExtract %float %293 0   ; RelaxedPrecision
        %295 =   OpVectorTimesScalar %v4float %291 %294     ; RelaxedPrecision
        %296 =   OpFAdd %v4float %285 %295                  ; RelaxedPrecision
                 OpStore %_6_output %296
        %297 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %298 =   OpLoad %v2float %297               ; RelaxedPrecision
        ...
        %304 =   OpLoad %v4float %303               ; RelaxedPrecision
        %305 =   OpCompositeExtract %float %304 1   ; RelaxedPrecision
        %306 =   OpVectorTimesScalar %v4float %302 %305     ; RelaxedPrecision
        %307 =   OpFAdd %v4float %296 %306                  ; RelaxedPrecision
                 OpStore %_6_output %307
        %308 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %309 =   OpLoad %v2float %308               ; RelaxedPrecision
        ...
        %315 =   OpLoad %v4float %314               ; RelaxedPrecision
        %316 =   OpCompositeExtract %float %315 2   ; RelaxedPrecision
        %317 =   OpVectorTimesScalar %v4float %313 %316     ; RelaxedPrecision
        %318 =   OpFAdd %v4float %307 %317                  ; RelaxedPrecision
                 OpStore %_6_output %318
        %319 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %320 =   OpLoad %v2float %319               ; RelaxedPrecision
        ...
        %326 =   OpLoad %v4float %325               ; RelaxedPrecision
        %327 =   OpCompositeExtract %float %326 3   ; RelaxedPrecision
        %328 =   OpVectorTimesScalar %v4float %324 %327     ; RelaxedPrecision
        %329 =   OpFAdd %v4float %318 %328                  ; RelaxedPrecision
                 OpStore %_6_output %329
        %330 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %331 =   OpLoad %v2float %330               ; RelaxedPrecision
        ...
        %338 =   OpCompositeExtract %float %337 0   ; RelaxedPrecision
        %339 =   OpVectorTimesScalar %v4float %335 %338     ; RelaxedPrecision
        %340 =   OpFAdd %v4float %329 %339                  ; RelaxedPrecision
                 OpStore %_6_output %340
        %341 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %342 =   OpLoad %v2float %341               ; RelaxedPrecision
        ...
        %349 =   OpCompositeExtract %float %348 1   ; RelaxedPrecision
        %350 =   OpVectorTimesScalar %v4float %346 %349     ; RelaxedPrecision
        %351 =   OpFAdd %v4float %340 %350                  ; RelaxedPrecision
                 OpStore %_6_output %351
        %352 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %353 =   OpLoad %v2float %352               ; RelaxedPrecision
        ...
        %359 =   OpLoad %v4float %358               ; RelaxedPrecision
        %360 =   OpCompositeExtract %float %359 2   ; RelaxedPrecision
        %361 =   OpVectorTimesScalar %v4float %357 %360     ; RelaxedPrecision
        %362 =   OpFAdd %v4float %351 %361                  ; RelaxedPrecision
                 OpStore %_6_output %362
        %363 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %364 =   OpLoad %v2float %363               ; RelaxedPrecision
        ...
        %370 =   OpLoad %v4float %369               ; RelaxedPrecision
        %371 =   OpCompositeExtract %float %370 3   ; RelaxedPrecision
        %372 =   OpVectorTimesScalar %v4float %368 %371     ; RelaxedPrecision
        %373 =   OpFAdd %v4float %362 %372                  ; RelaxedPrecision
                 OpStore %_6_output %373
        %374 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %375 =   OpLoad %v2float %374               ; RelaxedPrecision
        ...
        %383 =   OpVectorTimesScalar %v4float %379 %382     ; RelaxedPrecision
        %384 =   OpFAdd %v4float %373 %383                  ; RelaxedPrecision
                 OpStore %_6_output %384
        %385 =   OpAccessChain %_ptr_Uniform_v2float %4 %int_1
        %386 =   OpLoad %v2float %385               ; RelaxedPrecision
        %387 =   OpFAdd %v2float %376 %386
                 OpStore %_7_coord %387
        %388 =   OpFMul %v4float %384 %98           ; RelaxedPrecision
                 OpStore %_6_output %388
                 OpStore %output_Stage1 %388
        %390 =   OpFMul %v4float %388 %98           ; RelaxedPrecision
