          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %sk_VertexID "sk_VertexID"        ; id %11
               OpName %vcoord_Stage0 "vcoord_Stage0"    ; id %12
               OpName %main "main"                      ; id %2
               OpName %x "x"                            ; id %18
               OpName %y "y"                            ; id %23
               OpName %ileft "ileft"                    ; id %26
               OpName %iright "iright"                  ; id %32
               OpName %itop "itop"                      ; id %41
               OpName %ibot "ibot"                      ; id %46
               OpName %outset "outset"                  ; id %54
               OpName %l "l"                            ; id %69
               OpName %r "r"                            ; id %74
               OpName %t "t"                            ; id %78
               OpName %b "b"                            ; id %82
               OpName %vertexpos "vertexpos"            ; id %86
