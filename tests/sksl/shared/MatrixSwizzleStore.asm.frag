          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %test4x4_b "test4x4_b"            ; id %2
               OpName %matrix "matrix"                  ; id %27
               OpName %values "values"                  ; id %29
               OpName %index "index"                    ; id %36
               OpName %main "main"                      ; id %3
               OpName %_0_matrix "_0_matrix"            ; id %94
               OpName %_1_values "_1_values"            ; id %96
               OpName %_2_index "_2_index"              ; id %99
     ...
     %values =   OpVariable %_ptr_Function_v4float Function
      %index =   OpVariable %_ptr_Function_int Function
         ...
         %90 =   OpLogicalAnd %bool %85 %89
               ...
               ; Function main
       %main = OpFunction %v4float None %91         ; RelaxedPrecision
