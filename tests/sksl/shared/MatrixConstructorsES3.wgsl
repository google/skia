...
fn _skslMain(coords: vec2<f32>) -> vec4<f32> {
  {
    let f4: vec4<f32> = vec4<f32>(_skUnpacked__globalUniforms_testMatrix2x2[0], _skUnpacked__globalUniforms_testMatrix2x2[1]);
    let _skTemp0 = f4.xy;
    let _skTemp1 = mat2x3<f32>(f4[0], f4[1], f4[2], f4[3], _skTemp0[0], _skTemp0[1]);
    const _skTemp2 = mat2x3<f32>(1.0, 2.0, 3.0, 4.0, 1.0, 2.0);
    ...
    const _skTemp6 = mat2x4<f32>(1.0, 2.0, 3.0, 4.0, 1.0, 2.0, 3.0, 4.0);
    ...
    const _skTemp10 = mat3x3<f32>(1.0, 2.0, 3.0, 4.0, 1.0, 2.0, 3.0, 4.0, 1.0);
    ...
    const _skTemp14 = mat4x2<f32>(1.0, 2.0, 3.0, 4.0, 1.0, 2.0, 3.0, 4.0);
    ...
    const _skTemp19 = mat4x3<f32>(1.0, 2.0, 3.0, 4.0, 1.0, 2.0, 3.0, 4.0, 1.0, 2.0, 3.0, 4.0);
