          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %_entrypoint_v "_entrypoint_v"    ; id %24
               OpName %return_in_one_case_bi "return_in_one_case_bi"    ; id %2
               OpName %val "val"                                        ; id %40
               OpName %return_in_default_bi "return_in_default_bi"      ; id %3
               OpName %return_in_every_case_bi "return_in_every_case_bi"    ; id %4
               OpName %return_in_every_case_no_default_bi "return_in_every_case_no_default_bi"  ; id %5
               OpName %val_0 "val"                                                              ; id %67
               OpName %case_has_break_before_return_bi "case_has_break_before_return_bi"        ; id %6
               OpName %val_1 "val"                                                              ; id %76
               OpName %case_has_break_after_return_bi "case_has_break_after_return_bi"          ; id %7
               OpName %no_return_in_default_bi "no_return_in_default_bi"                        ; id %8
               OpName %val_2 "val"                                                              ; id %93
               OpName %empty_default_bi "empty_default_bi"                                      ; id %9
               OpName %val_3 "val"                                                              ; id %103
               OpName %return_with_fallthrough_bi "return_with_fallthrough_bi"                  ; id %10
               OpName %fallthrough_ends_in_break_bi "fallthrough_ends_in_break_bi"              ; id %11
               OpName %val_4 "val"                                                              ; id %120
               OpName %fallthrough_to_default_with_break_bi "fallthrough_to_default_with_break_bi"  ; id %12
               OpName %val_5 "val"                                                                  ; id %130
               OpName %fallthrough_to_default_with_return_bi "fallthrough_to_default_with_return_bi"    ; id %13
               OpName %fallthrough_with_loop_break_bi "fallthrough_with_loop_break_bi"                  ; id %14
               OpName %val_6 "val"                                                                      ; id %147
               OpName %i "i"                                                                            ; id %153
               OpName %fallthrough_with_loop_continue_bi "fallthrough_with_loop_continue_bi"            ; id %15
               OpName %val_7 "val"                                                                      ; id %168
               OpName %i_0 "i"                                                                          ; id %174
               OpName %main "main"                                                                      ; id %16
               OpName %x "x"                                                                            ; id %189
...
%fallthrough_with_loop_continue_bi = OpFunction %bool None %37
      ...
      %val_7 =   OpVariable %_ptr_Function_int Function
        ...
        %170 = OpLabel
               ...
               ; Function main
       %main = OpFunction %v4float None %186        ; RelaxedPrecision
        ...
        %192 =   OpLoad %v4float %190               ; RelaxedPrecision
        %193 =   OpCompositeExtract %float %192 1   ; RelaxedPrecision
        ...
        %268 =       OpLoad %v4float %267           ; RelaxedPrecision
                     OpStore %262 %268
                     OpBranch %266
        ...
        %266 = OpLabel
        %271 =   OpLoad %v4float %262               ; RelaxedPrecision
                 OpReturnValue %271
               OpFunctionEnd
