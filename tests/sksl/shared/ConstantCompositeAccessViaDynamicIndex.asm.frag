          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %localMatrix "localMatrix"        ; id %38
...
%localMatrix =   OpVariable %_ptr_Function_mat2v2float Function         ; RelaxedPrecision
                 OpStore %zero %int_0
         %16 =   OpCompositeConstruct %_arr_float_int_2 %float_1 %float_1   ; RelaxedPrecision
                 OpStore %globalArray %16
                 OpStore %globalMatrix %22
         %37 =   OpCompositeConstruct %_arr_float_int_2 %float_0 %float_1   ; RelaxedPrecision
                 OpStore %localArray %37
                 OpStore %localMatrix %44
         %45 =   OpLoad %int %zero
         %46 =   OpAccessChain %_ptr_Private_float %globalArray %45
         %48 =   OpLoad %float %46                  ; RelaxedPrecision
         %49 =   OpLoad %int %zero
         %50 =   OpAccessChain %_ptr_Function_float %localArray %49
         %52 =   OpLoad %float %50                  ; RelaxedPrecision
         %53 =   OpFMul %float %48 %52              ; RelaxedPrecision
         %54 =   OpLoad %int %zero
         %55 =   OpVectorExtractDynamic %float %21 %54
         %56 =   OpLoad %int %zero
         %57 =   OpVectorExtractDynamic %float %21 %56
         %58 =   OpFMul %float %55 %57              ; RelaxedPrecision
         %59 =   OpLoad %int %zero
         %60 =   OpAccessChain %_ptr_Private_v2float %globalMatrix %59
         %62 =   OpLoad %v2float %60                ; RelaxedPrecision
         %63 =   OpLoad %int %zero
         %64 =   OpAccessChain %_ptr_Function_v2float %localMatrix %63
         %65 =   OpLoad %v2float %64                ; RelaxedPrecision
         %66 =   OpFMul %v2float %62 %65            ; RelaxedPrecision
         %67 =   OpCompositeExtract %float %66 0    ; RelaxedPrecision
         %68 =   OpCompositeExtract %float %66 1    ; RelaxedPrecision
         %69 =   OpCompositeConstruct %v4float %53 %58 %67 %68  ; RelaxedPrecision
                 OpReturnValue %69
               OpFunctionEnd
