       ...
       %m3x3 =   OpVariable %_ptr_Function_mat3v3float Function
        ...
        %360 =   OpVariable %_ptr_Function_v4float Function
         ...
         %91 =   OpFAdd %float %90 %float_1
                 OpStore %88 %91
         %92 =   OpLoad %bool %ok                   ; RelaxedPrecision
        ...
        %115 =   OpFSub %float %114 %float_1
                 OpStore %113 %115
        %116 =   OpLoad %bool %ok                   ; RelaxedPrecision
        ...
        %294 =       OpLoad %v4float %292           ; RelaxedPrecision
        %295 =       OpCompositeExtract %float %294 0   ; RelaxedPrecision
        ...
        %303 =       OpCompositeExtract %float %302 1   ; RelaxedPrecision
        %304 =       OpFNegate %float %303              ; RelaxedPrecision
        ...
        %312 =       OpFNegate %v4float %311        ; RelaxedPrecision
        ...
        %366 =       OpLoad %v4float %365           ; RelaxedPrecision
                     OpStore %360 %366
                     OpBranch %364

        %363 =     OpLabel
        %367 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_1
        %368 =       OpLoad %v4float %367           ; RelaxedPrecision
                     OpStore %360 %368
                     OpBranch %364

        %364 = OpLabel
        %369 =   OpLoad %v4float %360               ; RelaxedPrecision
                 OpReturnValue %369
               OpFunctionEnd
