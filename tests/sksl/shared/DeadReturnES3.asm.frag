          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %test_return_b "test_return_b"    ; id %2
               OpName %test_break_b "test_break_b"      ; id %3
               OpName %test_continue_b "test_continue_b"    ; id %4
               OpName %test_if_return_b "test_if_return_b"  ; id %5
               OpName %test_if_break_b "test_if_break_b"    ; id %6
               OpName %test_else_b "test_else_b"            ; id %7
               OpName %test_loop_return_b "test_loop_return_b"  ; id %8
               OpName %test_loop_break_b "test_loop_break_b"    ; id %9
               OpName %x "x"                                    ; id %94
...
%test_if_return_b = OpFunction %bool None %29
         ...
         %60 =       OpLoad %v4float %56            ; RelaxedPrecision
         %61 =       OpCompositeExtract %float %60 1    ; RelaxedPrecision
...
%test_loop_break_b = OpFunction %bool None %29
        ...
        %100 = OpLabel
               ...
               ; Function main
       %main = OpFunction %v4float None %106        ; RelaxedPrecision
        ...
        %142 = OpLabel
        %147 =   OpLoad %v4float %138               ; RelaxedPrecision
                 OpReturnValue %147
               OpFunctionEnd
