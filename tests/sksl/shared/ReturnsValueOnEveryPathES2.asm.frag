          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %return_on_both_sides_b "return_on_both_sides_b"  ; id %2
               OpName %for_inside_body_b "for_inside_body_b"            ; id %3
               OpName %x "x"                                            ; id %40
               OpName %after_for_body_b "after_for_body_b"              ; id %4
               OpName %x_0 "x"                                          ; id %55
               OpName %for_with_double_sided_conditional_return_b "for_with_double_sided_conditional_return_b"  ; id %5
               OpName %x_1 "x"                                                                                  ; id %66
               OpName %if_else_chain_b "if_else_chain_b"                                                        ; id %6
...
%return_on_both_sides_b = OpFunction %bool None %26
         ...
         %32 =   OpLoad %float %28                  ; RelaxedPrecision
...
%if_else_chain_b = OpFunction %bool None %26
         ...
         %84 =   OpLoad %float %83                  ; RelaxedPrecision
         ...
         %90 =       OpLoad %float %89              ; RelaxedPrecision
         ...
         %98 =           OpLoad %float %97          ; RelaxedPrecision
        ...
        %105 =               OpLoad %float %104     ; RelaxedPrecision
        ...
        %103 =         OpLabel
         ...
         %88 = OpLabel
               ...
               ; Function main
       %main = OpFunction %v4float None %111        ; RelaxedPrecision
        ...
        %141 =       OpLoad %v4float %139           ; RelaxedPrecision
                     OpStore %134 %141
                     OpBranch %138
        ...
        %138 = OpLabel
        %144 =   OpLoad %v4float %134               ; RelaxedPrecision
                 OpReturnValue %144
               OpFunctionEnd
