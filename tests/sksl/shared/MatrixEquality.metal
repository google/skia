...
bool _mat2x2_equal_bh22h22(float2x2 x, float2x2 y) {
...
fragment Outputs fragmentMain(Inputs _in [[stage_in]], constant Uniforms& _uniforms [[buffer(0)]], bool _frontFacing [[front_facing]], float4 _fragCoord [[position]]) {
    ...
    (void)_out;
    bool _0_ok = true;
    _0_ok = _0_ok && _mat2x2_equal_bh22h22(_uniforms.testMatrix2x2, float2x2(float2(1.0, 2.0), float2(3.0, 4.0)));
    _0_ok = _0_ok && _uniforms.testMatrix3x3 == float3x3(float3(1.0, 2.0, 3.0), float3(4.0, 5.0, 6.0), float3(7.0, 8.0, 9.0));
    _0_ok = _0_ok && !_mat2x2_equal_bh22h22(_uniforms.testMatrix2x2, float2x2(100.0));
