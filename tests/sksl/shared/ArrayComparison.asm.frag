...
%_entrypoint_v = OpFunction %void None %15
       ...
       %main = OpFunction %v4float None %23         ; RelaxedPrecision
        ...
        %221 =     OpLabel
        %224 =       OpFOrdEqual %v2bool %59 %59    ; RelaxedPrecision
        %225 =       OpAll %bool %224
        %226 =       OpFOrdEqual %v2bool %60 %60    ; RelaxedPrecision
        %227 =       OpAll %bool %226
        %228 =       OpLogicalAnd %bool %225 %227
        %229 =       OpFOrdEqual %v2bool %62 %62    ; RelaxedPrecision
        %230 =       OpAll %bool %229
        %231 =       OpFOrdEqual %v2bool %63 %63    ; RelaxedPrecision
        %232 =       OpAll %bool %231
        %233 =       OpLogicalAnd %bool %230 %232
        %234 =       OpLogicalAnd %bool %233 %228
        %235 =       OpFOrdEqual %v2bool %66 %66    ; RelaxedPrecision
        %236 =       OpAll %bool %235
        %237 =       OpFOrdEqual %v2bool %67 %67    ; RelaxedPrecision
        %238 =       OpAll %bool %237
        ...
        %242 =     OpLabel
        %244 =       OpFUnordNotEqual %v2bool %59 %59   ; RelaxedPrecision
        %245 =       OpAny %bool %244
        %246 =       OpFUnordNotEqual %v2bool %60 %60   ; RelaxedPrecision
        %247 =       OpAny %bool %246
        %248 =       OpLogicalOr %bool %245 %247
        %249 =       OpFUnordNotEqual %v2bool %62 %72   ; RelaxedPrecision
        %250 =       OpAny %bool %249
        %251 =       OpFUnordNotEqual %v2bool %63 %73   ; RelaxedPrecision
        %252 =       OpAny %bool %251
        %253 =       OpLogicalOr %bool %250 %252
        %254 =       OpLogicalOr %bool %253 %248
        %255 =       OpFUnordNotEqual %v2bool %66 %75   ; RelaxedPrecision
        %256 =       OpAny %bool %255
        %257 =       OpFUnordNotEqual %v2bool %67 %76   ; RelaxedPrecision
        %258 =       OpAny %bool %257
        ...
        %289 =       OpLoad %v4float %288           ; RelaxedPrecision
                     OpStore %280 %289
                     OpBranch %284

        %284 = OpLabel
        %290 =   OpLoad %v4float %280               ; RelaxedPrecision
                 OpReturnValue %290
               OpFunctionEnd
