          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %values "values"                  ; id %30
               OpName %index "index"                    ; id %36
               OpName %test4x4_b "test4x4_b"            ; id %3
               OpName %matrix_0 "matrix"                ; id %78
               OpName %values_0 "values"                ; id %80
               OpName %index_0 "index"                  ; id %84
   ...
   %values_0 =   OpVariable %_ptr_Function_v4float Function
    %index_0 =   OpVariable %_ptr_Function_int Function
        ...
        %124 =   OpLogicalAnd %bool %119 %123
               ...
               ; Function main
       %main = OpFunction %v4float None %125        ; RelaxedPrecision
        ...
        %137 = OpLabel
        %143 =   OpLoad %v4float %134               ; RelaxedPrecision
                 OpReturnValue %143
               OpFunctionEnd
