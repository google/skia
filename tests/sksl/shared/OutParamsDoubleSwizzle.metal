...
half2 _skOutParamHelper0_swizzle_lvalue_h2hhh2h(half _var0, half _var1, thread half4& color, half _var3) {
    half2 _var2 = color.xz;
    half2 _skResult = swizzle_lvalue_h2hhh2h(_var0, _var1, _var2, _var3);
    color.xz = _var2;
    return _skResult;
}
...
void func_vh4(thread half4& color) {
    half2 t =     _skOutParamHelper0_swizzle_lvalue_h2hhh2h(1.0h, 2.0h, color, 5.0h);
    color.yw = t;
}
