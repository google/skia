          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %test3x3_b "test3x3_b"            ; id %2
               OpName %matrix "matrix"                  ; id %28
               OpName %expected "expected"              ; id %35
               OpName %index "index"                    ; id %41
               OpName %test4x4_b "test4x4_b"            ; id %3
               OpName %matrix_0 "matrix"                ; id %70
               OpName %expected_0 "expected"            ; id %75
               OpName %index_0 "index"                  ; id %79
    ...
    %index_0 =   OpVariable %_ptr_Function_int Function
        ...
        %101 =     OpIAdd %int %100 %int_1
         ...
         %84 = OpLabel
               ...
               ; Function main
       %main = OpFunction %v4float None %102        ; RelaxedPrecision
        ...
        %113 = OpLabel
        %119 =   OpLoad %v4float %110               ; RelaxedPrecision
                 OpReturnValue %119
               OpFunctionEnd
