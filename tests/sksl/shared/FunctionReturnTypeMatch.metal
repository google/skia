...
fragment Outputs fragmentMain(Inputs _in [[stage_in]], constant Uniforms& _uniforms [[buffer(0)]], bool _frontFacing [[front_facing]], float4 _fragCoord [[position]]) {
    ...
    float2 x9 = returns_half2();
    float3 x10 = returns_half3();
    float4 x11 = returns_half4();
    float2x2 x12 = returns_half2x2();
    float3x3 x13 = returns_half3x3();
    float4x4 x14 = returns_half4x4();
