...
%_entrypoint_v = OpFunction %void None %9
       ...
       %main = OpFunction %v4float None %17         ; RelaxedPrecision
         ...
         %25 =     OpLabel
         %29 =       OpLoad %v4float %x             ; RelaxedPrecision
         %30 =       OpCompositeExtract %float %29 3    ; RelaxedPrecision
         %31 =       OpFOrdEqual %bool %30 %float_1
                     OpBranchConditional %31 %26 %28

         %26 =         OpLabel
         %33 =           OpAccessChain %_ptr_Function_float %x %int_0
         %37 =           OpLoad %float %33          ; RelaxedPrecision
         %39 =           OpFSub %float %37 %float_0_25  ; RelaxedPrecision
                         OpStore %33 %39
         %40 =           OpLoad %v4float %x         ; RelaxedPrecision
         ...
         %46 =     OpLabel
         %50 =       OpLoad %v4float %x             ; RelaxedPrecision
