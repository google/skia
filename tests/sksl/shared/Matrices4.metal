...
fragment Outputs fragmentMain(Inputs _in [[stage_in]], constant Uniforms& _uniforms [[buffer(0)]], bool _frontFacing [[front_facing]], float4 _fragCoord [[position]]) {
    ...
    _0_ok = _0_ok && _2_m1 == float2x2(float2(1.0, 2.0), float2(3.0, 4.0));
    float2x2 _3_m2 = float2x2_from_float4(float4(5.0));
    _0_ok = _0_ok && _3_m2 == float2x2(float2(5.0, 5.0), float2(5.0, 5.0));
    float2x2 _4_m3 = _2_m1;
    _0_ok = _0_ok && _4_m3 == float2x2(float2(1.0, 2.0), float2(3.0, 4.0));
    _4_m3 *= _1_m4;
    _0_ok = _0_ok && _4_m3 == float2x2(float2(6.0, 12.0), float2(18.0, 24.0));
