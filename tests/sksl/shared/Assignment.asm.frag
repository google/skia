          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %globalVar "globalVar"        ; id %11
               OpName %S "S"                        ; id %18
               OpMemberName %S 0 "f"
               OpMemberName %S 1 "af"
               OpMemberName %S 2 "h4"
               OpMemberName %S 3 "ah4"
               OpName %globalStruct "globalStruct"  ; id %13
               OpName %_UniformBuffer "_UniformBuffer"  ; id %21
               OpMemberName %_UniformBuffer 0 "colorGreen"
               OpName %_entrypoint_v "_entrypoint_v"    ; id %23
               OpName %keepAlive_vh "keepAlive_vh"      ; id %2
               OpName %keepAlive_vf "keepAlive_vf"      ; id %3
               OpName %keepAlive_vi "keepAlive_vi"      ; id %4
               OpName %assignToFunctionParameter_vif "assignToFunctionParameter_vif"    ; id %5
               OpName %main "main"                                                      ; id %6
               OpName %i "i"                                                            ; id %52
               OpName %i4 "i4"                                                          ; id %54
               OpName %f3x3 "f3x3"                                                      ; id %61
               OpName %x "x"                                                            ; id %77
               OpName %ai "ai"                                                          ; id %82
               OpName %ai4 "ai4"                                                        ; id %86
               OpName %ah3x3 "ah3x3"                                                    ; id %90
               OpName %af4 "af4"                                                        ; id %94
               OpName %s "s"                                                            ; id %103
               OpName %l "l"                                                            ; id %126
               OpName %repeat "repeat"                                                  ; id %138
...
%_entrypoint_v = OpFunction %void None %25
         ...
         %32 =   OpFunctionCall %v4float %main %30
               ...
               ; Function keepAlive_vh
%keepAlive_vh = OpFunction %void None %34
         %35 = OpFunctionParameter %_ptr_Function_float     ; RelaxedPrecision
...
%keepAlive_vi = OpFunction %void None %40
         ...
         %42 = OpLabel
               ...
               ; Function assignToFunctionParameter_vif
%assignToFunctionParameter_vif = OpFunction %void None %43
      ...
      %ah3x3 =   OpVariable %_ptr_Function__arr_mat3v3float_int_1 Function
        ...
        %123 =   OpVariable %_ptr_Function_float Function
          %l =   OpVariable %_ptr_Function_float Function   ; RelaxedPrecision
     %repeat =   OpVariable %_ptr_Function_float Function
        %142 =   OpVariable %_ptr_Function_float Function
        %148 =   OpVariable %_ptr_Function_float Function   ; RelaxedPrecision
        ...
        %173 =   OpVariable %_ptr_Function_float Function   ; RelaxedPrecision
        %178 =   OpVariable %_ptr_Function_float Function
        %182 =   OpVariable %_ptr_Function_float Function   ; RelaxedPrecision
        ...
        %192 =   OpVariable %_ptr_Function_float Function
         ...
         %79 =   OpAccessChain %_ptr_Function_float %x %int_3
                 OpStore %79 %float_0
         %80 =   OpLoad %v4float %x                 ; RelaxedPrecision
         %81 =   OpVectorShuffle %v4float %80 %29 5 4 2 3   ; RelaxedPrecision
                 OpStore %x %81
        ...
        %110 =   OpVectorShuffle %v4float %109 %107 5 6 4 3     ; RelaxedPrecision
                 OpStore %108 %110
        %112 =   OpAccessChain %_ptr_Function_v4float %s %int_3 %int_2
        %113 =   OpLoad %v4float %112               ; RelaxedPrecision
        %114 =   OpVectorShuffle %v4float %113 %111 0 4 2 5     ; RelaxedPrecision
                 OpStore %112 %114
        ...
        %147 =   OpLoad %float %146                 ; RelaxedPrecision
                 OpStore %148 %147
        %149 =   OpFunctionCall %void %keepAlive_vh %148
        %150 =   OpLoad %float %148                 ; RelaxedPrecision
                 OpStore %146 %150
        %151 =   OpLoad %int %i
                 OpStore %152 %151
        ...
        %172 =   OpLoad %float %171                 ; RelaxedPrecision
                 OpStore %173 %172
        %174 =   OpFunctionCall %void %keepAlive_vh %173
        %175 =   OpLoad %float %173                 ; RelaxedPrecision
                 OpStore %171 %175
        ...
        %180 =   OpLoad %float %178
                 OpStore %176 %180
        %181 =   OpLoad %float %l                   ; RelaxedPrecision
                 OpStore %182 %181
        %183 =   OpFunctionCall %void %keepAlive_vh %182
        %184 =   OpLoad %float %182                 ; RelaxedPrecision
                 OpStore %l %184
        ...
        %197 =   OpLoad %v4float %195               ; RelaxedPrecision
                 OpReturnValue %197
               OpFunctionEnd
