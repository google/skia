          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %ok "ok"                          ; id %24
               OpName %m23 "m23"                        ; id %27
               OpName %m24 "m24"                        ; id %45
               OpName %m32 "m32"                        ; id %61
               OpName %m34 "m34"                        ; id %80
               OpName %m42 "m42"                        ; id %99
               OpName %m43 "m43"                        ; id %120
               OpName %m22 "m22"                        ; id %143
               OpName %m33 "m33"                        ; id %161
               OpName %main "main"                      ; id %3
               OpName %_0_ok "_0_ok"                    ; id %242
               OpName %_1_m23 "_1_m23"                  ; id %243
               OpName %_2_m24 "_2_m24"                  ; id %252
               OpName %_3_m32 "_3_m32"                  ; id %261
               OpName %_7_m22 "_7_m22"                  ; id %273
...
%test_half_b = OpFunction %bool None %22
        ...
        %m33 =   OpVariable %_ptr_Function_mat3v3float Function     ; RelaxedPrecision
         ...
         %36 =     OpLabel
         %39 =       OpFOrdEqual %v3bool %32 %32    ; RelaxedPrecision
         %40 =       OpAll %bool %39
         %41 =       OpFOrdEqual %v3bool %33 %33    ; RelaxedPrecision
         %42 =       OpAll %bool %41
         ...
         %52 =     OpLabel
         %55 =       OpFOrdEqual %v4bool %49 %49    ; RelaxedPrecision
         %56 =       OpAll %bool %55
         %57 =       OpFOrdEqual %v4bool %50 %50    ; RelaxedPrecision
         %58 =       OpAll %bool %57
         ...
         %68 =     OpLabel
         %71 =       OpFOrdEqual %v2bool %65 %65    ; RelaxedPrecision
         %72 =       OpAll %bool %71
         %73 =       OpFOrdEqual %v2bool %66 %66    ; RelaxedPrecision
         %74 =       OpAll %bool %73
         %75 =       OpLogicalAnd %bool %72 %74
         %76 =       OpFOrdEqual %v2bool %17 %17    ; RelaxedPrecision
         %77 =       OpAll %bool %76
         ...
         %88 =     OpLabel
         %90 =       OpFOrdEqual %v4bool %84 %84    ; RelaxedPrecision
         %91 =       OpAll %bool %90
         %92 =       OpFOrdEqual %v4bool %85 %85    ; RelaxedPrecision
         %93 =       OpAll %bool %92
         %94 =       OpLogicalAnd %bool %91 %93
         %95 =       OpFOrdEqual %v4bool %86 %86    ; RelaxedPrecision
         %96 =       OpAll %bool %95
        ...
        %106 =     OpLabel
        %108 =       OpFOrdEqual %v2bool %103 %103  ; RelaxedPrecision
        %109 =       OpAll %bool %108
        %110 =       OpFOrdEqual %v2bool %104 %104  ; RelaxedPrecision
        %111 =       OpAll %bool %110
        %112 =       OpLogicalAnd %bool %109 %111
        %113 =       OpFOrdEqual %v2bool %17 %17    ; RelaxedPrecision
        %114 =       OpAll %bool %113
        %115 =       OpLogicalAnd %bool %112 %114
        %116 =       OpFOrdEqual %v2bool %17 %17    ; RelaxedPrecision
        %117 =       OpAll %bool %116
        ...
        %129 =     OpLabel
        %131 =       OpFOrdEqual %v3bool %124 %124  ; RelaxedPrecision
        %132 =       OpAll %bool %131
        %133 =       OpFOrdEqual %v3bool %125 %125  ; RelaxedPrecision
        %134 =       OpAll %bool %133
        %135 =       OpLogicalAnd %bool %132 %134
        %136 =       OpFOrdEqual %v3bool %126 %126  ; RelaxedPrecision
        %137 =       OpAll %bool %136
        %138 =       OpLogicalAnd %bool %135 %137
        %139 =       OpFOrdEqual %v3bool %127 %127  ; RelaxedPrecision
        %140 =       OpAll %bool %139
        ...
        %142 =   OpPhi %bool %false %107 %141 %129
                 OpStore %ok %142
        %146 =   OpMatrixTimesMatrix %mat2v2float %67 %34   ; RelaxedPrecision
                 OpStore %m22 %146
                 OpSelectionMerge %148 None
                 OpBranchConditional %142 %147 %148

        %147 =     OpLabel
        %153 =       OpCompositeExtract %v2float %146 0     ; RelaxedPrecision
        %154 =       OpFOrdEqual %v2bool %153 %150          ; RelaxedPrecision
        %155 =       OpAll %bool %154
        %156 =       OpCompositeExtract %v2float %146 1     ; RelaxedPrecision
        %157 =       OpFOrdEqual %v2bool %156 %151          ; RelaxedPrecision
        %158 =       OpAll %bool %157
        ...
        %160 =   OpPhi %bool %false %130 %159 %147
                 OpStore %ok %160
        %164 =   OpMatrixTimesMatrix %mat3v3float %128 %87  ; RelaxedPrecision
                 OpStore %m33 %164
                 OpSelectionMerge %166 None
                 OpBranchConditional %160 %165 %166

        %165 =     OpLabel
        %172 =       OpCompositeExtract %v3float %164 0     ; RelaxedPrecision
        %173 =       OpFOrdEqual %v3bool %172 %168          ; RelaxedPrecision
        %174 =       OpAll %bool %173
        %175 =       OpCompositeExtract %v3float %164 1     ; RelaxedPrecision
        %176 =       OpFOrdEqual %v3bool %175 %169          ; RelaxedPrecision
        %177 =       OpAll %bool %176
        %178 =       OpLogicalAnd %bool %174 %177
        %179 =       OpCompositeExtract %v3float %164 2     ; RelaxedPrecision
        %180 =       OpFOrdEqual %v3bool %179 %170          ; RelaxedPrecision
        %181 =       OpAll %bool %180
        ...
        %183 =   OpPhi %bool %false %148 %182 %165
                 OpStore %ok %183
        %187 =   OpFAdd %v3float %32 %185           ; RelaxedPrecision
        %188 =   OpFAdd %v3float %33 %185           ; RelaxedPrecision
        %189 =   OpCompositeConstruct %mat2v3float %187 %188    ; RelaxedPrecision
                 OpStore %m23 %189
                 OpSelectionMerge %191 None
                 OpBranchConditional %183 %190 %191

        %190 =     OpLabel
        %195 =       OpFOrdEqual %v3bool %187 %192  ; RelaxedPrecision
        %196 =       OpAll %bool %195
        %197 =       OpFOrdEqual %v3bool %188 %193  ; RelaxedPrecision
        %198 =       OpAll %bool %197
        ...
        %200 =   OpPhi %bool %false %166 %199 %190
                 OpStore %ok %200
        %203 =   OpFSub %v2float %65 %201           ; RelaxedPrecision
        %204 =   OpFSub %v2float %66 %201           ; RelaxedPrecision
        %205 =   OpFSub %v2float %17 %201           ; RelaxedPrecision
        %206 =   OpCompositeConstruct %mat3v2float %203 %204 %205   ; RelaxedPrecision
                 OpStore %m32 %206
                 OpSelectionMerge %208 None
                 OpBranchConditional %200 %207 %208

        %207 =     OpLabel
        %214 =       OpFOrdEqual %v2bool %203 %210  ; RelaxedPrecision
        %215 =       OpAll %bool %214
        %216 =       OpFOrdEqual %v2bool %204 %211  ; RelaxedPrecision
        %217 =       OpAll %bool %216
        %218 =       OpLogicalAnd %bool %215 %217
        %219 =       OpFOrdEqual %v2bool %205 %212  ; RelaxedPrecision
        %220 =       OpAll %bool %219
        ...
        %222 =   OpPhi %bool %false %191 %221 %207
                 OpStore %ok %222
        %224 =   OpMatrixTimesScalar %mat2v4float %51 %float_0_25   ; RelaxedPrecision
                 OpStore %m24 %224
                 OpSelectionMerge %226 None
                 OpBranchConditional %222 %225 %226

        %225 =     OpLabel
        %231 =       OpCompositeExtract %v4float %224 0     ; RelaxedPrecision
        %232 =       OpFOrdEqual %v4bool %231 %228          ; RelaxedPrecision
        %233 =       OpAll %bool %232
        %234 =       OpCompositeExtract %v4float %224 1     ; RelaxedPrecision
        %235 =       OpFOrdEqual %v4bool %234 %229          ; RelaxedPrecision
        %236 =       OpAll %bool %235
     ...
     %_7_m22 =   OpVariable %_ptr_Function_mat2v2float Function
        ...
        %335 =       OpLoad %v4float %331           ; RelaxedPrecision
                     OpStore %326 %335
                     OpBranch %330

        %329 =     OpLabel
        %336 =       OpAccessChain %_ptr_Uniform_v4float %8 %int_1
        %338 =       OpLoad %v4float %336           ; RelaxedPrecision
                     OpStore %326 %338
                     OpBranch %330

        %330 = OpLabel
        %339 =   OpLoad %v4float %326               ; RelaxedPrecision
                 OpReturnValue %339
               OpFunctionEnd
