          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               ; Debug Information
               OpName %sk_FragColor "sk_FragColor"  ; id %26
               OpName %_UniformBuffer "_UniformBuffer"  ; id %31
               OpMemberName %_UniformBuffer 0 "colorGreen"
               OpMemberName %_UniformBuffer 1 "colorRed"
               OpName %_entrypoint_v "_entrypoint_v"    ; id %33
               OpName %takes_void_b "takes_void_b"      ; id %2
               OpName %takes_float_bf "takes_float_bf"  ; id %3
               OpName %takes_float2_bf2 "takes_float2_bf2"  ; id %4
               OpName %takes_float3_bf3 "takes_float3_bf3"  ; id %5
               OpName %takes_float4_bf4 "takes_float4_bf4"  ; id %6
               OpName %takes_float2x2_bf22 "takes_float2x2_bf22"    ; id %7
               OpName %takes_float3x3_bf33 "takes_float3x3_bf33"    ; id %8
               OpName %takes_float4x4_bf44 "takes_float4x4_bf44"    ; id %9
               OpName %takes_half_bh "takes_half_bh"                ; id %10
               OpName %takes_half2_bh2 "takes_half2_bh2"            ; id %11
               OpName %takes_half3_bh3 "takes_half3_bh3"            ; id %12
               OpName %takes_half4_bh4 "takes_half4_bh4"            ; id %13
               OpName %takes_half2x2_bh22 "takes_half2x2_bh22"      ; id %14
               OpName %takes_half3x3_bh33 "takes_half3x3_bh33"      ; id %15
               OpName %takes_half4x4_bh44 "takes_half4x4_bh44"      ; id %16
               OpName %takes_bool_bb "takes_bool_bb"                ; id %17
               OpName %takes_bool2_bb2 "takes_bool2_bb2"            ; id %18
               OpName %takes_bool3_bb3 "takes_bool3_bb3"            ; id %19
               OpName %takes_bool4_bb4 "takes_bool4_bb4"            ; id %20
               OpName %takes_int_bi "takes_int_bi"                  ; id %21
               OpName %takes_int2_bi2 "takes_int2_bi2"              ; id %22
               OpName %takes_int3_bi3 "takes_int3_bi3"              ; id %23
               OpName %takes_int4_bi4 "takes_int4_bi4"              ; id %24
...
%_ptr_Uniform__UniformBuffer = OpTypePointer Uniform %_UniformBuffer
         %30 = OpVariable %_ptr_Uniform__UniformBuffer Uniform  ; Binding 0, DescriptorSet 0
       %void = OpTypeVoid
...
%takes_half_bh = OpFunction %bool None %48
         %78 = OpFunctionParameter %_ptr_Function_float     ; RelaxedPrecision
...
%takes_half2_bh2 = OpFunction %bool None %51
         %80 = OpFunctionParameter %_ptr_Function_v2float   ; RelaxedPrecision
...
%takes_half3_bh3 = OpFunction %bool None %56
         %82 = OpFunctionParameter %_ptr_Function_v3float   ; RelaxedPrecision
...
%takes_half4_bh4 = OpFunction %bool None %60
         %84 = OpFunctionParameter %_ptr_Function_v4float   ; RelaxedPrecision
...
%takes_half2x2_bh22 = OpFunction %bool None %65
         %86 = OpFunctionParameter %_ptr_Function_mat2v2float   ; RelaxedPrecision
...
%takes_half3x3_bh33 = OpFunction %bool None %70
         %88 = OpFunctionParameter %_ptr_Function_mat3v3float   ; RelaxedPrecision
...
%takes_half4x4_bh44 = OpFunction %bool None %75
         %90 = OpFunctionParameter %_ptr_Function_mat4v4float   ; RelaxedPrecision
...
%takes_int4_bi4 = OpFunction %bool None %128
       ...
       %main = OpFunction %v4float None %131        ; RelaxedPrecision
        ...
        %285 =       OpLoad %v4float %282           ; RelaxedPrecision
                     OpStore %278 %285
                     OpBranch %281

        %280 =     OpLabel
        %286 =       OpAccessChain %_ptr_Uniform_v4float %30 %int_1
        %287 =       OpLoad %v4float %286           ; RelaxedPrecision
                     OpStore %278 %287
                     OpBranch %281

        %281 = OpLabel
        %288 =   OpLoad %v4float %278               ; RelaxedPrecision
                 OpReturnValue %288
               OpFunctionEnd
