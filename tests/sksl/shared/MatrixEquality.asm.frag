          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %_0_ok "_0_ok"                    ; id %26
               OpName %_1_zero "_1_zero"                ; id %118
               OpName %_2_one "_2_one"                  ; id %125
               OpName %_3_two "_3_two"                  ; id %129
               OpName %_4_nine "_4_nine"                ; id %131
               OpName %_5_m "_5_m"                      ; id %470
    ...
    %_4_nine =   OpVariable %_ptr_Function_float Function
       %_5_m =   OpVariable %_ptr_Function_mat3v3float Function
        %561 =   OpVariable %_ptr_Function_v4float Function
         ...
         %37 =       OpLoad %mat2v2float %33        ; RelaxedPrecision
         %46 =       OpCompositeExtract %v2float %37 0  ; RelaxedPrecision
         %47 =       OpFOrdEqual %v2bool %46 %42        ; RelaxedPrecision
         %48 =       OpAll %bool %47
         %49 =       OpCompositeExtract %v2float %37 1  ; RelaxedPrecision
         %50 =       OpFOrdEqual %v2bool %49 %43        ; RelaxedPrecision
         %51 =       OpAll %bool %50
         ...
         %59 =       OpLoad %mat3v3float %56        ; RelaxedPrecision
         %70 =       OpCompositeExtract %v3float %59 0  ; RelaxedPrecision
         %71 =       OpFOrdEqual %v3bool %70 %65        ; RelaxedPrecision
         %72 =       OpAll %bool %71
         %73 =       OpCompositeExtract %v3float %59 1  ; RelaxedPrecision
         %74 =       OpFOrdEqual %v3bool %73 %66        ; RelaxedPrecision
         %75 =       OpAll %bool %74
         %76 =       OpLogicalAnd %bool %72 %75
         %77 =       OpCompositeExtract %v3float %59 2  ; RelaxedPrecision
         %78 =       OpFOrdEqual %v3bool %77 %67        ; RelaxedPrecision
         %79 =       OpAll %bool %78
         ...
         %85 =       OpLoad %mat2v2float %84        ; RelaxedPrecision
         %90 =       OpCompositeExtract %v2float %85 0  ; RelaxedPrecision
         %91 =       OpFUnordNotEqual %v2bool %90 %87   ; RelaxedPrecision
         %92 =       OpAny %bool %91
         %93 =       OpCompositeExtract %v2float %85 1  ; RelaxedPrecision
         %94 =       OpFUnordNotEqual %v2bool %93 %88   ; RelaxedPrecision
         %95 =       OpAny %bool %94
        ...
        %101 =       OpLoad %mat3v3float %100       ; RelaxedPrecision
        %106 =       OpCompositeExtract %v3float %101 0     ; RelaxedPrecision
        %107 =       OpFUnordNotEqual %v3bool %106 %102     ; RelaxedPrecision
        %108 =       OpAny %bool %107
        %109 =       OpCompositeExtract %v3float %101 1     ; RelaxedPrecision
        %110 =       OpFUnordNotEqual %v3bool %109 %103     ; RelaxedPrecision
        %111 =       OpAny %bool %110
        %112 =       OpLogicalOr %bool %108 %111
        %113 =       OpCompositeExtract %v3float %101 2     ; RelaxedPrecision
        %114 =       OpFUnordNotEqual %v3bool %113 %104     ; RelaxedPrecision
        %115 =       OpAny %bool %114
        ...
        %124 =   OpCompositeExtract %float %123 0   ; RelaxedPrecision
                 OpStore %_1_zero %124
        ...
        %421 =       OpLoad %mat2v2float %420       ; RelaxedPrecision
        %422 =       OpCompositeExtract %float %421 0 0     ; RelaxedPrecision
        %423 =       OpCompositeExtract %float %421 0 1     ; RelaxedPrecision
        %424 =       OpCompositeExtract %float %421 1 0     ; RelaxedPrecision
        %425 =       OpCompositeExtract %float %421 1 1     ; RelaxedPrecision
        %426 =       OpCompositeConstruct %v4float %422 %423 %424 %425  ; RelaxedPrecision
        ...
        %437 =       OpLoad %mat2v2float %436       ; RelaxedPrecision
        %438 =       OpCompositeExtract %float %437 0 0     ; RelaxedPrecision
        %439 =       OpCompositeExtract %float %437 0 1     ; RelaxedPrecision
        %440 =       OpCompositeExtract %float %437 1 0     ; RelaxedPrecision
        %441 =       OpCompositeExtract %float %437 1 1     ; RelaxedPrecision
        %442 =       OpCompositeConstruct %v4float %438 %439 %440 %441  ; RelaxedPrecision
        ...
        %446 =       OpLoad %mat2v2float %445       ; RelaxedPrecision
        %447 =       OpCompositeExtract %float %446 0 0     ; RelaxedPrecision
        %448 =       OpCompositeExtract %float %446 0 1     ; RelaxedPrecision
        %449 =       OpCompositeExtract %float %446 1 0     ; RelaxedPrecision
        %450 =       OpCompositeExtract %float %446 1 1     ; RelaxedPrecision
        %451 =       OpCompositeConstruct %v4float %447 %448 %449 %450  ; RelaxedPrecision
        ...
        %458 =       OpLoad %mat2v2float %457       ; RelaxedPrecision
        %459 =       OpCompositeExtract %float %458 0 0     ; RelaxedPrecision
        %460 =       OpCompositeExtract %float %458 0 1     ; RelaxedPrecision
        %461 =       OpCompositeExtract %float %458 1 0     ; RelaxedPrecision
        %462 =       OpCompositeExtract %float %458 1 1     ; RelaxedPrecision
        %463 =       OpCompositeConstruct %v4float %459 %460 %461 %462  ; RelaxedPrecision
        ...
        %567 =       OpLoad %v4float %566           ; RelaxedPrecision
                     OpStore %561 %567
                     OpBranch %565

        %564 =     OpLabel
        %568 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_1
        %569 =       OpLoad %v4float %568           ; RelaxedPrecision
                     OpStore %561 %569
                     OpBranch %565

        %565 = OpLabel
        %570 =   OpLoad %v4float %561               ; RelaxedPrecision
                 OpReturnValue %570
               OpFunctionEnd
