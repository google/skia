          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %_UniformBuffer "_UniformBuffer"  ; id %30
               OpMemberName %_UniformBuffer 0 "colorGreen"
               OpMemberName %_UniformBuffer 1 "colorRed"
               OpMemberName %_UniformBuffer 2 "colorWhite"
               OpName %_entrypoint_v "_entrypoint_v"    ; id %32
               OpName %out_half_vh "out_half_vh"        ; id %2
               OpName %out_half2_vh2 "out_half2_vh2"    ; id %3
               OpName %out_half3_vh3 "out_half3_vh3"    ; id %4
               OpName %out_half4_vh4 "out_half4_vh4"    ; id %5
               OpName %out_half2x2_vh22 "out_half2x2_vh22"  ; id %6
               OpName %out_half3x3_vh33 "out_half3x3_vh33"  ; id %7
               OpName %out_half4x4_vh44 "out_half4x4_vh44"  ; id %8
               OpName %out_int_vi "out_int_vi"              ; id %9
               OpName %out_int2_vi2 "out_int2_vi2"          ; id %10
               OpName %out_int3_vi3 "out_int3_vi3"          ; id %11
               OpName %out_int4_vi4 "out_int4_vi4"          ; id %12
               OpName %out_float_vf "out_float_vf"          ; id %13
               OpName %out_float2_vf2 "out_float2_vf2"      ; id %14
               OpName %out_float3_vf3 "out_float3_vf3"      ; id %15
               OpName %out_float4_vf4 "out_float4_vf4"      ; id %16
               OpName %out_float2x2_vf22 "out_float2x2_vf22"    ; id %17
               OpName %out_float3x3_vf33 "out_float3x3_vf33"    ; id %18
               OpName %out_float4x4_vf44 "out_float4x4_vf44"    ; id %19
               OpName %out_bool_vb "out_bool_vb"                ; id %20
               OpName %out_bool2_vb2 "out_bool2_vb2"            ; id %21
               OpName %out_bool3_vb3 "out_bool3_vb3"            ; id %22
               OpName %out_bool4_vb4 "out_bool4_vb4"            ; id %23
               OpName %main "main"                              ; id %24
               OpName %h "h"                                    ; id %242
               OpName %h2 "h2"                                  ; id %246
               OpName %h3 "h3"                                  ; id %250
               OpName %h4 "h4"                                  ; id %254
               OpName %h2x2 "h2x2"                              ; id %273
               OpName %h3x3 "h3x3"                              ; id %277
               OpName %h4x4 "h4x4"                              ; id %281
               OpName %i "i"                                    ; id %301
               OpName %i2 "i2"                                  ; id %305
               OpName %i3 "i3"                                  ; id %309
               OpName %i4 "i4"                                  ; id %313
               ...
               OpName %f3 "f3"                                  ; id %334
               OpName %f4 "f4"                                  ; id %338
               OpName %f2x2 "f2x2"                              ; id %351
               OpName %f3x3 "f3x3"                              ; id %355
               OpName %f4x4 "f4x4"                              ; id %359
               OpName %b "b"                                    ; id %368
               OpName %b2 "b2"                                  ; id %372
               OpName %b3 "b3"                                  ; id %376
               OpName %b4 "b4"                                  ; id %380
...
%_ptr_Uniform__UniformBuffer = OpTypePointer Uniform %_UniformBuffer
         %29 = OpVariable %_ptr_Uniform__UniformBuffer Uniform  ; Binding 0, DescriptorSet 0
       %void = OpTypeVoid
...
%out_half_vh = OpFunction %void None %43
         %44 = OpFunctionParameter %_ptr_Function_float     ; RelaxedPrecision

         %45 = OpLabel
         %46 =   OpAccessChain %_ptr_Uniform_v4float %29 %int_2
         %50 =   OpLoad %v4float %46                ; RelaxedPrecision
...
%out_half2_vh2 = OpFunction %void None %52
         %53 = OpFunctionParameter %_ptr_Function_v2float   ; RelaxedPrecision
         ...
         %58 =   OpCompositeConstruct %v2float %57 %57  ; RelaxedPrecision
                 OpStore %53 %58
                 OpReturn
               OpFunctionEnd
...
%out_half3_vh3 = OpFunction %void None %61
         %62 = OpFunctionParameter %_ptr_Function_v3float   ; RelaxedPrecision

         %63 = OpLabel
         %64 =   OpAccessChain %_ptr_Uniform_v4float %29 %int_2
         %65 =   OpLoad %v4float %64                ; RelaxedPrecision
         %66 =   OpCompositeExtract %float %65 2    ; RelaxedPrecision
         %67 =   OpCompositeConstruct %v3float %66 %66 %66  ; RelaxedPrecision
                 OpStore %62 %67
                 OpReturn
               OpFunctionEnd
...
%out_half4_vh4 = OpFunction %void None %69
         %70 = OpFunctionParameter %_ptr_Function_v4float   ; RelaxedPrecision

         %71 = OpLabel
         %72 =   OpAccessChain %_ptr_Uniform_v4float %29 %int_2
         %73 =   OpLoad %v4float %72                ; RelaxedPrecision
         %74 =   OpCompositeExtract %float %73 3    ; RelaxedPrecision
         %75 =   OpCompositeConstruct %v4float %74 %74 %74 %74  ; RelaxedPrecision
                 OpStore %70 %75
                 OpReturn
               OpFunctionEnd
...
%out_half2x2_vh22 = OpFunction %void None %78
         %79 = OpFunctionParameter %_ptr_Function_mat2v2float   ; RelaxedPrecision
         ...
         %84 =   OpCompositeConstruct %v2float %83 %float_0     ; RelaxedPrecision
         %85 =   OpCompositeConstruct %v2float %float_0 %83     ; RelaxedPrecision
         %86 =   OpCompositeConstruct %mat2v2float %84 %85      ; RelaxedPrecision
                 OpStore %79 %86
                 OpReturn
               OpFunctionEnd
...
%out_half3x3_vh33 = OpFunction %void None %89
         %90 = OpFunctionParameter %_ptr_Function_mat3v3float   ; RelaxedPrecision
         ...
         %95 =   OpCompositeConstruct %v3float %94 %float_0 %float_0    ; RelaxedPrecision
         %96 =   OpCompositeConstruct %v3float %float_0 %94 %float_0    ; RelaxedPrecision
         %97 =   OpCompositeConstruct %v3float %float_0 %float_0 %94    ; RelaxedPrecision
         %98 =   OpCompositeConstruct %mat3v3float %95 %96 %97          ; RelaxedPrecision
                 OpStore %90 %98
                 OpReturn
               OpFunctionEnd
...
%out_half4x4_vh44 = OpFunction %void None %101
        %102 = OpFunctionParameter %_ptr_Function_mat4v4float   ; RelaxedPrecision

        %103 = OpLabel
        %104 =   OpAccessChain %_ptr_Uniform_v4float %29 %int_2
        %105 =   OpLoad %v4float %104               ; RelaxedPrecision
        %106 =   OpCompositeExtract %float %105 2   ; RelaxedPrecision
        %107 =   OpCompositeConstruct %v4float %106 %float_0 %float_0 %float_0  ; RelaxedPrecision
        %108 =   OpCompositeConstruct %v4float %float_0 %106 %float_0 %float_0  ; RelaxedPrecision
        %109 =   OpCompositeConstruct %v4float %float_0 %float_0 %106 %float_0  ; RelaxedPrecision
        %110 =   OpCompositeConstruct %v4float %float_0 %float_0 %float_0 %106  ; RelaxedPrecision
        %111 =   OpCompositeConstruct %mat4v4float %107 %108 %109 %110          ; RelaxedPrecision
                 OpStore %102 %111
                 OpReturn
               OpFunctionEnd
...
%out_int3_vi3 = OpFunction %void None %132
        ...
        %137 =   OpCompositeExtract %float %136 2   ; RelaxedPrecision
...
%out_int4_vi4 = OpFunction %void None %142
        ...
        %147 =   OpCompositeExtract %float %146 3   ; RelaxedPrecision
...
%out_float2_vf2 = OpFunction %void None %52
        ...
        %159 =   OpCompositeExtract %float %158 1   ; RelaxedPrecision
...
%out_float3_vf3 = OpFunction %void None %61
        ...
        %165 =   OpCompositeExtract %float %164 2   ; RelaxedPrecision
...
%out_float4_vf4 = OpFunction %void None %69
        ...
        %171 =   OpCompositeExtract %float %170 3   ; RelaxedPrecision
...
%out_float2x2_vf22 = OpFunction %void None %78
        ...
        %177 =   OpCompositeExtract %float %176 0   ; RelaxedPrecision
...
%out_float4x4_vf44 = OpFunction %void None %101
        ...
        %194 =   OpCompositeExtract %float %193 2   ; RelaxedPrecision
...
%out_bool2_vb2 = OpFunction %void None %211
        ...
        %215 =   OpLoad %v4float %214               ; RelaxedPrecision
        %216 =   OpCompositeExtract %float %215 1   ; RelaxedPrecision
...
%out_bool3_vb3 = OpFunction %void None %221
        ...
        %226 =   OpCompositeExtract %float %225 2   ; RelaxedPrecision
...
%out_bool4_vb4 = OpFunction %void None %231
        ...
        %238 =   OpCompositeConstruct %v4bool %237 %237 %237 %237
               ...
               ; Function main
       %main = OpFunction %v4float None %239        ; RelaxedPrecision
        %240 = OpFunctionParameter %_ptr_Function_v2float

        %241 = OpLabel
          %h =   OpVariable %_ptr_Function_float Function   ; RelaxedPrecision
        %243 =   OpVariable %_ptr_Function_float Function   ; RelaxedPrecision
         %h2 =   OpVariable %_ptr_Function_v2float Function     ; RelaxedPrecision
        %247 =   OpVariable %_ptr_Function_v2float Function     ; RelaxedPrecision
         %h3 =   OpVariable %_ptr_Function_v3float Function     ; RelaxedPrecision
        %251 =   OpVariable %_ptr_Function_v3float Function     ; RelaxedPrecision
         %h4 =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
        %255 =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
        %260 =   OpVariable %_ptr_Function_float Function       ; RelaxedPrecision
        %263 =   OpVariable %_ptr_Function_v2float Function     ; RelaxedPrecision
        %268 =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
       %h2x2 =   OpVariable %_ptr_Function_mat2v2float Function     ; RelaxedPrecision
        %274 =   OpVariable %_ptr_Function_mat2v2float Function     ; RelaxedPrecision
       %h3x3 =   OpVariable %_ptr_Function_mat3v3float Function     ; RelaxedPrecision
        %278 =   OpVariable %_ptr_Function_mat3v3float Function     ; RelaxedPrecision
       %h4x4 =   OpVariable %_ptr_Function_mat4v4float Function     ; RelaxedPrecision
        %282 =   OpVariable %_ptr_Function_mat4v4float Function     ; RelaxedPrecision
        %286 =   OpVariable %_ptr_Function_v3float Function         ; RelaxedPrecision
        %292 =   OpVariable %_ptr_Function_float Function           ; RelaxedPrecision
        %298 =   OpVariable %_ptr_Function_float Function           ; RelaxedPrecision
       ...
       %f4x4 =   OpVariable %_ptr_Function_mat4v4float Function
        ...
        %245 =   OpLoad %float %243                 ; RelaxedPrecision
                 OpStore %h %245
        %248 =   OpFunctionCall %void %out_half2_vh2 %247
        %249 =   OpLoad %v2float %247               ; RelaxedPrecision
                 OpStore %h2 %249
        %252 =   OpFunctionCall %void %out_half3_vh3 %251
        %253 =   OpLoad %v3float %251               ; RelaxedPrecision
                 OpStore %h3 %253
        %256 =   OpFunctionCall %void %out_half4_vh4 %255
        %257 =   OpLoad %v4float %255               ; RelaxedPrecision
                 OpStore %h4 %257
        %258 =   OpAccessChain %_ptr_Function_float %h3 %int_1
        %261 =   OpFunctionCall %void %out_half_vh %260
        %262 =   OpLoad %float %260                 ; RelaxedPrecision
                 OpStore %258 %262
        %264 =   OpFunctionCall %void %out_half2_vh2 %263
        %265 =   OpLoad %v2float %263               ; RelaxedPrecision
        %266 =   OpLoad %v3float %h3                ; RelaxedPrecision
        %267 =   OpVectorShuffle %v3float %266 %265 3 1 4   ; RelaxedPrecision
                 OpStore %h3 %267
        %269 =   OpFunctionCall %void %out_half4_vh4 %268
        %270 =   OpLoad %v4float %268               ; RelaxedPrecision
        %271 =   OpLoad %v4float %h4                ; RelaxedPrecision
        %272 =   OpVectorShuffle %v4float %271 %270 6 7 4 5     ; RelaxedPrecision
                 OpStore %h4 %272
        %275 =   OpFunctionCall %void %out_half2x2_vh22 %274
        %276 =   OpLoad %mat2v2float %274           ; RelaxedPrecision
                 OpStore %h2x2 %276
        %279 =   OpFunctionCall %void %out_half3x3_vh33 %278
        %280 =   OpLoad %mat3v3float %278           ; RelaxedPrecision
                 OpStore %h3x3 %280
        %283 =   OpFunctionCall %void %out_half4x4_vh44 %282
        %284 =   OpLoad %mat4v4float %282           ; RelaxedPrecision
                 OpStore %h4x4 %284
        %285 =   OpAccessChain %_ptr_Function_v3float %h3x3 %int_1
        %287 =   OpFunctionCall %void %out_half3_vh3 %286
        %288 =   OpLoad %v3float %286               ; RelaxedPrecision
                 OpStore %285 %288
        ...
        %294 =   OpLoad %float %292                 ; RelaxedPrecision
                 OpStore %291 %294
        ...
        %300 =   OpLoad %float %298                 ; RelaxedPrecision
                 OpStore %297 %300
        ...
        %396 =     OpLabel
        %399 =       OpLoad %float %h               ; RelaxedPrecision
        %400 =       OpLoad %v2float %h2            ; RelaxedPrecision
        %401 =       OpCompositeExtract %float %400 0   ; RelaxedPrecision
        %402 =       OpFMul %float %399 %401            ; RelaxedPrecision
        %403 =       OpLoad %v3float %h3                ; RelaxedPrecision
        %404 =       OpCompositeExtract %float %403 0   ; RelaxedPrecision
        %405 =       OpFMul %float %402 %404            ; RelaxedPrecision
        %406 =       OpLoad %v4float %h4                ; RelaxedPrecision
        ...
        %410 =       OpLoad %v2float %409           ; RelaxedPrecision
        %411 =       OpCompositeExtract %float %410 0   ; RelaxedPrecision
        %412 =       OpFMul %float %408 %411            ; RelaxedPrecision
        %413 =       OpAccessChain %_ptr_Function_v3float %h3x3 %int_0
        %414 =       OpLoad %v3float %413           ; RelaxedPrecision
        %415 =       OpCompositeExtract %float %414 0   ; RelaxedPrecision
        %416 =       OpFMul %float %412 %415            ; RelaxedPrecision
        %417 =       OpAccessChain %_ptr_Function_v4float %h4x4 %int_0
        %418 =       OpLoad %v4float %417           ; RelaxedPrecision
        %419 =       OpCompositeExtract %float %418 0   ; RelaxedPrecision
        %420 =       OpFMul %float %416 %419            ; RelaxedPrecision
        ...
        %463 =     OpLabel
        %465 =       OpLoad %bool %b                ; RelaxedPrecision
                     OpSelectionMerge %467 None
                     OpBranchConditional %465 %466 %467

        %466 =         OpLabel
        %468 =           OpLoad %v2bool %b2         ; RelaxedPrecision
        ...
        %471 =         OpLabel
        %473 =           OpLoad %v3bool %b3         ; RelaxedPrecision
        ...
        %476 =         OpLabel
        %478 =           OpLoad %v4bool %b4         ; RelaxedPrecision
        ...
        %487 =       OpLoad %v4float %486           ; RelaxedPrecision
                     OpStore %482 %487
                     OpBranch %485

        %484 =     OpLabel
        %488 =       OpAccessChain %_ptr_Uniform_v4float %29 %int_1
        %489 =       OpLoad %v4float %488           ; RelaxedPrecision
                     OpStore %482 %489
                     OpBranch %485

        %485 = OpLabel
        %490 =   OpLoad %v4float %482               ; RelaxedPrecision
                 OpReturnValue %490
               OpFunctionEnd
