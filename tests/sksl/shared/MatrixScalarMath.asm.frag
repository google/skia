          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %test_bifffff22 "test_bifffff22"  ; id %2
               OpName %one "one"                        ; id %36
               OpName %m2 "m2"                          ; id %42
               OpName %divisionTest_b "divisionTest_b"  ; id %3
               OpName %ten "ten"                        ; id %119
               OpName %mat "mat"                        ; id %125
               OpName %div "div"                        ; id %128
               OpName %main "main"                      ; id %4
               OpName %f1 "f1"                          ; id %169
               OpName %f2 "f2"                          ; id %173
               OpName %f3 "f3"                          ; id %178
               OpName %f4 "f4"                          ; id %184
               OpName %_0_expected "_0_expected"        ; id %190
               OpName %_1_one "_1_one"                  ; id %198
               OpName %_2_m2 "_2_m2"                    ; id %202
...
%test_bifffff22 = OpFunction %bool None %28
        ...
        %one =   OpVariable %_ptr_Function_float Function
         ...
         %40 =   OpLoad %v4float %37                ; RelaxedPrecision
...
%divisionTest_b = OpFunction %bool None %117
        ...
        %122 =   OpCompositeExtract %float %121 0   ; RelaxedPrecision
        %124 =   OpFMul %float %122 %float_10       ; RelaxedPrecision
                 OpStore %ten %124
        ...
        %165 =   OpPhi %bool %false %118 %156 %154
               ...
               ; Function main
       %main = OpFunction %v4float None %166        ; RelaxedPrecision
...
%_0_expected =   OpVariable %_ptr_Function_mat2v2float Function
     %_1_one =   OpVariable %_ptr_Function_float Function
      %_2_m2 =   OpVariable %_ptr_Function_mat2v2float Function
        ...
        %172 =   OpCompositeExtract %float %171 1   ; RelaxedPrecision
                 OpStore %f1 %172
        ...
        %177 =   OpFMul %float %float_2 %176        ; RelaxedPrecision
                 OpStore %f2 %177
        %180 =   OpAccessChain %_ptr_Uniform_v4float %9 %int_0
        %181 =   OpLoad %v4float %180               ; RelaxedPrecision
        %182 =   OpCompositeExtract %float %181 1   ; RelaxedPrecision
        %183 =   OpFMul %float %float_3 %182        ; RelaxedPrecision
                 OpStore %f3 %183
        ...
        %189 =   OpFMul %float %float_4 %188        ; RelaxedPrecision
                 OpStore %f4 %189
        ...
        %313 =       OpLoad %v4float %312           ; RelaxedPrecision
                     OpStore %307 %313
                     OpBranch %311
        ...
        %311 = OpLabel
        %316 =   OpLoad %v4float %307               ; RelaxedPrecision
                 OpReturnValue %316
               OpFunctionEnd
