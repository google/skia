          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               ; Debug Information
               OpName %sk_FragColor "sk_FragColor"  ; id %24
               OpName %_UniformBuffer "_UniformBuffer"  ; id %29
               OpMemberName %_UniformBuffer 0 "colorGreen"
               OpMemberName %_UniformBuffer 1 "colorRed"
               OpName %_entrypoint_v "_entrypoint_v"    ; id %31
               OpName %returns_float2_f2 "returns_float2_f2"    ; id %2
               OpName %returns_float3_f3 "returns_float3_f3"    ; id %3
               OpName %returns_float4_f4 "returns_float4_f4"    ; id %4
               OpName %returns_float2x2_f22 "returns_float2x2_f22"  ; id %5
               OpName %returns_float3x3_f33 "returns_float3x3_f33"  ; id %6
               OpName %returns_float4x4_f44 "returns_float4x4_f44"  ; id %7
               OpName %returns_half_h "returns_half_h"              ; id %8
               OpName %returns_half2_h2 "returns_half2_h2"          ; id %9
               OpName %returns_half3_h3 "returns_half3_h3"          ; id %10
               OpName %returns_half4_h4 "returns_half4_h4"          ; id %11
               OpName %returns_half2x2_h22 "returns_half2x2_h22"    ; id %12
               OpName %returns_half3x3_h33 "returns_half3x3_h33"    ; id %13
               OpName %returns_half4x4_h44 "returns_half4x4_h44"    ; id %14
               OpName %returns_bool_b "returns_bool_b"              ; id %15
               OpName %returns_bool2_b2 "returns_bool2_b2"          ; id %16
               OpName %returns_bool3_b3 "returns_bool3_b3"          ; id %17
               OpName %returns_bool4_b4 "returns_bool4_b4"          ; id %18
               OpName %returns_int_i "returns_int_i"                ; id %19
               OpName %returns_int2_i2 "returns_int2_i2"            ; id %20
               OpName %returns_int3_i3 "returns_int3_i3"            ; id %21
               OpName %returns_int4_i4 "returns_int4_i4"            ; id %22
               OpName %main "main"                                  ; id %23
               OpName %x1 "x1"                                      ; id %122
               OpName %x2 "x2"                                      ; id %124
               OpName %x3 "x3"                                      ; id %125
               OpName %x4 "x4"                                      ; id %127
               ...
               OpName %x8 "x8"                                      ; id %135
               OpName %x9 "x9"                                      ; id %136
               OpName %x10 "x10"                                    ; id %137
               OpName %x11 "x11"                                    ; id %138
               OpName %x12 "x12"                                    ; id %139
               OpName %x13 "x13"                                    ; id %140
               OpName %x14 "x14"                                    ; id %141
               OpName %x15 "x15"                                    ; id %142
               OpName %x16 "x16"                                    ; id %144
               OpName %x17 "x17"                                    ; id %146
               OpName %x18 "x18"                                    ; id %148
               OpName %x19 "x19"                                    ; id %150
               OpName %x20 "x20"                                    ; id %152
               OpName %x21 "x21"                                    ; id %154
               OpName %x22 "x22"                                    ; id %156
...
%_ptr_Uniform__UniformBuffer = OpTypePointer Uniform %_UniformBuffer
         %28 = OpVariable %_ptr_Uniform__UniformBuffer Uniform  ; Binding 0, DescriptorSet 0
       %void = OpTypeVoid
...
%returns_half_h = OpFunction %float None %75        ; RelaxedPrecision
...
%returns_half2_h2 = OpFunction %v2float None %41    ; RelaxedPrecision
...
%returns_half3_h3 = OpFunction %v3float None %46    ; RelaxedPrecision
...
%returns_half4_h4 = OpFunction %v4float None %50    ; RelaxedPrecision
...
%returns_half2x2_h22 = OpFunction %mat2v2float None %55     ; RelaxedPrecision
...
%returns_half3x3_h33 = OpFunction %mat3v3float None %61     ; RelaxedPrecision
...
%returns_half4x4_h44 = OpFunction %mat4v4float None %68     ; RelaxedPrecision
...
%returns_int4_i4 = OpFunction %v4int None %115
        ...
        %116 = OpLabel
               ...
               ; Function main
       %main = OpFunction %v4float None %119        ; RelaxedPrecision
        ...
        %248 =       OpCompositeExtract %v2float %247 0     ; RelaxedPrecision
        %249 =       OpFOrdEqual %v2bool %57 %248           ; RelaxedPrecision
        %250 =       OpAll %bool %249
        %251 =       OpCompositeExtract %v2float %247 1     ; RelaxedPrecision
        %252 =       OpFOrdEqual %v2bool %58 %251           ; RelaxedPrecision
        %253 =       OpAll %bool %252
        ...
        %259 =       OpCompositeExtract %v3float %258 0     ; RelaxedPrecision
        %260 =       OpFOrdEqual %v3bool %63 %259           ; RelaxedPrecision
        %261 =       OpAll %bool %260
        %262 =       OpCompositeExtract %v3float %258 1     ; RelaxedPrecision
        %263 =       OpFOrdEqual %v3bool %64 %262           ; RelaxedPrecision
        %264 =       OpAll %bool %263
        %265 =       OpLogicalAnd %bool %261 %264
        %266 =       OpCompositeExtract %v3float %258 2     ; RelaxedPrecision
        %267 =       OpFOrdEqual %v3bool %65 %266           ; RelaxedPrecision
        %268 =       OpAll %bool %267
        ...
        %274 =       OpCompositeExtract %v4float %273 0     ; RelaxedPrecision
        %275 =       OpFOrdEqual %v4bool %70 %274           ; RelaxedPrecision
        %276 =       OpAll %bool %275
        %277 =       OpCompositeExtract %v4float %273 1     ; RelaxedPrecision
        %278 =       OpFOrdEqual %v4bool %71 %277           ; RelaxedPrecision
        %279 =       OpAll %bool %278
        %280 =       OpLogicalAnd %bool %276 %279
        %281 =       OpCompositeExtract %v4float %273 2     ; RelaxedPrecision
        %282 =       OpFOrdEqual %v4bool %72 %281           ; RelaxedPrecision
        %283 =       OpAll %bool %282
        %284 =       OpLogicalAnd %bool %280 %283
        %285 =       OpCompositeExtract %v4float %273 3     ; RelaxedPrecision
        %286 =       OpFOrdEqual %v4bool %73 %285           ; RelaxedPrecision
        %287 =       OpAll %bool %286
        ...
        %343 =       OpLoad %v4float %340           ; RelaxedPrecision
                     OpStore %336 %343
                     OpBranch %339

        %338 =     OpLabel
        %344 =       OpAccessChain %_ptr_Uniform_v4float %28 %int_1
        %345 =       OpLoad %v4float %344           ; RelaxedPrecision
                     OpStore %336 %345
                     OpBranch %339

        %339 = OpLabel
        %346 =   OpLoad %v4float %336               ; RelaxedPrecision
                 OpReturnValue %346
               OpFunctionEnd
