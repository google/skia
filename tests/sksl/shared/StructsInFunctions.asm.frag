          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpMemberName %S 0 "x"
               OpMemberName %S 1 "y"
               OpName %returns_a_struct_S "returns_a_struct_S"  ; id %2
               OpName %s "s"                                    ; id %28
               OpName %constructs_a_struct_S "constructs_a_struct_S"    ; id %3
               OpName %accepts_a_struct_fS "accepts_a_struct_fS"        ; id %4
               OpName %modifies_a_struct_vS "modifies_a_struct_vS"      ; id %5
               OpName %main "main"                                      ; id %6
               OpName %s_0 "s"                                          ; id %64
               OpName %x "x"                                            ; id %66
               OpName %expected "expected"                              ; id %72
               OpName %Nested "Nested"                                  ; id %75
               OpMemberName %Nested 0 "a"
               OpMemberName %Nested 1 "b"
               OpName %n1 "n1"                      ; id %74
               OpName %n2 "n2"                      ; id %77
               OpName %n3 "n3"                      ; id %78
               OpName %Compound "Compound"          ; id %92
               OpMemberName %Compound 0 "f4"
               OpMemberName %Compound 1 "i3"
               OpName %c1 "c1"                      ; id %90
               OpName %c2 "c2"                      ; id %102
               OpName %c3 "c3"                      ; id %109
               OpName %valid "valid"                ; id %115
...
%returns_a_struct_S = OpFunction %S None %26
         ...
         %36 =   OpAccessChain %_ptr_Function_int %s %int_1
                 OpStore %36 %int_2
         %38 =   OpLoad %S %s                       ; RelaxedPrecision
                 OpReturnValue %38
               OpFunctionEnd
   ...
   %expected =   OpVariable %_ptr_Function_S Function
      ...
      %valid =   OpVariable %_ptr_Function_bool Function
        %249 =   OpVariable %_ptr_Function_v4float Function
         ...
         %82 =   OpLoad %S %81                      ; RelaxedPrecision
         %83 =   OpAccessChain %_ptr_Function_S %n1 %int_1
                 OpStore %83 %82
         %84 =   OpLoad %Nested %n1                 ; RelaxedPrecision
                 OpStore %n2 %84
                 OpStore %n3 %84
         %85 =   OpAccessChain %_ptr_Function_S %n3 %int_1
         %86 =   OpLoad %S %85                      ; RelaxedPrecision
                 OpStore %87 %86
        ...
        %106 =   OpCompositeExtract %float %105 1   ; RelaxedPrecision
        ...
        %133 =     OpLabel
        %135 =       OpLoad %S %s_0                 ; RelaxedPrecision
        %136 =       OpLoad %S %expected            ; RelaxedPrecision
        ...
        %145 =     OpLabel
        %147 =       OpLoad %S %s_0                 ; RelaxedPrecision
        ...
        %155 =     OpLabel
        %157 =       OpLoad %S %s_0                 ; RelaxedPrecision
        ...
        %167 =     OpLabel
        %169 =       OpLoad %Nested %n1             ; RelaxedPrecision
        %170 =       OpLoad %Nested %n2             ; RelaxedPrecision
        ...
        %191 =     OpLabel
        %193 =       OpLoad %Nested %n1             ; RelaxedPrecision
        %194 =       OpLoad %Nested %n3             ; RelaxedPrecision
        ...
        %215 =     OpLabel
        %217 =       OpLoad %Nested %n3             ; RelaxedPrecision
        ...
        %253 = OpLabel
        %258 =   OpLoad %v4float %249               ; RelaxedPrecision
                 OpReturnValue %258
               OpFunctionEnd
