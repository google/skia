          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %test_matrix_op_matrix_half_b "test_matrix_op_matrix_half_b"  ; id %2
               OpName %ok "ok"                                                      ; id %24
               OpName %splat_4 "splat_4"                                            ; id %27
               OpName %m "m"                                                        ; id %33
               OpName %splat_4_0 "splat_4"                                          ; id %99
               OpName %m_0 "m"                                                      ; id %105
               OpName %m_1 "m"                                                      ; id %151
               OpName %m_2 "m"                                                      ; id %199
               OpName %m_3 "m"                                                      ; id %250
               ...
               OpName %_0_ok "_0_ok"                                                ; id %303
               OpName %_1_splat_4 "_1_splat_4"                                      ; id %304
               OpName %_2_m "_2_m"                                                  ; id %305
               OpName %_3_splat_4 "_3_splat_4"                                      ; id %351
               OpName %_4_m "_4_m"                                                  ; id %352
               OpName %_5_m "_5_m"                                                  ; id %386
               OpName %_6_m "_6_m"                                                  ; id %406
               OpName %_7_m "_7_m"                                                  ; id %426
               OpName %_8_m "_8_m"                                                  ; id %438
...
%test_matrix_op_matrix_half_b = OpFunction %bool None %22
  ...
  %splat_4_0 =   OpVariable %_ptr_Function_mat2v3float Function     ; RelaxedPrecision
        ...
        %m_4 =   OpVariable %_ptr_Function_mat2v3float Function     ; RelaxedPrecision
                 ...
                 OpStore %splat_4 %32
                 OpStore %m %37
         %38 =   OpFAdd %v2float %35 %31            ; RelaxedPrecision
         %39 =   OpFAdd %v2float %36 %31            ; RelaxedPrecision
         %40 =   OpFAdd %v2float %17 %31            ; RelaxedPrecision
         %41 =   OpCompositeConstruct %mat3v2float %38 %39 %40  ; RelaxedPrecision
                 OpStore %m %41
                 OpSelectionMerge %44 None
                 OpBranchConditional %true %43 %44

         %43 =     OpLabel
         %50 =       OpFOrdEqual %v2bool %38 %46    ; RelaxedPrecision
         %51 =       OpAll %bool %50
         %52 =       OpFOrdEqual %v2bool %39 %47    ; RelaxedPrecision
         %53 =       OpAll %bool %52
         %54 =       OpLogicalAnd %bool %51 %53
         %55 =       OpFOrdEqual %v2bool %40 %31    ; RelaxedPrecision
         %56 =       OpAll %bool %55
         ...
         %58 =   OpPhi %bool %false %23 %57 %43
                 OpStore %ok %58
                 OpStore %m %37
         %59 =   OpFSub %v2float %35 %31            ; RelaxedPrecision
         %60 =   OpFSub %v2float %36 %31            ; RelaxedPrecision
         %61 =   OpFSub %v2float %17 %31            ; RelaxedPrecision
         %62 =   OpCompositeConstruct %mat3v2float %59 %60 %61  ; RelaxedPrecision
                 OpStore %m %62
                 OpSelectionMerge %64 None
                 OpBranchConditional %58 %63 %64

         %63 =     OpLabel
         %71 =       OpFOrdEqual %v2bool %59 %67    ; RelaxedPrecision
         %72 =       OpAll %bool %71
         %73 =       OpFOrdEqual %v2bool %60 %68    ; RelaxedPrecision
         %74 =       OpAll %bool %73
         %75 =       OpLogicalAnd %bool %72 %74
         %76 =       OpFOrdEqual %v2bool %61 %69    ; RelaxedPrecision
         %77 =       OpAll %bool %76
         ...
         %79 =   OpPhi %bool %false %44 %78 %63
                 OpStore %ok %79
                 OpStore %m %37
         %80 =   OpFDiv %v2float %35 %31            ; RelaxedPrecision
         %81 =   OpFDiv %v2float %36 %31            ; RelaxedPrecision
         %82 =   OpFDiv %v2float %17 %31            ; RelaxedPrecision
         %83 =   OpCompositeConstruct %mat3v2float %80 %81 %82  ; RelaxedPrecision
                 OpStore %m %83
                 OpSelectionMerge %85 None
                 OpBranchConditional %79 %84 %85

         %84 =     OpLabel
         %90 =       OpFOrdEqual %v2bool %80 %87    ; RelaxedPrecision
         %91 =       OpAll %bool %90
         %92 =       OpFOrdEqual %v2bool %81 %88    ; RelaxedPrecision
         %93 =       OpAll %bool %92
         %94 =       OpLogicalAnd %bool %91 %93
         %95 =       OpFOrdEqual %v2bool %82 %17    ; RelaxedPrecision
         %96 =       OpAll %bool %95
         ...
         %98 =   OpPhi %bool %false %64 %97 %84
                 ...
                 OpStore %m_0 %104
        %109 =   OpFAdd %v3float %103 %106          ; RelaxedPrecision
        %110 =   OpFAdd %v3float %103 %107          ; RelaxedPrecision
        %111 =   OpCompositeConstruct %mat2v3float %109 %110    ; RelaxedPrecision
                 OpStore %m_0 %111
                 OpSelectionMerge %113 None
                 OpBranchConditional %98 %112 %113

        %112 =     OpLabel
        %118 =       OpFOrdEqual %v3bool %109 %114  ; RelaxedPrecision
        %119 =       OpAll %bool %118
        %120 =       OpFOrdEqual %v3bool %110 %115  ; RelaxedPrecision
        %121 =       OpAll %bool %120
        ...
        %123 =   OpPhi %bool %false %85 %122 %112
                 OpStore %ok %123
                 OpStore %m_0 %104
        %124 =   OpFSub %v3float %103 %106          ; RelaxedPrecision
        %125 =   OpFSub %v3float %103 %107          ; RelaxedPrecision
        %126 =   OpCompositeConstruct %mat2v3float %124 %125    ; RelaxedPrecision
                 OpStore %m_0 %126
                 OpSelectionMerge %128 None
                 OpBranchConditional %123 %127 %128

        %127 =     OpLabel
        %132 =       OpFOrdEqual %v3bool %124 %129  ; RelaxedPrecision
        %133 =       OpAll %bool %132
        %134 =       OpFOrdEqual %v3bool %125 %130  ; RelaxedPrecision
        %135 =       OpAll %bool %134
        ...
        %137 =   OpPhi %bool %false %113 %136 %127
                 OpStore %ok %137
                 OpStore %m_0 %104
        %140 =   OpFDiv %v3float %103 %138          ; RelaxedPrecision
        %141 =   OpFDiv %v3float %103 %138          ; RelaxedPrecision
        %142 =   OpCompositeConstruct %mat2v3float %140 %141    ; RelaxedPrecision
                 OpStore %m_0 %142
                 OpSelectionMerge %144 None
                 OpBranchConditional %137 %143 %144

        %143 =     OpLabel
        %145 =       OpFOrdEqual %v3bool %140 %138  ; RelaxedPrecision
        %146 =       OpAll %bool %145
        %147 =       OpFOrdEqual %v3bool %141 %138  ; RelaxedPrecision
        %148 =       OpAll %bool %147
        ...
        %150 =   OpPhi %bool %false %128 %149 %143
                 OpStore %ok %150
                 OpStore %m_1 %167
        %177 =   OpFAdd %v3float %163 %172          ; RelaxedPrecision
        %178 =   OpFAdd %v3float %164 %173          ; RelaxedPrecision
        %179 =   OpFAdd %v3float %165 %174          ; RelaxedPrecision
        %180 =   OpFAdd %v3float %166 %175          ; RelaxedPrecision
        %181 =   OpCompositeConstruct %mat4v3float %177 %178 %179 %180  ; RelaxedPrecision
                 OpStore %m_1 %181
                 OpSelectionMerge %183 None
                 OpBranchConditional %150 %182 %183

        %182 =     OpLabel
        %187 =       OpFOrdEqual %v3bool %177 %185  ; RelaxedPrecision
        %188 =       OpAll %bool %187
        %189 =       OpFOrdEqual %v3bool %178 %185  ; RelaxedPrecision
        %190 =       OpAll %bool %189
        %191 =       OpLogicalAnd %bool %188 %190
        %192 =       OpFOrdEqual %v3bool %179 %185  ; RelaxedPrecision
        %193 =       OpAll %bool %192
        %194 =       OpLogicalAnd %bool %191 %193
        %195 =       OpFOrdEqual %v3bool %180 %185  ; RelaxedPrecision
        %196 =       OpAll %bool %195
        ...
        %198 =   OpPhi %bool %false %144 %197 %182
                 OpStore %ok %198
                 OpStore %m_2 %213
        %219 =   OpFSub %v2float %209 %214          ; RelaxedPrecision
        %220 =   OpFSub %v2float %210 %215          ; RelaxedPrecision
        %221 =   OpFSub %v2float %211 %216          ; RelaxedPrecision
        %222 =   OpFSub %v2float %212 %217          ; RelaxedPrecision
        %223 =   OpCompositeConstruct %mat4v2float %219 %220 %221 %222  ; RelaxedPrecision
                 OpStore %m_2 %223
                 OpSelectionMerge %225 None
                 OpBranchConditional %198 %224 %225

        %224 =     OpLabel
        %238 =       OpFOrdEqual %v2bool %219 %233  ; RelaxedPrecision
        %239 =       OpAll %bool %238
        %240 =       OpFOrdEqual %v2bool %220 %234  ; RelaxedPrecision
        %241 =       OpAll %bool %240
        %242 =       OpLogicalAnd %bool %239 %241
        %243 =       OpFOrdEqual %v2bool %221 %235  ; RelaxedPrecision
        %244 =       OpAll %bool %243
        %245 =       OpLogicalAnd %bool %242 %244
        %246 =       OpFOrdEqual %v2bool %222 %236  ; RelaxedPrecision
        %247 =       OpAll %bool %246
        ...
        %249 =   OpPhi %bool %false %183 %248 %224
                 OpStore %ok %249
                 OpStore %m_3 %254
        %258 =   OpFDiv %v4float %253 %255          ; RelaxedPrecision
        %259 =   OpFDiv %v4float %253 %256          ; RelaxedPrecision
        %260 =   OpCompositeConstruct %mat2v4float %258 %259    ; RelaxedPrecision
                 OpStore %m_3 %260
                 OpSelectionMerge %262 None
                 OpBranchConditional %249 %261 %262

        %261 =     OpLabel
        %267 =       OpFOrdEqual %v4bool %258 %263  ; RelaxedPrecision
        %268 =       OpAll %bool %267
        %269 =       OpFOrdEqual %v4bool %259 %264  ; RelaxedPrecision
        %270 =       OpAll %bool %269
        ...
        %272 =   OpPhi %bool %false %225 %271 %261
                 OpStore %ok %272
                 OpStore %m_4 %276
        %281 =   OpMatrixTimesMatrix %mat2v3float %276 %280     ; RelaxedPrecision
                 OpStore %m_4 %281
                 OpSelectionMerge %283 None
                 OpBranchConditional %272 %282 %283

        %282 =     OpLabel
        %292 =       OpCompositeExtract %v3float %281 0     ; RelaxedPrecision
        %293 =       OpFOrdEqual %v3bool %292 %289          ; RelaxedPrecision
        %294 =       OpAll %bool %293
        %295 =       OpCompositeExtract %v3float %281 1     ; RelaxedPrecision
        %296 =       OpFOrdEqual %v3bool %295 %290          ; RelaxedPrecision
        %297 =       OpAll %bool %296
        ...
        %299 =   OpPhi %bool %false %262 %298 %282
               ...
               ; Function main
       %main = OpFunction %v4float None %300        ; RelaxedPrecision
 ...
 %_3_splat_4 =   OpVariable %_ptr_Function_mat2v3float Function
       ...
       %_8_m =   OpVariable %_ptr_Function_mat2v3float Function
        ...
        %463 =       OpLoad %v4float %459           ; RelaxedPrecision
                     OpStore %454 %463
                     OpBranch %458

        %457 =     OpLabel
        %464 =       OpAccessChain %_ptr_Uniform_v4float %8 %int_0
        %466 =       OpLoad %v4float %464           ; RelaxedPrecision
                     OpStore %454 %466
                     OpBranch %458

        %458 = OpLabel
        %467 =   OpLoad %v4float %454               ; RelaxedPrecision
                 OpReturnValue %467
               OpFunctionEnd
