          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %test_half_b "test_half_b"        ; id %2
               OpName %ok "ok"                          ; id %25
               OpName %m1 "m1"                          ; id %28
               OpName %m3 "m3"                          ; id %48
               OpName %m4 "m4"                          ; id %57
               ...
               OpName %m7 "m7"                          ; id %123
               OpName %m9 "m9"                          ; id %136
               OpName %m10 "m10"                        ; id %157
               OpName %m11 "m11"                        ; id %181
               OpName %test_comma_b "test_comma_b"      ; id %3
               OpName %x "x"                            ; id %210
               OpName %y "y"                            ; id %211
               OpName %main "main"                      ; id %4
               OpName %_0_ok "_0_ok"                    ; id %220
               OpName %_1_m1 "_1_m1"                    ; id %221
               OpName %_2_m3 "_2_m3"                    ; id %230
               OpName %_3_m4 "_3_m4"                    ; id %239
               OpName %_4_m5 "_4_m5"                    ; id %251
               OpName %_7_m10 "_7_m10"                  ; id %277
               OpName %_8_m11 "_8_m11"                  ; id %278
...
%test_half_b = OpFunction %bool None %23
        ...
        %m11 =   OpVariable %_ptr_Function_mat4v4float Function     ; RelaxedPrecision
         ...
         %39 =     OpLabel
         %42 =       OpFOrdEqual %v2bool %35 %35    ; RelaxedPrecision
         %43 =       OpAll %bool %42
         %44 =       OpFOrdEqual %v2bool %36 %36    ; RelaxedPrecision
         %45 =       OpAll %bool %44
         ...
         %49 =     OpLabel
         %51 =       OpFOrdEqual %v2bool %35 %35    ; RelaxedPrecision
         %52 =       OpAll %bool %51
         %53 =       OpFOrdEqual %v2bool %36 %36    ; RelaxedPrecision
         %54 =       OpAll %bool %53
         ...
         %62 =     OpLabel
         %64 =       OpFOrdEqual %v2bool %59 %59    ; RelaxedPrecision
         %65 =       OpAll %bool %64
         %66 =       OpFOrdEqual %v2bool %60 %60    ; RelaxedPrecision
         %67 =       OpAll %bool %66
         ...
         %69 =   OpPhi %bool %false %50 %68 %62
                 OpStore %ok %69
         %70 =   OpMatrixTimesMatrix %mat2v2float %37 %61   ; RelaxedPrecision
                 OpStore %m3 %70
                 OpSelectionMerge %72 None
                 OpBranchConditional %69 %71 %72

         %71 =     OpLabel
         %79 =       OpCompositeExtract %v2float %70 0  ; RelaxedPrecision
         %80 =       OpFOrdEqual %v2bool %79 %76        ; RelaxedPrecision
         %81 =       OpAll %bool %80
         %82 =       OpCompositeExtract %v2float %70 1  ; RelaxedPrecision
         %83 =       OpFOrdEqual %v2bool %82 %77        ; RelaxedPrecision
         %84 =       OpAll %bool %83
         ...
         %91 =   OpLoad %v2float %90                ; RelaxedPrecision
         %92 =   OpCompositeExtract %float %91 1    ; RelaxedPrecision
         %93 =   OpCompositeConstruct %v2float %92 %float_0     ; RelaxedPrecision
         %94 =   OpCompositeConstruct %v2float %float_0 %92     ; RelaxedPrecision
         %95 =   OpCompositeConstruct %mat2v2float %93 %94      ; RelaxedPrecision
                 OpStore %m5 %95
                 OpSelectionMerge %97 None
                 OpBranchConditional %86 %96 %97

         %96 =     OpLabel
        %101 =       OpFOrdEqual %v2bool %93 %98    ; RelaxedPrecision
        %102 =       OpAll %bool %101
        %103 =       OpFOrdEqual %v2bool %94 %99    ; RelaxedPrecision
        %104 =       OpAll %bool %103
        ...
        %106 =   OpPhi %bool %false %72 %105 %96
                 OpStore %ok %106
        %107 =   OpFAdd %v2float %35 %93            ; RelaxedPrecision
        %108 =   OpFAdd %v2float %36 %94            ; RelaxedPrecision
        %109 =   OpCompositeConstruct %mat2v2float %107 %108    ; RelaxedPrecision
                 OpStore %m1 %109
                 OpSelectionMerge %111 None
                 OpBranchConditional %106 %110 %111

        %110 =     OpLabel
        %117 =       OpFOrdEqual %v2bool %107 %114  ; RelaxedPrecision
        %118 =       OpAll %bool %117
        %119 =       OpFOrdEqual %v2bool %108 %115  ; RelaxedPrecision
        %120 =       OpAll %bool %119
        ...
        %128 =     OpLabel
        %130 =       OpFOrdEqual %v2bool %125 %125  ; RelaxedPrecision
        %131 =       OpAll %bool %130
        %132 =       OpFOrdEqual %v2bool %126 %126  ; RelaxedPrecision
        %133 =       OpAll %bool %132
        ...
        %145 =     OpLabel
        %148 =       OpFOrdEqual %v3bool %141 %141  ; RelaxedPrecision
        %149 =       OpAll %bool %148
        %150 =       OpFOrdEqual %v3bool %142 %142  ; RelaxedPrecision
        %151 =       OpAll %bool %150
        %152 =       OpLogicalAnd %bool %149 %151
        %153 =       OpFOrdEqual %v3bool %143 %143  ; RelaxedPrecision
        %154 =       OpAll %bool %153
        ...
        %166 =     OpLabel
        %169 =       OpFOrdEqual %v4bool %161 %161  ; RelaxedPrecision
        %170 =       OpAll %bool %169
        %171 =       OpFOrdEqual %v4bool %162 %162  ; RelaxedPrecision
        %172 =       OpAll %bool %171
        %173 =       OpLogicalAnd %bool %170 %172
        %174 =       OpFOrdEqual %v4bool %163 %163  ; RelaxedPrecision
        %175 =       OpAll %bool %174
        %176 =       OpLogicalAnd %bool %173 %175
        %177 =       OpFOrdEqual %v4bool %164 %164  ; RelaxedPrecision
        %178 =       OpAll %bool %177
        ...
        %180 =   OpPhi %bool %false %146 %179 %166
                 OpStore %ok %180
                 OpStore %m11 %184
        %185 =   OpFSub %v4float %183 %161          ; RelaxedPrecision
        %186 =   OpFSub %v4float %183 %162          ; RelaxedPrecision
        %187 =   OpFSub %v4float %183 %163          ; RelaxedPrecision
        %188 =   OpFSub %v4float %183 %164          ; RelaxedPrecision
        ...
        %190 =     OpLabel
        %197 =       OpFOrdEqual %v4bool %185 %192  ; RelaxedPrecision
        %198 =       OpAll %bool %197
        %199 =       OpFOrdEqual %v4bool %186 %193  ; RelaxedPrecision
        %200 =       OpAll %bool %199
        %201 =       OpLogicalAnd %bool %198 %200
        %202 =       OpFOrdEqual %v4bool %187 %194  ; RelaxedPrecision
        %203 =       OpAll %bool %202
        %204 =       OpLogicalAnd %bool %201 %203
        %205 =       OpFOrdEqual %v4bool %188 %195  ; RelaxedPrecision
        %206 =       OpAll %bool %205
...
%test_comma_b = OpFunction %bool None %23
        ...
        %216 =   OpLogicalAnd %bool %213 %215
               ...
               ; Function main
       %main = OpFunction %v4float None %217        ; RelaxedPrecision
     ...
     %_8_m11 =   OpVariable %_ptr_Function_mat4v4float Function
        ...
        %314 =       OpLoad %v4float %311           ; RelaxedPrecision
                     OpStore %306 %314
                     OpBranch %310
        ...
        %310 = OpLabel
        %317 =   OpLoad %v4float %306               ; RelaxedPrecision
                 OpReturnValue %317
               OpFunctionEnd
