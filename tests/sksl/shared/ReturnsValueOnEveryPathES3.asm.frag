...
OpDecorate %conditional_inside_while_loop RelaxedPrecision
OpDecorate %128 RelaxedPrecision
OpDecorate %130 RelaxedPrecision
OpDecorate %inside_do_loop RelaxedPrecision
OpDecorate %inside_while_loop RelaxedPrecision
OpDecorate %after_do_loop RelaxedPrecision
OpDecorate %after_while_loop RelaxedPrecision
OpDecorate %switch_with_all_returns RelaxedPrecision
OpDecorate %157 RelaxedPrecision
OpDecorate %switch_only_default RelaxedPrecision
OpDecorate %165 RelaxedPrecision
OpDecorate %switch_fallthrough RelaxedPrecision
OpDecorate %171 RelaxedPrecision
OpDecorate %switch_fallthrough_twice RelaxedPrecision
OpDecorate %179 RelaxedPrecision
OpDecorate %switch_with_break_in_loop RelaxedPrecision
OpDecorate %187 RelaxedPrecision
OpDecorate %199 RelaxedPrecision
OpDecorate %switch_with_continue_in_loop RelaxedPrecision
OpDecorate %204 RelaxedPrecision
OpDecorate %216 RelaxedPrecision
OpDecorate %switch_with_if_that_returns RelaxedPrecision
OpDecorate %221 RelaxedPrecision
OpDecorate %227 RelaxedPrecision
OpDecorate %228 RelaxedPrecision
OpDecorate %switch_with_one_sided_if_then_fallthrough RelaxedPrecision
