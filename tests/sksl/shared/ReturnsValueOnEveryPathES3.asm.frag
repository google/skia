          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %inside_while_loop_b "inside_while_loop_b"    ; id %2
               OpName %inside_infinite_do_loop_b "inside_infinite_do_loop_b"    ; id %3
               OpName %inside_infinite_while_loop_b "inside_infinite_while_loop_b"  ; id %4
               OpName %after_do_loop_b "after_do_loop_b"                            ; id %5
               OpName %after_while_loop_b "after_while_loop_b"                      ; id %6
               OpName %switch_with_all_returns_b "switch_with_all_returns_b"        ; id %7
               OpName %switch_fallthrough_b "switch_fallthrough_b"                  ; id %8
               OpName %switch_fallthrough_twice_b "switch_fallthrough_twice_b"      ; id %9
               OpName %switch_with_break_in_loop_b "switch_with_break_in_loop_b"    ; id %10
               OpName %x "x"                                                        ; id %104
               OpName %switch_with_continue_in_loop_b "switch_with_continue_in_loop_b"  ; id %11
               OpName %x_0 "x"                                                          ; id %125
               OpName %switch_with_if_that_returns_b "switch_with_if_that_returns_b"    ; id %12
               OpName %switch_with_one_sided_if_then_fallthrough_b "switch_with_one_sided_if_then_fallthrough_b"    ; id %13
...
%inside_while_loop_b = OpFunction %bool None %33
         ...
         %44 =       OpLoad %float %40              ; RelaxedPrecision
...
%switch_with_all_returns_b = OpFunction %bool None %33
         ...
         %75 =   OpLoad %float %74                  ; RelaxedPrecision
...
%switch_fallthrough_b = OpFunction %bool None %33
         ...
         %83 =   OpLoad %float %82                  ; RelaxedPrecision
...
%switch_fallthrough_twice_b = OpFunction %bool None %33
         ...
         %91 =   OpLoad %float %90                  ; RelaxedPrecision
...
%switch_with_break_in_loop_b = OpFunction %bool None %33
         ...
         %99 =   OpLoad %float %98                  ; RelaxedPrecision
...
%switch_with_continue_in_loop_b = OpFunction %bool None %33
        ...
        %120 =   OpLoad %float %119                 ; RelaxedPrecision
...
%switch_with_if_that_returns_b = OpFunction %bool None %33
        ...
        %137 =   OpLoad %float %136                 ; RelaxedPrecision
        ...
        %143 =       OpLoad %float %142             ; RelaxedPrecision
...
%switch_with_one_sided_if_then_fallthrough_b = OpFunction %bool None %33
        ...
        %156 =       OpLoad %float %155             ; RelaxedPrecision
        ...
        %152 = OpLabel
               ...
               ; Function main
       %main = OpFunction %v4float None %160        ; RelaxedPrecision
        ...
        %212 = OpLabel
        %218 =   OpLoad %v4float %208               ; RelaxedPrecision
                 OpReturnValue %218
               OpFunctionEnd
