...
vec4 main() {
    ...
    _0_ok = _0_ok && _2_m1 == mat2(1.0, 2.0, 3.0, 4.0);
    mat2 _3_m2 = mat2(vec4(5.0));
    _0_ok = _0_ok && _3_m2 == mat2(5.0, 5.0, 5.0, 5.0);
    mat2 _4_m3 = _2_m1;
    _0_ok = _0_ok && _4_m3 == mat2(1.0, 2.0, 3.0, 4.0);
    _4_m3 *= _1_m4;
    _0_ok = _0_ok && _4_m3 == mat2(6.0, 12.0, 18.0, 24.0);
