...
fragment Outputs fragmentMain(Inputs _in [[stage_in]], constant Uniforms& _uniforms [[buffer(0)]], bool _frontFacing [[front_facing]], float4 _fragCoord [[position]]) {
    ...
    Outputs _out;
    (void)_out;
    _out.sk_FragColor = (((test_flat_b() && test_if_b(_uniforms, _globals)) && test_else_b(_uniforms)) && test_loop_return_b()) && test_loop_break_b(_globals) ? _uniforms.colorGreen : _uniforms.colorRed;
    return _out;
}
