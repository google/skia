          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %test_int_b "test_int_b"          ; id %2
               OpName %ok "ok"                          ; id %24
               OpName %inputRed "inputRed"              ; id %27
               OpName %inputGreen "inputGreen"          ; id %44
               OpName %x "x"                            ; id %57
               OpName %main "main"                      ; id %3
               OpName %_0_ok "_0_ok"                    ; id %207
               OpName %_1_inputRed "_1_inputRed"        ; id %208
               OpName %_2_inputGreen "_2_inputGreen"    ; id %212
               OpName %_3_x "_3_x"                      ; id %215
...
%_entrypoint_v = OpFunction %void None %13
 ...
 %inputGreen =   OpVariable %_ptr_Function_v4int Function
         ...
         %50 =   OpCompositeExtract %float %47 1    ; RelaxedPrecision
         %51 =   OpConvertFToS %int %50
         %52 =   OpCompositeExtract %float %47 2    ; RelaxedPrecision
         %53 =   OpConvertFToS %int %52
         %54 =   OpCompositeExtract %float %47 3    ; RelaxedPrecision
        ...
        %203 =   OpPhi %bool %false %191 %202 %199
               ...
               ; Function main
       %main = OpFunction %v4float None %204        ; RelaxedPrecision
...
%_2_inputGreen =   OpVariable %_ptr_Function_v4float Function   ; RelaxedPrecision
       %_3_x =   OpVariable %_ptr_Function_v4float Function     ; RelaxedPrecision
        ...
        %218 =   OpFAdd %v4float %211 %217          ; RelaxedPrecision
                 OpStore %_3_x %218
        ...
        %225 =   OpPhi %bool %false %206 %224 %219
                 OpStore %_0_ok %225
        %226 =   OpVectorShuffle %v4float %214 %214 1 3 0 2     ; RelaxedPrecision
        %227 =   OpFSub %v4float %226 %217                      ; RelaxedPrecision
                 OpStore %_3_x %227
        ...
        %235 =   OpPhi %bool %false %220 %234 %228
                 OpStore %_0_ok %235
        %236 =   OpCompositeExtract %float %214 1   ; RelaxedPrecision
        %237 =   OpCompositeConstruct %v4float %236 %236 %236 %236  ; RelaxedPrecision
        %238 =   OpFAdd %v4float %211 %237                          ; RelaxedPrecision
                 OpStore %_3_x %238
        ...
        %245 =   OpPhi %bool %false %229 %244 %239
                 OpStore %_0_ok %245
        %246 =   OpVectorShuffle %v3float %214 %214 3 1 3   ; RelaxedPrecision
        %249 =   OpVectorTimesScalar %v3float %246 %float_9     ; RelaxedPrecision
        %250 =   OpLoad %v4float %_3_x                          ; RelaxedPrecision
        %251 =   OpVectorShuffle %v4float %250 %249 4 5 6 3     ; RelaxedPrecision
                 OpStore %_3_x %251
        ...
        %257 =   OpPhi %bool %false %240 %256 %252
                 OpStore %_0_ok %257
        %258 =   OpVectorShuffle %v2float %251 %251 2 3     ; RelaxedPrecision
        %259 =   OpVectorTimesScalar %v2float %258 %float_2     ; RelaxedPrecision
        %260 =   OpLoad %v4float %_3_x                          ; RelaxedPrecision
        %261 =   OpVectorShuffle %v4float %260 %259 4 5 2 3     ; RelaxedPrecision
                 OpStore %_3_x %261
        ...
        %269 =   OpPhi %bool %false %253 %268 %262
                 OpStore %_0_ok %269
        %271 =   OpVectorTimesScalar %v4float %211 %float_5     ; RelaxedPrecision
        %272 =   OpVectorShuffle %v4float %271 %271 1 0 3 2     ; RelaxedPrecision
                 OpStore %_3_x %272
        ...
        %278 =   OpPhi %bool %false %263 %277 %273
                 OpStore %_0_ok %278
        %279 =   OpFAdd %v4float %217 %211          ; RelaxedPrecision
                 OpStore %_3_x %279
        ...
        %284 =   OpPhi %bool %false %274 %283 %280
                 OpStore %_0_ok %284
        %286 =   OpVectorShuffle %v4float %214 %214 1 3 0 2     ; RelaxedPrecision
        %288 =   OpFSub %v4float %287 %286                      ; RelaxedPrecision
                 OpStore %_3_x %288
        ...
        %294 =   OpPhi %bool %false %281 %293 %289
                 OpStore %_0_ok %294
        %295 =   OpCompositeExtract %float %211 0   ; RelaxedPrecision
        %296 =   OpCompositeConstruct %v4float %295 %295 %295 %295  ; RelaxedPrecision
        %297 =   OpFAdd %v4float %296 %214                          ; RelaxedPrecision
                 OpStore %_3_x %297
        ...
        %303 =   OpPhi %bool %false %290 %302 %298
                 OpStore %_0_ok %303
        %305 =   OpVectorShuffle %v3float %214 %214 3 1 3   ; RelaxedPrecision
        %306 =   OpVectorTimesScalar %v3float %305 %float_8     ; RelaxedPrecision
        %307 =   OpLoad %v4float %_3_x                          ; RelaxedPrecision
        %308 =   OpVectorShuffle %v4float %307 %306 4 5 6 3     ; RelaxedPrecision
                 OpStore %_3_x %308
        ...
        %314 =   OpPhi %bool %false %299 %313 %309
                 OpStore %_0_ok %314
        %316 =   OpVectorShuffle %v2float %308 %308 2 3     ; RelaxedPrecision
        %318 =   OpFDiv %v2float %317 %316                  ; RelaxedPrecision
        %319 =   OpLoad %v4float %_3_x                      ; RelaxedPrecision
        %320 =   OpVectorShuffle %v4float %319 %318 4 5 2 3     ; RelaxedPrecision
                 OpStore %_3_x %320
        ...
        %327 =   OpPhi %bool %false %310 %326 %321
                 OpStore %_0_ok %327
        %329 =   OpFDiv %v4float %328 %320          ; RelaxedPrecision
        %330 =   OpVectorShuffle %v4float %329 %329 1 0 3 2     ; RelaxedPrecision
                 OpStore %_3_x %330
        ...
        %336 =   OpPhi %bool %false %322 %335 %331
                 OpStore %_0_ok %336
        %337 =   OpFAdd %v4float %330 %217          ; RelaxedPrecision
                 OpStore %_3_x %337
        %338 =   OpVectorTimesScalar %v4float %337 %float_2     ; RelaxedPrecision
                 OpStore %_3_x %338
        %340 =   OpFSub %v4float %338 %339          ; RelaxedPrecision
                 OpStore %_3_x %340
        %342 =   OpVectorTimesScalar %v4float %340 %float_0_5   ; RelaxedPrecision
                 OpStore %_3_x %342
        ...
        %347 =   OpPhi %bool %false %332 %346 %343
                 OpStore %_0_ok %347
        %348 =   OpFAdd %v4float %342 %217          ; RelaxedPrecision
                 OpStore %_3_x %348
        %349 =   OpVectorTimesScalar %v4float %348 %float_2     ; RelaxedPrecision
                 OpStore %_3_x %349
        %350 =   OpFSub %v4float %349 %339          ; RelaxedPrecision
                 OpStore %_3_x %350
        %351 =   OpVectorTimesScalar %v4float %350 %float_0_5   ; RelaxedPrecision
                 OpStore %_3_x %351
        ...
        %364 = OpLabel
        %369 =   OpLoad %v4float %361               ; RelaxedPrecision
                 OpReturnValue %369
               OpFunctionEnd
