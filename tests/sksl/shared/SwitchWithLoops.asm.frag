          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %switch_with_continue_in_loop_bi "switch_with_continue_in_loop_bi"    ; id %2
               OpName %val "val"                                                            ; id %28
               OpName %i "i"                                                                ; id %34
               OpName %loop_with_break_in_switch_bi "loop_with_break_in_switch_bi"          ; id %3
               OpName %val_0 "val"                                                          ; id %55
               OpName %i_0 "i"                                                              ; id %56
               OpName %main "main"                                                          ; id %4
               OpName %x "x"                                                                ; id %81
               OpName %_0_val "_0_val"                                                      ; id %87
               OpName %_1_i "_1_i"                                                          ; id %91
...
%loop_with_break_in_switch_bi = OpFunction %bool None %25
      ...
      %val_0 =   OpVariable %_ptr_Function_int Function
        %i_0 =   OpVariable %_ptr_Function_int Function
         ...
         %77 =   OpIEqual %bool %75 %int_20
               ...
               ; Function main
       %main = OpFunction %v4float None %78         ; RelaxedPrecision
     ...
     %_0_val =   OpVariable %_ptr_Function_int Function
       %_1_i =   OpVariable %_ptr_Function_int Function
        ...
        %124 = OpLabel
        %129 =   OpLoad %v4float %120               ; RelaxedPrecision
                 OpReturnValue %129
               OpFunctionEnd
