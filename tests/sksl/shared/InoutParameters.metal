...
void inoutParameterRead_vh4(thread half4& x);
void _skOutParamHelper6_inoutParameterRead_vh4(thread half4& c) {
    half4 _var0 = c;
    inoutParameterRead_vh4(_var0);
    c = _var0;
}
void inoutParameterIgnore_vh4(thread half4& x);
void _skOutParamHelper7_inoutParameterIgnore_vh4(thread half4& c) {
    half4 _var0 = c;
    inoutParameterIgnore_vh4(_var0);
    c = _var0;
}
void outParameterWrite_vh4(Uniforms _uniforms, thread half4& x) {
...
fragment Outputs fragmentMain(Inputs _in [[stage_in]], constant Uniforms& _uniforms [[buffer(0)]], bool _frontFacing [[front_facing]], float4 _fragCoord [[position]]) {
    ...
    _skOutParamHelper6_inoutParameterRead_vh4(c);
    _skOutParamHelper7_inoutParameterIgnore_vh4(c);
    _out.sk_FragColor = c;
    return _out;
}
