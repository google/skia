...
fn _skslMain(_skParam0: vec2<f32>) -> vec4<f32> {
  {
    ...
    scalar = vec4<f32>(scalar.x, (scalar.yzw * mat3x3<f32>(0.5, 0.0, 0.0, 0.0, 0.5, 0.0, 0.0, 0.0, 0.5)));
    ...
    R_array[0] = vec4<f32>(R_array[0].x, (R_array[0].yzw * mat3x3<f32>(0.5, 0.0, 0.0, 0.0, 0.5, 0.0, 0.0, 0.0, 0.5)));
