...
bool test_half_b() {
    ...
    float4x2 m42 = float4x2(float2(1.0, 0.0), float2(0.0, 1.0), float2(0.0, 0.0), float2(0.0, 0.0)) * 6.0;
...
fragment Outputs fragmentMain(Inputs _in [[stage_in]], constant Uniforms& _uniforms [[buffer(0)]], bool _frontFacing [[front_facing]], float4 _fragCoord [[position]]) {
    ...
    float4x2 _5_m42 = float4x2(float2(1.0, 0.0), float2(0.0, 1.0), float2(0.0, 0.0), float2(0.0, 0.0)) * 6.0;
