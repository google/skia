...
%50 = OpLoad %v2float %_1_coords
OpStore %_2_inCoord %50
%51 = OpLoad %v2float %_2_inCoord
%53 = OpAccessChain %_ptr_Uniform_v4float %4 %int_6
%55 = OpLoad %v4float %53
%56 = OpVectorShuffle %v2float %55 %55 0 1
%57 = OpFMul %v2float %51 %56
OpStore %_2_inCoord %57
%58 = OpLoad %v2float %_2_inCoord
%59 = OpCompositeExtract %float %58 0
%60 = OpAccessChain %_ptr_Function_float %_3_subsetCoord %int_0
OpStore %60 %59
%62 = OpLoad %v2float %_2_inCoord
%63 = OpCompositeExtract %float %62 1
%64 = OpAccessChain %_ptr_Function_float %_3_subsetCoord %int_1
OpStore %64 %63
