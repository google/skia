          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %hugeH "hugeH"                    ; id %23
               OpName %hugeF "hugeF"                    ; id %38
               OpName %hugeI "hugeI"                    ; id %50
               OpName %hugeU "hugeU"                    ; id %75
               OpName %hugeS "hugeS"                    ; id %99
               OpName %hugeUS "hugeUS"                  ; id %118
               OpName %hugeNI "hugeNI"                  ; id %136
               OpName %hugeNS "hugeNS"                  ; id %157
               OpName %hugeIvec "hugeIvec"              ; id %175
               OpName %hugeUvec "hugeUvec"              ; id %195
               OpName %hugeMxM "hugeMxM"                ; id %214
               OpName %hugeMxV "hugeMxV"                ; id %221
               OpName %hugeVxM "hugeVxM"                ; id %224
...
%_entrypoint_v = OpFunction %void None %12
   ...
   %hugeUvec =   OpVariable %_ptr_Function_v4uint Function
    ...
    %hugeVxM =   OpVariable %_ptr_Function_v4float Function
         %27 =   OpFMul %float %float_9_99999962e_35 %float_1e_09   ; RelaxedPrecision
         %28 =   OpFMul %float %27 %float_1e_09                     ; RelaxedPrecision
         %29 =   OpFMul %float %28 %float_1e_09                     ; RelaxedPrecision
         %30 =   OpFMul %float %29 %float_1e_09                     ; RelaxedPrecision
         %31 =   OpFMul %float %30 %float_1e_09                     ; RelaxedPrecision
         %32 =   OpFMul %float %31 %float_1e_09                     ; RelaxedPrecision
         %33 =   OpFMul %float %32 %float_1e_09                     ; RelaxedPrecision
         %34 =   OpFMul %float %33 %float_1e_09                     ; RelaxedPrecision
         %35 =   OpFMul %float %34 %float_1e_09                     ; RelaxedPrecision
         %36 =   OpFMul %float %35 %float_1e_09                     ; RelaxedPrecision
         %37 =   OpFMul %float %36 %float_1e_09                     ; RelaxedPrecision
                 OpStore %hugeH %37
         ...
         %98 =   OpIMul %uint %97 %uint_2
                 OpStore %hugeU %98
        %101 =   OpIMul %int %int_16384 %int_2      ; RelaxedPrecision
        %102 =   OpIMul %int %101 %int_2            ; RelaxedPrecision
        %103 =   OpIMul %int %102 %int_2            ; RelaxedPrecision
        %104 =   OpIMul %int %103 %int_2            ; RelaxedPrecision
        %105 =   OpIMul %int %104 %int_2            ; RelaxedPrecision
        %106 =   OpIMul %int %105 %int_2            ; RelaxedPrecision
        %107 =   OpIMul %int %106 %int_2            ; RelaxedPrecision
        %108 =   OpIMul %int %107 %int_2            ; RelaxedPrecision
        ...
        %117 =   OpIMul %int %116 %int_2            ; RelaxedPrecision
                 OpStore %hugeS %117
        %120 =   OpIMul %uint %uint_32768 %uint_2   ; RelaxedPrecision
        %121 =   OpIMul %uint %120 %uint_2          ; RelaxedPrecision
        %122 =   OpIMul %uint %121 %uint_2          ; RelaxedPrecision
        %123 =   OpIMul %uint %122 %uint_2          ; RelaxedPrecision
        %124 =   OpIMul %uint %123 %uint_2          ; RelaxedPrecision
        %125 =   OpIMul %uint %124 %uint_2          ; RelaxedPrecision
        %126 =   OpIMul %uint %125 %uint_2          ; RelaxedPrecision
        %127 =   OpIMul %uint %126 %uint_2          ; RelaxedPrecision
        ...
        %156 =   OpIMul %int %155 %int_2
                 OpStore %hugeNI %156
        %159 =   OpIMul %int %int_n32768 %int_2     ; RelaxedPrecision
        %160 =   OpIMul %int %159 %int_2            ; RelaxedPrecision
        %161 =   OpIMul %int %160 %int_2            ; RelaxedPrecision
        %162 =   OpIMul %int %161 %int_2            ; RelaxedPrecision
        %163 =   OpIMul %int %162 %int_2            ; RelaxedPrecision
        %164 =   OpIMul %int %163 %int_2            ; RelaxedPrecision
        %165 =   OpIMul %int %164 %int_2            ; RelaxedPrecision
        %166 =   OpIMul %int %165 %int_2            ; RelaxedPrecision
        ...
        %229 =   OpLoad %v4float %226               ; RelaxedPrecision
        %230 =   OpExtInst %float %1 FClamp %37 %float_0 %float_1   ; RelaxedPrecision
        %232 =   OpVectorTimesScalar %v4float %229 %230             ; RelaxedPrecision
        %233 =   OpExtInst %float %1 FClamp %49 %float_0 %float_1   ; RelaxedPrecision
        %234 =   OpVectorTimesScalar %v4float %232 %233             ; RelaxedPrecision
        %236 =   OpConvertSToF %float %74                           ; RelaxedPrecision
        %235 =   OpExtInst %float %1 FClamp %236 %float_0 %float_1  ; RelaxedPrecision
        %237 =   OpVectorTimesScalar %v4float %234 %235             ; RelaxedPrecision
        %239 =   OpConvertUToF %float %98                           ; RelaxedPrecision
        %238 =   OpExtInst %float %1 FClamp %239 %float_0 %float_1  ; RelaxedPrecision
        %240 =   OpVectorTimesScalar %v4float %237 %238             ; RelaxedPrecision
        %242 =   OpConvertSToF %float %117                          ; RelaxedPrecision
        %241 =   OpExtInst %float %1 FClamp %242 %float_0 %float_1  ; RelaxedPrecision
        %243 =   OpVectorTimesScalar %v4float %240 %241             ; RelaxedPrecision
        %245 =   OpConvertUToF %float %135                          ; RelaxedPrecision
        %244 =   OpExtInst %float %1 FClamp %245 %float_0 %float_1  ; RelaxedPrecision
        %246 =   OpVectorTimesScalar %v4float %243 %244             ; RelaxedPrecision
        %248 =   OpConvertSToF %float %156                          ; RelaxedPrecision
        %247 =   OpExtInst %float %1 FClamp %248 %float_0 %float_1  ; RelaxedPrecision
        %249 =   OpVectorTimesScalar %v4float %246 %247             ; RelaxedPrecision
        %251 =   OpConvertSToF %float %174                          ; RelaxedPrecision
        %250 =   OpExtInst %float %1 FClamp %251 %float_0 %float_1  ; RelaxedPrecision
        %252 =   OpVectorTimesScalar %v4float %249 %250             ; RelaxedPrecision
        %254 =   OpCompositeExtract %int %194 0
        %255 =   OpConvertSToF %float %254          ; RelaxedPrecision
        %256 =   OpCompositeExtract %int %194 1
        %257 =   OpConvertSToF %float %256          ; RelaxedPrecision
        %258 =   OpCompositeExtract %int %194 2
        %259 =   OpConvertSToF %float %258          ; RelaxedPrecision
        %260 =   OpCompositeExtract %int %194 3
        %261 =   OpConvertSToF %float %260          ; RelaxedPrecision
        %262 =   OpCompositeConstruct %v4float %255 %257 %259 %261  ; RelaxedPrecision
        %253 =   OpExtInst %v4float %1 FClamp %262 %263 %264        ; RelaxedPrecision
        %265 =   OpFMul %v4float %252 %253                          ; RelaxedPrecision
        %267 =   OpCompositeExtract %uint %213 0
        %268 =   OpConvertUToF %float %267          ; RelaxedPrecision
        %269 =   OpCompositeExtract %uint %213 1
        %270 =   OpConvertUToF %float %269          ; RelaxedPrecision
        %271 =   OpCompositeExtract %uint %213 2
        %272 =   OpConvertUToF %float %271          ; RelaxedPrecision
        %273 =   OpCompositeExtract %uint %213 3
        %274 =   OpConvertUToF %float %273          ; RelaxedPrecision
        %275 =   OpCompositeConstruct %v4float %268 %270 %272 %274  ; RelaxedPrecision
        %266 =   OpExtInst %v4float %1 FClamp %275 %263 %264        ; RelaxedPrecision
        %276 =   OpFMul %v4float %265 %266                          ; RelaxedPrecision
        %278 =   OpAccessChain %_ptr_Function_v4float %hugeMxM %int_0
        %279 =   OpLoad %v4float %278
        %277 =   OpExtInst %v4float %1 FClamp %279 %263 %264    ; RelaxedPrecision
        %280 =   OpFMul %v4float %276 %277                      ; RelaxedPrecision
        %281 =   OpExtInst %v4float %1 FClamp %223 %263 %264    ; RelaxedPrecision
        %282 =   OpFMul %v4float %280 %281                      ; RelaxedPrecision
        %283 =   OpExtInst %v4float %1 FClamp %225 %263 %264    ; RelaxedPrecision
        %284 =   OpFMul %v4float %282 %283                      ; RelaxedPrecision
                 OpReturnValue %284
               OpFunctionEnd
