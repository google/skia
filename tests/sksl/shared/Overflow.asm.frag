          ...
          %5 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %hugeF "hugeF"                    ; id %42
               OpName %hugeI "hugeI"                    ; id %54
               OpName %hugeU "hugeU"                    ; id %78
               OpName %hugeS "hugeS"                    ; id %102
               OpName %hugeUS "hugeUS"                  ; id %121
               OpName %hugeNI "hugeNI"                  ; id %139
               OpName %hugeNS "hugeNS"                  ; id %160
               OpName %hugeIvec "hugeIvec"              ; id %178
               OpName %hugeUvec "hugeUvec"              ; id %198
               OpName %hugeMxM "hugeMxM"                ; id %217
               OpName %hugeMxV "hugeMxV"                ; id %224
               OpName %hugeVxM "hugeVxM"                ; id %227
...
%_entrypoint_v = OpFunction %void None %16
   ...
   %hugeUvec =   OpVariable %_ptr_Function_v4uint Function
    ...
    %hugeVxM =   OpVariable %_ptr_Function_v4float Function
         %31 =   OpFMul %float %float_9_99999962e_35 %float_1e_09   ; RelaxedPrecision
         ...
         %38 =   OpFMul %float %37 %float_1e_09                     ; RelaxedPrecision
         %39 =   OpFMul %float %38 %float_1e_09                     ; RelaxedPrecision
         %40 =   OpFMul %float %39 %float_1e_09                     ; RelaxedPrecision
         %41 =   OpFMul %float %40 %float_1e_09                     ; RelaxedPrecision
                 OpStore %hugeH %41
         %43 =   OpFMul %float %float_9_99999962e_35 %float_1e_09
        ...
        %101 =   OpIMul %uint %100 %uint_2
                 OpStore %hugeU %101
        %104 =   OpIMul %int %int_16384 %int_2      ; RelaxedPrecision
        ...
        %120 =   OpIMul %int %119 %int_2            ; RelaxedPrecision
                 OpStore %hugeS %120
        %123 =   OpIMul %uint %uint_32768 %uint_2   ; RelaxedPrecision
        ...
        %159 =   OpIMul %int %158 %int_2
                 OpStore %hugeNI %159
        %162 =   OpIMul %int %int_n32768 %int_2     ; RelaxedPrecision
        ...
        %228 =   OpVectorTimesMatrix %v4float %221 %222
                 OpStore %hugeVxM %228
        %229 =   OpAccessChain %_ptr_Uniform_v4float %11 %int_0
        %232 =   OpLoad %v4float %229               ; RelaxedPrecision
        %233 =   OpExtInst %float %5 FClamp %41 %float_0 %float_1   ; RelaxedPrecision
        %235 =   OpVectorTimesScalar %v4float %232 %233             ; RelaxedPrecision
        %236 =   OpExtInst %float %5 FClamp %53 %float_0 %float_1   ; RelaxedPrecision
        %237 =   OpVectorTimesScalar %v4float %235 %236             ; RelaxedPrecision
        %239 =   OpConvertSToF %float %77                           ; RelaxedPrecision
        %238 =   OpExtInst %float %5 FClamp %239 %float_0 %float_1  ; RelaxedPrecision
        %240 =   OpVectorTimesScalar %v4float %237 %238             ; RelaxedPrecision
        %242 =   OpConvertUToF %float %101                          ; RelaxedPrecision
        %241 =   OpExtInst %float %5 FClamp %242 %float_0 %float_1  ; RelaxedPrecision
        %243 =   OpVectorTimesScalar %v4float %240 %241             ; RelaxedPrecision
        %245 =   OpConvertSToF %float %120                          ; RelaxedPrecision
        %244 =   OpExtInst %float %5 FClamp %245 %float_0 %float_1  ; RelaxedPrecision
        %246 =   OpVectorTimesScalar %v4float %243 %244             ; RelaxedPrecision
        %248 =   OpConvertUToF %float %138                          ; RelaxedPrecision
        %247 =   OpExtInst %float %5 FClamp %248 %float_0 %float_1  ; RelaxedPrecision
        %249 =   OpVectorTimesScalar %v4float %246 %247             ; RelaxedPrecision
        %251 =   OpConvertSToF %float %159                          ; RelaxedPrecision
        %250 =   OpExtInst %float %5 FClamp %251 %float_0 %float_1  ; RelaxedPrecision
        %252 =   OpVectorTimesScalar %v4float %249 %250             ; RelaxedPrecision
        %254 =   OpConvertSToF %float %177                          ; RelaxedPrecision
        %253 =   OpExtInst %float %5 FClamp %254 %float_0 %float_1  ; RelaxedPrecision
        %255 =   OpVectorTimesScalar %v4float %252 %253             ; RelaxedPrecision
        %257 =   OpCompositeExtract %int %197 0
        %258 =   OpConvertSToF %float %257          ; RelaxedPrecision
        %259 =   OpCompositeExtract %int %197 1
        %260 =   OpConvertSToF %float %259          ; RelaxedPrecision
        ...
        %265 =   OpCompositeConstruct %v4float %258 %260 %262 %264  ; RelaxedPrecision
        %256 =   OpExtInst %v4float %5 FClamp %265 %266 %267        ; RelaxedPrecision
        %268 =   OpFMul %v4float %255 %256                          ; RelaxedPrecision
        %270 =   OpCompositeExtract %uint %216 0
        %271 =   OpConvertUToF %float %270          ; RelaxedPrecision
        %272 =   OpCompositeExtract %uint %216 1
        %273 =   OpConvertUToF %float %272          ; RelaxedPrecision
        ...
        %278 =   OpCompositeConstruct %v4float %271 %273 %275 %277  ; RelaxedPrecision
        %269 =   OpExtInst %v4float %5 FClamp %278 %266 %267        ; RelaxedPrecision
        %279 =   OpFMul %v4float %268 %269                          ; RelaxedPrecision
        %281 =   OpAccessChain %_ptr_Function_v4float %hugeMxM %int_0
        %282 =   OpLoad %v4float %281
        %280 =   OpExtInst %v4float %5 FClamp %282 %266 %267    ; RelaxedPrecision
        %283 =   OpFMul %v4float %279 %280                      ; RelaxedPrecision
        %284 =   OpExtInst %v4float %5 FClamp %226 %266 %267    ; RelaxedPrecision
        %285 =   OpFMul %v4float %283 %284                      ; RelaxedPrecision
        %286 =   OpExtInst %v4float %5 FClamp %228 %266 %267    ; RelaxedPrecision
        %287 =   OpFMul %v4float %285 %286                      ; RelaxedPrecision
                 OpReturnValue %287
               OpFunctionEnd
