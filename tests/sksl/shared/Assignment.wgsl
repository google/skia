...
struct S {
  ...
  af: array<f32, 5>,
  h4: vec4<f16>,
  ah4: array<vec4<f16>, 5>,
};
var<private> globalVar: vec4<f16>;
var<private> globalStruct: S;
fn keepAlive_vh(h: ptr<function, f16>) {
  {
  }
}
...
fn _skslMain(coords: vec2<f32>) -> vec4<f16> {
  {
    ...
    var x: vec4<f16>;
    x.w = 0.0h;
    x = vec4<f16>((vec2<f16>(0.0h)), x.zw).yxzw;
    var ai: array<i32, 1>;
    ai[0] = 0;
    var ai4: array<vec4<i32>, 1>;
    ai4[0] = vec4<i32>(1, 2, 3, 4);
    var ah3x3: array<mat3x3<f16>, 1>;
    ah3x3[0] = mat3x3<f16>(1.0h, 2.0h, 3.0h, 4.0h, 5.0h, 6.0h, 7.0h, 8.0h, 9.0h);
    ...
    s.f = 0.0;
    s.af[1] = 0.0;
    s.h4 = vec4<f16>((vec3<f16>(9.0h)), s.h4.w).yzxw;
    s.ah4[2] = vec4<f16>(s.ah4[2].xz, (vec2<f16>(5.0h))).xzyw;
    globalVar = vec4<f16>(0.0h);
    globalStruct.f = 0.0;
