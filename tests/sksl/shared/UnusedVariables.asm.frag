          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %userfunc_ff "userfunc_ff"        ; id %2
...
%userfunc_ff = OpFunction %float None %19
       ...
       %main = OpFunction %v4float None %25         ; RelaxedPrecision
         ...
         %62 =   OpSelect %float %61 %float_1 %float_0  ; RelaxedPrecision
         %64 =   OpSelect %float %true %float_1 %float_0    ; RelaxedPrecision
         ...
         %71 =   OpCompositeConstruct %v4float %62 %64 %67 %70  ; RelaxedPrecision
                 OpReturnValue %71
               OpFunctionEnd
