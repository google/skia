          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %MATRIXFIVE "MATRIXFIVE"      ; id %8
               OpName %_UniformBuffer "_UniformBuffer"  ; id %19
               OpMemberName %_UniformBuffer 0 "colorGreen"
               OpMemberName %_UniformBuffer 1 "colorRed"
               OpName %_entrypoint_v "_entrypoint_v"    ; id %21
               OpName %verify_const_globals_biih44 "verify_const_globals_biih44"    ; id %2
...
%verify_const_globals_biih44 = OpFunction %bool None %34
         ...
         %37 = OpFunctionParameter %_ptr_Function_mat4v4float   ; RelaxedPrecision
         ...
         %49 =     OpLabel
         %51 =       OpLoad %mat4v4float %37        ; RelaxedPrecision
         %53 =       OpCompositeExtract %v4float %51 0  ; RelaxedPrecision
         %54 =       OpFOrdEqual %v4bool %53 %13        ; RelaxedPrecision
         %55 =       OpAll %bool %54
         %56 =       OpCompositeExtract %v4float %51 1  ; RelaxedPrecision
         %57 =       OpFOrdEqual %v4bool %56 %14        ; RelaxedPrecision
         %58 =       OpAll %bool %57
         %59 =       OpLogicalAnd %bool %55 %58
         %60 =       OpCompositeExtract %v4float %51 2  ; RelaxedPrecision
         %61 =       OpFOrdEqual %v4bool %60 %15        ; RelaxedPrecision
         %62 =       OpAll %bool %61
         %63 =       OpLogicalAnd %bool %59 %62
         %64 =       OpCompositeExtract %v4float %51 3  ; RelaxedPrecision
         %65 =       OpFOrdEqual %v4bool %64 %16        ; RelaxedPrecision
         %66 =       OpAll %bool %65
         ...
         %68 =   OpPhi %bool %false %44 %67 %49
               ...
               ; Function main
       %main = OpFunction %v4float None %69         ; RelaxedPrecision
         ...
         %84 =       OpLoad %v4float %81            ; RelaxedPrecision
                     OpStore %76 %84
                     OpBranch %80
         ...
         %80 = OpLabel
         %88 =   OpLoad %v4float %76                ; RelaxedPrecision
                 OpReturnValue %88
               OpFunctionEnd
