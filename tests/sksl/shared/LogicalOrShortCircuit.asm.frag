          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %_entrypoint_v "_entrypoint_v"    ; id %13
               OpName %TrueFalse_b "TrueFalse_b"        ; id %2
               OpName %x "x"                            ; id %26
               OpName %y "y"                            ; id %30
               OpName %FalseTrue_b "FalseTrue_b"        ; id %3
               OpName %x_0 "x"                          ; id %48
               OpName %y_0 "y"                          ; id %49
               OpName %FalseFalse_b "FalseFalse_b"      ; id %4
               OpName %x_1 "x"                          ; id %66
               OpName %y_1 "y"                          ; id %67
               OpName %main "main"                      ; id %5
               OpName %_0_TrueTrue "_0_TrueTrue"        ; id %85
               OpName %_2_y "_2_y"                      ; id %87
...
%FalseFalse_b = OpFunction %bool None %24
        ...
        %y_1 =   OpVariable %_ptr_Function_int Function
         ...
         %76 = OpLabel
               ...
               ; Function main
       %main = OpFunction %v4float None %82         ; RelaxedPrecision
...
%_0_TrueTrue =   OpVariable %_ptr_Function_bool Function
       %_2_y =   OpVariable %_ptr_Function_int Function
        ...
        %108 =       OpLoad %v4float %105           ; RelaxedPrecision
                     OpStore %100 %108
                     OpBranch %104
        ...
        %104 = OpLabel
        %111 =   OpLoad %v4float %100               ; RelaxedPrecision
                 OpReturnValue %111
               OpFunctionEnd
