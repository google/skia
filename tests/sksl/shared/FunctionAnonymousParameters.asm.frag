          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %fnGreen_h4bf2 "fnGreen_h4bf2"    ; id %2
               OpName %S "S"                            ; id %35
               OpMemberName %S 0 "i"
               OpName %fnRed_h4ifS "fnRed_h4ifS"    ; id %3
...
%fnGreen_h4bf2 = OpFunction %v4float None %24       ; RelaxedPrecision
...
%fnRed_h4ifS = OpFunction %v4float None %37         ; RelaxedPrecision
       ...
       %main = OpFunction %v4float None %45         ; RelaxedPrecision
         ...
         %56 = OpLabel
         %69 =   OpLoad %v4float %52                ; RelaxedPrecision
                 OpReturnValue %69
               OpFunctionEnd
