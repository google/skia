...
bool test_matrix_op_matrix_float_b() {
    bool ok = true;
    {
        const float3x2 splat_4 = float3x2(float2(4.0, 4.0), float2(4.0, 4.0), float2(4.0, 4.0));
        float3x2 m;
        m = float3x2(2.0);
        m += splat_4;
        ok = ok && m == float3x2(float2(6.0, 4.0), float2(4.0, 6.0), float2(4.0, 4.0));
        m = float3x2(2.0);
        m -= splat_4;
        ok = ok && m == float3x2(float2(-2.0, -4.0), float2(-4.0, -2.0), float2(-4.0, -4.0));
        m = float3x2(2.0);
        m /= splat_4;
        ok = ok && m == float3x2(0.5);
    }
    {
        const float2x3 splat_4 = float2x3(float3(4.0, 4.0, 4.0), float3(4.0, 4.0, 4.0));
        float2x3 m;
        m = splat_4;
        m += float2x3(2.0);
        ok = ok && m == float2x3(float3(6.0, 4.0, 4.0), float3(4.0, 6.0, 4.0));
        m = splat_4;
        m -= float2x3(2.0);
        ok = ok && m == float2x3(float3(2.0, 4.0, 4.0), float3(4.0, 2.0, 4.0));
        m = splat_4;
        m /= float2x3(float3(2.0, 2.0, 2.0), float3(2.0, 2.0, 2.0));
        ok = ok && m == float2x3(float3(2.0, 2.0, 2.0), float3(2.0, 2.0, 2.0));
    }
    {
        float4x3 m = float4x3(float3(1.0, 2.0, 3.0), float3(4.0, 5.0, 6.0), float3(7.0, 8.0, 9.0), float3(10.0, 11.0, 12.0));
        m += float4x3(float3(16.0, 15.0, 14.0), float3(13.0, 12.0, 11.0), float3(10.0, 9.0, 8.0), float3(7.0, 6.0, 5.0));
        ok = ok && m == float4x3(float3(17.0, 17.0, 17.0), float3(17.0, 17.0, 17.0), float3(17.0, 17.0, 17.0), float3(17.0, 17.0, 17.0));
    }
    {
        float4x2 m = float4x2(float2(10.0, 20.0), float2(30.0, 40.0), float2(50.0, 60.0), float2(70.0, 80.0));
        m -= float4x2(float2(1.0, 2.0), float2(3.0, 4.0), float2(5.0, 6.0), float2(7.0, 8.0));
        ok = ok && m == float4x2(float2(9.0, 18.0), float2(27.0, 36.0), float2(45.0, 54.0), float2(63.0, 72.0));
    }
    {
        float2x4 m = float2x4(float4(10.0, 20.0, 30.0, 40.0), float4(10.0, 20.0, 30.0, 40.0));
        m /= float2x4(float4(10.0, 10.0, 10.0, 10.0), float4(5.0, 5.0, 5.0, 5.0));
        ok = ok && m == float2x4(float4(1.0, 2.0, 3.0, 4.0), float4(2.0, 4.0, 6.0, 8.0));
    }
    {
        float2x3 m = float2x3(float3(7.0, 9.0, 11.0), float3(8.0, 10.0, 12.0));
        m *= float2x2(float2(1.0, 4.0), float2(2.0, 5.0));
        ok = ok && m == float2x3(float3(39.0, 49.0, 59.0), float3(54.0, 68.0, 82.0));
    }
    return ok;
}
...
fragment Outputs fragmentMain(Inputs _in [[stage_in]], constant Uniforms& _uniforms [[buffer(0)]], bool _frontFacing [[front_facing]], float4 _fragCoord [[position]]) {
    Outputs _out;
    (void)_out;
    _out.sk_FragColor = test_matrix_op_matrix_float_b() && test_matrix_op_matrix_half_b() ? _uniforms.colorGreen : _uniforms.colorRed;
    return _out;
}
