...
%_entrypoint_v = OpFunction %void None %12
       ...
       %m3x3 =   OpVariable %_ptr_Function_mat3v3float Function
        ...
        %102 =   OpFAdd %float %101 %float_1
                 OpStore %99 %102
        %103 =   OpLoad %bool %ok                   ; RelaxedPrecision
        ...
        %132 =   OpFSub %float %131 %float_1
                 OpStore %130 %132
        %133 =   OpLoad %bool %ok                   ; RelaxedPrecision
        ...
        %347 =       OpLoad %v4float %345           ; RelaxedPrecision
                     OpStore %340 %347
                     OpBranch %344

        %343 =     OpLabel
        %348 =       OpAccessChain %_ptr_Uniform_v4float %7 %int_1
        %349 =       OpLoad %v4float %348           ; RelaxedPrecision
                     OpStore %340 %349
                     OpBranch %344

        %344 = OpLabel
        %350 =   OpLoad %v4float %340               ; RelaxedPrecision
                 OpReturnValue %350
               OpFunctionEnd
