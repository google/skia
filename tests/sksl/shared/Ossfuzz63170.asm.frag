          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %out_param_func2_ih "out_param_func2_ih"  ; id %2
               OpName %main "main"                              ; id %3
               OpName %testArray "testArray"                    ; id %35
...
%out_param_func2_ih = OpFunction %int None %23
  ...
  %testArray =   OpVariable %_ptr_Function__arr_float_int_2 Function    ; RelaxedPrecision
         %41 =   OpVariable %_ptr_Function_float Function               ; RelaxedPrecision
         ...
         %49 =   OpLoad %float %48                  ; RelaxedPrecision
         ...
         %62 = OpLabel
         %67 =   OpLoad %v4float %58                ; RelaxedPrecision
                 OpReturnValue %67
               OpFunctionEnd
