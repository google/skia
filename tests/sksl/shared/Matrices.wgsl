...
fn test_half_b() -> bool {
    ...
    let _skTemp13 = m7;
    let _skTemp14 = mat2x2<f32>(vec2<f32>(5.0, 6.0), vec2<f32>(7.0, 8.0));
    ...
    let _skTemp15 = m9;
    let _skTemp16 = mat3x3<f32>(vec3<f32>(9.0, 0.0, 0.0), vec3<f32>(0.0, 9.0, 0.0), vec3<f32>(0.0, 0.0, 9.0));
    ...
    let _skTemp17 = m10;
    let _skTemp18 = mat4x4<f32>(vec4<f32>(11.0, 0.0, 0.0, 0.0), vec4<f32>(0.0, 11.0, 0.0, 0.0), vec4<f32>(0.0, 0.0, 11.0, 0.0), vec4<f32>(0.0, 0.0, 0.0, 11.0));
    ...
    m11 = m11 - m10;
    let _skTemp19 = m11;
    let _skTemp20 = mat4x4<f32>(vec4<f32>(9.0, 20.0, 20.0, 20.0), vec4<f32>(20.0, 9.0, 20.0, 20.0), vec4<f32>(20.0, 20.0, 9.0, 20.0), vec4<f32>(20.0, 20.0, 20.0, 9.0));
...
fn main(coords: vec2<f32>) -> vec4<f32> {
    ...
    let _skTemp30 = _4_m5;
    let _skTemp31 = mat2x2<f32>(vec2<f32>(4.0, 0.0), vec2<f32>(0.0, 4.0));
    _0_ok = _0_ok && (all(_skTemp30[0] == _skTemp31[0]) && all(_skTemp30[1] == _skTemp31[1]));
    _1_m1 = _1_m1 + _4_m5;
    let _skTemp32 = _1_m1;
    let _skTemp33 = mat2x2<f32>(vec2<f32>(5.0, 2.0), vec2<f32>(3.0, 8.0));
    ...
    let _skTemp35 = mat4x4<f32>(vec4<f32>(9.0, 20.0, 20.0, 20.0), vec4<f32>(20.0, 9.0, 20.0, 20.0), vec4<f32>(20.0, 20.0, 9.0, 20.0), vec4<f32>(20.0, 20.0, 20.0, 9.0));
