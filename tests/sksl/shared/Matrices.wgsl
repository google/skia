...
fn test_half_b() -> bool {
  {
    var ok: bool = true;
    var m1: mat2x2<f16> = mat2x2<f16>(1.0h, 2.0h, 3.0h, 4.0h);
    const _skTemp0 = mat2x2<f16>(1.0h, 2.0h, 3.0h, 4.0h);
    ok = ok && (all(m1[0] == _skTemp0[0]) && all(m1[1] == _skTemp0[1]));
    var m3: mat2x2<f16> = m1;
    const _skTemp1 = mat2x2<f16>(1.0h, 2.0h, 3.0h, 4.0h);
    ok = ok && (all(m3[0] == _skTemp1[0]) && all(m3[1] == _skTemp1[1]));
    const m4: mat2x2<f16> = mat2x2<f16>(6.0h, 0.0, 0.0, 6.0h);
    const _skTemp2 = mat2x2<f16>(6.0h, 0.0h, 0.0h, 6.0h);
    ok = ok && (all(m4[0] == _skTemp2[0]) && all(m4[1] == _skTemp2[1]));
    m3 = m3 * m4;
    const _skTemp3 = mat2x2<f16>(6.0h, 12.0h, 18.0h, 24.0h);
    ok = ok && (all(m3[0] == _skTemp3[0]) && all(m3[1] == _skTemp3[1]));
    let _skTemp4 = m1[1].y;
    let m5: mat2x2<f16> = mat2x2<f16>(_skTemp4, 0.0, 0.0, _skTemp4);
    const _skTemp5 = mat2x2<f16>(4.0h, 0.0h, 0.0h, 4.0h);
    ok = ok && (all(m5[0] == _skTemp5[0]) && all(m5[1] == _skTemp5[1]));
    m1 = m1 + m5;
    const _skTemp6 = mat2x2<f16>(5.0h, 2.0h, 3.0h, 8.0h);
    ok = ok && (all(m1[0] == _skTemp6[0]) && all(m1[1] == _skTemp6[1]));
    const m7: mat2x2<f16> = mat2x2<f16>(5.0h, 6.0h, 7.0h, 8.0h);
    const _skTemp7 = mat2x2<f16>(5.0h, 6.0h, 7.0h, 8.0h);
    ok = ok && (all(m7[0] == _skTemp7[0]) && all(m7[1] == _skTemp7[1]));
    const m9: mat3x3<f16> = mat3x3<f16>(9.0h, 0.0, 0.0, 0.0, 9.0h, 0.0, 0.0, 0.0, 9.0h);
    const _skTemp8 = mat3x3<f16>(9.0h, 0.0h, 0.0h, 0.0h, 9.0h, 0.0h, 0.0h, 0.0h, 9.0h);
    ok = ok && (all(m9[0] == _skTemp8[0]) && all(m9[1] == _skTemp8[1]) && all(m9[2] == _skTemp8[2]));
    const m10: mat4x4<f16> = mat4x4<f16>(11.0h, 0.0, 0.0, 0.0, 0.0, 11.0h, 0.0, 0.0, 0.0, 0.0, 11.0h, 0.0, 0.0, 0.0, 0.0, 11.0h);
    const _skTemp9 = mat4x4<f16>(11.0h, 0.0h, 0.0h, 0.0h, 0.0h, 11.0h, 0.0h, 0.0h, 0.0h, 0.0h, 11.0h, 0.0h, 0.0h, 0.0h, 0.0h, 11.0h);
    ok = ok && (all(m10[0] == _skTemp9[0]) && all(m10[1] == _skTemp9[1]) && all(m10[2] == _skTemp9[2]) && all(m10[3] == _skTemp9[3]));
    var m11: mat4x4<f16> = mat4x4<f16>(20.0h, 20.0h, 20.0h, 20.0h, 20.0h, 20.0h, 20.0h, 20.0h, 20.0h, 20.0h, 20.0h, 20.0h, 20.0h, 20.0h, 20.0h, 20.0h);
    m11 = m11 - m10;
    const _skTemp10 = mat4x4<f16>(9.0h, 20.0h, 20.0h, 20.0h, 20.0h, 9.0h, 20.0h, 20.0h, 20.0h, 20.0h, 9.0h, 20.0h, 20.0h, 20.0h, 20.0h, 9.0h);
...
fn _skslMain(coords: vec2<f32>) -> vec4<f16> {
  {
    ...
    const _skTemp17 = mat4x4<f32>(9.0, 20.0, 20.0, 20.0, 20.0, 9.0, 20.0, 20.0, 20.0, 20.0, 9.0, 20.0, 20.0, 20.0, 20.0, 9.0);
