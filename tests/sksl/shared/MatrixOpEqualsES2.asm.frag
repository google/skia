          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %_0_ok "_0_ok"                                                ; id %314
               OpName %_1_splat_4 "_1_splat_4"                                      ; id %315
               OpName %_2_splat_2 "_2_splat_2"                                      ; id %316
               OpName %_3_m "_3_m"                                                  ; id %317
               OpName %_4_m "_4_m"                                                  ; id %408
               OpName %_5_m "_5_m"                                                  ; id %428
               OpName %_6_m "_6_m"                                                  ; id %440
               OpName %_7_m "_7_m"                                                  ; id %452
               OpName %_8_m "_8_m"                                                  ; id %464
...
%test_matrix_op_matrix_half_b = OpFunction %bool None %22
    ...
    %splat_2 =   OpVariable %_ptr_Function_mat3v3float Function     ; RelaxedPrecision
        ...
        %m_4 =   OpVariable %_ptr_Function_mat3v3float Function     ; RelaxedPrecision
                 ...
                 OpStore %splat_2 %37
                 OpStore %m %42
         %43 =   OpFAdd %v3float %39 %32            ; RelaxedPrecision
         %44 =   OpFAdd %v3float %40 %32            ; RelaxedPrecision
         %45 =   OpFAdd %v3float %41 %32            ; RelaxedPrecision
         %46 =   OpCompositeConstruct %mat3v3float %43 %44 %45  ; RelaxedPrecision
                 OpStore %m %46
                 OpSelectionMerge %49 None
                 OpBranchConditional %true %48 %49

         %48 =     OpLabel
         %56 =       OpFOrdEqual %v3bool %43 %51    ; RelaxedPrecision
         %57 =       OpAll %bool %56
         %58 =       OpFOrdEqual %v3bool %44 %52    ; RelaxedPrecision
         %59 =       OpAll %bool %58
         %60 =       OpLogicalAnd %bool %57 %59
         %61 =       OpFOrdEqual %v3bool %45 %53    ; RelaxedPrecision
         %62 =       OpAll %bool %61
         ...
         %64 =   OpPhi %bool %false %23 %63 %48
                 OpStore %ok %64
                 OpStore %m %42
         %65 =   OpFSub %v3float %39 %32            ; RelaxedPrecision
         %66 =   OpFSub %v3float %40 %32            ; RelaxedPrecision
         %67 =   OpFSub %v3float %41 %32            ; RelaxedPrecision
         %68 =   OpCompositeConstruct %mat3v3float %65 %66 %67  ; RelaxedPrecision
                 OpStore %m %68
                 OpSelectionMerge %70 None
                 OpBranchConditional %64 %69 %70

         %69 =     OpLabel
         %77 =       OpFOrdEqual %v3bool %65 %73    ; RelaxedPrecision
         %78 =       OpAll %bool %77
         %79 =       OpFOrdEqual %v3bool %66 %74    ; RelaxedPrecision
         %80 =       OpAll %bool %79
         %81 =       OpLogicalAnd %bool %78 %80
         %82 =       OpFOrdEqual %v3bool %67 %75    ; RelaxedPrecision
         %83 =       OpAll %bool %82
         ...
         %85 =   OpPhi %bool %false %49 %84 %69
                 OpStore %ok %85
                 OpStore %m %42
         %86 =   OpFDiv %v3float %39 %32            ; RelaxedPrecision
         %87 =   OpFDiv %v3float %40 %32            ; RelaxedPrecision
         %88 =   OpFDiv %v3float %41 %32            ; RelaxedPrecision
         %89 =   OpCompositeConstruct %mat3v3float %86 %87 %88  ; RelaxedPrecision
                 OpStore %m %89
                 OpSelectionMerge %91 None
                 OpBranchConditional %85 %90 %91

         %90 =     OpLabel
         %97 =       OpFOrdEqual %v3bool %86 %93    ; RelaxedPrecision
         %98 =       OpAll %bool %97
         %99 =       OpFOrdEqual %v3bool %87 %94    ; RelaxedPrecision
        %100 =       OpAll %bool %99
        %101 =       OpLogicalAnd %bool %98 %100
        %102 =       OpFOrdEqual %v3bool %88 %95    ; RelaxedPrecision
        %103 =       OpAll %bool %102
        ...
        %105 =   OpPhi %bool %false %70 %104 %90
                 OpStore %ok %105
                 OpStore %m %33
        %106 =   OpFAdd %v3float %32 %39            ; RelaxedPrecision
        %107 =   OpFAdd %v3float %32 %40            ; RelaxedPrecision
        %108 =   OpFAdd %v3float %32 %41            ; RelaxedPrecision
        %109 =   OpCompositeConstruct %mat3v3float %106 %107 %108   ; RelaxedPrecision
                 OpStore %m %109
                 OpSelectionMerge %111 None
                 OpBranchConditional %105 %110 %111

        %110 =     OpLabel
        %112 =       OpFOrdEqual %v3bool %106 %51   ; RelaxedPrecision
        %113 =       OpAll %bool %112
        %114 =       OpFOrdEqual %v3bool %107 %52   ; RelaxedPrecision
        %115 =       OpAll %bool %114
        %116 =       OpLogicalAnd %bool %113 %115
        %117 =       OpFOrdEqual %v3bool %108 %53   ; RelaxedPrecision
        %118 =       OpAll %bool %117
        ...
        %120 =   OpPhi %bool %false %91 %119 %110
                 OpStore %ok %120
                 OpStore %m %33
        %121 =   OpFSub %v3float %32 %39            ; RelaxedPrecision
        %122 =   OpFSub %v3float %32 %40            ; RelaxedPrecision
        %123 =   OpFSub %v3float %32 %41            ; RelaxedPrecision
        %124 =   OpCompositeConstruct %mat3v3float %121 %122 %123   ; RelaxedPrecision
                 OpStore %m %124
                 OpSelectionMerge %126 None
                 OpBranchConditional %120 %125 %126

        %125 =     OpLabel
        %131 =       OpFOrdEqual %v3bool %121 %127  ; RelaxedPrecision
        %132 =       OpAll %bool %131
        %133 =       OpFOrdEqual %v3bool %122 %128  ; RelaxedPrecision
        %134 =       OpAll %bool %133
        %135 =       OpLogicalAnd %bool %132 %134
        %136 =       OpFOrdEqual %v3bool %123 %129  ; RelaxedPrecision
        %137 =       OpAll %bool %136
        ...
        %139 =   OpPhi %bool %false %111 %138 %125
                 OpStore %ok %139
                 OpStore %m %33
        %140 =   OpFDiv %v3float %32 %36            ; RelaxedPrecision
        %141 =   OpFDiv %v3float %32 %36            ; RelaxedPrecision
        %142 =   OpFDiv %v3float %32 %36            ; RelaxedPrecision
        %143 =   OpCompositeConstruct %mat3v3float %140 %141 %142   ; RelaxedPrecision
                 OpStore %m %143
                 OpSelectionMerge %145 None
                 OpBranchConditional %139 %144 %145

        %144 =     OpLabel
        %146 =       OpFOrdEqual %v3bool %140 %36   ; RelaxedPrecision
        %147 =       OpAll %bool %146
        %148 =       OpFOrdEqual %v3bool %141 %36   ; RelaxedPrecision
        %149 =       OpAll %bool %148
        %150 =       OpLogicalAnd %bool %147 %149
        %151 =       OpFOrdEqual %v3bool %142 %36   ; RelaxedPrecision
        %152 =       OpAll %bool %151
        ...
        %154 =   OpPhi %bool %false %126 %153 %144
                 OpStore %ok %154
                 OpStore %m_0 %175
        %181 =   OpFAdd %v4float %171 %176          ; RelaxedPrecision
        %182 =   OpFAdd %v4float %172 %177          ; RelaxedPrecision
        %183 =   OpFAdd %v4float %173 %178          ; RelaxedPrecision
        %184 =   OpFAdd %v4float %174 %179          ; RelaxedPrecision
        %185 =   OpCompositeConstruct %mat4v4float %181 %182 %183 %184  ; RelaxedPrecision
                 OpStore %m_0 %185
                 OpSelectionMerge %187 None
                 OpBranchConditional %154 %186 %187

        %186 =     OpLabel
        %192 =       OpFOrdEqual %v4bool %181 %189  ; RelaxedPrecision
        %193 =       OpAll %bool %192
        %194 =       OpFOrdEqual %v4bool %182 %189  ; RelaxedPrecision
        %195 =       OpAll %bool %194
        %196 =       OpLogicalAnd %bool %193 %195
        %197 =       OpFOrdEqual %v4bool %183 %189  ; RelaxedPrecision
        %198 =       OpAll %bool %197
        %199 =       OpLogicalAnd %bool %196 %198
        %200 =       OpFOrdEqual %v4bool %184 %189  ; RelaxedPrecision
        %201 =       OpAll %bool %200
        ...
        %203 =   OpPhi %bool %false %145 %202 %186
                 OpStore %ok %203
                 OpStore %m_1 %212
        %216 =   OpFSub %v2float %210 %213          ; RelaxedPrecision
        %217 =   OpFSub %v2float %211 %214          ; RelaxedPrecision
        %218 =   OpCompositeConstruct %mat2v2float %216 %217    ; RelaxedPrecision
                 OpStore %m_1 %218
                 OpSelectionMerge %220 None
                 OpBranchConditional %203 %219 %220

        %219 =     OpLabel
        %228 =       OpFOrdEqual %v2bool %216 %224  ; RelaxedPrecision
        %229 =       OpAll %bool %228
        %230 =       OpFOrdEqual %v2bool %217 %225  ; RelaxedPrecision
        %231 =       OpAll %bool %230
        ...
        %233 =   OpPhi %bool %false %187 %232 %219
                 OpStore %ok %233
                 OpStore %m_2 %237
        %240 =   OpFDiv %v2float %235 %238          ; RelaxedPrecision
        %241 =   OpFDiv %v2float %236 %235          ; RelaxedPrecision
        %242 =   OpCompositeConstruct %mat2v2float %240 %241    ; RelaxedPrecision
                 OpStore %m_2 %242
                 OpSelectionMerge %244 None
                 OpBranchConditional %233 %243 %244

        %243 =     OpLabel
        %247 =       OpFOrdEqual %v2bool %240 %213  ; RelaxedPrecision
        %248 =       OpAll %bool %247
        %249 =       OpFOrdEqual %v2bool %241 %245  ; RelaxedPrecision
        %250 =       OpAll %bool %249
        ...
        %252 =   OpPhi %bool %false %220 %251 %243
                 OpStore %ok %252
                 OpStore %m_3 %255
        %258 =   OpMatrixTimesMatrix %mat2v2float %255 %257     ; RelaxedPrecision
                 OpStore %m_3 %258
                 OpSelectionMerge %260 None
                 OpBranchConditional %252 %259 %260

        %259 =     OpLabel
        %266 =       OpCompositeExtract %v2float %258 0     ; RelaxedPrecision
        %267 =       OpFOrdEqual %v2bool %266 %263          ; RelaxedPrecision
        %268 =       OpAll %bool %267
        %269 =       OpCompositeExtract %v2float %258 1     ; RelaxedPrecision
        %270 =       OpFOrdEqual %v2bool %269 %264          ; RelaxedPrecision
        %271 =       OpAll %bool %270
        ...
        %273 =   OpPhi %bool %false %244 %272 %259
                 OpStore %ok %273
                 OpStore %m_4 %278
        %283 =   OpMatrixTimesMatrix %mat3v3float %278 %282     ; RelaxedPrecision
                 OpStore %m_4 %283
                 OpSelectionMerge %285 None
                 OpBranchConditional %273 %284 %285

        %284 =     OpLabel
        %299 =       OpCompositeExtract %v3float %283 0     ; RelaxedPrecision
        %300 =       OpFOrdEqual %v3bool %299 %295          ; RelaxedPrecision
        %301 =       OpAll %bool %300
        %302 =       OpCompositeExtract %v3float %283 1     ; RelaxedPrecision
        %303 =       OpFOrdEqual %v3bool %302 %296          ; RelaxedPrecision
        %304 =       OpAll %bool %303
        %305 =       OpLogicalAnd %bool %301 %304
        %306 =       OpCompositeExtract %v3float %283 2     ; RelaxedPrecision
        %307 =       OpFOrdEqual %v3bool %306 %297          ; RelaxedPrecision
        %308 =       OpAll %bool %307
        ...
        %310 =   OpPhi %bool %false %260 %309 %284
               ...
               ; Function main
       %main = OpFunction %v4float None %311        ; RelaxedPrecision
 ...
 %_2_splat_2 =   OpVariable %_ptr_Function_mat3v3float Function
       ...
       %_8_m =   OpVariable %_ptr_Function_mat3v3float Function
        ...
        %493 =       OpLoad %v4float %489           ; RelaxedPrecision
                     OpStore %484 %493
                     OpBranch %488

        %487 =     OpLabel
        %494 =       OpAccessChain %_ptr_Uniform_v4float %8 %int_0
        %496 =       OpLoad %v4float %494           ; RelaxedPrecision
                     OpStore %484 %496
                     OpBranch %488

        %488 = OpLabel
        %497 =   OpLoad %v4float %484               ; RelaxedPrecision
                 OpReturnValue %497
               OpFunctionEnd
