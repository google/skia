...
if (primaryColors) {
    ...
    Var(kConst_Modifier, DSLType(kHalf4_Type), "colorGreen").swap(_colorGreen);
    DeclareGlobal(_colorGreen, Half4(0));
}
Var _colorRed;
if (primaryColors) {
    ...
    Var(kConst_Modifier, DSLType(kHalf4_Type), "colorRed").swap(_colorRed);
    DeclareGlobal(_colorRed, Half4(0));
}
Var _colorOrange;
if (!primaryColors) {
    ...
    Var(kConst_Modifier, DSLType(kHalf4_Type), "colorOrange").swap(_colorOrange);
    DeclareGlobal(_colorOrange, Half4(0));
}
Var _colorPurple;
if (!primaryColors) {
    ...
    Var(kConst_Modifier, DSLType(kHalf4_Type), "colorPurple").swap(_colorPurple);
    DeclareGlobal(_colorPurple, Half4(0));
}
