          ...
          %1 = OpExtInstImport "GLSL.std.450"
               ...
               OpName %sksl_synthetic_uniforms "sksl_synthetic_uniforms"    ; id %21
...
%_ptr_Uniform_sksl_synthetic_uniforms = OpTypePointer Uniform %sksl_synthetic_uniforms
         %19 = OpVariable %_ptr_Uniform_sksl_synthetic_uniforms Uniform     ; Binding 0, DescriptorSet 0
%_ptr_Uniform_v2float = OpTypePointer Uniform %v2float
       ...
       %main = OpFunction %void None %10
         ...
         %16 =   OpLoad %float %12                  ; RelaxedPrecision
         %18 =   OpFSub %float %16 %float_1         ; RelaxedPrecision
                 OpStore %12 %18
