...
DEF_TEST(GrBagOfBytesBasic, r) {
    const int k4K = 1 << 12;
    {
        ...
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(0, 1, 16, 16) == 31);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(1, 1, 16, 16) == 32);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(63, 1, 16, 16) == 94);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(0, 8, 16, 16) == 24);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(1, 8, 16, 16) == 32);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(63, 8, 16, 16) == 88);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(0, 16, 16, 16) == 16);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(1, 16, 16, 16) == 32);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(63, 16, 16, 16) == 80);

        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(0, 1, 8, 16) == 23);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(1, 1, 8, 16) == 24);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(63, 1, 8, 16) == 86);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(0, 8, 8, 16) == 16);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(1, 8, 8, 16) == 24);
        REPORTER_ASSERT(r, GrBagOfBytes::CalculateMinimumSizeWithOverhead(63, 8, 8, 16) == 80);
    }
