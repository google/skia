...
public:
    ...
    sk_sp<SkSurface> makeNonTextureable(GrContext* context, GrBackendTexture* backend) const {
        ...
        *backend = gpu->createTestingOnlyBackendTexture(nullptr,
            fWidth, fHeight,
            kRGBA_8888_GrPixelConfig, true, GrMipMapped::kNo);
        ...
        sk_sp<SkSurface> surface = SkSurface::MakeFromBackendTextureAsRenderTarget(
                context, *backend, fOrigin, fSampleCount, kRGBA_8888_SkColorType,
                nullptr, nullptr);
