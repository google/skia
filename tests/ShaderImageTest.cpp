...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(StorageImageLoad, reporter, ctxInfo) {
    ...
    private:
        TestFP(sk_sp<GrTexture> texture) : fStorageImageAccess(std::move(texture), kRead_GrIOType) {
            this->initClassID<TestFP>();
            this->setWillReadFragmentPosition();
            this->addImageAccess(&fStorageImageAccess);
        }
        ...
        bool onIsEqual(const GrFragmentProcessor& that) const override {
            return this->hasSameSamplersAndImages(that);
        }
        ...
        GrGLSLFragmentProcessor* onCreateGLSLInstance() const override {
            ...
            public:
                ...
                void emitCode(EmitArgs& args) override {
                    ...
                    if (GrPixelConfigIsSint(tfp.fImageAccess.texture()->config())) {
        ...
        StorageImageAccess fStorageImageAccess;
    };
