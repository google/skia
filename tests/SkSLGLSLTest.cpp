...
DEF_TEST(SkSLNormalization, r) {
    ...
    test(r,
         ...
         *SkSL::ShaderCapsFactory::Default(),
         ...
         "    gl_Position = gl_in[0].gl_Position + vec4(-0.5, 0.0, 0.0, float(gl_InvocationID));\n"
         "    {\n"
         "        gl_Position = vec4(gl_Position.x * sk_RTAdjust.x + gl_Position.z * "
                               "sk_RTAdjust.y, gl_Position.y * sk_RTAdjust.z + gl_Position.z * "
                               "sk_RTAdjust.w, 0, gl_Position.z);\n"
         "        EmitVertex();\n"
         "    }\n"
         "    gl_Position = gl_in[0].gl_Position + vec4(0.5, 0.0, 0.0, float(gl_InvocationID));\n"
         "    {\n"
