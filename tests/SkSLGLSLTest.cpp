...
DEF_TEST(SkSLIntFolding, r) {
    test(r,
         ...
         "sk_FragColor.r = -1 == -1 ? 1 : 0;"
         "sk_FragColor.r = -1 == -2 ? 1 : 0;"
         "sk_FragColor.r = 0 != 1 ? 1 : 0;"
         "sk_FragColor.r = 0 != 0 ? 1 : 0;"
         "sk_FragColor.r = 6 > 5 ? 1 : 0;"
         "sk_FragColor.r = 6 > 6 ? 1 : 0;"
         "sk_FragColor.r = -1 < 0 ? 1 : 0;"
         "sk_FragColor.r = 1 < 0 ? 1 : 0;"
         "sk_FragColor.r = 6 >= 6 ? 1 : 0;"
         "sk_FragColor.r = 6 >= 7 ? 1 : 0;"
         "sk_FragColor.r = 6 <= 6 ? 1 : 0;"
         "sk_FragColor.r = 6 <= 5 ? 1 : 0;"
         "}",
         *SkSL::ShaderCapsFactory::Default(),
...
DEF_TEST(SkSLFloatFolding, r) {
    test(r,
         ...
         "sk_FragColor.r = 0.0 == 0.0 ? 1 : 0;"
         "sk_FragColor.r = 0.0 == 1.0 ? 1 : 0;"
         "sk_FragColor.r = 0.0 != 1.0 ? 1 : 0;"
         "sk_FragColor.r = 0.0 != 0.0 ? 1 : 0;"
         "sk_FragColor.r = 6.0 > 5.0 ? 1 : 0;"
         "sk_FragColor.r = 6.0 > 6.0 ? 1 : 0;"
         "sk_FragColor.r = 6.0 >= 6.0 ? 1 : 0;"
         "sk_FragColor.r = 6.0 >= 7.0 ? 1 : 0;"
         "sk_FragColor.r = 5.0 < 6.0 ? 1 : 0;"
         "sk_FragColor.r = 6.0 < 6.0 ? 1 : 0;"
         "sk_FragColor.r = 6.0 <= 6.0 ? 1 : 0;"
         "sk_FragColor.r = 6.0 <= 5.0 ? 1 : 0;"
         "}",
...
DEF_TEST(SkSLBoolFolding, r) {
    test(r,
         "void main() {"
         "sk_FragColor.r = 1 == 1 || 2 == 8 ? 1 : 0;"
         "sk_FragColor.r = 1 > 1 || 2 == 8 ? 1 : 0;"
         "sk_FragColor.r = 1 == 1 && 2 <= 8 ? 1 : 0;"
         "sk_FragColor.r = 1 == 2 && 2 == 8 ? 1 : 0;"
         "sk_FragColor.r = 1 == 1 ^^ 1 != 1 ? 1 : 0;"
         "sk_FragColor.r = 1 == 1 ^^ 1 == 1 ? 1 : 0;"
         "}",
         *SkSL::ShaderCapsFactory::Default(),
         "#version 400\n"
