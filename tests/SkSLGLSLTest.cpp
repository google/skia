...
void main() {
    ...
    sk_FragColor = vec4(vec3(v.z, 1.0).yyx, 1.0);
    sk_FragColor = v;
    sk_FragColor = vec4(v.xyz, 1.0);
    ...
    sk_FragColor = vec4(v.xw, 1.0).xzzy;
    sk_FragColor = vec4(v.x, 1.0, 0.0).xyzy;
    sk_FragColor = vec4(v.yzw, 1.0).wxyz;
    sk_FragColor = vec4(v.yz, 0.0, 1.0).zxyw;
    sk_FragColor = vec4(v.yw, 0.0, 1.0).zxwy;
    sk_FragColor = vec4(v.y, 1.0).yxyy;
    sk_FragColor = vec4(v.zw, 0.0).zzxy;
    sk_FragColor = vec4(v.z, 0.0, 1.0).yyxz;
    sk_FragColor = vec4(v.w, 0.0, 1.0).yzzx;
}
)__GLSL__",
         SkSL::Program::kFragment_Kind
         );
...
void main() {
    ...
    sk_FragColor = vec4(vec4(v).xw, 0.0).zzxy;
    sk_FragColor = vec4(vec4(vec4(v).xw, 0.0).yx, 1.0).zzxy;
    sk_FragColor = vec4(vec4(v).zy, 1.0).xyzz;
    sk_FragColor = vec4(v);
...
DEF_TEST(SkSLSwizzleScalar, r) {
    ...
    test(r,
         ...
         *SkSL::ShaderCapsFactory::Default(),
         ...
         "out vec4 sk_FragColor;\n"
         "void main() {\n"
         "    sk_FragColor = vec4(sqrt(4.0), 0.0, 1.0).yxyz;\n"
         "}\n");
    test(r,
         "void main() {"
         ...
         *SkSL::ShaderCapsFactory::Default(),
         ...
         "out vec4 sk_FragColor;\n"
         "void main() {\n"
         "    sk_FragColor = vec4(vec2(sqrt(4.0)), 0.0).zxzy;\n"
         "}\n");
}
