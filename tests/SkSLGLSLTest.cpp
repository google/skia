...
DEF_TEST(SkSLIntFolding2, r) {
    test(r,
         ...
         "sk_FragColor.r = 254 & 7;"
         "sk_FragColor.r = 2 ^ 7;"
         "sk_FragColor.r = one << 4;"
         "sk_FragColor.r = 128 >> 2;"
         "sk_FragColor.r = -one == -one ? one : -one;"
         "sk_FragColor.r = -one == -2 ? 2 : -2;"
         "sk_FragColor.r = zero != one ? 3 : -3;"
         "sk_FragColor.r = zero != 0 ? 4 : -4;"
         "sk_FragColor.r = 6 > 5 ? 5 : -5;"
         "sk_FragColor.r = 6 > 6 ? 6 : -6;"
         "sk_FragColor.r = -one < 0 ? 7 : -7;"
         "sk_FragColor.r = one < 0 ? 8 : -8;"
         "sk_FragColor.r = 6 >= 6 ? 9 : -9;"
         "sk_FragColor.r = 6 >= 7 ? 10 : -10;"
         "sk_FragColor.r = 6 <= 6 ? 11 : -11;"
         "sk_FragColor.r = 6 <= 5 ? 12 : -12;"
         "sk_FragColor.r = int(sqrt(1)) + zero;"
         "sk_FragColor.r = zero + int(sqrt(2));"
         "sk_FragColor.r = int(sqrt(3)) - zero;"
         "sk_FragColor.r = int(sqrt(4)) * zero;"
         "sk_FragColor.r = int(sqrt(5)) * one;"
         "sk_FragColor.r = one * int(sqrt(6));"
         "sk_FragColor.r = zero * int(sqrt(7));"
         "sk_FragColor.r = int(sqrt(8)) / one;"
         "sk_FragColor.r = zero / int(sqrt(9));"
         "int x = int(sqrt(2));"
         "x += one;"
         "x += zero;"
         "x -= one;"
...
DEF_TEST(SkSLFloatFolding2, r) {
    test(r,
         ...
         "sk_FragColor.r = 32.0 * 2.0;"
         "sk_FragColor.r = 32.0 / 2.0;"
         "sk_FragColor.r = (12 > 2.0) ? (10 * 2 / 5 + 18 - 3) : zero;"
         "sk_FragColor.r = zero == zero ? one : -one;"
         "sk_FragColor.r = zero == one ? 2 : -2;"
         "sk_FragColor.r = zero != one ? 3 : -3;"
         "sk_FragColor.r = zero != zero ? 4 : -4;"
         "sk_FragColor.r = 6.0 > 5.0 ? 5 : -5;"
         "sk_FragColor.r = 6.0 > 6.0 ? 6 : -6;"
         "sk_FragColor.r = 6.0 >= 6.0 ? 7 : -7;"
         "sk_FragColor.r = 6.0 >= 7.0 ? 8 : -8;"
         ...
         "sk_FragColor.r = 6.0 <= 6.0 ? 11 : -11;"
         "sk_FragColor.r = 6.0 <= 5.0 ? 12 : -12;"
         "sk_FragColor.r = half(sqrt(1) + zero);"
         "sk_FragColor.r = half(zero + sqrt(2));"
         "sk_FragColor.r = half(sqrt(3) - zero);"
         "sk_FragColor.r = half(sqrt(4) * zero);"
         "sk_FragColor.r = half(sqrt(5) * one);"
         "sk_FragColor.r = half(one * sqrt(6));"
         "sk_FragColor.r = half(zero * sqrt(7));"
         "sk_FragColor.r = half(sqrt(8) / one);"
         "sk_FragColor.r = half(zero / sqrt(9));"
         "sk_FragColor.r += one;"
         "sk_FragColor.r += zero;"
         "sk_FragColor.r -= one;"
         "sk_FragColor.r -= zero;"
