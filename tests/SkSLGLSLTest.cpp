...
DEF_TEST(SkSLHelloWorld, r) {
    test(r,
         ...
         *SkSLGLSLTestCapsFactory::Default(),
         "#version 400\n"
...
DEF_TEST(SkSLVersion, r) {
    test(r,
         ...
         *SkSLGLSLTestCapsFactory::Version450Core(),
         "#version 450 core\n"
         "out vec4 sk_FragColor;\n"
         "in float test;\n"
         "void main() {\n"
    ...
    test(r,
         "in float test; void main() { sk_FragColor = vec4(0.75); }",
         *SkSLGLSLTestCapsFactory::Version110(),
         "#version 110\n"
         "varying float test;\n"
         "void main() {\n"
...
DEF_TEST(SkSLUsesPrecisionModifiers, r) {
    ...
    test(r,
         "void main() { float x = 0.75; highp float y = 1; }",
         *SkSLGLSLTestCapsFactory::UsesPrecisionModifiers(),
         "#version 400\n"
...
DEF_TEST(SkSLMinAbs, r) {
    ...
    test(r,
         ...
         "x = min(abs(x), 6.0);"
         "}",
         *SkSLGLSLTestCapsFactory::CannotUseMinAndAbsTogether(),
         "#version 400\n"
         "out vec4 sk_FragColor;\n"
         "void main() {\n"
...
DEF_TEST(SkSLNegatedAtan, r) {
    ...
    test(r,
         "void main() { vec2 x = vec2(1, 2); float y = atan(x.x, -(2 * x.y)); }",
         *SkSLGLSLTestCapsFactory::MustForceNegatedAtanParamToFloat(),
         "#version 400\n"
         "out vec4 sk_FragColor;\n"
         "void main() {\n"
         "    vec2 x = vec2(1.0, 2.0);\n"
...
DEF_TEST(SkSLDerivatives, r) {
    ...
    test(r,
         "void main() { float x = 1; }",
         *SkSLGLSLTestCapsFactory::ShaderDerivativeExtensionString(),
         "#version 400\n"
         "out vec4 sk_FragColor;\n"
         "void main() {\n"
         "    float x = 1.0;\n"
