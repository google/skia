...
#define DEF_GPUTEST_FOR_ALL_CONTEXTS_WITH_FILTER(name, reporter, context_info, options_filter) \
        DEF_GPUTEST_FOR_CONTEXTS(name, nullptr, reporter, context_info, options_filter)
