...
DEF_TEST(ICC_ToXYZD50, r) {
    ...
    sk_sp<SkICC> z30 = SkICC::MakeRGB(data->data(), data->size());
    ...
    sk_sp<SkICC> upperRight = SkICC::MakeRGB(data->data(), data->size());
