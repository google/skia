...
DEF_TEST(ICC_WriteICC, r) {
    ...
    char adobeTag[kSkICCDescriptionTagSize] = {};
    SkICCGetColorProfileTag(adobeTag, adobeFn, adobeMatrix);
    char srgbTag[kSkICCDescriptionTagSize] = {};
    SkICCGetColorProfileTag(srgbTag, srgbFn, srgbMatrix);
    REPORTER_ASSERT(r,  0 != memcmp(adobeTag, srgbTag, kSkICCDescriptionTagSize));
}
