...
DEF_TEST(WriteICCProfile, r) {
    ...
    struct {
        ...
        { g2Dot2_TransferFn, gAdobeRGB_toXYZD50, SkColorSpace::MakeRGB(g2Dot2_TransferFn, SkColorSpace::kAdobeRGB_Gamut) },
        { g2Dot2_TransferFn, gAdobeRGB_toXYZD50, SkColorSpace::MakeRGB(k2Dot2Curve_SkGammaNamed, adobe44) },
