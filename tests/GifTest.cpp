...
DEF_TEST(Codec_GifTruncated2, r) {
    ...
    for (int i = 21; i < 24; i++) {
        ...
        //
        // At 21 bytes, this test (without SK_HAS_WUFFS_GIF_LIBRARY) is overly
        // specific to the old implementation. In the new implementation, the
        // MakeFromStream factory method returns a nullptr SkCodec*, instead of
        // returning a non-null but otherwise unusable SkCodec*.
        //
        // The new implementation returns a nullptr SkCodec* because creating a
        ...
        // rejected as an invalid GIF image - but the two implementations
        // differ in how that's represented.
        //
