...
static void test_dsl_fp(skiatest::Reporter* r,
                        ...
                        Uniforms&&... uniforms) {
    if (!worksInES2) {
        // We don't use derivatives directly, but the caps bit for derivatives is a pretty good
        // proxy for our purposes; any GPU that supports derivatives will be ES3+ compatible.
