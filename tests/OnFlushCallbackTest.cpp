...
public:
    ...
    sk_sp<GrTextureProxy> getAtlasProxy(GrProxyProvider* proxyProvider) {
        ...
        fAtlasProxy = proxyProvider->createFullyLazyProxy(
                    [this](GrResourceProvider* resourceProvider, GrSurfaceOrigin* outOrigin) {
                        ...
                        *outOrigin = kBottomLeft_GrSurfaceOrigin;
                        ...
                        return resourceProvider->createTexture(
                                    desc, SkBudgeted::kYes, GrResourceProvider::kNoPendingIO_Flag);
                    },
                    GrProxyProvider::Renderable::kYes, kSkia8888_GrPixelConfig);
        return fAtlasProxy;
    }
    ...
    void preFlush(GrOnFlushResourceProvider* resourceProvider,
        ...
        sk_sp<GrRenderTargetContext> rtc = resourceProvider->makeRenderTargetContext2(
                                                                           fAtlasProxy,
                                                                           nullptr, nullptr);
