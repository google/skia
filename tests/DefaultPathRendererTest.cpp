...
//
// When the bug manifests the GrDefaultPathRenderer is/was leaving the stencil buffer outside
// of the first content rect in a bad state and the second draw would be incorrect.
DEF_GPUTEST_FOR_CONTEXTS(GrDefaultPathRendererTest,
                         sk_gpu_test::GrContextFactory::IsRenderingContext,
                         reporter, ctxInfo, modify_context_options) {
...

    {
        ...
        rtc->drawPath(GrNoClip::GrNoClip(), std::move(paint), GrAA::kNo,
