...
// Test that we correct copy or don't copy GrBackendTextures in the GrBackendTextureImageGenerator
// based on the requested mip support and mip status of the GrBackendTexture
