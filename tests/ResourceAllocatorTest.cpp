...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(ResourceAllocatorMemoryBudgetTest, reporter, ctxInfo) {
    ...
    const ProxyParams kProxy64Budgeted = {64, kRT, kRGBA, kE, 1, kB};
    const ProxyParams kProxy64NotBudgeted = {64, kRT, kRGBA, kE, 1, kNotB};
    ...
    TestCase tests[] = {
        {"empty DAG", true, 0, {}, {}, {}},
        {"unbudgeted", true, 0, {}, {}, {{kProxy64NotBudgeted, 0, 2}}},
        {"basic", true, kRGBA64Bytes, {}, {}, {{kProxy64Budgeted, 0, 2}}},
        {"basic, no fit", false, kRGBA64Bytes - 1, {}, {}, {{kProxy64Budgeted, 0, 2}}},
        {"shared", true, kRGBA64Bytes, {}, {},
            {
                {kProxy64Budgeted, 0, 2},
                {kProxy64Budgeted, 3, 5},
            }},
