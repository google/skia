...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(ResourceAllocatorTest, reporter, ctxInfo) {
    ...
    int k2 = context->priv().caps()->getRenderTargetSampleCount(2, beFormat);
    int k4 = context->priv().caps()->getRenderTargetSampleCount(4, beFormat);
...

    {
        ...
        GrBackendTexture backEndTex;
        sk_sp<GrSurfaceProxy> p1 = make_backend(context, t[0].fP1, &backEndTex);
