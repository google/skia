...
DEF_GPUTEST_FOR_RENDERING_CONTEXTS(ReimportImageTextureWithMipLevels, reporter, ctxInfo) {
    ...
    static const auto kCreateWithMipMaps = true;
    ...
    uint32_t pixel;
    surf->readPixels(SkImageInfo::Make(1, 1, kRGBA_8888_SkColorType, kPremul_SkAlphaType, nullptr),
                     &pixel, sizeof(uint32_t), 0, 0);
