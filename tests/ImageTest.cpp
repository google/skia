...
DEF_TEST(Image_makeColorSpace, r) {
    ...
    *srgbBitmap.getAddr32(0, 0) = SkSwizzle_RGBA_to_PMColor(0xFF604020);
    ...
    sk_sp<SkImage> p3Image = srgbImage->makeColorSpace(p3, SkBlendBehavior::kNonlinear);
    SkBitmap p3Bitmap;
    ...
    sk_sp<SkImage> adobeImage = srgbImage->makeColorSpace(adobeGamut, SkBlendBehavior::kNonlinear);
    ...
    p3Image = srgbImage->makeColorSpace(p3, SkBlendBehavior::kNonlinear);
