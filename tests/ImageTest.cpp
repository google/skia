...
DEF_TEST(Image_makeColorSpace, r) {
    ...
    SkColorSpaceTransferFn fn;
    fn.fA = 1.f; fn.fB = 0.f; fn.fC = 0.f; fn.fD = 0.f; fn.fE = 0.f; fn.fF = 0.f; fn.fG = 2.2f;
    sk_sp<SkColorSpace> adobe = SkColorSpace::MakeRGB(fn, SkColorSpace::kAdobeRGB_Gamut);
    ...
    *srgbBitmap.getAddr32(0, 0) = SkSwizzle_RGBA_to_PMColor(0xFF604020);
    ...
    srgbImage = GetResourceAsImage("1x1.png");
    sk_sp<SkImage> adobeImage = as_IB(srgbImage)->makeColorSpace(adobe);
    SkBitmap adobeBitmap;
    success = adobeImage->asLegacyBitmap(&adobeBitmap, SkImage::kRO_LegacyBitmapMode);
    REPORTER_ASSERT(r, success);
    adobeBitmap.lockPixels();
    REPORTER_ASSERT(r, almost_equal(0x89, SkGetPackedR32(*adobeBitmap.getAddr32(0, 0))));
    REPORTER_ASSERT(r, almost_equal(0x82, SkGetPackedG32(*adobeBitmap.getAddr32(0, 0))));
    REPORTER_ASSERT(r, almost_equal(0x77, SkGetPackedB32(*adobeBitmap.getAddr32(0, 0))));
}
