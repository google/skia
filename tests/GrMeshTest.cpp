...
public:
    ...
    void drawMesh1(const GrMesh& mesh, GrPrimitiveType);
    ...
    run_test(context, "setNonIndexedNonInstanced", reporter, rtc, gold,
             ...
             [&](DrawMeshHelper* helper) {
                 for (int y = 0; y < kBoxCountY; ++y) {
                     ...
                     helper->drawMesh1(mesh, GrPrimitiveType::kTriangles);
                 }
             });
        ...
        run_test(context, indexed ? "setIndexedInstanced" : "setInstanced",
                 ...
                 [&](DrawMeshHelper* helper) {
                     ...
                     for (int y = 0; y < kBoxCountY; ++y) {
                         ...
                         helper->drawMesh1(mesh, primitiveType);
                     }
                 });
    }
}
...
void DrawMeshHelper::drawMesh1(const GrMesh& mesh, GrPrimitiveType primitiveType) {
