...
static constexpr auto cubicConicTests = std::to_array<cubicConic>({
#if 0
...
// More work to be done to figure this out.
        cubicConic{{{{2.1883804947719909e-05, 3.6366123822517693e-05},
                   ...
                   {{{{0.00000000000000000, 5.8282581449020654e-05},
                      ...
                      {5.8282588724978268e-05, 0.00000000000000000}}},
                    53684.6563f}},
#endif

        cubicConic{{{{188.60000610351562, 2041.5999755859375},
        ...
        cubicConic{{{{231.80000305175781, 2084.800048828125},
