...
void cowboyCB(GrDiscipline* d, const SkTDArray<GrOpList*>& opLists) {
//    sk_sp<GrRenderTargetContext> rtc = d->newRTC();
}

DEF_GPUTEST_FOR_ALL_CONTEXTS(YeehawTest, reporter, ctxInfo) {
    GrContext* context = ctxInfo.grContext();

    context->contextPriv().jamOnIn(cowboyCB);
