...
DEF_GPUTEST_FOR_ALL_CONTEXTS(TessellatingPathRendererTests, reporter, ctxInfo) {
    ...
    ctx->flush();
    test_path(ctx, rp, rtc.get(), create_path_0());
    test_path(ctx, rp, rtc.get(), create_path_1());
    test_path(ctx, rp, rtc.get(), create_path_2());
    test_path(ctx, rp, rtc.get(), create_path_3());
    test_path(ctx, rp, rtc.get(), create_path_4());
    test_path(ctx, rp, rtc.get(), create_path_5());
    test_path(ctx, rp, rtc.get(), create_path_6());
    test_path(ctx, rp, rtc.get(), create_path_7());
    test_path(ctx, rp, rtc.get(), create_path_8());
    test_path(ctx, rp, rtc.get(), create_path_9());
    test_path(ctx, rp, rtc.get(), create_path_10());
    test_path(ctx, rp, rtc.get(), create_path_11());
    test_path(ctx, rp, rtc.get(), create_path_12());
    test_path(ctx, rp, rtc.get(), create_path_13());
    test_path(ctx, rp, rtc.get(), create_path_14());
    test_path(ctx, rp, rtc.get(), create_path_15());
    test_path(ctx, rp, rtc.get(), create_path_16());
    SkMatrix nonInvertibleMatrix = SkMatrix::MakeScale(0, 0);
    sk_sp<GrFragmentProcessor> fp(create_linear_gradient_processor(ctx));
    test_path(ctx, rp, rtc.get(), create_path_17(), nonInvertibleMatrix, GrAAType::kCoverage, fp);
}
#endif
