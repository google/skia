...
bool GrDrawingManager::ProgramUnitTest(GrContext* context, int maxStages, int maxLevels) {
    ...
    // setup dummy textures
    {
        ...
        proxies[0] = proxyProvider->createProxy(dummyDesc, SkBackingFit::kExact, SkBudgeted::kNo, 0);
    }
    {
        GrSurfaceDesc dummyDesc;
        ...
        proxies[1] = proxyProvider->createProxy(dummyDesc, SkBackingFit::kExact, SkBudgeted::kNo, 0);
    }
