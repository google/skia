...
bool GrDrawingManager::ProgramUnitTest(GrContext* context, int maxStages) {
    ...
    proxies[0] = context->resourceProvider()->createTextureProxy(dummyDesc, SkBudgeted::kNo,
                                                                 nullptr, 0);
    dummyDesc.fFlags = kNone_GrSurfaceFlags;
    dummyDesc.fConfig = kAlpha_8_GrPixelConfig;
    dummyDesc.fWidth = 16;
    dummyDesc.fHeight = 22;
    proxies[1] = context->resourceProvider()->createTextureProxy(dummyDesc, SkBudgeted::kNo,
                                                                 nullptr, 0);
