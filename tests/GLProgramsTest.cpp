...
static sk_sp<GrRenderTargetContext> random_draw_context(GrContext* context,
                                                        SkRandom* random,
                                                        const GrCaps* caps) {
...
bool GrDrawingManager::ProgramUnitTest(GrContext* context, int maxStages) {
    ...
    for (int t = 0; t < NUM_TESTS; t++) {
        ...
        sk_sp<GrRenderTargetContext> renderTargetContext(random_draw_context(context, &random,
                                                                             context->caps()));
