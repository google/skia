...
DEF_TEST(SkRemoteGlyphCache_SearchOfDesperation, reporter) {
    ...
    // Build a fallback cache.
    {
        ...
        SkGlyph prototype{lostGlyphID, 0.f, 0.f, 0, 0, 2, 1, SkMask::kA8_Format, (void*)glyphImage};
...
DEF_TEST(SkRemoteGlyphCache_ReWriteGlyph, reporter) {
    ...
    // Build a fallback cache.
    {
        ...
        SkGlyph prototypeGlyph{
            lostGlyphID, 0.f, 0.f, 0, 0, 2, 1, (SkMask::Format)fakeMask, (void*)glyphImage};
