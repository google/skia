...
DEF_TEST(Path_isRect, reporter) {
    ...
    REPORTER_ASSERT(reporter, rect == compare);
    // isolated from skbug.com/7792#11
    ...
    REPORTER_ASSERT(reporter, rect == compare);
    // isolated from skbug.com/7792#14
    ...
    REPORTER_ASSERT(reporter, !path.isRect(&rect, nullptr, nullptr));
    // isolated from skbug.com/7792#15
    ...
    REPORTER_ASSERT(reporter, !path.isRect(&rect, nullptr, nullptr));
    // isolated from skbug.com/7792#23
