...
static void write_and_read_back(skiatest::Reporter* reporter,
...

    {
        ...
        bool result = reader.readPath(&readBack);
...
static void test_corrupt_flattening(skiatest::Reporter* reporter) {
...

    {
        ...
        REPORTER_ASSERT(reporter, reader.readPath(&path));
    }
...
static void test_flattening(skiatest::Reporter* reporter) {
...

    {
        ...
        bool result = reader.readPath(&p2);
        REPORTER_ASSERT(reporter, result);
...

    {
        ...
        bool result = reader.readPath(&p3);
        REPORTER_ASSERT(reporter, !result);
    }

    {
        ...
        bool result = reader.readPath(&tooShort);
        REPORTER_ASSERT(reporter, !result);
    }
