...
DEF_TEST(SkColor_SkColorConstARGB, reporter) {
    ...
    constexpr SkColor kFromConstA = SkColorConstARGB(test_half(), test_half(), test_half(), test_half());
    ...
    REPORTER_ASSERT(reporter, kFromConstA == SkColorSetARGB(test_half(), test_half(), test_half(), test_half()));
    ...
    // SkColor kError4 = SkColorConstARGB(test_double(), test_double(), test_double(), test_double());
