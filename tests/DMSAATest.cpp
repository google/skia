...
DEF_GPUTEST_FOR_CONTEXTS(DMSAA_dst_read, &sk_gpu_test::GrContextFactory::IsRenderingContext,
    ...
    draw_paint_with_dmsaa(sdc.get(), kTransYellow, SkBlendMode::kOverlay);
    dstColor = SkBlendMode_Apply(SkBlendMode::kOverlay, kTransYellow, dstColor);

    draw_paint_with_dmsaa(sdc.get(), kTransCyan, SkBlendMode::kOverlay);
    dstColor = SkBlendMode_Apply(SkBlendMode::kOverlay, kTransCyan, dstColor);
...
DEF_GPUTEST_FOR_CONTEXTS(DMSAA_aa_dst_read_after_dmsaa,
    ...
    draw_paint_with_aa(sdc.get(), kTransCyan, SkBlendMode::kOverlay);
    dstColor = SkBlendMode_Apply(SkBlendMode::kOverlay, kTransCyan, dstColor);
...
DEF_GPUTEST_FOR_CONTEXTS(DMSAA_dst_read_with_existing_barrier,
    ...
    // barrier.
    draw_paint_with_aa(sdc.get(), kTransYellow, SkBlendMode::kOverlay);
    dstColor = SkBlendMode_Apply(SkBlendMode::kOverlay, kTransYellow, dstColor);
