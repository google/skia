...
//            if (f == (float) (int) f) {
//                return compiler->context().fInt_Type.typeNode();
//            }
//            return compiler->context().fFloat_Type.typeNode();
//        }
//        case skjson::Value::Type::kBool:
//            return compiler->context().fBool_Type.typeNode();
//        default:
//            return compiler->context().fVoid_Type.typeNode();
//    }
//}
//
