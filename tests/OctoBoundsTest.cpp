...
static void test_octagon(Reporter* reporter, SkRandom* rand, float l, float t, float r, float b) {
    for (int i = 0; i < 20; ++i) {
        ...
        std::function<void()> growOutDiagonals[4] = {
            [&]() {  // Push diagonal corner outside left edge.
            ...
            [&]() {  // Push diagonal corner outside top edge.
            ...
            [&]() {  // Push diagonal corner outside right edge.
            ...
            [&]() {  // Push diagonal corner outside bottom edge.
