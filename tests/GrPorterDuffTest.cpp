...
static void test_color_unknown_with_coverage(skiatest::Reporter* reporter, const GrCaps& caps) {
    GrProcessorSet::FragmentProcessorAnalysis analysis(GrPipelineAnalysisColor(), GrPipelineAnalysisCoverage::kSingleChannel, caps);
...
DEF_GPUTEST(PorterDuffNoDualSourceBlending, reporter, /*factory*/) {
    ...
    static const GrPipelineAnalysisColor colorInputs[] = {GrPipelineAnalysisColor::Opaque::kNo,
                                                          GrPipelineAnalysisColor::Opaque::kYes,
    ...
    for (const auto& colorInput : colorInputs) {
        GrProcessorSet::FragmentProcessorAnalysis analysis;
        for (GrPipelineAnalysisCoverage coverageType : {GrPipelineAnalysisCoverage::kSingleChannel,
                                                        GrPipelineAnalysisCoverage::kNone}) {
