...
static void test_lcd_coverage(skiatest::Reporter* reporter, const GrCaps& caps) {
    ...
    analysis.reset(GrPipelineInput(), lcdInput);
...
static void test_color_unknown_with_coverage(skiatest::Reporter* reporter, const GrCaps& caps) {
    GrProcessorSet::FragmentProcessorAnalysis analysis;
    analysis.reset(GrPipelineInput(), GrPipelineInput());
...
static void test_color_unknown_no_coverage(skiatest::Reporter* reporter, const GrCaps& caps) {
    GrProcessorSet::FragmentProcessorAnalysis analysis;
    analysis.reset(GrColorPackRGBA(229, 0, 154, 240), GrColorPackA4(255));
...
static void test_color_opaque_with_coverage(skiatest::Reporter* reporter, const GrCaps& caps) {
    GrProcessorSet::FragmentProcessorAnalysis analysis;
    analysis.reset(GrPipelineInput::Opaque::kYes, GrPipelineInput());
...
static void test_color_opaque_no_coverage(skiatest::Reporter* reporter, const GrCaps& caps) {
    GrProcessorSet::FragmentProcessorAnalysis analysis;
    analysis.reset(GrPipelineInput::Opaque::kYes, GrColorPackA4(255));
...
static void test_lcd_coverage_fallback_case(skiatest::Reporter* reporter, const GrCaps& caps) {
    ...
    testLCDCoverageOp.analyzeProcessors(&analysis, GrProcessorSet(GrPaint()), clip);
