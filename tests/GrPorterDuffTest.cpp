...
public:
    struct XPInfo {
        XPInfo(skiatest::Reporter* reporter, SkBlendMode xfermode, const GrCaps& caps,
            ...
            fHasConstantPreCoverageBlendedColor =
                    GrXPFactory::IsPreCoverageBlendedColorConstant(xpf, analysis.fColorPOI, &fPreCoverageBlendedColor);
    ...
    for (int m = 0; m <= (int)SkBlendMode::kLastCoeffMode; m++) {
        ...
        switch (xfermode) {
            case SkBlendMode::kClear:
                ...
                TEST_ASSERT(GrColor_TRANSPARENT_BLACK == xpi.fHasConstantPreCoverageBlendedColor);
