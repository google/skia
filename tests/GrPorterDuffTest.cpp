...
static void test_color_not_opaque_no_coverage(skiatest::Reporter* reporter, const GrCaps& caps) {
    GrProcessorAnalysisColor inputColor(GrColor4h::FromBytes_RGBA(GrColorPackRGBA(229, 0, 154, 240)));
...
static void test_lcd_coverage_fallback_case(skiatest::Reporter* reporter, const GrCaps& caps) {
    ...
    GrProcessorAnalysisColor color = GrColor4h::FromBytes_RGBA(GrColorPackRGBA(123, 45, 67, 255));
    ...
    color = GrColor4h::FromBytes_RGBA(GrColorPackRGBA(123, 45, 67, 221));
...
DEF_GPUTEST(PorterDuffNoDualSourceBlending, reporter, options) {
    ...
    static const GrProcessorAnalysisColor colorInputs[] = {
            ...
            GrProcessorAnalysisColor(GrColor4h::FromBytes_RGBA(GrColorPackRGBA(0, 82, 17, 100))),
            GrProcessorAnalysisColor(GrColor4h::FromBytes_RGBA(GrColorPackRGBA(0, 82, 17, 255)))};
