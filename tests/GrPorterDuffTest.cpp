...
static void test_lcd_coverage(skiatest::Reporter* reporter, const GrCaps& caps) {
    ...
    SkASSERT(!analysis.fColorPOI.knownColorComponents().isOpaque());
    SkASSERT(!analysis.fColorPOI.knownColorComponents().isSolidWhite());
    SkASSERT(!analysis.fCoveragePOI.knownColorComponents().isSolidWhite());
    ...
    for (int m = 0; m <= (int)SkBlendMode::kLastCoeffMode; m++) {
        ...
        switch (xfermode) {
            case SkBlendMode::kClear:
                ...
                TEST_ASSERT(0 == xpi.fBlendedColor.fKnownColorComponents.color());
                TEST_ASSERT(kRGBA_GrColorComponentFlags == xpi.fBlendedColor.fKnownColorComponents.knownComponentFlags());
            ...
            case SkBlendMode::kSrc:
                TEST_ASSERT(!xpi.fBlendedColor.fWillBlendWithDst);
                TEST_ASSERT(kNone_GrColorComponentFlags == xpi.fBlendedColor.fKnownColorComponents.knownComponentFlags());
...
static void test_color_unknown_no_coverage(skiatest::Reporter* reporter, const GrCaps& caps) {
    ...
    for (int m = 0; m <= (int)SkBlendMode::kLastCoeffMode; m++) {
        ...
        switch (xfermode) {
            ...
            case SkBlendMode::kSrc:
                TEST_ASSERT(!xpi.fBlendedColor.fWillBlendWithDst);
                TEST_ASSERT(229 == GrColorUnpackR(xpi.fBlendedColor.fKnownColorComponents.color()));
                TEST_ASSERT(154 == GrColorUnpackB(xpi.fBlendedColor.fKnownColorComponents.color()));
                TEST_ASSERT((kR_GrColorComponentFlag |
                             kB_GrColorComponentFlag) == xpi.fBlendedColor.fKnownColorComponents.knownComponentFlags());
                TEST_ASSERT(kNone_OptFlags == xpi.fOptFlags);
                TEST_ASSERT(kModulate_OutputType == xpi.fPrimaryOutputType);
                TEST_ASSERT(kNone_OutputType == xpi.fSecondaryOutputType);
                TEST_ASSERT(kAdd_GrBlendEquation == xpi.fBlendInfo.fEquation);
...
static void test_color_opaque_with_coverage(skiatest::Reporter* reporter, const GrCaps& caps) {
    ...
    for (int m = 0; m <= (int)SkBlendMode::kLastCoeffMode; m++) {
        ...
        switch (xfermode) {
            ...
            case SkBlendMode::kSrc:
                TEST_ASSERT(!xpi.fBlendedColor.fWillBlendWithDst);
                TEST_ASSERT(255 == GrColorUnpackA(xpi.fBlendedColor.fKnownColorComponents.color()));
                TEST_ASSERT(kA_GrColorComponentFlag == xpi.fBlendedColor.fKnownColorComponents.knownComponentFlags());
                TEST_ASSERT((kCanTweakAlphaForCoverage_OptFlag) == xpi.fOptFlags);
                TEST_ASSERT(kModulate_OutputType == xpi.fPrimaryOutputType);
                TEST_ASSERT(kNone_OutputType == xpi.fSecondaryOutputType);
                TEST_ASSERT(kAdd_GrBlendEquation == xpi.fBlendInfo.fEquation);
...
static void test_color_opaque_no_coverage(skiatest::Reporter* reporter, const GrCaps& caps) {
    ...
    for (int m = 0; m <= (int)SkBlendMode::kLastCoeffMode; m++) {
        ...
        switch (xfermode) {
            ...
            case SkBlendMode::kSrc:
                TEST_ASSERT(!xpi.fBlendedColor.fWillBlendWithDst);
                TEST_ASSERT(82 == GrColorUnpackG(xpi.fBlendedColor.fKnownColorComponents.color()));
                TEST_ASSERT(255 == GrColorUnpackA(xpi.fBlendedColor.fKnownColorComponents.color()));
                TEST_ASSERT((kG_GrColorComponentFlag |
                             kA_GrColorComponentFlag) == xpi.fBlendedColor.fKnownColorComponents.knownComponentFlags());
                TEST_ASSERT(kNone_OptFlags == xpi.fOptFlags);
                TEST_ASSERT(kModulate_OutputType == xpi.fPrimaryOutputType);
                TEST_ASSERT(kNone_OutputType == xpi.fSecondaryOutputType);
                TEST_ASSERT(kAdd_GrBlendEquation == xpi.fBlendInfo.fEquation);
...
static void test_lcd_coverage_fallback_case(skiatest::Reporter* reporter, const GrCaps& caps) {
    ...
    SkASSERT(kRGBA_GrColorComponentFlags == colorPOI.knownColorComponents().knownComponentFlags());
    ...
    TEST_ASSERT(kNone_GrColorComponentFlags == blendedColor.fKnownColorComponents.knownComponentFlags());
