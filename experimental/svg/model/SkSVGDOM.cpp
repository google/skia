...
bool SetTextAttribute(const sk_sp<SkSVGNode>& node, SkSVGAttribute attr,
                           const char* stringValue) {
...
SortedDictionaryEntry<AttrParseInfo> gAttributeParseInfo[] = {
    ...
    { "font-family"      , { SkSVGAttribute::kFontFamily       , SetTextAttribute         }},
    ...
    { "text"             , { SkSVGAttribute::kText             , SetTextAttribute         }},
    { "text-anchor"      , { SkSVGAttribute::kTextAnchor       , SetTextAttribute         }},
