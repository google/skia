...
public:
    ...
    sk_sp<SkSVGNode>* findNodeById(SkString id);

    // Sets an attribute of the node with the given id to a new value.
    int setNodeAttribute(const char* nodeId, const char* attributeName, const char* attributeValue);
