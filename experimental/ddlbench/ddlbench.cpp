...
static int test1(std::vector<const Cmd*>* test, std::vector<int>* expectedOrder) {
    ...
    test->push_back(new RectCmd(1, 1, r.makeOffset(48, 48), SK_ColorGREEN, SK_ColorBLACK));
    return 1;
}
...
static int test2(std::vector<const Cmd*>* test, std::vector<int>* expectedOrder) {
    ...
    test->push_back(new RectCmd(0, 1, r.makeOffset(8, 8),   SK_ColorRED,   SK_ColorBLACK));
    test->push_back(new RectCmd(1, 1, r.makeOffset(48, 48), SK_ColorGREEN, SK_ColorBLACK));
    test->push_back(new RectCmd(2, 1, r.makeOffset(98, 98), SK_ColorBLUE,  SK_ColorBLACK));
    return 2;
}
...
static int test3(std::vector<const Cmd*>* test, std::vector<int>* expectedOrder) {
    ...
    SkIRect r{0, 0, 100, 100};
    test->push_back(new RectCmd(0, 1, r.makeOffset(8, 8),   SK_ColorRED,  SK_ColorBLACK));
    test->push_back(new RectCmd(1, 1, r.makeOffset(48, 48), 0x8000FF00,   SK_ColorBLACK));
    test->push_back(new RectCmd(2, 1, r.makeOffset(98, 98), SK_ColorBLUE, SK_ColorBLACK));
    return 3;
}
...
static int test4(std::vector<const Cmd*>* test, std::vector<int>* expectedOrder) {
    ...
    SkIRect r{0, 0, 100, 100};
    test->push_back(new RectCmd(0, 1, r.makeOffset(8, 8),   0x80FF0000, SK_ColorBLACK));
    test->push_back(new RectCmd(1, 1, r.makeOffset(48, 48), 0x8000FF00, SK_ColorBLACK));
    test->push_back(new RectCmd(2, 1, r.makeOffset(98, 98), 0x800000FF, SK_ColorBLACK));
    return 4;
}
