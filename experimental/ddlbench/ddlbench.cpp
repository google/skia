...
static void sort_test1() {
    ...
    test.push_back(new RectCmd(0, SkRect::MakeXYWH(10, 10 , 100, 100), SK_ColorRED));
    test.push_back(new RectCmd(1, SkRect::MakeXYWH(50, 50 , 100, 100), SK_ColorGREEN));
    ...
    save_files(1, expectedBM, actualBM);
}
