...
${EMCXX} \
    ...
    --bind \
    $BASE_DIR/NotoMono-Regular.ttf.cpp \
...
# TODO(nifong): remove and use a pattern similar to canvaskit
cp index.html $BUILD_DIR
cp ../canvaskit/serve.py $BUILD_DIR

# TODO(nifong): write unit tests

# TODO(nifong): Don't include the generated cpp default font like this, use canvaskit's method.
