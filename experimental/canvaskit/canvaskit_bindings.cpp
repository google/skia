...
EMSCRIPTEN_BINDINGS(Skia) {
    ...
    class_<SkCanvas>("SkCanvas")
        ...
        .function("drawShadow", optional_override([](SkCanvas& self, const SkPath& path, const SkPoint3& zPlaneParams,
                                                     const SkPoint3& lightPos, SkScalar lightRadius,
                                                     JSColor ambientColor, JSColor spotColor, uint32_t flags) {
