...
EMSCRIPTEN_BINDINGS(Skia) {
    ...
    class_<SkCanvas>("SkCanvas")
        ...
        .function("drawImage", select_overload<void (const sk_sp<SkImage>& image, SkScalar left, SkScalar top, const SkPaint* paint)>(&SkCanvas::drawImage), allow_raw_pointers())
