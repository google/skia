...
SkottieKit._extraInitializations.push(function() {
  ...
  SkottieKit.GetWebGLContext = function(canvas, attrs) {
  ...
  SkottieKit.MakeWebGLCanvasSurface = function(arg, width, height) {
    var canvas = arg;
    ...
    if (!surface) {
      ...
      return SkottieKit.MakeSWCanvasSurface(newCanvas);
    }
  ...
  SkottieKit.MakeCanvasSurface = SkottieKit.MakeWebGLCanvasSurface;
});