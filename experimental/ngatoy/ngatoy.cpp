...
static int test1(std::vector<std::unique_ptr<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    test->push_back(std::make_unique<RectCmd>(ID(0), {}, r.makeOffset(8, 8),   FakePaint(SK_ColorRED),   nullptr));
    test->push_back(std::make_unique<RectCmd>(ID(1), {}, r.makeOffset(48, 48), FakePaint(SK_ColorGREEN), nullptr));
...
static int test2(std::vector<std::unique_ptr<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    test->push_back(std::make_unique<RectCmd>(ID(0), {}, r.makeOffset(8, 8),   FakePaint(SK_ColorRED),   nullptr));
    test->push_back(std::make_unique<RectCmd>(ID(1), {}, r.makeOffset(48, 48), FakePaint(SK_ColorGREEN), nullptr));
    test->push_back(std::make_unique<RectCmd>(ID(2), {}, r.makeOffset(98, 98), FakePaint(SK_ColorBLUE),  nullptr));
...
static int test3(std::vector<std::unique_ptr<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    SkIRect r{0, 0, 100, 100};
    test->push_back(std::make_unique<RectCmd>(ID(0), {}, r.makeOffset(8, 8),   FakePaint(SK_ColorRED),  nullptr));
    test->push_back(std::make_unique<RectCmd>(ID(1), {}, r.makeOffset(48, 48), FakePaint(0x8000FF00),   nullptr));
    test->push_back(std::make_unique<RectCmd>(ID(2), {}, r.makeOffset(98, 98), FakePaint(SK_ColorBLUE), nullptr));
...
static int test4(std::vector<std::unique_ptr<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    SkIRect r{0, 0, 100, 100};
    test->push_back(std::make_unique<RectCmd>(ID(0), {}, r.makeOffset(8, 8),   FakePaint(0x80FF0000), nullptr));
    test->push_back(std::make_unique<RectCmd>(ID(1), {}, r.makeOffset(48, 48), FakePaint(0x8000FF00), nullptr));
    test->push_back(std::make_unique<RectCmd>(ID(2), {}, r.makeOffset(98, 98), FakePaint(0x800000FF), nullptr));
...
static int test5(std::vector<std::unique_ptr<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    test->push_back(std::make_unique<RectCmd>(ID(1), {}, r.makeOffset(48, 48),   p,                       nullptr));
    p.setRadial(SK_ColorBLUE,    SK_ColorBLACK);
    test->push_back(std::make_unique<RectCmd>(ID(2), {}, r.makeOffset(98, 98),   p,                       nullptr));
    test->push_back(std::make_unique<RectCmd>(ID(3), {}, r.makeOffset(148, 148), FakePaint(SK_ColorCYAN), nullptr));
    p.setLinear(SK_ColorMAGENTA, SK_ColorWHITE);
    test->push_back(std::make_unique<RectCmd>(ID(4), {}, r.makeOffset(148, 8),   p,                       nullptr));
    p.setRadial(SK_ColorYELLOW,  SK_ColorBLACK);
    test->push_back(std::make_unique<RectCmd>(ID(5), {}, r.makeOffset(8, 148),   p,                       nullptr));
...
static int test6(std::vector<std::unique_ptr<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    test->push_back(std::make_unique<ClipCmd>(ID(0), {}, SkIRect::MakeXYWH(28, 28, 40, 40)));

    SkIRect r{0, 0, 100, 100};
    test->push_back(std::make_unique<RectCmd>(ID(1), {}, r.makeOffset(8, 8),   FakePaint(SK_ColorRED),   nullptr));
    test->push_back(std::make_unique<RectCmd>(ID(2), {}, r.makeOffset(48, 48), FakePaint(SK_ColorGREEN), nullptr));
...
static int test7(std::vector<std::unique_ptr<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    test->push_back(std::make_unique<ClipCmd>(ID(0), {}, SkIRect::MakeXYWH(85, 0, 86, 256)));
    ...
    test->push_back(std::make_unique<ClipCmd>(ID(3), {}, SkIRect::MakeXYWH(0, 85, 256, 86)));

    test->push_back(std::make_unique<RectCmd>(ID(4), {}, r.makeOffset(98, 98),   FakePaint(SK_ColorBLUE),    nullptr));
    test->push_back(std::make_unique<RectCmd>(ID(5), {}, r.makeOffset(148, 148), FakePaint(SK_ColorCYAN),    nullptr));

    test->push_back(std::make_unique<RestoreCmd>());

    test->push_back(std::make_unique<RectCmd>(ID(6), {}, r.makeOffset(148, 8),   FakePaint(SK_ColorMAGENTA), nullptr));
    test->push_back(std::make_unique<RectCmd>(ID(7), {}, r.makeOffset(8, 148),   FakePaint(SK_ColorYELLOW),  nullptr));
