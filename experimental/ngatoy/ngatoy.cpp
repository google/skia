...
typedef int (*PFTest)(std::vector<sk_sp<Cmd>>* test, std::vector<ID>* expectedOrder);
...
static int test1(std::vector<sk_sp<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    test->push_back(sk_make_sp<RectCmd>(ID(0), PaintersOrder::Invalid(), r.makeOffset(8, 8),   FakePaint(SK_ColorRED),   nullptr));
    test->push_back(sk_make_sp<RectCmd>(ID(1), PaintersOrder::Invalid(), r.makeOffset(48, 48), FakePaint(SK_ColorGREEN), nullptr));
...
static int test2(std::vector<sk_sp<Cmd>>* test, std::vector<ID>* expectedOrder) {
    // front-to-back order bc all opaque
    ...
    test->push_back(sk_make_sp<RectCmd>(ID(0), PaintersOrder::Invalid(), r.makeOffset(8, 8),   FakePaint(SK_ColorRED),   nullptr));
    test->push_back(sk_make_sp<RectCmd>(ID(1), PaintersOrder::Invalid(), r.makeOffset(48, 48), FakePaint(SK_ColorGREEN), nullptr));
    test->push_back(sk_make_sp<RectCmd>(ID(2), PaintersOrder::Invalid(), r.makeOffset(98, 98), FakePaint(SK_ColorBLUE),  nullptr));
...
static int test3(std::vector<sk_sp<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    SkIRect r{0, 0, 100, 100};
    test->push_back(sk_make_sp<RectCmd>(ID(0), PaintersOrder::Invalid(), r.makeOffset(8, 8),   FakePaint(SK_ColorRED),  nullptr));
    test->push_back(sk_make_sp<RectCmd>(ID(1), PaintersOrder::Invalid(), r.makeOffset(48, 48), FakePaint(0x8000FF00),   nullptr));
    test->push_back(sk_make_sp<RectCmd>(ID(2), PaintersOrder::Invalid(), r.makeOffset(98, 98), FakePaint(SK_ColorBLUE), nullptr));
...
static int test4(std::vector<sk_sp<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    SkIRect r{0, 0, 100, 100};
    test->push_back(sk_make_sp<RectCmd>(ID(0), PaintersOrder::Invalid(), r.makeOffset(8, 8),   FakePaint(0x80FF0000), nullptr));
    test->push_back(sk_make_sp<RectCmd>(ID(1), PaintersOrder::Invalid(), r.makeOffset(48, 48), FakePaint(0x8000FF00), nullptr));
    test->push_back(sk_make_sp<RectCmd>(ID(2), PaintersOrder::Invalid(), r.makeOffset(98, 98), FakePaint(0x800000FF), nullptr));
...
static int test5(std::vector<sk_sp<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    test->push_back(sk_make_sp<RectCmd>(ID(1), PaintersOrder::Invalid(), r.makeOffset(48, 48),   p,                       nullptr));
    p.setRadial(SK_ColorBLUE,    SK_ColorBLACK);
    test->push_back(sk_make_sp<RectCmd>(ID(2), PaintersOrder::Invalid(), r.makeOffset(98, 98),   p,                       nullptr));
    test->push_back(sk_make_sp<RectCmd>(ID(3), PaintersOrder::Invalid(), r.makeOffset(148, 148), FakePaint(SK_ColorCYAN), nullptr));
    p.setLinear(SK_ColorMAGENTA, SK_ColorWHITE);
    test->push_back(sk_make_sp<RectCmd>(ID(4), PaintersOrder::Invalid(), r.makeOffset(148, 8),   p,                       nullptr));
    p.setRadial(SK_ColorYELLOW,  SK_ColorBLACK);
    test->push_back(sk_make_sp<RectCmd>(ID(5), PaintersOrder::Invalid(), r.makeOffset(8, 148),   p,                       nullptr));
...
static int test6(std::vector<sk_sp<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    test->push_back(sk_make_sp<ClipCmd>(ID(0), PaintersOrder::Invalid(), SkIRect::MakeXYWH(28, 28, 40, 40)));

    SkIRect r{0, 0, 100, 100};
    test->push_back(sk_make_sp<RectCmd>(ID(1), PaintersOrder::Invalid(), r.makeOffset(8, 8),   FakePaint(SK_ColorRED),   nullptr));
    test->push_back(sk_make_sp<RectCmd>(ID(2), PaintersOrder::Invalid(), r.makeOffset(48, 48), FakePaint(SK_ColorGREEN), nullptr));
...
static int test7(std::vector<sk_sp<Cmd>>* test, std::vector<ID>* expectedOrder) {
    ...
    test->push_back(sk_make_sp<ClipCmd>(ID(0), PaintersOrder::Invalid(), SkIRect::MakeXYWH(85, 0, 86, 256)));
    ...
    test->push_back(sk_make_sp<ClipCmd>(ID(3), PaintersOrder::Invalid(), SkIRect::MakeXYWH(0, 85, 256, 86)));

    test->push_back(sk_make_sp<RectCmd>(ID(4), PaintersOrder::Invalid(), r.makeOffset(98, 98),   FakePaint(SK_ColorBLUE),    nullptr));
    test->push_back(sk_make_sp<RectCmd>(ID(5), PaintersOrder::Invalid(), r.makeOffset(148, 148), FakePaint(SK_ColorCYAN),    nullptr));

    test->push_back(sk_make_sp<RestoreCmd>());

    test->push_back(sk_make_sp<RectCmd>(ID(6), PaintersOrder::Invalid(), r.makeOffset(148, 8),   FakePaint(SK_ColorMAGENTA), nullptr));
    test->push_back(sk_make_sp<RectCmd>(ID(7), PaintersOrder::Invalid(), r.makeOffset(8, 148),   FakePaint(SK_ColorYELLOW),  nullptr));
