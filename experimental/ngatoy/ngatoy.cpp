...
static void sort_test(PFTest testcase) {
    ...
    actualBM.eraseColor(SK_ColorGRAY);
...
static int test1(std::vector<const Cmd*>* test, std::vector<int>* expectedOrder) {
    ...
    test->push_back(new RectCmd(0, kInvalidZ, kSolidMat, r.makeOffset(8, 8),   false, SK_ColorRED,   SK_ColorUNUSED, nullptr));
    test->push_back(new RectCmd(1, kInvalidZ, kSolidMat, r.makeOffset(48, 48), false, SK_ColorGREEN, SK_ColorUNUSED, nullptr));
...
static int test2(std::vector<const Cmd*>* test, std::vector<int>* expectedOrder) {
    ...
    test->push_back(new RectCmd(0, kInvalidZ, kSolidMat, r.makeOffset(8, 8),   false, SK_ColorRED,   SK_ColorUNUSED, nullptr));
    test->push_back(new RectCmd(1, kInvalidZ, kSolidMat, r.makeOffset(48, 48), false, SK_ColorGREEN, SK_ColorUNUSED, nullptr));
    test->push_back(new RectCmd(2, kInvalidZ, kSolidMat, r.makeOffset(98, 98), false, SK_ColorBLUE,  SK_ColorUNUSED, nullptr));
...
static int test3(std::vector<const Cmd*>* test, std::vector<int>* expectedOrder) {
    ...
    SkIRect r{0, 0, 100, 100};
    test->push_back(new RectCmd(0, kInvalidZ, kSolidMat, r.makeOffset(8, 8),   false, SK_ColorRED,  SK_ColorUNUSED, nullptr));
    test->push_back(new RectCmd(1, kInvalidZ, kSolidMat, r.makeOffset(48, 48), false, 0x8000FF00,   SK_ColorUNUSED, nullptr));
    test->push_back(new RectCmd(2, kInvalidZ, kSolidMat, r.makeOffset(98, 98), false, SK_ColorBLUE, SK_ColorUNUSED, nullptr));
...
static int test4(std::vector<const Cmd*>* test, std::vector<int>* expectedOrder) {
    ...
    SkIRect r{0, 0, 100, 100};
    test->push_back(new RectCmd(0, kInvalidZ, kSolidMat, r.makeOffset(8, 8),   true, 0x80FF0000, SK_ColorUNUSED, nullptr));
    test->push_back(new RectCmd(1, kInvalidZ, kSolidMat, r.makeOffset(48, 48), true, 0x8000FF00, SK_ColorUNUSED, nullptr));
    test->push_back(new RectCmd(2, kInvalidZ, kSolidMat, r.makeOffset(98, 98), true, 0x800000FF, SK_ColorUNUSED, nullptr));
...
static int test5(std::vector<const Cmd*>* test, std::vector<int>* expectedOrder) {
    ...
    SkIRect r{0, 0, 100, 100};
    test->push_back(new RectCmd(0, kInvalidZ, kSolidMat,  r.makeOffset(8, 8),     false, SK_ColorRED,     SK_ColorUNUSED, nullptr));
    test->push_back(new RectCmd(1, kInvalidZ, kLinearMat, r.makeOffset(48, 48),   false, SK_ColorGREEN,   SK_ColorWHITE,  nullptr));
    test->push_back(new RectCmd(2, kInvalidZ, kRadialMat, r.makeOffset(98, 98),   false, SK_ColorBLUE,    SK_ColorBLACK,  nullptr));
    test->push_back(new RectCmd(3, kInvalidZ, kSolidMat,  r.makeOffset(148, 148), false, SK_ColorCYAN,    SK_ColorUNUSED, nullptr));
    test->push_back(new RectCmd(4, kInvalidZ, kLinearMat, r.makeOffset(148, 8),   false, SK_ColorMAGENTA, SK_ColorWHITE,  nullptr));
    test->push_back(new RectCmd(5, kInvalidZ, kRadialMat, r.makeOffset(8, 148),   false, SK_ColorYELLOW,  SK_ColorBLACK,  nullptr));
...
static int test6(std::vector<const Cmd*>* test, std::vector<int>* expectedOrder) {
    ...
    expectedOrder->push_back(0); // clip
    expectedOrder->push_back(2);
    expectedOrder->push_back(1);
    ...
    test->push_back(new ClipCmd(0, kInvalidZ, SkIRect::MakeXYWH(28, 28, 40, 40)));

    SkIRect r{0, 0, 100, 100};
    test->push_back(new RectCmd(1, kInvalidZ, kSolidMat, r.makeOffset(8, 8),   false, SK_ColorRED,   SK_ColorUNUSED, nullptr));
    test->push_back(new RectCmd(2, kInvalidZ, kSolidMat, r.makeOffset(48, 48), false, SK_ColorGREEN, SK_ColorUNUSED, nullptr));
...
static int test7(std::vector<const Cmd*>* test, std::vector<int>* expectedOrder) {
    ...
    expectedOrder->push_back(3); // clip
    expectedOrder->push_back(5);
    expectedOrder->push_back(4);
    ...
    test->push_back(new ClipCmd(0, kInvalidZ, SkIRect::MakeXYWH(85, 0, 86, 256)));
    ...
    test->push_back(new ClipCmd(3, kInvalidZ, SkIRect::MakeXYWH(0, 85, 256, 86)));

    test->push_back(new RectCmd(4, kInvalidZ, kSolidMat, r.makeOffset(98, 98),   false, SK_ColorBLUE,    SK_ColorUNUSED, nullptr));
    test->push_back(new RectCmd(5, kInvalidZ, kSolidMat, r.makeOffset(148, 148), false, SK_ColorCYAN,    SK_ColorUNUSED, nullptr));

    test->push_back(new PopCmd());

    test->push_back(new RectCmd(6, kInvalidZ, kSolidMat, r.makeOffset(148, 8),   false, SK_ColorMAGENTA, SK_ColorUNUSED, nullptr));
    test->push_back(new RectCmd(7, kInvalidZ, kSolidMat, r.makeOffset(8, 148),   false, SK_ColorYELLOW,  SK_ColorUNUSED, nullptr));
