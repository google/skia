...
public:
    class MCState {
    public:
        MCState(const MCState&);
        MCState() {}
        ~MCState();

        void addRect(SkIRect r, std::unique_ptr<ClipCmd> clipCmd);
        ...
        const std::vector<std::unique_ptr<ClipCmd>>& cmds() const { return fCmds; }
    ...
    protected:
        ...
        std::vector<std::unique_ptr<ClipCmd>> fCmds;
...
public:
    ...
    void clipRect(SkIRect clipRect, std::unique_ptr<ClipCmd> clipCmd) {
...
private:
    ...
    std::vector<std::unique_ptr<Cmd>> fSortedCmds;
