...
void InterfaceParser::enumSizeItems(const Definition& child) {
 ...
 //       start here;
        SkDebugf("");  // set breakpoint here
        // doesn't this need to detect and skip comment tokens?
...
bool InterfaceParser::populate(Definition* def, RootDefinition* root) {
 ...
 //                       start here;
                        ...
                        SkASSERT(end);
                        if ('=' == *end) {
                            // need to write enum value
                            SkDebugf("");  // set breakpoint here
                        }
                        this->indentToColumn(fEnumItemValueTab);
                        this->writeBlock((int) token.fContentEnd - token.fContentStart),
                    ...
                    if (!currentEnumItem) {
                        ...
                        const char* commentStart = currentEnumItem->fContentStart;
                        const char* commentEnd;
