...
DEFINE_bool2(hack, k, "", "Do a find/replace hack to update all *.bmh files. (Requires -b)");
...
int main(int argc, char** const argv) {
    ...
    SkCommandLineFlags::SetUsage(
        "Common Usage: bookmaker -i directory/of_includes/include.h -t\n"
        "              bookmaker -b directory/of_bmh_files -e fiddle.json\n"
        "              ~/go/bin/fiddlecli --input fiddle.json --output fiddleout.json\n"
        "              bookmaker -b directory/of_bmh_files -f fiddleout.json -r out_directory/of_md_files\n"
        "              bookmaker -b directory/of_bmh_files -i directory/of_includes -x\n"
        "              bookmaker -b directory/of_bmh_files -i directory/of_includes -p\n");
    bool help = false;
    ...
    if (!help) {
        ...
        char* commands[] = { "", "-h", "bmh", "-h", "examples", "-h", "include", "-h", "fiddle",
            "-h", "ref", "-h", "tokens",
