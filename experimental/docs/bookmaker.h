...
// fill in other names once they're actually used
  { "",            nullptr,        MarkType::kNone,        R_Y,  0 }
, { "A",           nullptr,        MarkType::kAnchor,      R_Y,  0 }
, { "Alias",       nullptr,        MarkType::kAlias,       R_N,  0 }
, { "Bug",         nullptr,        MarkType::kBug,         R_N,  0 }
, { "Class",       &fClassMap,     MarkType::kClass,       R_Y,  M_CSST | M(Root) }
, { "Code",        nullptr,        MarkType::kCode,        R_Y,  M_CSST | M_E }      
, { "",            nullptr,        MarkType::kColumn,      R_Y,  M(Row) }
, { "",            nullptr,        MarkType::kComment,     R_N,  0 }
, { "Const",       &fConstMap,     MarkType::kConst,       R_Y,  M_E | M_ST  }
, { "Define",      nullptr,        MarkType::kDefine,      R_O,  M_ST }
, { "DefinedBy",   nullptr,        MarkType::kDefinedBy,   R_N,  M(Method) }
, { "Deprecated",  nullptr,        MarkType::kDeprecated,  R_Y,  0 }
, { "Description", nullptr,        MarkType::kDescription, R_Y,  M(Example) }
, { "Doxygen",     nullptr,        MarkType::kDoxygen,     R_Y,  0 }
, { "Enum",        &fEnumMap,      MarkType::kEnum,        R_Y,  M_CSST | M(Root) }
, { "EnumClass",   &fClassMap,     MarkType::kEnumClass,   R_Y,  M_CSST | M(Root) }
, { "Error",       nullptr,        MarkType::kError,       R_N,  M(Example) }
, { "Example",     nullptr,        MarkType::kExample,     R_O,  M_CSST | M_E | M(Method) }
, { "External",    nullptr,        MarkType::kExternal,    R_Y,  M(Root) }
, { "File",        nullptr,        MarkType::kFile,        R_N,  M(Track) }
, { "Formula",     nullptr,        MarkType::kFormula,     R_O,  M_ST | M(Method) | M_D }
, { "Function",    nullptr,        MarkType::kFunction,    R_O,  M(Example) }
, { "Height",      nullptr,        MarkType::kHeight,      R_N,  M(Example) }
, { "Image",       nullptr,        MarkType::kImage,       R_N,  M(Example) }
, { "Legend",      nullptr,        MarkType::kLegend,      R_Y,  M(Table) }
, { "Link",        nullptr,        MarkType::kLink,        R_Y,  0 }
, { "List",        nullptr,        MarkType::kList,        R_Y,  M(Method) | M_CSST | M_E | M_D }
, { "",            nullptr,        MarkType::kMarkChar,    R_N,  0 }
, { "Member",      nullptr,        MarkType::kMember,      R_Y,  M(Class) | M(Struct) }
, { "Method",      &fMethodMap,    MarkType::kMethod,      R_Y,  M_CSST }
, { "Param",       nullptr,        MarkType::kParam,       R_Y,  M(Method) }
, { "Platform",    nullptr,        MarkType::kPlatform,    R_Y,  M(Example) }
, { "Return",      nullptr,        MarkType::kReturn,      R_Y,  M(Method) }
, { "",            nullptr,        MarkType::kRoot,        R_Y,  0 }
, { "",            nullptr,        MarkType::kRow,         R_Y,  M(Table) | M(List) }
, { "SeeAlso",     nullptr,        MarkType::kSeeAlso,     R_Y,  M_CSST | M_E | M(Method) }
, { "StdOut",      nullptr,        MarkType::kStdOut,      R_N,  M(Example) }
, { "Struct",      &fClassMap,     MarkType::kStruct,      R_Y,  M(Class) | M(Root) | M_ST }
, { "Subtopic",    nullptr,        MarkType::kSubtopic,    R_Y,  M_CSST }
, { "Table",       nullptr,        MarkType::kTable,       R_Y,  M(Method) | M_CSST | M_E }
, { "Template",    nullptr,        MarkType::kTemplate,    R_Y,  0 }
, { "",            nullptr,        MarkType::kText,        R_Y,  0 }
, { "Time",        nullptr,        MarkType::kTime,        R_Y,  M(Track) }
, { "ToDo",        nullptr,        MarkType::kToDo,        R_N,  0 }
, { "Topic",       nullptr,        MarkType::kTopic,       R_Y,  M_CS | M(Root) | M(Topic) }
, { "Track",       nullptr,        MarkType::kTrack,       R_Y,  M_E |M_ST }
, { "Typedef",     &fTypedefMap,   MarkType::kTypedef,     R_Y,  M(Subtopic) | M(Topic) }
, { "",            nullptr,        MarkType::kUnion,       R_Y,  0 }
, { "Volatile",    nullptr,        MarkType::kVolatile,    R_N,  M(StdOut) }
, { "Width",       nullptr,        MarkType::kWidth,       R_N,  M(Example) } }
        {
            this->reset();
        }
