...
struct TextParser {
    ...
    const char* anyOf(const char* wordStart, const char* wordList[], size_t wordListCount) {
...
public:
    RootDefinition() {
        fBranches = new unordered_map<string, RootDefinition>;
    }
...
// fill in other names once they're actually used
          { "",            nullptr,        MarkType::kNone,        0 }
        , { "A",           nullptr,        MarkType::kAnchor,      0 }
        , { "Bug",         nullptr,        MarkType::kBug,         0 }
        , { "Class",       &fClassMap,     MarkType::kClass,       M_CSST | M(Root) }
        , { "Code",        nullptr,        MarkType::kCode,        M_CSST | M_E }      
        , { "",            nullptr,        MarkType::kColumn,      M(Row) }
        , { "",            nullptr,        MarkType::kComment,     0 }
        , { "Const",       &fConstMap,     MarkType::kConst,       M_E | M_ST  }
        , { "",            nullptr,        MarkType::kDefine,      0 }
        , { "DefinedBy",   nullptr,        MarkType::kDefinedBy,   M(Method) }
        , { "Deprecated",  nullptr,        MarkType::kDeprecated,  0 }
        , { "Description", nullptr,        MarkType::kDescription, M(Example) }
        , { "Doxygen",     nullptr,        MarkType::kDoxygen,     0 }
        , { "Enum",        &fEnumMap,      MarkType::kEnum,        M_CSST | M(Root) }
        , { "EnumClass",   &fEnumMap,      MarkType::kEnumClass,   M_CSST | M(Root) }
        , { "Error",       nullptr,        MarkType::kError,       M(Example) }
        , { "Example",     nullptr,        MarkType::kExample,     M_CSST | M_E | M(Method) }
        , { "External",    nullptr,        MarkType::kExternal,    M(Root) }
        , { "File",        nullptr,        MarkType::kFile,        M(Track) }
        , { "Formula",     nullptr,        MarkType::kFormula,     M(Subtopic) | M(Topic) }
        , { "Function",    nullptr,        MarkType::kFunction,    M(Example) }
        , { "Image",       nullptr,        MarkType::kImage,       M(Example) }
        , { "Legend",      nullptr,        MarkType::kLegend,      M(Table) }
        , { "",            nullptr,        MarkType::kLink,        0 }
        , { "List",        nullptr,        MarkType::kList,        M_ST | M(Method) }
        , { "Member",      nullptr,        MarkType::kMember,      M(Class) | M(Struct) }
        , { "Method",      &fMethodMap,    MarkType::kMethod,      M_CSST }
        , { "Param",       nullptr,        MarkType::kParam,       M(Method) }
        , { "Platform",    nullptr,        MarkType::kPlatform,    M(Example) }
        , { "Return",      nullptr,        MarkType::kReturn,      M(Method) }
        , { "",            nullptr,        MarkType::kRoot,        0 }
        , { "",            nullptr,        MarkType::kRow,         M(Table) }
        , { "SeeAlso",     nullptr,        MarkType::kSeeAlso,     M_CSST | M_E | M(Method) }
        , { "StdOut",      nullptr,        MarkType::kStdOut,      M(Example) }
        , { "Struct",      &fClassMap,     MarkType::kStruct,      M(Class) | M(Root) | M_ST }
        , { "Subtopic",    nullptr,        MarkType::kSubtopic,    M_CSST }
        , { "Table",       nullptr,        MarkType::kTable,       M(Method) | M_ST }
        , { "Template",    nullptr,        MarkType::kTemplate,    0 }
        , { "",            nullptr,        MarkType::kText,        0 }
        , { "Time",        nullptr,        MarkType::kTime,        M(Track) }
        , { "ToDo",        nullptr,        MarkType::kToDo,        0 }
        , { "Topic",       nullptr,        MarkType::kTopic,       M_CS | M(Root) | M(Topic) }
        , { "Track",       nullptr,        MarkType::kTrack,       M_E |M_ST }
        , { "Typedef",     &fTypedefMap,   MarkType::kTypedef,     M(Subtopic) | M(Topic) }
        , { "",            nullptr,        MarkType::kUnion,       0 }
        , { "Width",       nullptr,        MarkType::kWidth,       M(Example) } }
        {
            this->reset();
        }
