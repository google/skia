...
// fill in other names once they're actually used
        ...
        , { "Bug",         nullptr,        MarkType::kBug,         Resolvable::kYes,  0 }
        , { "Class",       &fClassMap,     MarkType::kClass,       Resolvable::kYes,  M_CSST | M(Root) }
        , { "Code",        nullptr,        MarkType::kCode,        Resolvable::kNo,   M_CSST | M_E }      
        ...
        , { "EnumClass",   &fEnumMap,      MarkType::kEnumClass,   Resolvable::kYes,  M_CSST | M(Root) }
        ...
        , { "Image",       nullptr,        MarkType::kImage,       Resolvable::kYes,  M(Example) }
        ...
        , { "Width",       nullptr,        MarkType::kWidth,       Resolvable::kYes,  M(Example) } }
        {
            this->reset();
        }
...
#undef M
    ...
    bool isDefined(const TextParser& parser, const string& ref, string* def) const;
    ...
    bool resolvable(MarkType markType) { 
        return Resolvable::kYes == fMaps[(int) markType].fResolve;
    }
