...
struct Definition {
    ...
    void dump(const char* typeName) const;
...
struct Parser : public TextParser {
    Parser()
        ...
        , { "Const",       nullptr,        nullptr,        MarkType::kConst }
        ...
        , { "External",    &fExternalMap,  nullptr,        MarkType::kExternal }
        ...
        , { "Method",      nullptr,        nullptr,        MarkType::kMethod }
    ...
    unordered_map<string, RootDefinition> fExternalMap;
