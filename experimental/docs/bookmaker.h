...
// fill in other names once they're actually used
        ...
        , { "Define",      nullptr,        MarkType::kDefine,      Resolvable::kOut,  M_ST }
        ...
        , { "Example",     nullptr,        MarkType::kExample,     Resolvable::kOut,  M_CSST | M_E | M(Method) }
        , { "External",    nullptr,        MarkType::kExternal,    Resolvable::kYes,  M(Root) }
        , { "File",        nullptr,        MarkType::kFile,        Resolvable::kNo,   M(Track) }
        , { "Formula",     nullptr,        MarkType::kFormula,     Resolvable::kOut,  M_ST | M(Method) }
        , { "Function",    nullptr,        MarkType::kFunction,    Resolvable::kOut,  M(Example) }
        ...
        , { "List",        nullptr,        MarkType::kList,        Resolvable::kYes,  M(Method) | M_CSST | M_E | M(Description) }
        , { "",            nullptr,        MarkType::kMarkChar,    Resolvable::kNo,   0 }
        ...
        , { "",            nullptr,        MarkType::kRow,         Resolvable::kYes,  M(Table) | M(List) }
        ...
        , { "Table",       nullptr,        MarkType::kTable,       Resolvable::kYes,  M(Method) | M_CSST | M_E }
