...
struct Parser : public TextParser {
    Parser()
        ...
        , { "A",           nullptr,        nullptr,        MarkType::kAnchor }
        , { "Bug",         nullptr,        nullptr,        MarkType::kBug }
        , { "Class",       &fClassMap,     nullptr,        MarkType::kClass }
        , { "",            nullptr,        nullptr,        MarkType::kColumn }
        , { "",            nullptr,        nullptr,        MarkType::kComment }
        , { "Const",       &fConstMap,     nullptr,        MarkType::kConst }
        , { "",            nullptr,        &fIDefineMap,   MarkType::kDefine }
        , { "Deprecated",  nullptr,        nullptr,        MarkType::kDeprecated }
        , { "Description", nullptr,        nullptr,        MarkType::kDescription }
        , { "Doxygen",     nullptr,        nullptr,        MarkType::kDoxygen }
        , { "Enum",        &fEnumMap,      &fIEnumMap,     MarkType::kEnum }
        , { "Error",       nullptr,        nullptr,        MarkType::kError }
        , { "Example",     nullptr,        nullptr,        MarkType::kExample }
        , { "External",    nullptr,        nullptr,        MarkType::kExternal }
        , { "File",        nullptr,        nullptr,        MarkType::kFile }
        , { "Formula",     nullptr,        nullptr,        MarkType::kFormula }
        , { "Function",    nullptr,        nullptr,        MarkType::kFunction }
        , { "Image",       nullptr,        nullptr,        MarkType::kImage }
        , { "Import",      nullptr,        nullptr,        MarkType::kImport }
        , { "Legend",      nullptr,        nullptr,        MarkType::kLegend }
        , { "List",        nullptr,        nullptr,        MarkType::kList }
        , { "Member",      nullptr,        nullptr,        MarkType::kMember }
        , { "Method",      &fMethodMap,    nullptr,        MarkType::kMethod }
        , { "Param",       nullptr,        nullptr,        MarkType::kParam }
        , { "Platform",    nullptr,        nullptr,        MarkType::kPlatform }
        , { "Return",      nullptr,        nullptr,        MarkType::kReturn }
        , { "",            nullptr,        nullptr,        MarkType::kRow }
        , { "SeeAlso",     nullptr,        nullptr,        MarkType::kSeeAlso }
        , { "StdOut",      nullptr,        nullptr,        MarkType::kStdOut }
        , { "Struct",      &fClassMap,     &fIStructMap,   MarkType::kStruct }
        , { "Subtopic",    nullptr,        nullptr,        MarkType::kSubtopic }
        , { "Table",       nullptr,        nullptr,        MarkType::kTable }
        , { "Template",    nullptr,        &fITemplateMap, MarkType::kTemplate }
        , { "",            nullptr,        nullptr,        MarkType::kText }
        , { "Time",        nullptr,        nullptr,        MarkType::kTime }
        , { "ToDo",        nullptr,        nullptr,        MarkType::kToDo }
        , { "Topic",       nullptr,        nullptr,        MarkType::kTopic }
        , { "Track",       nullptr,        nullptr,        MarkType::kTrack }
        , { "Typedef",     &fTypedefMap,   &fITypedefMap,  MarkType::kTypedef }
        , { "",            nullptr,        &fIUnionMap,    MarkType::kUnion }
        , { "Width",       nullptr,        nullptr,        MarkType::kWidth } }
    ...
    string addReferences(const string& text);
    ...
    bool isDefined(const string& ref) const;
    string memberName();
    string methodName();
    ...
    unordered_map<string, int> fWords;  // things to be defined
