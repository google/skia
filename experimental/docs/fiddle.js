...
var SkCanvas_int_int_const_SkSurfaceProps_star_code = 
"void draw(SkCanvas* ) {\n" + 
...
var SkCanvas_int_int_const_SkSurfaceProps_star_json = {
    "code": SkCanvas_int_int_const_SkSurfaceProps_star_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "SkCanvas_int_int_const_SkSurfaceProps_star",
    "overwrite": true
}

runFiddle(SkCanvas_int_int_const_SkSurfaceProps_star_json);
...
var SkCanvas_const_SkBitmap_const_SkSurfaceProps_code = 
"void draw(SkCanvas* ) {\n" + 
"    SkBitmap bitmap;\n" +
"    // create a bitmap 5 wide and 11 high\n" +
"    bitmap.allocPixels(SkImageInfo::MakeN32Premul(5, 11));\n" +
...
var SkCanvas_const_SkBitmap_const_SkSurfaceProps_json = {
    "code": SkCanvas_const_SkBitmap_const_SkSurfaceProps_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "SkCanvas_const_SkBitmap_const_SkSurfaceProps",
    "overwrite": true
}

runFiddle(SkCanvas_const_SkBitmap_const_SkSurfaceProps_json);
...
var SkCanvas_accessTopLayerPixels_a_code = 
"void draw(SkCanvas* canvas) {\n" +
"  SkPaint paint;\n" +
...
var SkCanvas_accessTopLayerPixels_a_json = {
    "code": SkCanvas_accessTopLayerPixels_a_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "SkCanvas_accessTopLayerPixels_a",
    "overwrite": true
}

runFiddle(SkCanvas_accessTopLayerPixels_a_json);
...
var Canvas_State_Stack_json = {
    "code": Canvas_State_Stack_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Canvas_State_Stack",
    "overwrite": true
}

runFiddle(Canvas_State_Stack_json);

var Canvas_State_Stack_a_code = 
"void draw(SkCanvas* canvas) {\n" +
...
var Canvas_State_Stack_a_json = {
    "code": Canvas_State_Stack_a_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Canvas_State_Stack_a",
    "overwrite": true
}

runFiddle(Canvas_State_Stack_a_json);
...
var SkCanvas_drawDRRect_a_code = 
"void draw(SkCanvas* canvas) {\n" +
"   SkRRect outer = SkRRect::MakeRect({20, 40, 210, 200});\n" +
...
var SkCanvas_drawDRRect_a_json = {
    "code": SkCanvas_drawDRRect_a_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "SkCanvas_drawDRRect_a",
    "overwrite": true
}

runFiddle(SkCanvas_drawDRRect_a_json);
...
var SkCanvas_drawArc_a_json = {
    "code": SkCanvas_drawArc_a_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "SkCanvas_drawArc_a",
    "overwrite": true
}

runFiddle(SkCanvas_drawArc_a_json);
...
var SkCanvas_drawPatch_2_a_code = 
"void draw(SkCanvas* canvas) {\n" +
...
var SkCanvas_drawPatch_2_a_json = {
    "code": SkCanvas_drawPatch_2_a_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 6,
    ...
    "name": "SkCanvas_drawPatch_2_a",
    "overwrite": true
}

runFiddle(SkCanvas_drawPatch_2_a_json);
...
var Paint_Anti_alias_json = {
    "code": Paint_Anti_alias_code,
    "options": {
        "width": 512,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Anti_alias",
    "overwrite": true
}

runFiddle(Paint_Anti_alias_json);
...
var Paint_Dither_json = {
    "code": Paint_Dither_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
...
var Paint_Vertical_Text_json = {
    "code": Paint_Vertical_Text_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Vertical_Text",
    "overwrite": true
}

runFiddle(Paint_Vertical_Text_json);
...
var Paint_Text_Decorations_Fake_Bold_code = 
"void draw(SkCanvas* canvas) {\n" +
"    SkPaint paint;\n" +
"    paint.setAntiAlias(true);\n" +
"    paint.setTextSize(40);\n" +
...
var Paint_Text_Decorations_Fake_Bold_json = {
    "code": Paint_Text_Decorations_Fake_Bold_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Text_Decorations_Fake_Bold",
    "overwrite": true
}

runFiddle(Paint_Text_Decorations_Fake_Bold_json);
...
var Paint_Filter_Quality_Methods_code = 
"void draw(SkCanvas* canvas) {\n" +
"    SkPaint paint;\n" +
"    canvas->scale(.2f, .2f);\n" +
...
var Paint_Filter_Quality_Methods_json = {
    "code": Paint_Filter_Quality_Methods_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Filter_Quality_Methods",
    "overwrite": true
}

runFiddle(Paint_Filter_Quality_Methods_json);
...
var Paint_Color_Methods_json = {
    "code": Paint_Color_Methods_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Color_Methods",
    "overwrite": true
}

runFiddle(Paint_Color_Methods_json);
...
var Paint_Stroke_Width_json = {
    "code": Paint_Stroke_Width_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
...
runFiddle(Paint_Stroke_Width_json);
...
var Paint_Miter_Limit_json = {
    "code": Paint_Miter_Limit_code,
    "options": {
        "width": 512,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Miter_Limit",
    "overwrite": true
}

runFiddle(Paint_Miter_Limit_json);
...
var Paint_Stroke_Cap_json = {
    "code": Paint_Stroke_Cap_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Stroke_Cap",
    "overwrite": true
}

runFiddle(Paint_Stroke_Cap_json);
...
var Paint_Stroke_Join_json = {
    "code": Paint_Stroke_Join_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Stroke_Join",
    "overwrite": true
}

runFiddle(Paint_Stroke_Join_json);
...
var Paint_Shader_Methods_json = {
    "code": Paint_Shader_Methods_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Shader_Methods",
    "overwrite": true
}

runFiddle(Paint_Shader_Methods_json);

var Paint_Shader_Methods_a_code = 
"void draw(SkCanvas* canvas) {\n" +
"   SkPaint paint;\n" +
"   SkBitmap bitmap;\n" +
...
var Paint_Shader_Methods_a_json = {
    "code": Paint_Shader_Methods_a_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Shader_Methods_a",
    "overwrite": true
}

runFiddle(Paint_Shader_Methods_a_json);
...
var Paint_Color_Filter_Methods_code = 
"void draw(SkCanvas* canvas) {\n" +
"    SkPaint paint;\n" +
...
var Paint_Color_Filter_Methods_json = {
    "code": Paint_Color_Filter_Methods_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Color_Filter_Methods",
    "overwrite": true
}

runFiddle(Paint_Color_Filter_Methods_json);
...
var Paint_Blend_Mode_Methods_code = 
"void draw(SkCanvas* canvas) {\n" +
...
var Paint_Blend_Mode_Methods_json = {
    "code": Paint_Blend_Mode_Methods_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Blend_Mode_Methods",
    "overwrite": true
}

runFiddle(Paint_Blend_Mode_Methods_json);
...
var Paint_Path_Effect_Methods_code = 
"void draw(SkCanvas* canvas) {\n" +
"    SkPaint paint;\n" +
"    paint.setStyle(SkPaint::kStroke_Style);\n" +
...
var Paint_Path_Effect_Methods_json = {
    "code": Paint_Path_Effect_Methods_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Path_Effect_Methods",
    "overwrite": true
}

runFiddle(Paint_Path_Effect_Methods_json);
...
var Paint_Mask_Filter_Methods_code = 
"void draw(SkCanvas* canvas) {\n" +
"    SkPaint paint;\n" +
...
var Paint_Mask_Filter_Methods_json = {
    "code": Paint_Mask_Filter_Methods_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Mask_Filter_Methods",
    "overwrite": true
}

runFiddle(Paint_Mask_Filter_Methods_json);
...
var Paint_Typeface_Methods_code = 
"void draw(SkCanvas* canvas) {\n" +
"    SkPaint paint;\n" +
...
var Paint_Typeface_Methods_json = {
    "code": Paint_Typeface_Methods_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Typeface_Methods",
    "overwrite": true
}

runFiddle(Paint_Typeface_Methods_json);
...
var Paint_Rasterizer_Methods_code = 
"void draw(SkCanvas* canvas) {\n" +
...
var Paint_Rasterizer_Methods_json = {
    "code": Paint_Rasterizer_Methods_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Rasterizer_Methods",
    "overwrite": true
}

runFiddle(Paint_Rasterizer_Methods_json);
...
var Paint_Image_Filter_Methods_code = 
"void draw(SkCanvas* canvas) {\n" +
"    SkPaint paint;\n" +
"    paint.setStyle(SkPaint::kStroke_Style);\n" +
"    paint.setStrokeWidth(2);\n" +
...
var Paint_Image_Filter_Methods_json = {
    "code": Paint_Image_Filter_Methods_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Image_Filter_Methods",
    "overwrite": true
}

runFiddle(Paint_Image_Filter_Methods_json);
...
var Paint_Draw_Looper_Methods_code = 
"void draw(SkCanvas* canvas) {\n" +
...
var Paint_Draw_Looper_Methods_json = {
    "code": Paint_Draw_Looper_Methods_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Draw_Looper_Methods",
    "overwrite": true
}

runFiddle(Paint_Draw_Looper_Methods_json);
...
var Paint_Text_Align_a_json = {
    "code": Paint_Text_Align_a_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "Paint_Text_Align_a",
    "overwrite": true
}

runFiddle(Paint_Text_Align_a_json);
...
var SkPaint_containsText_a_code = 
"void draw(SkCanvas* canvas) {\n" + 
"    SkPaint paint;\n" +
...
var SkPaint_containsText_a_json = {
    "code": SkPaint_containsText_a_code,
    "options": {
        "width": 256,
        "height": 256,
        "source": 0,
    ...
    "name": "SkPaint_containsText_a",
    "overwrite": true
}

runFiddle(SkPaint_containsText_a_json);
