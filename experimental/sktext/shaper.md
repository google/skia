...
A related explainer focuses on suggested [extensions to canvas2d](canvas2d.md) to allow it to efficiently render the shaped results, and to offer helper objects for inspecting useful properties from a typeface.
...
interface GlyphRun : TextRun {
    readonly attribute Font font;   // sans features
...
The [next explainer](canvas2d.md) describes how to take these results and render them
