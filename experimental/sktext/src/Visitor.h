...
public:
    ...
    void visit(Processor* processor, SkSpan<DecorBlock> decorBlocks);
...
class Processor;
class SkiaVisitor : public Visitor {
public:
    SkiaVisitor(SkCanvas* canvas, SkPoint xy) : fCanvas(canvas), fXY(xy) { }
