...
// All at once
bool Processor::drawText(const std::u16string& text, SkCanvas* canvas, SkScalar x, SkScalar y) {
...
bool Processor::drawText(const std::u16string& text, SkCanvas* canvas, TextFormatStyle textFormat, SkColor foreground, SkColor background, const SkString& fontFamily, SkScalar fontSize, SkFontStyle fontStyle, SkScalar x, SkScalar y) {

    Range textRange(0, text.size());
...
bool Processor::computeCodeUnitProperties() {
    ...
    size_t utf16Index = 0;
    fUTF16FromUTF8.push_back_n(text8.size() + 1, 0ul);
