...
void EMSCRIPTEN_KEEPALIVE SkPathToVerbsArgs(SkPath path, std::vector<SkPath::Verb>& verbs, std::vector<float>& args) {
    SkPath::Iter iter(path, false);
    SkPoint pts[4];
    SkPath::Verb verb;
    while ((verb = iter.next(pts, false)) != SkPath::kDone_Verb) {
...
void EMSCRIPTEN_KEEPALIVE SkPathToVerbsArgs2(SkPath path, emscripten::val /*Array*/ verbs,
...
SkPath EMSCRIPTEN_KEEPALIVE SkPathFromVerbsArgs(std::vector<SkPath::Verb> verbs, std::vector<float> args) {
    SkPath path;
    int argsIndex = 0;
...
SkPath EMSCRIPTEN_KEEPALIVE SkPathFromVerbsArgs2(emscripten::val /*Array*/  v, emscripten::val /*Array*/  a) {
...
EMSCRIPTEN_BINDINGS(skia) {
    ...
    function("SkPathFromVerbsArgsVector", &SkPathFromVerbsArgs);
    function("SkPathToVerbsArgsVector", &SkPathToVerbsArgs);
    function("SkPathFromVerbsArgsArray", &SkPathFromVerbsArgs2);
    function("SkPathToVerbsArgsArray", &SkPathToVerbsArgs2);
