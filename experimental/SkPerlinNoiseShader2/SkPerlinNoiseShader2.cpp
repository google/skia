...
void GrGLImprovedPerlinNoise::emitCode(EmitArgs& args) {
    ...
    // fade function
    static const GrShadeVar fadeArgs[] =  {
        GrShadeVar("t", kVec3f_GrSLType)
    };
    ...
    // perm function
    static const GrShadeVar permArgs[] =  {
    ...
    // grad function
    static const GrShadeVar gradArgs[] =  {
        GrShadeVar("x", kFloat_GrSLType),
        GrShadeVar("p", kVec3f_GrSLType)
    };
    ...
    // lerp function
    static const GrShadeVar lerpArgs[] =  {
        GrShadeVar("a", kFloat_GrSLType),
        GrShadeVar("b", kFloat_GrSLType),
        GrShadeVar("w", kFloat_GrSLType)
    };
    ...
    // noise function
    static const GrShadeVar noiseArgs[] =  {
        GrShadeVar("p", kVec3f_GrSLType),
    };
    SkString noiseFuncName;
    SkString noiseCode;
    ...
    static const GrShadeVar noiseOctavesArgs[] =  {
        GrShadeVar("p", kVec3f_GrSLType),
        GrShadeVar("octaves", kFloat_GrSLType),
    };
