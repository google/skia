...
gn_args = {
  ...
  'target_cpu':         '"none"',
  'target_os':          '"android"',
  'skia_vulkan_header': '"VulkanHeader_android.h"',
}
...
local_includes.add("external/skia/platform_tools/android/vulkan")
export_includes.add("external/skia/platform_tools/android/vulkan")
