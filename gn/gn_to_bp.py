...
gn_args = {
  'skia_build_for_android_framework': 'true',
...
# Android moves the only file in include/config/ into include/core, so this
# folder does not exist.
local_includes.remove('include/config/')
export_includes.remove('include/config/')
...
# While Skia defines them as "MACRO=X", in Android's SkUserConfig.h, they need
# to be defined as           "MACRO X".
defines = [str(d).replace('=', ' ')
           for d in js['targets']['//:skia']['defines']]
...
with open(os.path.join('include', 'core', 'SkUserConfig.h'), 'w') as f:
