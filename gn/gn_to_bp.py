...
gn_to_bp_utils.GrabDependentValues(js_linux, '//:skia', 'sources', linux_srcs, None)
...
with open(android_config, 'a') as f:
  print >>f, ''
  print >>f, '#ifndef SK_BUILD_FOR_ANDROID'
  print >>f, '    #error "SK_BUILD_FOR_ANDROID must be defined!"'
  print >>f, '#endif'
...
with open(linux_config, 'a') as f:
  print >>f, ''
  print >>f, '// Correct SK_BUILD_FOR flags that may have been set by'
  print >>f, '// SkPreConfig.h/Android.bp'
  print >>f, '#ifndef SK_BUILD_FOR_UNIX'
  print >>f, '    #define SK_BUILD_FOR_UNIX'
  print >>f, '#endif'
  print >>f, '#ifdef SK_BUILD_FOR_ANDROID'
  print >>f, '    #undef SK_BUILD_FOR_ANDROID'
  print >>f, '#endif'
