...
def main():
  ...
  # Most defines go into SkUserConfig.h, where they're seen by Skia and its
  # users. Start with the defines :skia uses, minus a couple.  We'll add more in
  # a bit.
  defines = [str(d) for d in js['targets']['//:skia']['defines']]
  defines.remove('SKIA_IMPLEMENTATION=1')  # Only libskia should have this
                                           # define.
