...
void SkGLWidget::createRenderTarget() {
    ...
    GrBackendRenderTarget backendRenderTarget = this->getBackendRenderTarget(this->width(), this->height());
...
GrBackendRenderTarget SkGLWidget::getBackendRenderTarget(int w, int h) {
