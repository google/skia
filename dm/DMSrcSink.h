...
// provided l/r trail. It then just draws the remaining paths. (Non-path draws are thrown out.) It is useful for finding a reduced
// repo case for path drawing bugs.
