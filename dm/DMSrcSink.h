...
struct Src {
    virtual ~Src() {}
    virtual Result SK_WARN_UNUSED_RESULT hailMary(GrContext*) const { return Result::Ok(); };
    virtual Result SK_WARN_UNUSED_RESULT draw7(GrContext*, SkCanvas*) const = 0;
    ...
    virtual Result SK_WARN_UNUSED_RESULT draw11(int, GrContext* context, SkCanvas* canvas) const {
        return this->draw7(context, canvas);
    }
...
public:
    ...
    Result hailMary(GrContext*) const override;
    Result draw7(GrContext*, SkCanvas*) const override;
...
public:
    ...
    Result draw7(GrContext*, SkCanvas* c) const override;
    Result draw11(int, GrContext*, SkCanvas*) const override;
    SkISize size() const override;
