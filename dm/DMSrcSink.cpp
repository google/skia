...
GPUDoubleHeadedTestingSink::GPUDoubleHeadedTestingSink(const SkCommandLineConfigGpu* config,
                                                       const GrContextOptions& grCtxOptions)
    : INHERITED(config, grCtxOptions) {}

Error GPUDoubleHeadedTestingSink::draw(const Src& src, SkBitmap* dst, SkWStream* wStream,
                                     SkString* log) const {
    return "";
}
