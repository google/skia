...
Result GPUDDLSink::ddlDraw(const Src& src,
    ...
    bool compileOnThreads = contexts[1].directContext() && contexts[2].directContext();
    ...
    DDLTileHelper tiles(contexts[0].directContext(), dstCharacterization, viewport, kNumDivisions,
