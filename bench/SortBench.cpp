...
static void skqsort_sort1(int array[N]) {
    // End is inclusive for SkTQSort!
    SkTQSort1<int>(array, array + N - 1);
}
...
enum SortType {
    kSKQSort, kSKQSort1, kSKHeap, kQSort
};
...
static Benchmark* NewSkQSort1(Type t) {
    return new SortBench(t, kSKQSort1);
}
