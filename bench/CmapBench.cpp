...
#else
        face->charsToGlyphs(SkEncodedText{text, len, (SkTextEncoding)encoding}, glyphs, glyphCount);
#endif
    }
}
...
#else
        face->charsToGlyphs(SkEncodedText{text, len, (SkTextEncoding)encoding}, nullptr, glyphCount);
#endif
