...
GrGLuint GLCpuPosInstancedArraysBench::setupShader(const GrGLContext* ctx) {
    ...
    // setup vertex shader
    GrShadeVar aPosition("a_position", kVec2f_GrSLType, GrShaderVar::kIn_TypeModifier);
    GrShadeVar aColor("a_color", kVec3f_GrSLType, GrShaderVar::kIn_TypeModifier);
    GrShadeVar oColor("o_color", kVec3f_GrSLType, GrShaderVar::kOut_TypeModifier);
    ...
    GrShadeVar oFragColor("o_FragColor", kVec4f_GrSLType, GrShaderVar::kOut_TypeModifier);
