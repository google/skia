...
GrGLuint GLVertexAttributesBench::setupShader(const GrGLContext* ctx, uint32_t attribs,
    ...
    // setup vertex shader
    GrShadeVar aPosition("a_position", kVec4f_GrSLType, GrShaderVar::kIn_TypeModifier);
    SkTArray<GrShadeVar> aVars;
    SkTArray<GrShadeVar> oVars;
    ...
    for (uint32_t i = 0; i < attribs; i++) {
        ...
        aVars.push_back(GrShadeVar(aname.c_str(),
                                      kVec4f_GrSLType,
    ...
    for (uint32_t i = 0; i < maxAttribs; i++) {
        ...
        oVars.push_back(GrShadeVar(oname.c_str(),
                                      kVec4f_GrSLType,
