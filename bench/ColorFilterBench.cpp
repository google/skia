 ...
 *  All of there timings should be about the same
...
public:
    ...
    FilteredRectBench(Type t) : fType(t) {
        static const char* suffix[] = { "none", "colorfilter", "imagefilter" };
...
DEF_BENCH( return new FilteredRectBench(FilteredRectBench::kNone_Type); )
