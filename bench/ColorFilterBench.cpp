...
DEF_BENCH( return new ColorMatrixBench("blend_plus",
    []() { return SkColorFilters::Blend(0x80808080, SkBlendMode::kPlus); }); )
...
DEF_BENCH( return new ColorMatrixBench("compose_matrix",
    []() { return SkColorFilters::Compose(SkColorFilters::Matrix(gColorMatrix),
                                          SkColorFilters::Matrix(gColorMatrix));
    }); )
DEF_BENCH( return new ColorMatrixBench("lerp_matrix",
...
DEF_BENCH( return new ColorMatrixBench("none_runtime", []() {
