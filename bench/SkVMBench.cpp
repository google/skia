...
namespace {
    ...
    enum Mode {Baseline, F32, I32, I32_SWAR};
    static const char* kMode_name[] = { "Baseline", "F32", "I32", "I32_SWAR" };
...
DEF_BENCH(return (new SkVMBench{   1, Baseline});)
DEF_BENCH(return (new SkVMBench{   4, Baseline});)
DEF_BENCH(return (new SkVMBench{  16, Baseline});)
DEF_BENCH(return (new SkVMBench{  64, Baseline});)
DEF_BENCH(return (new SkVMBench{ 256, Baseline});)
DEF_BENCH(return (new SkVMBench{1024, Baseline});)
DEF_BENCH(return (new SkVMBench{4096, Baseline});)
