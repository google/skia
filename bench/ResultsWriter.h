...
/**
 ...
 The purpose of this class is to implement "--closeOutResultsFileHandle" and not keep the file
 handle open between JSON flushes. SkJSONWriter uses a 32k in-memory cache already, so it only
 flushes occasionally and is well equipped for a steam like this.
