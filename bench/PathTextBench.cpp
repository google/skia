...
public:
    PathTextBench(bool clipped, bool cached) : fClipped(clipped), fCached(cached) {}
...
private:
    ...
    void onDelayedSetup() override {
        ...
        if (fClipped) {
            fClipPath = sk_tool_utils::make_star(11, 3);
            fClipPath.transform(SkMatrix::MakeScale(kScreenWidth, kScreenHeight));
            fClipPath.setIsVolatile(!fCached);
        }
    }
...
DEF_BENCH(return new PathTextBench(true, false);)
