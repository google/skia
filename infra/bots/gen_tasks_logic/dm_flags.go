...
func dmFlags(bot string, parts map[string]string, doUpload bool, internalHardwareLabel string) []string {
	properties := []string{
		"gitHash", specs.PLACEHOLDER_REVISION,
		"builder", specs.PLACEHOLDER_TASK_NAME,
		"buildbucket_build_id", specs.PLACEHOLDER_BUILDBUCKET_BUILD_ID,
		"task_id", specs.PLACEHOLDER_TASK_ID,
	}
	// TODO(borenet): We can't know whether this is a try job...
	if false {
	...
	if has("TecnoSpark3Pro") && has("Debug") {
	...
	/*
		...
		if has("Lottie") {
			args = append(args, "--lotties", "TODO", "TODO")
		}
		// More paths.
		if doUpload {
			args = append(args, "--uninterestingHashesFile", "TODO")
			args = append(args, "--writePath", "TODO")
		}
	*/
	return args
}
