...
// Regenerate the tasks.json file. Loads the job list from a jobs.json file
// which is the sibling of the calling gen_tasks.go file. If cfg is nil, it is
// similarly loaded from a cfg.json file which is the sibling of the calling
// gen_tasks.go file.
