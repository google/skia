...
const (
	...
	ISOLATE_XCODE_11_4_1_NAME  = "Housekeeper-PerCommit-IsolateXcode11_4_1"
...
var (
	...
	ISOLATE_ASSET_MAPPING = map[string]isolateAssetCfg{
		...
		"xcode-11.4.1": {
			alwaysIsolate:   true,
			isolateTaskName: ISOLATE_XCODE_11_4_1_NAME,
			path:            "win_toolchain",
		},
	}
)
...
func (b *jobBuilder) compile() string {
	...
	b.addTask(name, func(b *taskBuilder) {
		...
		if b.extraConfig("Android") {
			...
			if b.matchOs("Mac10.15.5") {
				b.asset("xcode-11.4.1")
			} else {
