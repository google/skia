...
INSTALL_DIR = os.path.join('/b', 'work', 'valgrind')
...
def create_install_dir():
  ...
  try:
    ...
    print '''Please create %s. This is to mimic the bot environment on your
machine, since the path gets baked into Valgrind. Eg:

$ sudo mkdir /b
$ sudo chown %s:%s /b
$ mkdir -p %s
''' % (INSTALL_DIR, user, group, INSTALL_DIR)
    sys.exit(1)
