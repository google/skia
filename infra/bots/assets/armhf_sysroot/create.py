...
def create_asset(target_dir):
  ...
  shutil.copytree('/usr/lib/gcc-cross/arm-linux-gnueabihf/8',
                  os.path.join(target_dir, 'gcc-cross'))

  # Libs needed to link:
  shutil.copy('/usr/lib/x86_64-linux-gnu/libbfd-2.31.1-armhf.so',
              os.path.join(target_dir, 'lib'))
  shutil.copy('/usr/lib/x86_64-linux-gnu/libopcodes-2.31.1-armhf.so',
              os.path.join(target_dir, 'lib'))
