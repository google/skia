...
def create_asset(target_dir):
  ...
  with utils.tmp_dir():
    # Install build deps.
    beignet_build_deps = ['clang', 'cmake', 'libclang-dev', 'libdrm-dev',
                          'libedit-dev', 'libegl1-mesa-dev', 'libtinfo-dev',
                          'libxext-dev', 'libxfixes-dev', 'llvm', 'ocl-icd-dev',
                          'ocl-icd-opencl-dev', 'pkg-config', 'python',
                          'zlib1g-dev']
