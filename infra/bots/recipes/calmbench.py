...
def RunSteps(api):
  ...
  with api.context(cwd=api.vars.skia_dir):
    ...
    config = api.vars.builder_cfg.get('nano_config')
...
def GenTests(api):
  builders = [
    "Calmbench-Debian9-Clang-GCE-CPU-AVX2-x86_64-Release-8888",
    "Calmbench-Ubuntu17-Clang-Golo-GPU-QuadroP400-x86_64-Release-gl",
  ]
