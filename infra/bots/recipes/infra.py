...
def RunSteps(api):
  ...
  repo_root = api.path.start_dir.joinpath(repo_name)
  infra_tests = repo_root.joinpath('infra', 'bots', 'infra_tests.py')
  ...
  if repo_name != 'skia':
    git_init(api, api.path.start_dir.joinpath('skia'), env)
