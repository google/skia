...
def dm_flags(bot):
  ...
  # Decoder tests are now performing gamma correct decodes.  This means that, when
  # viewing the results, we need to perform a gamma correct encode to PNG.  Therefore,
  # we run the image tests in srgb mode instead of 8888.
