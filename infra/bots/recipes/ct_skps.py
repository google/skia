...
def GenTests(api):
  ...
  yield(
    ...
    api.properties(
        buildername=('Test-Ubuntu14-GCC-GCE-CPU-AVX-x86_64-Debug-' +
                     'CT_DM_10k_SKPs'),
  ...
  yield(
    ...
    api.properties(
        buildername='Test-Ubuntu14-GCC-GCE-CPU-AVX-x86_64-Debug-CT_IMG_DECODE_'
                    '10k_SKPs',
        path_config=path_config,
        swarm_out_dir='[SWARM_OUT_DIR]',
        ct_num_slaves=ct_num_slaves,
  ...
  yield(
    ...
    api.properties(
        buildername=
            'Perf-Ubuntu14-GCC-GCE-CPU-AVX-x86_64-Release-CT_BENCH_10k_SKPs',
        path_config=path_config,
        swarm_out_dir='[SWARM_OUT_DIR]',
        ct_num_slaves=ct_num_slaves,
        num_per_slave=num_per_slave,
  ...
  yield(
    ...
    api.properties(
        buildername='Test-Ubuntu14-GCC-GCE-CPU-AVX-x86_64-Debug-CT_DM_1m_SKPs',
        path_config=path_config,
        swarm_out_dir='[SWARM_OUT_DIR]',
        ct_num_slaves=ct_num_slaves,
        num_per_slave=num_per_slave,
  ...
  builder = 'Test-Ubuntu14-GCC-GCE-CPU-AVX-x86_64-Debug-CT_DM_10k_SKPs'
  yield(
  ...
  builder = ('Test-Ubuntu14-GCC-GCE-CPU-AVX-x86_64-Debug-CT_IMG_DECODE_'
             '10k_SKPs')
  yield(
