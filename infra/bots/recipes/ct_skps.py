...
def RunSteps(api):
  ...
  # Required paths.
  infrabots_dir = api.vars.checkout_root.join('skia', 'infra', 'bots')
  ...
  src = api.vars.build_dir.join('out', api.vars.configuration, skia_tool)
  ...
  skps_dir = api.vars.checkout_root.join(
