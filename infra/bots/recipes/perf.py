...
def perf_steps(api):
  ...
  if 'IntelIris655' in bot and 'Win10' in bot and 'Vulkan' in bot:
    for i in range(10):
      for t in ['~^GM_varied_text_clipped_lcd$', '^GM_varied_text_ignorable_clip_lcd$', '^blendmode_mask_DstATop$', '^blendmode_mask_Src$', '^blendmode_mask_SrcIn$', '^blendmode_mask_SrcOut$', '^desk_carsvg.skp_1$', '^desk_carsvg.skp_1.1$', '^desk_carsvg.skp_1.1_mpd$', '^desk_carsvg.skp_1_mpd$', '^desk_googlespreadsheet.skp_1$', '^desk_googlespreadsheet.skp_1.1$', '^desk_googlespreadsheet.skp_1.1_mpd$', '^desk_googlespreadsheet.skp_1_mpd$', '^desk_skbug6850overlay2.skp_1$', '^desk_skbug6850overlay2.skp_1.1$', '^desk_skbug6850overlay2.skp_1.1_mpd$', '^desk_skbug6850overlay2.skp_1_mpd$', '^fontscaler_lcd$', '^rotated_rects_aa_alternating_transparent_and_opaque_src$', '^rotated_rects_aa_changing_transparent_src$', '^rotated_rects_aa_same_transparent_src$', '^shadermask_LCD_FF$', '^srcmode_rects_1_aa$', '^text_16_LCD_88$', '^text_16_LCD_BK$', '^text_16_LCD_FF$', '^text_16_LCD_WT$']:
