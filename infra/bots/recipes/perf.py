...
def perf_steps(api):
  ...
  if 'IntelIris655' in bot and 'Win10' in bot and 'Vulkan' in bot:
    extra_bl = ['~^desk_carsvg.skp_1.1_mpd$', '~^desk_googlespreadsheet.skp_1.1_mpd$', '~^desk_skbug6850overlay2.skp_1$', '~^desk_skbug6850overlay2.skp_1.1$', '~^desk_skbug6850overlay2.skp_1.1_mpd$', '~^desk_skbug6850overlay2.skp_1_mpd$']
