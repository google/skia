...
DOCKER_IMAGE = 'gcr.io/skia-public/karma-chrome-tests:68.0.3440.84'
...
shutil.copy(helper_js, copy_dest)
shutil.copy(wasm, copy_dest)
''',
...
def GenTests(api):
  yield (
      ...
      api.properties(buildername='Test-Debian9-EMCC-GCE-CPU-AVX2-wasm-Debug-All-PathKit',
