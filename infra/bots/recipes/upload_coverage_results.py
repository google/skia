...
def RunSteps(api):
  ...
  executable = api.path['start_dir'].join('dm')
  ...
  api.step('Merge and index', cmd=[clang_dir.join('llvm-cov'), 'show', executable, '-instr-profile='+str(indexed_data), '-use-color=0', '-output-dir='+str(output_data) ])
