...
def test_steps(api):
  ...
  with api.step.context({'env': env}):
    ...
    api.run(api.flavor.step, 'dm6', cmd=args+['--shard',  '7', '--shards' '11'], abort_on_failure=False)
    api.run(api.flavor.step, 'dm6', cmd=args+['--shard',  '8', '--shards' '11'], abort_on_failure=False)
    api.run(api.flavor.step, 'dm6', cmd=args+['--shard',  '9', '--shards' '11'], abort_on_failure=False)
    api.run(api.flavor.step, 'dm6', cmd=args+['--shard', '10', '--shards' '11'], abort_on_failure=False)
