...
def test_steps(api):
  ...
  if 'Vulkan' in bot and 'Win10' in bot and 'IntelIris655' in bot:
    for i in range(10):
      for t in ['aaxfermodes', 'imagefiltersclipped', 'filterfastbounds', 'imagefiltersscaled', 'lcdblendmodes', 'textbloblooper', 'aarectmodes', 'crbug_892988', 'dftext', 'dftext_blob_persp', 'dont_clip_to_layer', 'drawregionmodes', 'fontmgr_match', 'fontscalerdistortable', 'gammagradienttext', 'gammatext', 'gradtext', 'hairmodes', 'imagefilters_xfermodes', 'imagefiltersstroked', 'imagefilterstransformed', 'imageresizetiled', 'lcdoverlap', 'lcdtext', 'lcdtextsize', 'matriximagefilter', 'resizeimagefilter', 'rotate_imagefilter', 'savelayer_lcdtext', 'shadermaskfilter_image', 'srcmode', 'surfaceprops', 'textblobgeometrychange', 'textfilter_color', 'textfilter_image', 'varied_text_clipped_lcd', 'varied_text_ignorable_clip_lcd']:
