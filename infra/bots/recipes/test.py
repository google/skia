...
def dm_flags(api, bot):
  ...
  if 'CPU' in bot and ('GalaxyS6' in bot or 'MotoG4' in bot):
  ...
  if 'GalaxyS6' in bot and 'GPU' in bot:
...
TEST_BUILDERS = [
  ...
  'Test-Android-Clang-GalaxyS6-CPU-Exynos7420-arm64-Debug-All-Android',
