  ...
  for f in files:
    ...
    with api.context(cwd=skia_dir):
      ...
      if step_data and step_data.stdout:
        sections = step_data.stdout.split('=====')
        ...
        logs['alpha'] = sections[1].split('\n')
        logs['beta']  = sections[2].split('\n')
        logs['gamma'] = sections[3].split('\n')
        logs['delta']  = sections[4].split('\n')
        logs['epsilon'] = sections[5].split('\n')
