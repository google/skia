...
SKIA_COMMITTER_NAME = 'UpdateMetaConfig'
...
def main(target_dir, gitcookies, repo_name, tasks_json):
...
if '__main__' == __name__:
  ...
  main(args.target_dir, args.gitcookies, args.repo_name, args.tasks_json)
