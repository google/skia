...
""" % json_key,
  ...
  def compile(self, unused_target):
    ...
    # both needed?
    if self.m.vars.builder_cfg.get('extra_config',  '').startswith('SK'):
      extra_define = self.m.vars.builder_cfg.get('extra_config',  '')
      assert extra_define.isupper()
      extra_cflags.append('-D' + extra_define)
