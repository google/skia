...
class GNFlavorUtils(default_flavor.DefaultFlavorUtils):
  ...
  def _get_goma_json(self):
    ...
    json_key = 'goma-client-skia-swarming-bots-service-account-json'
...
""" % json_key,
  ...
  def compile(self, unused_target):
    ...
    if 'Goma' in extra_config:
      ...
      with self.m.context(cwd=goma_win_dir):
        self._py('update goma', 'goma_ctl.py', 'update')
        self._py('start goma', 'goma_ctl.py', 'ensure_start')
      args['use_goma'] = 'true'
