...
Each recipe module contains a few files:
  ...
  * __init__.py - Contains a single DEPS variable, indicating the other recipe
        modules on which this module depends.
  * example.py - Optional, this file demonstrates how to use the module, and
        should contain enough tests to achieve 100% coverage for the module.
