...
def compile_fn(api, checkout_root, out_dir):
  ...
  extra_cflags = target + sysroot + [
    ...
    # Force using the older libm function versions that shipped on the Chorizo.
    '-Wa,-defsym,expf=expf@GLIBC_2.4',
    '-Wa,-defsym,powf=powf@GLIBC_2.4',
    '-Wa,-defsym,log2f=log2f@GLIBC_2.4',
    '-Wa,-defsym,exp2f=exp2f@GLIBC_2.4',
  ]
