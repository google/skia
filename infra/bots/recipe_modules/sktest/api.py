...
def dm_flags(bot):
  ...
  configs = ['8888', 'pdf']
  # Add in either either gles or gl configs to the canonical set based on OS
  ...
  if 'NVIDIA_Shield' in bot:
    ...
    configs = [x.replace('glesmsaa', 'glmsaa') for x in configs]
    configs = [x.replace('glesnvpr', 'glnvpr') for x in configs]
