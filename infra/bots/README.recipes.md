...
&mdash; **def [RunSteps](/infra/bots/recipes/test.py#858)(api):**

&mdash; **def [dm\_flags](/infra/bots/recipes/test.py#27)(api, bot):**

&mdash; **def [key\_params](/infra/bots/recipes/test.py#714)(api):**

Build a unique key from the builder name (as a list).

E.g.  arch x86 gpu GeForce320M mode MacMini4.1 os Mac10.6

&mdash; **def [test\_steps](/infra/bots/recipes/test.py#730)(api):**
