...
&mdash; **def [get\_flavor](/infra/bots/recipe_modules/flavor/api.py#68)(self, vars_api, app_name):**
...
&mdash; **def [setup](/infra/bots/recipe_modules/flavor/api.py#85)(self, app_name):**
...
&mdash; **def [RunSteps](/infra/bots/recipes/compute_buildstats.py#23)(api):**

&mdash; **def [add\_binary\_size\_output\_property](/infra/bots/recipes/compute_buildstats.py#157)(result, binary_size):**

&mdash; **def [analyze\_cpp\_lib](/infra/bots/recipes/compute_buildstats.py#141)(api, checkout_root, out_dir, files):**

&mdash; **def [analyze\_flutter\_lib](/infra/bots/recipes/compute_buildstats.py#162)(api, checkout_root, out_dir, files):**

&mdash; **def [analyze\_wasm\_file](/infra/bots/recipes/compute_buildstats.py#201)(api, checkout_root, out_dir, files):**

&mdash; **def [analyze\_web\_file](/infra/bots/recipes/compute_buildstats.py#128)(api, checkout_root, out_dir, files):**

&mdash; **def [keys\_and\_props](/infra/bots/recipes/compute_buildstats.py#104)(api):**

&mdash; **def [make\_treemap](/infra/bots/recipes/compute_buildstats.py#233)(api, checkout_root, out_dir, files):**
