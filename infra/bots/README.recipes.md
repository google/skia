...
&mdash; **def [\_\_call\_\_](/infra/bots/recipe_modules/build/api.py#59)(self, checkout_root, out_dir):**

Compile the code.

&mdash; **def [copy\_build\_products](/infra/bots/recipe_modules/build/api.py#63)(self, out_dir, dst):**
...
&mdash; **def [bot\_update](/infra/bots/recipe_modules/checkout/api.py#47)(self, checkout_root, gclient_cache=None, checkout_chromium=False, checkout_flutter=False, extra_gclient_env=None, flutter_android=False):**
...
[DEPS](/infra/bots/recipe_modules/docker/__init__.py#7): [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/step][recipe_engine/recipe_modules/step], [env](#recipe_modules-env), [run](#recipe_modules-run)
...
&mdash; **def [run](/infra/bots/recipe_modules/docker/api.py#30)(self, name, docker_image, src_dir, out_dir, script, args=None, docker_args=None, copies=None, recursive_read=None, attempts=1):**
...
[DEPS](/infra/bots/recipe_modules/flavor/__init__.py#5): [depot\_tools/bot\_update][depot_tools/recipe_modules/bot_update], [depot\_tools/cipd][depot_tools/recipe_modules/cipd], [depot\_tools/gclient][depot_tools/recipe_modules/gclient], [depot\_tools/git][depot_tools/recipe_modules/git], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/step][recipe_engine/recipe_modules/step], [builder\_name\_schema](#recipe_modules-builder_name_schema), [docker](#recipe_modules-docker), [env](#recipe_modules-env), [infra](#recipe_modules-infra), [run](#recipe_modules-run), [vars](#recipe_modules-vars)

#### **class [SkiaFlavorApi](/infra/bots/recipe_modules/flavor/api.py#72)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [cleanup\_steps](/infra/bots/recipe_modules/flavor/api.py#148)(self):**

&mdash; **def [copy\_directory\_contents\_to\_device](/infra/bots/recipe_modules/flavor/api.py#104)(self, host_dir, device_dir):**

&mdash; **def [copy\_directory\_contents\_to\_host](/infra/bots/recipe_modules/flavor/api.py#107)(self, device_dir, host_dir):**

&mdash; **def [copy\_file\_to\_device](/infra/bots/recipe_modules/flavor/api.py#110)(self, host_path, device_path):**

&mdash; **def [create\_clean\_device\_dir](/infra/bots/recipe_modules/flavor/api.py#116)(self, path):**

&mdash; **def [create\_clean\_host\_dir](/infra/bots/recipe_modules/flavor/api.py#113)(self, path):**

&mdash; **def [device\_path\_join](/infra/bots/recipe_modules/flavor/api.py#101)(self, \*args):**

&mdash; **def [get\_flavor](/infra/bots/recipe_modules/flavor/api.py#73)(self, vars_api):**

Return a flavor utils object specific to the given builder.

&mdash; **def [install](/infra/bots/recipe_modules/flavor/api.py#125)(self, skps=False, images=False, lotties=False, svgs=False, resources=False, mskps=False, texttraces=False):**

&mdash; **def [read\_file\_on\_device](/infra/bots/recipe_modules/flavor/api.py#119)(self, path, \*\*kwargs):**

&mdash; **def [remove\_file\_on\_device](/infra/bots/recipe_modules/flavor/api.py#122)(self, path):**

&mdash; **def [setup](/infra/bots/recipe_modules/flavor/api.py#92)(self):**

&mdash; **def [step](/infra/bots/recipe_modules/flavor/api.py#98)(self, name, cmd, \*\*kwargs):**
...
&mdash; **def [go\_version](/infra/bots/recipe_modules/infra/api.py#41)(self):**

Print the Go version.

&emsp; **@property**<br>&mdash; **def [gopath](/infra/bots/recipe_modules/infra/api.py#37)(self):**
...
&mdash; **def [RunSteps](/infra/bots/recipes/android_compile.py#30)(api):**
...
[DEPS](/infra/bots/recipes/check_generated_files.py#8): [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/step][recipe_engine/recipe_modules/step], [build](#recipe_modules-build), [checkout](#recipe_modules-checkout), [flavor](#recipe_modules-flavor), [infra](#recipe_modules-infra), [run](#recipe_modules-run), [vars](#recipe_modules-vars)

&mdash; **def [RunSteps](/infra/bots/recipes/check_generated_files.py#25)(api):**
...
&mdash; **def [RunSteps](/infra/bots/recipes/compute_buildstats.py#21)(api):**

&mdash; **def [analyze\_cpp\_lib](/infra/bots/recipes/compute_buildstats.py#131)(api, checkout_root, out_dir, files):**

&mdash; **def [analyze\_flutter\_lib](/infra/bots/recipes/compute_buildstats.py#145)(api, checkout_root, out_dir, files):**

&mdash; **def [analyze\_wasm\_file](/infra/bots/recipes/compute_buildstats.py#175)(api, checkout_root, out_dir, files):**

&mdash; **def [analyze\_web\_file](/infra/bots/recipes/compute_buildstats.py#118)(api, checkout_root, out_dir, files):**

&mdash; **def [keys\_and\_props](/infra/bots/recipes/compute_buildstats.py#93)(api):**

&mdash; **def [make\_treemap](/infra/bots/recipes/compute_buildstats.py#201)(api, checkout_root, out_dir, files):**
...
### *recipes* / [g3\_compile](/infra/bots/recipes/g3_compile.py)

[DEPS](/infra/bots/recipes/g3_compile.py#6): [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/step][recipe_engine/recipe_modules/step], [run](#recipe_modules-run), [vars](#recipe_modules-vars)

&mdash; **def [RunSteps](/infra/bots/recipes/g3_compile.py#19)(api):**
...
&mdash; **def [RunSteps](/infra/bots/recipes/perf.py#354)(api):**

&mdash; **def [nanobench\_flags](/infra/bots/recipes/perf.py#46)(api, bot):**

&mdash; **def [perf\_steps](/infra/bots/recipes/perf.py#261)(api):**
...
&mdash; **def [RunSteps](/infra/bots/recipes/perf_skottietrace.py#226)(api):**

&mdash; **def [get\_trace\_match](/infra/bots/recipes/perf_skottietrace.py#135)(lottie_filename, is_android):**

Returns the DM regex to match the specified lottie file name.

&mdash; **def [parse\_trace](/infra/bots/recipes/perf_skottietrace.py#150)(trace_json, lottie_filename, api):**
...
&mdash; **def [RunSteps](/infra/bots/recipes/skpbench.py#129)(api):**
...
&mdash; **def [RunSteps](/infra/bots/recipes/test.py#970)(api):**

&mdash; **def [dm\_flags](/infra/bots/recipes/test.py#40)(api, bot):**

&mdash; **def [key\_params](/infra/bots/recipes/test.py#808)(api):**

Build a unique key from the builder name (as a list).

E.g.  arch x86 gpu GeForce320M mode MacMini4.1 os Mac10.6

&mdash; **def [test\_steps](/infra/bots/recipes/test.py#825)(api):**
...
&mdash; **def [RunSteps](/infra/bots/recipes/test_pathkit.py#26)(api):**
