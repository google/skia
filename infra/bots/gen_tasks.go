...
func updateGoDeps(b *specs.TasksCfgBuilder, name string) string {
	...
	t := &specs.TaskSpec{
		...
		Dependencies: []string{BUILD_TASK_DRIVERS_NAME, "Build-Debian9-GCC-x86_64-Release-Shared"},
		Dimensions:   linuxGceDimensions(machineType),
		Environment: map[string]string{
			// TODO(borenet): Hard-coding this path is a bad idea.
			"CGO_LDFLAGS": "-L/mnt/pd0/s/w/ir/build",
		},
		EnvPrefixes: map[string][]string{
			"PATH": {"cipd_bin_packages", "cipd_bin_packages/bin", "go/go/bin"},
		},
