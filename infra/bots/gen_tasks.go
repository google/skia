...
var (
	...
	JOBS = []string{
		...
		"Perf-Win10-MSVC-NUC-GPU-IntelIris6100-x86_64-Debug",
		"Perf-Win10-MSVC-NUC-GPU-IntelIris6100-x86_64-Release",
		...
		"Test-Win10-MSVC-NUC-GPU-IntelIris6100-x86_64-Debug",
		"Test-Win10-MSVC-NUC-GPU-IntelIris6100-x86_64-Release",
...
func swarmDimensions(parts map[string]string) []string {
	...
	if os, ok := parts["os"]; ok {
		...
		if (parts["role"] == "Test" || parts["role"] == "Perf") && parts["os"] == "Win10" && parts["cpu_or_gpu"] == "GPU" && parts["cpu_or_gpu_value"] == "GTX660" {
			d["os"] = "Windows-10-14393"
		}
	} else {
		d["os"] = DEFAULT_OS
	}
