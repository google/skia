...
var (
	...
	JOBS = []string{
		...
		"Perf-Win10-MSVC-ShuttleC-GPU-IntelHD530-x86_64-Debug",
		"Perf-Win10-MSVC-ShuttleC-GPU-IntelHD530-x86_64-Release",
		"Perf-Win10-MSVC-ShuttleC-GPU-IntelIris540-x86_64-Debug",
		"Perf-Win10-MSVC-ShuttleC-GPU-IntelIris540-x86_64-Release",
		...
		"Test-Win10-MSVC-ShuttleC-GPU-IntelHD530-x86_64-Debug",
		"Test-Win10-MSVC-ShuttleC-GPU-IntelHD530-x86_64-Release",
		"Test-Win10-MSVC-ShuttleC-GPU-IntelIris540-x86_64-Debug",
		"Test-Win10-MSVC-ShuttleC-GPU-IntelIris540-x86_64-Release",
...
func swarmDimensions(parts map[string]string) []string {
	...
	if os, ok := parts["os"]; ok {
		...
		if parts["cpu_or_gpu_value"] == "GT610" && os == "Win10" {
			// GT610 bots in Chrome Golo run Windows-10-10586.
