...
func process(b *specs.TasksCfgBuilder, name string) {
	...
	// Update_Meta_Config bot.
	if strings.Contains(name, "Update_Meta_Config") {
	...
	if parts["role"] != "Build" &&
		...
		!strings.Contains(name, "Update_Meta_Config") &&
	...
	if name == "Housekeeper-Nightly-Update_Meta_Config" {
		j.Trigger = "nightly"
	}
