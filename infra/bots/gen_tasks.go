		...
		if strings.Contains(parts["os"], "Android") || strings.Contains(parts["os"], "Chromecast") {
			...
			if strings.Contains(parts["os"], "Win") {
				gpu, ok := map[string]string{
					...
					"IntelHD530":    "8086:1912-23.20.16.4944",
					"IntelIris540":  "8086:1926-23.20.16.4944",
					"IntelIris580":  "8086:193b-21.20.16.4839",
					"IntelIris6100": "8086:162b-21.20.16.4839",
					"IntelIris640":  "8086:5926-23.20.16.4973",
