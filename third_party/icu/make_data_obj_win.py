...
def write_windows_obj(symbol_name, target_cpu, src_path, dst_path):
    ...
    section1_header = image_section_header.pack(
            '.drectve', 0, 0, opts_length, header_len, 0, 0, 0, 0, 0x00100A00)
    section2_header = image_section_header.pack(
            '.rdata', 0, 0, len(src), header_len + opts_length, 0, 0, 0, 0, 0x40100000)
...
if __name__ == '__main__':
    ...
    name, _, target_cpu, src, dst = sys.argv[1:6]
    write_windows_obj(name, target_cpu, src, dst)
