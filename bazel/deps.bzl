...
def c_plus_plus_deps(ws = "@skia"):
    ...
    new_git_repository(
        ...
        commit = "d90557b380fa5db281969840cf25518085b0c4db",
    ...
    git_repository(
        name = "spirv_headers",
        commit = "efb6b4099ddb8fa60f62956dee592c4b94ec6a49",
        remote = "https://skia.googlesource.com/external/github.com/KhronosGroup/SPIRV-Headers.git",
    )

    git_repository(
        name = "spirv_tools",
        commit = "edc68950bf725edc89b3e1974c533454cf2ae37c",
    ...
    new_git_repository(
        ...
        commit = "7ea05992a52e96426bd4c56ea12d208e0d6c9a5f",
