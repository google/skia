...
def c_plus_plus_deps(ws = "@skia"):
    ...
    new_git_repository(
        ...
        commit = "bbac3636580e0465d94509134413fa7d9cdf8df7",
    ...
    git_repository(
        name = "spirv_headers",
        commit = "41a8eb27f1a7554dadfcdd45819954eaa94935e6",
        remote = "https://skia.googlesource.com/external/github.com/KhronosGroup/SPIRV-Headers.git",
    )

    git_repository(
        name = "spirv_tools",
        commit = "216574bedb80d439c2533d161e7ea7897504bbb6",
    ...
    new_git_repository(
        ...
        commit = "190d2cb24e90e5bf2bec0a75604a9b3586485b6d",
    ...
    new_git_repository(
        ...
        commit = "7e13360e42364fdd1f07fe00f19d0432b12db055",
    ...
    new_git_repository(
        ...
        commit = "df78ee39d2ff6c10b4f7f2ae06c7ca64524f9e25",
