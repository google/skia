...
def c_plus_plus_deps(ws = "@skia"):
    ...
    new_git_repository(
        ...
        commit = "65fa98d50f6db634e6ed0bf52056bded862a3955",
    ...
    git_repository(
        name = "spirv_headers",
        commit = "50bc4debdc3eec5045edbeb8ce164090e29b91f3",
        remote = "https://skia.googlesource.com/external/github.com/KhronosGroup/SPIRV-Headers.git",
    )

    git_repository(
        name = "spirv_tools",
        commit = "5b98dea6f1ce1a6b84d733d6093cdb208f4a0752",
    ...
    new_git_repository(
        ...
        commit = "d91597a82f881d473887b560a03a7edf2720b72c",
    ...
    new_git_repository(
        ...
        commit = "bfd85956e1b4c1c79842ce857fc7fb15adb8a573",
