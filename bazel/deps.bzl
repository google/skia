...
def c_plus_plus_deps(ws = "@skia"):
    ...
    new_git_repository(
        ...
        commit = "39b828ef334f494988ad2af635bac30be5f3318d",
    ...
    git_repository(
        name = "spirv_headers",
        commit = "db5a00f8cebe81146cafabf89019674a3c4bf03d",
        remote = "https://skia.googlesource.com/external/github.com/KhronosGroup/SPIRV-Headers.git",
    )

    git_repository(
        name = "spirv_tools",
        commit = "ffb8d85eac107e8a7442d5166bceac1dae8c6409",
    ...
    new_git_repository(
        ...
        commit = "fabe9e2672334fdb9a622d42a2e8f94578952082",
    ...
    new_git_repository(
        ...
        commit = "67522b34edde86dbb97e164280291f387ade55fc",
