...
def git_repos_from_deps(ws = "@"):
    ...
    new_git_repository(
        ...
        commit = "2966d3ad08eb574cbc94f151812cf50e6efd5db3",
    ...
    git_repository(
        name = "spirv_headers",
        commit = "f7e1a2ef5630417e70a6286011edf9a6e4b725c3",
        remote = "https://skia.googlesource.com/external/github.com/KhronosGroup/SPIRV-Headers.git",
    )

    git_repository(
        name = "spirv_tools",
        commit = "2189ad7a5aadc2accb9250a1e7ed08e3b49df01b",
    ...
    new_git_repository(
        ...
        commit = "870a531486f77dfaf124395de80ed38867400d31",
    ...
    new_git_repository(
        ...
        commit = "b647be6419696dac2f5e009d7e27913d987f037b",
