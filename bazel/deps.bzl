...
def c_plus_plus_deps(ws = "@skia"):
    ...
    new_git_repository(
        ...
        commit = "d20125b786b14eb85894e593566705fc19461b17",
    ...
    git_repository(
        name = "spirv_tools",
        commit = "aafd524577cc90fcdd13a6f0bcbfb929a30ee90f",
    ...
    new_git_repository(
        ...
        commit = "176fef0bccaba8bdf51de54ab4eed8d5d9aaac77",
    ...
    new_git_repository(
        ...
        commit = "6be00ca9f51c714780cc1d6f537f8bc5650b6204",
