...
def c_plus_plus_deps(ws = "@skia"):
    ...
    new_git_repository(
        ...
        commit = "10bc0e035997cca844aa43864a1f412ffe5b49c3",
    ...
    git_repository(
        name = "spirv_headers",
        commit = "d3c2a6fa95ad463ca8044d7fc45557db381a6a64",
        remote = "https://skia.googlesource.com/external/github.com/KhronosGroup/SPIRV-Headers.git",
    )

    git_repository(
        name = "spirv_tools",
        commit = "b7413609cf2d5adccc877d71a1d67ec43bea07c0",
    ...
    new_git_repository(
        ...
        commit = "d7db171ca5e201d931a3fa94626f3d8d6bc099fe",
    ...
    new_git_repository(
        ...
        commit = "86de0a0a9dc09520644bfb6b2f49e919134fe86d",
