...
def git_repos_from_deps(ws = "@"):
    ...
    git_repository(
        name = "spirv_headers",
        commit = "51b106461707f46d962554efe1bf56dee28958a3",
        remote = "https://skia.googlesource.com/external/github.com/KhronosGroup/SPIRV-Headers.git",
    )

    git_repository(
        name = "spirv_tools",
        commit = "b5f600c08cc9d900c7450ecba3689ef45fa20d6d",
    ...
    new_git_repository(
        ...
        commit = "cb7b123f2ddc04b86fd106c3a2b2e9872e8215b5",
    ...
    new_git_repository(
        ...
        commit = "ab9d7a042d152f0f36ef7e43cf33edea438fc6ab",
