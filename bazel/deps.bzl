...
def c_plus_plus_deps(ws = "@skia"):
    ...
    new_git_repository(
        ...
        commit = "0c8f10626e6cb2bc260a61365976d52f5967dfd4",
    ...
    git_repository(
        name = "spirv_tools",
        commit = "b9d5ced92ac454caf526c3b80d5105a1f38878ce",
    ...
    new_git_repository(
        ...
        commit = "26c7bde34a4a253004af427d92b27656e386effc",
    ...
    new_git_repository(
        ...
        commit = "7b23ba7a5f86936a8d783baf64a77c38977d6890",
