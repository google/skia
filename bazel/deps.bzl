...
def git_repos_from_deps(ws = "@"):
    ...
    new_git_repository(
        ...
        commit = "a3b683653e6a498514ef8a1865594810e91c594c",
    ...
    new_git_repository(
        ...
        commit = "b8f2f1406ef3e7b9a2e01edaaaf62d82eef1eb00",
