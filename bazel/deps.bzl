...
def git_repos_from_deps(ws = "@"):
    ...
    new_git_repository(
        ...
        commit = "0fde633f706b6ce7f8dc40c5fd8c8111fbdc95de",
    ...
    git_repository(
        name = "spirv_headers",
        commit = "10db9d4e194246a020a4148e220837ac7c68cfd9",
        remote = "https://skia.googlesource.com/external/github.com/KhronosGroup/SPIRV-Headers.git",
    )

    git_repository(
        name = "spirv_tools",
        commit = "54691dcd737c7b01e524bedcd5e9eb844f1f2d59",
    ...
    new_git_repository(
        ...
        commit = "07924a8a495dd8bcda112597da1bbc9b28f9bf63",
