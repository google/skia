...
def c_plus_plus_deps(ws = "@skia"):
    ...
    new_git_repository(
        ...
        commit = "4a267203bfb38111ea00b209d1db459e68725f20",
    ...
    git_repository(
        name = "spirv_headers",
        commit = "fbf2402969ed9aec34a8f8b4f5afab342319f07b",
        remote = "https://skia.googlesource.com/external/github.com/KhronosGroup/SPIRV-Headers.git",
    )

    git_repository(
        name = "spirv_tools",
        commit = "9db5b5ec19444dba6720afe165b1bd6ce08fb4bf",
    ...
    new_git_repository(
        ...
        commit = "d67a9d3a394e11c1c4c0f480124f5b7925cb1b4d",
    ...
    new_git_repository(
        ...
        commit = "252879e8958afc0c250ed460dbecf43c206fca04",
