...
def git_repos_from_deps():
    ...
    new_git_repository(
        ...
        commit = "d586d914780ba28ebb3ff93547262dbb73c8c0de",
    ...
    new_git_repository(
        ...
        commit = "a89dea3c499b1e322b39c7e6127af2777c4aa49b",
        remote = "https://chromium.googlesource.com/external/github.com/KhronosGroup/SPIRV-Cross",
    )

    git_repository(
        name = "spirv_headers",
        commit = "70ff9d939cd7fd0c758756ac57ab0c7c6d6c64d6",
    ...
    new_git_repository(
        ...
        commit = "9b48e83ef8c318739f38a07e4cd15473ff09ad86",
    ...
    new_git_repository(
        ...
        commit = "ffa89a44472a60d05705bbfb61ef8376babe9a34",
