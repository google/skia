...
public class SkottieView extends FrameLayout {
        ...
        try {
            switch (a.getInteger(R.styleable.SkottieView_backing_view, -1)) {
                ...
                case 1:
                    ...
                    // if there are more than 6 hex digits, there is an alpha channel
                    if (Integer.toHexString(bg).length() > 6) {
    ...
    public void setSource(InputStream inputStream) {
        mAnimation = SkottieRunner.getInstance().createAnimation(((TextureView) mbackingView), inputStream);
    }
