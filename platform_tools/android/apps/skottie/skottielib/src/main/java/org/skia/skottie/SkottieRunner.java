...
class SkottieRunner {
     ...
     */
    public SkottieAnimation createAnimation(TextureView view, InputStream is, int backgroundColor, boolean looping) {
        return new SkottieAnimationImpl(view, is, backgroundColor, looping);
    }
     ...
     */
    public SkottieAnimation createAnimation(SurfaceView view, InputStream is, int backgroundColor, boolean looping) {
        return new SkottieAnimationImpl(view, is, backgroundColor, looping);
    }
    ...
    private class SkottieAnimationImpl implements SkottieAnimation, Choreographer.FrameCallback,
        ...
        SkottieAnimationImpl(TextureView view, InputStream is, int backgroundColor, boolean looping) {
            if (init(is)) {
        ...
        SkottieAnimationImpl(SurfaceView view, InputStream is, int backgroundColor, boolean looping) {
            if (init(is)) {
        ...
        public void doFrame(long frameTimeNanos) {
            if (mIsRunning) {
                ...
                if (timeSinceAnimationStartNS >= durationNS && !mLooping) {
                    mIsRunning = false;
                    mProgress = 1;
                }
            }
