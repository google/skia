        ...
        try {
            mRunner.runOnGLThread(() -> {
                ...
                if (mEglSurface != null) {
                    ...
                    mRunner.mEgl.eglMakeCurrent(mRunner.mEglDisplay, mRunner.mPBufferSurface, mRunner.mPBufferSurface,
                            mRunner.mEglContext);
        ...
        try {
            ...
            if (mEglSurface == null) {
                ...
                if (mSurfaceTexture != null) {
                    mEglSurface = mRunner.mEgl.eglCreateWindowSurface(mRunner.mEglDisplay, mRunner.mEglConfig,
            ...
            if (mEglSurface != null) {
                if (!mRunner.mEgl.eglMakeCurrent(mRunner.mEglDisplay, mEglSurface, mEglSurface, mRunner.mEglContext)) {
