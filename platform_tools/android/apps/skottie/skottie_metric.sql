...
-- limit test results from the last 7 seconds from the end of the trace
CREATE VIEW test_start_ts_old AS
SELECT
  max(sched_slice.ts) - 7000000000  as test_start,
  max(sched_slice.ts)               as test_end,
