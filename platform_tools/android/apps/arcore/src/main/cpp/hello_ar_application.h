...
// HelloArApplication handles all application logics.
	...
	public:
		...
		void OnTouched(float x, float y, int drawMode);
		...
		glm::mat4 ComputeCameraAlignedMatrix(ArPlane* arPlane, glm::mat4 planeModel, glm::mat4 initRotation, glm::vec4 anchorPos,
		                                glm::vec3 cameraPos, glm::vec3 hitPos, float cameraDisplayOutRaw[]);
