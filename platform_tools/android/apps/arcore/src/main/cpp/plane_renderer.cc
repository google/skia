...
namespace hello_ar {
    namespace {
        ...
        constexpr U8CPU kPlaneAlpha = 170;
        constexpr int32_t kPlaneColorRgbaSize = 6;
        constexpr std::array<SkColor, kPlaneColorRgbaSize> kPlaneColorRgba = {
                {SkColorSetARGB(170, 255, 0, 0), SkColorSetARGB(170, 0, 255, 0),
                SkColorSetARGB(170, 0, 0, 255), SkColorSetARGB(170, 255, 255, 0),
                SkColorSetARGB(170, 0, 255, 255), SkColorSetARGB(170, 255, 0, 255)}
        };
