...
class CubeRenderThread extends Thread {
    ...
    private float fNear = 0.05f;
    private float fFar = 4;
    ...
    private void renderFrame(Surface surface, float rads) {
        ...
        Matrix cam = Matrix.makeLookAt(0, 0, eyeZ, 0, 0, 0, 0, 1, 0);
        Matrix perspective = Matrix.makePerspective(fNear, fFar, fAngle);
        Matrix viewport = new Matrix().translate(mCubeSideLength/2, mCubeSideLength/2, 0)
