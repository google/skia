...
public class Gradient extends Shader {
    protected interface GradientFactory {
        long makeGradient(float[] colors, float[] pos, int tileMode, long nativeLocalMatrix);
    }
    ...
    private static long makeGradient(Color[] colors, float[] pos, TileMode tm, Matrix lm,
        ...
        return gf.makeGradient(fcolors, pos, tm.ordinal(), lm != null ? lm.getNativeInstance() : 0);
    }
}
