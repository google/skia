...
SkArTrackableType SkArUtil::MakeSkArTrackableType(const ArTrackableType& trackableType) {
    switch (trackableType) {
        case AR_TRACKABLE_BASE_TRACKABLE:
            return SkArTrackableType::kBaseTrackable;
        case AR_TRACKABLE_PLANE:
            return SkArTrackableType::kPlane;
        case AR_TRACKABLE_POINT:
            return SkArTrackableType::kPoint;
        case AR_TRACKABLE_AUGMENTED_IMAGE:
            return SkArTrackableType::kAugmentedImage;
        case AR_TRACKABLE_NOT_VALID:
            return SkArTrackableType::kInvalid;
        default:
            return SkArTrackableType::kInvalid;
    }
}
