...
// HelloArApplication handles all application logics.
    ...
    private:
        ...
        // Creates and returns a unique_ptr to a MatrixComputationInfo given the finalized pending anchor
        std::unique_ptr<util::MatrixComputationInfo> CreateMatrixComputationInfo(ArPlane* containingPlane);
