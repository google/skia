...
static void fuzz_float(Fuzz* fuzz, float* f) {
    fuzz->next(f);
...
void fuzz_float(Fuzz* fuzz, float* f, Args... rest) {
    fuzz_float(fuzz, f);
    fuzz_float(fuzz, rest...);
}
    ...
    for (uint8_t i = 0; i < numOps; ++i) {
        ...
        switch (op) {
            ...
            case 1:
                ...
                break;
            case 2:
                fuzz_float(fuzz, &a, &b, &c, &d);
                path->quadTo(a, b, c, d);
                break;
            case 3:
                fuzz_float(fuzz, &a, &b, &c, &d, &e);
                path->conicTo(a, b, c, d, e);
                break;
            case 4:
                fuzz_float(fuzz, &a, &b, &c, &d, &e, &f);
