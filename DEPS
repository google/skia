...
vars = {
  ...
  'sk_tool_revision': 'git_revision:f5264a674ac2fa1e3fc4af5aab74844369a5aade',
}
...
deps = {
  ...
  "third_party/externals/dawn"            : "https://dawn.googlesource.com/dawn.git@d9f22ce0346b222759d5510be3d1cd93caa5ab86",
